species(
    label = 'F[CH]C(F)(F)C(F)[C](F)F(369)',
...
species(
    label = 'F[CH]C(F)(F)C(F)(F)[CH]F(368)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-938.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,146,234,414,562,504,606,1176,1296,1354,1460,278.796,278.835,278.917],'cm^-1')),
        HinderedRotor(inertia=(0.227219,'amu*angstrom^2'), symmetry=1, barrier=(12.5354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226902,'amu*angstrom^2'), symmetry=1, barrier=(12.5249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.680775,'amu*angstrom^2'), symmetry=1, barrier=(37.6045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.049,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120225,0.0979875,-0.000148241,1.14506e-07,-3.50311e-11,-112698,30.7704], Tmin=(100,'K'), Tmax=(801.779,'K')), NASAPolynomial(coeffs=[14.2718,0.026185,-1.39062e-05,2.80487e-09,-2.00889e-13,-115006,-35.4826], Tmin=(801.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-938.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[CH]C(F)(F)C(F)=C(F)F(498)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0104319,'amu*angstrom^2'), symmetry=1, barrier=(58.8204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146401,'amu*angstrom^2'), symmetry=1, barrier=(58.8197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849592,0.075931,-0.000113259,9.05043e-08,-2.92264e-11,-77250.4,26.7006], Tmin=(100,'K'), Tmax=(755.307,'K')), NASAPolynomial(coeffs=[10.2903,0.0259276,-1.39424e-05,2.83166e-09,-2.03783e-13,-78676.4,-16.195], Tmin=(755.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)F(502)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)(F)[CH]C(F)(F)F(504)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.179652,0.103272,-0.000181718,1.66604e-07,-5.9429e-11,-120615,31.7109], Tmin=(100,'K'), Tmax=(807.577,'K')), NASAPolynomial(coeffs=[10.1024,0.0339151,-1.86625e-05,3.74031e-09,-2.63771e-13,-121675,-11.9755], Tmin=(807.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1004.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'F[C](F)[CH]C(F)(F)C(F)F(505)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C](F)C(F)C(F)(F)F(506)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495136,0.112935,-0.000209777,1.94418e-07,-6.84824e-11,-117123,31.3397], Tmin=(100,'K'), Tmax=(843.224,'K')), NASAPolynomial(coeffs=[10.4409,0.0331169,-1.80844e-05,3.5654e-09,-2.47172e-13,-117974,-13.6653], Tmin=(843.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-975.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C(F)[C](F)C(F)F(490)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.108247,0.10003,-0.000169592,1.51007e-07,-5.27778e-11,-113057,32.8344], Tmin=(100,'K'), Tmax=(799.67,'K')), NASAPolynomial(coeffs=[10.9215,0.0317849,-1.7056e-05,3.39759e-09,-2.39287e-13,-114403,-15.2985], Tmin=(799.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-941.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'F[CH]C(F)(F)[CH]F(494)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'F[C](F)C(F)[C](F)F(459)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['FC1C(F)(F)C(F)C1(F)F(495)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['FCC(F)(F)C(F)=C(F)F(496)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=C(F)F(497)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCF2(54)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=C(F)F(498)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=C(F)C(F)[C](F)F(499)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(183)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', 'F[CH]C(F)=C[C](F)F(500)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[C](F)F(501)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(87)', 'F[CH]C(F)(F)[CH]F(494)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(86)', 'F[C](F)C(F)[C](F)F(459)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)F(502)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['FCC(F)(F)[C](F)[C](F)F(503)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[CH]C(F)(F)[CH]C(F)(F)F(504)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)F(505)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[CH][C](F)C(F)C(F)(F)F(506)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(369)'],
    products = ['F[C](F)C(F)[C](F)C(F)F(490)'],
...
network(
    label = 'PDepNetwork #173',
    isomers = [
        'F[CH]C(F)(F)C(F)[C](F)F(369)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CHFCF2(54)'),
    ],
