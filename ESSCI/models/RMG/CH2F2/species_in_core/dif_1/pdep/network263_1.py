...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C([O])F(138)'],
    products = ['[O]C(F)O[CH]F(659)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(523)'],
    products = ['[O]C(F)O[CH]F(659)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]F(170)', '[O][CH]F(170)'],
    products = ['[O]C(F)O[CH]F(659)'],
    transitionState = 'TS9',
