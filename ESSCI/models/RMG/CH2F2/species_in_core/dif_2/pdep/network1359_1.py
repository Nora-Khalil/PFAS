...
"""),
    E0 = (-1413.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,435,565,619,662,854,1178,1396,2782.5,750,1395,475,1775,1000,219.438,219.439,219.441],'cm^-1')),
        HinderedRotor(inertia=(0.248479,'amu*angstrom^2'), symmetry=1, barrier=(8.49066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305568,'amu*angstrom^2'), symmetry=1, barrier=(10.4414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248477,'amu*angstrom^2'), symmetry=1, barrier=(8.49066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10652,'amu*angstrom^2'), symmetry=1, barrier=(37.8103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0621752,0.0939047,-0.000140734,1.09022e-07,-3.36808e-11,-169906,29.3319], Tmin=(100,'K'), Tmax=(792.242,'K')), NASAPolynomial(coeffs=[13.2467,0.0273363,-1.46954e-05,2.96064e-09,-2.11785e-13,-171995,-31.205], Tmin=(792.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1413.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.90951,'amu*angstrom^2'), symmetry=1, barrier=(43.9035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90988,'amu*angstrom^2'), symmetry=1, barrier=(43.9119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473981,'amu*angstrom^2'), symmetry=1, barrier=(10.8978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474639,'amu*angstrom^2'), symmetry=1, barrier=(10.9129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.127016,0.0930977,-0.000137275,1.06582e-07,-3.33447e-11,-127300,31.0609], Tmin=(100,'K'), Tmax=(779.492,'K')), NASAPolynomial(coeffs=[12.3467,0.0303904,-1.66026e-05,3.373e-09,-2.42693e-13,-129205,-24.8475], Tmin=(779.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1059.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]CC(F)(F)OC([O])(F)F(4177)',
...
"""),
    E0 = (-1023.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,180,180,180,683.059,684.081],'cm^-1')),
        HinderedRotor(inertia=(0.182473,'amu*angstrom^2'), symmetry=1, barrier=(4.19542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181796,'amu*angstrom^2'), symmetry=1, barrier=(4.17984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182634,'amu*angstrom^2'), symmetry=1, barrier=(4.19912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0264562,0.0964677,-0.000159581,1.41544e-07,-4.99059e-11,-122996,31.3422], Tmin=(100,'K'), Tmax=(779.847,'K')), NASAPolynomial(coeffs=[10.3516,0.0332001,-1.80625e-05,3.61539e-09,-2.55834e-13,-124293,-13.8937], Tmin=(779.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1023.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFOO) + radical(CCOJ) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = '[O]C(F)(F)OC(F)(F)[CH]O(4178)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1072.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,375,486,586,623,710,938,1161,1294,3025,407.5,1350,352.5,180,180,180,1720.44],'cm^-1')),
        HinderedRotor(inertia=(0.34231,'amu*angstrom^2'), symmetry=1, barrier=(7.87038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342358,'amu*angstrom^2'), symmetry=1, barrier=(7.87148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342468,'amu*angstrom^2'), symmetry=1, barrier=(7.87401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342525,'amu*angstrom^2'), symmetry=1, barrier=(7.87533,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.518119,0.112906,-0.000209189,1.91046e-07,-6.61442e-11,-128795,32.8487], Tmin=(100,'K'), Tmax=(854.862,'K')), NASAPolynomial(coeffs=[11.202,0.0305923,-1.6548e-05,3.21905e-09,-2.2071e-13,-129795,-15.9847], Tmin=(854.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1072.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)
...
"""),
    E0 = (-1051.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,280,501,1494,1531,2782.5,750,1395,475,1775,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.41773,'amu*angstrom^2'), symmetry=1, barrier=(32.5963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792966,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477037,'amu*angstrom^2'), symmetry=1, barrier=(10.968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884709,0.0759188,-0.000107079,7.949e-08,-2.23803e-11,-126391,26.0004], Tmin=(100,'K'), Tmax=(630.71,'K')), NASAPolynomial(coeffs=[9.53544,0.0292112,-1.53922e-05,3.07918e-09,-2.19517e-13,-127645,-13.0332], Tmin=(630.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1051.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=CC(F)(F)O[C](O)F(4180)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-976.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,2782.5,750,1395,475,1775,1000,482,586,761,1411,319.977,320.022,320.191],'cm^-1')),
        HinderedRotor(inertia=(0.107017,'amu*angstrom^2'), symmetry=1, barrier=(7.7727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275074,'amu*angstrom^2'), symmetry=1, barrier=(20.0112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106917,'amu*angstrom^2'), symmetry=1, barrier=(7.77406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563244,'amu*angstrom^2'), symmetry=1, barrier=(40.974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696683,0.077019,-0.000100075,6.5522e-08,-1.70603e-11,-117372,28.2688], Tmin=(100,'K'), Tmax=(935.625,'K')), NASAPolynomial(coeffs=[13.6434,0.0216694,-1.13386e-05,2.29449e-09,-1.65939e-13,-119795,-33.3303], Tmin=(935.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-976.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFHOO) + group(Cds-OdCsH) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.157319,'amu*angstrom^2'), symmetry=1, barrier=(3.61707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385448,'amu*angstrom^2'), symmetry=1, barrier=(8.86221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161296,'amu*angstrom^2'), symmetry=1, barrier=(3.70852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.672224,0.0818554,-0.00014232,1.29028e-07,-4.55999e-11,-118821,27.7555], Tmin=(100,'K'), Tmax=(811.34,'K')), NASAPolynomial(coeffs=[9.01386,0.0267667,-1.4657e-05,2.91619e-09,-2.04672e-13,-119715,-7.91178], Tmin=(811.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-988.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-1147.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,217.126,217.126,217.126],'cm^-1')),
        HinderedRotor(inertia=(0.171759,'amu*angstrom^2'), symmetry=1, barrier=(5.74604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171759,'amu*angstrom^2'), symmetry=1, barrier=(5.74604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.937613,'amu*angstrom^2'), symmetry=1, barrier=(31.3671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49997,0.0829274,-0.00011314,7.82837e-08,-2.16117e-11,-137866,28.6641], Tmin=(100,'K'), Tmax=(882.749,'K')), NASAPolynomial(coeffs=[13.5048,0.0239971,-1.30001e-05,2.65455e-09,-1.92444e-13,-140162,-32.4543], Tmin=(882.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1147.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.450927,'amu*angstrom^2'), symmetry=1, barrier=(10.3677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450533,'amu*angstrom^2'), symmetry=1, barrier=(10.3586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452847,'amu*angstrom^2'), symmetry=1, barrier=(10.4118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452758,'amu*angstrom^2'), symmetry=1, barrier=(10.4098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.662627,0.123871,-0.000260083,2.48997e-07,-8.6857e-11,-149339,31.2282], Tmin=(100,'K'), Tmax=(894.603,'K')), NASAPolynomial(coeffs=[8.93908,0.0296273,-1.60259e-05,3.00886e-09,-1.97533e-13,-149003,-2.54906], Tmin=(894.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1242.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)

species(
    label = 'O=CC(F)(F)OC(=O)F(4183)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {7,S} {9,S}
...
"""),
    E0 = (-1148.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,2782.5,750,1395,475,1775,1000,482,664,788,1296,1923,231.439,234.469,234.798],'cm^-1')),
        HinderedRotor(inertia=(0.412118,'amu*angstrom^2'), symmetry=1, barrier=(15.5393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.714126,'amu*angstrom^2'), symmetry=1, barrier=(26.7342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0111329,'amu*angstrom^2'), symmetry=1, barrier=(36.7325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31654,0.0632918,-7.32691e-05,4.31964e-08,-1.03302e-11,-138013,24.8011], Tmin=(100,'K'), Tmax=(1003.53,'K')), NASAPolynomial(coeffs=[11.6114,0.0222562,-1.1931e-05,2.44731e-09,-1.78546e-13,-140080,-24.9018], Tmin=(1003.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1148.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH) + group(COFOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    ...
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(O)(F)F(1235)', 'CF2CO(104)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)OOC=C(F)F(4176)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]CC(F)(F)OC([O])(F)F(4177)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OC(F)(F)[CH]O(4178)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C[C](F)OC(O)(F)F(4179)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC(F)(F)O[C](O)F(4180)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)(F)F(323)', 'O=C[C](F)F(1009)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(232)', '[O]C(F)(F)C=O(437)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(4)', 'O=CC(F)(F)O[C](F)F(1463)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)(F)C=O(4181)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(14)', 'OC(F)(F)O[C](F)F(769)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=[C]C(F)(F)OC(O)(F)F(4182)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC(F)(F)OC(=O)F(4183)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3734)'],
...
network(
    label = 'PDepNetwork #1359',
    isomers = [
        'O=CC(F)(F)OC(O)(F)F(3734)',
    ],
    reactants = [
