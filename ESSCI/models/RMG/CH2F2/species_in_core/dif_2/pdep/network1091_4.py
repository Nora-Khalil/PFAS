...
"""),
    E0 = (259.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,570.104,570.387,570.574,570.842,2595.54],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0366,'amu'),
...
"""),
    E0 = (531.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,394.338,394.363,398.126,4000,4000],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0366,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33875,0.0122035,-6.26994e-06,-3.20881e-10,6.50296e-13,63974.1,-3.68947], Tmin=(100,'K'), Tmax=(1309.99,'K')), NASAPolynomial(coeffs=[7.4415,0.00436678,-2.66783e-06,5.79435e-10,-4.31767e-14,62496.7,-26.1269], Tmin=(1309.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CsJ2_singlet-CsH) + ring(Cyclopropene)"""),
)
...
"""),
    E0 = (273.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1775.15,2035.43],'cm^-1')),
        HinderedRotor(inertia=(0.109151,'amu*angstrom^2'), symmetry=1, barrier=(2.85469,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0366,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.66977,0.00698954,2.70399e-06,-4.66684e-09,1.29289e-12,32888.1,9.36099], Tmin=(100,'K'), Tmax=(1428.7,'K')), NASAPolynomial(coeffs=[4.5709,0.00902813,-4.22548e-06,8.01349e-10,-5.50003e-14,32165.1,3.06283], Tmin=(1428.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['O(170)', 'C2H2(70)'],
    products = ['C1=CO1(2889)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.77e+15,'cm^3/(mol*s)'), n=-0.662, Ea=(0.157737,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""Estimated using template [elec_def;mb_tb_unsub] for rate rule [o_atom_singlet;mb_tb_unsub]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction13',
    reactants = ['[C-]1=[O+]C1(3252)'],
    products = ['C1=CO1(2889)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.36538e+17,'s^-1'), n=-1.42952, Ea=(22.1772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.5517143818398826, var=16.398565006535087, Tref=1000.0, N=6, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C=O(3260)'],
    products = ['CH2CO(75)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(12.6272,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)
