...
reaction(
    ...
    products = ['[O-][O+]=O(227)', '[O]C(F)F(146)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](159)', '[O]C(F)F(146)'],
    products = ['[O]OOOC(F)F(206)'],
    transitionState = 'TS7',
