...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06028,0.0235152,3.48166e-05,-7.80744e-08,3.54798e-11,-25689.8,18.2991], Tmin=(100,'K'), Tmax=(937.225,'K')), NASAPolynomial(coeffs=[20.392,-0.00598453,4.02562e-06,-6.86046e-10,3.6242e-14,-31266.6,-80.3719], Tmin=(937.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(207)', '[O]O[C]=O(206)'],
    products = ['O=[C]OO[C]=O(201)'],
    transitionState = 'TS2',
