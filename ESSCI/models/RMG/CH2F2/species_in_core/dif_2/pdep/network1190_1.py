...
"""),
    E0 = (-704.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,197,221,431,657,2120,512.5,787.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.167988,'amu*angstrom^2'), symmetry=1, barrier=(3.86238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168411,'amu*angstrom^2'), symmetry=1, barrier=(3.87211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0438976,'amu*angstrom^2'), symmetry=1, barrier=(52.5235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-162.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,197,221,431,657,2120,512.5,787.5,829.745,829.77,829.824],'cm^-1')),
        HinderedRotor(inertia=(0.168494,'amu*angstrom^2'), symmetry=1, barrier=(3.87401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00792869,'amu*angstrom^2'), symmetry=1, barrier=(3.87439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75185,0.0567397,-0.00010456,9.87118e-08,-3.57612e-11,-19454.9,21.618], Tmin=(100,'K'), Tmax=(823.331,'K')), NASAPolynomial(coeffs=[6.53033,0.0194556,-1.1002e-05,2.2016e-09,-1.54483e-13,-19764.9,2.38928], Tmin=(823.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-273.027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,197,221,431,657,580,1155,1237,1373,3147,2120,512.5,787.5,180,1929.19],'cm^-1')),
        HinderedRotor(inertia=(0.431723,'amu*angstrom^2'), symmetry=1, barrier=(9.92615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0159741,'amu*angstrom^2'), symmetry=1, barrier=(42.3068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83745,'amu*angstrom^2'), symmetry=1, barrier=(42.2466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08541,0.074343,-0.000137374,1.31749e-07,-4.83432e-11,-32742.5,26.7248], Tmin=(100,'K'), Tmax=(826.256,'K')), NASAPolynomial(coeffs=[6.35141,0.0280769,-1.56704e-05,3.12415e-09,-2.18845e-13,-32903.6,6.61537], Tmin=(826.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFHHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(CsF1sHO2s)"""),
)

species(
    label = 'O=C=[C]OOC(F)F(3126)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-276.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,1685,370,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.376307,'amu*angstrom^2'), symmetry=1, barrier=(8.65204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376574,'amu*angstrom^2'), symmetry=1, barrier=(8.65817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56419,'amu*angstrom^2'), symmetry=1, barrier=(58.9557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11473,0.0719567,-0.000128394,1.18123e-07,-4.17722e-11,-33168.8,28.221], Tmin=(100,'K'), Tmax=(835.243,'K')), NASAPolynomial(coeffs=[7.74102,0.0239181,-1.28398e-05,2.51887e-09,-1.74734e-13,-33706.9,0.850588], Tmin=(835.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
species(
    label = 'O=C(F)[C-]=[O+]OC(F)F(3127)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {5,S} {7,S}
5  O u0 p1 c+1 {4,S} {9,D}
6  O u0 p2 c0 {8,D}
7  C u0 p0 c0 {1,S} {2,S} {4,S} {10,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.53071,0.0919539,-0.000181314,1.79072e-07,-6.58934e-11,-78188.2,39.4203], Tmin=(100,'K'), Tmax=(854.11,'K')), NASAPolynomial(coeffs=[4.94018,0.0355739,-1.95498e-05,3.8315e-09,-2.64069e-13,-77638.2,26.4717], Tmin=(854.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8655,0.0524743,-8.51021e-05,7.81177e-08,-2.87499e-11,-87985.5,20.437], Tmin=(100,'K'), Tmax=(776.722,'K')), NASAPolynomial(coeffs=[6.12248,0.0226414,-1.22132e-05,2.44512e-09,-1.73367e-13,-88408.2,2.5111], Tmin=(776.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOC(F)F(3014)'],
    products = ['CF2O(48)', 'O=CC(=O)F(557)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(16.7744,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'O=C=C(F)OO(3123)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(86)', 'O=C=C(F)OOF(3124)'],
    products = ['O=C=C(F)OOC(F)F(3014)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=C(F)OO[CH]F(3125)'],
    products = ['O=C=C(F)OOC(F)F(3014)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C=[C]OOC(F)F(3126)'],
    products = ['O=C=C(F)OOC(F)F(3014)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)F(163)', 'O=C=[C]F(965)'],
    products = ['O=C=C(F)OOC(F)F(3014)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[C-]=[O+]OC(F)F(3127)'],
    products = ['O=C=C(F)OOC(F)F(3014)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OOC(F)F(3014)'],
    products = ['CO(12)', 'F[C-]=[O+]OC(F)F(3128)'],
...
network(
    label = 'PDepNetwork #1190',
    isomers = [
        'O=C=C(F)OOC(F)F(3014)',
    ],
    reactants = [
