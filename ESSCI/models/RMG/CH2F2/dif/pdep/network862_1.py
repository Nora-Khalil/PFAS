...
"""),
    E0 = (-1316.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,300.85,301.914,308.648],'cm^-1')),
        HinderedRotor(inertia=(0.00185787,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18788,'amu*angstrom^2'), symmetry=1, barrier=(11.8263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300838,'amu*angstrom^2'), symmetry=1, barrier=(19.2713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'O=C(C(O)(F)F)C(F)(F)F(2202)',
...
"""),
    E0 = (-1433.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,203.601,203.602],'cm^-1')),
        HinderedRotor(inertia=(0.228588,'amu*angstrom^2'), symmetry=1, barrier=(6.72463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228575,'amu*angstrom^2'), symmetry=1, barrier=(6.72467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228574,'amu*angstrom^2'), symmetry=1, barrier=(6.72468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0918974,0.0923858,-0.000147741,1.19371e-07,-3.79254e-11,-172291,28.5811], Tmin=(100,'K'), Tmax=(775.001,'K')), NASAPolynomial(coeffs=[13.7164,0.0220672,-1.16438e-05,2.30059e-09,-1.61682e-13,-174403,-33.6769], Tmin=(775.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1433.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCOFFF) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-898.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,395,473,707,1436,181.303,182.295,183.777],'cm^-1')),
        HinderedRotor(inertia=(0.00504672,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173306,'amu*angstrom^2'), symmetry=1, barrier=(4.2034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.594674,'amu*angstrom^2'), symmetry=1, barrier=(14.1455,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108895,0.0931076,-0.000156167,1.33185e-07,-4.44114e-11,-107990,28.6961], Tmin=(100,'K'), Tmax=(808.487,'K')), NASAPolynomial(coeffs=[12.4733,0.0238497,-1.26716e-05,2.49185e-09,-1.73785e-13,-109725,-26.6922], Tmin=(808.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,190,488,555,1236,1407,180,180,2114.88],'cm^-1')),
        HinderedRotor(inertia=(0.543146,'amu*angstrom^2'), symmetry=1, barrier=(12.488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.519,'amu*angstrom^2'), symmetry=1, barrier=(34.9247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369357,0.0884257,-0.000153771,1.36918e-07,-4.75396e-11,-108483,25.8051], Tmin=(100,'K'), Tmax=(803.677,'K')), NASAPolynomial(coeffs=[10.7524,0.0250914,-1.38054e-05,2.76616e-09,-1.95017e-13,-109776,-19.6756], Tmin=(803.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(C([O])(F)F)C(F)(F)F(2205)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1056.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,193,295,551,588,656,1146,1192,1350,368.088,368.116,368.119],'cm^-1')),
        HinderedRotor(inertia=(0.0825026,'amu*angstrom^2'), symmetry=1, barrier=(7.93415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.082507,'amu*angstrom^2'), symmetry=1, barrier=(7.93495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.18766,0.0894721,-0.000128568,9.19293e-08,-2.58873e-11,-126883,28.3875], Tmin=(100,'K'), Tmax=(870.918,'K')), NASAPolynomial(coeffs=[14.9851,0.0215102,-1.15168e-05,2.32996e-09,-1.67673e-13,-129461,-40.9565], Tmin=(870.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1056.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + radical(CC(C)OJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-481.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,180,798.992],'cm^-1')),
        HinderedRotor(inertia=(0.636029,'amu*angstrom^2'), symmetry=1, barrier=(14.6236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2104,'amu*angstrom^2'), symmetry=1, barrier=(50.8215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
...
species(
    label = '[O][C](C(O)(F)F)C(F)(F)F(2206)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.362071,'amu*angstrom^2'), symmetry=1, barrier=(8.32472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.721726,'amu*angstrom^2'), symmetry=1, barrier=(16.5939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362436,'amu*angstrom^2'), symmetry=1, barrier=(8.33311,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.174746,0.10165,-0.000161832,1.185e-07,-2.95318e-11,-136898,28.5485], Tmin=(100,'K'), Tmax=(632.938,'K')), NASAPolynomial(coeffs=[15.1348,0.0216391,-1.18921e-05,2.36073e-09,-1.65376e-13,-139171,-40.9581], Tmin=(632.938,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1139.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C(C(=O)F)C(F)(F)F(2207)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1022.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,486,617,768,1157,1926,335.561,336.792,337.055],'cm^-1')),
        HinderedRotor(inertia=(0.00149042,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0564339,'amu*angstrom^2'), symmetry=1, barrier=(4.55614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.40246,'amu*angstrom^2'), symmetry=1, barrier=(9.25334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00760854,'amu*angstrom^2'), symmetry=1, barrier=(49.0175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13254,'amu*angstrom^2'), symmetry=1, barrier=(49.0314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830154,0.0756948,-0.00012045,1.01864e-07,-3.4225e-11,-128773,25.5353], Tmin=(100,'K'), Tmax=(790.401,'K')), NASAPolynomial(coeffs=[10.0683,0.0238138,-1.22571e-05,2.39767e-09,-1.67522e-13,-130073,-15.847], Tmin=(790.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1071.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCOFFF) + group(Cds-OdCsCs) + radical(CsCOF1sO2s)"""),
)
...
species(
    label = 'O[C](C(O)(F)F)C(F)(F)F(2209)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1286.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,193,295,551,588,656,1146,1192,1350,302.878,302.907],'cm^-1')),
        HinderedRotor(inertia=(0.120032,'amu*angstrom^2'), symmetry=1, barrier=(7.80928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11998,'amu*angstrom^2'), symmetry=1, barrier=(7.80992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119946,'amu*angstrom^2'), symmetry=1, barrier=(7.80974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
...
"""),
    E0 = (-1063.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,190,488,555,1236,1407,275.245,275.268],'cm^-1')),
        HinderedRotor(inertia=(0.606452,'amu*angstrom^2'), symmetry=1, barrier=(32.5462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151973,'amu*angstrom^2'), symmetry=1, barrier=(8.13814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.21922,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274612,'amu*angstrom^2'), symmetry=1, barrier=(14.7999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.313575,0.102841,-0.000162209,1.30705e-07,-4.17426e-11,-127716,30.2371], Tmin=(100,'K'), Tmax=(768.735,'K')), NASAPolynomial(coeffs=[14.1869,0.0273873,-1.49734e-05,3.01421e-09,-2.14681e-13,-129945,-35.9052], Tmin=(768.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1063.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-Cs(F)2) + group(CsCsFFH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-994.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,395,473,707,1436,244.73,245.93,246.456],'cm^-1')),
        HinderedRotor(inertia=(0.171695,'amu*angstrom^2'), symmetry=1, barrier=(7.31338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16998,'amu*angstrom^2'), symmetry=1, barrier=(7.31423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608625,'amu*angstrom^2'), symmetry=1, barrier=(26.1164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172253,'amu*angstrom^2'), symmetry=1, barrier=(7.33154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(O)C(F)(F)F(2190)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'OC(F)(F)[CH]C(F)(F)F(1033)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O[C](F)F(239)', 'CF3CHO(74)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CF3(44)', 'O=CC(O)(F)F(574)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(C(O)(F)F)C(F)(F)F(2202)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C([C](O)F)C(F)(F)F(2203)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', '[O]C([C](F)F)C(F)(F)F(2204)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(C([O])(F)F)C(F)(F)F(2205)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(239)', '[O][CH]C(F)(F)F(1093)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF3(44)', '[O][CH]C(O)(F)F(1623)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O][C](C(O)(F)F)C(F)(F)F(2206)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C(C(=O)F)C(F)(F)F(2207)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C([C](O)F)C(F)(F)F(2208)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
    products = ['O[C](C(O)(F)F)C(F)(F)F(2209)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(F)C(O)C(F)(F)F(2060)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OOC([C](F)F)C(F)(F)F(2210)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O[C](F)C(OF)C(F)(F)F(2120)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(1935)'],
...
network(
    label = 'PDepNetwork #862',
    isomers = [
        '[O]C(C(O)(F)F)C(F)(F)F(1935)',
    ],
    reactants = [
