...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(214)'],
    products = ['[O]C(=O)C([O])=O(199)'],
    transitionState = 'TS2',
