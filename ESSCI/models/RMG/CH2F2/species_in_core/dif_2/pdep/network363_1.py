...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(F)O[C](O)F(864)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(865)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(136)', 'O[C](F)F(232)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(50)', '[O]C(O)(F)F(323)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(4)', 'O=C(F)O[C](F)F(300)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(F)OC(=O)F(612)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(866)'],
    products = ['O=C(F)OC(O)(F)F(818)'],
