...
"""),
    E0 = (-380.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,580,1155,1237,1373,3147,493,600,700,1144,1293,180],'cm^-1')),
        HinderedRotor(inertia=(2.12421,'amu*angstrom^2'), symmetry=1, barrier=(48.8399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473995,'amu*angstrom^2'), symmetry=1, barrier=(10.8981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12525,'amu*angstrom^2'), symmetry=1, barrier=(48.8636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73994,0.0546011,-7.40072e-05,5.20939e-08,-1.48105e-11,-45744.5,21.2015], Tmin=(100,'K'), Tmax=(853.097,'K')), NASAPolynomial(coeffs=[9.50431,0.0181957,-9.99599e-06,2.07155e-09,-1.51585e-13,-47069.3,-15.0235], Tmin=(853.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
