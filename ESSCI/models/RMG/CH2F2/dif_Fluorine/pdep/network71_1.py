...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(150)', '[O]C=O(142)'],
    products = ['O=COC(=O)OF(203)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(248)', 'O=[C]OC=O(247)'],
    products = ['O=COC(=O)OF(203)'],
    transitionState = 'TS9',
