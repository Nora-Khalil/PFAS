...
"""),
    E0 = (-281.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,242.85,244.903],'cm^-1')),
        HinderedRotor(inertia=(0.00498522,'amu*angstrom^2'), symmetry=1, barrier=(0.209914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426784,'amu*angstrom^2'), symmetry=1, barrier=(17.643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-329.661,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,946.723],'cm^-1')),
        HinderedRotor(inertia=(0.00979768,'amu*angstrom^2'), symmetry=1, barrier=(21.8149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948414,'amu*angstrom^2'), symmetry=1, barrier=(21.8059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947005,'amu*angstrom^2'), symmetry=1, barrier=(21.7735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20703,0.0421788,-3.31275e-05,1.3234e-08,-2.21664e-12,-37946.7,18.7099], Tmin=(100,'K'), Tmax=(1345.81,'K')), NASAPolynomial(coeffs=[8.9841,0.0220359,-1.06766e-05,2.11252e-09,-1.50668e-13,-39770.8,-15.9982], Tmin=(1345.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)

species(
    label = '[CH2][C](F)COF(1981)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (35.8094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,3000,3100,440,815,1455,1000,180,1377.7],'cm^-1')),
        HinderedRotor(inertia=(0.241886,'amu*angstrom^2'), symmetry=1, barrier=(5.56144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244334,'amu*angstrom^2'), symmetry=1, barrier=(5.61773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243171,'amu*angstrom^2'), symmetry=1, barrier=(5.59097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41612,0.0668033,-0.00012086,1.16626e-07,-4.25752e-11,4390.32,23.035], Tmin=(100,'K'), Tmax=(851.157,'K')), NASAPolynomial(coeffs=[4.88319,0.0284474,-1.43849e-05,2.7759e-09,-1.90827e-13,4599.29,11.5618], Tmin=(851.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.8094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[O]C[C](F)CF(1982)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.428575,'amu*angstrom^2'), symmetry=1, barrier=(9.85378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13227,'amu*angstrom^2'), symmetry=1, barrier=(26.0332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33722,0.0666521,-0.00011329,1.06817e-07,-3.9397e-11,-29048.4,21.7903], Tmin=(100,'K'), Tmax=(807.087,'K')), NASAPolynomial(coeffs=[6.04157,0.0285641,-1.5046e-05,2.9877e-09,-2.103e-13,-29326.6,3.08354], Tmin=(807.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sHH)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(66)', '[O]C[C](F)F(728)'],
    products = ['[CH2]C(F)(F)C[O](1903)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])(F)F(973)'],
    products = ['[CH2]C(F)(F)C[O](1903)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C=O(921)'],
    products = ['[CH2]C(F)(F)C[O](1903)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](922)'],
    products = ['[CH2]C(F)(F)C[O](1903)'],
