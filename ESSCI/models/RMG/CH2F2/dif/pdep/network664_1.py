...
"""),
    E0 = (-720.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,180,180,180,1354.3],'cm^-1')),
        HinderedRotor(inertia=(0.25602,'amu*angstrom^2'), symmetry=1, barrier=(5.8864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256064,'amu*angstrom^2'), symmetry=1, barrier=(5.88741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29499,'amu*angstrom^2'), symmetry=1, barrier=(29.7745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-510.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,180,180,1078.68,4000],'cm^-1')),
        HinderedRotor(inertia=(0.36689,'amu*angstrom^2'), symmetry=1, barrier=(8.43552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54835,'amu*angstrom^2'), symmetry=1, barrier=(35.5997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54859,'amu*angstrom^2'), symmetry=1, barrier=(35.6052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    E0 = (-806.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,2782.5,750,1395,475,1775,1000,253.197,974.364],'cm^-1')),
        HinderedRotor(inertia=(0.819988,'amu*angstrom^2'), symmetry=1, barrier=(37.4431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821166,'amu*angstrom^2'), symmetry=1, barrier=(37.4316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(170)', '[CH2]OF(1527)'],
    products = ['FOCOC(F)F(1591)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(228)', '[CH2]OC(F)F(1532)'],
    products = ['FOCOC(F)F(1591)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FO[CH]OC(F)F(528)'],
    products = ['FOCOC(F)F(1591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['FOCOC(F)F(1591)'],
    products = ['F2(77)', 'CHFO(46)', 'CH2O(19)'],
