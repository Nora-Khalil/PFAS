...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.690091,'amu*angstrom^2'), symmetry=1, barrier=(15.8666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.7912,'amu*angstrom^2'), symmetry=1, barrier=(18.1912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08579,0.0624915,-7.15727e-05,3.99668e-08,-8.68899e-12,-60205.2,22.5414], Tmin=(100,'K'), Tmax=(1126.76,'K')), NASAPolynomial(coeffs=[14.9522,0.0132659,-6.04129e-06,1.19419e-09,-8.63274e-14,-63330,-46.0108], Tmin=(1126.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-501.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6767,0.0551559,-6.70755e-05,4.51597e-08,-1.2505e-11,-58712,22.8831], Tmin=(100,'K'), Tmax=(870.294,'K')), NASAPolynomial(coeffs=[8.76216,0.0225907,-1.09485e-05,2.16585e-09,-1.54867e-13,-59945.3,-10.3159], Tmin=(870.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-488.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.298809,'amu*angstrom^2'), symmetry=1, barrier=(6.8702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.93294,'amu*angstrom^2'), symmetry=1, barrier=(21.4501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88102,0.0509899,-8.08803e-05,6.99263e-08,-2.40253e-11,-34776.7,20.1862], Tmin=(100,'K'), Tmax=(793.137,'K')), NASAPolynomial(coeffs=[7.52779,0.0177047,-8.83956e-06,1.73134e-09,-1.21346e-13,-35521.2,-4.79441], Tmin=(793.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)[C](O)F(1249)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644703,0.0809591,-0.000139273,1.20704e-07,-4.04142e-11,-64135.7,24.134], Tmin=(100,'K'), Tmax=(833.16,'K')), NASAPolynomial(coeffs=[11.067,0.0201384,-1.03588e-05,2.01687e-09,-1.39485e-13,-65498.1,-21.9993], Tmin=(833.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C]([O])F(1250)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977733,0.0744098,-0.000128737,1.15384e-07,-3.9763e-11,-62403.5,22.2069], Tmin=(100,'K'), Tmax=(846.091,'K')), NASAPolynomial(coeffs=[8.60722,0.0233674,-1.17004e-05,2.25114e-09,-1.5459e-13,-63158.6,-10.1587], Tmin=(846.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[CH2][C](F)C(F)OF(1251)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-175.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,212,367,445,1450,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.171733,'amu*angstrom^2'), symmetry=1, barrier=(3.94849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172466,'amu*angstrom^2'), symmetry=1, barrier=(3.96532,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939396,0.0796193,-0.000151193,1.47257e-07,-5.39972e-11,-21004.4,24.7956], Tmin=(100,'K'), Tmax=(844.967,'K')), NASAPolynomial(coeffs=[5.58864,0.0306726,-1.64822e-05,3.24232e-09,-2.24846e-13,-20828.4,8.8392], Tmin=(844.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[O]C(F)[C](F)CF(1252)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19678,'amu*angstrom^2'), symmetry=1, barrier=(27.5163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19677,'amu*angstrom^2'), symmetry=1, barrier=(27.5161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47376,0.0560406,-5.80095e-05,3.00457e-08,-6.21606e-12,-55576.4,22.1842], Tmin=(100,'K'), Tmax=(1161.85,'K')), NASAPolynomial(coeffs=[12.5706,0.0178366,-8.68644e-06,1.74426e-09,-1.26336e-13,-58154.9,-33.0165], Tmin=(1161.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-462.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)[CH]OF(1253)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-196.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,230.065,1778.45],'cm^-1')),
        HinderedRotor(inertia=(0.302365,'amu*angstrom^2'), symmetry=1, barrier=(11.377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.567638,'amu*angstrom^2'), symmetry=1, barrier=(21.1549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556293,'amu*angstrom^2'), symmetry=1, barrier=(21.1456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922367,0.0727593,-0.000105124,7.68492e-08,-2.2201e-11,-23469.7,24.0702], Tmin=(100,'K'), Tmax=(848.362,'K')), NASAPolynomial(coeffs=[12.3482,0.0188875,-9.87403e-06,1.9997e-09,-1.44156e-13,-25408.3,-29.1739], Tmin=(848.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)CF(1254)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-485.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00768558,'amu*angstrom^2'), symmetry=1, barrier=(35.7022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55274,'amu*angstrom^2'), symmetry=1, barrier=(35.7005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60886,0.0604015,-7.42222e-05,3.72673e-08,1.82263e-12,-58284.8,21.0193], Tmin=(100,'K'), Tmax=(548.159,'K')), NASAPolynomial(coeffs=[7.83631,0.0266525,-1.38692e-05,2.78324e-09,-1.98985e-13,-59143.2,-6.88319], Tmin=(548.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-485.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C[C](F)F(1179)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[O]C(F)[C](F)F(402)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]F(1244)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(1246)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(1247)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(46)', '[CH2][C](F)F(1124)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(1147)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(127)', '[CH2][C](F)F(1124)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[CH2]C(F)=C[O](1248)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][C](F)C(=O)F(1223)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[CH]OF(1253)'],
    products = ['[CH2]C(F)(F)C([O])F(1178)'],
