...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57842,0.0448756,-3.16222e-05,5.75057e-09,1.23724e-12,-82567.3,21.0953], Tmin=(100,'K'), Tmax=(1133.43,'K')), NASAPolynomial(coeffs=[14.7061,0.0120661,-6.09369e-06,1.25906e-09,-9.336e-14,-86411.6,-47.7132], Tmin=(1133.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHHO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-233.704,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,580,1155,1237,1373,3147,180,180,1525.85,1526.38,1529.26],'cm^-1')),
        HinderedRotor(inertia=(0.227072,'amu*angstrom^2'), symmetry=1, barrier=(5.22083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22667,'amu*angstrom^2'), symmetry=1, barrier=(5.2116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225932,'amu*angstrom^2'), symmetry=1, barrier=(5.19463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6954,0.0732728,-0.000174365,2.00024e-07,-8.08267e-11,-28046.9,23.8004], Tmin=(100,'K'), Tmax=(851.14,'K')), NASAPolynomial(coeffs=[-4.97319,0.0471724,-2.71375e-05,5.41712e-09,-3.77146e-13,-24831.1,67.1201], Tmin=(851.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHHO) + radical(OCOJ) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'O[C](OF)O[CH]F(1368)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-255.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,580,1155,1237,1373,3147,180,180,1495.45,1495.55],'cm^-1')),
        HinderedRotor(inertia=(0.267302,'amu*angstrom^2'), symmetry=1, barrier=(6.14581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267394,'amu*angstrom^2'), symmetry=1, barrier=(6.14791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267415,'amu*angstrom^2'), symmetry=1, barrier=(6.14839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267343,'amu*angstrom^2'), symmetry=1, barrier=(6.14674,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17754,0.0768202,-0.000160045,1.62141e-07,-6.04656e-11,-30684.8,25.8759], Tmin=(100,'K'), Tmax=(854.626,'K')), NASAPolynomial(coeffs=[3.9036,0.029652,-1.68644e-05,3.34019e-09,-2.31074e-13,-29894.2,20.5042], Tmin=(854.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHHO) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-578.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,180,602.263,602.265,602.268,602.268,602.281,602.285,602.301],'cm^-1')),
        HinderedRotor(inertia=(0.00722238,'amu*angstrom^2'), symmetry=1, barrier=(1.85906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00721962,'amu*angstrom^2'), symmetry=1, barrier=(1.85832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40169,0.0296805,-1.58838e-05,1.08463e-10,1.5938e-12,-69460.9,18.4443], Tmin=(100,'K'), Tmax=(1165.19,'K')), NASAPolynomial(coeffs=[10.0146,0.0127324,-5.89175e-06,1.15766e-09,-8.3038e-14,-71858.6,-22.1232], Tmin=(1165.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFHHO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(86)', 'O=C(O)OF(854)'],
    products = ['O=C(OF)OCF(1365)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(855)', 'CH2(S)(72)'],
    products = ['O=C(OF)OCF(1365)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=O)OF(1369)'],
    products = ['O=C(OF)OCF(1365)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(860)', 'CH2F(89)'],
    products = ['O=C(OF)OCF(1365)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(154)', 'O=[C]OCF(1371)'],
    products = ['O=C(OF)OCF(1365)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[CH]F(858)'],
    products = ['O=C(OF)OCF(1365)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(OF)OCF(1365)'],
    products = ['F2(106)', 'CO2(13)', 'CH2O(19)'],
