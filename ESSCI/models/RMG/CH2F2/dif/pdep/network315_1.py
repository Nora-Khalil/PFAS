...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.423862,'amu*angstrom^2'), symmetry=1, barrier=(9.74541,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752106,0.0844093,-0.000171855,1.63427e-07,-5.74736e-11,-78847.6,24.2131], Tmin=(100,'K'), Tmax=(870.764,'K')), NASAPolynomial(coeffs=[8.29011,0.0205949,-1.16481e-05,2.27712e-09,-1.54978e-13,-79053.8,-4.75645], Tmin=(870.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.641076,'amu*angstrom^2'), symmetry=1, barrier=(14.7396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641046,'amu*angstrom^2'), symmetry=1, barrier=(14.7389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641084,'amu*angstrom^2'), symmetry=1, barrier=(14.7398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
...
"""),
    ...
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765185,0.0821447,-0.000155422,1.47649e-07,-5.34275e-11,-59842.9,24.4527], Tmin=(100,'K'), Tmax=(828.183,'K')), NASAPolynomial(coeffs=[7.80738,0.0264074,-1.51236e-05,3.03879e-09,-2.13324e-13,-60264.3,-3.69627], Tmin=(828.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(F)(F)OOF(663)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(42)', '[O]OC(F)F(168)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(124)', 'F[C]C(F)F(231)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)(F)F(654)', 'CHF(40)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)C(F)F(637)'],
    products = ['[O]OC(F)C(F)(F)F(655)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C(F)F(247)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)C(F)F(656)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]F(657)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)F(658)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(660)'],
    products = ['[O]OC(F)(F)C(F)F(637)'],
