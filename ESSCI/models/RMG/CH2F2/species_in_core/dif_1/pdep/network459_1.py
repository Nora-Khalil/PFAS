...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)CF(1196)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.98542e+10,'s^-1'), n=0.978818, Ea=(211.228,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'OC(F)(F)CF(319)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(339.956,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'OC(F)(F)[C]F(576)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(190.689,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(254)', 'F[C]CF-2(188)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(155)', 'F[C]C(F)(F)CF(893)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(88)', 'OC(F)(F)C(F)F(435)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(21.3408,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OF(155)', 'FCC(F)=C(F)F(793)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[C](F)CF(1266)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)(F)CF(1267)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)F(1268)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'FCC(F)(F)[C](F)F(902)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)CF(901)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(220)', 'CH2F-CF2(67)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(91)', 'OC(F)(F)[C](F)F(586)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(752)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(108)', 'OC(F)=C(F)CF(1269)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(108)', 'C=C(F)C(O)(F)F(1270)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=CF(1026)'],
    products = ['OC(F)(F)C(F)(F)CF(1196)'],
...
network(
    ...
    isomers = [
        'OC(F)(F)C(F)(F)CF(1196)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CH2CF2(56)'),
        ('O[C](F)F(220)', 'CH2F-CF2(67)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
