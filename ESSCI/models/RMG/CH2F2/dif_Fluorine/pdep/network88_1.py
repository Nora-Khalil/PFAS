...
"""),
    E0 = (-410.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,180,180,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.60764,'amu*angstrom^2'), symmetry=1, barrier=(13.9708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0740649,'amu*angstrom^2'), symmetry=1, barrier=(28.6072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98725,0.0484698,-7.69053e-05,6.26646e-08,-2.02742e-11,-49264.9,16.9419], Tmin=(100,'K'), Tmax=(758.144,'K')), NASAPolynomial(coeffs=[8.64799,0.013326,-7.36985e-06,1.51673e-09,-1.09721e-13,-50274.8,-13.3478], Tmin=(758.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
species(
    label = 'F[C-]=[O+]C(F)F(714)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {6,S}
4 O u0 p1 c+1 {5,S} {6,D}
5 C u0 p0 c0 {1,S} {2,S} {4,S} {7,S}
6 C u0 p1 c-1 {3,S} {4,D}
7 H u0 p0 c0 {5,S}
"""),
    E0 = (-647.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.92491,'amu*angstrom^2'), symmetry=1, barrier=(44.2574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6088,0.0337708,-3.4861e-05,1.95943e-08,-4.68123e-12,-77847.6,14.9817], Tmin=(100,'K'), Tmax=(979.441,'K')), NASAPolynomial(coeffs=[6.80003,0.016654,-8.64691e-06,1.75139e-09,-1.26882e-13,-78668.6,-5.15149], Tmin=(979.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsFFHO) + group(CJ2_singlet-FO)"""),
)

species(
    label = 'F[CH]OC(F)(F)F(558)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    E0 = (-906.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,580,1155,1237,1373,3147,180,180,976.051],'cm^-1')),
        HinderedRotor(inertia=(0.278318,'amu*angstrom^2'), symmetry=1, barrier=(6.39909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281102,'amu*angstrom^2'), symmetry=1, barrier=(6.46309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.5389,0.049496,-0.000143134,3.15901e-07,-2.87705e-10,-109021,12.4662], Tmin=(10,'K'), Tmax=(309.794,'K')), NASAPolynomial(coeffs=[4.79229,0.028831,-2.13775e-05,7.19011e-09,-8.97978e-13,-109077,8.23515], Tmin=(309.794,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-906.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""F[CH]OC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF2O(48)', 'CHF2(81)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(61.188,'m^3/(mol*s)'), n=1.29312, Ea=(46.7157,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.28976280499384915, var=2.1569028208455543, Tref=1000.0, N=37, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O[C](F)F(237)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(76.147,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FO[C](F)F(238)', 'CHF(40)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(8.8418,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OC(F)F(713)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(126)', '[O]C(F)F(146)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]O[C](F)F(467)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(714)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(518506,'m^3/(mol*s)'), n=0.4717, Ea=(5.42329,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R->H_N-2Br1sCl1sF1s->Cl1s_3BrCClFINOPSSi->F',), comment="""Estimated from node Root_N-3R->H_N-2Br1sCl1sF1s->Cl1s_3BrCClFINOPSSi->F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[O]C(F)F(146)'],
    products = ['F[C](F)OC(F)F(250)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(4.25263,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)F(250)'],
    products = ['F[CH]OC(F)(F)F(558)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(219.649,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #88',
    isomers = [
        'F[C](F)OC(F)F(250)',
    ],
    reactants = [
