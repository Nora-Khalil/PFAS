...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]C[CH]F(1558)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)[C](F)F(1066)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]CC=C(F)F(1561)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[O]CC(F)[C](F)F(1545)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(14.4536,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]CC(F)=C(F)F(1562)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(28.1069,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=CC(F)[C](F)F(741)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[C](F)F(742)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(89)', '[O]C[CH]F(1558)'],
    products = ['[O]CC(F)[C](F)F(1545)'],
