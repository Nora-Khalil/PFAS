...
"""),
    E0 = (34.4821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,580,1155,1237,1373,3147,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(2.17199,'amu*angstrom^2'), symmetry=1, barrier=(49.9384,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17194,0.0448311,-5.95891e-05,4.02553e-08,-8.94641e-12,4208.72,16.005], Tmin=(100,'K'), Tmax=(608.403,'K')), NASAPolynomial(coeffs=[7.21436,0.0179807,-8.92606e-06,1.76427e-09,-1.25226e-13,3478.53,-6.7745], Tmin=(608.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.4821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH2]O[O](264)'],
    products = ['[CH2]OO[CH]F(2009)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(159)', 'CH2(T)(66)'],
    products = ['[CH2]OO[CH]F(2009)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
