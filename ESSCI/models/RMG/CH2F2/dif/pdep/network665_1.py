...
"""),
    E0 = (-754.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,226.172,226.421],'cm^-1')),
        HinderedRotor(inertia=(0.621723,'amu*angstrom^2'), symmetry=1, barrier=(22.4105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190629,'amu*angstrom^2'), symmetry=1, barrier=(6.8916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190067,'amu*angstrom^2'), symmetry=1, barrier=(6.89033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-731.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.19801,'amu*angstrom^2'), symmetry=1, barrier=(27.5446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19567,'amu*angstrom^2'), symmetry=1, barrier=(27.4908,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-659.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,342.532,343.06],'cm^-1')),
        HinderedRotor(inertia=(0.319234,'amu*angstrom^2'), symmetry=1, barrier=(26.7328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321349,'amu*angstrom^2'), symmetry=1, barrier=(26.7198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.84091,0.00962319,0.00013275,-2.95876e-07,1.88512e-10,-79255.3,11.1078], Tmin=(10,'K'), Tmax=(552.064,'K')), NASAPolynomial(coeffs=[5.48479,0.0325844,-2.43872e-05,8.30075e-09,-1.04673e-12,-79968.2,-0.659247], Tmin=(552.064,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-659.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[O]CC(O)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-499.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.356885,'amu*angstrom^2'), symmetry=1, barrier=(8.2055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06263,'amu*angstrom^2'), symmetry=1, barrier=(24.432,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.61006,0.0322889,7.99049e-05,-3.34792e-07,3.14073e-10,-60075,12.1453], Tmin=(10,'K'), Tmax=(411.43,'K')), NASAPolynomial(coeffs=[6.83583,0.0307088,-2.29122e-05,7.74515e-09,-9.7068e-13,-60592.5,-3.61556], Tmin=(411.43,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-499.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[O]C(F)(F)COF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0959116,'amu*angstrom^2'), symmetry=1, barrier=(2.2052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.63616,'amu*angstrom^2'), symmetry=1, barrier=(14.6266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)COF(1592)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(40.14,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OCOF(1675)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(200.66,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(173)', 'F[C]COF(1735)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.56497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)OF(421)', 'CH2(S)(24)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(66.0576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OC(F)(CF)OF(1730)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(428)', 'C=C(O)F(1736)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(1738)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)COF(1740)'],
    products = ['OC(F)(F)COF(1592)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', '[CH2]C(O)(F)F(1291)'],
    products = ['OC(F)(F)COF(1592)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(239)', '[CH2]OF(1527)'],
    products = ['OC(F)(F)COF(1592)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(568)'],
    products = ['OC(F)(F)COF(1592)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(1741)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(163.249,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(574)'],
    products = ['OC(F)(F)COF(1592)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(445.989,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(178.606,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)
