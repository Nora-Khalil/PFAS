...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(882)'],
    products = ['[O]CC([O])=O(1893)'],
    transitionState = 'TS2',
