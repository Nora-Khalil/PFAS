...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91288,0.0467647,-5.40568e-05,3.09686e-08,-6.99618e-12,27092,17.6804], Tmin=(100,'K'), Tmax=(1076.8,'K')), NASAPolynomial(coeffs=[11.1984,0.012271,-6.00547e-06,1.21852e-09,-8.89737e-14,25092.3,-27.8037], Tmin=(1076.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cd-CdH)(F1s)) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    E0 = (509.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,563.333,586.667,610,1970,2140,137,207,812,180,1590.03,2099.38],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0489,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40434,0.037874,-6.11683e-05,5.05278e-08,-1.59224e-11,61348.6,15.2976], Tmin=(100,'K'), Tmax=(903.897,'K')), NASAPolynomial(coeffs=[7.43482,0.00945004,-3.77258e-06,6.53016e-10,-4.18334e-14,60691,-7.07067], Tmin=(903.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=C=CJ) + radical(Cdj(Cdd-Cdd)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31888,0.041151,-5.95095e-05,5.46631e-08,-2.10568e-11,20323.9,17.1955], Tmin=(100,'K'), Tmax=(726.709,'K')), NASAPolynomial(coeffs=[4.9195,0.0223986,-1.16423e-05,2.3474e-09,-1.68431e-13,20063.1,6.28545], Tmin=(726.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=C(F)C#CF(1847)'],
    products = ['[CH]=C(F)C=[C]F(1836)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(1849)'],
    products = ['[CH]=C(F)C=[C]F(1836)'],
    transitionState = 'TS7',
