...
species(
    label = 'F[CH]C1(F)O[CH]C1(F)F(2876)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.270383,0.0907116,-0.000153857,1.36069e-07,-4.70397e-11,-72701.2,26.2014], Tmin=(100,'K'), Tmax=(814.155,'K')), NASAPolynomial(coeffs=[10.3781,0.0281922,-1.49791e-05,2.94998e-09,-2.0598e-13,-73920.8,-17.8671], Tmin=(814.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-605.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(O2s-Cs-Cs-Cs(F)) + radical(Csj(Cs-F1sF1sCs)(O2s-Cs)(H)_ring) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'F[C](F)C(F)C1(F)[CH]O1(2761)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-525.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2950,1000,190,488,555,1236,1407,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897799,0.0629918,-5.69925e-05,2.42559e-08,-4.05594e-12,-98799.5,18.048], Tmin=(100,'K'), Tmax=(1431.98,'K')), NASAPolynomial(coeffs=[17.4241,0.0168281,-8.63558e-06,1.74289e-09,-1.25513e-13,-103533,-67.6156], Tmin=(1431.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-822.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCCFO) + group(CsCsCsFH) + group(CsCsCsFF) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'O=C[C](F)C(F)(F)[CH]F(2877)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-650.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,234,347,1316,1464,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,250.828,250.954],'cm^-1')),
        HinderedRotor(inertia=(0.147799,'amu*angstrom^2'), symmetry=1, barrier=(6.59944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14819,'amu*angstrom^2'), symmetry=1, barrier=(6.60143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07159,'amu*angstrom^2'), symmetry=1, barrier=(47.4754,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360112,0.0884711,-0.000148957,1.31417e-07,-4.53527e-11,-78116.1,28.3433], Tmin=(100,'K'), Tmax=(816.883,'K')), NASAPolynomial(coeffs=[10.1021,0.0280815,-1.47714e-05,2.89586e-09,-2.01694e-13,-79284.5,-14.0951], Tmin=(816.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CsCOCsF1s) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-182.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,2950,1000,334,575,1197,1424,3202,235,240.667,241.319,982.449,1719.48,1725.86,4000],'cm^-1')),
        HinderedRotor(inertia=(0.642798,'amu*angstrom^2'), symmetry=1, barrier=(25.2804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00273529,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47464,0.0593185,-7.18904e-05,4.55978e-08,-1.17153e-11,-21913.8,24.4686], Tmin=(100,'K'), Tmax=(940.013,'K')), NASAPolynomial(coeffs=[10.5018,0.0209048,-1.05918e-05,2.1235e-09,-1.52962e-13,-23610.9,-18.5237], Tmin=(940.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
"""),
    E0 = (-428.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,467,575,827,1418,2950,1000,194,682,905,1196,1383,3221,180,180,180,180,410.717,1011.38,1011.39,1011.39,1011.39,4000],'cm^-1')),
        HinderedRotor(inertia=(0.934161,'amu*angstrom^2'), symmetry=1, barrier=(21.4782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19216,0.0643897,-7.82608e-05,4.78873e-08,-1.16574e-11,-51378,22.2871], Tmin=(100,'K'), Tmax=(998.233,'K')), NASAPolynomial(coeffs=[12.6307,0.0185532,-9.38218e-06,1.88558e-09,-1.36241e-13,-53661.6,-32.8766], Tmin=(998.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + ring(Cs-Cs(F)-O2s) + radical(CCsJO)"""),
)
...
"""),
    E0 = (-57.3099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,2950,1000,234,589,736,816,1240,3237,718.861,719.647,720.065,720.171,720.223,721.125,721.297],'cm^-1')),
        HinderedRotor(inertia=(0.000325215,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83107,0.0377367,-1.07292e-05,-1.74156e-08,1.0123e-11,-6805.88,21.2151], Tmin=(100,'K'), Tmax=(1000.3,'K')), NASAPolynomial(coeffs=[14.1046,0.0111283,-4.52467e-06,9.0662e-10,-6.87886e-14,-10385.6,-43.6207], Tmin=(1000.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.3099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + ring(Cd(Cd-F)-Cs-O2s) + radical(C=CCJO) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)
...
species(
    label = 'FC(F)C(F)(F)[C]1[CH]O1(2882)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.72299,0.0782999,-0.000115956,9.32281e-08,-3.03267e-11,-70044.3,26.9798], Tmin=(100,'K'), Tmax=(750.301,'K')), NASAPolynomial(coeffs=[10.2646,0.027424,-1.42299e-05,2.82722e-09,-2.00612e-13,-71475.9,-16.3104], Tmin=(750.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-583.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'F[CH][C](F)C1(F)OC1F(2883)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.999369,0.0718834,-9.44259e-05,6.76197e-08,-1.98536e-11,-65183.8,27.6678], Tmin=(100,'K'), Tmax=(823.567,'K')), NASAPolynomial(coeffs=[10.0368,0.0279892,-1.44788e-05,2.90311e-09,-2.08308e-13,-66672.4,-14.1782], Tmin=(823.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C](C(F)F)C1(F)[CH]O1(2790)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.882299,0.0744945,-0.000105888,8.28975e-08,-2.64476e-11,-64368.1,27.9329], Tmin=(100,'K'), Tmax=(762.677,'K')), NASAPolynomial(coeffs=[9.75882,0.027935,-1.43072e-05,2.83682e-09,-2.01467e-13,-65721.9,-12.4855], Tmin=(762.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-536.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(88.2077,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 88.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    products = ['F[CH]C1(F)O[CH]C1(F)F(2876)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33e+08,'s^-1'), n=1.36, Ea=(157.318,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [cCs(-R!HR!H)CJ;CsJ;C]
Euclidian distance = 0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'F[C](F)C1(F)[CH]O1(2672)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    products = ['FC1C2OC2(F)C1(F)F(2765)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)C(F)(F)[CH]F(2877)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C1=CO1(2878)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(15.7698,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C1(F)[CH]O1(2879)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(67.9813,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', 'F[CH]C(F)=C1[CH]O1(2880)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(12.5479,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CHF(86)', 'F[C](F)C1(F)[CH]O1(2672)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    products = ['FC(F)C(F)(F)[C]1[CH]O1(2882)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(199.527,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2759)'],
    products = ['F[CH][C](F)C1(F)OC1F(2883)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(218.527,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
