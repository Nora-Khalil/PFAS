...
"""),
    E0 = (-704.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,3000,3100,440,815,1455,1000,219.432,219.622,219.811],'cm^-1')),
        HinderedRotor(inertia=(0.0034917,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17568,'amu*angstrom^2'), symmetry=1, barrier=(6.01584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497196,'amu*angstrom^2'), symmetry=1, barrier=(17.0517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71561,0.0776349,-0.000118862,9.17966e-08,-2.78797e-11,-84643.3,25.2541], Tmin=(100,'K'), Tmax=(809.673,'K')), NASAPolynomial(coeffs=[12.6398,0.0187288,-9.73647e-06,1.94891e-09,-1.3889e-13,-86574.3,-29.756], Tmin=(809.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666603,0.0818954,-0.000144992,1.29286e-07,-4.41025e-11,-85489.4,25.1686], Tmin=(100,'K'), Tmax=(849.473,'K')), NASAPolynomial(coeffs=[9.90445,0.0223299,-1.1441e-05,2.21011e-09,-1.51656e-13,-86479.2,-14.4796], Tmin=(849.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(F1s)(O2s-Cs)) + radical(CsJOCH3)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    products = ['CH2O(19)', 'CF2CF2(60)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]O[C](F)F(729)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2O(19)', 'F[C](F)[C](F)F(230)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=C(F)F(1928)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](1639)', 'CF2CF2(60)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](1639)', 'F[C](F)[C](F)F(230)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(87)', '[CH2]O[C](F)F(729)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2011)'],
    products = ['[CH2]O[C](F)C(F)(F)F(2028)'],
...
network(
    label = 'PDepNetwork #794',
    isomers = [
        '[CH2]OC(F)(F)[C](F)F(2011)',
    ],
    reactants = [
        ('CH2O(19)', 'CF2CF2(60)'),
    ],
