...
"""),
    E0 = (-270.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,218.775,218.814,218.83],'cm^-1')),
        HinderedRotor(inertia=(0.700822,'amu*angstrom^2'), symmetry=1, barrier=(23.8122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(6.45219e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210588,'amu*angstrom^2'), symmetry=1, barrier=(7.15197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-161.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0076311,'amu*angstrom^2'), symmetry=1, barrier=(2.49092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0855359,'amu*angstrom^2'), symmetry=1, barrier=(27.9133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92891,0.0176099,1.24831e-05,-2.45569e-08,9.44501e-12,-19413.5,15.0279], Tmin=(100,'K'), Tmax=(1028.1,'K')), NASAPolynomial(coeffs=[6.84084,0.016555,-6.64487e-06,1.24791e-09,-8.86336e-14,-20966.5,-7.59411], Tmin=(1028.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""CH3OCH2O""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['COCOF(1613)'],
    products = ['HF(38)', 'CH2O(19)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(44.2749,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'COC=O(1722)'],
    products = ['COCOF(1613)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(496.516,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
