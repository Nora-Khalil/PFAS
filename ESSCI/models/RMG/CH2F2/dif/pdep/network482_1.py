...
"""),
    E0 = (-1039.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,419.92,419.959,419.959,420.002,420.008,1634.7],'cm^-1')),
        HinderedRotor(inertia=(0.0810074,'amu*angstrom^2'), symmetry=1, barrier=(10.1369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342618,'amu*angstrom^2'), symmetry=1, barrier=(42.8821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342575,'amu*angstrom^2'), symmetry=1, barrier=(42.881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43453,0.0603449,-6.32694e-05,3.51633e-08,-8.09641e-12,-124903,22.2959], Tmin=(100,'K'), Tmax=(1029.27,'K')), NASAPolynomial(coeffs=[10.3108,0.0258493,-1.29971e-05,2.60127e-09,-1.87361e-13,-126731,-20.783], Tmin=(1029.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1039.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.194658,'amu*angstrom^2'), symmetry=1, barrier=(4.47557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194424,'amu*angstrom^2'), symmetry=1, barrier=(4.47018,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506139,0.0857953,-0.000147788,1.32337e-07,-4.58694e-11,-65898,24.5145], Tmin=(100,'K'), Tmax=(834.472,'K')), NASAPolynomial(coeffs=[9.34362,0.0274817,-1.42927e-05,2.77901e-09,-1.92124e-13,-66817.5,-13.1943], Tmin=(834.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-548.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'OC(OCF)=C(F)F(1388)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-876.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,182,240,577,636,1210,1413,280.006,280.148,280.742],'cm^-1')),
        HinderedRotor(inertia=(0.325634,'amu*angstrom^2'), symmetry=1, barrier=(18.2039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328175,'amu*angstrom^2'), symmetry=1, barrier=(18.2084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326998,'amu*angstrom^2'), symmetry=1, barrier=(18.2079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694441,0.0745053,-9.49497e-05,6.00801e-08,-1.49169e-11,-105341,22.657], Tmin=(100,'K'), Tmax=(986.831,'K')), NASAPolynomial(coeffs=[14.7288,0.0176197,-8.48374e-06,1.66764e-09,-1.19075e-13,-108111,-44.8647], Tmin=(986.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-876.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)(F)CF(1389)',
...
"""),
    E0 = (-642.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,1380,1390,370,380,2900,435,180,180,180,1498.32],'cm^-1')),
        HinderedRotor(inertia=(0.141502,'amu*angstrom^2'), symmetry=1, barrier=(3.25341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141305,'amu*angstrom^2'), symmetry=1, barrier=(3.24887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906439,0.0817377,-0.000153387,1.54367e-07,-5.87207e-11,-77160.1,26.4098], Tmin=(100,'K'), Tmax=(832.36,'K')), NASAPolynomial(coeffs=[3.35437,0.0392222,-2.13517e-05,4.22898e-09,-2.95363e-13,-76502.3,21.4482], Tmin=(832.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)C(F)(F)[CH]F(1390)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-668.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,334,575,1197,1424,3202,180,180,1969.37],'cm^-1')),
        HinderedRotor(inertia=(0.221922,'amu*angstrom^2'), symmetry=1, barrier=(5.10243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221783,'amu*angstrom^2'), symmetry=1, barrier=(5.09924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221485,'amu*angstrom^2'), symmetry=1, barrier=(5.09239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519425,0.0907342,-0.000174041,1.68898e-07,-6.14998e-11,-80329.4,28.7683], Tmin=(100,'K'), Tmax=(852.149,'K')), NASAPolynomial(coeffs=[5.92307,0.0338073,-1.82775e-05,3.57392e-09,-2.4635e-13,-80104.4,10.2873], Tmin=(852.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'O[C](O)C(F)(F)[CH]F(1391)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-689.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,215,315,519,588,595,1205,1248,360,370,350,334,575,1197,1424,3202,303.244,1941.01],'cm^-1')),
        HinderedRotor(inertia=(0.135107,'amu*angstrom^2'), symmetry=1, barrier=(8.83139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135236,'amu*angstrom^2'), symmetry=1, barrier=(8.83199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135251,'amu*angstrom^2'), symmetry=1, barrier=(8.83421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135524,'amu*angstrom^2'), symmetry=1, barrier=(8.82734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209711,0.0940106,-0.00017135,1.54708e-07,-5.31053e-11,-82775.4,29.0156], Tmin=(100,'K'), Tmax=(855.248,'K')), NASAPolynomial(coeffs=[10.4252,0.0250665,-1.33069e-05,2.57578e-09,-1.76256e-13,-83748.7,-14.1451], Tmin=(855.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-672.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,234,347,1316,1464,435.764,435.95,435.955,436.028,436.168,1772.18],'cm^-1')),
        HinderedRotor(inertia=(0.319289,'amu*angstrom^2'), symmetry=1, barrier=(43.0787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373939,'amu*angstrom^2'), symmetry=1, barrier=(50.338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23261,'amu*angstrom^2'), symmetry=1, barrier=(31.3372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83866,0.0471033,-3.97137e-05,1.68486e-08,-2.9232e-12,-80808.6,20.7456], Tmin=(100,'K'), Tmax=(1343.23,'K')), NASAPolynomial(coeffs=[10.9317,0.0200252,-9.47521e-06,1.84075e-09,-1.29966e-13,-83251.4,-25.8061], Tmin=(1343.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = '[CH2]C(F)(F)C(=O)O(1393)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-654.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,249,341,381,651,928,1217,1251,3000,3100,440,815,1455,1000,180,180,180,700.694,700.811],'cm^-1')),
        HinderedRotor(inertia=(0.00809579,'amu*angstrom^2'), symmetry=1, barrier=(2.82137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00809908,'amu*angstrom^2'), symmetry=1, barrier=(2.82104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28479,'amu*angstrom^2'), symmetry=1, barrier=(52.5318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56887,0.0586722,-7.51902e-05,5.42167e-08,-1.62904e-11,-78600.4,21.6443], Tmin=(100,'K'), Tmax=(800.464,'K')), NASAPolynomial(coeffs=[8.17729,0.0256484,-1.33047e-05,2.67405e-09,-1.92208e-13,-79658.3,-8.76656], Tmin=(800.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    E0 = (-813.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,180,762.465,762.713,762.715],'cm^-1')),
        HinderedRotor(inertia=(0.00463256,'amu*angstrom^2'), symmetry=1, barrier=(1.91234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129629,'amu*angstrom^2'), symmetry=1, barrier=(53.5196,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48317,0.0615386,-9.07807e-05,8.28248e-08,-3.15423e-11,-97761.9,22.2743], Tmin=(100,'K'), Tmax=(734.911,'K')), NASAPolynomial(coeffs=[5.59667,0.0323253,-1.72257e-05,3.46482e-09,-2.47628e-13,-98182.2,4.94977], Tmin=(734.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-451.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,288,410,724,839,1320,2950,3100,1380,975,1025,1650,318.585,318.739,1613.47,1613.48,1613.5],'cm^-1')),
        HinderedRotor(inertia=(0.114778,'amu*angstrom^2'), symmetry=1, barrier=(8.27989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115066,'amu*angstrom^2'), symmetry=1, barrier=(8.28049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'O=C(O)[C]F(447)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C(O)C(F)(F)[C]F(926)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(O)C(F)F(163)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(22.0857,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(24)', 'O=C(O)C(F)(F)F(616)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(173)', 'O=C=C(F)CF(818)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(1390)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(1391)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(1392)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(1393)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(F)(F)CF(826)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)CF(825)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(45)', 'O=C(O)[C](F)F(454)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(164)', 'CH2F-CF2(67)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[CH]F(932)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'C=C(F)C(=O)O(1394)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=CF(933)'],
    products = ['O=C(O)C(F)(F)CF(1315)'],
