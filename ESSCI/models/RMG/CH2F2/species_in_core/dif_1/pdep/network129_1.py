...
"""),
    E0 = (19.8123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,594.039,594.079,594.131,594.16,594.182,2310.87],'cm^-1')),
        HinderedRotor(inertia=(0.000477884,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000477756,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000477439,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59909,0.0206996,6.95683e-06,-3.52809e-08,1.82435e-11,2442.75,19.1344], Tmin=(100,'K'), Tmax=(914.133,'K')), NASAPolynomial(coeffs=[14.2683,-0.00369158,3.21745e-06,-6.38039e-10,4.08314e-14,-805.012,-42.21], Tmin=(914.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.8123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(O2sFO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90147,0.0386572,-2.69936e-05,-1.01066e-09,5.29072e-12,-10843.6,24.3536], Tmin=(100,'K'), Tmax=(959.712,'K')), NASAPolynomial(coeffs=[14.3174,0.00453944,-1.22476e-06,2.30881e-10,-1.90702e-14,-14038.6,-39.2655], Tmin=(959.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.8431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(10)', '[O]OC(F)F(128)'],
    products = ['OOOOC(F)F(327)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OOOO(166)', 'CF2(89)'],
    products = ['OOOOC(F)F(327)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(67.7731,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OOOOF(403)', 'CHF(88)'],
    products = ['OOOOC(F)F(327)'],
    transitionState = 'TS3',
