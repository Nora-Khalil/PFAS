...
"""),
    E0 = (-507.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,261,493,600,1152,1365,1422,3097,2750,2850,1437.5,1250,1305,750,350,323.598,323.985],'cm^-1')),
        HinderedRotor(inertia=(0.133692,'amu*angstrom^2'), symmetry=1, barrier=(9.94531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.356717,'amu*angstrom^2'), symmetry=1, barrier=(26.5824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133538,'amu*angstrom^2'), symmetry=1, barrier=(9.94974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0488,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70742,0.053405,-6.17136e-05,3.8123e-08,-9.60679e-12,-60970.1,19.1024], Tmin=(100,'K'), Tmax=(955.334,'K')), NASAPolynomial(coeffs=[9.59363,0.0203849,-9.86719e-06,1.9423e-09,-1.38597e-13,-62476.9,-18.5836], Tmin=(955.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-507.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsHH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88071,0.0254385,-2.53337e-05,1.48259e-08,-3.65563e-12,-9452.08,14.087], Tmin=(100,'K'), Tmax=(964.977,'K')), NASAPolynomial(coeffs=[5.99227,0.0125404,-5.2841e-06,9.74207e-10,-6.69771e-14,-10052.6,-0.813519], Tmin=(964.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.9184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-505.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.330884,'amu*angstrom^2'), symmetry=1, barrier=(7.60766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42474,'amu*angstrom^2'), symmetry=1, barrier=(32.7577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.732801,'amu*angstrom^2'), symmetry=1, barrier=(16.8485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0488,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70217,0.0253304,0.000116951,-4.48965e-07,4.51314e-10,-60782.6,11.3217], Tmin=(10,'K'), Tmax=(362.452,'K')), NASAPolynomial(coeffs=[5.38384,0.0329445,-2.28763e-05,7.45134e-09,-9.1534e-13,-61076.5,2.54368], Tmin=(362.452,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-505.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""OC(CF)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-107.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,191.491,194.428],'cm^-1')),
        HinderedRotor(inertia=(0.724733,'amu*angstrom^2'), symmetry=1, barrier=(19.3916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713913,'amu*angstrom^2'), symmetry=1, barrier=(19.4166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722319,'amu*angstrom^2'), symmetry=1, barrier=(19.377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856582,0.0547087,-5.97811e-05,2.96162e-08,-5.40692e-12,-12766,20.8845], Tmin=(100,'K'), Tmax=(1536.38,'K')), NASAPolynomial(coeffs=[18.4925,0.000603391,1.03883e-06,-2.44372e-10,1.65541e-14,-17218.5,-68.6265], Tmin=(1536.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)
...
"""),
    E0 = (-418.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(1.21744,'amu*angstrom^2'), symmetry=1, barrier=(27.9913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2193,'amu*angstrom^2'), symmetry=1, barrier=(28.034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.88086,0.00657758,0.00011217,-2.13752e-07,1.17511e-10,-50342.5,10.1764], Tmin=(10,'K'), Tmax=(629.765,'K')), NASAPolynomial(coeffs=[4.12837,0.0350615,-2.72626e-05,9.63428e-09,-1.25128e-12,-50969.7,4.36465], Tmin=(629.765,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-418.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[O]C(F)CO""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-283.423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,2750,2850,1437.5,1250,1305,750,350,212.676,212.705,1715.25],'cm^-1')),
        HinderedRotor(inertia=(0.719797,'amu*angstrom^2'), symmetry=1, barrier=(22.9464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00827,'amu*angstrom^2'), symmetry=1, barrier=(32.2247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.639901,'amu*angstrom^2'), symmetry=1, barrier=(14.7126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277426,'amu*angstrom^2'), symmetry=1, barrier=(6.37857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27529,'amu*angstrom^2'), symmetry=1, barrier=(6.32945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38838,0.0642805,-0.00011117,9.94638e-08,-3.42524e-11,-37563.2,21.0386], Tmin=(100,'K'), Tmax=(847.334,'K')), NASAPolynomial(coeffs=[7.92869,0.0203694,-1.03586e-05,1.99005e-09,-1.36378e-13,-38203.6,-6.66961], Tmin=(847.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-596.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,226.326],'cm^-1')),
        HinderedRotor(inertia=(0.686674,'amu*angstrom^2'), symmetry=1, barrier=(25.0435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.687969,'amu*angstrom^2'), symmetry=1, barrier=(25.0482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OCC(F)OF(1600)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(34.803,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OF(173)', 'OC[C]F-2(1433)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OCOF(1675)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(128.327,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(24)', 'OC(F)OF(468)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(70.1605,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OC(CF)OF(1742)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(228)', 'OC[CH]F(1746)'],
    products = ['OCC(F)OF(1600)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', '[CH2]C(F)OF(1459)'],
    products = ['OCC(F)OF(1600)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(295)', 'CH2OH(33)'],
    products = ['OCC(F)OF(1600)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O[CH]C(F)OF(584)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(0.653538,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['F2(77)', 'O=CCO(1748)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(73.743,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)CO(1643)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(486.226,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC=COF(592)'],
    products = ['OCC(F)OF(1600)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(258.251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #673',
    isomers = [
        'OCC(F)OF(1600)',
    ],
    reactants = [
        ('HF(38)', 'CHFO(46)', 'CH2O(19)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
