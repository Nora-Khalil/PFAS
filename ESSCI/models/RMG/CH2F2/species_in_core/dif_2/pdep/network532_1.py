...
"""),
    E0 = (-735.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,387.759,387.76,387.762,387.762,387.762,1650.03],'cm^-1')),
        HinderedRotor(inertia=(0.0914353,'amu*angstrom^2'), symmetry=1, barrier=(9.75595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392324,'amu*angstrom^2'), symmetry=1, barrier=(41.8598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392316,'amu*angstrom^2'), symmetry=1, barrier=(41.8598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44075,0.0616815,-6.63106e-05,3.8593e-08,-9.44222e-12,-88408.1,21.0452], Tmin=(100,'K'), Tmax=(964.696,'K')), NASAPolynomial(coeffs=[9.43114,0.0285506,-1.4796e-05,2.99347e-09,-2.16726e-13,-89949.7,-17.2167], Tmin=(964.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.260451,'amu*angstrom^2'), symmetry=1, barrier=(5.98827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260521,'amu*angstrom^2'), symmetry=1, barrier=(5.98989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260411,'amu*angstrom^2'), symmetry=1, barrier=(5.98736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.671801,0.0894301,-0.000176469,1.77169e-07,-6.6021e-11,-27065.1,24.3911], Tmin=(100,'K'), Tmax=(854.871,'K')), NASAPolynomial(coeffs=[3.49,0.0384686,-2.07679e-05,4.05648e-09,-2.79362e-13,-26166.6,19.31], Tmin=(854.871,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'COC(OF)=C(F)F(1322)',
...
"""),
    E0 = (-504.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,197.27,197.504,2207.75],'cm^-1')),
        HinderedRotor(inertia=(0.304497,'amu*angstrom^2'), symmetry=1, barrier=(8.49827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00428264,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34039,'amu*angstrom^2'), symmetry=1, barrier=(36.9471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735688,0.0803698,-0.00013503,1.22317e-07,-4.33522e-11,-60590.5,23.3601], Tmin=(100,'K'), Tmax=(818.794,'K')), NASAPolynomial(coeffs=[8.03253,0.029954,-1.5614e-05,3.05773e-09,-2.13035e-13,-61290.3,-7.36091], Tmin=(818.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[CH2]C(F)(F)C([O])OF(1323)',
...
"""),
    E0 = (-352.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,180,1905.05],'cm^-1')),
        HinderedRotor(inertia=(0.225546,'amu*angstrom^2'), symmetry=1, barrier=(5.18576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22535,'amu*angstrom^2'), symmetry=1, barrier=(5.18124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34512,'amu*angstrom^2'), symmetry=1, barrier=(30.927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.426912,0.0889467,-0.000157429,1.45557e-07,-5.21175e-11,-42283.1,28.3658], Tmin=(100,'K'), Tmax=(819.36,'K')), NASAPolynomial(coeffs=[8.49996,0.0308483,-1.68587e-05,3.34868e-09,-2.3457e-13,-42978.8,-5.14577], Tmin=(819.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)[C](O)OF(1324)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-373.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,215,315,519,588,595,1205,1248,360,370,350,3000,3100,440,815,1455,1000,192.605,192.608],'cm^-1')),
        HinderedRotor(inertia=(0.199489,'amu*angstrom^2'), symmetry=1, barrier=(5.25154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00246082,'amu*angstrom^2'), symmetry=1, barrier=(27.9403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.491851,'amu*angstrom^2'), symmetry=1, barrier=(12.948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06137,'amu*angstrom^2'), symmetry=1, barrier=(27.9403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143301,0.0918849,-0.000153403,1.29399e-07,-4.27686e-11,-44730.2,29.2146], Tmin=(100,'K'), Tmax=(793.791,'K')), NASAPolynomial(coeffs=[12.9369,0.022225,-1.19588e-05,2.36773e-09,-1.65934e-13,-46597.7,-28.5223], Tmin=(793.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    E0 = (-363.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,234,347,1316,1464,421.115,421.115,421.116,421.117,421.119,421.119],'cm^-1')),
        HinderedRotor(inertia=(0.000950607,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38955,'amu*angstrom^2'), symmetry=1, barrier=(49.0222,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389543,'amu*angstrom^2'), symmetry=1, barrier=(49.0222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9147,0.0477244,-4.05023e-05,1.74826e-08,-3.13905e-12,-43688.8,19.3359], Tmin=(100,'K'), Tmax=(1281.44,'K')), NASAPolynomial(coeffs=[9.95707,0.0226199,-1.11155e-05,2.19388e-09,-1.56281e-13,-45749.9,-21.4581], Tmin=(1281.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = 'CC(F)(F)C([O])=O(1326)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-644.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,625.985,634.626,640.976,646.658],'cm^-1')),
        HinderedRotor(inertia=(0.00867204,'amu*angstrom^2'), symmetry=1, barrier=(2.58381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00883164,'amu*angstrom^2'), symmetry=1, barrier=(2.52634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92181,0.0511354,-6.97917e-05,6.55678e-08,-2.63274e-11,-77457.6,19.2935], Tmin=(100,'K'), Tmax=(733.155,'K')), NASAPolynomial(coeffs=[3.79002,0.0332133,-1.73097e-05,3.46533e-09,-2.47502e-13,-77523.8,12.2771], Tmin=(733.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-644.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(85)', 'O=C([C]F)OF(832)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(72)', 'O=C(OF)C(F)F(1270)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'CC(F)=C=O(1320)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1323)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1324)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1325)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1326)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'CC(F)(F)[C]=O(1327)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(67)', 'O=C(OF)[C](F)F(840)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(190)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(1278)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(1282)'],
    products = ['CC(F)(F)C(=O)OF(1317)'],
