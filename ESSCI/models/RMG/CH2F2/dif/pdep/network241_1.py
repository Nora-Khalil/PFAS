...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(1106)'],
    products = ['FC1(F)OC1(F)F(671)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', 'FC1=C(F)O1(1108)'],
    products = ['FC1(F)OC1(F)F(671)'],
    transitionState = 'TS6',
