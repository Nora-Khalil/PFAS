...
"""),
    E0 = (-679.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([234,347,1316,1464,190,488,555,1236,1407,611,648,830,1210,1753,213.168,213.272],'cm^-1')),
        HinderedRotor(inertia=(0.31108,'amu*angstrom^2'), symmetry=1, barrier=(10.0173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44409,'amu*angstrom^2'), symmetry=1, barrier=(46.6917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2861,0.0654743,-0.000109962,9.59815e-08,-3.3175e-11,-81604.5,24.1634], Tmin=(100,'K'), Tmax=(762.349,'K')), NASAPolynomial(coeffs=[9.40925,0.0188766,-1.0453e-05,2.1204e-09,-1.5125e-13,-82727.5,-12.0641], Tmin=(762.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0751046,0.0974781,-0.000181405,1.65119e-07,-5.71618e-11,-112128,29.1971], Tmin=(100,'K'), Tmax=(842.357,'K')), NASAPolynomial(coeffs=[11.1138,0.0241091,-1.34475e-05,2.66601e-09,-1.85079e-13,-113244,-17.7526], Tmin=(842.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-933.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504763,0.0836448,-0.00013899,1.18603e-07,-3.98324e-11,-112656,28.2635], Tmin=(100,'K'), Tmax=(782.148,'K')), NASAPolynomial(coeffs=[11.5917,0.0221402,-1.18228e-05,2.3572e-09,-1.66294e-13,-114243,-21.5609], Tmin=(782.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-937.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sF1s)(H))"""),
)

species(
    label = 'FO[C](F)C(F)[C](F)F(771)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.316951,'amu*angstrom^2'), symmetry=1, barrier=(7.28733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139965,'amu*angstrom^2'), symmetry=1, barrier=(3.21807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10111,'amu*angstrom^2'), symmetry=1, barrier=(48.3086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283964,0.0933066,-0.000173262,1.61853e-07,-5.78222e-11,-67412.6,28.9923], Tmin=(100,'K'), Tmax=(826.958,'K')), NASAPolynomial(coeffs=[9.1922,0.0284174,-1.60183e-05,3.21055e-09,-2.25255e-13,-68140.5,-7.78528], Tmin=(826.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)C(F)(F)F(772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248978,0.0967532,-0.000189438,1.79808e-07,-6.36895e-11,-109405,26.5707], Tmin=(100,'K'), Tmax=(862.659,'K')), NASAPolynomial(coeffs=[8.29273,0.0280239,-1.52767e-05,2.9787e-09,-2.03859e-13,-109623,-4.26866], Tmin=(862.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-910.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sCsH)(F1s)(O2s-H))"""),
)
...
reaction(
    ...
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C(F)[C](F)F(761)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)(F)C=C(F)F(763)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=C(F)F(764)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)C(F)[C](F)F(650)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', 'O=C(F)[CH][C](F)F(765)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[C](F)F(766)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FOC(F)(F)[CH][C](F)F(769)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    products = ['[O]C(F)(F)[CH]C(F)(F)F(770)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FO[C](F)C(F)[C](F)F(771)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(699)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(699)'],
    products = ['[O][C](F)C(F)C(F)(F)F(772)'],
...
network(
    label = 'PDepNetwork #284',
    isomers = [
        '[O]C(F)(F)C(F)[C](F)F(699)',
    ],
    reactants = [
        ('CF2O(48)', 'CHFCF2(54)'),
    ],
