...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.16238,'amu*angstrom^2'), symmetry=1, barrier=(49.7173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25004,'amu*angstrom^2'), symmetry=1, barrier=(51.7329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548272,'amu*angstrom^2'), symmetry=1, barrier=(12.6058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804201,0.0772903,-0.000137211,1.19696e-07,-4.02013e-11,-70787.4,22.8645], Tmin=(100,'K'), Tmax=(827.661,'K')), NASAPolynomial(coeffs=[11.2103,0.0168518,-9.28568e-06,1.84223e-09,-1.28383e-13,-72162.4,-23.2708], Tmin=(827.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-589.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]O[C](F)F(171)'],
    products = ['F[C](F)OO[C](F)F(255)'],
    transitionState = 'TS2',
