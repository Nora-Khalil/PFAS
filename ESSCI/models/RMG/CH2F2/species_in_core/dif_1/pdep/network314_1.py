...
"""),
    E0 = (-1252.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,482,664,788,1296,1923,180,180,1673.59],'cm^-1')),
        HinderedRotor(inertia=(0.585354,'amu*angstrom^2'), symmetry=1, barrier=(13.4584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42775,'amu*angstrom^2'), symmetry=1, barrier=(32.8268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04464,'amu*angstrom^2'), symmetry=1, barrier=(24.0183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-763.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,451,553,637,1069,1180,1265,1301,3056,180,180,2053.87],'cm^-1')),
        HinderedRotor(inertia=(0.531695,'amu*angstrom^2'), symmetry=1, barrier=(12.2247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2695,'amu*angstrom^2'), symmetry=1, barrier=(29.1883,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43774,0.0564224,-6.37771e-05,3.53022e-08,-7.70511e-12,-91788.6,24.4759], Tmin=(100,'K'), Tmax=(1113.29,'K')), NASAPolynomial(coeffs=[13.1112,0.0144801,-7.26586e-06,1.4619e-09,-1.05941e-13,-94387.8,-33.0948], Tmin=(1113.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFFOO) + group(CsFHOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[O]C(F)(F)O[C](O)F(845)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-814.641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,486,586,623,710,938,1161,1294,482,586,761,1411,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.824007,'amu*angstrom^2'), symmetry=1, barrier=(18.9455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00678141,'amu*angstrom^2'), symmetry=1, barrier=(4.19208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34053,'amu*angstrom^2'), symmetry=1, barrier=(30.8213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10429,0.0616333,-7.28124e-05,4.07155e-08,-8.80536e-12,-97872.6,26.0069], Tmin=(100,'K'), Tmax=(1135.69,'K')), NASAPolynomial(coeffs=[15.6216,0.0105014,-5.27761e-06,1.07118e-09,-7.83498e-14,-101170,-45.8779], Tmin=(1135.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-814.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFFOO) + group(CsFHOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    E0 = (-833.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0452637,'amu*angstrom^2'), symmetry=1, barrier=(14.7841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24956,'amu*angstrom^2'), symmetry=1, barrier=(51.7217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24682,'amu*angstrom^2'), symmetry=1, barrier=(51.6587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83978,0.0501089,-6.0458e-05,3.6899e-08,-9.02461e-12,-100176,19.1733], Tmin=(100,'K'), Tmax=(989.639,'K')), NASAPolynomial(coeffs=[10.3835,0.0155779,-8.1217e-06,1.64451e-09,-1.19144e-13,-101867,-21.9567], Tmin=(989.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-833.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-819.192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,482,664,788,1296,1923,180,187.772,1527.66],'cm^-1')),
        HinderedRotor(inertia=(0.731768,'amu*angstrom^2'), symmetry=1, barrier=(16.8248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25608,'amu*angstrom^2'), symmetry=1, barrier=(28.8798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-986.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,482,664,788,1296,1923,180,507.997,1772.06],'cm^-1')),
        HinderedRotor(inertia=(1.18989,'amu*angstrom^2'), symmetry=1, barrier=(27.358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18989,'amu*angstrom^2'), symmetry=1, barrier=(27.3578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58758,0.0494797,-5.13016e-05,2.49171e-08,-4.70326e-12,-118508,23.031], Tmin=(100,'K'), Tmax=(1289.33,'K')), NASAPolynomial(coeffs=[14.3697,0.0098245,-5.16681e-06,1.06231e-09,-7.78199e-14,-121804,-41.8834], Tmin=(1289.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-986.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(COFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.524903,'amu*angstrom^2'), symmetry=1, barrier=(12.0685,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93424,0.0478336,-6.8728e-05,4.70907e-08,-1.25299e-11,-111768,21.2342], Tmin=(100,'K'), Tmax=(925.17,'K')), NASAPolynomial(coeffs=[11.0591,0.00838021,-4.75863e-06,9.93177e-10,-7.29084e-14,-113456,-22.0781], Tmin=(925.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-929.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(COFOO) + group(COFOO)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(F)O[C](O)F(846)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(847)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(143)', 'O[C](F)F(220)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(50)', '[O]C(O)(F)F(257)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(4)', 'O=C(F)O[C](F)F(363)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(F)OC(=O)F(469)'],
    products = ['O=C(F)OC(O)(F)F(806)'],
