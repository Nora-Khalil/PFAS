...
"""),
    E0 = (223.079,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,3120,650,792.5,1650,269.563,269.701,269.706,1162.25,2270.43],'cm^-1')),
        HinderedRotor(inertia=(0.00231807,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00232127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18797,0.0423883,-6.2038e-05,4.72555e-08,-1.42633e-11,26893.1,22.1649], Tmin=(100,'K'), Tmax=(813.251,'K')), NASAPolynomial(coeffs=[8.39509,0.0118605,-5.73497e-06,1.10403e-09,-7.69089e-14,25883.4,-6.49814], Tmin=(813.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.006,0.0515445,-0.000104343,9.71543e-08,-3.3159e-11,19053.1,15.8309], Tmin=(100,'K'), Tmax=(897.332,'K')), NASAPolynomial(coeffs=[7.11377,0.0105563,-5.3704e-06,9.95749e-10,-6.48121e-14,18870,-4.17054], Tmin=(897.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (377.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,542.382,730.524,730.528,730.549],'cm^-1')),
        HinderedRotor(inertia=(0.645493,'amu*angstrom^2'), symmetry=1, barrier=(14.8412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55755,'amu*angstrom^2'), symmetry=1, barrier=(35.811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0274,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28701,0.0328616,-3.85595e-05,2.13391e-08,-4.43264e-12,45450.5,17.8912], Tmin=(100,'K'), Tmax=(1297.89,'K')), NASAPolynomial(coeffs=[11.2255,0.00250284,-2.24379e-07,-2.0662e-11,3.1232e-15,43367,-26.6503], Tmin=(1297.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsOs) + group(O2s-OsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (575.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,1685,370,3120,650,792.5,1650,180,531.637,3320.67],'cm^-1')),
        HinderedRotor(inertia=(0.110593,'amu*angstrom^2'), symmetry=1, barrier=(22.2453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0148311,'amu*angstrom^2'), symmetry=1, barrier=(2.96787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176466,'amu*angstrom^2'), symmetry=1, barrier=(34.9696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09116,0.0416782,-5.21714e-05,3.1708e-08,-7.47853e-12,69342.2,25.144], Tmin=(100,'K'), Tmax=(1043.3,'K')), NASAPolynomial(coeffs=[10.8906,0.00794034,-3.66343e-06,7.10553e-10,-5.05791e-14,67506.2,-17.6808], Tmin=(1043.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2sFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[O]OO[C]=CF(2690)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OO[O](2611)'],
    products = ['O2(2)', 'FC1=CO1(390)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.60331e+13,'s^-1'), n=-0.0568549, Ea=(88.8943,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2OO;Y_rad_intra;OO_intra] for rate rule [R2OO_D;Cd_pri_rad_in;OO_intra]
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C(F)O[O](787)'],
    products = ['[CH]=C(F)OO[O](2611)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.67697e+10,'s^-1'), n=0.54, Ea=(107.243,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnOO;Y_rad_intra;OOJ] + [R3OO;Y_rad_intra;OO] for rate rule [R3OO;Cd_pri_rad_in;OOJ]
Euclidian distance = 2.23606797749979
family: Cyclic_Ether_Formation"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]OOOF(2689)'],
    products = ['[CH]=C(F)OO[O](2611)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(66.9995,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(F)OO[O](2611)'],
    products = ['[O]OO[C]=CF(2690)'],
