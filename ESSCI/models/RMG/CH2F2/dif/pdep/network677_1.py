...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.893637,'amu*angstrom^2'), symmetry=1, barrier=(20.5465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893197,'amu*angstrom^2'), symmetry=1, barrier=(20.5364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893122,'amu*angstrom^2'), symmetry=1, barrier=(20.5346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-394.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,2750,2850,1437.5,1250,1305,750,350,617,898,1187,217.128,217.13,217.171,217.18,2048.34],'cm^-1')),
        HinderedRotor(inertia=(0.349837,'amu*angstrom^2'), symmetry=1, barrier=(11.7091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350035,'amu*angstrom^2'), symmetry=1, barrier=(11.709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.886389,'amu*angstrom^2'), symmetry=1, barrier=(29.665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705994,0.0792247,-0.000131238,1.13442e-07,-3.87257e-11,-47351.8,24.7434], Tmin=(100,'K'), Tmax=(788.748,'K')), NASAPolynomial(coeffs=[10.3797,0.023515,-1.26429e-05,2.51129e-09,-1.76676e-13,-48670.9,-18.3193], Tmin=(788.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-774.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,180,2377],'cm^-1')),
        HinderedRotor(inertia=(0.529917,'amu*angstrom^2'), symmetry=1, barrier=(12.1838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11483,'amu*angstrom^2'), symmetry=1, barrier=(25.6322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.03,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27775,'amu*angstrom^2'), symmetry=1, barrier=(29.378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27699,'amu*angstrom^2'), symmetry=1, barrier=(29.3606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.274,'amu*angstrom^2'), symmetry=1, barrier=(29.2918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.998578,'amu*angstrom^2'), symmetry=1, barrier=(22.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0949617,'amu*angstrom^2'), symmetry=1, barrier=(2.18336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432534,'amu*angstrom^2'), symmetry=1, barrier=(9.9448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-379.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,1896.89],'cm^-1')),
        HinderedRotor(inertia=(0.349903,'amu*angstrom^2'), symmetry=1, barrier=(8.04497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348295,'amu*angstrom^2'), symmetry=1, barrier=(8.00798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0393,'amu*angstrom^2'), symmetry=1, barrier=(23.8955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    E0 = (-638.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,394.165,399.198,400.569],'cm^-1')),
        HinderedRotor(inertia=(0.00110048,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108325,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.979588,'amu*angstrom^2'), symmetry=1, barrier=(22.5226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980483,'amu*angstrom^2'), symmetry=1, barrier=(22.5432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981038,'amu*angstrom^2'), symmetry=1, barrier=(22.556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.290269,0.0859414,-0.000119467,8.11695e-08,-2.1574e-11,-69290.6,24.1702], Tmin=(100,'K'), Tmax=(923.693,'K')), NASAPolynomial(coeffs=[15.89,0.0183876,-9.76535e-06,1.99329e-09,-1.44765e-13,-72172.4,-49.8513], Tmin=(923.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'F[CH]C(F)(F)COF(1778)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.485658,'amu*angstrom^2'), symmetry=1, barrier=(11.1662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485297,'amu*angstrom^2'), symmetry=1, barrier=(11.1579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.482688,'amu*angstrom^2'), symmetry=1, barrier=(11.0979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    E0 = (-401.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,323,467,575,827,1418,3010,987.5,1337.5,450,1655,180,1039.24],'cm^-1')),
        HinderedRotor(inertia=(0.358871,'amu*angstrom^2'), symmetry=1, barrier=(8.25114,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'FCCOF(1770)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]COF(1735)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(24)', 'FCC(F)(F)OF(814)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'F[C]C(F)(F)COF(1771)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOCC(F)F(1355)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(24)', 'FOCC(F)(F)F(1772)'],
    products = ['FCC(F)(F)COF(1604)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(428)', 'C=C(F)CF(1774)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(1775)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(1776)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(1777)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(228)', '[CH2]C(F)(F)CF(1416)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(1527)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(45)', 'FOC[C](F)F(1739)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FCC(F)(F)[CH]OF(1052)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)COF(1778)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'C=C(F)COF(1779)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FCC(F)=COF(1058)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)COF(1780)'],
    products = ['FCC(F)(F)COF(1604)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)COF(1604)'],
    products = ['F2(77)', 'CH2O(19)', 'CH2CF2(56)'],
