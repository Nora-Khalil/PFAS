...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.190786,'amu*angstrom^2'), symmetry=1, barrier=(4.38654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190765,'amu*angstrom^2'), symmetry=1, barrier=(4.38606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.877625,'amu*angstrom^2'), symmetry=1, barrier=(20.1783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79262,0.0520774,-6.36775e-05,4.43461e-08,-1.27965e-11,3902.11,20.4157], Tmin=(100,'K'), Tmax=(835.458,'K')), NASAPolynomial(coeffs=[7.95461,0.0225736,-1.07032e-05,2.07232e-09,-1.45967e-13,2872.55,-8.20423], Tmin=(835.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.8091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-158.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,243.783,245.24,1166.61],'cm^-1')),
        HinderedRotor(inertia=(0.148938,'amu*angstrom^2'), symmetry=1, barrier=(6.47115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153258,'amu*angstrom^2'), symmetry=1, barrier=(6.55619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780053,'amu*angstrom^2'), symmetry=1, barrier=(32.869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-474.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,251.544,251.605,251.82],'cm^-1')),
        HinderedRotor(inertia=(0.157577,'amu*angstrom^2'), symmetry=1, barrier=(7.10114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157795,'amu*angstrom^2'), symmetry=1, barrier=(7.10266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
"""),
    E0 = (-376.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,180,180,1712.19],'cm^-1')),
        HinderedRotor(inertia=(0.24974,'amu*angstrom^2'), symmetry=1, barrier=(5.74202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.881032,'amu*angstrom^2'), symmetry=1, barrier=(20.2567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249758,'amu*angstrom^2'), symmetry=1, barrier=(5.74243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['OF(153)', 'C=CC(F)F(2325)'],
    products = ['FOCCC(F)F(2182)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(154)', '[CH2]CC(F)F(2368)'],
    products = ['FOCCC(F)F(2182)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(1634)', 'CHF2-CH2(63)'],
    products = ['FOCCC(F)F(2182)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', '[CH2]COF(2369)'],
    products = ['FOCCC(F)F(2182)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(2326)'],
    products = ['FOCCC(F)F(2182)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(2232)'],
    products = ['FOCCC(F)F(2182)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CCC(F)F(1972)'],
    products = ['FOCCC(F)F(2182)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOCCC(F)F(2182)'],
    products = ['F2(106)', 'CH2O(19)', 'CH2CHF(94)'],
