...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.39753,'amu*angstrom^2'), symmetry=1, barrier=(9.14,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77128,0.0580337,-0.000110663,1.05771e-07,-3.75987e-11,-27970.8,20.3106], Tmin=(100,'K'), Tmax=(874.09,'K')), NASAPolynomial(coeffs=[5.5126,0.0201695,-1.00883e-05,1.91315e-09,-1.29079e-13,-27832.5,7.29722], Tmin=(874.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)O[O](431)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34553,'amu*angstrom^2'), symmetry=1, barrier=(30.9365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15773,0.0721048,-0.000132544,1.25997e-07,-4.58412e-11,-34171.8,23.5803], Tmin=(100,'K'), Tmax=(827.181,'K')), NASAPolynomial(coeffs=[6.7503,0.0259897,-1.43361e-05,2.85508e-09,-1.99929e-13,-34444.5,1.60431], Tmin=(827.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)OOF(941)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.220779,'amu*angstrom^2'), symmetry=1, barrier=(5.07614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05048,'amu*angstrom^2'), symmetry=1, barrier=(24.1526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49884,'amu*angstrom^2'), symmetry=1, barrier=(34.4612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.509847,'amu*angstrom^2'), symmetry=1, barrier=(11.7224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508441,'amu*angstrom^2'), symmetry=1, barrier=(11.6901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37144,0.0620155,-0.00010459,8.62657e-08,-2.72658e-11,-26914.3,19.9486], Tmin=(100,'K'), Tmax=(860.668,'K')), NASAPolynomial(coeffs=[10.9641,0.0112383,-5.29671e-06,9.90894e-10,-6.66398e-14,-28336.1,-23.558], Tmin=(860.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (206.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,291.4,3698.42],'cm^-1')),
        HinderedRotor(inertia=(0.374163,'amu*angstrom^2'), symmetry=1, barrier=(22.5476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92062,0.01896,-2.08417e-05,1.10971e-08,-2.15333e-12,24926,11.4734], Tmin=(100,'K'), Tmax=(1506.19,'K')), NASAPolynomial(coeffs=[8.03868,0.00135571,6.85987e-07,-2.0007e-10,1.53426e-14,23839.4,-13.8038], Tmin=(1506.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(ROOJ) + radical(CsJOOH)"""),
)

species(
    label = '[O]O[CH]C(F)(F)F(352)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.446274,'amu*angstrom^2'), symmetry=1, barrier=(10.2607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444299,'amu*angstrom^2'), symmetry=1, barrier=(10.2153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11149,0.0700311,-0.000125494,1.0881e-07,-3.58062e-11,-58093.8,20.6344], Tmin=(100,'K'), Tmax=(866.845,'K')), NASAPolynomial(coeffs=[10.6159,0.0138739,-7.03535e-06,1.33865e-09,-9.03543e-14,-59279.4,-21.1954], Tmin=(866.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.9864,0.028195,-2.0916e-05,5.04802e-09,6.02563e-13,-95123.4,13.7466], Tmin=(298,'K'), Tmax=(1000,'K')), NASAPolynomial(coeffs=[8.04771,0.013775,-7.75122e-06,2.0531e-09,-2.09098e-13,-96451.9,-12.1768], Tmin=(1000,'K'), Tmax=(5000,'K'))], Tmin=(298,'K'), Tmax=(5000,'K'), E0=(-789.584,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(153.818,'J/mol/K'), label="""CF3CHO""", comment="""Thermo library: Fluorine"""),
)

species(
    label = 'FOOC[C](F)F(354)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)CF(348)'],
    products = ['HO2(10)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.91635e+11,'s^-1'), n=0.573333, Ea=(148.459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO]
...
reaction(
    ...
    products = ['[O]OC(F)(F)CF(348)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(206.29,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(154)', 'F[C]CF-2(188)'],
    products = ['[O]OC(F)(F)CF(348)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[O]OC(F)(F)CF(348)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(21.2507,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(416)', 'CH2(S)(74)'],
    products = ['[O]OC(F)(F)CF(348)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](431)'],
    products = ['[O]OC(F)(F)CF(348)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(147)', 'CH2F(91)'],
    products = ['[O]OC(F)(F)CF(348)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(234)'],
    products = ['[O]OC(F)(F)CF(348)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(108)', 'C=C(F)O[O](939)'],
    products = ['[O]OC(F)(F)CF(348)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(244.578,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]CC(F)(F)F(349)'],
    products = ['[O]OCC(F)(F)F(603)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(962)'],
    products = ['[O]OCC(F)(F)F(603)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(18.5816,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CF3(44)', '[CH2]O[O](351)'],
    products = ['[O]OCC(F)(F)F(603)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(352)'],
    products = ['[O]OCC(F)(F)F(603)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OCC(F)(F)F(603)'],
    products = ['OH(4)', 'CF3CHO(105)'],
