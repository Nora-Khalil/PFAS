...
"""),
    E0 = (-345.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,1855,455,950,372.906,996.676],'cm^-1')),
        HinderedRotor(inertia=(2.22442,'amu*angstrom^2'), symmetry=1, barrier=(51.1439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22222,'amu*angstrom^2'), symmetry=1, barrier=(51.0932,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38443,0.0331249,-2.9166e-05,1.25996e-08,-2.17134e-12,-41540.1,18.0887], Tmin=(100,'K'), Tmax=(1381.75,'K')), NASAPolynomial(coeffs=[10.0481,0.0109393,-5.08176e-06,9.79417e-10,-6.88925e-14,-43657.9,-21.3623], Tmin=(1381.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sO2sH)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.02595,0.000308212,8.65648e-05,-1.1853e-07,4.61718e-11,-82882.5,13.3902], Tmin=(100,'K'), Tmax=(958.763,'K')), NASAPolynomial(coeffs=[15.5241,0.00191784,-5.00681e-08,1.73081e-10,-2.79978e-14,-87749.6,-59.2638], Tmin=(958.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(CsFHOO) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16703,0.043103,-7.09533e-05,5.65755e-08,-1.75005e-11,-61376.7,19.026], Tmin=(100,'K'), Tmax=(798.974,'K')), NASAPolynomial(coeffs=[9.27834,0.00750519,-4.12989e-06,8.24651e-10,-5.80991e-14,-62513.2,-13.6869], Tmin=(798.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(COFOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]O[C](O)F(373)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38921,0.0368605,-3.96912e-05,2.19408e-08,-4.92075e-12,-47478,18.7214], Tmin=(100,'K'), Tmax=(1067.8,'K')), NASAPolynomial(coeffs=[8.66237,0.0133615,-6.68139e-06,1.33197e-09,-9.57587e-14,-48817.7,-11.9546], Tmin=(1067.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-OdOsH) + radical(CsF1sO2sO2s) + radical((O)CJOC)"""),
)

species(
    label = '[O][CH]OC(=O)F(374)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34409,0.0440038,-8.09946e-05,8.40558e-08,-3.32818e-11,-44240.6,18.4981], Tmin=(100,'K'), Tmax=(811.028,'K')), NASAPolynomial(coeffs=[2.7616,0.0248092,-1.38021e-05,2.77249e-09,-1.95914e-13,-43744.8,20.0457], Tmin=(811.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(COFOO) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'O=[C]O[CH]OF(375)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-42.1104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,1855,455,950,397.687,397.727,397.8],'cm^-1')),
        HinderedRotor(inertia=(0.381098,'amu*angstrom^2'), symmetry=1, barrier=(42.7877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160576,'amu*angstrom^2'), symmetry=1, barrier=(18.0313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591857,'amu*angstrom^2'), symmetry=1, barrier=(66.4418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75702,0.0517462,-7.46161e-05,5.28055e-08,-1.45849e-11,-4986.04,18.2528], Tmin=(100,'K'), Tmax=(891.348,'K')), NASAPolynomial(coeffs=[10.9146,0.0106502,-5.45692e-06,1.07842e-09,-7.65364e-14,-6618.53,-24.8738], Tmin=(891.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.1104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCJO) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[C]=O(306)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[C]=O(306)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(68.2,'m^3/(mol*s)'), n=8.73864e-09, Ea=(8.306,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['[O]C(F)O[C]=O(306)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(65.4455,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(=O)F(260)'],
    products = ['[O]C(F)O[C]=O(306)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(30.9291,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
