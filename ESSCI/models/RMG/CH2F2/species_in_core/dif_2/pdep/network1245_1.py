...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95774,0.0246237,-2.50872e-05,1.62787e-08,-4.59853e-12,-5902.4,14.7453], Tmin=(100,'K'), Tmax=(836.398,'K')), NASAPolynomial(coeffs=[5.16832,0.0140521,-6.12859e-06,1.16775e-09,-8.19846e-14,-6272.2,4.4754], Tmin=(836.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.3749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.00287,0.00678839,6.85869e-05,-9.64885e-08,3.86252e-11,-62753.1,14.5616], Tmin=(100,'K'), Tmax=(921.796,'K')), NASAPolynomial(coeffs=[10.9362,0.0112389,-1.91641e-06,2.53466e-10,-2.05851e-14,-65867.3,-32.0249], Tmin=(921.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-522.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)

species(
    label = 'O=C=CC(O)F(3513)',
...
"""),
    E0 = (-233.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([361,769,965,1078,1132,1246,3247,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.602161,'amu*angstrom^2'), symmetry=1, barrier=(13.8449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31455,0.0372121,-3.58853e-05,1.78748e-08,-3.6174e-12,-27973.7,18.1618], Tmin=(100,'K'), Tmax=(1176.19,'K')), NASAPolynomial(coeffs=[9.06308,0.0142614,-6.61601e-06,1.28475e-09,-9.11433e-14,-29561.2,-15.491], Tmin=(1176.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(CsCFHO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(O2sj(Cs-F1sCdH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.527509,'amu*angstrom^2'), symmetry=1, barrier=(12.1285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.38299,'amu*angstrom^2'), symmetry=1, barrier=(54.7895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90726,0.0409354,-4.49734e-05,2.27291e-08,-4.37773e-12,1517.23,16.7461], Tmin=(100,'K'), Tmax=(1283.04,'K')), NASAPolynomial(coeffs=[13.6845,0.0042188,-2.04809e-06,4.25142e-10,-3.1815e-14,-1504.9,-43.0074], Tmin=(1283.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.9527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + radical(C=COJ) + radical(C=CCJ=O)"""),
)

species(
    label = '[O]C=CC([O])F(3517)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u1 p2 c0 {4,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80729,0.0379754,-1.16706e-05,-2.01595e-08,1.25224e-11,-26314.6,20.0212], Tmin=(100,'K'), Tmax=(954.233,'K')), NASAPolynomial(coeffs=[15.2209,0.00670869,-1.75837e-06,3.28152e-10,-2.70581e-14,-30010.9,-50.0177], Tmin=(954.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(O2sj(Cs-F1sCdH)) + radical(C=COJ)"""),
)

species(
    label = 'O=[C]C[C](O)F(3518)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57738,0.0619321,-0.000113375,1.06104e-07,-3.73409e-11,-28106.2,22.5811], Tmin=(100,'K'), Tmax=(871.788,'K')), NASAPolynomial(coeffs=[6.049,0.0218953,-1.09012e-05,2.05748e-09,-1.38703e-13,-28144.1,5.87598], Tmin=(871.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + radical(CsCsF1sO2s) + radical(CCCJ=O)"""),
)

species(
    label = '[O][C](F)CC=O(3519)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {5,S}
3 O u0 p2 c0 {6,D}
...
"""),
    E0 = (-167.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,2782.5,750,1395,475,1775,1000,180,3104.4],'cm^-1')),
        HinderedRotor(inertia=(0.341001,'amu*angstrom^2'), symmetry=1, barrier=(7.84028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340776,'amu*angstrom^2'), symmetry=1, barrier=(7.83511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89948,0.0550277,-9.91102e-05,9.66896e-08,-3.55013e-11,-20106.3,21.5085], Tmin=(100,'K'), Tmax=(861.411,'K')), NASAPolynomial(coeffs=[3.76838,0.0259336,-1.28972e-05,2.45377e-09,-1.67044e-13,-19670.9,17.1676], Tmin=(861.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O=[C][CH]C(O)F(3520)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {9,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98948,0.0470727,-5.97729e-05,4.14111e-08,-1.16511e-11,-27472.1,22.8051], Tmin=(100,'K'), Tmax=(862.599,'K')), NASAPolynomial(coeffs=[8.3773,0.017451,-8.26194e-06,1.59989e-09,-1.12712e-13,-28574.1,-7.06823], Tmin=(862.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[CH]OF(3521)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (115.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1855,455,950,208.169,208.169],'cm^-1')),
        HinderedRotor(inertia=(0.00389017,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401038,'amu*angstrom^2'), symmetry=1, barrier=(12.3321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401028,'amu*angstrom^2'), symmetry=1, barrier=(12.3321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39113,0.0618808,-9.94067e-05,8.26661e-08,-2.6848e-11,13925.8,22.6516], Tmin=(100,'K'), Tmax=(838.031,'K')), NASAPolynomial(coeffs=[9.56852,0.0168676,-8.13034e-06,1.53693e-09,-1.04801e-13,12765.2,-14.1014], Tmin=(838.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', '[CH2]C([O])F(907)'],
    products = ['[O]C(F)C[C]=O(3288)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(3516)'],
    products = ['[O]C(F)C[C]=O(3288)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(296.409,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C[C]=O(3288)'],
    products = ['[O]C=CC([O])F(3517)'],
