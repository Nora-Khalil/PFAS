...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.582478,0.072053,-7.34827e-05,3.74311e-08,-7.5451e-12,-142687,24.9602], Tmin=(100,'K'), Tmax=(1201.72,'K')), NASAPolynomial(coeffs=[16.0582,0.020541,-9.18452e-06,1.76083e-09,-1.24406e-13,-146406,-52.5448], Tmin=(1201.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1187.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsCsFF) + group(CsCsCsFF) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cs-Cs-Cs(F)(F)-Cs)"""),
)

species(
    label = 'FC(F)=C(F)C(F)C(F)F(485)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)[CH]C(F)(F)F(492)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.038437,0.0960047,-0.000159621,1.40809e-07,-4.90771e-11,-120719,30.6516], Tmin=(100,'K'), Tmax=(788.777,'K')), NASAPolynomial(coeffs=[10.7977,0.0311132,-1.65742e-05,3.30394e-09,-2.33214e-13,-122095,-16.6657], Tmin=(788.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1004.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]C(F)C(F)(F)F(493)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0806256,0.0956932,-0.000161047,1.44446e-07,-5.10032e-11,-119511,32.0239], Tmin=(100,'K'), Tmax=(796.736,'K')), NASAPolynomial(coeffs=[10.0212,0.0325917,-1.74048e-05,3.46742e-09,-2.44461e-13,-120676,-11.0465], Tmin=(796.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'F[CH]C(F)[C](F)F(483)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    products = ['FC1C(F)C(F)(F)C1(F)F(484)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    products = ['FC(F)=C(F)C(F)C(F)F(485)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)C(F)C=C(F)F(486)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C(F)F(487)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(106)', 'F[C](F)C=C[C](F)F(488)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(489)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', 'F[CH]C(F)[C](F)F(483)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(370)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    products = ['F[C](F)[C](F)C(F)C(F)F(491)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    products = ['F[C](F)C(F)[CH]C(F)(F)F(492)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(370)'],
    products = ['F[C](F)[CH]C(F)C(F)(F)F(493)'],
