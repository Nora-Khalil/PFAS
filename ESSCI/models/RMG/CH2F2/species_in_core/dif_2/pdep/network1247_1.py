...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.23814,'amu*angstrom^2'), symmetry=1, barrier=(5.47531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481603,'amu*angstrom^2'), symmetry=1, barrier=(11.073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02293,'amu*angstrom^2'), symmetry=1, barrier=(46.5112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46976,0.041933,-2.13859e-05,-6.31957e-08,8.11376e-11,21964.9,22.1424], Tmin=(100,'K'), Tmax=(446.994,'K')), NASAPolynomial(coeffs=[6.35745,0.0231016,-1.17439e-05,2.29315e-09,-1.6008e-13,21457.9,4.73365], Tmin=(446.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sHO2s) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02328,'amu*angstrom^2'), symmetry=1, barrier=(23.5272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02315,'amu*angstrom^2'), symmetry=1, barrier=(23.5242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02318,'amu*angstrom^2'), symmetry=1, barrier=(23.5249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7355,0.0519876,-6.17884e-05,3.77624e-08,-9.25181e-12,22882.5,21.8991], Tmin=(100,'K'), Tmax=(989.118,'K')), NASAPolynomial(coeffs=[10.4805,0.0166229,-8.15801e-06,1.61561e-09,-1.15745e-13,21152.5,-20.1949], Tmin=(989.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sHO2s) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OOCF(3464)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {4,S}
3 O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.700033,'amu*angstrom^2'), symmetry=1, barrier=(16.0951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373167,'amu*angstrom^2'), symmetry=1, barrier=(8.57985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17897,'amu*angstrom^2'), symmetry=1, barrier=(50.0988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19819,0.0456007,-4.95327e-05,1.79765e-08,7.02681e-12,27754.7,23.1759], Tmin=(100,'K'), Tmax=(538.716,'K')), NASAPolynomial(coeffs=[6.46262,0.0229774,-1.17122e-05,2.32383e-09,-1.65271e-13,27164,4.02274], Tmin=(538.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=[C]O[O](2890)'],
    products = ['C=[C]OO[CH]F(3290)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(159)', '[C]=C(2065)'],
    products = ['C=[C]OO[CH]F(3290)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
