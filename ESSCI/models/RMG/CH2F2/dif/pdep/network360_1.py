...
"""),
    E0 = (-672.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,557,1111,435,565,619,662,854,1178,1396,180],'cm^-1')),
        HinderedRotor(inertia=(1.28646,'amu*angstrom^2'), symmetry=1, barrier=(29.5782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28584,'amu*angstrom^2'), symmetry=1, barrier=(29.564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.286,'amu*angstrom^2'), symmetry=1, barrier=(29.5677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.012,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34386,0.0631495,-9.24261e-05,6.72394e-08,-1.9347e-11,-80842.7,19.5554], Tmin=(100,'K'), Tmax=(850.887,'K')), NASAPolynomial(coeffs=[11.414,0.0158088,-8.96893e-06,1.84949e-09,-1.34339e-13,-82556.4,-27.4011], Tmin=(850.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5732,'amu*angstrom^2'), symmetry=1, barrier=(36.171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01668,'amu*angstrom^2'), symmetry=1, barrier=(23.3755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-520.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,557,1111,435,565,619,662,854,1178,1396,180],'cm^-1')),
        HinderedRotor(inertia=(0.884429,'amu*angstrom^2'), symmetry=1, barrier=(20.3348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88465,'amu*angstrom^2'), symmetry=1, barrier=(20.3398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39767,0.0622567,-0.000107671,9.19292e-08,-3.0502e-11,-62563.4,20.1067], Tmin=(100,'K'), Tmax=(807.66,'K')), NASAPolynomial(coeffs=[10.2365,0.0134109,-7.53606e-06,1.5015e-09,-1.05131e-13,-63825.7,-19.6236], Tmin=(807.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.740592,'amu*angstrom^2'), symmetry=1, barrier=(17.0277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100567,'amu*angstrom^2'), symmetry=1, barrier=(60.0956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OOC(F)(F)OF(984)'],
    products = ['O=O(176)', 'HF(38)', 'CF2O(48)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(77.7165,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(285)'],
    products = ['OOC(F)(F)OF(984)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', 'O=C(F)OO(992)'],
    products = ['OOC(F)(F)OF(984)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(82.1687,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #360',
    isomers = [
        'OOC(F)(F)OF(984)',
    ],
    reactants = [
