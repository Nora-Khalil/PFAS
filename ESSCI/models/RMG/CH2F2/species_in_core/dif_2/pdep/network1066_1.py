...
"""),
    E0 = (-112.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,493,600,700,1144,1293,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.261435,'amu*angstrom^2'), symmetry=1, barrier=(6.01092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519765,'amu*angstrom^2'), symmetry=1, barrier=(11.9504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92026,0.0500394,-7.83078e-05,6.74279e-08,-2.33894e-11,-13404.2,19.6104], Tmin=(100,'K'), Tmax=(748.785,'K')), NASAPolynomial(coeffs=[7.51975,0.0178406,-9.22569e-06,1.84405e-09,-1.31138e-13,-14178.6,-5.35599], Tmin=(748.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.271592,'amu*angstrom^2'), symmetry=1, barrier=(6.24443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271301,'amu*angstrom^2'), symmetry=1, barrier=(6.23774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82528,0.05903,-0.000119177,1.19904e-07,-4.43424e-11,-10359.4,20.8028], Tmin=(100,'K'), Tmax=(864.491,'K')), NASAPolynomial(coeffs=[3.68851,0.0240242,-1.26567e-05,2.4542e-09,-1.6791e-13,-9695.63,17.7875], Tmin=(864.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.6948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[CH]=C[O](2806)'],
    products = ['[CH]=CO[C](F)F(2800)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(87)', '[CH]=C[O](2806)'],
    products = ['[CH]=CO[C](F)F(2800)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(49.4074,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH]=CO[C](F)F(2800)'],
    products = ['C=[C]O[C](F)F(2808)'],
    transitionState = 'TS9',
