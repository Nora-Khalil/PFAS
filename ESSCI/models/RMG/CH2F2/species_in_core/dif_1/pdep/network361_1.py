...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0138611,'amu*angstrom^2'), symmetry=1, barrier=(6.78768,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15905,0.0685176,-9.91318e-05,7.75162e-08,-2.45999e-11,-84188.1,25.196], Tmin=(100,'K'), Tmax=(766.914,'K')), NASAPolynomial(coeffs=[9.60201,0.0244801,-1.29966e-05,2.63779e-09,-1.90099e-13,-85483.1,-13.2955], Tmin=(766.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sH)(H))"""),
)
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500956,0.0886945,-0.000166683,1.55862e-07,-5.50649e-11,-47951.9,26.8408], Tmin=(100,'K'), Tmax=(851.053,'K')), NASAPolynomial(coeffs=[8.48397,0.0267313,-1.4391e-05,2.81799e-09,-1.94325e-13,-48425.6,-5.18459], Tmin=(851.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)CC(F)(F)F(917)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45084,0.0591311,-6.65972e-05,3.85358e-08,-9.0009e-12,-90538,23.5468], Tmin=(100,'K'), Tmax=(1029.86,'K')), NASAPolynomial(coeffs=[11.4059,0.0204651,-1.02797e-05,2.07921e-09,-1.50971e-13,-92588.5,-24.7736], Tmin=(1029.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C([O])(F)F(870)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C([O])(F)F(907)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(911)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[C](F)F(913)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2O(48)', '[CH2][C](F)F(187)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(83.8819,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(178)', '[CH2][C](F)F(187)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(89)', '[CH2]C([O])(F)F(907)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(914)'],
    products = ['[O]C(F)(F)C[C](F)F(871)'],
