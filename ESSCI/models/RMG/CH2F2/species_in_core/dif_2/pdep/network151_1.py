...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[C](F)F(386)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(474)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)C(=O)F(436)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)(F)C=O(437)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)F(304)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(176)', '[O][CH]F(168)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(106)', '[O][CH]C(=O)F(438)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O][C](F)C(=O)F(305)'],
    products = ['[O]C(F)C([O])(F)F(348)'],
