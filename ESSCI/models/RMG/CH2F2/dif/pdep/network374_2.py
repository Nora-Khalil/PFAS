...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77131,0.0580334,-0.000110661,1.05769e-07,-3.75977e-11,-27970.8,20.3105], Tmin=(100,'K'), Tmax=(874.096,'K')), NASAPolynomial(coeffs=[5.51254,0.0201696,-1.00883e-05,1.91317e-09,-1.2908e-13,-27832.4,7.29758], Tmin=(874.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.556615,'amu*angstrom^2'), symmetry=1, barrier=(12.7977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31599,'amu*angstrom^2'), symmetry=1, barrier=(30.2571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556241,'amu*angstrom^2'), symmetry=1, barrier=(12.7891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15768,0.0721054,-0.000132546,1.26001e-07,-4.58431e-11,-34171.8,23.5805], Tmin=(100,'K'), Tmax=(827.17,'K')), NASAPolynomial(coeffs=[6.75039,0.0259895,-1.4336e-05,2.85505e-09,-1.99927e-13,-34444.6,1.60381], Tmin=(827.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)OOF(914)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (206.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,291.4,3698.43],'cm^-1')),
        HinderedRotor(inertia=(0.374164,'amu*angstrom^2'), symmetry=1, barrier=(22.5476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92062,0.01896,-2.08417e-05,1.10971e-08,-2.15333e-12,24926,11.4734], Tmin=(100,'K'), Tmax=(1506.19,'K')), NASAPolynomial(coeffs=[8.03865,0.00135575,6.85966e-07,-2.00066e-10,1.53423e-14,23839.4,-13.8036], Tmin=(1506.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(ROOJ) + radical(CsJOOH)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(654)', 'CH2(S)(24)'],
    products = ['[O]OC(F)(F)CF(693)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)(F)CF(693)'],
    products = ['[O]OCC(F)(F)F(908)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](911)'],
    products = ['[O]OC(F)(F)CF(693)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(171)', 'CH2F(45)'],
    products = ['[O]OC(F)(F)CF(693)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(657)'],
    products = ['[O]OC(F)(F)CF(693)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC[C](F)F(1156)'],
    products = ['[O]OCC(F)(F)F(908)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(1125)'],
    products = ['[O]OCC(F)(F)F(908)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(946)'],
    products = ['[O]OCC(F)(F)F(908)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OCC(F)(F)F(908)'],
    products = ['OH(4)', 'CF3CHO(74)'],
