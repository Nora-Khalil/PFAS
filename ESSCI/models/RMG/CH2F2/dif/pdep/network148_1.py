...
"""),
    E0 = (-453.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,180,1746.6,1747.73,1749.76],'cm^-1')),
        HinderedRotor(inertia=(0.1975,'amu*angstrom^2'), symmetry=1, barrier=(4.5409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196449,'amu*angstrom^2'), symmetry=1, barrier=(4.51676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197159,'amu*angstrom^2'), symmetry=1, barrier=(4.53307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41073,0.0812524,-0.000194201,2.20099e-07,-8.81298e-11,-54416.2,26.6791], Tmin=(100,'K'), Tmax=(852.042,'K')), NASAPolynomial(coeffs=[-4.65556,0.0483408,-2.81843e-05,5.63947e-09,-3.92667e-13,-51154,68.051], Tmin=(852.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[C](OF)O[C](F)F(459)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-475.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,493,600,700,1144,1293,180,180,1860.7,1860.72],'cm^-1')),
        HinderedRotor(inertia=(0.244422,'amu*angstrom^2'), symmetry=1, barrier=(5.61975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244606,'amu*angstrom^2'), symmetry=1, barrier=(5.62397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244449,'amu*angstrom^2'), symmetry=1, barrier=(5.62036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24449,'amu*angstrom^2'), symmetry=1, barrier=(5.6213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892803,0.0848007,-0.000179886,1.82226e-07,-6.77741e-11,-57054.1,28.7548], Tmin=(100,'K'), Tmax=(855.711,'K')), NASAPolynomial(coeffs=[4.22083,0.0308211,-1.79115e-05,3.56263e-09,-2.46604e-13,-56216.9,21.4373], Tmin=(855.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-615.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,1855,455,950,180,314.103],'cm^-1')),
        HinderedRotor(inertia=(1.14158,'amu*angstrom^2'), symmetry=1, barrier=(26.2472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0174012,'amu*angstrom^2'), symmetry=1, barrier=(26.1983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17992,0.0633084,-8.44976e-05,5.32188e-08,-1.29756e-11,-84095.3,23.6944], Tmin=(100,'K'), Tmax=(1009.21,'K')), NASAPolynomial(coeffs=[14.5487,0.010321,-5.74139e-06,1.19348e-09,-8.78366e-14,-86793.6,-40.9246], Tmin=(1009.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFHO) + group(Cds-OdOsOs) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OC(F)F(333)'],
    products = ['HF(38)', 'CF2O(48)', 'CO2(13)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(16.4961,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C(O)OF(353)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(457)', 'CHF(40)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.3639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(OF)O[C](F)F(458)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(460)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(461)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(358)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(142)', '[O]C(F)F(170)'],
    products = ['O=C(OF)OC(F)F(333)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(228)', 'O=[C]OC(F)F(180)'],
    products = ['O=C(OF)OC(F)F(333)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(462)'],
    products = ['O=C(OF)OC(F)F(333)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(OF)OC(F)F(333)'],
    products = ['F2(77)', 'CO2(13)', 'CHFO(46)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(204.026,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #148',
    isomers = [
        'O=C(OF)OC(F)F(333)',
    ],
    reactants = [
