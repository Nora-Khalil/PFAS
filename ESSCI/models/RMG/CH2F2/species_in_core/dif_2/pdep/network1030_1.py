...
"""),
    E0 = (-221.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,180,1031.7,1031.7,1031.7,1031.7,1031.7,1031.7,1031.7,1031.7,1031.7,2282.03],'cm^-1')),
        HinderedRotor(inertia=(0.0302807,'amu*angstrom^2'), symmetry=1, barrier=(0.696214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0302807,'amu*angstrom^2'), symmetry=1, barrier=(0.696214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90093,0.0418583,-3.68286e-05,1.55459e-08,-2.59031e-12,-26514.5,19.3805], Tmin=(100,'K'), Tmax=(1436.52,'K')), NASAPolynomial(coeffs=[12.5965,0.0120761,-5.72983e-06,1.11319e-09,-7.85296e-14,-29587.3,-36.0933], Tmin=(1436.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (171.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,180.432,180.432,180.432,180.432,180.432,845.289,2591.93,2591.93],'cm^-1')),
        HinderedRotor(inertia=(1.41059,'amu*angstrom^2'), symmetry=1, barrier=(32.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4106,'amu*angstrom^2'), symmetry=1, barrier=(32.5879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0381,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60241,0.0639891,-0.000131923,1.2986e-07,-4.71466e-11,20692.1,16.5546], Tmin=(100,'K'), Tmax=(863.919,'K')), NASAPolynomial(coeffs=[5.32359,0.0207693,-1.17553e-05,2.30613e-09,-1.58045e-13,21019.1,4.75976], Tmin=(863.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(oxirene) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06224,0.0365882,-2.55251e-05,7.30916e-09,-6.08457e-13,-26525.6,20.0723], Tmin=(100,'K'), Tmax=(1382.47,'K')), NASAPolynomial(coeffs=[12.3728,0.012839,-6.35728e-06,1.24877e-09,-8.81075e-14,-29957.8,-35.112], Tmin=(1382.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-OdOsH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = 'O=C(F)O[C]1[CH]O1(2661)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02608,0.0510546,-5.63368e-05,2.9672e-08,-5.70052e-12,-30179.4,24.6691], Tmin=(100,'K'), Tmax=(1535.8,'K')), NASAPolynomial(coeffs=[14.4365,0.00407012,1.32844e-06,-4.71298e-10,3.83645e-14,-32876.7,-41.153], Tmin=(1535.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(COFOO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1(F)[CH]O1(2620)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C1(F)[CH]O1(2640)'],
    products = ['O=[C]OC1(F)[CH]O1(2620)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[O]C1(F)[CH]O1(2640)'],
    products = ['O=[C]OC1(F)[CH]O1(2620)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(6.05939,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OC1(F)[CH]O1(2620)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5.33888e+13,'m^3/(mol*s)'), n=-2.06969, Ea=(136.408,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC1=CO1(2660)'],
    products = ['O=[C]OC1(F)[CH]O1(2620)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(9.96273,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC1(F)[CH]O1(2620)'],
    products = ['O=C(F)O[C]1[CH]O1(2661)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(212.701,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1030',
    isomers = [
        'O=[C]OC1(F)[CH]O1(2620)',
    ],
    reactants = [
        ('CO2(13)', 'FC1=CO1(390)'),
    ],
