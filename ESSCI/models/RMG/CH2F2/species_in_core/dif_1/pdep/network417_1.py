...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C([CH2])(F)F(1159)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(68)', 'F[C](F)C[C](F)F(911)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C[C](F)F(1162)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[C](F)F(1083)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(89)', '[CH2]C([CH2])(F)F(1159)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(1163)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C[C](F)F(1103)'],
    products = ['[CH2][C](F)CC(F)(F)F(1165)'],
