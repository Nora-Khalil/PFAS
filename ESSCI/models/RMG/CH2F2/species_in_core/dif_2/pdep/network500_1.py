...
reaction(
    label = 'reaction2',
    reactants = ['OF(153)', 'OC(F)(F)[C]F(715)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(86)', 'OC(F)(F)OF(707)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(153)', 'F[C]C(F)OF(1224)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(716)', 'OC(F)=CF(1225)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(718)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(153)', 'FOC=C(F)F(1226)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(1227)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)OF(1228)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(1229)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', 'OC(F)(F)[CH]F(551)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'FOC(F)[C](F)F(1230)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(1231)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(177)', 'O[C](F)F(232)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(721)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'O=CC(O)(F)F(1232)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(1233)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(435)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(106)', 'OC(F)=COF(1234)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(727)'],
    products = ['OC(F)(F)C(F)OF(1196)'],
