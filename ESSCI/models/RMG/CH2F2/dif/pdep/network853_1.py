...
"""),
    E0 = (-369.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,1380,1390,370,380,2900,435,190,488,555,1236,1407,316.096,316.405,316.458],'cm^-1')),
        HinderedRotor(inertia=(0.251796,'amu*angstrom^2'), symmetry=1, barrier=(17.8986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251615,'amu*angstrom^2'), symmetry=1, barrier=(17.898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569766,'amu*angstrom^2'), symmetry=1, barrier=(40.5212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.223006,'amu*angstrom^2'), symmetry=1, barrier=(5.12735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182203,0.0928662,-0.000159478,1.41839e-07,-4.95286e-11,-68016.1,29.2989], Tmin=(100,'K'), Tmax=(793.893,'K')), NASAPolynomial(coeffs=[10.8294,0.0279601,-1.55673e-05,3.12471e-09,-2.20724e-13,-69351.8,-17.3755], Tmin=(793.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CsFFHO) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0807036,0.0991844,-0.000185452,1.74176e-07,-6.22308e-11,-62402.8,31.6449], Tmin=(100,'K'), Tmax=(838.555,'K')), NASAPolynomial(coeffs=[8.77902,0.0315139,-1.75751e-05,3.4822e-09,-2.42204e-13,-62941.2,-3.29989], Tmin=(838.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O]C(OC(F)F)[C](F)F(2005)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-859.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,519,593,830,1115,1166,1389,1413,3114,190,488,555,1236,1407,180,180,180,1433.25,1434.41],'cm^-1')),
        HinderedRotor(inertia=(0.256168,'amu*angstrom^2'), symmetry=1, barrier=(5.88981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256068,'amu*angstrom^2'), symmetry=1, barrier=(5.8875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255058,'amu*angstrom^2'), symmetry=1, barrier=(5.86428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583311,0.0902258,-0.00017407,1.73282e-07,-6.47839e-11,-103307,31.2267], Tmin=(100,'K'), Tmax=(841.006,'K')), NASAPolynomial(coeffs=[4.38428,0.0383039,-2.11003e-05,4.17311e-09,-2.90289e-13,-102750,20.663], Tmin=(841.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-859.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-286.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,945.148],'cm^-1')),
        HinderedRotor(inertia=(0.325138,'amu*angstrom^2'), symmetry=1, barrier=(7.47556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13664,'amu*angstrom^2'), symmetry=1, barrier=(49.1256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19122,0.0739371,-0.000147777,1.46254e-07,-5.4156e-11,-34328.5,21.6825], Tmin=(100,'K'), Tmax=(839.186,'K')), NASAPolynomial(coeffs=[5.56666,0.0264161,-1.51727e-05,3.04572e-09,-2.13164e-13,-34124,6.935], Tmin=(839.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]OC(F)F(786)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-714.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,3025,407.5,1350,352.5,190,488,555,1236,1407,274.332,274.332,274.334,2179.8],'cm^-1')),
        HinderedRotor(inertia=(0.2037,'amu*angstrom^2'), symmetry=1, barrier=(10.8786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203701,'amu*angstrom^2'), symmetry=1, barrier=(10.8785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584648,'amu*angstrom^2'), symmetry=1, barrier=(31.2236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736656,0.0782993,-0.00012924,1.11055e-07,-3.76701e-11,-85808.9,27.0157], Tmin=(100,'K'), Tmax=(781.389,'K')), NASAPolynomial(coeffs=[10.6526,0.022336,-1.18225e-05,2.35536e-09,-1.66264e-13,-87199.7,-17.3606], Tmin=(781.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-714.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'FO[C](OC(F)F)[C](F)F(2007)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.218665,0.106059,-0.000198802,1.84987e-07,-6.55612e-11,-89559.6,34.1046], Tmin=(100,'K'), Tmax=(836.256,'K')), NASAPolynomial(coeffs=[10.0891,0.0308821,-1.75485e-05,3.49473e-09,-2.43596e-13,-90378.9,-8.37192], Tmin=(836.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(O[C](F)F)[C](F)F(2008)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.205734,0.107186,-0.000205371,1.94367e-07,-6.9585e-11,-88772,34.5298], Tmin=(100,'K'), Tmax=(841.665,'K')), NASAPolynomial(coeffs=[9.10292,0.0326712,-1.86153e-05,3.70295e-09,-2.57592e-13,-89266.6,-2.40398], Tmin=(841.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O=C(OC(F)F)[C](F)F(2009)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.2685,0.103041,-0.000173869,1.51921e-07,-5.23567e-11,-114525,32.7758], Tmin=(100,'K'), Tmax=(783.432,'K')), NASAPolynomial(coeffs=[12.2798,0.0299276,-1.65627e-05,3.32362e-09,-2.35033e-13,-116214,-22.9282], Tmin=(783.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-953.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Cs_P)"""),
)

species(
    label = 'FOC(O[C](F)F)C(F)F(2012)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.272494,0.104384,-0.000181259,1.6245e-07,-5.68966e-11,-113737,33.2607], Tmin=(100,'K'), Tmax=(803.164,'K')), NASAPolynomial(coeffs=[11.353,0.03161,-1.75655e-05,3.51627e-09,-2.4771e-13,-115125,-17.2907], Tmin=(803.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-946.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O]C(OC(F)F)C(F)(F)F(2013)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183708,0.0952999,-0.000166368,1.5582e-07,-5.69235e-11,-156528,30.9545], Tmin=(100,'K'), Tmax=(807.252,'K')), NASAPolynomial(coeffs=[7.86762,0.0369495,-2.02684e-05,4.04894e-09,-2.85226e-13,-157108,-0.378741], Tmin=(807.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1302.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(CCOJ)"""),
)

species(
    label = 'F[CH]OC(OF)C(F)(F)F(2014)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    ...
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(OF)[C](F)F(2001)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]C(OF)OC(F)F(2002)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(166)', 'FO[CH]OC(F)F(528)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(170)', 'FOC=C(F)F(565)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(228)', 'FC(F)=COC(F)F(1198)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FOC(OC(F)F)=C(F)F(2003)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]OC(OF)[C](F)F(2004)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(OC(F)F)[C](F)F(2005)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(170)', 'FO[CH][C](F)F(1092)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF2(81)', '[O]C(OF)[C](F)F(2006)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(228)', 'F[C](F)[CH]OC(F)F(786)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FO[C](OC(F)F)[C](F)F(2007)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(O[C](F)F)[C](F)F(2008)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(OC(F)F)[C](F)F(2009)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOC(OC(F)F)[C](F)F(1926)'],
    products = ['F2(77)', 'CHFO(46)', 'O=C[C](F)F(1089)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'F[C]C(OF)OC(F)F-2(2010)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CF2(42)', 'FO[CH]OC(F)F(528)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FO[C](OC(F)F)C(F)F(2011)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC(O[C](F)F)C(F)F(2012)'],
    products = ['FOC(OC(F)F)[C](F)F(1926)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(OC(F)F)[C](F)F(1926)'],
    products = ['[O]C(OC(F)F)C(F)(F)F(2013)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FOC(OC(F)F)[C](F)F(1926)'],
    products = ['F[CH]OC(OF)C(F)(F)F(2014)'],
...
network(
    label = 'PDepNetwork #853',
    isomers = [
        'FOC(OC(F)F)[C](F)F(1926)',
    ],
    reactants = [
