...
reaction(
    label = 'reaction1',
    reactants = ['CF2(87)', '[O]OC(F)F(163)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(218.458,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(152)', 'F[C]C(F)F(180)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)(F)F(433)', 'CHF(86)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(158.401,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)C(F)F(419)'],
    products = ['[O]OC(F)C(F)(F)F(378)'],
    transitionState = 'TS4',
...
reaction(
    ...
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.58174e+10,'s^-1'), n=0.573333, Ea=(171.624,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)C(F)F(379)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]F(232)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(171)', 'CHF2(81)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)F(269)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(106)', '[O]OC(F)=CF(380)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(381)'],
    products = ['[O]OC(F)(F)C(F)F(419)'],
...
network(
    label = 'PDepNetwork #431',
    isomers = [
        '[O]OC(F)(F)C(F)F(419)',
    ],
    reactants = [
        ('CF2(87)', '[O]OC(F)F(163)'),
        ('[O]OC(F)(F)F(433)', 'CHF(86)'),
        ('HO2(10)', 'CF2CF2(60)'),
        ('O2(2)', 'CHF2-CF2(68)'),
        ('[O]O[C](F)F(171)', 'CHF2(81)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
