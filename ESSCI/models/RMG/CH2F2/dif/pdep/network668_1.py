...
"""),
    E0 = (-726.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.286507,'amu*angstrom^2'), symmetry=1, barrier=(6.58735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.921195,'amu*angstrom^2'), symmetry=1, barrier=(21.1801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286907,'amu*angstrom^2'), symmetry=1, barrier=(6.59656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.57544,0.0369334,4.4792e-05,-2.35761e-07,2.27906e-10,-87401.4,11.2744], Tmin=(10,'K'), Tmax=(410.473,'K')), NASAPolynomial(coeffs=[6.2206,0.0334296,-2.37958e-05,7.828e-09,-9.64622e-13,-87806.2,-1.41714], Tmin=(410.473,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-726.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""COC(F)(F)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-283.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,263.066,1764.34,1764.65],'cm^-1')),
        HinderedRotor(inertia=(0.193238,'amu*angstrom^2'), symmetry=1, barrier=(9.43784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191799,'amu*angstrom^2'), symmetry=1, barrier=(9.41691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.897624,'amu*angstrom^2'), symmetry=1, barrier=(43.7188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4686,0.0377788,-3.60842e-05,2.08155e-08,-5.42963e-12,-33987.1,19.3424], Tmin=(100,'K'), Tmax=(876.672,'K')), NASAPolynomial(coeffs=[5.57456,0.0236074,-1.18371e-05,2.37703e-09,-1.71625e-13,-34531.7,4.76673], Tmin=(876.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'COC([O])(F)F(1685)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-622.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,180,1221.56],'cm^-1')),
        HinderedRotor(inertia=(0.13875,'amu*angstrom^2'), symmetry=1, barrier=(3.19013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396723,'amu*angstrom^2'), symmetry=1, barrier=(9.12144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.78765,0.0215073,2.15702e-05,-5.51019e-08,2.85872e-11,-74889.5,12.2099], Tmin=(10,'K'), Tmax=(728.751,'K')), NASAPolynomial(coeffs=[5.1898,0.0270177,-1.69553e-05,5.00898e-09,-5.64803e-13,-75444.6,3.48297], Tmin=(728.751,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-622.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""COC([O])(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-455.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,493,600,700,1144,1293,180,2433.03],'cm^-1')),
        HinderedRotor(inertia=(0.276617,'amu*angstrom^2'), symmetry=1, barrier=(6.35996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380647,'amu*angstrom^2'), symmetry=1, barrier=(8.75182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0414,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70954,0.0275444,-4.17298e-05,6.58071e-08,-4.64391e-11,-54734.3,11.1857], Tmin=(10,'K'), Tmax=(451.246,'K')), NASAPolynomial(coeffs=[3.64279,0.0237666,-1.46472e-05,4.33696e-09,-4.94807e-13,-54683.8,11.9475], Tmin=(451.246,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-455.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""CO[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-613.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,240.572,1291.63],'cm^-1')),
        HinderedRotor(inertia=(0.0910953,'amu*angstrom^2'), symmetry=1, barrier=(2.09446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44694,'amu*angstrom^2'), symmetry=1, barrier=(33.2681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['COC(F)(F)OF(1595)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(33.2817,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction5',
    reactants = ['FO[C](F)F(240)', 'CH3O(26)'],
    products = ['COC(F)(F)OF(1595)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(424)', 'CH3(18)'],
    products = ['COC(F)(F)OF(1595)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(228)', 'CO[C](F)F(1686)'],
    products = ['COC(F)(F)OF(1595)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC(F)(F)OF(524)'],
    products = ['COC(F)(F)OF(1595)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(77)', 'COC(=O)F(1637)'],
    products = ['COC(F)(F)OF(1595)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(96.5095,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #668',
    isomers = [
        'COC(F)(F)OF(1595)',
    ],
    reactants = [
