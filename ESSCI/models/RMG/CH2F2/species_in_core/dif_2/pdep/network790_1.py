...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258439,'amu*angstrom^2'), symmetry=1, barrier=(5.94202,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96516,0.0410956,-4.35615e-05,2.24159e-08,-4.4556e-12,-29623.9,18.2764], Tmin=(100,'K'), Tmax=(1236.4,'K')), NASAPolynomial(coeffs=[12.2788,0.00772887,-3.08112e-06,5.88934e-10,-4.21876e-14,-32174.3,-33.6697], Tmin=(1236.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-179.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,180,629.818,1564.25],'cm^-1')),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51501,0.027424,-1.25834e-05,-2.75907e-09,2.71482e-12,-21504.7,17.0501], Tmin=(100,'K'), Tmax=(1087.6,'K')), NASAPolynomial(coeffs=[9.4211,0.0119557,-4.94658e-06,9.55412e-10,-6.8839e-14,-23594.3,-19.548], Tmin=(1087.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[CH2]O[CH]OF(2016)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (108.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1282.3,1282.69],'cm^-1')),
        HinderedRotor(inertia=(0.20151,'amu*angstrom^2'), symmetry=1, barrier=(4.6331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201568,'amu*angstrom^2'), symmetry=1, barrier=(4.63445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201538,'amu*angstrom^2'), symmetry=1, barrier=(4.63376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05918,0.0566647,-0.000122906,1.32295e-07,-5.12016e-11,13105.6,18.1595], Tmin=(100,'K'), Tmax=(860.898,'K')), NASAPolynomial(coeffs=[0.442561,0.0297673,-1.60885e-05,3.15005e-09,-2.16842e-13,14659,33.1222], Tmin=(860.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(CsJOCH3)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(131)', 'CH2(T)(66)'],
    products = ['[CH2]OC([O])F(2008)'],
    transitionState = 'TS2',
