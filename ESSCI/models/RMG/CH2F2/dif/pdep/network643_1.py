...
"""),
    E0 = (-249.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3000,3100,440,815,1455,1000,313.312,313.314,2065.01],'cm^-1')),
        HinderedRotor(inertia=(0.00171745,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103657,'amu*angstrom^2'), symmetry=1, barrier=(7.2201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103685,'amu*angstrom^2'), symmetry=1, barrier=(7.22187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67173,0.0554971,-8.12421e-05,6.80717e-08,-2.29801e-11,-29880.7,21.937], Tmin=(100,'K'), Tmax=(799.888,'K')), NASAPolynomial(coeffs=[7.44732,0.0221445,-1.03139e-05,1.96936e-09,-1.36457e-13,-30661.6,-3.7433], Tmin=(799.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(CsJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79571,0.0539779,-6.76091e-05,3.86923e-08,-4.0036e-12,-31864.1,21.3064], Tmin=(100,'K'), Tmax=(601.77,'K')), NASAPolynomial(coeffs=[8.31191,0.0206472,-9.41118e-06,1.78549e-09,-1.2356e-13,-32829.1,-8.32292], Tmin=(601.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = 'CO[CH][C](F)F(1709)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46292,0.0642148,-0.000111968,1.04902e-07,-3.7541e-11,-30087.6,21.6091], Tmin=(100,'K'), Tmax=(850.35,'K')), NASAPolynomial(coeffs=[5.84026,0.0257913,-1.27338e-05,2.44116e-09,-1.67436e-13,-30187.3,4.99154], Tmin=(850.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-250.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]O[CH2](1706)'],
    products = ['[CH2]OC[C](F)F(1570)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC=C(F)F(1655)'],
    products = ['[CH2]OC[C](F)F(1570)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH2]O[CH2](1706)'],
    products = ['[CH2]OC[C](F)F(1570)'],
