...
"""),
    E0 = (-590.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,180,180,695.871,695.983,695.999,696.024,3048.78,3048.81],'cm^-1')),
        HinderedRotor(inertia=(0.416395,'amu*angstrom^2'), symmetry=1, barrier=(9.57374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58196,'amu*angstrom^2'), symmetry=1, barrier=(36.3725,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84663,0.0499744,-7.53345e-05,5.62096e-08,-1.63577e-11,-70982.1,21.6039], Tmin=(100,'K'), Tmax=(847.357,'K')), NASAPolynomial(coeffs=[10.2434,0.010337,-5.16764e-06,1.00489e-09,-7.03252e-14,-72405.1,-17.5147], Tmin=(847.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05957,0.0466976,-7.52502e-05,6.47545e-08,-2.19287e-11,-25849.1,21.9494], Tmin=(100,'K'), Tmax=(823.076,'K')), NASAPolynomial(coeffs=[7.28373,0.0154863,-7.75807e-06,1.49287e-09,-1.03028e-13,-26511.8,-1.03881], Tmin=(823.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(CsFFHO) + ring(dioxirane) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][C]1OC(F)(F)O1(275)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.02553,0.0365772,-8.93244e-05,1.19021e-07,-5.3701e-11,-58655.1,17.6183], Tmin=(100,'K'), Tmax=(823.258,'K')), NASAPolynomial(coeffs=[-6.86757,0.0428623,-2.46465e-05,4.99651e-09,-3.53937e-13,-55610.3,72.0222], Tmin=(823.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(126)', '[O]C([O])=O(208)'],
    products = ['[O]C(=O)O[C](F)F(260)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]C(=O)O[C](F)F(260)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(84.2245,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)
