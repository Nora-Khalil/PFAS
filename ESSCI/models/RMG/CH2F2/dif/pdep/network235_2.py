...
"""),
    E0 = (24.3221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,269.016,269.111],'cm^-1')),
    ...
    molecularWeight = (48.0164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.34426,0.0104286,-1.53634e-06,-8.5461e-09,4.63416e-12,2952.45,8.82077], Tmin=(100,'K'), Tmax=(987.022,'K')), NASAPolynomial(coeffs=[8.33235,-0.000272539,2.6849e-07,2.39035e-13,-3.9609e-15,1504.37,-17.5263], Tmin=(987.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.3221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
"""),
    E0 = (-154.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([878.049,878.275,878.415,2058.69,4000,4000],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (48.0164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.88127,8.17224e-05,1.45158e-05,-1.63325e-08,5.32333e-12,-18576.5,-3.58777], Tmin=(100,'K'), Tmax=(1082.99,'K')), NASAPolynomial(coeffs=[4.57895,0.00496324,-2.57576e-06,5.47932e-10,-4.13617e-14,-19165,-9.02864], Tmin=(1082.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['OH(4)', 'CF2(42)'],
    products = ['O[C](F)F(239)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.70189e+10,'cm^3/(mol*s)'), n=0.7539, Ea=(3.775,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Matched reaction 13 CF2 + OH <=> CF2OH in halocarbene_recombination/training
This reaction matched rate rule [Root_N-3R->H_N-2Br1sCl1sF1s->Cl1s_N-3BrCClFINOPSSi->F_N-3CClO->C]
family: halocarbene_recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C]F(1102)'],
    products = ['O[C](F)F(239)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1',
    reactants = ['O(6)', 'CHF2(81)'],
    products = ['[O]C(F)F(170)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'CHFO(46)'],
    products = ['[O]C(F)F(170)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(31.5024,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(295)'],
    products = ['[O]C(F)F(170)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(76.4868,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

network(
    label = 'PDepNetwork #235',
    isomers = [
        'O[C](F)F(239)',
        '[O]C(F)F(170)',
    ],
