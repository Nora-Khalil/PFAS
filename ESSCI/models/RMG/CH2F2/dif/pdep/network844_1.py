...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.545751,'amu*angstrom^2'), symmetry=1, barrier=(12.5479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.942018,'amu*angstrom^2'), symmetry=1, barrier=(21.6588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683307,0.0864805,-0.000176525,1.71819e-07,-6.25266e-11,-39206.4,23.5337], Tmin=(100,'K'), Tmax=(841.361,'K')), NASAPolynomial(coeffs=[7.49719,0.025074,-1.53248e-05,3.10507e-09,-2.17474e-13,-39326.1,-2.05995], Tmin=(841.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)

species(
    label = 'O[C](C=C(F)F)OOF(2123)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.855014,'amu*angstrom^2'), symmetry=1, barrier=(19.6585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850999,'amu*angstrom^2'), symmetry=1, barrier=(19.5661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265668,0.0895749,-0.000147758,1.2675e-07,-4.3028e-11,-44939.2,31.1242], Tmin=(100,'K'), Tmax=(778.635,'K')), NASAPolynomial(coeffs=[11.5517,0.025872,-1.40104e-05,2.79306e-09,-1.97025e-13,-46523.3,-19.3861], Tmin=(778.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cs_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00154858,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00154767,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015482,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.633169,'amu*angstrom^2'), symmetry=1, barrier=(14.5578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634365,'amu*angstrom^2'), symmetry=1, barrier=(14.5853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633347,'amu*angstrom^2'), symmetry=1, barrier=(14.5619,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-659.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,350,440,435,1725,182,240,577,636,1210,1413,180,180,180,1604.21,1609.83,1610.31],'cm^-1')),
        HinderedRotor(inertia=(0.168136,'amu*angstrom^2'), symmetry=1, barrier=(3.86577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170046,'amu*angstrom^2'), symmetry=1, barrier=(3.90969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170157,'amu*angstrom^2'), symmetry=1, barrier=(3.91224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587407,0.0903719,-0.000180676,1.7842e-07,-6.56028e-11,-79270.6,27.8892], Tmin=(100,'K'), Tmax=(851.33,'K')), NASAPolynomial(coeffs=[5.43675,0.0329618,-1.85139e-05,3.65823e-09,-2.53154e-13,-78841.5,12.6438], Tmin=(851.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-478.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,180,1148.8,1148.85,1149.19],'cm^-1')),
        HinderedRotor(inertia=(0.00380231,'amu*angstrom^2'), symmetry=1, barrier=(3.56396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.43947,'amu*angstrom^2'), symmetry=1, barrier=(56.0881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155009,'amu*angstrom^2'), symmetry=1, barrier=(3.56397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5662,0.0590188,-9.38038e-05,8.24975e-08,-2.88648e-11,-57423.4,24.2624], Tmin=(100,'K'), Tmax=(803.427,'K')), NASAPolynomial(coeffs=[7.29364,0.0227448,-1.15944e-05,2.26178e-09,-1.57786e-13,-58093.3,-0.557207], Tmin=(803.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-286.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,1855,455,950,241.655,241.944],'cm^-1')),
        HinderedRotor(inertia=(0.388169,'amu*angstrom^2'), symmetry=1, barrier=(16.2025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388954,'amu*angstrom^2'), symmetry=1, barrier=(16.2059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00289223,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0696,0.0682654,-9.7508e-05,6.8184e-08,-1.867e-11,-34383.2,28.3849], Tmin=(100,'K'), Tmax=(896.988,'K')), NASAPolynomial(coeffs=[13.0805,0.0147046,-7.94088e-06,1.61559e-09,-1.16768e-13,-36537.9,-28.2551], Tmin=(896.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CsCsF1sF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(=O)C(OF)[C](F)F(2131)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00657,0.0728994,-0.00010874,9.07046e-08,-3.12705e-11,-58431.7,29.2656], Tmin=(100,'K'), Tmax=(703.431,'K')), NASAPolynomial(coeffs=[8.6021,0.0297076,-1.66367e-05,3.41392e-09,-2.46976e-13,-59500.3,-4.70637], Tmin=(703.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-486.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788974,0.0793929,-0.000119014,8.45783e-08,-1.96025e-11,-63910.1,31.0255], Tmin=(100,'K'), Tmax=(599.626,'K')), NASAPolynomial(coeffs=[10.8989,0.0246284,-1.37296e-05,2.77996e-09,-1.98452e-13,-65350.4,-14.4786], Tmin=(599.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868454,0.0750128,-9.86752e-05,6.815e-08,-1.91033e-11,-88246.9,29.0911], Tmin=(100,'K'), Tmax=(863.682,'K')), NASAPolynomial(coeffs=[11.3822,0.0263199,-1.41073e-05,2.8725e-09,-2.0803e-13,-90063,-20.0907], Tmin=(863.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO)"""),
)

species(
    label = '[O]C(=O)C(OF)C(F)F(2083)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38846,0.0642993,-6.94641e-05,4.05598e-08,-1.006e-11,-82781.6,26.9748], Tmin=(100,'K'), Tmax=(945.599,'K')), NASAPolynomial(coeffs=[9.22991,0.0311297,-1.68483e-05,3.46531e-09,-2.53015e-13,-84264.6,-10.4172], Tmin=(945.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    ...
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CO2(13)', 'FOC[C](F)F(1739)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=[C]C(OF)=C(F)F(2122)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](C=C(F)F)OOF(2123)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF(2124)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C]F(166)', 'O=C(O)[CH]OF(499)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C(O)C(OF)[C](F)F(1917)'],
    products = ['O[C]1OC(F)(F)C1OF(2125)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(O)C(OF)[C](F)F(1917)'],
    products = ['[O]C1(O)C(OF)C1(F)F(2126)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(O)=C(OF)[C](F)F(2127)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', 'O=C(O)C=C(F)F(1087)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(164)', 'FOC=C(F)F(565)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)C(OF)=C(F)F(2128)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(228)', 'O=C(O)[CH][C](F)F(1208)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(OF)[C](F)F(2130)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(OF)[C](F)F(2131)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(164)', 'FO[CH][C](F)F(1092)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[C](OF)[C](F)F(2132)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF-2(2133)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CF2(42)', 'O=C(O)[CH]OF(499)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(O)C(OF)[C](F)F(1917)'],
    products = ['O=C(O)[C](OF)C(F)F(2134)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(=O)C(OF)C(F)F(2083)'],
    products = ['O=C(O)C(OF)[C](F)F(1917)'],
