...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[CH]F(1546)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(68)', '[O]C(F)(F)[CH]F(467)'],
    products = ['[CH2]OC(F)(F)[CH]F(1546)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(888)'],
    products = ['[CH2]OC(F)(F)[CH]F(1546)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(88)', '[CH2]O[C](F)F(888)'],
    products = ['[CH2]OC(F)(F)[CH]F(1546)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[C](F)C(F)F(1553)'],
    products = ['[CH2]OC(F)(F)[CH]F(1546)'],
