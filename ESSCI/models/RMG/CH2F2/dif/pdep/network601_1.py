...
"""),
    E0 = (-161.025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,574.445,574.446,574.446,574.446,574.446,574.447,574.448],'cm^-1')),
        HinderedRotor(inertia=(0.000510862,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000510864,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50294,0.0264379,-1.07488e-05,-8.282e-09,5.65508e-12,-19307.2,16.2305], Tmin=(100,'K'), Tmax=(1007.02,'K')), NASAPolynomial(coeffs=[11.039,0.00682823,-2.83472e-06,5.76726e-10,-4.40975e-14,-21751.3,-28.6101], Tmin=(1007.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(CsJOC(O))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(188)', 'CH2(T)(17)'],
    products = ['[CH2]OC([O])=O(1537)'],
    transitionState = 'TS2',
