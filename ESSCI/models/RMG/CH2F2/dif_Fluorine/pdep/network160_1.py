...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48357,0.0604832,-9.58204e-05,7.77672e-08,-2.50525e-11,-80312.7,22.9468], Tmin=(100,'K'), Tmax=(761.509,'K')), NASAPolynomial(coeffs=[9.86043,0.0164788,-9.13557e-06,1.87328e-09,-1.35142e-13,-81588.5,-15.1839], Tmin=(761.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][C](F)OC(F)F(184)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02727,0.0447276,-4.70554e-05,2.45939e-08,-5.14901e-12,-75070.1,21.3684], Tmin=(100,'K'), Tmax=(1144.87,'K')), NASAPolynomial(coeffs=[10.6825,0.0144884,-7.43692e-06,1.52429e-09,-1.11506e-13,-77052,-21.559], Tmin=(1144.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'FO[CH]O[C](F)F(470)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-317.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,493,600,700,1144,1293,180,180,1640.42,1642.56],'cm^-1')),
        HinderedRotor(inertia=(0.264488,'amu*angstrom^2'), symmetry=1, barrier=(6.08111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264172,'amu*angstrom^2'), symmetry=1, barrier=(6.07383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264964,'amu*angstrom^2'), symmetry=1, barrier=(6.09204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37753,0.0792827,-0.00018764,2.03474e-07,-7.82523e-11,-38145.8,23.1837], Tmin=(100,'K'), Tmax=(867.41,'K')), NASAPolynomial(coeffs=[-0.932518,0.0363863,-2.08586e-05,4.11881e-09,-2.82941e-13,-35730.5,45.612], Tmin=(867.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][CH]OC(F)(F)F(471)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69763,0.0797615,-0.00020916,2.43971e-07,-9.79286e-11,-80491.4,18.6408], Tmin=(100,'K'), Tmax=(865.728,'K')), NASAPolynomial(coeffs=[-8.09903,0.0504265,-2.90781e-05,5.76191e-09,-3.97104e-13,-75999.6,80.6372], Tmin=(865.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(126)', '[O]C([O])F(138)'],
    products = ['[O]C(F)O[C](F)F(431)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(467)'],
    products = ['[O]C(F)O[C](F)F(431)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(268)', 'CHFO(46)'],
    products = ['[O]C(F)O[C](F)F(431)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(70.2434,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(286)'],
    products = ['[O]C(F)O[C](F)F(431)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(268)', '[O][CH]F(135)'],
    products = ['[O]C(F)O[C](F)F(431)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C([O])F(138)'],
    products = ['[O]C(F)O[C](F)F(431)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(257654,'m^3/(mol*s)'), n=0.469398, Ea=(3.53053,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R
Multiplied by reaction path degeneracy 2.0"""),
)
