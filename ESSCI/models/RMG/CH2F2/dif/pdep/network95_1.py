...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)(F)F(283)'],
    products = ['HO2(10)', 'CF2O(48)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(155)'],
    products = ['[O]OC(O)(F)F(283)'],
    transitionState = 'TS2',
