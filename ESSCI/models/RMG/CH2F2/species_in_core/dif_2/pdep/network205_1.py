...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20994,0.0504268,-5.62798e-05,2.88399e-08,-5.49356e-12,-72497.4,28.948], Tmin=(100,'K'), Tmax=(1447.53,'K')), NASAPolynomial(coeffs=[16.5719,0.00189859,3.05884e-07,-1.2165e-10,9.3245e-15,-76308,-48.6465], Tmin=(1447.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFFO) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-835.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,180,180,180,369.078,836.119,3189.93],'cm^-1')),
        HinderedRotor(inertia=(0.0302036,'amu*angstrom^2'), symmetry=1, barrier=(14.9715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0302098,'amu*angstrom^2'), symmetry=1, barrier=(14.9717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1561,'amu*angstrom^2'), symmetry=1, barrier=(49.573,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.021,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764265,0.0733723,-9.73027e-05,6.33741e-08,-1.61365e-11,-100429,28.0438], Tmin=(100,'K'), Tmax=(964.289,'K')), NASAPolynomial(coeffs=[14.6189,0.0159011,-7.90258e-06,1.56633e-09,-1.12143e-13,-103101,-38.2927], Tmin=(964.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-835.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642448,0.0735161,-9.62152e-05,6.03657e-08,-1.46104e-11,-45908.3,32.7897], Tmin=(100,'K'), Tmax=(1020,'K')), NASAPolynomial(coeffs=[16.3763,0.0118154,-5.48028e-06,1.06263e-09,-7.55937e-14,-49118.1,-43.429], Tmin=(1020,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OOOC(F)(F)[CH]F(1539)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (146.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301759,0.0761452,-9.60411e-05,5.637e-08,-1.25695e-11,-46745.4,32.7898], Tmin=(100,'K'), Tmax=(1114.71,'K')), NASAPolynomial(coeffs=[19.6573,0.00669046,-2.58009e-06,4.74485e-10,-3.36599e-14,-51060.5,-62.6913], Tmin=(1114.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107203,0.0872583,-0.000125883,8.5465e-08,-2.22595e-11,-71280.8,34.184], Tmin=(100,'K'), Tmax=(950.9,'K')), NASAPolynomial(coeffs=[18.2423,0.010972,-5.54507e-06,1.09674e-09,-7.82321e-14,-74729.7,-52.3943], Tmin=(950.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20116,0.0645235,-9.01598e-05,6.2577e-08,-1.7022e-11,-42820,31.195], Tmin=(100,'K'), Tmax=(903.251,'K')), NASAPolynomial(coeffs=[12.4637,0.0146487,-7.3355e-06,1.44724e-09,-1.02889e-13,-44854.6,-21.9943], Tmin=(903.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(ROOJ)"""),
)

species(
    label = 'OOOOC(F)(F)[C](F)F(1543)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.132442,0.0905725,-0.000120225,7.4893e-08,-1.79279e-11,-89552.3,34.2844], Tmin=(100,'K'), Tmax=(1032,'K')), NASAPolynomial(coeffs=[20.0956,0.0121673,-6.26136e-06,1.27138e-09,-9.28015e-14,-93727.3,-63.9411], Tmin=(1032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)

species(
    label = 'FOOOO[C](F)C(F)F(1544)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.126148,0.0854569,-0.000109383,6.65131e-08,-1.566e-11,-52710.1,35.2686], Tmin=(100,'K'), Tmax=(1044.73,'K')), NASAPolynomial(coeffs=[18.6467,0.0145459,-7.56958e-06,1.54299e-09,-1.12706e-13,-56579.9,-54.8926], Tmin=(1044.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(F)(F)OOOOF(1545)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)(F)C(F)F(419)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', '[O]OOOC(F)F(206)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OOOF(223)', 'F[C]C(F)F(180)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(1035)', 'CHF(86)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)(F)C(F)F(533)'],
    products = ['[O]OOOC(F)C(F)(F)F(1536)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]OOC(F)(F)C(F)F(1537)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OOOC(F)(F)C(F)F(533)'],
    products = ['[O-][O+]=O(225)', '[O]C(F)(F)C(F)F(259)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OOO[C](F)C(F)F(1538)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OOOC(F)(F)[CH]F(1539)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[O](157)', '[O]C(F)(F)C(F)F(259)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OO[O](207)', 'CHF2-CF2(68)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OOO[C](F)F(227)', 'CHF2(81)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OOOC(F)(F)[C](F)F(1540)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(106)', '[O]OOOC(F)=CF(1541)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OOOC(F)=C(F)F(1542)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OOOOC(F)(F)[C](F)F(1543)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOOOO[C](F)C(F)F(1544)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)OOOOF(1545)'],
    products = ['[O]OOOC(F)(F)C(F)F(533)'],
...
network(
    ...
    isomers = [
        '[O]OOOC(F)(F)C(F)F(533)',
    ],
    reactants = [
        ('O2(2)', '[O]OC(F)(F)C(F)F(419)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
