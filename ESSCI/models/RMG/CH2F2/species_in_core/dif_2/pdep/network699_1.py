...
reaction(
    label = 'reaction1',
    reactants = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    ...
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F(1789)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'O[CH]OC(F)(F)F(1238)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF3O(90)', 'OC=C(F)F(1217)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(4)', 'FC(F)=COC(F)(F)F(1790)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC(OC(F)(F)F)=C(F)F(1791)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(O[C](F)F)[C](F)F(1792)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF3O(90)', 'O[CH][C](F)F(1445)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF3(44)', '[O]C(O)[C](F)F(1793)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'F[C](F)[CH]OC(F)(F)F(456)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OC(F)(F)F)[C](F)F(1794)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[C](OC(F)(F)F)[C](F)F(1795)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F-2(1796)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(87)', 'O[CH]OC(F)(F)F(1238)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](OC(F)(F)F)C(F)F(1797)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(OC(F)(F)F)[C](F)F(1669)'],
    products = ['[O]C(OC(F)(F)F)C(F)F(1798)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OC(O[C](F)F)C(F)(F)F(1799)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1669)'],
...
network(
    label = 'PDepNetwork #699',
    isomers = [
        'OC(OC(F)(F)F)[C](F)F(1669)',
    ],
    reactants = [
