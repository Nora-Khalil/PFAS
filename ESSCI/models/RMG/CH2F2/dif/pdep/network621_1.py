...
"""),
    E0 = (-181.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,180,180,180,918.673],'cm^-1')),
        HinderedRotor(inertia=(0.113797,'amu*angstrom^2'), symmetry=1, barrier=(2.61642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122594,'amu*angstrom^2'), symmetry=1, barrier=(2.81867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32331,0.0493039,-0.000102863,1.15536e-07,-4.69973e-11,-21752.8,15.7934], Tmin=(100,'K'), Tmax=(836.02,'K')), NASAPolynomial(coeffs=[-0.792325,0.0331717,-1.82272e-05,3.63502e-09,-2.54742e-13,-20147.1,36.7539], Tmin=(836.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70653,0.0686375,-0.000159291,1.70111e-07,-6.43915e-11,-26358.9,17.3241], Tmin=(100,'K'), Tmax=(878.196,'K')), NASAPolynomial(coeffs=[0.245245,0.0301642,-1.64935e-05,3.19309e-09,-2.16312e-13,-24362,34.0923], Tmin=(878.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C[O](1545)'],
    products = ['[O]CO[CH]F(1552)'],
    transitionState = 'TS2',
