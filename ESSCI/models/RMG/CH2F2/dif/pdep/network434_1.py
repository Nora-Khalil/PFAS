...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.305576,'amu*angstrom^2'), symmetry=1, barrier=(7.02579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75207,'amu*angstrom^2'), symmetry=1, barrier=(40.2836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305624,'amu*angstrom^2'), symmetry=1, barrier=(7.02691,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.384756,0.0886121,-0.000157733,1.41199e-07,-4.86895e-11,-47842.6,26.9429], Tmin=(100,'K'), Tmax=(827.876,'K')), NASAPolynomial(coeffs=[10.6919,0.0237357,-1.28704e-05,2.54883e-09,-1.77798e-13,-49032.5,-17.7161], Tmin=(827.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-398.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[O]C(F)(F)[C](F)CF(1225)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.40652,'amu*angstrom^2'), symmetry=1, barrier=(32.3386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40818,'amu*angstrom^2'), symmetry=1, barrier=(32.3769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877027,0.0647982,-7.07232e-05,3.69552e-08,-7.48426e-12,-80329.7,25.19], Tmin=(100,'K'), Tmax=(1209.41,'K')), NASAPolynomial(coeffs=[16.7089,0.0124359,-5.77958e-06,1.15615e-09,-8.41703e-14,-84159.1,-54.2], Tmin=(1209.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sHH)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)[C](F)OF(1226)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.280973,'amu*angstrom^2'), symmetry=1, barrier=(6.46013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281194,'amu*angstrom^2'), symmetry=1, barrier=(6.4652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15705,'amu*angstrom^2'), symmetry=1, barrier=(26.6029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26165,0.0942846,-0.000178319,1.65683e-07,-5.82015e-11,-47119.9,26.1583], Tmin=(100,'K'), Tmax=(848.5,'K')), NASAPolynomial(coeffs=[9.54744,0.0260187,-1.43416e-05,2.82828e-09,-1.95634e-13,-47814.1,-11.9197], Tmin=(848.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.948023,'amu*angstrom^2'), symmetry=1, barrier=(21.7969,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[O]C(F)(F)[C](F)F(278)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)F(1221)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C([O])(F)F(1222)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)F(1147)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(77)', '[CH2][C](F)C(=O)F(1223)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)C(F)(F)OF(1224)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[C](F)OF(1226)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
...
network(
    label = 'PDepNetwork #434',
    isomers = [
        '[CH2]C(F)(F)C([O])(F)F(1172)',
    ],
    reactants = [
        ('CF2O(48)', 'CH2CF2(56)'),
    ],
