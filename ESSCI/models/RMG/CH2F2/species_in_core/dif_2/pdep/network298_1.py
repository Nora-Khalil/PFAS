species(
    label = 'F[CH]C(F)(F)C(F)(F)[C](F)F(613)',
...
"""),
    E0 = (-1135.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,190,488,555,1236,1407,334,575,1197,1424,3202,180,180,1755.07],'cm^-1')),
        HinderedRotor(inertia=(0.408626,'amu*angstrom^2'), symmetry=1, barrier=(9.39512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407956,'amu*angstrom^2'), symmetry=1, barrier=(9.37971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95469,'amu*angstrom^2'), symmetry=1, barrier=(44.9422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'F[C](F)C(F)C(F)(F)[C](F)F(614)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1C(F)(F)C(F)(F)C1(F)F(756)',
...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)(F)F(774)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.76134,0.119069,-0.000221186,2.04318e-07,-7.19857e-11,-141309,33.3151], Tmin=(100,'K'), Tmax=(835.098,'K')), NASAPolynomial(coeffs=[11.3999,0.0336093,-1.88114e-05,3.7453e-09,-2.61271e-13,-142391,-17.4838], Tmin=(835.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1176.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'F[C](F)[C](F)C(F)(F)C(F)F(762)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)(F)F(775)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.707981,0.11772,-0.000217911,2.01522e-07,-7.11858e-11,-141784,33.3052], Tmin=(100,'K'), Tmax=(832.711,'K')), NASAPolynomial(coeffs=[11.165,0.0339949,-1.90108e-05,3.7886e-09,-2.64629e-13,-142836,-16.2449], Tmin=(832.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1180.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C(F)(F)[C](F)C(F)F(761)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(614)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'F[C](F)C(F)(F)[C](F)F(519)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    products = ['FC1C(F)(F)C(F)(F)C1(F)F(756)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=C(F)F(498)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(60)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C(F)(F)[C](F)F(773)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(230)', 'CHFCF2(54)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(230)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(106)', 'F[CH]C(F)=C(F)[C](F)F(501)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(86)', 'F[C](F)C(F)(F)[C](F)F(519)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)(F)F(774)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    products = ['F[C](F)[C](F)C(F)(F)C(F)F(762)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    products = ['F[CH][C](F)C(F)(F)C(F)(F)F(775)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(613)'],
    products = ['F[C](F)C(F)(F)[C](F)C(F)F(761)'],
...
network(
    label = 'PDepNetwork #298',
    isomers = [
        'F[CH]C(F)(F)C(F)(F)[C](F)F(613)',
    ],
    reactants = [
        ('CF2CF2(60)', 'CHFCF2(54)'),
    ],
