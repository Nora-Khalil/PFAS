...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.158357,'amu*angstrom^2'), symmetry=1, barrier=(32.9561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0366,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.05211,-0.00483582,6.57607e-05,-1.15121e-07,6.54453e-11,48084.2,7.57695], Tmin=(10,'K'), Tmax=(555.637,'K')), NASAPolynomial(coeffs=[2.65445,0.0139892,-8.7171e-06,2.62401e-09,-3.0363e-13,48104.2,12.2812], Tmin=(555.637,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(399.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""[C]DCO""", comment="""Thermo library: 2-BTP_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0712174,'amu*angstrom^2'), symmetry=1, barrier=(8.14037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0611,0.024237,-4.33999e-05,4.44991e-08,-1.77793e-11,21816.1,14.7462], Tmin=(100,'K'), Tmax=(775.749,'K')), NASAPolynomial(coeffs=[3.95588,0.0125254,-7.02963e-06,1.4484e-09,-1.04389e-13,21890.8,12.0332], Tmin=(775.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(4)', 'C2HF(57)'],
    products = ['OC=[C]F(1881)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'O=C[C]F-2(964)'],
    products = ['OC=[C]F(1881)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(7.35745,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'O[C]=[C]F(2462)'],
    products = ['OC=[C]F(1881)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC=[C]F(1881)'],
    products = ['O[C]=CF(2463)'],
    transitionState = 'TS7',
