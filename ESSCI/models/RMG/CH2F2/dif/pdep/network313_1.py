...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.193848,'amu*angstrom^2'), symmetry=1, barrier=(4.45694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193177,'amu*angstrom^2'), symmetry=1, barrier=(4.44151,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-1151.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,193,295,551,588,656,1146,1192,1350,190,488,555,1236,1407,180,2427.65],'cm^-1')),
        HinderedRotor(inertia=(0.537878,'amu*angstrom^2'), symmetry=1, barrier=(12.3669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26526,'amu*angstrom^2'), symmetry=1, barrier=(29.0908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[O]C(F)(F)C(F)C(F)(F)F(1036)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0191037,'amu*angstrom^2'), symmetry=1, barrier=(5.27091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588079,'amu*angstrom^2'), symmetry=1, barrier=(13.5211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    ...
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)F(230)', 'F[C]C(F)(F)F(1028)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(42)', 'OC(F)C(F)(F)F(1029)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(173)', 'F[C]C(F)C(F)(F)F(1030)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    products = ['OC(C(F)(F)F)C(F)(F)F(1031)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FC(F)=C(F)C(F)(F)F(1032)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(173)', 'FC(F)=CC(F)(F)F(716)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)(F)F(244)', 'CHFCF2(54)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[CH]C(F)(F)F(1033)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)C(F)(F)F(1034)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC(F)(F)C(F)[C](F)F(1035)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'F[C](F)C(F)C(F)(F)F(673)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)C(F)(F)F(1036)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(239)', 'CF3-CHF(53)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF3(44)', 'OC(F)(F)[CH]F(572)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)[C](F)C(F)(F)F(1037)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)C(F)(F)F(1038)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'OC(F)=CC(F)(F)F(1039)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)=C(F)C(F)(F)F(1040)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'OC(F)(F)C=C(F)F(1041)'],
    products = ['OC(F)(F)C(F)C(F)(F)F(727)'],
...
network(
    label = 'PDepNetwork #313',
    isomers = [
        'OC(F)(F)C(F)C(F)(F)F(727)',
    ],
    reactants = [
