...
"""),
    E0 = (-417.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,1855,455,950,424.106,424.161,424.194],'cm^-1')),
        HinderedRotor(inertia=(0.0642803,'amu*angstrom^2'), symmetry=1, barrier=(8.20445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0642491,'amu*angstrom^2'), symmetry=1, barrier=(8.20416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182964,'amu*angstrom^2'), symmetry=1, barrier=(23.3692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5588,0.0575762,-7.81292e-05,5.51684e-08,-1.56053e-11,-50166.4,22.4983], Tmin=(100,'K'), Tmax=(861.662,'K')), NASAPolynomial(coeffs=[10.0899,0.0179744,-9.19138e-06,1.83278e-09,-1.31071e-13,-51636.7,-17.3893], Tmin=(861.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical((O)CJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09899,0.064344,-8.70033e-05,5.64161e-08,-1.41119e-11,-51083.6,22.8537], Tmin=(100,'K'), Tmax=(987.404,'K')), NASAPolynomial(coeffs=[14.4509,0.0102566,-4.83943e-06,9.42944e-10,-6.70858e-14,-53720.4,-41.3926], Tmin=(987.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'O=CO[CH][C](F)F(1193)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C[C](F)F(1170)'],
    products = ['O=[C]OC[C](F)F(1167)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]O[C]=O(1191)'],
    products = ['O=[C]OC[C](F)F(1167)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[O]C[C](F)F(1170)'],
    products = ['O=[C]OC[C](F)F(1167)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(736)'],
    products = ['O=[C]OC[C](F)F(1167)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[C]=O(1191)'],
    products = ['O=[C]OC[C](F)F(1167)'],
