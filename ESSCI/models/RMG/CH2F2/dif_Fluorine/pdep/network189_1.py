...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2861,'amu*angstrom^2'), symmetry=1, barrier=(29.5699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28607,'amu*angstrom^2'), symmetry=1, barrier=(29.5693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28608,'amu*angstrom^2'), symmetry=1, barrier=(29.5695,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.012,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34384,0.0631498,-9.24268e-05,6.72402e-08,-1.93474e-11,-80842.7,19.5554], Tmin=(100,'K'), Tmax=(850.826,'K')), NASAPolynomial(coeffs=[11.414,0.0158089,-8.96897e-06,1.84951e-09,-1.3434e-13,-82556.4,-27.4009], Tmin=(850.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.884959,'amu*angstrom^2'), symmetry=1, barrier=(20.3469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.884124,'amu*angstrom^2'), symmetry=1, barrier=(20.3278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39761,0.0622574,-0.000107674,9.19338e-08,-3.05043e-11,-62563.4,20.1069], Tmin=(100,'K'), Tmax=(807.613,'K')), NASAPolynomial(coeffs=[10.2366,0.0134107,-7.53595e-06,1.50148e-09,-1.05129e-13,-63825.8,-19.6241], Tmin=(807.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OOC(F)(F)OF(574)'],
    products = ['O=O(176)', 'HF(38)', 'CF2O(48)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(66.6898,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(256)'],
    products = ['OOC(F)(F)OF(574)'],
    transitionState = 'TS2',
