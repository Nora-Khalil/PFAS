...
"""),
    E0 = (-959.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,180,180,880.888],'cm^-1')),
        HinderedRotor(inertia=(1.444,'amu*angstrom^2'), symmetry=1, barrier=(33.2005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759412,'amu*angstrom^2'), symmetry=1, barrier=(17.4604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44391,'amu*angstrom^2'), symmetry=1, barrier=(33.1983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42488,'amu*angstrom^2'), symmetry=1, barrier=(32.7609,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13024,0.0441469,-5.7068e-05,3.73787e-08,-9.80542e-12,-20395.9,17.1296], Tmin=(100,'K'), Tmax=(925.385,'K')), NASAPolynomial(coeffs=[9.24209,0.0134063,-7.23986e-06,1.48208e-09,-1.07808e-13,-21712.2,-16.6296], Tmin=(925.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-532.317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([353,444,1253,3145,235,523,627,1123,1142,1372,1406,3097,617,898,1187,355.827,355.834,355.843,355.849],'cm^-1')),
        HinderedRotor(inertia=(0.0816536,'amu*angstrom^2'), symmetry=1, barrier=(7.33744,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-529.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0668587,'amu*angstrom^2'), symmetry=1, barrier=(15.7021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94439,'amu*angstrom^2'), symmetry=1, barrier=(44.7053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-378.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,261,493,600,1152,1365,1422,3097,617,898,1187,366.696,368.025,371.162,371.746,1882.53],'cm^-1')),
        HinderedRotor(inertia=(0.07579,'amu*angstrom^2'), symmetry=1, barrier=(7.48543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323974,'amu*angstrom^2'), symmetry=1, barrier=(31.6996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320685,'amu*angstrom^2'), symmetry=1, barrier=(31.7098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17934,0.0674506,-8.71013e-05,5.81694e-08,-1.57198e-11,-45392.8,23.5166], Tmin=(100,'K'), Tmax=(895.162,'K')), NASAPolynomial(coeffs=[11.1545,0.0228774,-1.24116e-05,2.54495e-09,-1.85195e-13,-47178.7,-23.5029], Tmin=(895.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-378.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FOC(C(F)F)C(F)F(1062)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.126653,'amu*angstrom^2'), symmetry=1, barrier=(2.91199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7509,'amu*angstrom^2'), symmetry=1, barrier=(40.2566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-569.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.991934,'amu*angstrom^2'), symmetry=1, barrier=(22.8065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991926,'amu*angstrom^2'), symmetry=1, barrier=(22.8063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992317,'amu*angstrom^2'), symmetry=1, barrier=(22.8153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.395686,0.0842368,-0.000117939,8.2159e-08,-2.25279e-11,-68323.5,24.3136], Tmin=(100,'K'), Tmax=(893.972,'K')), NASAPolynomial(coeffs=[14.6843,0.0203031,-1.06642e-05,2.15982e-09,-1.55944e-13,-70878.2,-43.0193], Tmin=(893.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-569.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'F[CH]C(F)C(F)OF(1066)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.883868,'amu*angstrom^2'), symmetry=1, barrier=(20.3219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155394,'amu*angstrom^2'), symmetry=1, barrier=(3.5728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.97383,'amu*angstrom^2'), symmetry=1, barrier=(45.3821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    E0 = (-872.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,235,523,627,1123,1142,1372,1406,3097,391,562,707,872,1109,1210,1289,3137,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.17341,'amu*angstrom^2'), symmetry=1, barrier=(12.0347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50014,'amu*angstrom^2'), symmetry=1, barrier=(34.4911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.57572,0.0483777,-3.59878e-05,9.66434e-09,1.27666e-13,-104990,13.246], Tmin=(10,'K'), Tmax=(1058.14,'K')), NASAPolynomial(coeffs=[12.5825,0.0234487,-1.35751e-05,3.68765e-09,-3.84421e-13,-107407,-33.1277], Tmin=(1058.14,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-872.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""[O]C(F)C(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-708.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.148477,'amu*angstrom^2'), symmetry=1, barrier=(3.41377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622312,'amu*angstrom^2'), symmetry=1, barrier=(14.3082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.59036,0.0442234,6.97126e-05,-6.87999e-07,1.17292e-09,-85159.3,12.4166], Tmin=(10,'K'), Tmax=(241.349,'K')), NASAPolynomial(coeffs=[5.75627,0.0338039,-2.38726e-05,7.89282e-09,-9.81921e-13,-85338.1,3.50893], Tmin=(241.349,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-708.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""F[CH]C(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.16326,0.0166688,-1.18483e-05,3.84824e-09,-4.87945e-13,-13289.3,12.47], Tmin=(100,'K'), Tmax=(1844.95,'K')), NASAPolynomial(coeffs=[8.40957,0.00529426,-2.60032e-06,5.06461e-10,-3.51112e-14,-15225.1,-16.0535], Tmin=(1844.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (-760.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.554261,'amu*angstrom^2'), symmetry=1, barrier=(12.7436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551552,'amu*angstrom^2'), symmetry=1, barrier=(12.6813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90687,'amu*angstrom^2'), symmetry=1, barrier=(43.8427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.21377,0.0780105,-0.000148437,1.72171e-07,-8.40238e-11,-91413.3,14.5596], Tmin=(10,'K'), Tmax=(490.487,'K')), NASAPolynomial(coeffs=[8.00719,0.0389194,-2.88887e-05,9.68159e-09,-1.20349e-12,-91883.5,-5.1512], Tmin=(490.487,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-760.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""FOC(F)[C](F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FO[C](F)C(F)C(F)F(896)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.916932,'amu*angstrom^2'), symmetry=1, barrier=(21.0821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218722,'amu*angstrom^2'), symmetry=1, barrier=(5.02884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13421,'amu*angstrom^2'), symmetry=1, barrier=(49.0696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.323417,0.088391,-0.000143022,1.22947e-07,-4.2269e-11,-91629.4,27.5569], Tmin=(100,'K'), Tmax=(750.732,'K')), NASAPolynomial(coeffs=[10.9767,0.0280271,-1.52156e-05,3.06103e-09,-2.17738e-13,-93127.5,-20.1086], Tmin=(750.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-762.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FOC(F)C(F)[C](F)F(1070)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-760.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,253.899,254.088,254.386],'cm^-1')),
        HinderedRotor(inertia=(0.511975,'amu*angstrom^2'), symmetry=1, barrier=(23.4747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245671,'amu*angstrom^2'), symmetry=1, barrier=(11.2586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95867,'amu*angstrom^2'), symmetry=1, barrier=(43.9237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33331,0.0652059,-7.58593e-05,4.46894e-08,-1.06196e-11,-91454.7,14.786], Tmin=(10,'K'), Tmax=(978.743,'K')), NASAPolynomial(coeffs=[12.4841,0.0278078,-1.85439e-05,5.64919e-09,-6.47548e-13,-93246,-29.1645], Tmin=(978.743,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-760.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""FOC(F)C(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-775.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,235,523,627,1123,1142,1372,1406,3097,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0515564,'amu*angstrom^2'), symmetry=1, barrier=(2.03161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704125,'amu*angstrom^2'), symmetry=1, barrier=(16.1892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.73612,0.0377609,-2.767e-05,9.84642e-09,-1.37442e-12,-93272.6,12.3435], Tmin=(10,'K'), Tmax=(1774.15,'K')), NASAPolynomial(coeffs=[13.5167,0.0142411,-6.54313e-06,1.44116e-09,-1.24278e-13,-96512,-39.7986], Tmin=(1774.15,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-775.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""ODCC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FOC=CC(F)F(1072)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-609.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,323,467,575,827,1418,3010,987.5,1337.5,450,1655,252.23,252.413],'cm^-1')),
        HinderedRotor(inertia=(0.19351,'amu*angstrom^2'), symmetry=1, barrier=(8.72822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.554929,'amu*angstrom^2'), symmetry=1, barrier=(25.1039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.496837,'amu*angstrom^2'), symmetry=1, barrier=(11.4233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83471,'amu*angstrom^2'), symmetry=1, barrier=(42.1835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
"""),
    E0 = (-599.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,323,467,575,827,1418,194,682,905,1196,1383,3221,180.523,189.459],'cm^-1')),
        HinderedRotor(inertia=(0.438938,'amu*angstrom^2'), symmetry=1, barrier=(10.092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95603,'amu*angstrom^2'), symmetry=1, barrier=(44.973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-1035.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,235,523,627,1123,1142,1372,1406,3097,486,617,768,1157,1926,180,1260.89],'cm^-1')),
        HinderedRotor(inertia=(0.418087,'amu*angstrom^2'), symmetry=1, barrier=(9.61265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25016,'amu*angstrom^2'), symmetry=1, barrier=(28.7436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-637.787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,326,540,652,719,1357,286.99,287.774],'cm^-1')),
        HinderedRotor(inertia=(0.15982,'amu*angstrom^2'), symmetry=1, barrier=(9.45624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.514069,'amu*angstrom^2'), symmetry=1, barrier=(30.0855,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-638.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,601.078],'cm^-1')),
        HinderedRotor(inertia=(0.440669,'amu*angstrom^2'), symmetry=1, barrier=(10.1318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60059,'amu*angstrom^2'), symmetry=1, barrier=(36.8008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)C(F)C(F)F(1042)'],
    products = ['HF(38)', 'CHFO(46)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(49.5513,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2F2(1)', 'F[C]C(F)OF(564)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.67744e-07,'m^3/(mol*s)'), n=3.38172, Ea=(55.4259,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FCOF(297)', 'F[C]C(F)F(231)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.67744e-07,'m^3/(mol*s)'), n=3.38172, Ea=(49.476,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'FOC(F)C(F)F(830)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5.7066e-06,'m^3/(mol*s)'), n=3.19155, Ea=(222.688,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'F[C]C(F)C(F)F(891)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(47.238,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CF2(42)', 'FCC(F)OF(1046)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(131.435,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'F[C]C(F)C(F)OF(1061)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.4487,'m^3/(mol*s)'), n=1.52711, Ea=(28.0131,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.02090651070256912, var=1.7269912187795557, Tref=1000.0, N=2, data_mean=0.0, correlation='HY_N-3Br1sCCl1sF1sHI1s->F1s_N-4Br1sCl1sF1sI1s->Br1s_N-2Br1sCl1sF1sHI1s->H_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R',), comment="""Estimated from node HY_N-3Br1sCCl1sF1sHI1s->F1s_N-4Br1sCl1sF1sI1s->Br1s_N-2Br1sCl1sF1sHI1s->H_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['FOC(F)C(F)C(F)F(1042)'],
    products = ['FOC(C(F)F)C(F)F(1062)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(173)', 'FC=C(F)C(F)F(906)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(428)', 'FC=CC(F)F(1063)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC(F)[CH]C(F)F(1064)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FO[CH]C(F)C(F)F(1065)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(F)C(F)OF(1066)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)C(F)F(1067)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(228)', 'F[CH]C(F)C(F)F(1068)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(295)', 'CHF2-CHF(66)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', 'F[CH]C(F)OF(587)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FOC(F)[C](F)C(F)F(1069)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FO[C](F)C(F)C(F)F(896)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)C(F)[C](F)F(1070)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'O=CC(F)C(F)F(1071)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(70.7223,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'FOC=CC(F)F(1072)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.76904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FOC=C(F)C(F)F(1073)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(230.13,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'FC=CC(F)OF(1074)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.36703,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FC=C(F)C(F)OF(1060)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(189.826,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(F)C(F)C(F)F(626)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(477.14,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FOC(F)=CC(F)F(901)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(243.399,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FOC(F)C=C(F)F(1075)'],
    products = ['FOC(F)C(F)C(F)F(1042)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(243.779,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction29',
    reactants = ['FOC(F)C(F)C(F)F(1042)'],
    products = ['F2(77)', 'CHFO(46)', 'CHFCHF[Z](58)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(292.652,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
network(
    ...
    isomers = [
        'FOC(F)C(F)C(F)F(1042)',
    ],
    reactants = [
        ('HF(38)', 'CHFO(46)', 'CHFCF2(54)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
