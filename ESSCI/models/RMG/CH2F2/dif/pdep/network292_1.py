...
"""),
    E0 = (-667.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,580,1155,1237,1373,3147,199.513,199.524,199.536,199.547],'cm^-1')),
        HinderedRotor(inertia=(0.201092,'amu*angstrom^2'), symmetry=1, barrier=(5.67974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201054,'amu*angstrom^2'), symmetry=1, barrier=(5.67963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40628,'amu*angstrom^2'), symmetry=1, barrier=(39.7272,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.75643,0.0809654,-0.000144493,1.35201e-07,-4.90842e-11,-80139.8,26.5308], Tmin=(100,'K'), Tmax=(807.105,'K')), NASAPolynomial(coeffs=[7.9683,0.0284705,-1.57964e-05,3.17948e-09,-2.24784e-13,-80758.3,-3.33647], Tmin=(807.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-677.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,182,240,577,636,1210,1413,580,1155,1237,1373,3147,180,180,1848.41],'cm^-1')),
        HinderedRotor(inertia=(0.424555,'amu*angstrom^2'), symmetry=1, barrier=(9.76136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425083,'amu*angstrom^2'), symmetry=1, barrier=(9.77348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-662.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,395,473,707,1436,190,488,555,1236,1407,180,180,180,1584.51],'cm^-1')),
        HinderedRotor(inertia=(0.202207,'amu*angstrom^2'), symmetry=1, barrier=(4.64915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200802,'amu*angstrom^2'), symmetry=1, barrier=(4.61683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65485,'amu*angstrom^2'), symmetry=1, barrier=(38.0483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06608,0.0748815,-0.000135331,1.32157e-07,-4.98867e-11,-79580.2,27.5024], Tmin=(100,'K'), Tmax=(805.105,'K')), NASAPolynomial(coeffs=[5.59363,0.0321102,-1.78647e-05,3.60656e-09,-2.5567e-13,-79652,10.7224], Tmin=(805.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-662.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH]O[CH]C(F)(F)F(785)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645555,0.0849173,-0.000157789,1.48295e-07,-5.29753e-11,-86348.7,25.4459], Tmin=(100,'K'), Tmax=(839.84,'K')), NASAPolynomial(coeffs=[7.98801,0.0274297,-1.48972e-05,2.94288e-09,-2.04589e-13,-86787.9,-3.96791], Tmin=(839.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', 'F[CH]O[CH]F(413)'],
    products = ['F[CH]OC(F)[C](F)F(707)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OC=C(F)F(781)'],
    products = ['F[CH]OC(F)[C](F)F(707)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=C(F)F(782)'],
    products = ['F[CH]OC(F)[C](F)F(707)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', 'F[CH]O[CH]F(413)'],
    products = ['F[CH]OC(F)[C](F)F(707)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]OC(F)[C](F)F(707)'],
    products = ['F[CH]O[CH]C(F)(F)F(785)'],
