...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000941992,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00093192,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338398,'amu*angstrom^2'), symmetry=1, barrier=(43.4604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337005,'amu*angstrom^2'), symmetry=1, barrier=(43.4575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.814486,0.0612482,-5.90021e-05,2.61468e-08,-4.46687e-12,-80977.5,24.9925], Tmin=(100,'K'), Tmax=(1427.16,'K')), NASAPolynomial(coeffs=[19.0101,0.0102501,-5.40102e-06,1.10817e-09,-8.07653e-14,-86171.1,-69.2626], Tmin=(1427.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823148,0.0638093,-6.64214e-05,3.22684e-08,-6.05775e-12,-106800,23.9972], Tmin=(100,'K'), Tmax=(1302.15,'K')), NASAPolynomial(coeffs=[17.9965,0.0110562,-5.65362e-06,1.15733e-09,-8.48005e-14,-111273,-63.3885], Tmin=(1302.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-888.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-383.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,680.615,680.638,680.903,680.932,680.954],'cm^-1')),
        HinderedRotor(inertia=(0.00544975,'amu*angstrom^2'), symmetry=1, barrier=(1.7908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.832673,0.0745216,-9.56509e-05,6.02825e-08,-1.50995e-11,-128610,24.3267], Tmin=(100,'K'), Tmax=(969.705,'K')), NASAPolynomial(coeffs=[14.0274,0.0200939,-1.14586e-05,2.40066e-09,-1.76956e-13,-131169,-38.9241], Tmin=(969.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(CdCFO) + group(Cds-OdOsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'O=C(O)O[CH][C](F)F(2153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747132,0.0728165,-8.14101e-05,4.42666e-08,-9.5385e-12,-128167,27.2986], Tmin=(100,'K'), Tmax=(1121.94,'K')), NASAPolynomial(coeffs=[15.6093,0.0198299,-1.05696e-05,2.17319e-09,-1.59046e-13,-131502,-46.1132], Tmin=(1121.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1066.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsOs) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(=O)OC(F)C(F)F(2158)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.94959,0.064769,-6.35656e-05,3.00796e-08,-5.6338e-12,-122255,26.2409], Tmin=(100,'K'), Tmax=(1282.33,'K')), NASAPolynomial(coeffs=[15.816,0.0183961,-9.32124e-06,1.87868e-09,-1.35832e-13,-126067,-49.1778], Tmin=(1282.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1017.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)

species(
    label = 'O=C(O)O[CH]C(F)(F)F(2159)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O=C(O)OC(F)[C]F(2148)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', 'O=C(O)O[CH]F(599)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(O)OC(F)[C](F)F(1921)'],
    products = ['O[C]1OC(F)C(F)(F)O1(2149)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(O)OC=C(F)F(2151)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)O(208)', 'CHFCF2(54)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(O)OC(F)=C(F)F(2152)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(O)O[CH][C](F)F(2153)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(208)', 'F[CH][C](F)F(635)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'O=[C]OC(F)[C](F)F(689)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)OC(F)[C](F)F(2154)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)O[C](F)[C](F)F(2155)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)OC(F)[C]F-2(2156)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(42)', 'O=C(O)O[CH]F(599)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(O)OC(F)[C](F)F(1921)'],
    products = ['O=C(O)O[C](F)C(F)F(2157)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(=O)OC(F)C(F)F(2158)'],
    products = ['O=C(O)OC(F)[C](F)F(1921)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C(O)OC(F)[C](F)F(1921)'],
    products = ['O=C(O)O[CH]C(F)(F)F(2159)'],
...
network(
    label = 'PDepNetwork #848',
    isomers = [
        'O=C(O)OC(F)[C](F)F(1921)',
    ],
    reactants = [
