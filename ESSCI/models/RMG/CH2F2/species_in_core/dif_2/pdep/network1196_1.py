...
"""),
    E0 = (-502.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,486,617,768,1157,1926,1855,455,950,358.101,358.106,358.117,1852.17],'cm^-1')),
        HinderedRotor(inertia=(0.0170478,'amu*angstrom^2'), symmetry=1, barrier=(41.5009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126436,'amu*angstrom^2'), symmetry=1, barrier=(11.5067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456062,'amu*angstrom^2'), symmetry=1, barrier=(41.5008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-335.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,611,648,830,1210,1753,1855,455,950,413.205,413.681,413.963],'cm^-1')),
        HinderedRotor(inertia=(0.12461,'amu*angstrom^2'), symmetry=1, barrier=(15.0817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124353,'amu*angstrom^2'), symmetry=1, barrier=(15.0821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124586,'amu*angstrom^2'), symmetry=1, barrier=(15.0851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28611,0.0559816,-7.0658e-05,4.12365e-08,-9.13802e-12,-40291.2,23.5862], Tmin=(100,'K'), Tmax=(1121.26,'K')), NASAPolynomial(coeffs=[15.686,0.00461086,-1.93477e-06,3.75418e-10,-2.74252e-14,-43520.4,-47.5328], Tmin=(1121.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(COCsFO) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'O=C1OC(C(=O)F)O1(3178)',
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33837,0.0167539,5.95803e-05,-9.30068e-08,3.66573e-11,-100297,22.2555], Tmin=(100,'K'), Tmax=(985.9,'K')), NASAPolynomial(coeffs=[16.3872,0.0092166,-4.20578e-06,1.01204e-09,-8.72125e-14,-105471,-57.5136], Tmin=(985.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-834.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(COCsFO) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16326,0.0704187,-0.000124868,1.13084e-07,-3.91756e-11,-69517.4,26.5554], Tmin=(100,'K'), Tmax=(851.862,'K')), NASAPolynomial(coeffs=[8.06059,0.0220041,-1.13953e-05,2.19327e-09,-1.50104e-13,-70111,-2.20103], Tmin=(851.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical(CsCOF1sO2s) + radical((O)CJOC)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17374,0.0691223,-0.000124388,1.11198e-07,-3.83798e-11,-77579.3,25.3544], Tmin=(100,'K'), Tmax=(818.425,'K')), NASAPolynomial(coeffs=[9.56898,0.0173859,-9.94628e-06,1.9949e-09,-1.40007e-13,-78594.9,-11.2753], Tmin=(818.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-O2d(Cds-O2d)O2s) + group(COCFO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-223.798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1850,1860,440,470,900,1000,310.927,310.928,310.929,310.929,2053.66,4000],'cm^-1')),
        HinderedRotor(inertia=(0.189947,'amu*angstrom^2'), symmetry=1, barrier=(13.0312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366287,'amu*angstrom^2'), symmetry=1, barrier=(25.1284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366283,'amu*angstrom^2'), symmetry=1, barrier=(25.1284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56141,0.0592819,-0.000107157,9.41765e-08,-3.17272e-11,-26834.3,23.7331], Tmin=(100,'K'), Tmax=(836.047,'K')), NASAPolynomial(coeffs=[9.40999,0.0126356,-7.14705e-06,1.41604e-09,-9.82691e-14,-27828.8,-10.8253], Tmin=(836.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + group(Cds-OdOsH) + radical(OC=OCJ=O) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]O[C](O)C(=O)F(3186)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52608,0.0595332,-8.15216e-05,5.93618e-08,-1.75843e-11,-65001.5,26.7314], Tmin=(100,'K'), Tmax=(818.553,'K')), NASAPolynomial(coeffs=[9.34456,0.021327,-1.15089e-05,2.3405e-09,-1.69065e-13,-66281.5,-9.42289], Tmin=(818.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(COCsFO) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-203.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,1850,1860,440,470,900,1000,379.87,379.87,1895.05],'cm^-1')),
        HinderedRotor(inertia=(0.379107,'amu*angstrom^2'), symmetry=1, barrier=(38.8204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379108,'amu*angstrom^2'), symmetry=1, barrier=(38.8204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379107,'amu*angstrom^2'), symmetry=1, barrier=(38.8204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(13.9724,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51212,0.0603206,-8.02773e-05,5.68548e-08,-1.64988e-11,-24358.3,26.0221], Tmin=(100,'K'), Tmax=(831.877,'K')), NASAPolynomial(coeffs=[9.3236,0.02276,-1.25503e-05,2.57858e-09,-1.87512e-13,-25658,-10.2259], Tmin=(831.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CsCJ=O) + radical((O)CJOC)"""),
)

species(
    label = '[O]C([C]=O)OC(=O)F(3189)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89112,0.0511245,-6.0483e-05,3.84187e-08,-1.01393e-11,-61634.5,27.3294], Tmin=(100,'K'), Tmax=(904.161,'K')), NASAPolynomial(coeffs=[8.55185,0.0216573,-1.15968e-05,2.37315e-09,-1.72721e-13,-62839,-4.13368], Tmin=(904.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + group(COFOO) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O[C]=O)C(=O)F(3135)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', '[O]C(F)O[C]=O(576)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(222)', '[O]C([O])C(=O)F(3053)'],
    products = ['[O]C(O[C]=O)C(=O)F(3135)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]O[CH]C(=O)F(2655)'],
    products = ['[O]C(O[C]=O)C(=O)F(3135)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CO(12)', '[O]C([O])C(=O)F(3053)'],
    products = ['[O]C(O[C]=O)C(=O)F(3135)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=[C]OC(=O)C(=O)F(3185)'],
    products = ['[O]C(O[C]=O)C(=O)F(3135)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=[C]OC(=O)[C]=O(3173)'],
    products = ['[O]C(O[C]=O)C(=O)F(3135)'],
