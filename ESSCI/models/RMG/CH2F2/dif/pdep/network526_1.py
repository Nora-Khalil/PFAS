...
"""),
    E0 = (-1103.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.57749,'amu*angstrom^2'), symmetry=1, barrier=(36.2695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57499,'amu*angstrom^2'), symmetry=1, barrier=(36.2121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57822,'amu*angstrom^2'), symmetry=1, barrier=(36.2863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.76427,0.0148239,0.000200126,-4.62527e-07,3.07349e-10,-132749,12.8615], Tmin=(10,'K'), Tmax=(522.789,'K')), NASAPolynomial(coeffs=[5.00819,0.0518391,-3.95924e-05,1.34221e-08,-1.66943e-12,-133515,1.58547], Tmin=(522.789,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1103.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(F)C(F)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27378,'amu*angstrom^2'), symmetry=1, barrier=(29.2867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27151,'amu*angstrom^2'), symmetry=1, barrier=(29.2345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-538.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,528,1116,1182,1331,1402,1494,3075,3110,617,898,1187,258.577,258.578,258.58,258.581],'cm^-1')),
        HinderedRotor(inertia=(0.213535,'amu*angstrom^2'), symmetry=1, barrier=(10.1316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556214,'amu*angstrom^2'), symmetry=1, barrier=(26.3902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70365,0.0545346,-6.85394e-05,4.54574e-08,-1.22534e-11,-64658.7,19.7087], Tmin=(100,'K'), Tmax=(896.42,'K')), NASAPolynomial(coeffs=[9.52132,0.0196516,-1.01703e-05,2.04945e-09,-1.47816e-13,-66060.3,-17.1524], Tmin=(896.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.46668,'amu*angstrom^2'), symmetry=1, barrier=(33.7219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46509,'amu*angstrom^2'), symmetry=1, barrier=(33.6853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46548,'amu*angstrom^2'), symmetry=1, barrier=(33.6944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-708.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,180,1201.18],'cm^-1')),
        HinderedRotor(inertia=(1.26249,'amu*angstrom^2'), symmetry=1, barrier=(29.027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26023,'amu*angstrom^2'), symmetry=1, barrier=(28.9753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.400778,'amu*angstrom^2'), symmetry=1, barrier=(9.21467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.50842,0.0533998,-7.23398e-05,7.65808e-08,-4.05275e-11,-85156.9,12.3054], Tmin=(10,'K'), Tmax=(423.791,'K')), NASAPolynomial(coeffs=[4.77572,0.0414383,-3.00025e-05,9.98036e-09,-1.2392e-12,-85264.3,7.27942], Tmin=(423.791,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-708.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""O[CH]C(F)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH2]C(F)(F)C(O)F(1479)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-727.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,190.396],'cm^-1')),
        HinderedRotor(inertia=(0.903789,'amu*angstrom^2'), symmetry=1, barrier=(23.4821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858429,'amu*angstrom^2'), symmetry=1, barrier=(23.4614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868719,'amu*angstrom^2'), symmetry=1, barrier=(23.5195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74677,0.0164952,0.00018145,-4.58312e-07,3.25531e-10,-87473.8,12.6922], Tmin=(10,'K'), Tmax=(501.341,'K')), NASAPolynomial(coeffs=[6.60875,0.0405574,-3.08581e-05,1.05916e-08,-1.33622e-12,-88350.2,-5.01687], Tmin=(501.341,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-727.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""[CH2]C(F)(F)C(O)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-877.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,391,562,707,872,1109,1210,1289,3137,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.18132,'amu*angstrom^2'), symmetry=1, barrier=(27.161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17896,'amu*angstrom^2'), symmetry=1, barrier=(27.1066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.624899,'amu*angstrom^2'), symmetry=1, barrier=(14.3677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625059,'amu*angstrom^2'), symmetry=1, barrier=(14.3713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.624927,'amu*angstrom^2'), symmetry=1, barrier=(14.3683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.721306,'amu*angstrom^2'), symmetry=1, barrier=(16.5842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724655,'amu*angstrom^2'), symmetry=1, barrier=(16.6613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11518,'amu*angstrom^2'), symmetry=1, barrier=(25.6402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.638457,'amu*angstrom^2'), symmetry=1, barrier=(14.6794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.638115,'amu*angstrom^2'), symmetry=1, barrier=(14.6715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)C(F)(F)CF(1444)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(8.86023e+09,'s^-1'), n=1.0283, Ea=(213.276,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.7239647048627136, var=0.5241804487032486, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)CF(1475)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(336.354,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'OC(F)[C]F(532)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(188.315,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)F(230)', 'F[C]CF(874)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(197.79,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)(F)CF(876)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(50.4188,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OC(F)(F)CF(680)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(135.879,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H2(7)', 'OC(F)C(F)(F)[C]F(1094)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.26413e-09,'m^3/(mol*s)'), n=4.30786, Ea=(76.9248,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HH_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node HH_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', 'OC(F)C(F)F(681)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(22.708,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(24)', 'OC(F)C(F)(F)F(1029)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(163.533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction11',
    reactants = ['OF(173)', 'FC=C(F)CF(1050)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)[C](F)CF(1477)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[CH]C(F)(F)CF(1478)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)F(1479)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(4)', 'F[CH]C(F)(F)CF(1055)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)C(F)(F)CF(1054)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[CH]F(290)', 'CH2F-CF2(67)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(45)', 'OC(F)[C](F)F(540)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)(F)CF(1381)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)(F)[CH]F(1098)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)(F)CF(1057)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(147.001,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'OC=C(F)CF(1480)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(4.82953,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'C=C(F)C(O)F(1481)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.26484,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'OC(F)=C(F)CF(1383)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(183.548,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'OC(F)C(F)=CF(1101)'],
    products = ['OC(F)C(F)(F)CF(1444)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(182.438,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

network(
    label = 'PDepNetwork #526',
    isomers = [
        'OC(F)C(F)(F)CF(1444)',
    ],
    reactants = [
