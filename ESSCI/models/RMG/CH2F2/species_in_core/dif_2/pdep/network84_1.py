...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(290)'],
    products = ['[O]C(=O)C([O])(F)F(246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(295)'],
    products = ['[O]C(=O)C([O])(F)F(246)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(176)', '[O][C]=O(188)'],
    products = ['[O]C(=O)C([O])(F)F(246)'],
