...
reaction(
    label = 'reaction4',
    reactants = ['CF2(89)', 'CF2(89)'],
    products = ['CF2CF2(60)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.26e+10,'cm^3/(mol*s)'), n=1.53, Ea=(0,'kJ/mol'), T0=(300,'K'), comment="""Matched reaction 6 CF2 + CF2-2 <=> C2F4 in halocarbene_recombination_double/training
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)(F)F(307)'],
    products = ['CF2CF2(60)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(5.731e+10,'s^-1'), n=0.827, Ea=(35644,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 4 C2F4 <=> C2F4-2 in Singlet_Carbene_Intra_Disproportionation/training
This reaction matched rate rule [CCY]
family: Singlet_Carbene_Intra_Disproportionation"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F2(108)', 'C2F2(98)'],
    products = ['CF2CF2(60)'],
    transitionState = 'TS4',
