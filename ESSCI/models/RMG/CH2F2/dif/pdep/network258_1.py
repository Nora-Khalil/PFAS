...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.24084,'amu*angstrom^2'), symmetry=1, barrier=(28.5293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.94849,0.0800176,-0.000163053,1.5823e-07,-5.69818e-11,-10276.8,24.6784], Tmin=(100,'K'), Tmax=(856.792,'K')), NASAPolynomial(coeffs=[6.98138,0.0231692,-1.33109e-05,2.64333e-09,-1.82651e-13,-10257.8,2.64958], Tmin=(856.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.2568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](F)F(171)', '[CH]F(128)'],
    products = ['[O]OC(F)(F)[CH]F(657)'],
    transitionState = 'TS4',
