...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.694003,'amu*angstrom^2'), symmetry=1, barrier=(15.9565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.69399,'amu*angstrom^2'), symmetry=1, barrier=(15.9562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36056,'amu*angstrom^2'), symmetry=1, barrier=(31.2819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-167.187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,2750,2850,1437.5,1250,1305,750,350,617,898,1187,204.385,204.399,204.563,204.707,205.441],'cm^-1')),
        HinderedRotor(inertia=(0.0040558,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401856,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0107215,'amu*angstrom^2'), symmetry=1, barrier=(32.7332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.654734,'amu*angstrom^2'), symmetry=1, barrier=(15.0536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.654426,'amu*angstrom^2'), symmetry=1, barrier=(15.0466,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.239628,'amu*angstrom^2'), symmetry=1, barrier=(5.50952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241126,'amu*angstrom^2'), symmetry=1, barrier=(5.54395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785782,'amu*angstrom^2'), symmetry=1, barrier=(18.0667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    E0 = (-656.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,235,523,627,1123,1142,1372,1406,3097,2750,2850,1437.5,1250,1305,750,350,180,180,1767.13],'cm^-1')),
        HinderedRotor(inertia=(0.427043,'amu*angstrom^2'), symmetry=1, barrier=(9.81857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15165,'amu*angstrom^2'), symmetry=1, barrier=(26.4787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.200579,'amu*angstrom^2'), symmetry=1, barrier=(4.61171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200084,'amu*angstrom^2'), symmetry=1, barrier=(4.60033,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221068,'amu*angstrom^2'), symmetry=1, barrier=(5.08278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03206,'amu*angstrom^2'), symmetry=1, barrier=(23.7292,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['COF(1655)', 'F[C]C(F)F(180)'],
    products = ['FOCC(F)C(F)F(2178)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(72)', 'FOC(F)C(F)F(1155)'],
    products = ['FOCC(F)C(F)F(2178)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'F[C]C(F)COF(2323)'],
    products = ['FOCC(F)C(F)F(2178)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(153)', 'C=C(F)C(F)F(1064)'],
    products = ['FOCC(F)C(F)F(2178)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(716)', 'C=CC(F)F(2325)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC[CH]C(F)F(2326)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)COF(2327)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)C(F)F(2328)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', '[CH2]C(F)C(F)F(2329)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(1634)', 'CHF2-CHF(66)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', 'F[CH]COF(2330)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC[C](F)C(F)F(2331)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FO[CH]C(F)C(F)F(2212)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FOCC(F)[C](F)F(2332)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)C(F)F(1936)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FOC=CC(F)F(2219)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FOCC=C(F)F(2334)'],
    products = ['FOCC(F)C(F)F(2178)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FOCC(F)C(F)F(2178)'],
    products = ['F2(106)', 'CH2O(19)', 'CHFCHF[Z](95)'],
