...
"""),
    E0 = (-567.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0979247,'amu*angstrom^2'), symmetry=1, barrier=(46.5061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45628,'amu*angstrom^2'), symmetry=1, barrier=(46.4526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0205,0.0423341,-4.48375e-05,2.27883e-08,-4.55458e-12,-68124.9,19.4157], Tmin=(100,'K'), Tmax=(1211.84,'K')), NASAPolynomial(coeffs=[11.6712,0.0104796,-5.40833e-06,1.09731e-09,-7.97665e-14,-70464,-28.9975], Tmin=(1211.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-567.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sF1sO2s)) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-260.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,1855,455,950,274.943,275.767,276.398],'cm^-1')),
        HinderedRotor(inertia=(0.06208,'amu*angstrom^2'), symmetry=1, barrier=(42.1507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.951266,'amu*angstrom^2'), symmetry=1, barrier=(51.2598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.952375,'amu*angstrom^2'), symmetry=1, barrier=(51.2708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96497,0.0484857,-6.32526e-05,4.19729e-08,-1.12107e-11,-31287.2,20.4236], Tmin=(100,'K'), Tmax=(907.27,'K')), NASAPolynomial(coeffs=[9.47304,0.0153825,-8.52031e-06,1.75369e-09,-1.27791e-13,-32649.5,-15.0676], Tmin=(907.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsH) + radical(CsF1sO2sO2s) + radical((O)CJOC)"""),
)

species(
    label = '[O][C](F)OC(=O)F(262)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-558.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([482,586,761,1411,482,664,788,1296,1923,424.194,424.435,424.448,424.493],'cm^-1')),
        HinderedRotor(inertia=(0.00093584,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000935663,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15259,0.0346502,-2.97031e-05,1.18681e-08,-1.84379e-12,-67130.3,22.4817], Tmin=(100,'K'), Tmax=(1553.37,'K')), NASAPolynomial(coeffs=[12.5886,0.00777703,-3.75329e-06,7.31152e-10,-5.14021e-14,-70372.5,-32.4622], Tmin=(1553.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFHOO) + group(COFOO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C([O])(F)F(144)'],
    products = ['[O]C(F)(F)O[C]=O(250)'],
    transitionState = 'TS2',
