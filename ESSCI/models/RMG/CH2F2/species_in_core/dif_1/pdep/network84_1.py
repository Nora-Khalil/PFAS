...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C([O])=O(237)'],
    products = ['[O]C(=O)O[C](F)F(243)'],
    transitionState = 'TS2',
