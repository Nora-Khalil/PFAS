...
species(
    label = '[CH2]C(F)(F)C(F)(F)[C](F)F(1061)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC1(F)CC(F)(F)C1(F)F(1076)',
...
species(
    label = 'F[C](F)C(F)(F)[CH]C(F)F(1078)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)C[C](F)C(F)(F)F(1079)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(1061)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'F[C](F)C[C](F)F(736)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    products = ['FC1(F)CC(F)(F)C1(F)F(1076)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    products = ['FC(F)=CC(F)(F)C(F)F(1077)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)CC(F)=C(F)F(934)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(60)', '[CH2][C](F)F(185)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(5.4417,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(230)', 'CH2CF2(56)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(7.21446,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C=C(F)F(758)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(230)', '[CH2][C](F)F(185)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(87)', 'F[C](F)C[C](F)F(736)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.24836,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)(F)[CH]C(F)F(1078)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)[CH]C(F)(F)C(F)F(505)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    products = ['F[C](F)C[C](F)C(F)(F)F(1079)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(1062)'],
    products = ['F[C](F)[C](F)CC(F)(F)F(1080)'],
...
network(
    label = 'PDepNetwork #471',
    isomers = [
        'F[C](F)CC(F)(F)[C](F)F(1062)',
    ],
    reactants = [
        ('CF2CF2(60)', 'CH2CF2(56)'),
    ],
