...
species(
    label = 'F[CH]C(F)(F)C(F)(F)[CH]F(719)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.368124,0.109521,-0.00020172,1.85286e-07,-6.44987e-11,-112311,31.6696], Tmin=(100,'K'), Tmax=(854.864,'K')), NASAPolynomial(coeffs=[10.3823,0.0316382,-1.66681e-05,3.23322e-09,-2.21722e-13,-113141,-12.615], Tmin=(854.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-935.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(F)C(F)=C(F)F(862)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0815841,'amu*angstrom^2'), symmetry=1, barrier=(1.87578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0416172,'amu*angstrom^2'), symmetry=1, barrier=(55.8446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849571,0.0759312,-0.00011326,9.05055e-08,-2.92269e-11,-77250.4,26.7006], Tmin=(100,'K'), Tmax=(755.21,'K')), NASAPolynomial(coeffs=[10.2903,0.0259277,-1.39424e-05,2.83167e-09,-2.03784e-13,-78676.4,-16.1949], Tmin=(755.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)F(866)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.544619,0.114386,-0.000213947,1.97699e-07,-6.90783e-11,-113284,32.6523], Tmin=(100,'K'), Tmax=(853.608,'K')), NASAPolynomial(coeffs=[10.6609,0.0321833,-1.73188e-05,3.38094e-09,-2.32471e-13,-114115,-13.2976], Tmin=(853.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'FCC(F)(F)[C](F)[C](F)F(867)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.464709,0.111805,-0.000206364,1.89968e-07,-6.64628e-11,-113029,32.5336], Tmin=(100,'K'), Tmax=(846.71,'K')), NASAPolynomial(coeffs=[10.6692,0.032154,-1.73327e-05,3.39839e-09,-2.34762e-13,-113945,-13.6021], Tmin=(846.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-941.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH]C(F)(F)[CH]C(F)(F)F(868)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.179556,0.103271,-0.000181713,1.66596e-07,-5.94249e-11,-120615,31.7106], Tmin=(100,'K'), Tmax=(807.6,'K')), NASAPolynomial(coeffs=[10.1022,0.0339154,-1.86627e-05,3.74036e-09,-2.63774e-13,-121675,-11.9746], Tmin=(807.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1004.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'F[C](F)[CH]C(F)(F)C(F)F(869)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0957995,0.103093,-0.000187384,1.74928e-07,-6.24066e-11,-117025,33.2943], Tmin=(100,'K'), Tmax=(837.066,'K')), NASAPolynomial(coeffs=[8.81512,0.0347039,-1.85844e-05,3.6577e-09,-2.5416e-13,-117613,-2.71016], Tmin=(837.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-974.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][C](F)C(F)C(F)(F)F(870)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495309,0.112938,-0.000209786,1.94432e-07,-6.8489e-11,-117123,31.3403], Tmin=(100,'K'), Tmax=(843.194,'K')), NASAPolynomial(coeffs=[10.4412,0.0331162,-1.8084e-05,3.5653e-09,-2.47164e-13,-117974,-13.6673], Tmin=(843.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-975.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(166)', 'F[CH]C(F)(F)[CH]F(804)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(128)', 'F[C](F)C(F)[C](F)F(761)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['FC1C(F)(F)C(F)C1(F)F(859)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['FCC(F)(F)C(F)=C(F)F(860)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=C(F)F(861)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=C(F)F(862)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=C(F)C(F)[C](F)F(863)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', 'F[CH]C(F)=C[C](F)F(864)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[C](F)F(865)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', 'F[CH]C(F)(F)[CH]F(804)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[C](F)C(F)[C](F)F(761)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)F(866)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['FCC(F)(F)[C](F)[C](F)F(867)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['F[CH]C(F)(F)[CH]C(F)(F)F(868)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)F(869)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(720)'],
    products = ['F[CH][C](F)C(F)C(F)(F)F(870)'],
...
network(
    label = 'PDepNetwork #305',
    isomers = [
        'F[CH]C(F)(F)C(F)[C](F)F(720)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CHFCF2(54)'),
    ],
