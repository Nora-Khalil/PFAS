...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.820626,0.0766882,-0.000126902,1.10656e-07,-3.81516e-11,-84688.5,27.0356], Tmin=(100,'K'), Tmax=(782.841,'K')), NASAPolynomial(coeffs=[9.92166,0.0235926,-1.25331e-05,2.50125e-09,-1.76771e-13,-85911.4,-13.3531], Tmin=(782.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]C[C](F)F(1170)'],
    products = ['F[C](F)CO[C](F)F(1175)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]O[C](F)F(1197)'],
    products = ['F[C](F)CO[C](F)F(1175)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(730)'],
    products = ['F[C](F)CO[C](F)F(1175)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH2]O[C](F)F(1197)'],
    products = ['F[C](F)CO[C](F)F(1175)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C[C](F)F(1170)'],
    products = ['F[C](F)CO[C](F)F(1175)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)CO[C](F)F(1175)'],
    products = ['F[C](F)O[CH]C(F)F(1199)'],
