...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(214)'],
    products = ['O=O(177)', 'CO2(13)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](157)', '[C]=O(222)'],
    products = ['[O]OO[C]=O(214)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]O[O](157)', 'CO(12)'],
    products = ['[O]OO[C]=O(214)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(68.2,'m^3/(mol*s)'), n=8.73864e-09, Ea=(11.4672,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O
Multiplied by reaction path degeneracy 2.0"""),
)
