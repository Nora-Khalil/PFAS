...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(266)'],
    products = ['FC1(F)[CH]OO1(1440)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(1442)'],
    products = ['[O]OC=C(F)F(266)'],
    transitionState = 'TS6',
