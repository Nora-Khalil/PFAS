...
"""),
    E0 = (-1308.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.518534,'amu*angstrom^2'), symmetry=1, barrier=(11.9221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26703,'amu*angstrom^2'), symmetry=1, barrier=(29.1316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51885,'amu*angstrom^2'), symmetry=1, barrier=(11.9294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.38068,0.0530995,3.5056e-05,-2.3092e-07,2.05911e-10,-157388,13.6526], Tmin=(10,'K'), Tmax=(471.425,'K')), NASAPolynomial(coeffs=[8.86446,0.0399008,-2.90011e-05,9.64239e-09,-1.19383e-12,-158276,-12.6079], Tmin=(471.425,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1308.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(F)C(F)(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07256,'amu*angstrom^2'), symmetry=1, barrier=(24.6604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07105,'amu*angstrom^2'), symmetry=1, barrier=(24.6256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16044,'amu*angstrom^2'), symmetry=1, barrier=(26.6808,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52995,0.0328068,-3.44818e-05,1.85825e-08,-4.03249e-12,-36585.7,15.5157], Tmin=(100,'K'), Tmax=(1107.53,'K')), NASAPolynomial(coeffs=[8.48484,0.0113002,-5.35438e-06,1.04981e-09,-7.49314e-14,-37904.7,-13.8215], Tmin=(1107.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-747.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,235,523,627,1123,1142,1372,1406,3097,617,898,1187,180,180,180,1260.16],'cm^-1')),
        HinderedRotor(inertia=(0.42531,'amu*angstrom^2'), symmetry=1, barrier=(9.77871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.943462,'amu*angstrom^2'), symmetry=1, barrier=(21.6921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21762,0.0664332,-9.99961e-05,7.86569e-08,-2.47513e-11,-89842.7,22.6319], Tmin=(100,'K'), Tmax=(777.474,'K')), NASAPolynomial(coeffs=[10.2024,0.0202047,-1.08007e-05,2.16915e-09,-1.54811e-13,-91239.7,-18.4525], Tmin=(777.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-734.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,347,453,1141,1468,617,898,1187,350.555,350.56,350.562,350.565],'cm^-1')),
        HinderedRotor(inertia=(0.105721,'amu*angstrom^2'), symmetry=1, barrier=(9.21957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338777,'amu*angstrom^2'), symmetry=1, barrier=(29.544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105725,'amu*angstrom^2'), symmetry=1, barrier=(9.21957,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0852,0.0687432,-9.24285e-05,6.34111e-08,-1.73653e-11,-88294.6,23.8648], Tmin=(100,'K'), Tmax=(889.771,'K')), NASAPolynomial(coeffs=[11.8714,0.0202534,-1.06828e-05,2.16242e-09,-1.56124e-13,-90214.1,-26.9124], Tmin=(889.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (150.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.66867,0.0221817,0.000216976,-5.80512e-07,4.30759e-10,-158278,14.492], Tmin=(10,'K'), Tmax=(484.762,'K')), NASAPolynomial(coeffs=[7.76542,0.0460751,-3.54906e-05,1.22185e-08,-1.54461e-12,-159353,-9.29836], Tmin=(484.762,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1316.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(F)(C(F)F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-896.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.468611,'amu*angstrom^2'), symmetry=1, barrier=(10.7743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17683,'amu*angstrom^2'), symmetry=1, barrier=(50.0497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.467917,'amu*angstrom^2'), symmetry=1, barrier=(10.7583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.41518,0.059831,-8.30343e-05,7.20961e-08,-2.76236e-11,-107875,13.8672], Tmin=(10,'K'), Tmax=(599.455,'K')), NASAPolynomial(coeffs=[6.85312,0.0368906,-2.56312e-05,8.25691e-09,-9.99767e-13,-108287,-0.959545], Tmin=(599.455,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-896.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""OC(F)[C](F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'O[CH]C(F)(F)C(F)F(1097)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-923.005,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,186.956,1989.19],'cm^-1')),
        HinderedRotor(inertia=(0.569835,'amu*angstrom^2'), symmetry=1, barrier=(14.1386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570005,'amu*angstrom^2'), symmetry=1, barrier=(14.139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33535,'amu*angstrom^2'), symmetry=1, barrier=(33.1295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.34893,0.0570263,-5.5881e-05,2.12168e-08,4.46595e-14,-111007,14.1338], Tmin=(10,'K'), Tmax=(746.98,'K')), NASAPolynomial(coeffs=[10.4697,0.0287198,-1.8768e-05,5.70158e-09,-6.5563e-13,-112345,-19.9774], Tmin=(746.98,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-923.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""O[CH]C(F)(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC(F)C(F)(F)[CH]F(1098)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-904.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.931113,'amu*angstrom^2'), symmetry=1, barrier=(21.4081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722962,'amu*angstrom^2'), symmetry=1, barrier=(16.6223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720634,'amu*angstrom^2'), symmetry=1, barrier=(16.5688,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.61372,0.0276986,0.00019677,-6.2102e-07,5.1851e-10,-108777,13.7847], Tmin=(10,'K'), Tmax=(445.015,'K')), NASAPolynomial(coeffs=[9.19041,0.0359085,-2.75334e-05,9.57229e-09,-1.22531e-12,-109851,-15.0945], Tmin=(445.015,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-904.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""OC(F)C(F)(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.126342,'amu*angstrom^2'), symmetry=1, barrier=(2.90485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274448,'amu*angstrom^2'), symmetry=1, barrier=(6.31009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1085.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,391,562,707,872,1109,1210,1289,3137,235,523,627,1123,1142,1372,1406,3097,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.887285,'amu*angstrom^2'), symmetry=1, barrier=(20.4004,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.41777,0.0572667,-4.79295e-05,1.15939e-08,2.49081e-12,-130557,13.5926], Tmin=(10,'K'), Tmax=(865.437,'K')), NASAPolynomial(coeffs=[12.7026,0.0270815,-1.76737e-05,5.28205e-09,-5.95213e-13,-132640,-32.6136], Tmin=(865.437,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1085.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""[O]C(F)C(F)(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.568917,'amu*angstrom^2'), symmetry=1, barrier=(13.0805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72071,'amu*angstrom^2'), symmetry=1, barrier=(16.5705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1116.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.374167,'amu*angstrom^2'), symmetry=1, barrier=(8.60284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374522,'amu*angstrom^2'), symmetry=1, barrier=(8.611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52669,'amu*angstrom^2'), symmetry=1, barrier=(12.1096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24442,0.0692509,-5.82355e-05,-9.43848e-08,1.58199e-10,-134254,14.7261], Tmin=(10,'K'), Tmax=(408.23,'K')), NASAPolynomial(coeffs=[9.52549,0.0339259,-2.47778e-05,8.30631e-09,-1.03759e-12,-134985,-12.625], Tmin=(408.23,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1116.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""O[C](F)C(F)(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC(F)C(F)(F)[C](F)F(1099)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1108.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.724482,'amu*angstrom^2'), symmetry=1, barrier=(16.6573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72394,'amu*angstrom^2'), symmetry=1, barrier=(16.6448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00752,'amu*angstrom^2'), symmetry=1, barrier=(23.1648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.44705,0.0444956,0.000125611,-5.05999e-07,4.56858e-10,-133291,14.0674], Tmin=(10,'K'), Tmax=(433.93,'K')), NASAPolynomial(coeffs=[10.0253,0.0364478,-2.83658e-05,9.86356e-09,-1.25936e-12,-134357,-17.8822], Tmin=(433.93,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1108.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""OC(F)C(F)(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'O=CC(F)(F)C(F)F(628)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.671653,'amu*angstrom^2'), symmetry=1, barrier=(15.4426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672853,'amu*angstrom^2'), symmetry=1, barrier=(15.4702,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-754.704,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,323,467,575,827,1418,3010,987.5,1337.5,450,1655,300.137],'cm^-1')),
        HinderedRotor(inertia=(0.303721,'amu*angstrom^2'), symmetry=1, barrier=(19.4147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484783,'amu*angstrom^2'), symmetry=1, barrier=(30.987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72036,0.027127,4.0538e-05,-1.08087e-07,6.26997e-11,-90766.8,12.4906], Tmin=(10,'K'), Tmax=(654.198,'K')), NASAPolynomial(coeffs=[6.43262,0.0324695,-2.19858e-05,6.86093e-09,-8.05545e-13,-91590.9,-3.02959], Tmin=(654.198,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-754.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""OCDC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC(F)C(F)=CF(1101)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.526484,'amu*angstrom^2'), symmetry=1, barrier=(12.1049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.527891,'amu*angstrom^2'), symmetry=1, barrier=(12.1373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.55767,'amu*angstrom^2'), symmetry=1, barrier=(12.8219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557162,'amu*angstrom^2'), symmetry=1, barrier=(12.8102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)C(F)(F)C(F)F(1045)'],
    products = ['HF(38)', 'CHFO(46)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.77205e+10,'s^-1'), n=1.0283, Ea=(243.91,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.7239647048627136, var=0.5241804487032486, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)C(F)F(681)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(343.867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'OC(F)[C]F(532)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(205.205,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)F(230)', 'F[C]C(F)F(231)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(193.458,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)(F)C(F)F(1017)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(52.2308,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)F(638)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(138.295,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'OC(F)C(F)(F)[C]F(1094)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(22.4644,'m^3/(mol*s)'), n=1.4485, Ea=(33.1835,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HY_N-3Br1sCCl1sF1sHI1s->F1s_N-4Br1sCl1sF1sI1s->Br1s_N-2Br1sCl1sF1sHI1s->H_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R',), comment="""Estimated from node HY_N-3Br1sCCl1sF1sHI1s->F1s_N-4Br1sCl1sF1sI1s->Br1s_N-2Br1sCl1sF1sHI1s->H_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R_Ext-3Br1sCCl1sHI1s-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', 'OC(F)C(F)(F)F(1029)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(160.899,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)C(F)(F)C(F)F(1045)'],
    products = ['OC(F)(C(F)F)C(F)F(1095)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)F(230)', 'CHFCF2(54)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)[C](F)C(F)F(1096)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[CH]C(F)(F)C(F)F(1097)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC(F)C(F)(F)[CH]F(1098)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.271022,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'F[CH]C(F)(F)C(F)F(683)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)(F)C(F)F(649)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[CH]F(290)', 'CHF2-CF2(68)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(81)', 'OC(F)[C](F)F(540)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O[C](F)C(F)(F)C(F)F(1022)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(F)C(F)(F)[C](F)F(1099)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=CC(F)(F)C(F)F(628)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(149.495,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'OC=C(F)C(F)F(1100)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(5.50097,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'OC(F)C(F)=CF(1101)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(4.32338,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC(F)=C(F)C(F)F(1026)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(187.139,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'OC(F)C(F)=C(F)F(790)'],
    products = ['OC(F)C(F)(F)C(F)F(1045)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(178.193,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #367',
    isomers = [
        'OC(F)C(F)(F)C(F)F(1045)',
    ],
    reactants = [
