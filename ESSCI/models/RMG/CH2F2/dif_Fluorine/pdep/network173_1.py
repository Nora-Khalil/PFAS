...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.257959,'amu*angstrom^2'), symmetry=1, barrier=(5.93097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258093,'amu*angstrom^2'), symmetry=1, barrier=(5.93407,'kJ/mol'), semiclassical=False),
...
reaction(
    ...
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(18.9033,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(556)'],
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(557)'],
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'F[CH]OC(F)(F)F(558)'],
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(559)'],
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(392)'],
    products = ['OC(F)OC(F)(F)F(440)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(560)'],
    products = ['OC(F)OC(F)(F)F(440)'],
