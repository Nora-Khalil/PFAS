...
"""),
    E0 = (-216.391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([194,682,905,1196,1383,3221,350,440,435,1725,971.27,971.394],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0265,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.65012,0.017516,-7.47388e-06,3.1283e-10,1.86786e-13,-26022.4,12.2475], Tmin=(100,'K'), Tmax=(2155.49,'K')), NASAPolynomial(coeffs=[14.5245,0.00476204,-3.76605e-06,7.64342e-10,-5.09573e-14,-32435.4,-52.5683], Tmin=(2155.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.87712,0.00439418,7.92639e-05,-1.11352e-07,4.36126e-11,-56897.4,14.9214], Tmin=(100,'K'), Tmax=(959.892,'K')), NASAPolynomial(coeffs=[15.2643,0.00428664,-1.06367e-06,3.43793e-10,-3.8546e-14,-61648.6,-56.6938], Tmin=(959.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.1948,0.0227232,-1.2488e-05,2.63728e-09,-1.89434e-13,-912.125,17.6822], Tmin=(100,'K'), Tmax=(2347.65,'K')), NASAPolynomial(coeffs=[15.8011,0.00466698,-3.13823e-06,6.03242e-10,-3.89659e-14,-7774.42,-55.9035], Tmin=(2347.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.78475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])OC1F(457)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-451.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,280,501,1494,1531,180,180,180,180,882.41,882.97],'cm^-1')),
        HinderedRotor(inertia=(0.00329775,'amu*angstrom^2'), symmetry=1, barrier=(1.8245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00329713,'amu*angstrom^2'), symmetry=1, barrier=(1.82281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41906,0.0432703,-8.17465e-05,8.32629e-08,-3.13061e-11,-54277.1,17.909], Tmin=(100,'K'), Tmax=(869.434,'K')), NASAPolynomial(coeffs=[2.28286,0.0232634,-1.16312e-05,2.20371e-09,-1.49255e-13,-53473.5,23.0319], Tmin=(869.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH)) + radical(CsCOF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.67053,0.0349918,-5.54601e-05,5.87191e-08,-2.44125e-11,-54388.7,17.3043], Tmin=(100,'K'), Tmax=(795.764,'K')), NASAPolynomial(coeffs=[1.7385,0.0263017,-1.38678e-05,2.75272e-09,-1.94311e-13,-53816.9,24.2487], Tmin=(795.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-91.8413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3010,987.5,1337.5,450,1655,350,440,435,1725,231.946,232.029,232.2],'cm^-1')),
        HinderedRotor(inertia=(0.796217,'amu*angstrom^2'), symmetry=1, barrier=(30.3121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(458)'],
    products = ['[O]C(=O)C([O])F(424)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(149)', 'CHFO(46)'],
    products = ['[O]C(=O)C([O])F(424)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(92.2597,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(=O)F(282)'],
    products = ['[O]C(=O)C([O])F(424)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(149)', '[O][CH]F(135)'],
    products = ['[O]C(=O)C([O])F(424)'],
