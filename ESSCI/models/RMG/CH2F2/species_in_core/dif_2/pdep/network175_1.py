...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C(F)F(372)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]C(F)C(F)F-2(1601)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC(F)=CC(F)F(809)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC(F)=C(F)C(F)F(992)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)[CH]C(F)F(1476)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(F)[C](F)F(483)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', 'F[CH][C](F)F(183)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C](F)[C](F)C(F)F(1602)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)[C](F)F(459)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(106)', 'F[CH]C=C(F)F(1477)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'FC=C(F)[C](F)F(1603)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[C](F)C=C(F)F(1604)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'F[C]C(F)C(F)F(1156)'],
    products = ['F[C](F)C(F)C(F)F(371)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)F(371)'],
    products = ['F[C](C(F)F)C(F)F(1605)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C(F)F(371)'],
    products = ['F[CH]C(F)C(F)(F)F(1607)'],
