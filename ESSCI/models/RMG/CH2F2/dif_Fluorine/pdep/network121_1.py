...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(F)O[C](O)F(389)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(390)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(143)', 'O[C](F)F(237)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(50)', '[O]C(O)(F)F(190)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(4)', 'O=C(F)O[C](F)F(286)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(F)OC(=O)F(321)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(391)'],
    products = ['O=C(F)OC(O)(F)F(324)'],
