...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58609,0.0571437,-8.68652e-05,7.15981e-08,-2.34366e-11,-53011,24.7725], Tmin=(100,'K'), Tmax=(820.826,'K')), NASAPolynomial(coeffs=[8.48068,0.0190484,-9.03087e-06,1.70724e-09,-1.16995e-13,-53991.4,-6.20581], Tmin=(820.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-441.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(CJCO) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56957,0.054151,-7.3019e-05,5.25021e-08,-1.44788e-11,-33134.2,23.1749], Tmin=(100,'K'), Tmax=(1023.63,'K')), NASAPolynomial(coeffs=[9.63811,0.0150096,-4.50751e-06,6.17266e-10,-3.27247e-14,-34387.3,-13.9915], Tmin=(1023.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFFHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)O1(3362)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32253,0.0377913,-2.85275e-05,1.0406e-08,-1.55376e-12,-43210.2,19.592], Tmin=(100,'K'), Tmax=(1515.16,'K')), NASAPolynomial(coeffs=[9.86867,0.0178696,-8.80513e-06,1.72823e-09,-1.21944e-13,-45496.9,-19.9494], Tmin=(1515.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(Cs_P) + radical(CJCO)"""),
)
...
"""),
    E0 = (-290.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,493,600,700,1144,1293,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.823111,'amu*angstrom^2'), symmetry=1, barrier=(18.9249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.824386,'amu*angstrom^2'), symmetry=1, barrier=(18.9542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.824456,'amu*angstrom^2'), symmetry=1, barrier=(18.9559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799586,0.0641583,-7.56198e-05,3.76103e-08,-5.92616e-12,-34803.4,23.3629], Tmin=(100,'K'), Tmax=(956.797,'K')), NASAPolynomial(coeffs=[18.8234,0.00245796,-2.89995e-07,3.34305e-11,-3.75432e-15,-38877.3,-66.0605], Tmin=(956.797,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=O)OC(F)F(3366)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28835,0.0408168,-3.53457e-05,1.62678e-08,-3.20596e-12,-50997.1,21.717], Tmin=(100,'K'), Tmax=(1155.98,'K')), NASAPolynomial(coeffs=[7.73762,0.0219609,-1.08783e-05,2.15713e-09,-1.54289e-13,-52257,-5.36237], Tmin=(1155.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(3300)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=O)O[C](F)F(3300)'],
    products = ['F[C](F)O[C]1CO1(3361)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.95361e+10,'s^-1'), n=0.549916, Ea=(165.233,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(3300)'],
    products = ['[CH2][C]1OC(F)(F)O1(3362)'],
    transitionState = 'TS6',
...
reaction(
    ...
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(146.964,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 146.4 to 147.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2]C(=O)O[C](F)F(3300)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(78.2575,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)
...
reaction(
    ...
    products = ['[CH2]C(=O)O[C](F)F(3300)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(13.8013,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(257654,'m^3/(mol*s)'), n=0.469398, Ea=(8.01303,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
network(
    label = 'PDepNetwork #1257',
    isomers = [
        '[CH2]C(=O)O[C](F)F(3300)',
    ],
    reactants = [
        ('CF2O(48)', 'CH2CO(75)'),
    ],
