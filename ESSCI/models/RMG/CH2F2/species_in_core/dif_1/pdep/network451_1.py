...
reaction(
    ...
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.68018e-11,'m^3/(mol*s)'), n=4.72997, Ea=(125.788,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(O)C(F)(F)[C]F(1282)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(88)', 'O=C(O)C(F)(F)F(443)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(150.914,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CO2(13)', 'FC(F)C(F)F(130)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)F(164)', 'CF2CO(106)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OC(OC(F)F)=C(F)F(1283)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])C(F)(F)C(F)F(1284)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[C](F)F(1285)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[C](F)F(1286)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)C(F)F(1287)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(O)C(F)(F)[CH]F(1288)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(F)(F)C(F)F(869)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)C(F)F(804)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(81)', 'O=C(O)[C](F)F(833)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(191)', 'CHF2-CF2(68)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[C](F)F(802)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(108)', 'O=C(O)C(F)=CF(1289)'],
    products = ['O=C(O)C(F)(F)C(F)F(333)'],
...
network(
    ...
    isomers = [
        'O=C(O)C(F)(F)C(F)F(333)',
    ],
    reactants = [
        ('HF(38)', 'CO2(13)', 'CHFCF2(54)'),
        ('CO2(13)', 'FC(F)C(F)F(130)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
