...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.39066,'amu*angstrom^2'), symmetry=1, barrier=(31.9739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38982,'amu*angstrom^2'), symmetry=1, barrier=(31.9547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39126,'amu*angstrom^2'), symmetry=1, barrier=(31.9878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.108196,'amu*angstrom^2'), symmetry=1, barrier=(2.48764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105352,'amu*angstrom^2'), symmetry=1, barrier=(2.42226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813578,'amu*angstrom^2'), symmetry=1, barrier=(18.7058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.478493,0.0836313,-0.000134093,1.08591e-07,-3.46524e-11,-115062,26.637], Tmin=(100,'K'), Tmax=(770.718,'K')), NASAPolynomial(coeffs=[12.663,0.0204111,-1.10846e-05,2.21819e-09,-1.57151e-13,-116941,-28.9762], Tmin=(770.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-957.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.409958,'amu*angstrom^2'), symmetry=1, barrier=(9.42574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09286,'amu*angstrom^2'), symmetry=1, barrier=(25.1269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410065,'amu*angstrom^2'), symmetry=1, barrier=(9.42819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.351392,'amu*angstrom^2'), symmetry=1, barrier=(8.07919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351614,'amu*angstrom^2'), symmetry=1, barrier=(8.08429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'OC(F)(F)CF(320)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'OC(F)(F)[C]F(715)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(254)', 'F[C]CF-2(186)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'OC(F)(F)C(F)(F)[C]F(1340)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(86)', 'OC(F)(F)C(F)F(322)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(72)', 'OC(F)(F)C(F)(F)F(1341)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(153)', 'FCC(F)=C(F)F(811)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[C](F)CF(1343)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)(F)CF(1344)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)F(1345)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'FCC(F)(F)[C](F)F(1150)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)CF(1149)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(232)', 'CH2F-CF2(67)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(89)', 'OC(F)(F)[C](F)F(725)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[CH]F(1346)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', 'OC(F)=C(F)CF(1347)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(106)', 'C=C(F)C(O)(F)F(1348)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=CF(1349)'],
    products = ['OC(F)(F)C(F)(F)CF(1202)'],
...
network(
    label = 'PDepNetwork #506',
    isomers = [
        'OC(F)(F)C(F)(F)CF(1202)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CH2CF2(56)'),
        ('O[C](F)F(232)', 'CH2F-CF2(67)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
