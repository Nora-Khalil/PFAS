...
"""),
    E0 = (-590.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,180,180.042,449.976,450.623,453.453,456.805,2997.03,3001.18],'cm^-1')),
        HinderedRotor(inertia=(0.0169909,'amu*angstrom^2'), symmetry=1, barrier=(2.42694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245144,'amu*angstrom^2'), symmetry=1, barrier=(35.2099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84662,0.0499745,-7.53347e-05,5.62098e-08,-1.63578e-11,-70982.1,21.6039], Tmin=(100,'K'), Tmax=(847.311,'K')), NASAPolynomial(coeffs=[10.2434,0.010337,-5.16765e-06,1.00489e-09,-7.03254e-14,-72405.1,-17.5146], Tmin=(847.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70984,0.00775424,7.15357e-05,-1.05191e-07,4.16541e-11,-110790,15.1828], Tmin=(100,'K'), Tmax=(966.878,'K')), NASAPolynomial(coeffs=[16.6559,0.0021684,-6.40343e-07,3.15775e-10,-3.86791e-14,-115922,-64.2251], Tmin=(966.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-921.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(CsFFOO) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)

species(
    label = 'F[C](F)O[C]1OO1(263)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05961,0.046697,-7.52478e-05,6.47509e-08,-2.19269e-11,-25849.1,21.9493], Tmin=(100,'K'), Tmax=(823.112,'K')), NASAPolynomial(coeffs=[7.28365,0.0154865,-7.75817e-06,1.49289e-09,-1.03029e-13,-26511.8,-1.03835], Tmin=(823.112,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(CsFFHO) + ring(dioxirane) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][C]1OC(F)(F)O1(264)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.02565,0.0365757,-8.93184e-05,1.19012e-07,-5.36964e-11,-58655.1,17.6179], Tmin=(100,'K'), Tmax=(823.27,'K')), NASAPolynomial(coeffs=[-6.86778,0.0428627,-2.46467e-05,4.99657e-09,-3.53942e-13,-55610.2,72.0234], Tmin=(823.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]C([O])=O(188)'],
    products = ['[O]C(=O)O[C](F)F(249)'],
    transitionState = 'TS2',
