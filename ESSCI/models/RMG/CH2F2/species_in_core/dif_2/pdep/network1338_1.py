...
"""),
    E0 = (-353.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,339.709,339.713,339.743,339.944],'cm^-1')),
        HinderedRotor(inertia=(0.00145969,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202998,'amu*angstrom^2'), symmetry=1, barrier=(16.6315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202944,'amu*angstrom^2'), symmetry=1, barrier=(16.6316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0911117,0.0831555,-0.000102154,6.08291e-08,-1.39764e-11,-42352.7,31.6532], Tmin=(100,'K'), Tmax=(1074.4,'K')), NASAPolynomial(coeffs=[18.612,0.0142012,-5.88423e-06,1.09258e-09,-7.62769e-14,-46332.5,-59.0283], Tmin=(1074.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03486,'amu*angstrom^2'), symmetry=1, barrier=(23.7935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03459,'amu*angstrom^2'), symmetry=1, barrier=(23.7872,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70611,0.0542027,-7.61334e-05,5.81304e-08,-1.79178e-11,-18087.9,19.9304], Tmin=(100,'K'), Tmax=(791.458,'K')), NASAPolynomial(coeffs=[8.68972,0.0189111,-9.2538e-06,1.80111e-09,-1.26596e-13,-19193.4,-12.1288], Tmin=(791.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.564127,0.0818622,-0.000114746,8.63086e-08,-2.62538e-11,-107685,26.5355], Tmin=(100,'K'), Tmax=(800.461,'K')), NASAPolynomial(coeffs=[11.26,0.0284168,-1.46001e-05,2.90647e-09,-2.07167e-13,-109398,-22.686], Tmin=(800.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-896.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)CC1(F)[CH]OO1(3968)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.850774,0.0773378,-0.000118378,1.09253e-07,-4.13655e-11,-64150.2,26.9994], Tmin=(100,'K'), Tmax=(754.009,'K')), NASAPolynomial(coeffs=[6.07526,0.0389459,-2.0764e-05,4.16722e-09,-2.96928e-13,-64634.6,5.28189], Tmin=(754.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(Cs(O2)-O2s-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-520.337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,180,2310.68],'cm^-1')),
        HinderedRotor(inertia=(0.546044,'amu*angstrom^2'), symmetry=1, barrier=(12.5546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56223,'amu*angstrom^2'), symmetry=1, barrier=(35.9188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.545757,'amu*angstrom^2'), symmetry=1, barrier=(12.548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74413,0.081639,-0.000142358,1.32298e-07,-4.7406e-11,-62474.6,25.1473], Tmin=(100,'K'), Tmax=(835.373,'K')), NASAPolynomial(coeffs=[7.07458,0.0313977,-1.63592e-05,3.18668e-09,-2.20657e-13,-62836.8,-0.092666], Tmin=(835.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.543868,0.0823014,-0.000115903,8.72792e-08,-2.65361e-11,-71666.6,29.9424], Tmin=(100,'K'), Tmax=(801.387,'K')), NASAPolynomial(coeffs=[11.4029,0.028099,-1.44465e-05,2.87597e-09,-2.04961e-13,-73407,-20.0414], Tmin=(801.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCJCO)"""),
)

species(
    label = 'O=CC(O)(F)[CH][C](F)F(3975)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50565,0.0857002,-0.000123204,8.65074e-08,-2.03664e-11,-76862.7,30.6879], Tmin=(100,'K'), Tmax=(612.666,'K')), NASAPolynomial(coeffs=[11.189,0.028753,-1.51253e-05,3.01056e-09,-2.13387e-13,-78412,-17.58], Tmin=(612.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-640.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]C(O)(F)C[C](F)F(3976)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0668776,0.0982247,-0.000166507,1.44634e-07,-4.88703e-11,-81646,31.022], Tmin=(100,'K'), Tmax=(826.206,'K')), NASAPolynomial(coeffs=[11.8882,0.0273618,-1.42816e-05,2.78282e-09,-1.92764e-13,-83178.3,-21.6902], Tmin=(826.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)CC(F)F(3977)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0992014,0.0927876,-0.000148723,1.24588e-07,-4.12166e-11,-76455.4,29.8464], Tmin=(100,'K'), Tmax=(798.385,'K')), NASAPolynomial(coeffs=[12.1426,0.0266518,-1.35767e-05,2.64319e-09,-1.83995e-13,-78193.7,-24.3871], Tmin=(798.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C(C[C](F)F)OF(3978)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-349.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,327.731,327.738,327.741,327.744],'cm^-1')),
        HinderedRotor(inertia=(0.00156946,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292122,'amu*angstrom^2'), symmetry=1, barrier=(22.2664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292137,'amu*angstrom^2'), symmetry=1, barrier=(22.2664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124442,0.0802833,-9.154e-05,5.0071e-08,-1.05794e-11,-41912.3,31.443], Tmin=(100,'K'), Tmax=(1164.58,'K')), NASAPolynomial(coeffs=[19.4274,0.0139817,-6.14079e-06,1.18304e-09,-8.44772e-14,-46408.1,-64.6233], Tmin=(1164.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C=C([O])CC(F)(F)F(3979)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26335,0.0800811,-8.92403e-05,4.67671e-08,-9.22918e-12,-98205.8,30.5483], Tmin=(100,'K'), Tmax=(1352.1,'K')), NASAPolynomial(coeffs=[22.5821,0.00659229,-1.1634e-06,1.10613e-10,-5.40855e-15,-103844,-84.5637], Tmin=(1352.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-817.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(=COF)C[C](F)F(3965)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C=C(F)C[C](F)F(2730)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2(42)', '[CH2]C([O])(F)C=O(3966)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['O=CC(O)(F)C=C(F)F(3967)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['F[C](F)CC1(F)[CH]OO1(3968)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['[O]C1OC1(F)C[C](F)F(3970)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=CC(=O)C[C](F)F(3972)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HCO(14)', 'O=C(F)C[C](F)F(738)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)(C=O)C=C(F)F(3800)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[O]C=C([O])C=C(F)F(3802)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CF2(87)', '[CH2]C([O])(F)C=O(3966)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['[O]C(F)([CH]C(F)F)C=O(3974)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['O=CC(O)(F)[CH][C](F)F(3975)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['O=[C]C(O)(F)C[C](F)F(3976)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['[O]C(F)([C]=O)CC(F)F(3977)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=C(C[C](F)F)OF(3978)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['[O]C=C([O])CC(F)(F)F(3979)'],
