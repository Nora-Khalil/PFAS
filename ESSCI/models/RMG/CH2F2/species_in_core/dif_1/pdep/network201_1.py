...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(372)'],
    products = ['[O]C(F)O[C](F)F(458)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(363)'],
    products = ['[O]C(F)O[C](F)F(458)'],
    transitionState = 'TS9',
