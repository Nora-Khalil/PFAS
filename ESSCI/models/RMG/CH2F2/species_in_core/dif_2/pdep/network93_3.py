...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.172188,'amu*angstrom^2'), symmetry=1, barrier=(3.95895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172262,'amu*angstrom^2'), symmetry=1, barrier=(3.96065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06258,0.0701987,-0.00012032,1.02513e-07,-3.39389e-11,-59837.8,25.2502], Tmin=(100,'K'), Tmax=(806.556,'K')), NASAPolynomial(coeffs=[11.0456,0.0153195,-8.27172e-06,1.64422e-09,-1.15246e-13,-61273.5,-19.6834], Tmin=(806.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C](F)C(F)(F)OF(307)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,395,473,707,1436,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.359193,'amu*angstrom^2'), symmetry=1, barrier=(8.25854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359252,'amu*angstrom^2'), symmetry=1, barrier=(8.2599,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12486,0.106885,-0.000241493,2.36729e-07,-8.31186e-11,-62270.9,24.1679], Tmin=(100,'K'), Tmax=(903.351,'K')), NASAPolynomial(coeffs=[7.1628,0.0223506,-1.25028e-05,2.33332e-09,-1.50291e-13,-61364.8,2.9825], Tmin=(903.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sO2s)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(304)'],
    products = ['[O]C(F)(F)C([O])(F)F(255)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(106)', '[O][C](F)C(=O)F(305)'],
    products = ['[O]C(F)(F)C([O])(F)F(255)'],
    transitionState = 'TS7',
