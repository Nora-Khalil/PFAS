...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)O[C](F)F(361)'],
    products = ['[O]C(F)(F)O[C](F)F(335)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[C](F)F(363)'],
    products = ['[O]C(F)(F)O[C](F)F(335)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(89)', '[O]C([O])(F)F(152)'],
    products = ['[O]C(F)(F)O[C](F)F(335)'],
    transitionState = 'TS8',
