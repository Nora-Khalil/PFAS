...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[CH]F(200)'],
    products = ['O=O(177)', 'CHFO(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](157)', 'CHF(40)'],
    products = ['[O]OO[CH]F(200)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.27e+09,'s^-1'), n=1.06, Ea=(129.704,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;C_sec_rad_intra;OOJ]
Euclidian distance = 0
