...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02873,'amu*angstrom^2'), symmetry=1, barrier=(23.6525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02806,'amu*angstrom^2'), symmetry=1, barrier=(23.6371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02803,'amu*angstrom^2'), symmetry=1, barrier=(23.6363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196432,0.0794784,-9.43608e-05,5.29016e-08,-1.14062e-11,-140009,26.1331], Tmin=(100,'K'), Tmax=(1143.6,'K')), NASAPolynomial(coeffs=[19.5696,0.0117156,-5.47877e-06,1.08671e-09,-7.88804e-14,-144440,-69.9303], Tmin=(1143.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1165.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-917.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,3025,407.5,1350,352.5,190,488,555,1236,1407,194.437,194.462,194.514,194.594],'cm^-1')),
        HinderedRotor(inertia=(0.265677,'amu*angstrom^2'), symmetry=1, barrier=(7.14537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00444542,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266525,'amu*angstrom^2'), symmetry=1, barrier=(7.14587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11094,'amu*angstrom^2'), symmetry=1, barrier=(29.8363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.163325,0.101247,-0.000179656,1.57812e-07,-5.32754e-11,-110220,30.3616], Tmin=(100,'K'), Tmax=(838.687,'K')), NASAPolynomial(coeffs=[12.6001,0.0242684,-1.31748e-05,2.58047e-09,-1.78282e-13,-111795,-25.5925], Tmin=(838.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-917.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](F)OC(F)[C](F)F(2164)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-867.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,586,761,1411,333.586,333.596,333.596,333.603],'cm^-1')),
        HinderedRotor(inertia=(0.0996142,'amu*angstrom^2'), symmetry=1, barrier=(7.86645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233723,'amu*angstrom^2'), symmetry=1, barrier=(18.4572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428187,'amu*angstrom^2'), symmetry=1, barrier=(33.8138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.42817,'amu*angstrom^2'), symmetry=1, barrier=(33.8138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.61799,0.0783548,-9.82572e-05,6.09911e-08,-1.50246e-11,-104166,29.425], Tmin=(100,'K'), Tmax=(987.064,'K')), NASAPolynomial(coeffs=[14.7163,0.0212213,-1.14322e-05,2.34806e-09,-1.71445e-13,-106949,-38.4075], Tmin=(987.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-867.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.213608,'amu*angstrom^2'), symmetry=1, barrier=(4.91127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21073,'amu*angstrom^2'), symmetry=1, barrier=(4.84509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807555,'amu*angstrom^2'), symmetry=1, barrier=(18.5673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292399,0.0917366,-0.000166905,1.51847e-07,-5.2978e-11,-106900,29.2181], Tmin=(100,'K'), Tmax=(830.123,'K')), NASAPolynomial(coeffs=[10.379,0.0250891,-1.38693e-05,2.75972e-09,-1.92772e-13,-107953,-13.8212], Tmin=(830.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-889.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O]C(F)(F)OC(F)[C](F)F(2165)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1037.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,190,488,555,1236,1407,203.139,203.151,203.17,203.179],'cm^-1')),
        HinderedRotor(inertia=(0.795824,'amu*angstrom^2'), symmetry=1, barrier=(23.3045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00408438,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27312,'amu*angstrom^2'), symmetry=1, barrier=(37.2827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446932,0.0839385,-0.000110089,7.20207e-08,-1.87799e-11,-124661,29.7298], Tmin=(100,'K'), Tmax=(932.364,'K')), NASAPolynomial(coeffs=[14.4847,0.023711,-1.31886e-05,2.73082e-09,-1.9985e-13,-127278,-37.0104], Tmin=(932.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)O[C](F)[C](F)F(2166)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1100.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,395,473,707,1436,190,488,555,1236,1407,199.149,199.735,201.274,1872.64],'cm^-1')),
        HinderedRotor(inertia=(0.269622,'amu*angstrom^2'), symmetry=1, barrier=(7.68463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268885,'amu*angstrom^2'), symmetry=1, barrier=(7.66749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13477,'amu*angstrom^2'), symmetry=1, barrier=(32.2617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12998,'amu*angstrom^2'), symmetry=1, barrier=(32.2498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0427209,0.0978674,-0.000167065,1.47264e-07,-5.13009e-11,-132233,32.9061], Tmin=(100,'K'), Tmax=(771.203,'K')), NASAPolynomial(coeffs=[11.8039,0.0283607,-1.61929e-05,3.28727e-09,-2.34018e-13,-133820,-19.6148], Tmin=(771.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1100.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)OC(F)[C](F)F(918)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1038.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,664,788,1296,1923,272.817,272.939,272.973,273.021],'cm^-1')),
        HinderedRotor(inertia=(0.618606,'amu*angstrom^2'), symmetry=1, barrier=(33.1668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394245,'amu*angstrom^2'), symmetry=1, barrier=(20.7768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0310748,'amu*angstrom^2'), symmetry=1, barrier=(33.1773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22028,0.0648673,-7.24186e-05,4.00588e-08,-8.93275e-12,-124806,26.0178], Tmin=(100,'K'), Tmax=(1074.07,'K')), NASAPolynomial(coeffs=[12.8682,0.0214884,-1.18371e-05,2.45606e-09,-1.803e-13,-127308,-31.0088], Tmin=(1074.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1038.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-1245.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,375,486,586,623,710,938,1161,1294,322.331,322.334,322.348,322.349],'cm^-1')),
        HinderedRotor(inertia=(0.332537,'amu*angstrom^2'), symmetry=1, barrier=(24.5178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103285,'amu*angstrom^2'), symmetry=1, barrier=(7.61541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435648,'amu*angstrom^2'), symmetry=1, barrier=(32.1229,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374857,0.0831379,-9.8558e-05,5.79912e-08,-1.35842e-11,-149658,28.5285], Tmin=(100,'K'), Tmax=(1034.22,'K')), NASAPolynomial(coeffs=[15.7011,0.0238608,-1.25836e-05,2.57095e-09,-1.87409e-13,-152828,-45.9274], Tmin=(1034.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1245.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = 'OC(F)(F)O[CH]C(F)(F)F(2170)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.520751,0.109498,-0.000190831,1.66852e-07,-5.64613e-11,-162952,30.2488], Tmin=(100,'K'), Tmax=(826.478,'K')), NASAPolynomial(coeffs=[13.2618,0.0277111,-1.50195e-05,2.95569e-09,-2.05394e-13,-164715,-30.5009], Tmin=(826.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1356.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFOO) + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H))"""),
)

species(
    label = 'O[C](F)OC(F)C(F)(F)F(2171)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F(2160)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', 'OC(F)(F)O[CH]F(602)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)(F)OC=C(F)F(2161)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(O)(F)F(155)', 'CHFCF2(54)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=C(F)F(2162)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(F)(F)O[CH][C](F)F(2163)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)OC(F)[C](F)F(2164)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(155)', 'F[CH][C](F)F(635)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'F[C](F)OC(F)[C](F)F(701)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)[C](F)F(2165)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)[C](F)F(2166)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)OC(F)[C](F)F(918)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F-2(2167)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(42)', 'OC(F)(F)O[CH]F(602)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    products = ['OC(F)(F)O[C](F)C(F)F(2168)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)OC(F)C(F)F(2169)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1931)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    products = ['OC(F)(F)O[CH]C(F)(F)F(2170)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1931)'],
    products = ['O[C](F)OC(F)C(F)(F)F(2171)'],
...
network(
    label = 'PDepNetwork #858',
    isomers = [
        'OC(F)(F)OC(F)[C](F)F(1931)',
    ],
    reactants = [
