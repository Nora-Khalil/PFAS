...
reaction(
    ...
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C(F)[C](F)F(1066)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(42)', 'F[CH]C[C](F)F(1013)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.79811,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(593)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C](F)CC=C(F)F(1070)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(9.5718,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(1071)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(595)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(89)', '[CH2]C(F)[C](F)F(1066)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(89)', 'F[CH]C[C](F)F(1013)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)[CH]C(F)F(1072)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)CC(F)[C](F)F(1036)'],
    products = ['F[C](F)[C](F)CC(F)F(1074)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)[CH]C(F)C(F)F(1075)'],
    products = ['F[C](F)CC(F)[C](F)F(1036)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(1036)'],
    products = ['F[C](F)[CH]CC(F)(F)F(1076)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(1036)'],
    products = ['F[C](F)C[CH]C(F)(F)F(1077)'],
...
network(
    label = 'PDepNetwork #411',
    isomers = [
        'F[C](F)CC(F)[C](F)F(1036)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CF2(56)'),
    ],
