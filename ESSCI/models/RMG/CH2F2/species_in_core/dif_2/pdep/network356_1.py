...
"""),
    E0 = (-591.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,190,488,555,1236,1407,3000,3100,440,815,1455,1000,209.791,209.792],'cm^-1')),
        HinderedRotor(inertia=(0.2246,'amu*angstrom^2'), symmetry=1, barrier=(7.01472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224599,'amu*angstrom^2'), symmetry=1, barrier=(7.01472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224599,'amu*angstrom^2'), symmetry=1, barrier=(7.01471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218872,0.0929952,-0.000159977,1.44099e-07,-5.02937e-11,-70973.6,26.8023], Tmin=(100,'K'), Tmax=(828.742,'K')), NASAPolynomial(coeffs=[9.61799,0.0304658,-1.57348e-05,3.07555e-09,-2.13659e-13,-71942.1,-13.2213], Tmin=(828.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.244005,0.0884732,-0.000129913,9.82444e-08,-2.93977e-11,-71587.4,25.4496], Tmin=(100,'K'), Tmax=(820.069,'K')), NASAPolynomial(coeffs=[13.4628,0.0239951,-1.19726e-05,2.36348e-09,-1.67507e-13,-73755.4,-35.701], Tmin=(820.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'F[C](F)CC[C](F)F(814)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-579.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,146,234,414,562,504,606,1176,1296,1354,1460,180,897.664,900.8],'cm^-1')),
        HinderedRotor(inertia=(0.231013,'amu*angstrom^2'), symmetry=1, barrier=(5.31144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231637,'amu*angstrom^2'), symmetry=1, barrier=(5.32578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228036,'amu*angstrom^2'), symmetry=1, barrier=(5.24299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993831,0.0757201,-0.000124434,1.19694e-07,-4.54449e-11,-69582.9,27.0894], Tmin=(100,'K'), Tmax=(798.81,'K')), NASAPolynomial(coeffs=[4.8079,0.038375,-2.00445e-05,3.97852e-09,-2.80597e-13,-69610.1,13.1893], Tmin=(798.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.84833,0.0093471,0.000169538,-3.60824e-07,2.29273e-10,-103188,11.9824], Tmin=(10,'K'), Tmax=(527.726,'K')), NASAPolynomial(coeffs=[2.89187,0.0486712,-3.34041e-05,1.07197e-08,-1.29821e-12,-103534,11.7538], Tmin=(527.726,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-858.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), label="""FC1(F)CC(F)(F)C1""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'CC(F)(F)C=C(F)F(975)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.2004,'amu*angstrom^2'), symmetry=1, barrier=(4.6076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197119,'amu*angstrom^2'), symmetry=1, barrier=(4.53217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.542278,'amu*angstrom^2'), symmetry=1, barrier=(12.468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420672,0.0857836,-0.00013561,1.15854e-07,-3.94875e-11,-70128.6,27.8154], Tmin=(100,'K'), Tmax=(777.694,'K')), NASAPolynomial(coeffs=[10.4512,0.0286121,-1.45757e-05,2.87262e-09,-2.02115e-13,-71520,-16.9692], Tmin=(777.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-584.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[CH][C](F)F(978)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540898,0.0861791,-0.00014781,1.36737e-07,-4.90857e-11,-71522,27.1071], Tmin=(100,'K'), Tmax=(824.463,'K')), NASAPolynomial(coeffs=[7.57041,0.0332234,-1.71673e-05,3.36565e-09,-2.34581e-13,-72040.5,-1.56384], Tmin=(824.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](F)CC(F)(F)F(979)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828883,0.076543,-0.000118177,1.02716e-07,-3.56351e-11,-74192.1,27.1805], Tmin=(100,'K'), Tmax=(804.026,'K')), NASAPolynomial(coeffs=[8.30641,0.030224,-1.47518e-05,2.85479e-09,-1.98746e-13,-75099.7,-5.43031], Tmin=(804.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C[C](F)F(980)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.26279,'amu*angstrom^2'), symmetry=1, barrier=(6.04205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262099,'amu*angstrom^2'), symmetry=1, barrier=(6.02618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510382,'amu*angstrom^2'), symmetry=1, barrier=(11.7347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.393399,0.0933307,-0.000173532,1.68077e-07,-6.15363e-11,-66901.3,28.25], Tmin=(100,'K'), Tmax=(844.569,'K')), NASAPolynomial(coeffs=[5.81124,0.0371751,-1.96341e-05,3.84347e-09,-2.66117e-13,-66728.8,9.46629], Tmin=(844.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C](F)F(813)'],
    products = ['CH2CF2(56)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C[C](F)F(813)'],
    products = ['[CH2]C(F)(F)C([CH2])(F)F(812)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(814)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C([CH2])(F)F(973)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(66)', 'F[C](F)C[C](F)F(736)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[C](F)F(946)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(238.674,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CF2(87)', '[CH2]C([CH2])(F)F(973)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(977)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C[C](F)F(813)'],
    products = ['[CH2][C](F)CC(F)(F)F(979)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(213.461,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)C[C](F)F(980)'],
    products = ['[CH2]C(F)(F)C[C](F)F(813)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(137.297,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #356',
    isomers = [
        '[CH2]C(F)(F)C[C](F)F(813)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CH2CF2(56)'),
    ],
