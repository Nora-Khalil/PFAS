species(
    label = 'FOC(F)(F)C(F)(F)C(F)F(1362)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.369178,'amu*angstrom^2'), symmetry=1, barrier=(8.48814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28449,'amu*angstrom^2'), symmetry=1, barrier=(29.5329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369403,'amu*angstrom^2'), symmetry=1, barrier=(8.4933,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'FOC(F)(C(F)F)C(F)(F)F(1364)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.210731,'amu*angstrom^2'), symmetry=1, barrier=(4.84513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209438,'amu*angstrom^2'), symmetry=1, barrier=(4.81538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66865,'amu*angstrom^2'), symmetry=1, barrier=(38.3655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (167.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.138191,0.0991219,-0.000167523,1.4336e-07,-4.79409e-11,-115943,29.8634], Tmin=(100,'K'), Tmax=(803.88,'K')), NASAPolynomial(coeffs=[13.1366,0.0247731,-1.33127e-05,2.63473e-09,-1.84444e-13,-117809,-29.6145], Tmin=(803.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-965.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
species(
    label = 'FOC(F)(F)C(F)(F)[C](F)F(1366)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.370405,'amu*angstrom^2'), symmetry=1, barrier=(8.51635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370631,'amu*angstrom^2'), symmetry=1, barrier=(8.52155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903,'amu*angstrom^2'), symmetry=1, barrier=(20.7617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-997.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,323,467,575,827,1418,182,240,577,636,1210,1413,236.481,236.617],'cm^-1')),
        HinderedRotor(inertia=(0.21772,'amu*angstrom^2'), symmetry=1, barrier=(8.63857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889636,'amu*angstrom^2'), symmetry=1, barrier=(35.3275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.022,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    products = ['HF(38)', 'CF2O(48)', 'CF2CF2(60)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(47.3981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'FOC(F)(F)C(F)F(895)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(343.797,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'F[C]C(F)(F)OF(575)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(219.87,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(892)', 'F[C]C(F)F(182)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(577)', 'F[C]C(F)(F)C(F)F(1017)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]C(F)(F)C(F)(F)OF(894)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(88)', 'FOC(F)(F)C(F)(F)F(896)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(155.443,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    products = ['FOC(F)(C(F)F)C(F)(F)F(1364)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(577)', 'FC(F)=C(F)C(F)F(268)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FOC(F)(F)[C](F)C(F)F(931)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FO[C](F)C(F)(F)C(F)F(1365)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)(F)OF(903)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)C(F)F(466)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(156)', 'F[C](F)C(F)(F)C(F)F(479)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(194)', 'CHF2-CF2(68)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', 'FOC(F)(F)[C](F)F(584)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)(F)C(F)(F)[C](F)F(1366)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(108)', 'O=C(F)C(F)(F)C(F)F(762)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(108)', 'FOC(F)=C(F)C(F)F(934)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(108)', 'FC=C(F)C(F)(F)OF(906)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FOC(F)(F)C(F)=C(F)F(1367)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1362)'],
    products = ['F2(108)', 'CF2O(48)', 'CHFCF2(54)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(263.405,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
