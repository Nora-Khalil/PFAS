...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58789,0.039792,-7.47283e-05,7.97837e-08,-3.12184e-11,39629.8,13.7842], Tmin=(100,'K'), Tmax=(857.519,'K')), NASAPolynomial(coeffs=[0.982305,0.0258297,-1.27809e-05,2.45098e-09,-1.68015e-13,40693.9,25.8822], Tmin=(857.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45509,-0.00220291,7.24465e-05,-9.26516e-08,3.52775e-11,4953.89,10.1695], Tmin=(100,'K'), Tmax=(945.85,'K')), NASAPolynomial(coeffs=[9.50805,0.00847934,-2.03008e-06,3.95157e-10,-3.46519e-14,2185.98,-27.2744], Tmin=(945.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.9181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""oxetene""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94493,0.017528,8.67158e-06,-2.09292e-08,8.38191e-12,-9500.47,10.6675], Tmin=(100,'K'), Tmax=(1025.08,'K')), NASAPolynomial(coeffs=[7.2666,0.0139912,-5.65425e-06,1.07053e-09,-7.65801e-14,-11086.7,-13.7044], Tmin=(1025.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""acrolein""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43519,0.0321429,-2.11365e-05,7.43423e-09,-1.09823e-12,24561.7,14.1742], Tmin=(100,'K'), Tmax=(1529.3,'K')), NASAPolynomial(coeffs=[8.00324,0.0175792,-6.85174e-06,1.20709e-09,-8.02557e-14,22858.7,-15.0538], Tmin=(1529.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63074,0.0408506,-8.28301e-05,9.17008e-08,-3.63169e-11,38513.3,13.7006], Tmin=(100,'K'), Tmax=(865.182,'K')), NASAPolynomial(coeffs=[-0.468533,0.0281971,-1.41118e-05,2.70318e-09,-1.8457e-13,40059.5,34.0402], Tmin=(865.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCOJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20188,0.0470219,-8.67415e-05,8.31875e-08,-2.9649e-11,41104.6,14.7829], Tmin=(100,'K'), Tmax=(881.729,'K')), NASAPolynomial(coeffs=[4.5405,0.0188157,-8.82104e-06,1.63828e-09,-1.09432e-13,41376.2,7.67373], Tmin=(881.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53857,0.0281494,-1.8842e-05,5.72107e-09,-5.00512e-13,21219.9,13.001], Tmin=(100,'K'), Tmax=(1228.78,'K')), NASAPolynomial(coeffs=[8.45064,0.0129027,-5.11121e-06,9.19804e-10,-6.24769e-14,19465.1,-17.9677], Tmin=(1228.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""acrolein(T)""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[O](2931)'],
    products = ['CH2O(19)', 'C2H2(70)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(2836)'],
    products = ['[CH]=CC[O](2931)'],
    transitionState = 'TS2',
