...
"""),
    E0 = (-48.0901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,180,180,180,710.085,710.122,710.136,710.152,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0657557,'amu*angstrom^2'), symmetry=1, barrier=(23.5317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158169,'amu*angstrom^2'), symmetry=1, barrier=(23.5315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97993,0.0407244,-4.09818e-05,1.99735e-08,-3.79653e-12,-5708.08,20.9088], Tmin=(100,'K'), Tmax=(1282.4,'K')), NASAPolynomial(coeffs=[12.0972,0.00916738,-4.07025e-06,7.84783e-10,-5.57612e-14,-8302.96,-30.4176], Tmin=(1282.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.0901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(OC=OOJ) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-40.7382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,405.912,405.918,405.923,405.929,405.93,405.932,405.953],'cm^-1')),
        HinderedRotor(inertia=(0.00102314,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20968,'amu*angstrom^2'), symmetry=1, barrier=(24.5178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67307,0.0428131,-3.21758e-05,9.23324e-10,5.24304e-12,-4808.31,19.282], Tmin=(100,'K'), Tmax=(962.974,'K')), NASAPolynomial(coeffs=[15.9281,0.0030986,-6.84929e-07,1.48424e-10,-1.44559e-14,-8457.8,-53.6464], Tmin=(962.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.7382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(OC=OOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC(=O)O(3407)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-44.7422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3120,650,792.5,1650,487.726,487.774,487.774,487.778,487.787,487.791],'cm^-1')),
        HinderedRotor(inertia=(0.113178,'amu*angstrom^2'), symmetry=1, barrier=(19.1134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113225,'amu*angstrom^2'), symmetry=1, barrier=(19.1151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708447,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(236)', '[C]=C(2065)'],
    products = ['C=[C]OC([O])=O(3273)'],
    transitionState = 'TS2',
