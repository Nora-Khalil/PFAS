...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(289)'],
    products = ['[O]C(F)(F)C([O])(F)F(264)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(290)'],
    products = ['[O]C(F)(F)C([O])(F)F(264)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(77)', '[O][C](F)C(=O)F(291)'],
    products = ['[O]C(F)(F)C([O])(F)F(264)'],
    transitionState = 'TS7',
