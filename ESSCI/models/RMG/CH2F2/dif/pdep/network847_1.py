...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744476,0.0746956,-8.53264e-05,4.78182e-08,-1.06931e-11,-86284.9,26.8809], Tmin=(100,'K'), Tmax=(1078.25,'K')), NASAPolynomial(coeffs=[14.9522,0.0219893,-1.20048e-05,2.48481e-09,-1.82308e-13,-89348.8,-42.7338], Tmin=(1078.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-328.755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,1474.35],'cm^-1')),
        HinderedRotor(inertia=(0.110341,'amu*angstrom^2'), symmetry=1, barrier=(31.3757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110374,'amu*angstrom^2'), symmetry=1, barrier=(31.3784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0777819,'amu*angstrom^2'), symmetry=1, barrier=(22.1195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110377,'amu*angstrom^2'), symmetry=1, barrier=(31.3777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17837,0.0628844,-6.61293e-05,3.35126e-08,-6.75676e-12,-39439.2,23.3085], Tmin=(100,'K'), Tmax=(1190.18,'K')), NASAPolynomial(coeffs=[14.432,0.018341,-9.99049e-06,2.06692e-09,-1.51508e-13,-42594,-42.9401], Tmin=(1190.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.700954,0.0688885,-9.25964e-05,6.0939e-08,-1.49281e-11,-76417.4,23.1022], Tmin=(100,'K'), Tmax=(1156.63,'K')), NASAPolynomial(coeffs=[15.0382,0.00856229,-4.28484e-07,-2.15998e-10,2.60529e-14,-79015.3,-45.0467], Tmin=(1156.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(Cs_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.60355,0.0731589,-8.26491e-05,4.36046e-08,-8.95326e-12,-90618.3,24.9559], Tmin=(100,'K'), Tmax=(1186.73,'K')), NASAPolynomial(coeffs=[18.109,0.0141546,-8.06828e-06,1.70714e-09,-1.26961e-13,-94773.1,-62.4945], Tmin=(1186.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-754.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C(=O)OC[C](F)F(2065)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309057,0.0848403,-0.000114603,7.33472e-08,-1.82936e-11,-62945.6,28.6144], Tmin=(100,'K'), Tmax=(983.196,'K')), NASAPolynomial(coeffs=[17.2661,0.0158526,-9.35222e-06,1.98044e-09,-1.46834e-13,-66280,-52.9059], Tmin=(983.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(OF)OC[C]F-2(2067)',
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1394,0.0603334,-6.05262e-05,2.90383e-08,-5.48687e-12,-39926.4,25.1402], Tmin=(100,'K'), Tmax=(1276.19,'K')), NASAPolynomial(coeffs=[15.3784,0.0157032,-8.06854e-06,1.63473e-09,-1.18574e-13,-43560.7,-47.0271], Tmin=(1276.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cds-OdOsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.275406,0.0822553,-9.87009e-05,5.61446e-08,-1.2454e-11,-87292.7,27.1968], Tmin=(100,'K'), Tmax=(1101.37,'K')), NASAPolynomial(coeffs=[18.3927,0.0164552,-9.08361e-06,1.89769e-09,-1.40291e-13,-91283.4,-61.9575], Tmin=(1101.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-726.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(CCsJOC(O))"""),
)

species(
    label = '[O]C(=O)OCC(F)(F)F(2069)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OC[C](F)F(1920)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O=C(OF)OC[C]F(2062)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]OC(=O)OF(465)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(OF)OC[C](F)F(1920)'],
    products = ['FO[C]1OCC(F)(F)O1(2063)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(358)', 'CH2CF2(56)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(OF)OC=C(F)F(2064)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(=O)OC[C](F)F(2065)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)OF(358)', '[CH2][C](F)F(1124)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(228)', 'O=[C]OC[C](F)F(1167)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(OF)O[CH][C](F)F(2066)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(OF)OC[C]F-2(2067)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]OC(=O)OF(465)'],
    products = ['O=C(OF)OC[C](F)F(1920)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(OF)OC[C](F)F(1920)'],
    products = ['O=C(OF)O[CH]C(F)F(2068)'],
