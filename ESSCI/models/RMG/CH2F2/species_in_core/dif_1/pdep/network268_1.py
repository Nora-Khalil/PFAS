...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(664)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(467)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(372)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(52.874,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(736)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(7.25315,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(88)', 'F[CH]O[C](F)F(372)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(88)', '[O]C(F)(F)[CH]F(467)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(732)'],
    products = ['F[CH]OC(F)(F)[CH]F(664)'],
...
network(
    ...
    isomers = [
        'F[CH]OC(F)(F)[CH]F(664)',
    ],
    reactants = [
        ('CHFO(46)', 'CHFCF2(54)'),
        ('CHF(40)', '[O]C(F)(F)[CH]F(467)'),
        ('CHF(88)', '[O]C(F)(F)[CH]F(467)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
