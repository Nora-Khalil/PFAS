...
reaction(
    label = 'reaction3',
    reactants = ['OF(155)', 'F[C]C(F)(F)OF(575)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(577)', 'OC(F)(F)[C]F(576)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(155)', 'FOC(F)=C(F)F(579)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(577)', 'OC(F)=C(F)F(580)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)C(F)(F)OF(581)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)[C](F)OF(582)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)F(583)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'FOC(F)(F)[C](F)F(584)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)OF(585)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(156)', 'OC(F)(F)[C](F)F(586)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)F(194)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)OF(587)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(108)', 'O=C(F)C(O)(F)F(558)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(108)', 'OC(F)=C(F)OF(588)'],
    products = ['OC(F)(F)C(F)(F)OF(481)'],
