...
"""),
    E0 = (-904.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,329.123],'cm^-1')),
        HinderedRotor(inertia=(0.0908449,'amu*angstrom^2'), symmetry=1, barrier=(6.98441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0909033,'amu*angstrom^2'), symmetry=1, barrier=(6.98517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.141981,'amu*angstrom^2'), symmetry=1, barrier=(9.49018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.214139,0.0444773,-4.85709e-05,2.87261e-08,-7.06581e-12,-91218.9,24.4576], Tmin=(298,'K'), Tmax=(1150,'K')), NASAPolynomial(coeffs=[9.56471,0.0120541,-5.11001e-06,9.72843e-10,-6.75072e-14,-93737.6,-24.901], Tmin=(1150,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-761.419,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(178.761,'J/mol/K'), label="""CH3-CF3""", comment="""Thermo library: Fluorine"""),
)
...
"""),
    E0 = (-686.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1380,1390,370,380,2900,435,180,1731.29,1732.46,1732.91],'cm^-1')),
        HinderedRotor(inertia=(0.28138,'amu*angstrom^2'), symmetry=1, barrier=(6.46947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282277,'amu*angstrom^2'), symmetry=1, barrier=(6.4901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25628,0.0718285,-0.000127625,1.28468e-07,-4.95229e-11,-82475.5,26.4302], Tmin=(100,'K'), Tmax=(822.752,'K')), NASAPolynomial(coeffs=[2.85814,0.0385647,-2.05335e-05,4.05764e-09,-2.84038e-13,-81876.8,24.2547], Tmin=(822.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[CH]C(F)(F)F(1500)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-712.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,249.772,1792.31,1792.41],'cm^-1')),
        HinderedRotor(inertia=(0.00269807,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176,'amu*angstrom^2'), symmetry=1, barrier=(7.78781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175812,'amu*angstrom^2'), symmetry=1, barrier=(7.79512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15314,0.0685261,-0.000103425,8.91157e-08,-3.13081e-11,-85569.7,29.1344], Tmin=(100,'K'), Tmax=(756.582,'K')), NASAPolynomial(coeffs=[7.92974,0.0281843,-1.44932e-05,2.86653e-09,-2.0257e-13,-86465.9,-0.814584], Tmin=(756.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'OC(O)=CC(F)(F)F(1501)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.738142,'amu*angstrom^2'), symmetry=1, barrier=(16.9713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739924,'amu*angstrom^2'), symmetry=1, barrier=(17.0123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738601,'amu*angstrom^2'), symmetry=1, barrier=(16.9819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.179647,0.0786231,-9.76204e-05,5.5476e-08,-1.14853e-11,-120425,22.8917], Tmin=(100,'K'), Tmax=(966.314,'K')), NASAPolynomial(coeffs=[19.9843,0.00679182,-1.87153e-06,2.87137e-10,-1.90796e-14,-124727,-74.4275], Tmin=(966.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1002.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)
...
"""),
    E0 = (-678.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,352.234,352.698,352.83,352.888,353.342,353.519],'cm^-1')),
        HinderedRotor(inertia=(0.00135009,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00135444,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00135319,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38179,0.064121,-0.000102089,9.16472e-08,-3.26252e-11,-81460.4,21.7342], Tmin=(100,'K'), Tmax=(812.751,'K')), NASAPolynomial(coeffs=[6.69184,0.0271043,-1.36867e-05,2.65893e-09,-1.84973e-13,-81964.1,-0.571467], Tmin=(812.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-704.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1855,455,950,348.274],'cm^-1')),
        HinderedRotor(inertia=(0.0878182,'amu*angstrom^2'), symmetry=1, barrier=(7.56487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0878995,'amu*angstrom^2'), symmetry=1, barrier=(7.56473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-893.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,180,180,180,180,884.301,884.355,884.381],'cm^-1')),
        HinderedRotor(inertia=(0.00593556,'amu*angstrom^2'), symmetry=1, barrier=(3.29382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593586,'amu*angstrom^2'), symmetry=1, barrier=(3.29397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43885,0.0642355,-0.000103719,9.94114e-08,-3.79893e-11,-107438,21.8367], Tmin=(100,'K'), Tmax=(789.926,'K')), NASAPolynomial(coeffs=[4.60862,0.0335959,-1.78342e-05,3.54838e-09,-2.50677e-13,-107484,10.1729], Tmin=(789.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(89)', 'O=C(O)CF(1497)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(229.872,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CO2(13)', 'CC(F)(F)F(318)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(F)(F)F(1290)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)F(254)', 'CH2CO(77)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)[CH]C(F)(F)F(1500)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C(O)C[C](F)F(1438)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'O=[C]CC(F)(F)F(800)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)CC(F)(F)F(456)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF3(44)', '[CH2]C(=O)O(1502)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]O(191)', '[CH2]C(F)(F)F(962)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)(F)F(1296)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(O)C=C(F)F(947)'],
    products = ['O=C(O)CC(F)(F)F(1191)'],
