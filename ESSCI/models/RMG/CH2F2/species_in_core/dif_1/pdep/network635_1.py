...
"""),
    E0 = (-542.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,1321.9],'cm^-1')),
        HinderedRotor(inertia=(9.65562e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20958,0.0341013,-3.54726e-05,1.69185e-08,-3.06582e-12,-65125.6,16.2461], Tmin=(100,'K'), Tmax=(1363.53,'K')), NASAPolynomial(coeffs=[12.7162,0.00327884,-1.56471e-06,3.39751e-10,-2.60857e-14,-67990.7,-37.7002], Tmin=(1363.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: Fluorine + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)F(424)'],
    products = ['CF2(89)', 'CF3(44)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.27e+15,'s^-1'), n=0, Ea=(56240,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 3 C2F5 <=> CF3 + CF2 in halocarbene_recombination/training
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(1523)'],
    products = ['F[C](F)C(F)(F)F(424)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)[C](F)F(315)'],
    products = ['F[C](F)C(F)(F)F(424)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]C(F)(F)F(307)'],
    products = ['F[C](F)C(F)(F)F(424)'],
    transitionState = 'TS6',
