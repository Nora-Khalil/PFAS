...
"""),
    E0 = (-189.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,391,562,707,872,1109,1210,1289,3137,391.879,392.36],'cm^-1')),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70179,-0.002788,5.18219e-05,-5.96731e-08,2.03773e-11,-2247.83,13.3237], Tmin=(100,'K'), Tmax=(1035.3,'K')), NASAPolynomial(coeffs=[6.65091,0.0113882,-5.76539e-06,1.26601e-09,-9.87771e-14,-4228.85,-7.62463], Tmin=(1035.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C(F)[CH]O(1645)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.54131,'amu*angstrom^2'), symmetry=1, barrier=(35.4377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53415,'amu*angstrom^2'), symmetry=1, barrier=(35.273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07117,0.0316098,-3.25805e-06,-2.43335e-08,1.26107e-11,-28084.4,17.1782], Tmin=(100,'K'), Tmax=(995.007,'K')), NASAPolynomial(coeffs=[14.7809,0.00575807,-2.33907e-06,5.46923e-10,-4.66524e-14,-31863.2,-50.354], Tmin=(995.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)

species(
    label = '[O]C[C](O)F(1646)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {8,S}
3 O u1 p2 c0 {4,S}
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1592,0.0292292,2.73413e-06,-2.95459e-08,1.41348e-11,-26690.8,17.5588], Tmin=(100,'K'), Tmax=(999.31,'K')), NASAPolynomial(coeffs=[14.4845,0.00638712,-2.74633e-06,6.40029e-10,-5.39197e-14,-30476.9,-48.5138], Tmin=(999.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-O2sHH)(F1s)(O2s-H))"""),
)

species(
    label = '[O][CH]C(O)F(1648)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {8,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.147,0.033103,-1.51156e-05,-4.79321e-09,3.73369e-12,-28194.8,16.8728], Tmin=(100,'K'), Tmax=(1140.89,'K')), NASAPolynomial(coeffs=[12.5978,0.0113099,-5.98431e-06,1.27825e-09,-9.63802e-14,-31545.8,-39.1588], Tmin=(1140.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)
...
"""),
    E0 = (115.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,472.153,473.774],'cm^-1')),
        HinderedRotor(inertia=(0.265698,'amu*angstrom^2'), symmetry=1, barrier=(16.9691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107711,'amu*angstrom^2'), symmetry=1, barrier=(16.972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96449,0.0475821,-6.06702e-05,3.92888e-08,-1.01205e-11,13913.2,17.1108], Tmin=(100,'K'), Tmax=(945.044,'K')), NASAPolynomial(coeffs=[9.95435,0.0137641,-6.99332e-06,1.42328e-09,-1.03604e-13,12403.1,-20.9841], Tmin=(945.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]C[CH]OF(1650)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (118.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,385.299,385.595,385.664],'cm^-1')),
        HinderedRotor(inertia=(0.186156,'amu*angstrom^2'), symmetry=1, barrier=(19.6113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185957,'amu*angstrom^2'), symmetry=1, barrier=(19.6093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80452,0.0452075,-4.89511e-05,2.51531e-08,-4.99068e-12,14335.8,18.33], Tmin=(100,'K'), Tmax=(1235.54,'K')), NASAPolynomial(coeffs=[13.3025,0.00798332,-3.75944e-06,7.68778e-10,-5.67561e-14,11494.5,-39.5731], Tmin=(1235.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])F(1234)'],
    products = ['[O]CC([O])F(1550)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(127)', '[CH2][O](1485)'],
    products = ['[O]CC([O])F(1550)'],
