...
"""),
    E0 = (-67.4905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436],'cm^-1')),
        HinderedRotor(inertia=(0.398394,'amu*angstrom^2'), symmetry=1, barrier=(9.15986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399095,'amu*angstrom^2'), symmetry=1, barrier=(9.17597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18025,0.0469957,-8.34575e-05,8.09339e-08,-2.98368e-11,-8058.44,16.6044], Tmin=(100,'K'), Tmax=(844.386,'K')), NASAPolynomial(coeffs=[4.37112,0.0213352,-1.07259e-05,2.07663e-09,-1.43375e-13,-7883.64,9.63126], Tmin=(844.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.77543,0.0147582,0.000146681,-3.94071e-07,2.91225e-10,-52112,13.4496], Tmin=(10,'K'), Tmax=(493.557,'K')), NASAPolynomial(coeffs=[7.56216,0.026862,-2.01599e-05,6.95834e-09,-8.89547e-13,-53007,-7.42546], Tmin=(493.557,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-433.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""[CH2]C(F)(F)OO""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C[C](F)OOF(1443)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-123.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.176821,'amu*angstrom^2'), symmetry=1, barrier=(4.06546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177016,'amu*angstrom^2'), symmetry=1, barrier=(4.06995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.878796,'amu*angstrom^2'), symmetry=1, barrier=(20.2053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3785,0.0666998,-0.000121833,1.15366e-07,-4.15881e-11,-14718.2,19.8392], Tmin=(100,'K'), Tmax=(841.63,'K')), NASAPolynomial(coeffs=[6.30705,0.0244435,-1.29578e-05,2.53768e-09,-1.75794e-13,-14880.8,0.873985], Tmin=(841.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['O2(2)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.41e+07,'m^3/(mol*s)'), n=6.30826e-09, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C_Ext-2C-R_5R!H->C_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C_Ext-2C-R_5R!H->C_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'CO[O](1440)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(189.939,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(154)', 'C[C]F-2(419)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(21.5794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(128)', 'CH2(S)(74)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)O[O](1101)'],
    products = ['HO2(10)', 'CH2CF2(56)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.6e+09,'s^-1','*|/',2.51189), n=1.2, Ea=(146.962,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 0 used for R2OO_2H
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(147)', 'CH3(69)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](431)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C=C(F)O[O](939)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(10.477,'m^3/(mol*s)'), n=1.29062, Ea=(160.761,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CC(F)(F)O[O](1101)'],
    products = ['[CH2]C(F)(F)OO(1178)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C](F)OOF(1443)'],
    products = ['CC(F)(F)O[O](1101)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(84.902,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
