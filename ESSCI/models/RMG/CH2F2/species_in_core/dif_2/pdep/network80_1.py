...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(279)'],
    products = ['[O]C(=O)C([O])=O(242)'],
    transitionState = 'TS2',
