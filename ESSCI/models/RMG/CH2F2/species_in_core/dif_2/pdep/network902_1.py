...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.546923,'amu*angstrom^2'), symmetry=1, barrier=(12.5748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940898,'amu*angstrom^2'), symmetry=1, barrier=(21.6331,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683236,0.0864815,-0.000176529,1.71825e-07,-6.25294e-11,-39206.4,23.534], Tmin=(100,'K'), Tmax=(841.349,'K')), NASAPolynomial(coeffs=[7.49734,0.0250737,-1.53247e-05,3.10503e-09,-2.17471e-13,-39326.2,-2.06076], Tmin=(841.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)

species(
    label = 'O[C](C=C(F)F)OOF(2299)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.852997,'amu*angstrom^2'), symmetry=1, barrier=(19.6121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853015,'amu*angstrom^2'), symmetry=1, barrier=(19.6125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265531,0.0895767,-0.000147766,1.26762e-07,-4.30345e-11,-44939.2,31.1247], Tmin=(100,'K'), Tmax=(778.538,'K')), NASAPolynomial(coeffs=[11.5519,0.0258716,-1.40102e-05,2.793e-09,-1.9702e-13,-46523.3,-19.3872], Tmin=(778.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cs_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00155542,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.633719,'amu*angstrom^2'), symmetry=1, barrier=(14.5704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633633,'amu*angstrom^2'), symmetry=1, barrier=(14.5685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44917,'amu*angstrom^2'), symmetry=1, barrier=(33.3192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633542,'amu*angstrom^2'), symmetry=1, barrier=(14.5664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
...
"""),
    E0 = (-659.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,350,440,435,1725,182,240,577,636,1210,1413,180,180,180,1607.66,1608.23,1608.66],'cm^-1')),
        HinderedRotor(inertia=(0.169405,'amu*angstrom^2'), symmetry=1, barrier=(3.89495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169546,'amu*angstrom^2'), symmetry=1, barrier=(3.8982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169435,'amu*angstrom^2'), symmetry=1, barrier=(3.89565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587244,0.090374,-0.000180684,1.78432e-07,-6.56089e-11,-79270.6,27.8898], Tmin=(100,'K'), Tmax=(851.307,'K')), NASAPolynomial(coeffs=[5.43709,0.0329612,-1.85135e-05,3.65814e-09,-2.53147e-13,-78841.7,12.6419], Tmin=(851.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([C](F)F)C(=O)O(2305)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48131,0.0589091,-6.81466e-05,4.09684e-08,-1.00029e-11,-72454.4,28.0056], Tmin=(100,'K'), Tmax=(984.889,'K')), NASAPolynomial(coeffs=[10.7464,0.0212815,-1.08411e-05,2.1799e-09,-1.57389e-13,-74279.5,-16.5523], Tmin=(984.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'O=C(O)[CH][C](F)F(887)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-478.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,180,1147.28,1147.87,1149.21],'cm^-1')),
        HinderedRotor(inertia=(0.155442,'amu*angstrom^2'), symmetry=1, barrier=(3.57391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0596634,'amu*angstrom^2'), symmetry=1, barrier=(56.1388,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56624,0.0590183,-9.38018e-05,8.24945e-08,-2.88632e-11,-57423.4,24.2623], Tmin=(100,'K'), Tmax=(803.447,'K')), NASAPolynomial(coeffs=[7.29358,0.0227449,-1.15944e-05,2.2618e-09,-1.57788e-13,-58093.3,-0.556874], Tmin=(803.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-286.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,1855,455,950,241.984,242.201],'cm^-1')),
        HinderedRotor(inertia=(0.390185,'amu*angstrom^2'), symmetry=1, barrier=(16.2059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389941,'amu*angstrom^2'), symmetry=1, barrier=(16.2025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00288395,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06961,0.0682654,-9.75079e-05,6.81838e-08,-1.86699e-11,-34383.2,28.3849], Tmin=(100,'K'), Tmax=(897.003,'K')), NASAPolynomial(coeffs=[13.0805,0.0147046,-7.94086e-06,1.61559e-09,-1.16768e-13,-36537.9,-28.2552], Tmin=(897.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CsCsF1sF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(=O)C(OF)[C](F)F(2307)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00656,0.0728996,-0.000108741,9.07056e-08,-3.1271e-11,-58431.7,29.2656], Tmin=(100,'K'), Tmax=(703.321,'K')), NASAPolynomial(coeffs=[8.60209,0.0297076,-1.66367e-05,3.41393e-09,-2.46977e-13,-59500.3,-4.70629], Tmin=(703.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-486.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788996,0.0793925,-0.000119013,8.45752e-08,-1.96005e-11,-63910.1,31.0254], Tmin=(100,'K'), Tmax=(599.622,'K')), NASAPolynomial(coeffs=[10.8989,0.0246284,-1.37297e-05,2.77997e-09,-1.98452e-13,-65350.4,-14.4786], Tmin=(599.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'O=C(O)C(=O)[C](F)F(1456)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-747.02,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,552.5,462.5,1710,179,346,818,1406,1524,284.561,288.508,289.963,1026.15,1028.77,1029.23],'cm^-1')),
        HinderedRotor(inertia=(2.10534,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667558,'amu*angstrom^2'), symmetry=1, barrier=(37.5228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10158,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868453,0.0750128,-9.86753e-05,6.81501e-08,-1.91033e-11,-88246.9,29.0911], Tmin=(100,'K'), Tmax=(863.68,'K')), NASAPolynomial(coeffs=[11.3822,0.0263199,-1.41073e-05,2.87251e-09,-2.0803e-13,-90063,-20.0907], Tmin=(863.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    ...
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=[C]C(OF)=C(F)F(2298)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](C=C(F)F)OOF(2299)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF(2300)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(42)', 'O=C(O)[CH]OF(1396)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C(O)C(OF)[C](F)F(2170)'],
    products = ['O[C]1OC(F)(F)C1OF(2301)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(O)C(OF)[C](F)F(2170)'],
    products = ['[O]C1(O)C(OF)C1(F)F(2302)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(O)=C(OF)[C](F)F(2303)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'O=C(O)C=C(F)F(791)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(189)', 'FOC=C(F)F(1226)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)C(OF)=C(F)F(2304)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C([C](F)F)C(=O)O(2305)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(154)', 'O=C(O)[CH][C](F)F(887)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(OF)[C](F)F(2306)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(OF)[C](F)F(2307)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(189)', 'FO[CH][C](F)F(1446)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[C](OF)[C](F)F(2308)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(O)C(=O)[C](F)F(1456)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF-2(2309)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CF2(87)', 'O=C(O)[CH]OF(1396)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(O)C(OF)[C](F)F(2170)'],
    products = ['O=C(O)[C](OF)C(F)F(2310)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(=O)C(OF)C(F)F(2273)'],
    products = ['O=C(O)C(OF)[C](F)F(2170)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(O)C(OF)[C](F)F(2170)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
network(
    label = 'PDepNetwork #902',
    isomers = [
        'O=C(O)C(OF)[C](F)F(2170)',
    ],
    reactants = [
