...
reaction(
    ...
    products = ['O=C(O)OC(F)F(573)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.35852,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C([O])OC(F)F(622)'],
    products = ['O=C(O)OC(F)F(573)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(625)'],
    products = ['O=C(O)OC(F)F(573)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(146)', 'O=[C]O(175)'],
    products = ['O=C(O)OC(F)F(573)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(371)'],
    products = ['O=C(O)OC(F)F(573)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(398)'],
    products = ['O=C(O)OC(F)F(573)'],
