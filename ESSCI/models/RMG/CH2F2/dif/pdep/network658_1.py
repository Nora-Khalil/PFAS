...
"""),
    E0 = (-427.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,387.314,387.465,387.543],'cm^-1')),
        HinderedRotor(inertia=(0.264924,'amu*angstrom^2'), symmetry=1, barrier=(28.2415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264987,'amu*angstrom^2'), symmetry=1, barrier=(28.2433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265033,'amu*angstrom^2'), symmetry=1, barrier=(28.2425,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84385,0.0297623,2.60722e-05,-6.82174e-08,3.15208e-11,-51324.8,19.5162], Tmin=(100,'K'), Tmax=(940.394,'K')), NASAPolynomial(coeffs=[19.258,0.000415261,1.54385e-06,-2.54762e-10,8.27661e-15,-56577.6,-73.9414], Tmin=(940.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-31.3248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,419.69,419.691,419.691,419.692,419.694],'cm^-1')),
        HinderedRotor(inertia=(0.000957063,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188243,'amu*angstrom^2'), symmetry=1, barrier=(23.5292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188245,'amu*angstrom^2'), symmetry=1, barrier=(23.5292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45439,0.0550334,-6.39599e-05,3.62131e-08,-8.00726e-12,-3674.95,20.7226], Tmin=(100,'K'), Tmax=(1106.59,'K')), NASAPolynomial(coeffs=[13.3396,0.012072,-5.72505e-06,1.12951e-09,-8.12105e-14,-6305.37,-37.8204], Tmin=(1106.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'O[CH]O[CH]OF(1677)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (-69.7626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,345.577,345.669,345.873,346.169],'cm^-1')),
        HinderedRotor(inertia=(0.00141139,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166842,'amu*angstrom^2'), symmetry=1, barrier=(14.1189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16686,'amu*angstrom^2'), symmetry=1, barrier=(14.1202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166659,'amu*angstrom^2'), symmetry=1, barrier=(14.1219,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.715067,0.0759106,-0.000126409,9.98364e-08,-2.99872e-11,-8275.66,22.688], Tmin=(100,'K'), Tmax=(894.762,'K')), NASAPolynomial(coeffs=[14.13,0.00948488,-4.23049e-06,7.42024e-10,-4.72202e-14,-10417.9,-39.0959], Tmin=(894.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.7626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCJO)"""),
)
...
"""),
    E0 = (-334.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,534.386,534.81,535.096],'cm^-1')),
        HinderedRotor(inertia=(0.000589822,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228122,'amu*angstrom^2'), symmetry=1, barrier=(46.2773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89274,0.0142605,2.98241e-05,-4.65687e-08,1.76371e-11,-40197.9,16.0585], Tmin=(100,'K'), Tmax=(1016.29,'K')), NASAPolynomial(coeffs=[9.44069,0.0135447,-6.1013e-06,1.25702e-09,-9.53413e-14,-42822.7,-22.0034], Tmin=(1016.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.395837,'amu*angstrom^2'), symmetry=1, barrier=(33.6604,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79262,0.0222941,-9.08445e-06,-2.403e-09,1.82246e-12,-20487.5,13.1527], Tmin=(100,'K'), Tmax=(1184.75,'K')), NASAPolynomial(coeffs=[8.2588,0.0116085,-5.39242e-06,1.05479e-09,-7.5224e-14,-22328,-16.4464], Tmin=(1184.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""CH2OCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-231.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1855,455,950,216.804,217.412,217.483],'cm^-1')),
        HinderedRotor(inertia=(0.948559,'amu*angstrom^2'), symmetry=1, barrier=(31.8987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.954276,'amu*angstrom^2'), symmetry=1, barrier=(31.9008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.953449,'amu*angstrom^2'), symmetry=1, barrier=(31.894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64068,0.0374468,-1.71948e-06,-4.04132e-08,2.24062e-11,-27693,18.8732], Tmin=(100,'K'), Tmax=(927.993,'K')), NASAPolynomial(coeffs=[19.5699,-0.00263448,2.93726e-06,-5.61112e-10,3.27451e-14,-32622.5,-74.9154], Tmin=(927.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C=O(135)', '[CH2]OF(1527)'],
    products = ['O=COCOF(1585)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(228)', '[CH2]OC=O(1638)'],
    products = ['O=COCOF(1585)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
