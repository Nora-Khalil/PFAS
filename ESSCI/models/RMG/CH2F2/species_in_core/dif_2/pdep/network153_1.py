...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(416)'],
    products = ['[O]C(F)(F)O[CH]F(350)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(144)', 'CHF(86)'],
    products = ['[O]C(F)(F)O[CH]F(350)'],
    transitionState = 'TS9',
...
network(
    ...
    reactants = [
        ('CF2O(48)', 'CHFO(46)'),
        ('[O]C([O])(F)F(144)', 'CHF(40)'),
        ('[O]C([O])(F)F(144)', 'CHF(86)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
