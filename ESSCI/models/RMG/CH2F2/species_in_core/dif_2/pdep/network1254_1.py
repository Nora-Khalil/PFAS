...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.910892,'amu*angstrom^2'), symmetry=1, barrier=(20.9432,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53944,0.0545515,-6.44281e-05,3.84645e-08,-9.07011e-12,-50661.3,21.1463], Tmin=(100,'K'), Tmax=(1034.98,'K')), NASAPolynomial(coeffs=[11.8423,0.0147333,-6.72003e-06,1.29305e-09,-9.14019e-14,-52794,-28.9133], Tmin=(1034.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sCd)) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99714,0.0336999,-2.36834e-06,-2.17312e-08,1.0134e-11,-45170.5,18.0023], Tmin=(100,'K'), Tmax=(1061.78,'K')), NASAPolynomial(coeffs=[13.2996,0.0140279,-6.93928e-06,1.45825e-09,-1.10345e-13,-48861.9,-43.2839], Tmin=(1061.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-376.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = '[O]C(F)(F)[C]1CO1(3384)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05986,0.0434092,-4.0111e-05,1.92017e-08,-3.77412e-12,-41330.8,19.4271], Tmin=(100,'K'), Tmax=(1198.37,'K')), NASAPolynomial(coeffs=[9.59647,0.018253,-8.62293e-06,1.68455e-09,-1.19742e-13,-43137.1,-18.2965], Tmin=(1198.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])OC1(F)F(3363)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12464,'amu*angstrom^2'), symmetry=1, barrier=(25.8577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12402,'amu*angstrom^2'), symmetry=1, barrier=(25.8435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948571,0.0638725,-8.01336e-05,4.74799e-08,-1.0751e-11,-37492.2,22.1655], Tmin=(100,'K'), Tmax=(1094.72,'K')), NASAPolynomial(coeffs=[16.3298,0.00767092,-3.12523e-06,5.82907e-10,-4.11555e-14,-40859.8,-53.432], Tmin=(1094.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sCd)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(O)(F)F(3388)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947643,0.07317,-0.000125108,1.0638e-07,-3.476e-11,-50755.8,22.1591], Tmin=(100,'K'), Tmax=(856.714,'K')), NASAPolynomial(coeffs=[10.8387,0.0167446,-8.3784e-06,1.58756e-09,-1.07539e-13,-52074.6,-21.836], Tmin=(856.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(=O)[C](F)OF(3389)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-156.256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,552.5,462.5,1710,280,501,1494,1531,3000,3100,440,815,1455,1000,257.014,257.016],'cm^-1')),
        HinderedRotor(inertia=(1.12104,'amu*angstrom^2'), symmetry=1, barrier=(52.5524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0225455,'amu*angstrom^2'), symmetry=1, barrier=(29.5373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.121,'amu*angstrom^2'), symmetry=1, barrier=(52.5525,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66159,0.0561046,-7.20424e-05,5.03591e-08,-1.44837e-11,-18713.1,20.7907], Tmin=(100,'K'), Tmax=(838.532,'K')), NASAPolynomial(coeffs=[8.73994,0.0223402,-1.16452e-05,2.34244e-09,-1.68474e-13,-19900.2,-12.1119], Tmin=(838.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CsCOF1sO2s) + radical(C2JC=O)"""),
)

species(
    label = '[CH2]C(OF)=C([O])F(3390)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-117.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3000,3100,440,815,1455,1000,326,540,652,719,1357,708.433,708.683],'cm^-1')),
        HinderedRotor(inertia=(0.135619,'amu*angstrom^2'), symmetry=1, barrier=(3.11815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135861,'amu*angstrom^2'), symmetry=1, barrier=(3.1237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42264,0.0629851,-0.000103434,9.26517e-08,-3.27907e-11,-14039.7,22.9146], Tmin=(100,'K'), Tmax=(805.157,'K')), NASAPolynomial(coeffs=[7.38243,0.0237526,-1.24144e-05,2.44147e-09,-1.70867e-13,-14687.5,-2.60909], Tmin=(805.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[O]C(F)(F)C[C]=O(3299)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.241507,'amu*angstrom^2'), symmetry=1, barrier=(5.55272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240811,'amu*angstrom^2'), symmetry=1, barrier=(5.53673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39887,0.0632871,-0.000106013,9.32599e-08,-3.19262e-11,-48458.6,23.2157], Tmin=(100,'K'), Tmax=(833.687,'K')), NASAPolynomial(coeffs=[8.21619,0.0203352,-1.0303e-05,1.98795e-09,-1.37047e-13,-49239.4,-6.29908], Tmin=(833.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-403.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[C](F)F(3383)'],
    products = ['C=C([O])C([O])(F)F(3297)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C([O])(F)F(2814)'],
    products = ['C=C([O])C([O])(F)F(3297)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C([O])(F)F(3297)'],
    products = ['[CH2]C1([O])OC1(F)F(3363)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)F(3386)'],
    products = ['C=C([O])C([O])(F)F(3297)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(66)', '[O]C(F)(F)[C]=O(292)'],
    products = ['C=C([O])C([O])(F)F(3297)'],
