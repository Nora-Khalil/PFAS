...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75355,0.0545271,-6.76785e-05,4.5891e-08,-1.29419e-11,-55349.1,23.0282], Tmin=(100,'K'), Tmax=(849.636,'K')), NASAPolynomial(coeffs=[8.40134,0.0232293,-1.24221e-05,2.53305e-09,-1.83773e-13,-56478.7,-7.96008], Tmin=(849.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFFHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968885,0.0866089,-0.000191482,2.01123e-07,-7.63694e-11,-56778.4,22.1256], Tmin=(100,'K'), Tmax=(861.289,'K')), NASAPolynomial(coeffs=[1.18213,0.0372575,-2.13083e-05,4.21031e-09,-2.9015e-13,-55021.3,31.5418], Tmin=(861.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)
...
"""),
    E0 = (-258.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21587,0.0800992,-0.000180186,1.9106e-07,-7.31861e-11,-30999.7,23.5131], Tmin=(100,'K'), Tmax=(855.478,'K')), NASAPolynomial(coeffs=[1.13843,0.0347282,-2.04435e-05,4.08402e-09,-2.83375e-13,-29313,33.6555], Tmin=(855.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFO) + ring(oxirene) + radical(Csj(F1s)(F1s)(O2s-Cd)) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77395,0.0530777,-6.02962e-05,3.58319e-08,-8.75577e-12,-56138.2,23.1719], Tmin=(100,'K'), Tmax=(976.798,'K')), NASAPolynomial(coeffs=[9.59477,0.021051,-1.11146e-05,2.26504e-09,-1.64628e-13,-57666,-14.3754], Tmin=(976.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFFHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1O[C]1F(2627)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C1O[C]1F(2633)'],
    products = ['F[C](F)OC1O[C]1F(2627)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[C](F)F(2635)'],
    products = ['F[C](F)OC1O[C]1F(2627)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[C](F)OC1O[C]1F(2627)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.66944e+13,'m^3/(mol*s)'), n=-2.06969, Ea=(122.245,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC1=C(F)O1(2637)'],
    products = ['F[C](F)OC1O[C]1F(2627)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', '[O]C1O[C]1F(2633)'],
    products = ['F[C](F)OC1O[C]1F(2627)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(7.13682,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC1O[C]1F(2627)'],
    products = ['F[C]1O[C]1OC(F)F(2639)'],
...
network(
    label = 'PDepNetwork #1039',
    isomers = [
        'F[C](F)OC1O[C]1F(2627)',
    ],
    reactants = [
        ('CF2O(48)', 'FC1=CO1(390)'),
    ],
