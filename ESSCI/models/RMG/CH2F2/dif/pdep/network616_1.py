...
"""),
    E0 = (-408.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,180,180,180,966.651],'cm^-1')),
        HinderedRotor(inertia=(0.186589,'amu*angstrom^2'), symmetry=1, barrier=(4.29004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186061,'amu*angstrom^2'), symmetry=1, barrier=(4.2779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85336,0.0590103,-0.000119065,1.24839e-07,-4.84805e-11,-49105.4,18.1402], Tmin=(100,'K'), Tmax=(835.396,'K')), NASAPolynomial(coeffs=[2.21322,0.0295882,-1.65012e-05,3.30042e-09,-2.31362e-13,-48199,22.2537], Tmin=(835.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2334,0.0783866,-0.000175671,1.79695e-07,-6.60219e-11,-53711.4,19.682], Tmin=(100,'K'), Tmax=(880.459,'K')), NASAPolynomial(coeffs=[3.25176,0.0265785,-1.4766e-05,2.85811e-09,-1.92897e-13,-52414.1,19.5869], Tmin=(880.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]C[O](1545)'],
    products = ['[O]CO[C](F)F(1548)'],
    transitionState = 'TS2',
