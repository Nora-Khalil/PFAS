...
"""),
    E0 = (27.8611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([525,764,1175,1295,1876,180,1152.84,2873.72],'cm^-1')),
        HinderedRotor(inertia=(0.543166,'amu*angstrom^2'), symmetry=1, barrier=(12.4885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.17735,0.0201066,-2.58791e-05,2.0036e-08,-6.66677e-12,3378.69,10.9969], Tmin=(100,'K'), Tmax=(718.109,'K')), NASAPolynomial(coeffs=[4.9288,0.0103509,-5.50129e-06,1.11825e-09,-8.08764e-14,3127.14,3.12714], Tmin=(718.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.8611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=CF(633)'],
    products = ['CO(12)', 'CHF(40)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.15699e+14,'s^-1'), n=0.0573689, Ea=(197.881,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='RFC=C=O',), comment="""Estimated from node RFC=C=O"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(666)'],
    products = ['O=C=CF(633)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C(=O)F(668)'],
    products = ['O=C=CF(633)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(132.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction6',
    reactants = ['O=C[C]F-2(669)'],
    products = ['O=C=CF(633)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.33334e+12,'s^-1'), n=-1.40567e-07, Ea=(70.3195,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br_4CClFINOPSSi->F',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br_4CClFINOPSSi->F"""),
)
