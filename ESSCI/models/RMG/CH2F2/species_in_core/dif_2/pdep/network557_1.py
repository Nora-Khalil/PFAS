species(
    label = 'FOC(F)(F)C(F)(F)C(F)F(1431)',
...
species(
    label = 'FOC(F)(C(F)F)C(F)(F)F(1434)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
species(
    label = 'FOC(F)(F)C(F)(F)[C](F)F(1436)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'FOC(F)(F)C(F)F(1143)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'F[C]C(F)(F)OF(714)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(1140)', 'F[C]C(F)F(180)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'F[C]C(F)(F)C(F)F(1433)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]C(F)(F)C(F)(F)OF(1142)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(86)', 'FOC(F)(F)C(F)(F)F(1144)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    products = ['FOC(F)(C(F)F)C(F)(F)F(1434)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(716)', 'FC(F)=C(F)C(F)F(992)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FOC(F)(F)[C](F)C(F)F(1163)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FO[C](F)C(F)(F)C(F)F(1435)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)(F)OF(1151)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)C(F)F(363)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', 'F[C](F)C(F)(F)C(F)F(537)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(192)', 'CHF2-CF2(68)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', 'FOC(F)(F)[C](F)F(723)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)(F)C(F)(F)[C](F)F(1436)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(106)', 'O=C(F)C(F)(F)C(F)F(750)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'FOC(F)=C(F)C(F)F(1166)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(106)', 'FC=C(F)C(F)(F)OF(1154)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FOC(F)(F)C(F)=C(F)F(1437)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(1431)'],
    products = ['F2(106)', 'CF2O(48)', 'CHFCF2(54)'],
...
network(
    label = 'PDepNetwork #557',
    isomers = [
        'FOC(F)(F)C(F)(F)C(F)F(1431)',
    ],
    reactants = [
