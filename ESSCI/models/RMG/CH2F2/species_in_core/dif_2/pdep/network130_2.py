...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(152)', 'F[C]CF-2(186)'],
    products = ['[O]OC(F)(F)CF(261)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(433)', 'CH2(S)(72)'],
    products = ['[O]OC(F)(F)CF(261)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](317)'],
    products = ['[O]OC(F)(F)CF(261)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(171)', 'CH2F(89)'],
    products = ['[O]OC(F)(F)CF(261)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(232)'],
    products = ['[O]OC(F)(F)CF(261)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', 'C=C(F)O[O](829)'],
    products = ['[O]OC(F)(F)CF(261)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(1097)'],
    products = ['[O]OCC(F)(F)F(649)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(265)'],
    products = ['[O]OCC(F)(F)F(649)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OCC(F)(F)F(649)'],
    products = ['OH(4)', 'CF3CHO(103)'],
