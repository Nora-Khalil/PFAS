...
"""),
    E0 = (-993.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,252.329,255.147],'cm^-1')),
        HinderedRotor(inertia=(0.178502,'amu*angstrom^2'), symmetry=1, barrier=(8.08678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176458,'amu*angstrom^2'), symmetry=1, barrier=(8.10299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408145,'amu*angstrom^2'), symmetry=1, barrier=(18.9104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-191.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,262,1290,180,1548.87],'cm^-1')),
        HinderedRotor(inertia=(0.525313,'amu*angstrom^2'), symmetry=1, barrier=(12.078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969898,'amu*angstrom^2'), symmetry=1, barrier=(22.2999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97492,0.0489724,-7.70014e-05,6.74095e-08,-2.36379e-11,-22926.5,18.7339], Tmin=(100,'K'), Tmax=(788.467,'K')), NASAPolynomial(coeffs=[6.82714,0.0189896,-9.75142e-06,1.91534e-09,-1.34364e-13,-23524.9,-2.46417], Tmin=(788.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + group(CJ2_singlet-FCO)"""),
)
...
"""),
    E0 = (-624.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,375,552.5,462.5,1710,262,1290,210.078,210.104],'cm^-1')),
        HinderedRotor(inertia=(0.142814,'amu*angstrom^2'), symmetry=1, barrier=(4.47309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142811,'amu*angstrom^2'), symmetry=1, barrier=(4.47309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417001,'amu*angstrom^2'), symmetry=1, barrier=(13.0613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749106,0.0789726,-0.000140147,1.22692e-07,-4.12129e-11,-74946.4,24.9666], Tmin=(100,'K'), Tmax=(843.283,'K')), NASAPolynomial(coeffs=[10.8419,0.0184326,-9.93081e-06,1.93629e-09,-1.33304e-13,-76198.2,-19.3345], Tmin=(843.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + group(CJ2_singlet-FCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00574127,'amu*angstrom^2'), symmetry=1, barrier=(6.10547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264922,'amu*angstrom^2'), symmetry=1, barrier=(6.09108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16088,'amu*angstrom^2'), symmetry=1, barrier=(49.6829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00577,0.076488,-0.000133593,1.30347e-07,-4.93634e-11,-71716.6,25.6839], Tmin=(100,'K'), Tmax=(811.235,'K')), NASAPolynomial(coeffs=[4.71674,0.0365584,-1.97639e-05,3.93351e-09,-2.76737e-13,-71606.9,12.944], Tmin=(811.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-597.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-677.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,259.188,259.188,259.191],'cm^-1')),
        HinderedRotor(inertia=(0.105638,'amu*angstrom^2'), symmetry=1, barrier=(5.03564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105626,'amu*angstrom^2'), symmetry=1, barrier=(5.0357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432767,'amu*angstrom^2'), symmetry=1, barrier=(20.6298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309689,0.0888447,-0.000149365,1.29158e-07,-4.36682e-11,-81317.6,27.1153], Tmin=(100,'K'), Tmax=(813.05,'K')), NASAPolynomial(coeffs=[11.3346,0.0247911,-1.30864e-05,2.56935e-09,-1.79062e-13,-82785.9,-21.7968], Tmin=(813.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(CF)C([O])(F)F(4235)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-611.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,528,1116,1182,1331,1402,1494,3075,3110,282.77,282.82,283.193],'cm^-1')),
        HinderedRotor(inertia=(0.20087,'amu*angstrom^2'), symmetry=1, barrier=(11.3628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19956,'amu*angstrom^2'), symmetry=1, barrier=(11.3649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920957,0.0724428,-9.54343e-05,6.56035e-08,-1.81046e-11,-73469.1,25.2009], Tmin=(100,'K'), Tmax=(881.682,'K')), NASAPolynomial(coeffs=[11.7599,0.0232686,-1.17745e-05,2.34572e-09,-1.67921e-13,-75380.4,-25.7261], Tmin=(881.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = '[O]C(F)(F)[C](O)CF(4236)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.376038,'amu*angstrom^2'), symmetry=1, barrier=(8.64584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37568,'amu*angstrom^2'), symmetry=1, barrier=(8.63762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367154,'amu*angstrom^2'), symmetry=1, barrier=(8.63756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.342336,0.0885015,-0.000151265,1.31487e-07,-4.42064e-11,-79914.5,26.8778], Tmin=(100,'K'), Tmax=(839.037,'K')), NASAPolynomial(coeffs=[11.1208,0.0239483,-1.23168e-05,2.37837e-09,-1.63557e-13,-81259.6,-20.468], Tmin=(839.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(C2CsJOH)"""),
)

species(
    label = 'OC(=CF)C(O)(F)F(4237)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.341107,'amu*angstrom^2'), symmetry=1, barrier=(7.84272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342482,'amu*angstrom^2'), symmetry=1, barrier=(7.87434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949163,'amu*angstrom^2'), symmetry=1, barrier=(21.8231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431615,0.0850065,-0.000137553,1.15692e-07,-3.84418e-11,-116875,23.569], Tmin=(100,'K'), Tmax=(788.56,'K')), NASAPolynomial(coeffs=[11.5692,0.0238687,-1.24259e-05,2.44139e-09,-1.70851e-13,-118487,-26.6024], Tmin=(788.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-972.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.8691,'amu*angstrom^2'), symmetry=1, barrier=(42.9742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0106327,'amu*angstrom^2'), symmetry=1, barrier=(9.50323,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57014,0.0584481,-8.52122e-05,7.32443e-08,-2.57904e-11,-75847.7,21.546], Tmin=(100,'K'), Tmax=(773.933,'K')), NASAPolynomial(coeffs=[6.77117,0.026415,-1.31419e-05,2.56133e-09,-1.79519e-13,-76498.4,-1.2163], Tmin=(773.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-607.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,179,346,818,1406,1524,410.522,410.607],'cm^-1')),
        HinderedRotor(inertia=(0.0598123,'amu*angstrom^2'), symmetry=1, barrier=(7.1424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301273,'amu*angstrom^2'), symmetry=1, barrier=(36.0286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-727.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([377,639,914,1335,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,180,180,180,180,1398.86,1399.13],'cm^-1')),
        HinderedRotor(inertia=(0.120725,'amu*angstrom^2'), symmetry=1, barrier=(2.77571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120713,'amu*angstrom^2'), symmetry=1, barrier=(2.77542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28336,0.068586,-0.000117907,1.11635e-07,-4.09773e-11,-87369.5,25.0683], Tmin=(100,'K'), Tmax=(825.359,'K')), NASAPolynomial(coeffs=[5.56851,0.0300916,-1.5731e-05,3.08225e-09,-2.14661e-13,-87473.1,8.87514], Tmin=(825.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(O2sj(Cs-F1sF1sCO))"""),
)
...
"""),
    E0 = (-839.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,375,552.5,462.5,1710,235,1215,1347,1486,3221,284.904,290.49],'cm^-1')),
        HinderedRotor(inertia=(0.0894934,'amu*angstrom^2'), symmetry=1, barrier=(5.34011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0918767,'amu*angstrom^2'), symmetry=1, barrier=(5.34509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60445,'amu*angstrom^2'), symmetry=1, barrier=(33.1899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08889,0.0687027,-9.83367e-05,7.36223e-08,-2.20061e-11,-100808,23.572], Tmin=(100,'K'), Tmax=(818.288,'K')), NASAPolynomial(coeffs=[10.8899,0.0207931,-1.05143e-05,2.07299e-09,-1.46781e-13,-102412,-21.7468], Tmin=(818.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-839.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)

species(
    label = 'O=C(F)C(=O)CF(4242)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,D}
4 O u0 p2 c0 {7,D}
...
"""),
    E0 = (-713.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,286,619,818,1246,1924,371.742,372.016],'cm^-1')),
        HinderedRotor(inertia=(0.11699,'amu*angstrom^2'), symmetry=1, barrier=(11.4845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298844,'amu*angstrom^2'), symmetry=1, barrier=(29.2743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98201,0.0487135,-5.66162e-05,3.61357e-08,-9.6445e-12,-85716.5,19.6253], Tmin=(100,'K'), Tmax=(892.868,'K')), NASAPolynomial(coeffs=[8.00683,0.0217227,-1.12722e-05,2.27936e-09,-1.64856e-13,-86792.4,-8.75835], Tmin=(892.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(COCFO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OF(153)', 'O=C([C]F)CF(4231)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C([C]F)C(O)(F)F(4232)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([CH]F)C(O)(F)F(4234)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(CF)[C](O)F(4238)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'O=C(CF)[C](F)F(4239)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)CF(4240)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(232)', 'O=[C]CF(2425)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(89)', 'O=[C]C(O)(F)F(842)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=C([CH]F)C(O)(F)F(4241)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(=O)CF(4242)'],
    products = ['O=C(CF)C(O)(F)F(3355)'],
