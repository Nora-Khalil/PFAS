...
"""),
    E0 = (-699.524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,548,1085,1183,1302,1466,1520,3060,3119,180,180,180,580.675],'cm^-1')),
        HinderedRotor(inertia=(0.672902,'amu*angstrom^2'), symmetry=1, barrier=(15.4713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215209,'amu*angstrom^2'), symmetry=1, barrier=(4.94807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65393,'amu*angstrom^2'), symmetry=1, barrier=(38.0272,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-298.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,3000,3100,440,815,1455,1000,180,491.166,1816.3],'cm^-1')),
        HinderedRotor(inertia=(0.255611,'amu*angstrom^2'), symmetry=1, barrier=(5.877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667814,'amu*angstrom^2'), symmetry=1, barrier=(15.3543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3575,'amu*angstrom^2'), symmetry=1, barrier=(31.2115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.241526,'amu*angstrom^2'), symmetry=1, barrier=(5.55316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241594,'amu*angstrom^2'), symmetry=1, barrier=(5.55471,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)OF(527)', 'CH2(S)(24)'],
    products = ['FCOC(F)OF(350)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)OF(551)'],
    products = ['FCOC(F)OF(350)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(295)', '[O]CF(294)'],
    products = ['FCOC(F)OF(350)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)OF(154)', 'CH2F(45)'],
    products = ['FCOC(F)OF(350)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(228)', 'F[CH]OCF(553)'],
    products = ['FCOC(F)OF(350)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]OC(F)OF(529)'],
    products = ['FCOC(F)OF(350)'],
