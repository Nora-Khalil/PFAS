...
"""),
    E0 = (-146.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1052.98,1053.21,1054.15,2964.93,2966.57],'cm^-1')),
        HinderedRotor(inertia=(0.135303,'amu*angstrom^2'), symmetry=1, barrier=(3.11088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (34.0147,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(892.977,'J/mol'), sigma=(3.458,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=3.8, comment="""GRI-Mech"""),
...
reaction(
    ...
    products = ['OH(4)', 'OH(4)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.187e+12,'s^-1'), n=0.9, Ea=(48750,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library FFCM1(-)"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(5)', 'HO2(10)'],
    products = ['H2O2(11)'],
    transitionState = 'TS2',
