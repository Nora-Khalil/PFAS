...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34182,'amu*angstrom^2'), symmetry=1, barrier=(30.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33831,'amu*angstrom^2'), symmetry=1, barrier=(30.7704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6089,0.0550351,-6.71345e-05,3.9686e-08,-9.2513e-12,-75021.6,19.4919], Tmin=(100,'K'), Tmax=(1042.73,'K')), NASAPolynomial(coeffs=[12.4065,0.013615,-7.55116e-06,1.59204e-09,-1.18195e-13,-77273.4,-33.0524], Tmin=(1042.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-293.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,580,1155,1237,1373,3147,223.204,223.306,223.358,2598.74],'cm^-1')),
        HinderedRotor(inertia=(0.201026,'amu*angstrom^2'), symmetry=1, barrier=(7.09247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13399,'amu*angstrom^2'), symmetry=1, barrier=(40.1669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13505,'amu*angstrom^2'), symmetry=1, barrier=(40.1686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5024,0.06071,-0.000102649,9.13841e-08,-3.20847e-11,-35198.8,23.6319], Tmin=(100,'K'), Tmax=(784.054,'K')), NASAPolynomial(coeffs=[8.33139,0.0191877,-1.04263e-05,2.09722e-09,-1.48755e-13,-36064.3,-6.34272], Tmin=(784.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(144)', '[CH]F(128)'],
    products = ['[O]C(F)(F)O[CH]F(318)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]C(F)(F)O[CH]F(318)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(64.9796,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(144)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(318)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]O[C](F)OF(400)'],
    products = ['[O]C(F)(F)O[CH]F(318)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(72.6913,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(226.673,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
