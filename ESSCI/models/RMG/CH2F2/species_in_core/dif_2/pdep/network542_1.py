...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63974,0.0441336,-3.27825e-05,7.42935e-09,7.62061e-13,-126703,21.6548], Tmin=(100,'K'), Tmax=(1111.35,'K')), NASAPolynomial(coeffs=[14.1817,0.0114357,-5.44439e-06,1.10463e-09,-8.14714e-14,-130259,-43.6341], Tmin=(1111.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1054.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-625.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,422.936,423.119,423.137,423.638],'cm^-1')),
        HinderedRotor(inertia=(0.000938738,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341261,'amu*angstrom^2'), symmetry=1, barrier=(43.4871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98121,0.0114384,2.77965e-05,-4.94724e-08,2.0801e-11,-75136.3,10.9456], Tmin=(100,'K'), Tmax=(956.744,'K')), NASAPolynomial(coeffs=[11.8952,0.00171628,-1.48076e-07,9.26261e-11,-1.38642e-14,-78102.7,-38.2537], Tmin=(956.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-571.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,1380,1390,370,380,2900,435,180,1683.73,1683.86,1683.93,1685.8],'cm^-1')),
        HinderedRotor(inertia=(0.0032325,'amu*angstrom^2'), symmetry=1, barrier=(6.52394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283114,'amu*angstrom^2'), symmetry=1, barrier=(6.50934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40951,0.0640003,-0.000174444,2.22578e-07,-9.52298e-11,-68759.5,21.5423], Tmin=(100,'K'), Tmax=(850.388,'K')), NASAPolynomial(coeffs=[-13.7512,0.0627572,-3.59743e-05,7.18904e-09,-5.01394e-13,-63217.4,113.314], Tmin=(850.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-571.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(O)O[C](F)F(1410)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-587.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,2054.22,2055.04,2055.2],'cm^-1')),
        HinderedRotor(inertia=(0.188026,'amu*angstrom^2'), symmetry=1, barrier=(4.32309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187824,'amu*angstrom^2'), symmetry=1, barrier=(4.31844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187612,'amu*angstrom^2'), symmetry=1, barrier=(4.31356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90918,0.068617,-0.000166474,1.93769e-07,-7.87533e-11,-70610.1,24.7198], Tmin=(100,'K'), Tmax=(854.449,'K')), NASAPolynomial(coeffs=[-5.8757,0.0470529,-2.6784e-05,5.3242e-09,-3.69645e-13,-67162.2,73.444], Tmin=(854.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[C](O)O[C](F)F(1411)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-609.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,360,370,350,493,600,700,1144,1293,180,2436.78,2436.88],'cm^-1')),
        HinderedRotor(inertia=(0.235148,'amu*angstrom^2'), symmetry=1, barrier=(5.40651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235258,'amu*angstrom^2'), symmetry=1, barrier=(5.40904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235257,'amu*angstrom^2'), symmetry=1, barrier=(5.40902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235192,'amu*angstrom^2'), symmetry=1, barrier=(5.40752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39031,0.0721781,-0.000152214,1.55983e-07,-5.84444e-11,-73247.9,26.1056], Tmin=(100,'K'), Tmax=(859.967,'K')), NASAPolynomial(coeffs=[3.00051,0.0295334,-1.65113e-05,3.24736e-09,-2.23581e-13,-72224.9,26.1383], Tmin=(859.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    ...
    products = ['O=C(O)OC(F)F(1366)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.3639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C([O])OC(F)F(1409)'],
    products = ['O=C(O)OC(F)F(1366)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(1412)'],
    products = ['O=C(O)OC(F)F(1366)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(170)', 'O=[C]O(189)'],
    products = ['O=C(O)OC(F)F(1366)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(859)'],
    products = ['O=C(O)OC(F)F(1366)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(868)'],
    products = ['O=C(O)OC(F)F(1366)'],
