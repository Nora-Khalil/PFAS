...
"""),
    E0 = (-121.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1850,1860,440,470,900,1000,180,744.46],'cm^-1')),
        HinderedRotor(inertia=(0.00646034,'amu*angstrom^2'), symmetry=1, barrier=(2.54212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948725,'amu*angstrom^2'), symmetry=1, barrier=(21.8131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948675,'amu*angstrom^2'), symmetry=1, barrier=(21.8119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06199,0.0375154,-3.42725e-05,1.51226e-08,-2.60834e-12,-14581.6,21.0114], Tmin=(100,'K'), Tmax=(1405.71,'K')), NASAPolynomial(coeffs=[12.0417,0.00911812,-3.97073e-06,7.51918e-10,-5.26004e-14,-17387.4,-30.5335], Tmin=(1405.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CsCJ=O) + radical((O)CJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87808,0.0402373,-3.73354e-05,1.64042e-08,-2.79348e-12,-14935.1,21.5894], Tmin=(100,'K'), Tmax=(1431.01,'K')), NASAPolynomial(coeffs=[13.3863,0.00806889,-3.61582e-06,6.95088e-10,-4.90391e-14,-18228.8,-38.0555], Tmin=(1431.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C[C]=O(1921)'],
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', '[CH2]O[C]=O(874)'],
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[CH2]O[C]=O(874)'],
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.329931,'m^3/(mol*s)'), n=2.07304, Ea=(17.9031,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17748312369238067, var=0.6615994821919932, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C',), comment="""Estimated from node Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CO(12)', '[O]C[C]=O(1921)'],
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(11.0324,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(133.185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['O=[C]CO[C]=O(3277)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(21.4,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC=C=O(2912)'],
    products = ['O=[C]CO[C]=O(3277)'],
