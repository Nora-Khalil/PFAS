...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258438,'amu*angstrom^2'), symmetry=1, barrier=(5.94201,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31352,0.035731,-3.40922e-05,1.65582e-08,-3.20515e-12,-23540.6,16.6905], Tmin=(100,'K'), Tmax=(1242.69,'K')), NASAPolynomial(coeffs=[9.79313,0.0116553,-5.03095e-06,9.67572e-10,-6.86398e-14,-25399.6,-21.0194], Tmin=(1242.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96516,0.0410956,-4.35615e-05,2.24159e-08,-4.45559e-12,-29623.9,18.2764], Tmin=(100,'K'), Tmax=(1236.43,'K')), NASAPolynomial(coeffs=[12.2788,0.00772885,-3.08111e-06,5.8893e-10,-4.21873e-14,-32174.3,-33.6698], Tmin=(1236.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-179.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,180,629.836,1564.24],'cm^-1')),
        HinderedRotor(inertia=(0.117214,'amu*angstrom^2'), symmetry=1, barrier=(2.69499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12894,'amu*angstrom^2'), symmetry=1, barrier=(25.9565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.515,0.027424,-1.25836e-05,-2.75888e-09,2.71475e-12,-21504.7,17.0501], Tmin=(100,'K'), Tmax=(1087.61,'K')), NASAPolynomial(coeffs=[9.42112,0.0119557,-4.94656e-06,9.55407e-10,-6.88386e-14,-23594.3,-19.5482], Tmin=(1087.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[CH2]O[CH]OF(1641)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (108.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1279.78,1285.03],'cm^-1')),
        HinderedRotor(inertia=(0.20202,'amu*angstrom^2'), symmetry=1, barrier=(4.64483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201139,'amu*angstrom^2'), symmetry=1, barrier=(4.62459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201421,'amu*angstrom^2'), symmetry=1, barrier=(4.63108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05932,0.0566629,-0.000122899,1.32284e-07,-5.11965e-11,13105.6,18.159], Tmin=(100,'K'), Tmax=(860.919,'K')), NASAPolynomial(coeffs=[0.442243,0.0297679,-1.60888e-05,3.15013e-09,-2.16849e-13,14659.1,33.124], Tmin=(860.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-190.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,180,180,1523.88,1524.05],'cm^-1')),
        HinderedRotor(inertia=(0.213876,'amu*angstrom^2'), symmetry=1, barrier=(4.91743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214279,'amu*angstrom^2'), symmetry=1, barrier=(4.9267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37031,0.0600196,-0.000158155,1.91359e-07,-7.87095e-11,-22935.9,15.1582], Tmin=(100,'K'), Tmax=(863.043,'K')), NASAPolynomial(coeffs=[-8.36042,0.0469536,-2.6297e-05,5.19051e-09,-3.58152e-13,-18744.8,78.8971], Tmin=(863.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(131)', 'CH2(T)(17)'],
    products = ['[CH2]OC([O])F(1551)'],
    transitionState = 'TS2',
