...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'CF2(87)'],
    products = ['CF3(44)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.18506e+11,'cm^3/(mol*s)'), n=0.4717, Ea=(2.886,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Matched reaction 12 CF2 + F <=> CF3_p in halocarbene_recombination/training
This reaction matched rate rule [Root_N-3R->H_N-2Br1sCl1sF1s->Cl1s_3BrCClFINOPSSi->F]
family: halocarbene_recombination"""),
)

network(
    label = 'PDepNetwork #192',
    isomers = [
        'CF3(44)',
    ],
    reactants = [
