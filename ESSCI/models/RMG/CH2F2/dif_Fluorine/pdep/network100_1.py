...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.88791,'amu*angstrom^2'), symmetry=1, barrier=(43.4067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89675,'amu*angstrom^2'), symmetry=1, barrier=(43.61,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90006,'amu*angstrom^2'), symmetry=1, barrier=(43.6862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55121,0.0451401,-3.55109e-05,4.45875e-09,3.5391e-12,-49182.7,22.0162], Tmin=(100,'K'), Tmax=(1000.07,'K')), NASAPolynomial(coeffs=[16.2933,0.00449353,-2.01999e-06,4.4815e-10,-3.67441e-14,-53047.3,-53.6869], Tmin=(1000.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsFFHO) + group(Cds-OdOsH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(126)', '[O]O[C]=O(206)'],
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(207)', '[O]O[C](F)F(147)'],
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[O]O[C](F)F(147)'],
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(5.41783,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(209.441,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
...
reaction(
    ...
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(248.89,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 244.9 to 248.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.808e+07,'m^3/(mol*s)'), n=2.17087e-08, Ea=(11.9251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[O]O[C]=O(206)'],
    products = ['O=[C]OO[C](F)F(262)'],
    transitionState = 'TS9',
