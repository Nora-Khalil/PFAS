...
"""),
    E0 = (-529.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([235,523,627,1123,1142,1372,1406,3097,90,150,250,247,323,377,431,433,1065,1274,2227.63],'cm^-1')),
        HinderedRotor(inertia=(0.00118033,'amu*angstrom^2'), symmetry=1, barrier=(4.16936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00941222,'amu*angstrom^2'), symmetry=1, barrier=(33.2412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44925,0.0629868,-0.000106327,9.77237e-08,-3.52865e-11,-63573.9,20.0331], Tmin=(100,'K'), Tmax=(801.121,'K')), NASAPolynomial(coeffs=[7.00701,0.0241236,-1.2752e-05,2.5379e-09,-1.78922e-13,-64107.8,-3.32169], Tmin=(801.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (132.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05543,0.0738366,-0.000134471,1.2445e-07,-4.39192e-11,-86806.2,27.5003], Tmin=(100,'K'), Tmax=(841.909,'K')), NASAPolynomial(coeffs=[7.93571,0.0232108,-1.23153e-05,2.41516e-09,-1.67304e-13,-87329,-0.73378], Tmin=(841.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'CH2F-CF2(67)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(120.845,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(88)', 'CHF2-CF2(68)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.9233e-06,'m^3/(mol*s)'), n=3.30609, Ea=(141.4,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C(F)F(260)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]C(F)C(F)F(266)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC(F)=CC(F)F(267)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)[CH]C(F)F(269)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(F)[C](F)F(270)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', 'F[CH][C](F)F(185)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C](F)[C](F)C(F)F(271)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)[C](F)F(272)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(108)', 'F[CH]C=C(F)F(273)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'FC=C(F)[C](F)F(274)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[C](F)C=C(F)F(275)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'F[C]C(F)C(F)F-2(276)'],
    products = ['F[C](F)C(F)C(F)F(444)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)F(444)'],
    products = ['F[C](C(F)F)C(F)F(277)'],
