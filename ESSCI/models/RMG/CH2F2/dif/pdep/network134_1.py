...
"""),
    E0 = (-460.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([580,1155,1237,1373,3147,493,600,700,1144,1293,180,180,2051],'cm^-1')),
        HinderedRotor(inertia=(0.385476,'amu*angstrom^2'), symmetry=1, barrier=(8.86285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385009,'amu*angstrom^2'), symmetry=1, barrier=(8.85212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02941,0.0516261,-0.000100304,9.81372e-08,-3.59059e-11,-55342.8,19.4657], Tmin=(100,'K'), Tmax=(849.816,'K')), NASAPolynomial(coeffs=[5.06217,0.018969,-1.0215e-05,2.01038e-09,-1.39199e-13,-55194.5,9.23331], Tmin=(849.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'FC1OC(F)(F)O1(395)',
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90977,0.005212,0.000102594,-1.99581e-07,1.14992e-10,-116341,11.0251], Tmin=(10,'K'), Tmax=(581.371,'K')), NASAPolynomial(coeffs=[2.85619,0.0334405,-2.43677e-05,8.0788e-09,-9.96689e-13,-116573,12.4874], Tmin=(581.371,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-967.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""FC1OC(F)(F)O1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-588.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,2782.5,750,1395,475,1775,1000,180,495.221],'cm^-1')),
        HinderedRotor(inertia=(0.185229,'amu*angstrom^2'), symmetry=1, barrier=(4.25879,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48357,0.0604831,-9.58202e-05,7.77669e-08,-2.50524e-11,-80312.7,22.9467], Tmin=(100,'K'), Tmax=(761.544,'K')), NASAPolynomial(coeffs=[9.86044,0.0164787,-9.13556e-06,1.87327e-09,-1.35142e-13,-81588.5,-15.1839], Tmin=(761.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-317.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,493,600,700,1144,1293,180,180,1640.93,1641.89],'cm^-1')),
        HinderedRotor(inertia=(0.264478,'amu*angstrom^2'), symmetry=1, barrier=(6.08088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264947,'amu*angstrom^2'), symmetry=1, barrier=(6.09165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264435,'amu*angstrom^2'), symmetry=1, barrier=(6.07987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37763,0.0792814,-0.000187635,2.03466e-07,-7.82487e-11,-38145.8,23.1834], Tmin=(100,'K'), Tmax=(867.42,'K')), NASAPolynomial(coeffs=[-0.932753,0.0363867,-2.08588e-05,4.11887e-09,-2.82947e-13,-35730.4,45.6133], Tmin=(867.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][CH]OC(F)(F)F(399)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69753,0.0797628,-0.000209165,2.43978e-07,-9.79321e-11,-80491.4,18.6411], Tmin=(100,'K'), Tmax=(865.722,'K')), NASAPolynomial(coeffs=[-8.09881,0.050426,-2.90779e-05,5.76185e-09,-3.97099e-13,-75999.7,80.636], Tmin=(865.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[C](F)F(319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(394)'],
    products = ['[O]C(F)O[C](F)F(319)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[C](F)F(319)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(257654,'m^3/(mol*s)'), n=0.469398, Ea=(4.07748,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['FO[CH]O[C](F)F(398)'],
    products = ['[O]C(F)O[C](F)F(319)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(80.6484,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)O[C](F)F(319)'],
    products = ['[O][CH]OC(F)(F)F(399)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(203.528,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #134',
    isomers = [
        '[O]C(F)O[C](F)F(319)',
    ],
    reactants = [
