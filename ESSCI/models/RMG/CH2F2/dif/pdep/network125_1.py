...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55601,0.0451149,-3.15334e-05,-1.91102e-10,5.47314e-12,-62727.7,26.3089], Tmin=(100,'K'), Tmax=(971.768,'K')), NASAPolynomial(coeffs=[15.739,0.00638143,-2.07153e-06,4.01893e-10,-3.1738e-14,-66411.8,-46.4827], Tmin=(971.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-522.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO)"""),
)
...
"""),
    E0 = (-75.4884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([200.919,828.846,921.926,1037.17,1152.41,1272.19,1420.88,1521.32,1632.89],'cm^-1')),
        HinderedRotor(inertia=(0.150503,'amu*angstrom^2'), symmetry=1, barrier=(3.54372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150503,'amu*angstrom^2'), symmetry=1, barrier=(3.54372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150503,'amu*angstrom^2'), symmetry=1, barrier=(3.54372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96694,0.0109336,3.00703e-05,-5.80001e-08,2.63837e-11,-9030.89,16.4329], Tmin=(100,'K'), Tmax=(904.6,'K')), NASAPolynomial(coeffs=[13.5649,-0.00472586,4.29569e-06,-8.73094e-10,5.74474e-14,-12225,-40.6903], Tmin=(904.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(O2s-OsH)"""),
)
...
"""),
    E0 = (19.8123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,593.706,593.879,593.884,594.031,594.524,2311.05],'cm^-1')),
        HinderedRotor(inertia=(0.000477391,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000477207,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000477648,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59905,0.0207,6.95513e-06,-3.52785e-08,1.82424e-11,2442.75,19.1345], Tmin=(100,'K'), Tmax=(914.14,'K')), NASAPolynomial(coeffs=[14.2684,-0.00369176,3.21756e-06,-6.38064e-10,4.08335e-14,-805.053,-42.2106], Tmin=(914.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.8123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(O2sFO)"""),
)
...
"""),
    E0 = (-90.8431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([580,1155,1237,1373,3147,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90149,0.0386569,-2.69925e-05,-1.01224e-09,5.29142e-12,-10843.6,24.3535], Tmin=(100,'K'), Tmax=(959.703,'K')), NASAPolynomial(coeffs=[14.3173,0.00453959,-1.22485e-06,2.30903e-10,-1.9072e-14,-14038.6,-39.265], Tmin=(959.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.8431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (76.5163,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([598.567,599.352,600.754,600.834,601.406,2834.58,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00046881,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00046714,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.25054,0.00709423,2.63212e-05,-5.01068e-08,2.3332e-11,9238.71,16.175], Tmin=(100,'K'), Tmax=(881.876,'K')), NASAPolynomial(coeffs=[11.8239,-0.00611983,5.13017e-06,-1.07632e-09,7.44321e-14,6728.3,-29.7686], Tmin=(881.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.5163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(O2s-OsH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-406.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,369.567,370.141,371.394,371.669,1852.3],'cm^-1')),
        HinderedRotor(inertia=(0.00121271,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0887881,'amu*angstrom^2'), symmetry=1, barrier=(8.66489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0136,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30892,0.0364485,-4.19925e-05,2.43451e-08,-5.53863e-12,-48806.9,20.2522], Tmin=(100,'K'), Tmax=(1076.17,'K')), NASAPolynomial(coeffs=[9.6708,0.0090853,-3.85275e-06,7.18309e-10,-5.00064e-14,-50391.5,-15.805], Tmin=(1076.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (115.013,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63942,0.0424687,-2.70941e-05,-7.13849e-09,8.90263e-12,-36508.8,26.5071], Tmin=(100,'K'), Tmax=(941.739,'K')), NASAPolynomial(coeffs=[16.7313,0.00182747,2.70754e-07,-5.68561e-11,1.72327e-16,-40391.7,-50.9201], Tmin=(941.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(10)', '[O]OC(F)F(168)'],
    products = ['OOOOC(F)F(310)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.49151e+08,'m^3/(mol*s)'), n=0.0472428, Ea=(1.02237,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OOOO(309)', 'CF2(42)'],
    products = ['OOOOC(F)F(310)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(69.7321,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OOOOF(548)', 'CHF(40)'],
    products = ['OOOOC(F)F(310)'],
    transitionState = 'TS3',
