...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.355423,'amu*angstrom^2'), symmetry=1, barrier=(8.17188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355748,'amu*angstrom^2'), symmetry=1, barrier=(8.17935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247662,0.0930315,-0.000169673,1.54721e-07,-5.40281e-11,-66969.2,27.3571], Tmin=(100,'K'), Tmax=(832.798,'K')), NASAPolynomial(coeffs=[10.3081,0.0256979,-1.41504e-05,2.80974e-09,-1.95959e-13,-67985.5,-15.3793], Tmin=(832.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01929,0.0705894,-8.67169e-05,5.89265e-08,-1.6489e-11,-79819.6,24.9473], Tmin=(100,'K'), Tmax=(861.51,'K')), NASAPolynomial(coeffs=[9.99284,0.0289248,-1.41727e-05,2.78886e-09,-1.98411e-13,-81365.7,-17.0071], Tmin=(861.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674669,0.0823327,-0.000125246,8.7988e-08,-1.91225e-11,-70203,25.2019], Tmin=(100,'K'), Tmax=(597.544,'K')), NASAPolynomial(coeffs=[11.657,0.0231542,-1.26848e-05,2.5616e-09,-1.82365e-13,-71771.4,-24.2683], Tmin=(597.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-584.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[CH]C(F)=C(F)F(1115)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C(F)F(1173)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC(F)(F)[C](F)F(1809)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(106)', '[CH]=C=C(F)[C](F)F(1176)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', '[CH]C(F)=C(F)F(1115)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    products = ['[CH]C(F)=C(F)C(F)(F)F(1810)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    products = ['F[CH]C(F)=C(F)[C](F)F(501)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    products = ['[CH]=[C]C(F)(F)C(F)(F)F(1811)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(1800)'],
    products = ['FC=[C]C(F)(F)[C](F)F(1806)'],
