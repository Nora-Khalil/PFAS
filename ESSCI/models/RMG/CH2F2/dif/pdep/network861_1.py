species(
    label = '[O]C(F)C(F)(F)C(O)(F)F(1934)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292659,'amu*angstrom^2'), symmetry=1, barrier=(6.72882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565773,'amu*angstrom^2'), symmetry=1, barrier=(13.0082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292657,'amu*angstrom^2'), symmetry=1, barrier=(6.72875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.204146,0.0991034,-0.000154567,1.2224e-07,-3.80525e-11,-155272,30.3008], Tmin=(100,'K'), Tmax=(790.505,'K')), NASAPolynomial(coeffs=[14.5859,0.0242631,-1.25516e-05,2.46897e-09,-1.73444e-13,-157610,-37.5751], Tmin=(790.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1292.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.38787,'amu*angstrom^2'), symmetry=1, barrier=(31.9099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3931,'amu*angstrom^2'), symmetry=1, barrier=(32.0302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03034,0.0462781,-6.69894e-05,4.89419e-08,-1.41203e-11,-64798.6,17.5213], Tmin=(100,'K'), Tmax=(849.997,'K')), NASAPolynomial(coeffs=[9.3566,0.011803,-6.15346e-06,1.22947e-09,-8.77634e-14,-66044.1,-16.6333], Tmin=(849.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-539.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = '[O]C(F)C(O)(F)C(F)(F)F(2211)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1137.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,180,2080.48],'cm^-1')),
        HinderedRotor(inertia=(0.483676,'amu*angstrom^2'), symmetry=1, barrier=(11.1207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0159,'amu*angstrom^2'), symmetry=1, barrier=(23.3575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33483,'amu*angstrom^2'), symmetry=1, barrier=(53.6822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1192.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,223,363,546,575,694,1179,1410,2782.5,750,1395,475,1775,1000,223.434],'cm^-1')),
        HinderedRotor(inertia=(0.203919,'amu*angstrom^2'), symmetry=1, barrier=(7.15418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202318,'amu*angstrom^2'), symmetry=1, barrier=(7.15306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47152,'amu*angstrom^2'), symmetry=1, barrier=(16.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637861,0.079841,-0.000117252,8.99187e-08,-2.75455e-11,-143368,26.3864], Tmin=(100,'K'), Tmax=(798.612,'K')), NASAPolynomial(coeffs=[11.769,0.0240872,-1.25288e-05,2.49548e-09,-1.77513e-13,-145146,-24.8114], Tmin=(798.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1192.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'O=C(F)C(F)(F)C(O)(F)F(2213)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.236482,'amu*angstrom^2'), symmetry=1, barrier=(5.43719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236477,'amu*angstrom^2'), symmetry=1, barrier=(5.43707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80612,'amu*angstrom^2'), symmetry=1, barrier=(18.5343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152869,0.0915216,-0.000146222,1.1957e-07,-3.86896e-11,-173900,29.0452], Tmin=(100,'K'), Tmax=(759.506,'K')), NASAPolynomial(coeffs=[12.9667,0.0240372,-1.29442e-05,2.5847e-09,-1.82964e-13,-175846,-29.2494], Tmin=(759.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1446.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(COCsFO)"""),
)

species(
    label = '[O]C(F)[C](F)C(O)(F)F(2214)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309564,'amu*angstrom^2'), symmetry=1, barrier=(7.11749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30961,'amu*angstrom^2'), symmetry=1, barrier=(7.11855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309638,'amu*angstrom^2'), symmetry=1, barrier=(7.11918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675479,0.0832862,-0.000117696,6.65705e-08,-2.4584e-12,-106569,28.9721], Tmin=(100,'K'), Tmax=(569.083,'K')), NASAPolynomial(coeffs=[11.7663,0.0243984,-1.27378e-05,2.49176e-09,-1.73453e-13,-108140,-20.9952], Tmin=(569.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-886.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(F)C(F)(F)[C](O)F(2215)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.289411,'amu*angstrom^2'), symmetry=1, barrier=(6.65413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288987,'amu*angstrom^2'), symmetry=1, barrier=(6.64439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00808476,0.101517,-0.000191921,1.77339e-07,-6.15163e-11,-105185,29.9005], Tmin=(100,'K'), Tmax=(868.936,'K')), NASAPolynomial(coeffs=[9.5902,0.028145,-1.48789e-05,2.85224e-09,-1.93179e-13,-105752,-8.71674], Tmin=(868.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-875.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(O)(F)F(2216)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-909.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,180,1094.41,1096.9],'cm^-1')),
        HinderedRotor(inertia=(0.145094,'amu*angstrom^2'), symmetry=1, barrier=(3.33601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145026,'amu*angstrom^2'), symmetry=1, barrier=(3.33442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143737,'amu*angstrom^2'), symmetry=1, barrier=(3.3048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.55832,0.0867638,-0.00015413,1.45511e-07,-5.30359e-11,-109306,29.8164], Tmin=(100,'K'), Tmax=(823.06,'K')), NASAPolynomial(coeffs=[7.00003,0.0338548,-1.83344e-05,3.62961e-09,-2.53816e-13,-109634,4.43832], Tmin=(823.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.422036,'amu*angstrom^2'), symmetry=1, barrier=(9.70343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423382,'amu*angstrom^2'), symmetry=1, barrier=(9.73439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.112981,0.0973055,-0.000182441,1.67375e-07,-5.8113e-11,-105549,27.2417], Tmin=(100,'K'), Tmax=(851.576,'K')), NASAPolynomial(coeffs=[10.4131,0.0252474,-1.381e-05,2.71013e-09,-1.86774e-13,-106445,-15.7547], Tmin=(851.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)C(F)(F)C([O])(F)F(2218)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0498606,0.0959164,-0.000156633,1.29579e-07,-4.21079e-11,-124011,30.3301], Tmin=(100,'K'), Tmax=(784.878,'K')), NASAPolynomial(coeffs=[13.6952,0.0231008,-1.21867e-05,2.39757e-09,-1.67663e-13,-126083,-32.1097], Tmin=(784.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sH))"""),
)
...
species(
    label = '[O][C](F)C(F)(F)C(O)(F)F(2219)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1098.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,395,473,707,1436,180,180,3231.3],'cm^-1')),
        HinderedRotor(inertia=(0.363468,'amu*angstrom^2'), symmetry=1, barrier=(8.35684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364661,'amu*angstrom^2'), symmetry=1, barrier=(8.38428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363485,'amu*angstrom^2'), symmetry=1, barrier=(8.35723,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.448876,0.114304,-0.000225494,2.10771e-07,-7.31301e-11,-131960,32.0865], Tmin=(100,'K'), Tmax=(878.469,'K')), NASAPolynomial(coeffs=[10.1246,0.0287545,-1.5547e-05,2.97187e-09,-1.99563e-13,-132375,-9.33931], Tmin=(878.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1098.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)C(F)(F)C(=O)F(2220)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.337483,'amu*angstrom^2'), symmetry=1, barrier=(7.75939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334024,'amu*angstrom^2'), symmetry=1, barrier=(7.67987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881265,0.0742552,-0.00011105,8.70028e-08,-2.72535e-11,-119886,26.7342], Tmin=(100,'K'), Tmax=(781.227,'K')), NASAPolynomial(coeffs=[10.9671,0.0226104,-1.18825e-05,2.37099e-09,-1.68619e-13,-121462,-19.4334], Tmin=(781.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHO) + group(COCsFO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.637103,'amu*angstrom^2'), symmetry=1, barrier=(14.6482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.637942,'amu*angstrom^2'), symmetry=1, barrier=(14.6675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854236,0.0709515,-9.36215e-05,6.10015e-08,-1.55277e-11,-86417.8,23.8076], Tmin=(100,'K'), Tmax=(965.332,'K')), NASAPolynomial(coeffs=[14.2494,0.0154467,-7.37424e-06,1.43848e-09,-1.0213e-13,-89004,-40.3436], Tmin=(965.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-719.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(O2sj(Cs-F1sCdH))"""),
)

species(
    label = '[O]C=C(F)C(O)(F)F(2222)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-846.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,323,467,575,827,1418,3010,987.5,1337.5,450,1655,211.694,213.478],'cm^-1')),
        HinderedRotor(inertia=(0.309817,'amu*angstrom^2'), symmetry=1, barrier=(9.98827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.648413,'amu*angstrom^2'), symmetry=1, barrier=(21.5069,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922567,0.069893,-9.00421e-05,5.73449e-08,-1.43419e-11,-101704,23.3072], Tmin=(100,'K'), Tmax=(979.044,'K')), NASAPolynomial(coeffs=[13.9901,0.0165033,-8.24202e-06,1.64334e-09,-1.18171e-13,-104262,-39.4589], Tmin=(979.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-846.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'O=C(F)[C](F)C(O)(F)F(2223)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.497263,'amu*angstrom^2'), symmetry=1, barrier=(11.4331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58302,'amu*angstrom^2'), symmetry=1, barrier=(36.3967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497504,'amu*angstrom^2'), symmetry=1, barrier=(11.4386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817641,0.0749844,-0.000106464,7.65463e-08,-2.18181e-11,-130629,26.2821], Tmin=(100,'K'), Tmax=(858.614,'K')), NASAPolynomial(coeffs=[12.5923,0.0201305,-1.0635e-05,2.14019e-09,-1.53572e-13,-132651,-28.7288], Tmin=(858.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1087.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COCsFO) + radical(CsCOCsF1s)"""),
)

species(
    label = 'O[C](F)C(F)(F)C(O)(F)F(2224)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)C(F)(F)C(O)F(2225)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1258.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,201.654,201.748],'cm^-1')),
        HinderedRotor(inertia=(0.233349,'amu*angstrom^2'), symmetry=1, barrier=(6.73022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233281,'amu*angstrom^2'), symmetry=1, barrier=(6.73048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683912,'amu*angstrom^2'), symmetry=1, barrier=(19.7497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.1404,0.0978155,-0.000147888,1.13124e-07,-3.41545e-11,-151258,29.764], Tmin=(100,'K'), Tmax=(813.368,'K')), NASAPolynomial(coeffs=[14.7266,0.0247017,-1.3052e-05,2.60653e-09,-1.85376e-13,-153676,-38.8897], Tmin=(813.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1258.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'OOC(F)C(F)(F)[C](F)F(2226)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83806,'amu*angstrom^2'), symmetry=1, barrier=(42.2605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.619547,'amu*angstrom^2'), symmetry=1, barrier=(14.2446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618999,'amu*angstrom^2'), symmetry=1, barrier=(14.232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83838,'amu*angstrom^2'), symmetry=1, barrier=(42.2681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.624164,0.110932,-0.000187731,1.61322e-07,-5.43751e-11,-124289,30.8761], Tmin=(100,'K'), Tmax=(792.7,'K')), NASAPolynomial(coeffs=[14.0201,0.0285348,-1.57282e-05,3.13726e-09,-2.20699e-13,-126343,-34.6874], Tmin=(792.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1034.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)[C](F)C(F)OF(2227)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.364923,'amu*angstrom^2'), symmetry=1, barrier=(8.39029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.36401,'amu*angstrom^2'), symmetry=1, barrier=(8.3693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72238,'amu*angstrom^2'), symmetry=1, barrier=(39.601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816927,'amu*angstrom^2'), symmetry=1, barrier=(18.7828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.234409,0.102685,-0.000160695,1.23362e-07,-3.52782e-11,-117608,31.4583], Tmin=(100,'K'), Tmax=(648.736,'K')), NASAPolynomial(coeffs=[13.9899,0.0273336,-1.50296e-05,3.02211e-09,-2.14689e-13,-119714,-33.0139], Tmin=(648.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-979.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsCsF1s)"""),
)

species(
    label = 'O[C](F)C(F)(F)C(F)OF(2228)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.355238,'amu*angstrom^2'), symmetry=1, barrier=(8.16762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355138,'amu*angstrom^2'), symmetry=1, barrier=(8.16533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355342,'amu*angstrom^2'), symmetry=1, barrier=(8.17,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53335,'amu*angstrom^2'), symmetry=1, barrier=(35.2548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.741423,0.117938,-0.000218459,1.98581e-07,-6.85942e-11,-116232,31.8001], Tmin=(100,'K'), Tmax=(849.583,'K')), NASAPolynomial(coeffs=[12.159,0.0304607,-1.67995e-05,3.29245e-09,-2.26783e-13,-117459,-22.6548], Tmin=(849.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-967.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)
...
"""),
    E0 = (-994.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,297.582,297.649,297.685],'cm^-1')),
        HinderedRotor(inertia=(0.165272,'amu*angstrom^2'), symmetry=1, barrier=(10.3899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165081,'amu*angstrom^2'), symmetry=1, barrier=(10.3856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165327,'amu*angstrom^2'), symmetry=1, barrier=(10.3901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394885,'amu*angstrom^2'), symmetry=1, barrier=(24.8463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(F)C(O)(F)F(569)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)F(170)', 'OC(F)(F)[C]F(506)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    products = ['[O]C(F)C(O)(F)C(F)(F)F(2211)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', '[O]C(F)C(F)=C(F)F(792)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(O)F(296)', 'CF2CF2(60)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'OC(F)(F)C(F)(F)[CH]F(1023)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)(F)C(O)(F)F(2212)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFO(46)', 'OC(F)(F)[C](F)F(515)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=C(F)C(F)(F)C(O)(F)F(2213)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)[C](F)C(O)(F)F(2214)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(F)(F)[C](O)F(2215)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O][CH]C(F)(F)C(O)(F)F(2216)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', '[O]C(F)C(F)(F)[C](F)F(2217)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)C([O])(F)F(2218)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(239)', '[O]C(F)[C](F)F(402)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O][CH]F(127)', 'OC(F)(F)[C](F)F(515)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O][C](F)C(F)(F)C(O)(F)F(2219)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C(F)C(F)(F)C(=O)F(2220)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', '[O]C(F)C(F)=C(O)F(2221)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', '[O]C=C(F)C(O)(F)F(2222)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)[C](F)C(O)(F)F(2223)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
    products = ['O[C](F)C(F)(F)C(O)(F)F(2224)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(F)C(F)(F)C(O)F(2225)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OOC(F)C(F)(F)[C](F)F(2226)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(F)(F)[C](F)C(F)OF(2227)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C](F)C(F)(F)C(F)OF(2228)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)(F)C(F)(F)[CH]OF(2107)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1934)'],
...
network(
    label = 'PDepNetwork #861',
    isomers = [
        '[O]C(F)C(F)(F)C(O)(F)F(1934)',
    ],
    reactants = [
