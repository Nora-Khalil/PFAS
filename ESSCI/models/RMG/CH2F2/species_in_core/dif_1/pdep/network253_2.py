...
"""),
    E0 = (20.9052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,447.815,1383.55,1384.21,1384.63,1385.19,1385.22,1385.96],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.39188,0.000408014,1.38943e-05,-1.0182e-08,2.05744e-12,2492.29,8.31424], Tmin=(100,'K'), Tmax=(1748.83,'K')), NASAPolynomial(coeffs=[3.06259,0.0141581,-7.08517e-06,1.31722e-09,-8.69865e-14,1319.51,10.788], Tmin=(1748.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(OCOJ)"""),
)

species(
    label = '[O]C(F)C1(F)OO1(685)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-431.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([391,562,707,872,1109,1210,1289,3137,180,180,180,180,963.931,964.11,964.161,964.173,964.323],'cm^-1')),
        HinderedRotor(inertia=(0.00832895,'amu*angstrom^2'), symmetry=1, barrier=(5.49494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03307,0.0418101,-4.10256e-05,2.01727e-08,-3.9566e-12,-51855.5,19.5993], Tmin=(100,'K'), Tmax=(1226.02,'K')), NASAPolynomial(coeffs=[10.7841,0.0132592,-6.09457e-06,1.1785e-09,-8.34732e-14,-54001.3,-24.4025], Tmin=(1226.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(O2s-O2s-Cs(C-F)) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = 'FC1(F)[CH]OO1(686)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.90347,'amu*angstrom^2'), symmetry=1, barrier=(43.7644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9028,'amu*angstrom^2'), symmetry=1, barrier=(43.7492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90606,'amu*angstrom^2'), symmetry=1, barrier=(43.8241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37844,0.0170214,5.01457e-05,-8.52902e-08,3.52456e-11,-83480.4,17.8131], Tmin=(100,'K'), Tmax=(963.167,'K')), NASAPolynomial(coeffs=[17,0.00300205,-7.54965e-07,2.84789e-10,-3.34774e-14,-88463.3,-63.4244], Tmin=(963.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFFO) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)2-CO) + ring(Cyclobutane)"""),
)

species(
    label = '[O]C1OO[C]1F(688)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.07189,0.019598,-9.55021e-06,1.51373e-09,-5.73199e-14,-2246.94,14.5317], Tmin=(100,'K'), Tmax=(2806.04,'K')), NASAPolynomial(coeffs=[28.521,-0.00807937,1.40962e-06,-1.78914e-10,1.22993e-14,-18792.7,-133.681], Tmin=(2806.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C]1OOC1(F)F(304)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45122,0.038283,-5.10725e-05,4.24365e-08,-1.54811e-11,-29129.3,20.2178], Tmin=(100,'K'), Tmax=(652.907,'K')), NASAPolynomial(coeffs=[5.23181,0.0212482,-1.19377e-05,2.47796e-09,-1.81236e-13,-29492.4,7.98839], Tmin=(652.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + ring(O2s-Cs(F)(F)-Cs-O2s) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'O=C1OO[C]1F(689)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-351.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([691.304,691.305,691.305,691.305,691.305,691.305,691.305,691.305,691.305,691.305,691.305,691.305],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0179,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.37993,-0.00825372,0.000105286,-1.33998e-07,5.06611e-11,-42223.5,14.0357], Tmin=(100,'K'), Tmax=(961.487,'K')), NASAPolynomial(coeffs=[13.9312,0.00389364,-1.09741e-06,3.8725e-10,-4.37827e-14,-46843,-49.9251], Tmin=(961.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + group(Cds-OdCsOs) + ring(Cyclobutane) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O[C]1OOC1(F)F(690)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06036,0.0414481,-4.03767e-05,1.89835e-08,-3.53855e-12,-56256.4,20.7527], Tmin=(100,'K'), Tmax=(1285.89,'K')), NASAPolynomial(coeffs=[11.4878,0.0121222,-6.16755e-06,1.24776e-09,-9.03935e-14,-58680.9,-27.0998], Tmin=(1285.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + ring(O2s-Cs(F)(F)-Cs-O2s) + radical(Cs_P)"""),
)

species(
    label = 'FOC1OO[C]1F(691)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07383,0.0466995,-5.97874e-05,4.1585e-08,-1.19528e-11,-13125.2,21.1498], Tmin=(100,'K'), Tmax=(836.818,'K')), NASAPolynomial(coeffs=[7.85995,0.0190406,-1.02064e-05,2.08355e-09,-1.51187e-13,-14093.5,-5.73386], Tmin=(836.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Cs-Cs(F)-O2s-O2s) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(12)', '[O]OC(F)F(128)'],
    products = ['[O]OC(F)(F)C=O(899)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OF(154)', 'O=C[C]F(675)'],
    products = ['[O]OC(F)(F)C=O(899)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)(F)C=O(899)'],
    products = ['HO2(10)', 'CF2CO(106)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.58174e+10,'s^-1'), n=0.573333, Ea=(252.662,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]O[C](F)C=O(679)'],
    products = ['[O]OC(F)(F)C=O(899)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(147)', 'HCO(14)'],
    products = ['[O]OC(F)(F)C=O(899)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=O(680)'],
    products = ['[O]OC(F)(F)C=O(899)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C=O(681)'],
    products = ['[O]OC(F)(F)C=O(899)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(89)', '[O]C1OO1(684)'],
    products = ['[O]C1OOC1(F)F(2126)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.81816e-07,'m^3/(mol*s)'), n=3.45227, Ea=(197.811,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)C1(F)OO1(685)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2O(48)', '[O]C=O(142)'],
    products = ['[O]C1OOC1(F)F(2126)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(5.46542e-32,'m^3/(mol*s)'), n=10.9581, Ea=(341.592,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCSCdCdd->Cd',), comment="""Estimated from node Root_N-1COCSCdCdd->Cd
Multiplied by reaction path degeneracy 2.0
Ea raised from 335.2 to 341.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'FC1(F)[CH]OO1(686)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C1OOC1(F)F(246)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(688)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[O][C]1OOC1(F)F(304)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(689)'],
    products = ['[O]C1OOC1(F)F(2126)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(2126)'],
    products = ['O[C]1OOC1(F)F(690)'],
