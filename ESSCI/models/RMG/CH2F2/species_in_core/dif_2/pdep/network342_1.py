...
"""),
    E0 = (-457.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,580,1155,1237,1373,3147,258.1,258.102,258.11,2520.4],'cm^-1')),
        HinderedRotor(inertia=(0.17332,'amu*angstrom^2'), symmetry=1, barrier=(8.19411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173331,'amu*angstrom^2'), symmetry=1, barrier=(8.19397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692416,'amu*angstrom^2'), symmetry=1, barrier=(32.7337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20505,0.0695328,-0.000119125,1.10374e-07,-3.98186e-11,-54982.2,24.2592], Tmin=(100,'K'), Tmax=(816.24,'K')), NASAPolynomial(coeffs=[6.95565,0.0268485,-1.40317e-05,2.77024e-09,-1.94045e-13,-55437.8,0.643033], Tmin=(816.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10145,0.071358,-0.000121239,1.0987e-07,-3.87988e-11,-56955.9,24.4083], Tmin=(100,'K'), Tmax=(819.136,'K')), NASAPolynomial(coeffs=[7.92235,0.0251503,-1.30012e-05,2.55399e-09,-1.78321e-13,-57640.6,-4.4961], Tmin=(819.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C[C](F)F(728)'],
    products = ['F[CH]OC[C](F)F(801)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(668)'],
    products = ['F[CH]OC[C](F)F(801)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(86)', '[O]C[C](F)F(728)'],
    products = ['F[CH]OC[C](F)F(801)'],
