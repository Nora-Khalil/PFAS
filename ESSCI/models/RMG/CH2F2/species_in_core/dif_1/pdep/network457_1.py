...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.74934,'amu*angstrom^2'), symmetry=1, barrier=(17.2288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.479905,'amu*angstrom^2'), symmetry=1, barrier=(11.034,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59624,0.00365317,1.31032e-05,-1.4533e-08,4.48014e-12,-29006.8,10.4823], Tmin=(298,'K'), Tmax=(1100,'K')), NASAPolynomial(coeffs=[2.644,0.00997251,-3.98497e-06,7.25148e-10,-4.8844e-14,-29427.1,8.42306], Tmin=(1100,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-242.471,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(108.088,'J/mol/K'), label="""CH3F""", comment="""Thermo library: Fluorine"""),
)
...
"""),
    E0 = (-616.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.18014,'amu*angstrom^2'), symmetry=1, barrier=(27.1338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.549819,'amu*angstrom^2'), symmetry=1, barrier=(12.6414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.466147,'amu*angstrom^2'), symmetry=1, barrier=(27.1076,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-916.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,351,323,533,609,664,892,1120,1201,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
    ...
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.919955,0.0739475,-0.000111976,9.50135e-08,-3.28285e-11,-110073,21.6021], Tmin=(100,'K'), Tmax=(738.556,'K')), NASAPolynomial(coeffs=[8.90162,0.0283845,-1.46967e-05,2.92328e-09,-2.07406e-13,-111188,-14.0549], Tmin=(738.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-916.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-750.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,227.873],'cm^-1')),
        HinderedRotor(inertia=(0.174001,'amu*angstrom^2'), symmetry=1, barrier=(6.43285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176171,'amu*angstrom^2'), symmetry=1, barrier=(6.4374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)(F)OF(1194)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(39.1729,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(343.307,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH3F(87)', 'F[C]C(F)(F)OF(575)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(177.736,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(892)', 'C[C]F-2(419)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(577)', 'CC(F)(F)[C]F(1213)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(577)', 'CC(F)=C(F)F(1215)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)C(F)(F)OF(1216)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)[C](F)OF(1217)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)F(1183)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(156)', 'CC(F)(F)[C](F)F(1218)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(194)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(69)', 'FOC(F)(F)[C](F)F(584)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)OF(900)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(108)', 'CC(F)(F)C(=O)F(1056)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(108)', 'CC(F)=C(F)OF(1219)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)C(F)(F)OF(905)'],
    products = ['CC(F)(F)C(F)(F)OF(1194)'],
...
network(
    label = 'PDepNetwork #457',
    isomers = [
        'CC(F)(F)C(F)(F)OF(1194)',
    ],
    reactants = [
