...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(569)', 'CH2(S)(74)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FCO[C](F)OF(1111)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)(F)OF(1112)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OCF(1113)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(194)', '[O]CF(193)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(573)', 'CH2F(91)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(156)', 'FCO[C](F)F(1114)'],
    products = ['FCOC(F)(F)OF(1105)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]OC(F)(F)OF(571)'],
    products = ['FCOC(F)(F)OF(1105)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(108)', 'O=C(F)OCF(715)'],
    products = ['FCOC(F)(F)OF(1105)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FCOC(F)(F)OF(1105)'],
    products = ['F2(108)', 'CF2O(48)', 'CH2O(19)'],
