...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'O=C(O)OF(836)'],
    products = ['O=C(O)OC(=O)F(960)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(143)', 'O=[C]O(191)'],
    products = ['O=C(O)OC(=O)F(960)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(251)'],
    products = ['O=C(O)OC(=O)F(960)'],
