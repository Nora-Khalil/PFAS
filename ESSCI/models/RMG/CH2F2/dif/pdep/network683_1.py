...
"""),
    E0 = (-592.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,185.578,199.692],'cm^-1')),
        HinderedRotor(inertia=(0.198823,'amu*angstrom^2'), symmetry=1, barrier=(4.57134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212836,'amu*angstrom^2'), symmetry=1, barrier=(4.89351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453027,'amu*angstrom^2'), symmetry=1, barrier=(15.9262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.655502,'amu*angstrom^2'), symmetry=1, barrier=(15.0713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.655361,'amu*angstrom^2'), symmetry=1, barrier=(15.068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34891,'amu*angstrom^2'), symmetry=1, barrier=(31.0141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.066,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.222392,'amu*angstrom^2'), symmetry=1, barrier=(5.11324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222739,'amu*angstrom^2'), symmetry=1, barrier=(5.12121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221718,'amu*angstrom^2'), symmetry=1, barrier=(5.09774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-496.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,367.241,367.866],'cm^-1')),
        HinderedRotor(inertia=(0.0758487,'amu*angstrom^2'), symmetry=1, barrier=(7.24629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0757979,'amu*angstrom^2'), symmetry=1, barrier=(7.25004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.79248,0.0163519,0.000143877,-4.22893e-07,3.63388e-10,-59702.8,11.741], Tmin=(10,'K'), Tmax=(395.943,'K')), NASAPolynomial(coeffs=[3.91287,0.0380554,-2.51745e-05,7.94517e-09,-9.5535e-13,-59892,9.00301], Tmin=(395.943,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-496.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CC(F)(F)C[O]""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)COF(1610)'],
    products = ['HF(38)', 'CH2O(19)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(67.8664,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'CCOF(1792)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(331.063,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]COF(1735)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(165.484,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FCOF(297)', 'C[C]F(1325)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(179.67,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(24)', 'CC(F)(F)OF(1324)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(68.8015,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(24)', 'FOCC(F)F(1355)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(428)', 'C=C(C)F(1794)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](1576)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(228)', '[CH2]C(C)(F)F(1796)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(1527)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', 'FOC[C](F)F(1739)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(1449)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(1776)'],
    products = ['CC(F)(F)COF(1610)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(1452)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(443.417,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'CC(F)=COF(1453)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(195.402,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)COF(1779)'],
    products = ['CC(F)(F)COF(1610)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(10.477,'m^3/(mol*s)'), n=1.29062, Ea=(171.845,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #683',
    isomers = [
        'CC(F)(F)COF(1610)',
    ],
    reactants = [
        ('HF(38)', 'CH2O(19)', 'CH2CF2(56)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
