...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11599,'amu*angstrom^2'), symmetry=1, barrier=(25.6588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84102,0.0453938,-4.79347e-05,2.4696e-08,-4.99145e-12,-53682.2,20.7358], Tmin=(100,'K'), Tmax=(1203.5,'K')), NASAPolynomial(coeffs=[12.1594,0.0110992,-5.19092e-06,1.01845e-09,-7.29473e-14,-56165.8,-30.9555], Tmin=(1203.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(CsCFFO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3782,'amu*angstrom^2'), symmetry=1, barrier=(31.6875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37752,'amu*angstrom^2'), symmetry=1, barrier=(31.6718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79228,0.0530966,-8.90996e-05,7.67663e-08,-2.58317e-11,-24270,17.9714], Tmin=(100,'K'), Tmax=(818.985,'K')), NASAPolynomial(coeffs=[8.40969,0.0147242,-7.73416e-06,1.51018e-09,-1.04823e-13,-25150.9,-11.3931], Tmin=(818.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(COCsFO) + group(Cds-OdCsH) + radical(C=OCJC=O) + radical(C=OCCJ=O)"""),
)

species(
    label = '[O]C=CC([O])(F)F(3372)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41133,0.0452445,-2.05471e-05,-1.74133e-08,1.28659e-11,-52026.5,22.3169], Tmin=(100,'K'), Tmax=(951.76,'K')), NASAPolynomial(coeffs=[17.9914,0.00408835,-6.40846e-07,1.33647e-10,-1.47632e-14,-56474.5,-63.6398], Tmin=(951.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(O2sj(Cs-F1sF1sCd)) + radical(C=COJ)"""),
)

species(
    label = 'O=[C][CH]C(O)(F)F(3373)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37461,0.0620944,-9.86153e-05,8.13234e-08,-2.64333e-11,-55680.3,25.2117], Tmin=(100,'K'), Tmax=(802.084,'K')), NASAPolynomial(coeffs=[9.81508,0.0169433,-8.45753e-06,1.63328e-09,-1.13176e-13,-56935.9,-13.034], Tmin=(802.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[C](F)OF(3374)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.366992,'amu*angstrom^2'), symmetry=1, barrier=(8.43788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367005,'amu*angstrom^2'), symmetry=1, barrier=(8.43817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367025,'amu*angstrom^2'), symmetry=1, barrier=(8.43863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08183,0.0745282,-0.000140935,1.32165e-07,-4.65733e-11,-11912.5,24.5304], Tmin=(100,'K'), Tmax=(863.046,'K')), NASAPolynomial(coeffs=[7.27026,0.0231816,-1.23008e-05,2.37261e-09,-1.61714e-13,-12136.6,0.476384], Tmin=(863.046,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.8373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + radical(CsCsF1sO2s) + radical(CCCJ=O)"""),
)

species(
    label = '[O][C](F)CC(=O)F(3375)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {6,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49055,0.0657098,-0.000124057,1.20227e-07,-4.35645e-11,-50641.5,23.9008], Tmin=(100,'K'), Tmax=(864.142,'K')), NASAPolynomial(coeffs=[4.82279,0.0261431,-1.34689e-05,2.5811e-09,-1.75731e-13,-50316,13.5268], Tmin=(864.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(COCsFO) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(2919)'],
    products = ['[O]C(F)(F)C[C]=O(3299)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(3370)'],
    products = ['[O]C(F)(F)C[C]=O(3299)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(3371)'],
    products = ['[O]C(F)(F)C[C]=O(3299)'],
