...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(O)(F)F(600)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[C](F)OC(F)F(601)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)O[CH]F(602)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(239)', '[O]C(F)F(170)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(81)', '[O]C(O)(F)F(155)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(4)', 'F[C](F)OC(F)F(246)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)F(491)'],
    products = ['OC(F)(F)OC(F)F(349)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)F(577)'],
    products = ['OC(F)(F)OC(F)F(349)'],
