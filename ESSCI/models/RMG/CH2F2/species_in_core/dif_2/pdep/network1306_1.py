...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27231,0.0549135,-5.20832e-05,2.33611e-08,-4.09707e-12,-86107.4,21.2568], Tmin=(100,'K'), Tmax=(1377.24,'K')), NASAPolynomial(coeffs=[15.6718,0.0130917,-6.5331e-06,1.3119e-09,-9.45954e-14,-90073.6,-52.8212], Tmin=(1377.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-716.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(CdCFO) + group(Cds-OdOsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-341.632,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,296.006,855.128,855.128,855.128,855.128,855.128,855.128,1766.29,1766.29,1766.29,1766.29,1766.29,1766.29,1766.29,1766.29,1766.29],'cm^-1')),
        HinderedRotor(inertia=(0.158167,'amu*angstrom^2'), symmetry=1, barrier=(3.63658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64611,0.0503445,-6.94481e-05,4.84935e-08,-1.23674e-11,-41002.7,20.1307], Tmin=(100,'K'), Tmax=(1175.59,'K')), NASAPolynomial(coeffs=[9.90698,0.0091101,-8.62338e-08,-3.39009e-10,3.71341e-14,-42037.9,-17.2018], Tmin=(1175.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(CsCsF1sO2s) + radical(Cs_P)"""),
)

species(
    label = 'C=C(F)OC([O])[O](3903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-260.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,1452.89,1452.96,1452.98,1453.01],'cm^-1')),
        HinderedRotor(inertia=(0.159609,'amu*angstrom^2'), symmetry=1, barrier=(3.66971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159585,'amu*angstrom^2'), symmetry=1, barrier=(3.66917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08954,0.0637745,-0.000147537,1.80978e-07,-7.74302e-11,-31229.2,21.071], Tmin=(100,'K'), Tmax=(834.497,'K')), NASAPolynomial(coeffs=[-8.49623,0.0570981,-3.23292e-05,6.48965e-09,-4.56131e-13,-27463.2,82.2046], Tmin=(834.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CdCFO) + group(Cds-CdsHH) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[CH]=C(F)OC([O])O(3904)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-224.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,293,496,537,1218,3120,650,792.5,1650,180,1124.27,1124.28,1124.58],'cm^-1')),
        HinderedRotor(inertia=(0.234188,'amu*angstrom^2'), symmetry=1, barrier=(5.38445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234297,'amu*angstrom^2'), symmetry=1, barrier=(5.38694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23422,'amu*angstrom^2'), symmetry=1, barrier=(5.38518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37548,0.0717235,-0.000141468,1.48516e-07,-5.81489e-11,-26979.9,23.9688], Tmin=(100,'K'), Tmax=(829.546,'K')), NASAPolynomial(coeffs=[1.5359,0.0381203,-2.13427e-05,4.27014e-09,-2.99796e-13,-25877,30.0332], Tmin=(829.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CdCFO) + group(Cds-CdsHH) + radical(OCOJ) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = '[CH2]C(F)OC([O])=O(3905)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64079,0.0496188,-4.40988e-05,1.91432e-08,-3.32322e-12,-49737.6,23.264], Tmin=(100,'K'), Tmax=(1366.39,'K')), NASAPolynomial(coeffs=[12.827,0.016872,-8.15001e-06,1.60365e-09,-1.14119e-13,-52794.5,-34.1952], Tmin=(1366.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH]=C(F)O[C](O)O(3906)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-247.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,360,370,350,293,496,537,1218,3120,650,792.5,1650,231.48,231.49,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00647148,'amu*angstrom^2'), symmetry=1, barrier=(6.24889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600758,'amu*angstrom^2'), symmetry=1, barrier=(22.8435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6007,'amu*angstrom^2'), symmetry=1, barrier=(22.8434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16435,'amu*angstrom^2'), symmetry=1, barrier=(6.2489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883749,0.074935,-0.00012584,1.08737e-07,-3.68867e-11,-29618.9,25.2591], Tmin=(100,'K'), Tmax=(797.488,'K')), NASAPolynomial(coeffs=[10.341,0.0207287,-1.11468e-05,2.21195e-09,-1.55312e-13,-30912,-16.8767], Tmin=(797.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'C[C](F)OC([O])=O(3907)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92989,0.048706,-4.6867e-05,2.37614e-08,-5.0364e-12,-51934.8,21.3371], Tmin=(100,'K'), Tmax=(1103.01,'K')), NASAPolynomial(coeffs=[9.14453,0.0225427,-1.12875e-05,2.25705e-09,-1.6243e-13,-53526.3,-14.1767], Tmin=(1103.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-432.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6395,0.0435325,-3.02473e-05,1.63769e-09,3.82305e-12,-35007.7,21.653], Tmin=(100,'K'), Tmax=(1015.01,'K')), NASAPolynomial(coeffs=[14.9642,0.0082033,-3.42812e-06,6.99817e-10,-5.36032e-14,-38597.7,-47.1892], Tmin=(1015.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-473.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,180,180,983.624,983.672,983.733,983.777],'cm^-1')),
        HinderedRotor(inertia=(0.24619,'amu*angstrom^2'), symmetry=1, barrier=(5.66038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.024961,'amu*angstrom^2'), symmetry=1, barrier=(17.1407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90451,0.0487005,-5.12084e-05,2.72883e-08,-5.92053e-12,-56820.3,19.4652], Tmin=(100,'K'), Tmax=(1096.57,'K')), NASAPolynomial(coeffs=[10.261,0.0182178,-9.51069e-06,1.93768e-09,-1.40947e-13,-58652.9,-21.6205], Tmin=(1096.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(CdCFO) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(OC=OOJ)"""),
)

species(
    label = '[CH]=C(F)OC(=O)O(3910)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57898,0.0682154,-0.000139503,1.45843e-07,-5.55404e-11,-5956.56,21.2522], Tmin=(100,'K'), Tmax=(864.095,'K')), NASAPolynomial(coeffs=[0.898269,0.0349016,-1.83728e-05,3.55127e-09,-2.42825e-13,-4477.57,32.314], Tmin=(864.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(=O)O(3912)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {6,S} {10,S}
4  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29173,0.0542957,-4.94341e-05,2.10231e-08,-3.49893e-12,-50365.8,22.4909], Tmin=(100,'K'), Tmax=(1443.08,'K')), NASAPolynomial(coeffs=[16.0233,0.013462,-6.98991e-06,1.41507e-09,-1.02021e-13,-54617.5,-53.9838], Tmin=(1443.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-419.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(Cds-OdOsOs) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-282.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,180,180,180,180,668.626,1546.58,1779.35,2482.66,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0342923,'amu*angstrom^2'), symmetry=1, barrier=(1.6998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0342923,'amu*angstrom^2'), symmetry=1, barrier=(1.6998,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(3902)'],
    products = ['C=C(F)OC(=O)O(3345)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(3908)'],
    products = ['C=C(F)OC(=O)O(3345)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(241)', 'CH2CF(100)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O(189)', 'CH2CFO(107)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'C=C(F)O[C]=O(877)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(3909)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(3910)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(=O)O(3282)'],
    products = ['C=C(F)OC(=O)O(3345)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(72)', 'O=C(O)[O+]=[C-]F(3244)'],
    products = ['C=C(F)OC(=O)O(3345)'],
