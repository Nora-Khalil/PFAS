...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C](F)OOF(295)'],
    products = ['OC(F)(F)OOF(575)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(248)', '[O]C(O)(F)F(190)'],
    products = ['OC(F)(F)OOF(575)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OF(124)', 'O[C](F)F(237)'],
    products = ['OC(F)(F)OOF(575)'],
    transitionState = 'TS5',
