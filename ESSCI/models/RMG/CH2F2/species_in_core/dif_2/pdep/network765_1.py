...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(233)', 'CH2(T)(66)'],
    products = ['[CH2]OO[C]=O(1896)'],
    transitionState = 'TS2',
