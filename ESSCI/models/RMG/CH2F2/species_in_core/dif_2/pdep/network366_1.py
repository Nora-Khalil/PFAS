...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'O=C(O)OF(854)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(855)', 'CHF(86)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(858)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(859)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(860)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(190)', '[O]C(F)F(170)'],
    products = ['O=C(OF)OC(F)F(821)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(154)', 'O=[C]OC(F)F(251)'],
    products = ['O=C(OF)OC(F)F(821)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(861)'],
    products = ['O=C(OF)OC(F)F(821)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(OF)OC(F)F(821)'],
    products = ['F2(106)', 'CO2(13)', 'CHFO(46)'],
