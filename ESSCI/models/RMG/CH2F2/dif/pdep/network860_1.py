...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.91095,'amu*angstrom^2'), symmetry=1, barrier=(20.9445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900815,'amu*angstrom^2'), symmetry=1, barrier=(20.7115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.534233,'amu*angstrom^2'), symmetry=1, barrier=(12.2831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534517,'amu*angstrom^2'), symmetry=1, barrier=(12.2896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-1065.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,251,367,519,700,855,1175,1303,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,231.9,231.94,232.045],'cm^-1')),
        HinderedRotor(inertia=(0.232163,'amu*angstrom^2'), symmetry=1, barrier=(8.86539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231929,'amu*angstrom^2'), symmetry=1, barrier=(8.86713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812145,'amu*angstrom^2'), symmetry=1, barrier=(31.0046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0539634,0.0973423,-0.000163896,1.41159e-07,-4.78095e-11,-128005,29.4523], Tmin=(100,'K'), Tmax=(788.094,'K')), NASAPolynomial(coeffs=[12.5438,0.026084,-1.43402e-05,2.86391e-09,-2.01802e-13,-129764,-26.8828], Tmin=(788.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1065.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-529.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,267.844,267.874,267.905,268.033],'cm^-1')),
        HinderedRotor(inertia=(0.187809,'amu*angstrom^2'), symmetry=1, barrier=(9.56781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187764,'amu*angstrom^2'), symmetry=1, barrier=(9.56793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.605304,'amu*angstrom^2'), symmetry=1, barrier=(30.849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0647233,0.0979739,-0.000167929,1.4576e-07,-4.93244e-11,-63539.9,29.6864], Tmin=(100,'K'), Tmax=(810.677,'K')), NASAPolynomial(coeffs=[12.4693,0.0254137,-1.38435e-05,2.742e-09,-1.91764e-13,-65220,-25.9806], Tmin=(810.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C([CH]F)C(F)(F)OF(2038)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-542.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,180,180,180,1239.2],'cm^-1')),
        HinderedRotor(inertia=(0.428572,'amu*angstrom^2'), symmetry=1, barrier=(9.85371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663595,'amu*angstrom^2'), symmetry=1, barrier=(15.2574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39377,'amu*angstrom^2'), symmetry=1, barrier=(32.0456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.187623,0.101468,-0.000177061,1.55476e-07,-5.30577e-11,-65123.7,29.0705], Tmin=(100,'K'), Tmax=(812.756,'K')), NASAPolynomial(coeffs=[12.5434,0.0260987,-1.44983e-05,2.88742e-09,-2.02319e-13,-66773.3,-27.1269], Tmin=(812.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(C(F)F)C([O])(F)F(2039)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-833.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,351,323,533,609,664,892,1120,1201,296.82,296.82,296.821],'cm^-1')),
        HinderedRotor(inertia=(0.147287,'amu*angstrom^2'), symmetry=1, barrier=(9.20828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147285,'amu*angstrom^2'), symmetry=1, barrier=(9.2083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.440845,0.0842714,-0.000123169,9.20751e-08,-2.73322e-11,-100094,27.7103], Tmin=(100,'K'), Tmax=(824.988,'K')), NASAPolynomial(coeffs=[13.0196,0.0232818,-1.22757e-05,2.46208e-09,-1.75984e-13,-102169,-30.5549], Tmin=(824.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-833.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-665.978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,190,488,555,1236,1407,227.781,227.782,227.787],'cm^-1')),
        HinderedRotor(inertia=(0.246688,'amu*angstrom^2'), symmetry=1, barrier=(9.08284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04718,'amu*angstrom^2'), symmetry=1, barrier=(38.5557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613626,0.083857,-0.000148188,1.36481e-07,-4.8868e-11,-79985.8,24.698], Tmin=(100,'K'), Tmax=(807.32,'K')), NASAPolynomial(coeffs=[8.80639,0.0278136,-1.53515e-05,3.08155e-09,-2.17504e-13,-80805.1,-9.95537], Tmin=(807.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.601145,'amu*angstrom^2'), symmetry=1, barrier=(13.8215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.601555,'amu*angstrom^2'), symmetry=1, barrier=(13.8309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01504,'amu*angstrom^2'), symmetry=1, barrier=(23.3377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.652894,0.112548,-0.0002006,1.75119e-07,-5.8939e-11,-93905,30.6259], Tmin=(100,'K'), Tmax=(824.351,'K')), NASAPolynomial(coeffs=[14.5115,0.0244523,-1.3892e-05,2.76735e-09,-1.93126e-13,-95912,-36.6132], Tmin=(824.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-782.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
"""),
    E0 = (-793.806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,486,617,768,1157,1926,340.248,345.841,352.101],'cm^-1')),
        HinderedRotor(inertia=(0.00130138,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0605322,'amu*angstrom^2'), symmetry=1, barrier=(5.49728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-703.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,280,501,1494,1531,180,180,1209.67],'cm^-1')),
        HinderedRotor(inertia=(2.23892,'amu*angstrom^2'), symmetry=1, barrier=(51.4771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608446,'amu*angstrom^2'), symmetry=1, barrier=(13.9894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23958,'amu*angstrom^2'), symmetry=1, barrier=(51.4924,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717053,0.0802114,-0.000134779,1.20789e-07,-4.26197e-11,-84488.5,26.2922], Tmin=(100,'K'), Tmax=(802.405,'K')), NASAPolynomial(coeffs=[8.83883,0.0279353,-1.50174e-05,2.97671e-09,-2.08986e-13,-85412.4,-8.7378], Tmin=(802.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=C([CH]F)C(F)(F)OF(2044)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-704.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,251,367,519,700,855,1175,1303,375,552.5,462.5,1710,235,1215,1347,1486,3221,180,180,1330.6],'cm^-1')),
        HinderedRotor(inertia=(0.473964,'amu*angstrom^2'), symmetry=1, barrier=(10.8974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853691,'amu*angstrom^2'), symmetry=1, barrier=(19.628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15333,'amu*angstrom^2'), symmetry=1, barrier=(49.5093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573396,0.0815541,-0.000126904,1.01208e-07,-3.20175e-11,-84613.4,25.5916], Tmin=(100,'K'), Tmax=(775.748,'K')), NASAPolynomial(coeffs=[12.1048,0.022092,-1.1922e-05,2.39018e-09,-1.69975e-13,-86402.5,-27.1121], Tmin=(775.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    E0 = (-625.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,200.791,200.791,200.792,200.792],'cm^-1')),
        HinderedRotor(inertia=(0.312006,'amu*angstrom^2'), symmetry=1, barrier=(8.92647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312005,'amu*angstrom^2'), symmetry=1, barrier=(8.92647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2103,'amu*angstrom^2'), symmetry=1, barrier=(34.6264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702121,'amu*angstrom^2'), symmetry=1, barrier=(20.0876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.725305,0.114588,-0.000201465,1.76904e-07,-6.0151e-11,-75046.6,32.4199], Tmin=(100,'K'), Tmax=(820.102,'K')), NASAPolynomial(coeffs=[13.7902,0.0284323,-1.57931e-05,3.13603e-09,-2.19039e-13,-76911,-31.5817], Tmin=(820.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(OF)C(F)(F)OF(2049)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-638.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,228.499,232.131,241.322,242.493],'cm^-1')),
        HinderedRotor(inertia=(0.200724,'amu*angstrom^2'), symmetry=1, barrier=(7.70107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198427,'amu*angstrom^2'), symmetry=1, barrier=(7.72381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725952,'amu*angstrom^2'), symmetry=1, barrier=(28.5567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78504,'amu*angstrom^2'), symmetry=1, barrier=(28.5909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.847332,0.118071,-0.000210552,1.86552e-07,-6.38515e-11,-76630.5,31.8009], Tmin=(100,'K'), Tmax=(820.88,'K')), NASAPolynomial(coeffs=[13.8623,0.0291212,-1.64502e-05,3.28201e-09,-2.29641e-13,-78463.5,-32.7163], Tmin=(820.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(OF)C(F)F(2035)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', '[O]C(F)C(F)(F)OF(542)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'FOC(F)(F)[CH]C(F)F(895)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(240)', 'O=CC(F)F(618)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(81)', 'O=CC(F)(F)OF(543)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(C(F)F)C(F)(F)OF(2036)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C([C](F)OF)C(F)F(2037)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C([CH]F)C(F)(F)OF(2038)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(C(F)F)C([O])(F)F(2039)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', '[O]C([C](F)F)C(F)F(1868)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(240)', '[O][CH]C(F)F(1486)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(81)', '[O][CH]C(F)(F)OF(410)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O][C](C(F)F)C(F)(F)OF(2040)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', '[O]C(C(=O)F)C(F)F(2042)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C([C](F)OF)C(F)F(2043)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C([CH]F)C(F)(F)OF(2044)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
    products = ['F2(77)', 'CF2O(48)', 'O=C[CH]F(2045)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FO[C](F)C(OF)C(F)F(2048)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH]C(OF)C(F)(F)OF(2049)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(1933)'],
...
network(
    label = 'PDepNetwork #860',
    isomers = [
        '[O]C(C(F)F)C(F)(F)OF(1933)',
    ],
    reactants = [
