...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4029,0.0622122,-9.92088e-05,8.15338e-08,-2.65931e-11,-97621.4,20.5684], Tmin=(100,'K'), Tmax=(752.542,'K')), NASAPolynomial(coeffs=[9.89099,0.0170985,-9.29284e-06,1.88426e-09,-1.34904e-13,-98899,-17.9692], Tmin=(752.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.172185,'amu*angstrom^2'), symmetry=1, barrier=(3.95887,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06246,0.0702002,-0.000120326,1.02522e-07,-3.39438e-11,-59837.8,25.2506], Tmin=(100,'K'), Tmax=(806.463,'K')), NASAPolynomial(coeffs=[11.0458,0.0153191,-8.2715e-06,1.64417e-09,-1.15241e-13,-61273.6,-19.6845], Tmin=(806.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(278)'],
    products = ['[O]C(F)(F)C([O])(F)F(253)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(279)'],
    products = ['[O]C(F)(F)C([O])(F)F(253)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(77)', '[O][C](F)C(=O)F(280)'],
    products = ['[O]C(F)(F)C([O])(F)F(253)'],
    transitionState = 'TS7',
