...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34453,0.0385976,-3.39447e-05,1.61103e-08,-3.25016e-12,-26796.7,20.5256], Tmin=(100,'K'), Tmax=(1142.48,'K')), NASAPolynomial(coeffs=[7.65615,0.0200005,-9.52745e-06,1.86203e-09,-1.32263e-13,-28010.4,-5.80734], Tmin=(1142.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(CsFHHO) + group(Cds-OdCsOs) + radical(CJCO) + radical(Csj(F1s)(O2s-CO)(H))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79186,0.0469583,-5.61988e-05,3.6771e-08,-9.24499e-12,-6762.28,20.5168], Tmin=(100,'K'), Tmax=(1123.12,'K')), NASAPolynomial(coeffs=[9.2718,0.013906,-3.49104e-06,4.00877e-10,-1.76246e-14,-8038.02,-14.6376], Tmin=(1123.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.8976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFHHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[CH2][C]1OC(F)O1(3466)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87234,0.0243422,5.11722e-05,-1.00518e-07,4.4532e-11,-46350.2,11.854], Tmin=(100,'K'), Tmax=(932.411,'K')), NASAPolynomial(coeffs=[21.887,-0.00398853,4.19595e-06,-7.55924e-10,4.06764e-14,-52583.5,-96.7154], Tmin=(932.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(CsFHOO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = '[O][C]1CC(F)O1(3469)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8288,0.0229184,-6.87056e-07,-8.26852e-09,2.75922e-12,-12016.9,19.8494], Tmin=(100,'K'), Tmax=(1376.51,'K')), NASAPolynomial(coeffs=[7.48116,0.0203176,-9.75097e-06,1.88371e-09,-1.31183e-13,-14332.1,-7.83951], Tmin=(1376.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(O2s-Cs-Cs-Cs(F)) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH]=C(O)O[CH]F(3470)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.881984,'amu*angstrom^2'), symmetry=1, barrier=(20.2785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.878749,'amu*angstrom^2'), symmetry=1, barrier=(20.2042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.8786,'amu*angstrom^2'), symmetry=1, barrier=(20.2007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.75055,0.0649256,-8.49594e-05,5.10108e-08,-1.14407e-11,-8855.8,21.055], Tmin=(100,'K'), Tmax=(1182.83,'K')), NASAPolynomial(coeffs=[18.2302,0.00163092,6.12602e-07,-2.09328e-10,1.70251e-14,-12698.2,-64.9723], Tmin=(1182.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.6513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=O)OCF(3471)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {5,D}
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH2]C([O])=O(882)'],
    products = ['[CH2]C(=O)O[CH]F(3289)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(66)', 'O=[C]O[CH]F(406)'],
    products = ['[CH2]C(=O)O[CH]F(3289)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(86)', '[CH2]C([O])=O(882)'],
    products = ['[CH2]C(=O)O[CH]F(3289)'],
