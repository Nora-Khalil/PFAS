...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])(F)F(1159)'],
    products = ['[CH2]C(F)(F)C[O](1591)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](1059)'],
    products = ['[CH2]C(F)(F)C[O](1591)'],
