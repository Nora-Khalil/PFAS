...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.35321,'amu*angstrom^2'), symmetry=1, barrier=(8.12098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999858,'amu*angstrom^2'), symmetry=1, barrier=(22.9887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353947,'amu*angstrom^2'), symmetry=1, barrier=(8.13794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310678,0.102552,-0.000170294,1.43023e-07,-4.67589e-11,-40691.4,29.4991], Tmin=(100,'K'), Tmax=(827.081,'K')), NASAPolynomial(coeffs=[13.8138,0.0249604,-1.27398e-05,2.45775e-09,-1.69276e-13,-42710.4,-34.0425], Tmin=(827.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-468.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,234,347,1316,1464,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,337.171],'cm^-1')),
        HinderedRotor(inertia=(0.108417,'amu*angstrom^2'), symmetry=1, barrier=(8.45983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168793,'amu*angstrom^2'), symmetry=1, barrier=(13.3784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562288,'amu*angstrom^2'), symmetry=1, barrier=(43.5611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984557,0.0712145,-9.33675e-05,6.4908e-08,-1.82314e-11,-56273,25.2135], Tmin=(100,'K'), Tmax=(864.725,'K')), NASAPolynomial(coeffs=[11.0796,0.0245165,-1.23613e-05,2.45467e-09,-1.75304e-13,-58018.9,-22.022], Tmin=(864.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCOCsF1s) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16288,'amu*angstrom^2'), symmetry=1, barrier=(26.7368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847262,0.0763394,-0.000131578,1.15083e-07,-3.91043e-11,-66131.8,25.4981], Tmin=(100,'K'), Tmax=(821.506,'K')), NASAPolynomial(coeffs=[10.2223,0.0205074,-1.10383e-05,2.17222e-09,-1.51193e-13,-67328.5,-15.796], Tmin=(821.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCsF1sF1s)"""),
)
...
species(
    label = '[CH2]C(F)(F)C1(F)[CH]OO1(4091)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)(F)C1(F)OC1[O](4092)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.185412,'amu*angstrom^2'), symmetry=1, barrier=(4.26299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43472,'amu*angstrom^2'), symmetry=1, barrier=(9.99507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67019,'amu*angstrom^2'), symmetry=1, barrier=(38.4008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751683,0.0785743,-0.000125216,1.09947e-07,-3.88066e-11,-59606.9,25.6851], Tmin=(100,'K'), Tmax=(767.883,'K')), NASAPolynomial(coeffs=[8.87532,0.0293656,-1.56279e-05,3.11622e-09,-2.206e-13,-60651.3,-10.0382], Tmin=(767.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04162,'amu*angstrom^2'), symmetry=1, barrier=(23.9489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04141,'amu*angstrom^2'), symmetry=1, barrier=(23.944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03075,0.0713222,-9.92834e-05,7.30809e-08,-2.06162e-11,-54976.8,24.2263], Tmin=(100,'K'), Tmax=(662.396,'K')), NASAPolynomial(coeffs=[9.73676,0.025952,-1.28526e-05,2.50845e-09,-1.76382e-13,-56288.2,-15.382], Tmin=(662.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-244.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,350,440,435,1725,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.18086,'amu*angstrom^2'), symmetry=1, barrier=(27.1504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308891,0.0648441,-7.05444e-05,3.54809e-08,-6.59939e-12,-29270.2,23.8351], Tmin=(100,'K'), Tmax=(1514.25,'K')), NASAPolynomial(coeffs=[19.9661,0.00292032,7.00441e-07,-2.45738e-10,1.88927e-14,-34077.2,-75.3706], Tmin=(1514.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
species(
    label = '[CH2]C(F)(F)C(O)(F)[C]=O(4097)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.2668,0.100166,-0.000158328,1.25175e-07,-3.87272e-11,-81935.4,30.4183], Tmin=(100,'K'), Tmax=(796.969,'K')), NASAPolynomial(coeffs=[15.291,0.0220771,-1.13464e-05,2.21795e-09,-1.54948e-13,-84415.1,-41.1078], Tmin=(796.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(CCCJ=O)"""),
)

species(
    label = 'CC(F)(F)C([O])(F)[C]=O(4098)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-335.899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,248,333,466,604,684,796,1061,1199,350,440,435,1725,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,204.757,207.136],'cm^-1')),
        HinderedRotor(inertia=(0.634443,'amu*angstrom^2'), symmetry=1, barrier=(16.5885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220312,'amu*angstrom^2'), symmetry=1, barrier=(7.09433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10234,'amu*angstrom^2'), symmetry=1, barrier=(31.4843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.110979,0.0975994,-0.000151885,1.21505e-07,-3.85211e-11,-40258,28.7003], Tmin=(100,'K'), Tmax=(774.51,'K')), NASAPolynomial(coeffs=[13.6786,0.0263809,-1.39529e-05,2.77612e-09,-1.96508e-13,-42394,-34.3026], Tmin=(774.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)

species(
    label = '[O]C=C([O])C(F)(F)CF(4100)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.59048,'amu*angstrom^2'), symmetry=1, barrier=(36.5683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672619,'amu*angstrom^2'), symmetry=1, barrier=(15.4648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.901513,'amu*angstrom^2'), symmetry=1, barrier=(20.7276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59366,'amu*angstrom^2'), symmetry=1, barrier=(36.6415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.118803,0.100534,-0.000172197,1.53511e-07,-5.34414e-11,-35467.9,31.1558], Tmin=(100,'K'), Tmax=(813.062,'K')), NASAPolynomial(coeffs=[10.8307,0.0315349,-1.6987e-05,3.35911e-09,-2.34994e-13,-36748.3,-16.3278], Tmin=(813.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[O]C(F)(C=O)[C](F)CF(4102)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    ...
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C([O])=COF(4090)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)C=O(2738)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(66)', '[O]C(F)(C=O)[C](F)F(3093)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]OO1(4091)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['[CH2]C(F)(F)C1(F)OC1[O](4092)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)C=O(4093)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(14)', '[CH2]C(F)(F)C(=O)F(571)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=C(F)C([O])(F)C=O(4094)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'C=C(F)C([O])=C[O](4095)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['[CH2]C(F)(F)C(O)(F)[C]=O(4097)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['CC(F)(F)C([O])(F)[C]=O(4098)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(F)C(=C[O])OF(4099)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
    products = ['[O]C=C([O])C(F)(F)CF(4100)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C](F)C(F)(C=O)OF(4101)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)(C=O)[C](F)CF(4102)'],
    products = ['[CH2]C(F)(F)C([O])(F)C=O(3709)'],
...
network(
    label = 'PDepNetwork #1334',
    isomers = [
        '[CH2]C(F)(F)C([O])(F)C=O(3709)',
    ],
    reactants = [
