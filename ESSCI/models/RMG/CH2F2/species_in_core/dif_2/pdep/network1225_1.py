...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.55199,'amu*angstrom^2'), symmetry=1, barrier=(58.6752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0685902,'amu*angstrom^2'), symmetry=1, barrier=(58.5571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0467,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08835,0.0555322,-0.000119922,1.22898e-07,-4.47104e-11,42585,26.1614], Tmin=(100,'K'), Tmax=(909.485,'K')), NASAPolynomial(coeffs=[1.49158,0.0239651,-1.14666e-05,2.06221e-09,-1.32477e-13,44107.6,36.7581], Tmin=(909.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    molecularWeight = (70.0467,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74497,0.0358288,-7.39729e-05,7.57792e-08,-2.77994e-11,62812.7,11.5617], Tmin=(100,'K'), Tmax=(900.268,'K')), NASAPolynomial(coeffs=[2.38466,0.0168146,-7.94396e-06,1.44796e-09,-9.46276e-14,63713,17.902], Tmin=(900.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-C2dc) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#C[O+]=[C-]O(3269)'],
    products = ['CO(12)', 'CH2CO(75)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(7.04587,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C#C[O+]=[C-]O(3269)'],
    products = ['C#C[OH+][C-]=O(3564)'],
    transitionState = 'TS2',
