...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)[CH]F(234)'],
    products = ['O=O(176)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(35.6842,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 35.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(467)'],
    products = ['[O]OC(F)(F)[CH]F(234)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(147)', 'CHF(40)'],
    products = ['[O]OC(F)(F)[CH]F(234)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[C](F)F(147)', 'CHF(88)'],
    products = ['[O]OC(F)(F)[CH]F(234)'],
    transitionState = 'TS9',
...
network(
    ...
    reactants = [
        ...
        ('[O]O[C](F)F(147)', 'CHF(40)'),
        ('O(6)', 'FC1OC1(F)F(286)'),
        ('O2(2)', 'CHFCF2(54)'),
        ('[O]O[C](F)F(147)', 'CHF(88)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
