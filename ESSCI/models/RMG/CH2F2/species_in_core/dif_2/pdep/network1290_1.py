...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32808,0.0397062,-4.20921e-05,2.69837e-08,-7.47767e-12,-19592,17.1756], Tmin=(100,'K'), Tmax=(852.601,'K')), NASAPolynomial(coeffs=[6.20697,0.0215087,-1.00774e-05,1.95132e-09,-1.37802e-13,-20253.5,-0.91931], Tmin=(852.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + group(CdCFH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (85.0563,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53233,0.0302514,-2.15016e-05,6.93293e-09,-8.7834e-13,15321,18.9518], Tmin=(100,'K'), Tmax=(1824.87,'K')), NASAPolynomial(coeffs=[11.4614,0.0106797,-5.41439e-06,1.05602e-09,-7.32388e-14,12062,-29.497], Tmin=(1824.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(CtCF) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC=C[C]F(3888)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,D}
...
"""),
    E0 = (203.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,1217.3],'cm^-1')),
        HinderedRotor(inertia=(0.0569647,'amu*angstrom^2'), symmetry=1, barrier=(14.8595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.646608,'amu*angstrom^2'), symmetry=1, barrier=(14.8668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6481,0.0337475,-2.18929e-05,6.00918e-09,-6.35666e-13,24462.9,18.323], Tmin=(100,'K'), Tmax=(2125.59,'K')), NASAPolynomial(coeffs=[13.5738,0.0131872,-7.38386e-06,1.45863e-09,-1.0046e-13,19818.2,-42.626], Tmin=(2125.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=[C]C=C[CH]F(3891)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {6,D}
3 C u0 p0 c0 {4,D} {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76411,0.0546402,-7.90984e-05,6.56525e-08,-2.27782e-11,-42.93,18.9201], Tmin=(100,'K'), Tmax=(696.376,'K')), NASAPolynomial(coeffs=[7.0765,0.0241296,-1.33865e-05,2.75199e-09,-1.99645e-13,-782.908,-4.78738], Tmin=(696.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.983984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(C=CCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', 'C=C[C]F(1494)'],
    products = ['O=[C]CC=[C]F(3331)'],
    transitionState = 'TS3',
