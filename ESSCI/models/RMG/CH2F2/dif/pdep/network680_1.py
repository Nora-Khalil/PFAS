...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20746,'amu*angstrom^2'), symmetry=1, barrier=(27.762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20503,'amu*angstrom^2'), symmetry=1, barrier=(27.706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20573,'amu*angstrom^2'), symmetry=1, barrier=(27.722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.0312,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66095,0.0377221,-5.88432e-06,-3.59704e-08,2.1042e-11,-24554.9,17.2272], Tmin=(100,'K'), Tmax=(921.702,'K')), NASAPolynomial(coeffs=[19.5165,-0.00395341,3.65478e-06,-7.12666e-10,4.4151e-14,-29367.6,-75.7123], Tmin=(921.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(Cs-OsOsHH)"""),
)
...
"""),
    E0 = (-106.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,297.992],'cm^-1')),
        HinderedRotor(inertia=(0.191042,'amu*angstrom^2'), symmetry=1, barrier=(11.9579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191088,'amu*angstrom^2'), symmetry=1, barrier=(11.9524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44714,0.0340634,-4.14969e-05,2.61186e-08,-6.4611e-12,-12765,14.0867], Tmin=(100,'K'), Tmax=(992.626,'K')), NASAPolynomial(coeffs=[8.67811,0.00895442,-3.55371e-06,6.35249e-10,-4.29521e-14,-14002,-15.928], Tmin=(992.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""HOOCH2O""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.981346,'amu*angstrom^2'), symmetry=1, barrier=(22.5631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981223,'amu*angstrom^2'), symmetry=1, barrier=(22.5603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0232,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94768,0.0338537,-9.58023e-06,-2.80494e-08,1.79217e-11,-6285.4,16.9576], Tmin=(100,'K'), Tmax=(904.525,'K')), NASAPolynomial(coeffs=[17.7286,-0.00526783,4.44342e-06,-9.0507e-10,6.02383e-14,-10394.7,-64.527], Tmin=(904.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.9624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(Cs-OsOsHH) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.748872,'amu*angstrom^2'), symmetry=1, barrier=(17.218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
