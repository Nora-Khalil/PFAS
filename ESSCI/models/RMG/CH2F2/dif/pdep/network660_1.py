...
"""),
    E0 = (-784.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,402.43,402.806,403.097],'cm^-1')),
        HinderedRotor(inertia=(0.181093,'amu*angstrom^2'), symmetry=1, barrier=(20.8305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179861,'amu*angstrom^2'), symmetry=1, barrier=(20.8317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181513,'amu*angstrom^2'), symmetry=1, barrier=(20.8225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78109,0.0311172,2.22187e-05,-6.75929e-08,3.26364e-11,-94272.8,20.2584], Tmin=(100,'K'), Tmax=(924.092,'K')), NASAPolynomial(coeffs=[20.34,-0.00341448,3.92494e-06,-7.59675e-10,4.53016e-14,-99658.5,-78.3937], Tmin=(924.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-784.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(COFOO)"""),
)
...
"""),
    E0 = (-373.535,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,451,553,637,1069,1180,1265,1301,3056,3025,407.5,1350,352.5,180.02,497.433,497.734],'cm^-1')),
        HinderedRotor(inertia=(0.0858709,'amu*angstrom^2'), symmetry=1, barrier=(1.97438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0651837,'amu*angstrom^2'), symmetry=1, barrier=(11.5696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502901,'amu*angstrom^2'), symmetry=1, barrier=(11.5627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54871,0.0547493,-7.16599e-05,4.71445e-08,-1.21154e-11,-44838.3,21.7924], Tmin=(100,'K'), Tmax=(957.641,'K')), NASAPolynomial(coeffs=[11.6803,0.0124305,-5.37442e-06,9.99832e-10,-6.90543e-14,-46778.8,-26.6484], Tmin=(957.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFHOO) + group(Cs-OsOsHH) + radical(O2sj(Cs-F1sO2sH)) + radical(OCJO)"""),
)

species(
    label = 'O[CH]O[C](O)F(1757)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    E0 = (-424.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3025,407.5,1350,352.5,482,586,761,1411,180,588.5,588.504],'cm^-1')),
        HinderedRotor(inertia=(0.134857,'amu*angstrom^2'), symmetry=1, barrier=(3.10064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992959,'amu*angstrom^2'), symmetry=1, barrier=(22.8301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595303,'amu*angstrom^2'), symmetry=1, barrier=(13.6872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0557216,'amu*angstrom^2'), symmetry=1, barrier=(13.6875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25515,0.0595048,-7.9174e-05,5.06818e-08,-1.24545e-11,-50924.1,23.1794], Tmin=(100,'K'), Tmax=(1008.16,'K')), NASAPolynomial(coeffs=[14.0761,0.00863588,-3.48764e-06,6.32258e-10,-4.33298e-14,-53509.1,-38.7782], Tmin=(1008.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCJO) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[O]COC([O])F(1758)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-335.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,451,553,637,1069,1180,1265,1301,3056,180,542.271,1354.34,1357.96],'cm^-1')),
        HinderedRotor(inertia=(1.01038,'amu*angstrom^2'), symmetry=1, barrier=(23.2307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00981,'amu*angstrom^2'), symmetry=1, barrier=(23.2176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97601,0.0375871,-2.23529e-05,7.57678e-10,2.42765e-12,-40224.2,20.9437], Tmin=(100,'K'), Tmax=(1086.63,'K')), NASAPolynomial(coeffs=[11.9858,0.0131727,-5.81293e-06,1.13926e-09,-8.25581e-14,-43133.5,-31.5566], Tmin=(1086.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCOJ) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[O]CO[C](O)F(1759)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-385.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,482,586,761,1411,434.784,434.787,434.805,434.813],'cm^-1')),
        HinderedRotor(inertia=(0.00089171,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213274,'amu*angstrom^2'), symmetry=1, barrier=(28.6118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213276,'amu*angstrom^2'), symmetry=1, barrier=(28.6117,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74848,0.041564,-2.71684e-05,8.79854e-10,3.48981e-12,-46312.7,22.0941], Tmin=(100,'K'), Tmax=(1033.64,'K')), NASAPolynomial(coeffs=[13.9302,0.0101341,-4.35774e-06,8.72896e-10,-6.5184e-14,-49670.3,-41.1387], Tmin=(1033.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCOJ) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    E0 = (-365.578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1855,455,950,309.203,309.642],'cm^-1')),
        HinderedRotor(inertia=(0.396714,'amu*angstrom^2'), symmetry=1, barrier=(27.0425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396669,'amu*angstrom^2'), symmetry=1, barrier=(27.036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.397145,'amu*angstrom^2'), symmetry=1, barrier=(27.0378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14932,0.0247013,2.63243e-05,-6.70068e-08,3.18023e-11,-43887.4,16.8769], Tmin=(100,'K'), Tmax=(915.167,'K')), NASAPolynomial(coeffs=[18.255,-0.00375995,4.24334e-06,-8.54044e-10,5.3908e-14,-48591.2,-68.9897], Tmin=(915.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-365.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.837474,'amu*angstrom^2'), symmetry=1, barrier=(38.3801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-557.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,458.819,460.057,460.253,460.793],'cm^-1')),
        HinderedRotor(inertia=(0.000798249,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281451,'amu*angstrom^2'), symmetry=1, barrier=(41.9677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30842,0.0285093,-2.56582e-06,-1.8764e-08,9.13565e-12,-66951,18.8436], Tmin=(100,'K'), Tmax=(1032.3,'K')), NASAPolynomial(coeffs=[11.9276,0.01069,-4.94063e-06,1.02499e-09,-7.7828e-14,-69973.5,-32.8898], Tmin=(1032.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(COFOO) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(136)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(1587)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', '[CH2]OC(=O)F(1579)'],
    products = ['O=C(F)OCO(1587)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(562)'],
    products = ['O=C(F)OCO(1587)'],
