...
reaction(
    ...
    products = ['[O]OC(F)(F)[C](F)F(356)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(21668.1,'m^3/(mol*s)'), n=0.762578, Ea=(39.3704,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)(F)[C](F)F(356)'],
    products = ['O=O(176)', 'CF2CF2(60)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(66.4662,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['[O]OC(F)(F)[C](F)F(356)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)(F)[C](F)F(356)'],
    products = ['O(6)', 'FC1(F)OC1(F)F(855)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)=C(F)F(408)'],
    products = ['[O]OC(F)(F)[C](F)F(356)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'F[C](F)[C](F)F(315)'],
    products = ['[O]OC(F)(F)[C](F)F(356)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(89)', '[O]O[C](F)F(147)'],
    products = ['[O]OC(F)(F)[C](F)F(356)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'FC1(F)OO1(932)'],
    products = ['FC1(F)OOC1(F)F(252)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(2.81816e-07,'m^3/(mol*s)'), n=3.45227, Ea=(214.877,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.36636e-32,'m^3/(mol*s)'), n=10.9581, Ea=(401.14,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCSCdCdd->Cd',), comment="""Estimated from node Root_N-1COCSCdCdd->Cd
Ea raised from 396.7 to 401.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C](F)OO[C](F)F(336)'],
    products = ['FC1(F)OOC1(F)F(252)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C]1OOC1(F)F(357)'],
    products = ['FC1(F)OOC1(F)F(252)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F2(108)', 'FC1=C(F)OO1(358)'],
    products = ['FC1(F)OOC1(F)F(252)'],
...
network(
    ...
    reactants = [
        ('O2(2)', 'CF2CF2(60)'),
        ('O=O(176)', 'CF2CF2(60)'),
        ('CF2(42)', '[O]O[C](F)F(147)'),
        ('CF2(89)', '[O]O[C](F)F(147)'),
        ('CF2(89)', 'FC1(F)OO1(932)'),
        ('CF2O(48)', 'CF2O(48)'),
    ],
    bathGas = {
        'N2': 0.5,
