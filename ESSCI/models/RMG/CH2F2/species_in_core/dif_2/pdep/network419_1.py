...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC([O])(F)F(1001)'],
    products = ['O2(2)', 'FC1(F)OO1(924)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(203)'],
    products = ['[O]OOC([O])(F)F(1001)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](157)', '[O][C](F)F(176)'],
    products = ['[O]OOC([O])(F)F(1001)'],
    transitionState = 'TS9',
