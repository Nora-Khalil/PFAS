...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.615262,'amu*angstrom^2'), symmetry=1, barrier=(14.1461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616751,'amu*angstrom^2'), symmetry=1, barrier=(14.1803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90651,0.0501265,-8.99341e-05,7.56595e-08,-2.39216e-11,16428.3,16.8944], Tmin=(100,'K'), Tmax=(902.267,'K')), NASAPolynomial(coeffs=[9.54348,0.00719182,-3.46423e-06,6.17655e-10,-3.92362e-14,15419.7,-17.1164], Tmin=(902.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(OCJO)"""),
)
...
"""),
    E0 = (172.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3025,407.5,1350,352.5,180,978.569,1979.74],'cm^-1')),
        HinderedRotor(inertia=(0.0171298,'amu*angstrom^2'), symmetry=1, barrier=(47.6329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07391,'amu*angstrom^2'), symmetry=1, barrier=(47.6833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33854,0.0479112,-0.000104959,1.12381e-07,-4.35702e-11,20757.8,16.2672], Tmin=(100,'K'), Tmax=(852.206,'K')), NASAPolynomial(coeffs=[1.5747,0.0237498,-1.35937e-05,2.70185e-09,-1.87526e-13,21895.5,25.7416], Tmin=(852.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])F(131)'],
    products = ['[O]OC([O])F(211)'],
    transitionState = 'TS2',
