...
species(
    label = 'OC(F)(F)O[CH]C(F)(F)F(1787)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F(1777)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'OC(F)(F)O[CH]F(1237)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)(F)OC=C(F)F(1778)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(O)(F)F(323)', 'CHFCF2(54)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=C(F)F(1779)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(F)(F)O[CH][C](F)F(1780)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)OC(F)[C](F)F(1781)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(323)', 'F[CH][C](F)F(183)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'F[C](F)OC(F)[C](F)F(356)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)[C](F)F(1782)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)[C](F)F(1783)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)OC(F)[C](F)F(1314)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F-2(1784)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(87)', 'OC(F)(F)O[CH]F(1237)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    products = ['OC(F)(F)O[C](F)C(F)F(1785)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)OC(F)C(F)F(1786)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1672)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    products = ['OC(F)(F)O[CH]C(F)(F)F(1787)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1672)'],
    products = ['O[C](F)OC(F)C(F)(F)F(1788)'],
