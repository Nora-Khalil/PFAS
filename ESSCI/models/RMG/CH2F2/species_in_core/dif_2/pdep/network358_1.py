...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(1475)'],
    products = ['F[C](F)CC(F)F(815)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(908)'],
    products = ['F[C](F)CC(F)F(815)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2][C](F)F(185)'],
    products = ['F[C](F)CC(F)F(815)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(1476)'],
    products = ['F[C](F)CC(F)F(815)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(736)'],
    products = ['F[C](F)CC(F)F(815)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(1477)'],
    products = ['F[C](F)CC(F)F(815)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]CC(F)F(1252)'],
    products = ['F[C](F)CC(F)F(815)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(815)'],
    products = ['F[CH]CC(F)(F)F(1479)'],
