...
reaction(
    label = 'reaction2',
    reactants = ['H2(7)', 'F[C]C(F)(F)F(240)'],
    products = ['FCC(F)(F)F(315)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]C(F)(F)F(1097)'],
    products = ['FCC(F)(F)F(315)'],
    transitionState = 'TS6',
