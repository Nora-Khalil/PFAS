...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.49992,'amu*angstrom^2'), symmetry=1, barrier=(11.4942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798729,'amu*angstrom^2'), symmetry=1, barrier=(18.3644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.190548,'amu*angstrom^2'), symmetry=1, barrier=(4.38108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190995,'amu*angstrom^2'), symmetry=1, barrier=(4.39136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.877627,'amu*angstrom^2'), symmetry=1, barrier=(20.1784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7926,0.0520776,-6.36782e-05,4.4347e-08,-1.27968e-11,3902.11,20.4158], Tmin=(100,'K'), Tmax=(835.371,'K')), NASAPolynomial(coeffs=[7.95457,0.0225736,-1.07032e-05,2.07233e-09,-1.45968e-13,2872.56,-8.20405], Tmin=(835.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.8091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-158.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,245.133,245.175,1166.59],'cm^-1')),
        HinderedRotor(inertia=(0.152745,'amu*angstrom^2'), symmetry=1, barrier=(6.51387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152734,'amu*angstrom^2'), symmetry=1, barrier=(6.51355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.770781,'amu*angstrom^2'), symmetry=1, barrier=(32.869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-474.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,251.749,251.763,251.794],'cm^-1')),
        HinderedRotor(inertia=(0.157929,'amu*angstrom^2'), symmetry=1, barrier=(7.10176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157866,'amu*angstrom^2'), symmetry=1, barrier=(7.10204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
"""),
    E0 = (-376.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,180,180,1712.2],'cm^-1')),
        HinderedRotor(inertia=(0.248408,'amu*angstrom^2'), symmetry=1, barrier=(5.71138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.881041,'amu*angstrom^2'), symmetry=1, barrier=(20.2569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251091,'amu*angstrom^2'), symmetry=1, barrier=(5.77307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['OF(173)', 'C=CC(F)F(1783)'],
    products = ['FOCCC(F)F(1609)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(228)', '[CH2]CC(F)F(1806)'],
    products = ['FOCCC(F)F(1609)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(1527)', 'CHF2-CH2(63)'],
    products = ['FOCCC(F)F(1609)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', '[CH2]COF(1807)'],
    products = ['FOCCC(F)F(1609)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(1784)'],
    products = ['FOCCC(F)F(1609)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(1455)'],
    products = ['FOCCC(F)F(1609)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CCC(F)F(1461)'],
    products = ['FOCCC(F)F(1609)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOCCC(F)F(1609)'],
    products = ['F2(77)', 'CH2O(19)', 'CH2CHF(55)'],
