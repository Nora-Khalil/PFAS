...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.97084e+10,'s^-1'), n=0.978818, Ea=(239.16,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'OC(F)(F)C(F)F(435)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(341.56,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'OC(F)(F)[C]F(576)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(206.226,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(254)', 'F[C]C(F)F(182)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(155)', 'F[C]C(F)(F)C(F)F(1017)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(88)', 'OC(F)(F)C(F)(F)F(1019)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(155.151,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(164)', 'CF2CF2(60)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'F[C](F)C(F)(F)C(F)F(479)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)C(F)F(466)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(220)', 'CHF2-CF2(68)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', 'OC(F)(F)[C](F)F(586)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)C(F)F(762)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(108)', 'OC(F)=C(F)C(F)F(1025)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(108)', 'OC(F)(F)C(F)=CF(1026)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=C(F)F(382)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(884)'],
...
network(
    label = 'PDepNetwork #374',
    isomers = [
        'OC(F)(F)C(F)(F)C(F)F(884)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CHFCF2(54)'),
        ('O[C](F)F(220)', 'CHF2-CF2(68)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
