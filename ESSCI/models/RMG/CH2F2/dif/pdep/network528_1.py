...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.399095,'amu*angstrom^2'), symmetry=1, barrier=(9.17598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1803,0.046995,-8.34549e-05,8.093e-08,-2.98349e-11,-8058.44,16.6042], Tmin=(100,'K'), Tmax=(844.402,'K')), NASAPolynomial(coeffs=[4.37102,0.0213354,-1.0726e-05,2.07666e-09,-1.43377e-13,-7883.6,9.63184], Tmin=(844.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.878796,'amu*angstrom^2'), symmetry=1, barrier=(20.2052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3785,0.0666998,-0.000121833,1.15366e-07,-4.1588e-11,-14718.2,19.8391], Tmin=(100,'K'), Tmax=(841.63,'K')), NASAPolynomial(coeffs=[6.30705,0.0244435,-1.29578e-05,2.53768e-09,-1.75794e-13,-14880.8,0.874011], Tmin=(841.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'CO[O](1395)'],
    products = ['CC(F)(F)O[O](1300)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(192.561,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(124)', 'C[C]F(1325)'],
    products = ['CC(F)(F)O[O](1300)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(168)', 'CH2(S)(24)'],
    products = ['CC(F)(F)O[O](1300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(171)', 'CH3(18)'],
    products = ['CC(F)(F)O[O](1300)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](911)'],
    products = ['CC(F)(F)O[O](1300)'],
    transitionState = 'TS9',
