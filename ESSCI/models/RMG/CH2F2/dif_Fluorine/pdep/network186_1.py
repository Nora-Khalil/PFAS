...
"""),
    E0 = (-315.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3615,1277.5,1000,3025,407.5,1350,352.5,336.538,336.539,336.539,336.539,336.539,1250.8],'cm^-1')),
        HinderedRotor(inertia=(0.619113,'amu*angstrom^2'), symmetry=1, barrier=(49.7587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0716704,'amu*angstrom^2'), symmetry=1, barrier=(49.7587,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)OF(505)'],
    products = ['O=C(OF)C(O)F(571)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)OF(338)'],
    products = ['O=C(OF)C(O)F(571)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(172)', 'O=C=C(O)F(339)'],
    products = ['O=C(OF)C(O)F(571)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C([CH]O)OF(594)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)C(O)F(595)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'O=C([CH]F)OF(596)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(=O)OF(597)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(248)', 'O=[C]C(O)F(598)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(150)', 'O[CH]F(180)'],
    products = ['O=C(OF)C(O)F(571)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)[C](O)F(345)'],
    products = ['O=C(OF)C(O)F(571)'],
