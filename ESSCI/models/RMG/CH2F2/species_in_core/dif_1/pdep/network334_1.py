...
reaction(
    label = 'reaction1',
    reactants = ['CF2(89)', 'CF2O(48)'],
    products = ['FC1(F)OC1(F)F(855)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(516)'],
    products = ['FC1(F)OC1(F)F(855)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(108)', 'FC1=C(F)O1(518)'],
    products = ['FC1(F)OC1(F)F(855)'],
    transitionState = 'TS6',
