...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(207)', '[O]C([O])=O(208)'],
    products = ['[O]C(=O)O[C]=O(200)'],
    transitionState = 'TS2',
