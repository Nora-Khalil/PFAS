...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05617,0.0721197,-0.00010929,1.00014e-07,-3.74423e-11,-69818.9,29.1487], Tmin=(100,'K'), Tmax=(759.916,'K')), NASAPolynomial(coeffs=[6.12729,0.0357845,-1.85351e-05,3.6987e-09,-2.62939e-13,-70311.2,7.90758], Tmin=(759.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]CC(F)F(1157)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(1104)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1103)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C[C](F)F(1153)'],
    products = ['F[C](F)CC[C](F)F(1104)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[C](F)CC[C](F)F(1104)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(14.7198,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(1070)'],
    products = ['F[C](F)CC[C](F)F(1104)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(89)', '[CH2]C[C](F)F(1153)'],
    products = ['F[C](F)CC[C](F)F(1104)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)CC[C](F)F(1104)'],
    products = ['F[C](F)C[CH]C(F)F(1156)'],
