...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.892551,'amu*angstrom^2'), symmetry=1, barrier=(20.5215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892059,'amu*angstrom^2'), symmetry=1, barrier=(20.5102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.48893,'amu*angstrom^2'), symmetry=1, barrier=(34.2334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47907,'amu*angstrom^2'), symmetry=1, barrier=(34.0068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16044,0.0509472,-3.36773e-05,-2.75579e-09,6.65636e-12,-100984,20.691], Tmin=(100,'K'), Tmax=(1012.81,'K')), NASAPolynomial(coeffs=[18.8216,0.00560392,-2.67179e-06,6.30125e-10,-5.2916e-14,-105814,-70.919], Tmin=(1012.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-840.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)C(F)(F)OF(441)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(16.9533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)OF(505)'],
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(215.293,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOF(340)', 'OC(F)[C]F(511)'],
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(373)'],
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(132.088,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['OC(F)C(F)(F)OF(441)'],
    products = ['OC(OF)C(F)(F)F(512)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(172)', 'OC(F)=C(F)F(377)'],
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(340)', 'OC=C(F)F(514)'],
    products = ['OC(F)C(F)(F)OF(441)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(172)', 'FC=C(F)OF(515)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[C](F)OF(516)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(517)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(518)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(248)', 'OC(F)[C](F)F(519)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'F[CH]C(F)(F)OF(520)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(521)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(238)', 'O[CH]F(180)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(378)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(F)C(O)F(494)'],
    products = ['OC(F)C(F)(F)OF(441)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(522)'],
    products = ['OC(F)C(F)(F)OF(441)'],
