...
"""),
    E0 = (-243.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,180,180,458.984,1190.61,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0159868,'amu*angstrom^2'), symmetry=1, barrier=(16.0838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6323,'amu*angstrom^2'), symmetry=1, barrier=(37.5297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.699526,'amu*angstrom^2'), symmetry=1, barrier=(16.0835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-503.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,588.2,588.296,588.378,588.4,588.421,589.068,800.385,1507.87,1507.92,1507.95,1508.05],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-39.3724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,180.03,180.035,180.496,2059.92,2060.42],'cm^-1')),
        HinderedRotor(inertia=(0.00597821,'amu*angstrom^2'), symmetry=1, barrier=(1.72108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.040054,'amu*angstrom^2'), symmetry=1, barrier=(11.6314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44876,0.0359989,-3.86685e-05,2.30444e-08,-5.6987e-12,-4681.12,21.1195], Tmin=(100,'K'), Tmax=(965.685,'K')), NASAPolynomial(coeffs=[7.31722,0.0158329,-7.34431e-06,1.41936e-09,-1.00283e-13,-5621.39,-2.19793], Tmin=(965.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.3724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (129.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,1006.22,2592.73],'cm^-1')),
        HinderedRotor(inertia=(0.577739,'amu*angstrom^2'), symmetry=1, barrier=(13.2834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0186911,'amu*angstrom^2'), symmetry=1, barrier=(13.3531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0473409,'amu*angstrom^2'), symmetry=1, barrier=(33.4934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45158,'amu*angstrom^2'), symmetry=1, barrier=(33.3746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30084,0.0628073,-8.61927e-05,5.90628e-08,-1.59655e-11,15611.7,26.7443], Tmin=(100,'K'), Tmax=(905.833,'K')), NASAPolynomial(coeffs=[11.9702,0.0156928,-8.17365e-06,1.64267e-09,-1.18093e-13,13678.8,-23.6741], Tmin=(905.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + group(Cs-CsHHH) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)

species(
    label = '[O]OO[C](F)CF(1996)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-202.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,308.794,308.803,308.857,308.869,309.098,2424.67],'cm^-1')),
        HinderedRotor(inertia=(0.00176883,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264385,'amu*angstrom^2'), symmetry=1, barrier=(17.8548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524272,'amu*angstrom^2'), symmetry=1, barrier=(35.4567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51246,0.0577285,-7.81589e-05,5.45269e-08,-1.51009e-11,-24256.4,24.6724], Tmin=(100,'K'), Tmax=(883.444,'K')), NASAPolynomial(coeffs=[10.6441,0.0163828,-7.95754e-06,1.55109e-09,-1.09532e-13,-25869.9,-18.2506], Tmin=(883.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OO[O](1890)'],
    products = ['O2(2)', 'FC1(F)CO1(1188)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](317)'],
    products = ['[CH2]C(F)(F)OO[O](1890)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(202)', 'CH2(T)(66)'],
    products = ['[CH2]C(F)(F)OO[O](1890)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OO[O](1994)'],
    products = ['[CH2]C(F)(F)OO[O](1890)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', '[CH2]C([O])(F)F(732)'],
    products = ['[CH2]C(F)(F)OO[O](1890)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](157)', '[CH2][C](F)F(185)'],
    products = ['[CH2]C(F)(F)OO[O](1890)'],
    transitionState = 'TS9',
