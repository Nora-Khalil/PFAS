...
reaction(
    ...
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC([C]F)C(F)(F)OF(1745)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CF2(42)', 'O[CH]C(F)(F)OF(1218)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'FOC(F)(F)C=C(F)F(1168)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FO[C](F)F(192)', 'OC=C(F)F(1217)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(=C(F)F)C(F)(F)OF(1746)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OC([C](F)F)[C](F)OF(1747)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)C(O)[C](F)F(1748)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'FOC(F)(F)[CH][C](F)F(468)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', 'OC([C](F)F)[C](F)F(1749)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(192)', 'O[CH][C](F)F(1445)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O[C]([C](F)F)C(F)(F)OF(1750)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(106)', 'O=C(F)C(O)[C](F)F(1751)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'OC([C](F)F)=C(F)OF(1752)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'OC([C]F)C(F)(F)OF-2(1753)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(87)', 'O[CH]C(F)(F)OF(1218)'],
    products = ['OC([C](F)F)C(F)(F)OF(1670)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OC([C](F)F)C(F)(F)OF(1670)'],
    products = ['[O]C(F)(F)C(O)C(F)(F)F(1754)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC([C](F)F)C(F)(F)OF(1670)'],
    products = ['OC([C](F)OF)C(F)(F)F(1755)'],
