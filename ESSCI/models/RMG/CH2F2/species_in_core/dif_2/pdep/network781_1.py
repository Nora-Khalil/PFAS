...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.488538,'amu*angstrom^2'), symmetry=1, barrier=(11.2325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488204,'amu*angstrom^2'), symmetry=1, barrier=(11.2248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970386,'amu*angstrom^2'), symmetry=1, barrier=(22.3111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.32109,'amu*angstrom^2'), symmetry=1, barrier=(7.38249,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88071,0.0254385,-2.53338e-05,1.4826e-08,-3.65566e-12,-9452.08,14.087], Tmin=(100,'K'), Tmax=(964.949,'K')), NASAPolynomial(coeffs=[5.99226,0.0125404,-5.28411e-06,9.74209e-10,-6.69774e-14,-10052.6,-0.813474], Tmin=(964.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.9184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.639874,'amu*angstrom^2'), symmetry=1, barrier=(14.712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276358,'amu*angstrom^2'), symmetry=1, barrier=(6.35401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276371,'amu*angstrom^2'), symmetry=1, barrier=(6.35431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38856,0.0642782,-0.000111161,9.94501e-08,-3.42457e-11,-37563.2,21.038], Tmin=(100,'K'), Tmax=(847.401,'K')), NASAPolynomial(coeffs=[7.92832,0.0203701,-1.0359e-05,1.99014e-09,-1.36386e-13,-38203.5,-6.66753], Tmin=(847.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)CO(1986)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.30963,'amu*angstrom^2'), symmetry=1, barrier=(30.1111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31013,'amu*angstrom^2'), symmetry=1, barrier=(30.1225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50458,0.0459928,-3.26841e-05,3.08681e-09,3.33014e-12,-75047.6,18.2146], Tmin=(100,'K'), Tmax=(1034.43,'K')), NASAPolynomial(coeffs=[15.6901,0.00860651,-3.80024e-06,7.95812e-10,-6.13645e-14,-78916.9,-55.2198], Tmin=(1034.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.173691,'amu*angstrom^2'), symmetry=1, barrier=(3.99349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173679,'amu*angstrom^2'), symmetry=1, barrier=(3.99321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(716)', 'OC[C]F-2(1879)'],
    products = ['OCC(F)(F)OF(1911)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(153)', 'C=C(F)OF(1984)'],
    products = ['OCC(F)(F)OF(1911)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(153)', 'OC=C(F)F(1217)'],
    products = ['OCC(F)(F)OF(1911)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(1986)'],
    products = ['OCC(F)(F)OF(1911)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', '[CH2]C(F)(F)OF(1257)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(F)(F)OF(1687)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'OC[C](F)F(1002)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(192)', 'CH2OH(81)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(1218)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(106)', 'O=C(F)CO(1987)'],
    products = ['OCC(F)(F)OF(1911)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'OC=C(F)OF(1223)'],
    products = ['OCC(F)(F)OF(1911)'],
