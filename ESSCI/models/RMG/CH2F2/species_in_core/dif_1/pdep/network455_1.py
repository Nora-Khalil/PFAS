...
"""),
    E0 = (-1039.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,387.608,387.632,387.658,387.663,512.665,3957.41],'cm^-1')),
        HinderedRotor(inertia=(0.381071,'amu*angstrom^2'), symmetry=1, barrier=(40.6315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381102,'amu*angstrom^2'), symmetry=1, barrier=(40.6316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38103,'amu*angstrom^2'), symmetry=1, barrier=(40.6315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43453,0.0603449,-6.32694e-05,3.51633e-08,-8.09642e-12,-124903,22.2959], Tmin=(100,'K'), Tmax=(1029.27,'K')), NASAPolynomial(coeffs=[10.3108,0.0258493,-1.29971e-05,2.60127e-09,-1.87361e-13,-126731,-20.783], Tmin=(1029.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1039.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.102032,'amu*angstrom^2'), symmetry=1, barrier=(18.5922,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0404,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647376,0.0362925,-3.11432e-05,1.44646e-08,-3.0121e-12,-81526.6,23.2953], Tmin=(298,'K'), Tmax=(1100,'K')), NASAPolynomial(coeffs=[9.27265,0.0120402,-4.8606e-06,8.86567e-10,-5.96506e-14,-83983.5,-21.388], Tmin=(1100,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-680.064,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(178.761,'J/mol/K'), label="""CH2F-CHF2""", comment="""Thermo library: Fluorine"""),
)
...
"""),
    E0 = (-548.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,212,931,1104,1251,1325,1474,3102,3155,323,467,575,827,1418,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.194576,'amu*angstrom^2'), symmetry=1, barrier=(4.47369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194543,'amu*angstrom^2'), symmetry=1, barrier=(4.47292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.936813,'amu*angstrom^2'), symmetry=1, barrier=(21.5392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506186,0.0857947,-0.000147785,1.32333e-07,-4.58676e-11,-65898,24.5143], Tmin=(100,'K'), Tmax=(834.486,'K')), NASAPolynomial(coeffs=[9.34353,0.0274818,-1.42928e-05,2.77903e-09,-1.92126e-13,-66817.5,-13.1938], Tmin=(834.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-548.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'OC(OCF)=C(F)F(1303)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-876.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,182,240,577,636,1210,1413,280.218,280.219,280.219],'cm^-1')),
        HinderedRotor(inertia=(0.326747,'amu*angstrom^2'), symmetry=1, barrier=(18.2068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326747,'amu*angstrom^2'), symmetry=1, barrier=(18.2068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326746,'amu*angstrom^2'), symmetry=1, barrier=(18.2068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694449,0.0745053,-9.49495e-05,6.00799e-08,-1.49168e-11,-105341,22.6569], Tmin=(100,'K'), Tmax=(986.856,'K')), NASAPolynomial(coeffs=[14.7288,0.0176196,-8.48371e-06,1.66763e-09,-1.19074e-13,-108111,-44.8648], Tmin=(986.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-876.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)(F)CF(1304)',
...
"""),
    E0 = (-642.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,1380,1390,370,380,2900,435,180,180,180,1498.33],'cm^-1')),
        HinderedRotor(inertia=(0.141504,'amu*angstrom^2'), symmetry=1, barrier=(3.25346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141308,'amu*angstrom^2'), symmetry=1, barrier=(3.24894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906632,0.0817352,-0.000153377,1.54351e-07,-5.87131e-11,-77160.1,26.4091], Tmin=(100,'K'), Tmax=(832.389,'K')), NASAPolynomial(coeffs=[3.354,0.0392229,-2.13521e-05,4.22908e-09,-2.95372e-13,-76502.2,21.4502], Tmin=(832.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)C(F)(F)[CH]F(1305)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-668.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,334,575,1197,1424,3202,180,180,1969.38],'cm^-1')),
        HinderedRotor(inertia=(0.221923,'amu*angstrom^2'), symmetry=1, barrier=(5.10244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221785,'amu*angstrom^2'), symmetry=1, barrier=(5.09927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221485,'amu*angstrom^2'), symmetry=1, barrier=(5.09237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519474,0.0907336,-0.000174038,1.68894e-07,-6.1498e-11,-80329.4,28.7681], Tmin=(100,'K'), Tmax=(852.156,'K')), NASAPolynomial(coeffs=[5.92296,0.0338075,-1.82776e-05,3.57395e-09,-2.46352e-13,-80104.3,10.2878], Tmin=(852.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'O[C](O)C(F)(F)[CH]F(1306)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-689.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,215,315,519,588,595,1205,1248,360,370,350,334,575,1197,1424,3202,302.734,1941.06],'cm^-1')),
        HinderedRotor(inertia=(0.135139,'amu*angstrom^2'), symmetry=1, barrier=(8.82826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13517,'amu*angstrom^2'), symmetry=1, barrier=(8.83259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13572,'amu*angstrom^2'), symmetry=1, barrier=(8.83691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134627,'amu*angstrom^2'), symmetry=1, barrier=(8.82764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209827,0.0940091,-0.000171344,1.54699e-07,-5.3101e-11,-82775.4,29.0152], Tmin=(100,'K'), Tmax=(855.275,'K')), NASAPolynomial(coeffs=[10.4249,0.025067,-1.33072e-05,2.57584e-09,-1.76261e-13,-83748.6,-14.1437], Tmin=(855.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-672.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,234,347,1316,1464,435.763,435.881,435.886,435.908,436.033,1772.18],'cm^-1')),
        HinderedRotor(inertia=(0.23241,'amu*angstrom^2'), symmetry=1, barrier=(31.3387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.319482,'amu*angstrom^2'), symmetry=1, barrier=(43.0725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373384,'amu*angstrom^2'), symmetry=1, barrier=(50.3452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83866,0.0471033,-3.97137e-05,1.68486e-08,-2.92321e-12,-80808.6,20.7456], Tmin=(100,'K'), Tmax=(1343.23,'K')), NASAPolynomial(coeffs=[10.9317,0.0200252,-9.47522e-06,1.84075e-09,-1.29966e-13,-83251.4,-25.806], Tmin=(1343.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = '[CH2]C(F)(F)C(=O)O(1308)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-654.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,249,341,381,651,928,1217,1251,3000,3100,440,815,1455,1000,265.1,265.103,265.104,265.105,265.105],'cm^-1')),
        HinderedRotor(inertia=(0.815169,'amu*angstrom^2'), symmetry=1, barrier=(40.6535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.80656e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0197327,'amu*angstrom^2'), symmetry=1, barrier=(40.6535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56888,0.058672,-7.51897e-05,5.42161e-08,-1.62901e-11,-78600.4,21.6443], Tmin=(100,'K'), Tmax=(800.501,'K')), NASAPolynomial(coeffs=[8.17731,0.0256483,-1.33047e-05,2.67404e-09,-1.92207e-13,-79658.3,-8.76666], Tmin=(800.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    E0 = (-813.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,180,762.478,762.814,762.824],'cm^-1')),
        HinderedRotor(inertia=(0.00463243,'amu*angstrom^2'), symmetry=1, barrier=(1.91223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129702,'amu*angstrom^2'), symmetry=1, barrier=(53.52,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48301,0.0615409,-9.07903e-05,8.28408e-08,-3.15512e-11,-97761.8,22.2748], Tmin=(100,'K'), Tmax=(734.826,'K')), NASAPolynomial(coeffs=[5.59686,0.0323249,-1.72255e-05,3.46477e-09,-2.47624e-13,-98182.2,4.94875], Tmin=(734.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-451.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,288,410,724,839,1320,2950,3100,1380,975,1025,1650,318.141,319.106,1613.08,1613.54,1613.83],'cm^-1')),
        HinderedRotor(inertia=(0.114575,'amu*angstrom^2'), symmetry=1, barrier=(8.27748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115216,'amu*angstrom^2'), symmetry=1, barrier=(8.2829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5316,0.0354103,-3.27008e-05,1.82661e-08,-4.57498e-12,-54218.2,17.8792], Tmin=(100,'K'), Tmax=(915.697,'K')), NASAPolynomial(coeffs=[5.64596,0.021806,-1.04154e-05,2.04135e-09,-1.45358e-13,-54788.6,3.12854], Tmin=(915.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'O=C(O)C(F)=CF(1289)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(F)(F)CF(1192)'],
    products = ['HF(38)', 'CO2(13)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.30828e+07,'s^-1'), n=1.83354, Ea=(207.575,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.49335582114639515, var=20.078174816455903, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_7R!H->O',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_7R!H->O"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)(F)CF(319)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(232.628,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'O=C(O)[C]F(826)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(188.18,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C(O)C(F)(F)[C]F(1282)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(88)', 'O=C(O)C(F)F(222)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(19.8992,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(74)', 'O=C(O)C(F)(F)F(443)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(161.005,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CO2(13)', 'FCC(F)F(158)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(155)', 'O=C=C(F)CF(1200)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(OF)=C(F)CF(1302)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(118.364,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction11',
    reactants = ['OC(OCF)=C(F)F(1303)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(90.9437,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])C(F)(F)CF(1304)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(1305)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(1306)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(1307)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(1308)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(F)(F)CF(1208)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)CF(1207)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(91)', 'O=C(O)[C](F)F(833)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(191)', 'CH2F-CF2(67)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[CH]F(1288)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(108)', 'C=C(F)C(=O)O(1309)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=CF(1289)'],
    products = ['O=C(O)C(F)(F)CF(1192)'],
...
network(
    label = 'PDepNetwork #455',
    isomers = [
        'O=C(O)C(F)(F)CF(1192)',
    ],
    reactants = [
        ('HF(38)', 'CO2(13)', 'CH2CF2(56)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
