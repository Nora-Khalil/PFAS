...
"""),
    E0 = (-952.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,180,180,180,2177.48],'cm^-1')),
        HinderedRotor(inertia=(0.299752,'amu*angstrom^2'), symmetry=1, barrier=(6.89188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75869,'amu*angstrom^2'), symmetry=1, barrier=(40.4358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299898,'amu*angstrom^2'), symmetry=1, barrier=(6.89524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.364348,0.109465,-0.000199991,1.85653e-07,-6.59482e-11,-114446,30.356], Tmin=(100,'K'), Tmax=(835.263,'K')), NASAPolynomial(coeffs=[9.69169,0.0350707,-1.92747e-05,3.8077e-09,-2.64826e-13,-115211,-10.8697], Tmin=(835.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-952.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.52249,'amu*angstrom^2'), symmetry=1, barrier=(35.0051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52268,'amu*angstrom^2'), symmetry=1, barrier=(35.0094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52556,0.0589817,-9.49274e-05,7.55252e-08,-2.3606e-11,-48604.5,19.5038], Tmin=(100,'K'), Tmax=(787.159,'K')), NASAPolynomial(coeffs=[10.5434,0.0131539,-7.59295e-06,1.55453e-09,-1.11631e-13,-50024.1,-21.8434], Tmin=(787.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = '[O]CC(F)(OF)C(F)(F)F(1977)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.283339,0.104735,-0.000180676,1.61948e-07,-5.67163e-11,-116030,29.511], Tmin=(100,'K'), Tmax=(808.092,'K')), NASAPolynomial(coeffs=[11.0536,0.0328505,-1.79754e-05,3.57676e-09,-2.51132e-13,-117348,-19.582], Tmin=(808.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-965.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.326147,'amu*angstrom^2'), symmetry=1, barrier=(7.49876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326064,'amu*angstrom^2'), symmetry=1, barrier=(7.49685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24298,'amu*angstrom^2'), symmetry=1, barrier=(28.5786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1058.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,231,348,427,405,1245,1236,1280,223,363,546,575,694,1179,1410,2782.5,750,1395,475,1775,1000,227.898,227.932],'cm^-1')),
        HinderedRotor(inertia=(0.255438,'amu*angstrom^2'), symmetry=1, barrier=(9.42001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.869426,'amu*angstrom^2'), symmetry=1, barrier=(32.0205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255357,'amu*angstrom^2'), symmetry=1, barrier=(9.41963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.114011,0.092808,-0.000146314,1.18303e-07,-3.79819e-11,-127173,28.4349], Tmin=(100,'K'), Tmax=(764.354,'K')), NASAPolynomial(coeffs=[13.002,0.0253523,-1.39156e-05,2.80753e-09,-2.00265e-13,-129143,-30.2768], Tmin=(764.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1058.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-542.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,180,180,180,1093.04],'cm^-1')),
        HinderedRotor(inertia=(0.254123,'amu*angstrom^2'), symmetry=1, barrier=(5.8428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254162,'amu*angstrom^2'), symmetry=1, barrier=(5.8437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254163,'amu*angstrom^2'), symmetry=1, barrier=(5.84371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182505,0.0988825,-0.000189692,1.82993e-07,-6.64366e-11,-65100.6,30.2494], Tmin=(100,'K'), Tmax=(847.949,'K')), NASAPolynomial(coeffs=[6.79886,0.0351291,-1.93468e-05,3.8067e-09,-2.63345e-13,-65052.7,6.31918], Tmin=(847.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]CC(F)(F)[C](F)OF(1980)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.20069,'amu*angstrom^2'), symmetry=1, barrier=(4.61427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20066,'amu*angstrom^2'), symmetry=1, barrier=(4.61358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200617,'amu*angstrom^2'), symmetry=1, barrier=(4.61258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0248066,0.104804,-0.000205316,1.9827e-07,-7.16133e-11,-64273.4,29.3362], Tmin=(100,'K'), Tmax=(854.571,'K')), NASAPolynomial(coeffs=[7.17261,0.0350081,-1.94299e-05,3.8155e-09,-2.62911e-13,-64185.1,3.45784], Tmin=(854.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]CC(F)(F)C([O])(F)F(1981)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.351803,0.092801,-0.000170898,1.61384e-07,-5.79399e-11,-99381.4,28.2041], Tmin=(100,'K'), Tmax=(844.095,'K')), NASAPolynomial(coeffs=[7.45663,0.0328475,-1.76472e-05,3.45474e-09,-2.38897e-13,-99644.4,0.678469], Tmin=(844.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-827.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CCOJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.296083,'amu*angstrom^2'), symmetry=1, barrier=(6.80753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.518331,'amu*angstrom^2'), symmetry=1, barrier=(11.9174,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376923,0.0931302,-0.000179519,1.71385e-07,-6.15628e-11,-80457.7,24.0962], Tmin=(100,'K'), Tmax=(847.697,'K')), NASAPolynomial(coeffs=[7.78513,0.0295483,-1.63589e-05,3.23386e-09,-2.24149e-13,-80685.2,-4.35371], Tmin=(847.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
species(
    label = '[O][CH]C(F)(F)C(F)(F)OF(1983)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-775.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,180,1214.07,1217.36,1218.13],'cm^-1')),
        HinderedRotor(inertia=(0.293565,'amu*angstrom^2'), symmetry=1, barrier=(6.74964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293521,'amu*angstrom^2'), symmetry=1, barrier=(6.74863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.27432,'amu*angstrom^2'), symmetry=1, barrier=(52.291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0614519,0.0993813,-0.0001818,1.71788e-07,-6.24036e-11,-93111.9,31.77], Tmin=(100,'K'), Tmax=(821.757,'K')), NASAPolynomial(coeffs=[8.20863,0.035163,-1.97467e-05,3.94776e-09,-2.7708e-13,-93621.6,-0.890279], Tmin=(821.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-775.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.255777,'amu*angstrom^2'), symmetry=1, barrier=(5.88083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256583,'amu*angstrom^2'), symmetry=1, barrier=(5.89935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1849,0.0724383,-0.000130599,1.2689e-07,-4.71724e-11,-95252.4,24.9512], Tmin=(100,'K'), Tmax=(830.622,'K')), NASAPolynomial(coeffs=[4.94314,0.0319658,-1.71059e-05,3.37013e-09,-2.34909e-13,-95104.9,12.1634], Tmin=(830.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-792.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(COCsFO) + radical(CCOJ)"""),
)

species(
    label = '[O]CC(F)=C(F)OF(1985)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-341.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,326,540,652,719,1357,180,2014.43,2014.69],'cm^-1')),
        HinderedRotor(inertia=(0.243885,'amu*angstrom^2'), symmetry=1, barrier=(5.6074,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243376,'amu*angstrom^2'), symmetry=1, barrier=(5.5957,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11361,0.0789314,-0.000157671,1.61601e-07,-6.11717e-11,-40933.1,25.8866], Tmin=(100,'K'), Tmax=(853.438,'K')), NASAPolynomial(coeffs=[2.19124,0.0372878,-2.01632e-05,3.94525e-09,-2.72155e-13,-39784.4,28.6659], Tmin=(853.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ)"""),
)

species(
    label = '[O]C=C(F)C(F)(F)OF(1986)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.248632,'amu*angstrom^2'), symmetry=1, barrier=(5.71653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244105,'amu*angstrom^2'), symmetry=1, barrier=(5.61246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497454,'amu*angstrom^2'), symmetry=1, barrier=(11.4374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.465731,0.107639,-0.000184252,1.59669e-07,-5.38257e-11,-110317,30.4507], Tmin=(100,'K'), Tmax=(818.866,'K')), NASAPolynomial(coeffs=[13.2606,0.0279087,-1.49755e-05,2.94585e-09,-2.05075e-13,-112140,-30.4321], Tmin=(818.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-918.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'FOC[C](F)C(F)(F)OF(1989)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-633.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,251.942,252.063,252.178,252.397],'cm^-1')),
        HinderedRotor(inertia=(0.183354,'amu*angstrom^2'), symmetry=1, barrier=(8.29572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.851057,'amu*angstrom^2'), symmetry=1, barrier=(38.4804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183354,'amu*angstrom^2'), symmetry=1, barrier=(8.29374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183613,'amu*angstrom^2'), symmetry=1, barrier=(8.29584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.643688,0.11383,-0.000203467,1.81877e-07,-6.25985e-11,-76036.2,32.5265], Tmin=(100,'K'), Tmax=(830.683,'K')), NASAPolynomial(coeffs=[12.6303,0.0301412,-1.66458e-05,3.2907e-09,-2.28922e-13,-77559.4,-24.9446], Tmin=(830.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-633.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(CsCsCsF1s)"""),
)

species(
    label = 'FOCC(F)(F)[C](F)OF(1990)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-626.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,201.33,201.33,201.33,201.33],'cm^-1')),
        HinderedRotor(inertia=(0.324342,'amu*angstrom^2'), symmetry=1, barrier=(9.32929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324344,'amu*angstrom^2'), symmetry=1, barrier=(9.32928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29697,'amu*angstrom^2'), symmetry=1, barrier=(37.3056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324343,'amu*angstrom^2'), symmetry=1, barrier=(9.32928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.855926,0.119812,-0.000219313,1.97444e-07,-6.7896e-11,-75208.8,31.6307], Tmin=(100,'K'), Tmax=(841.725,'K')), NASAPolynomial(coeffs=[13.0256,0.029982,-1.67062e-05,3.29404e-09,-2.28028e-13,-76700.4,-27.9263], Tmin=(841.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-626.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]CC(F)(F)OF(1734)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]CF(294)', 'F[C]C(F)(F)OF(505)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    products = ['[O]CC(F)(OF)C(F)(F)F(1977)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(428)', '[O]CC(F)=C(F)F(1662)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C(F)(F)C(F)(F)OF(884)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2O(19)', 'FOC(F)(F)[C](F)F(513)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=CC(F)(F)C(F)(F)OF(1978)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C[C](F)C(F)(F)OF(1979)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]CC(F)(F)[C](F)OF(1980)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]CC(F)(F)C([O])(F)F(1981)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', '[O]CC(F)(F)[C](F)F(1982)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(240)', '[O]C[C](F)F(1170)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][O](1485)', 'FOC(F)(F)[C](F)F(513)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O][CH]C(F)(F)C(F)(F)OF(1983)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', '[O]CC(F)(F)C(=O)F(1984)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', '[O]CC(F)=C(F)OF(1985)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[O]C=C(F)C(F)(F)OF(1986)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C(F)(F)COF(1988)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC[C](F)C(F)(F)OF(1989)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOCC(F)(F)[C](F)OF(1990)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(1932)'],
