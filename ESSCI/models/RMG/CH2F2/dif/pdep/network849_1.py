...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651752,0.0840637,-0.000144756,1.37338e-07,-5.10039e-11,-80462,27.4179], Tmin=(100,'K'), Tmax=(804.289,'K')), NASAPolynomial(coeffs=[6.37311,0.0363315,-1.97818e-05,3.94655e-09,-2.78145e-13,-80758.8,4.93803], Tmin=(804.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-161.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,2120,512.5,787.5,180,2321.17],'cm^-1')),
        HinderedRotor(inertia=(0.346484,'amu*angstrom^2'), symmetry=1, barrier=(7.96635,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92124,0.055433,-0.000105878,1.0404e-07,-3.78611e-11,-19385.9,18.8214], Tmin=(100,'K'), Tmax=(874.869,'K')), NASAPolynomial(coeffs=[3.81105,0.0237013,-1.18823e-05,2.24456e-09,-1.51242e-13,-18832.9,15.0073], Tmin=(874.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cd(Cdd-Od)CF) + missing(Cdd-CdO2d) + radical(CCOJ)"""),
)

species(
    label = '[O]CC(F)=C(OF)OF(2022)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.128466,'amu*angstrom^2'), symmetry=1, barrier=(2.95368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128397,'amu*angstrom^2'), symmetry=1, barrier=(2.9521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128224,'amu*angstrom^2'), symmetry=1, barrier=(2.94813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.449645,0.101665,-0.000221042,2.32443e-07,-8.83147e-11,-18336,29.803], Tmin=(100,'K'), Tmax=(864.862,'K')), NASAPolynomial(coeffs=[-0.103045,0.0466754,-2.58623e-05,5.05736e-09,-3.46718e-13,-16088.2,44.8315], Tmin=(864.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs) + radical(CCOJ)"""),
)

species(
    label = '[O]COC(OF)=C(F)F(2023)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-469.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,182,240,577,636,1210,1413,375.054,375.658,375.918,376.023,376.748],'cm^-1')),
        HinderedRotor(inertia=(0.00119946,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265235,'amu*angstrom^2'), symmetry=1, barrier=(26.5997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0202258,'amu*angstrom^2'), symmetry=1, barrier=(34.9827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575012,0.0820466,-0.000115796,8.50798e-08,-2.51525e-11,-56319.8,26.3444], Tmin=(100,'K'), Tmax=(823.617,'K')), NASAPolynomial(coeffs=[12.0529,0.0263033,-1.42758e-05,2.90607e-09,-2.09852e-13,-58210.5,-26.8028], Tmin=(823.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(OCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215747,0.0747879,-8.63805e-05,4.91232e-08,-1.06333e-11,-51470.4,26.2039], Tmin=(100,'K'), Tmax=(1227.05,'K')), NASAPolynomial(coeffs=[18.2352,0.0111102,-2.50281e-06,2.72741e-10,-1.2367e-14,-55520.8,-62.9023], Tmin=(1227.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)OCC1(F)F(2025)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43352,0.0622822,-7.83894e-05,6.03679e-08,-2.00494e-11,-64999.9,24.8172], Tmin=(100,'K'), Tmax=(719.209,'K')), NASAPolynomial(coeffs=[6.73008,0.032821,-1.69368e-05,3.39777e-09,-2.43922e-13,-65761.6,1.01075], Tmin=(719.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(CsCsCsFF) + group(Cs-CsOsHH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83364,'amu*angstrom^2'), symmetry=1, barrier=(42.159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83468,'amu*angstrom^2'), symmetry=1, barrier=(42.1829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83369,'amu*angstrom^2'), symmetry=1, barrier=(42.1602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04036,0.071559,-0.000102151,7.95375e-08,-2.53601e-11,-95328.3,25.0423], Tmin=(100,'K'), Tmax=(760.961,'K')), NASAPolynomial(coeffs=[9.47078,0.0272437,-1.47953e-05,3.00542e-09,-2.16505e-13,-96611.4,-13.3265], Tmin=(760.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-793.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26243,0.0682296,-0.000111288,1.05001e-07,-3.94427e-11,-35748,25.2375], Tmin=(100,'K'), Tmax=(790.89,'K')), NASAPolynomial(coeffs=[5.47214,0.0328707,-1.75453e-05,3.49166e-09,-2.46522e-13,-35973.9,8.69717], Tmin=(790.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCOCsF1s)"""),
)

species(
    label = '[O]CC(F)(F)C([O])=O(2028)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-578.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2850,1437.5,1250,1305,750,350,180,180,1032.69,1033,1033.06,1033.23,1033.78,1033.79],'cm^-1')),
        HinderedRotor(inertia=(0.225583,'amu*angstrom^2'), symmetry=1, barrier=(5.18659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225493,'amu*angstrom^2'), symmetry=1, barrier=(5.18453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46929,0.0692176,-0.000131317,1.38819e-07,-5.49378e-11,-69526,24.4786], Tmin=(100,'K'), Tmax=(829.272,'K')), NASAPolynomial(coeffs=[0.596618,0.041222,-2.24249e-05,4.44857e-09,-3.1139e-13,-68273.9,35.2021], Tmin=(829.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-379.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([169,350,401,508,725,1243,1223,2750,2850,1437.5,1250,1305,750,350,1855,455,950,180,1938.29],'cm^-1')),
        HinderedRotor(inertia=(0.163156,'amu*angstrom^2'), symmetry=1, barrier=(3.75128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163302,'amu*angstrom^2'), symmetry=1, barrier=(3.75464,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7284,0.0590771,-0.000106051,1.05199e-07,-3.99249e-11,-45594.1,23.4003], Tmin=(100,'K'), Tmax=(826.267,'K')), NASAPolynomial(coeffs=[3.81071,0.029116,-1.55685e-05,3.07432e-09,-2.1486e-13,-45259.6,17.8583], Tmin=(826.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(COj(Cs-F1sF1sCs)(O2d))"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.387537,0.0927185,-0.000175477,1.68547e-07,-6.14273e-11,-58770.4,27.9163], Tmin=(100,'K'), Tmax=(836.19,'K')), NASAPolynomial(coeffs=[7.06119,0.0330105,-1.85294e-05,3.68237e-09,-2.56755e-13,-58915.1,2.72187], Tmin=(836.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-489.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'O=C[C](F)C(=O)OF(2031)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-384.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,180,180,180,566.265,757.387,757.71],'cm^-1')),
        HinderedRotor(inertia=(0.109451,'amu*angstrom^2'), symmetry=1, barrier=(44.4503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93359,'amu*angstrom^2'), symmetry=1, barrier=(44.4571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93354,'amu*angstrom^2'), symmetry=1, barrier=(44.4559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48447,0.0611982,-8.64845e-05,6.8151e-08,-2.22516e-11,-46160.7,23.2448], Tmin=(100,'K'), Tmax=(740.545,'K')), NASAPolynomial(coeffs=[8.11421,0.0253875,-1.39473e-05,2.84908e-09,-2.05987e-13,-47142.6,-6.74839], Tmin=(740.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651752,0.0840637,-0.000144756,1.37338e-07,-5.10039e-11,-80462,26.7247], Tmin=(100,'K'), Tmax=(804.289,'K')), NASAPolynomial(coeffs=[6.37311,0.0363315,-1.97818e-05,3.94655e-09,-2.78145e-13,-80758.8,4.24488], Tmin=(804.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'O=C(OF)[C](F)COF(2034)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.661723,0.0801945,-0.000112937,8.53251e-08,-2.6204e-11,-46693.2,26.7255], Tmin=(100,'K'), Tmax=(791.214,'K')), NASAPolynomial(coeffs=[10.8428,0.0287225,-1.53527e-05,3.10006e-09,-2.22689e-13,-48304.3,-20.0077], Tmin=(791.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', '[O]CC(F)(F)OF(1734)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]CF(294)', 'O=C([C]F)OF(426)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(428)', '[O]CC(F)=C=O(2021)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', '[CH2]C(F)(F)C(=O)OF(824)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC(F)(F)C(=O)OF(1922)'],
    products = ['[O]C1(OF)OCC1(F)F(2025)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2O(19)', 'O=C(OF)[C](F)F(435)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC(F)(F)C(=O)OF(2026)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C[C](F)C(=O)OF(2027)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)C([O])=O(2028)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(228)', '[O]CC(F)(F)[C]=O(2029)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][O](1485)', 'O=C(OF)[C](F)F(435)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(142)', '[O]C[C](F)F(1170)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O][CH]C(F)(F)C(=O)OF(2030)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C[C](F)C(=O)OF(2031)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(=O)C(F)(F)COF(2033)'],
    products = ['[O]CC(F)(F)C(=O)OF(1922)'],
