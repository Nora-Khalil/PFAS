...
"""),
    E0 = (90.8727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,395,473,707,1436,3000,3100,440,815,1455,1000,180,1986.48],'cm^-1')),
        HinderedRotor(inertia=(0.352669,'amu*angstrom^2'), symmetry=1, barrier=(8.10856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353261,'amu*angstrom^2'), symmetry=1, barrier=(8.12216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63175,'amu*angstrom^2'), symmetry=1, barrier=(37.5171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28882,0.0697418,-0.000136157,1.29417e-07,-4.60463e-11,11017.4,22.1512], Tmin=(100,'K'), Tmax=(855.36,'K')), NASAPolynomial(coeffs=[7.20094,0.0202847,-1.118e-05,2.20098e-09,-1.51778e-13,10803.8,-0.78386], Tmin=(855.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.8727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[O](431)'],
    products = ['O=O(176)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(19.95,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])(F)F(907)'],
    products = ['[CH2]C(F)(F)O[O](431)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(147)', 'CH2(T)(68)'],
    products = ['[CH2]C(F)(F)O[O](431)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[O](431)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(12.7814,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2][C](F)OOF(1148)'],
    products = ['[CH2]C(F)(F)O[O](431)'],
    transitionState = 'TS9',
