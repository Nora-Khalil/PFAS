...
"""),
    E0 = (-672.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,234,347,1316,1464,435.453,435.727,435.856,435.939,435.95,1772.18],'cm^-1')),
        HinderedRotor(inertia=(0.319404,'amu*angstrom^2'), symmetry=1, barrier=(43.0708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23236,'amu*angstrom^2'), symmetry=1, barrier=(31.3391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372624,'amu*angstrom^2'), symmetry=1, barrier=(50.347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83866,0.0471033,-3.97137e-05,1.68486e-08,-2.92321e-12,-80808.6,20.7456], Tmin=(100,'K'), Tmax=(1343.23,'K')), NASAPolynomial(coeffs=[10.9317,0.0200252,-9.47522e-06,1.84075e-09,-1.29966e-13,-83251.4,-25.806], Tmin=(1343.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = '[CH2]C(F)(F)C(=O)O(1357)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)(F)CF(320)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'O=C(O)[C]F(844)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C(O)C(F)(F)[C]F(1350)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(86)', 'O=C(O)C(F)F(220)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(72)', 'O=C(O)C(F)(F)F(526)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(153)', 'O=C=C(F)CF(1272)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(1354)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(1355)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(1356)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(1357)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(4)', 'O=[C]C(F)(F)CF(1280)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)CF(1279)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(89)', 'O=C(O)[C](F)F(851)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(189)', 'CH2F-CF2(67)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[CH]F(1308)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(106)', 'C=C(F)C(=O)O(1358)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=CF(1359)'],
    products = ['O=C(O)C(F)(F)CF(1319)'],
