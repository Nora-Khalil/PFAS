...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.8067,0.0281003,0.000697139,-6.7127e-06,1.96358e-08,-122848,7.87934], Tmin=(10,'K'), Tmax=(118.869,'K')), NASAPolynomial(coeffs=[4.27353,0.0493013,-3.61607e-05,1.21573e-08,-1.52315e-12,-122885,5.52451], Tmin=(118.869,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1021.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), label="""FCC(F)(F)CDC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
species(
    label = 'F[CH]C(F)(F)[CH]C(F)F(1093)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.241371,'amu*angstrom^2'), symmetry=1, barrier=(5.5496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244813,'amu*angstrom^2'), symmetry=1, barrier=(5.62872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240717,'amu*angstrom^2'), symmetry=1, barrier=(5.53456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00662705,0.101752,-0.000187561,1.7737e-07,-6.38483e-11,-91814.8,29.9777], Tmin=(100,'K'), Tmax=(838.499,'K')), NASAPolynomial(coeffs=[8.04308,0.0354653,-1.90941e-05,3.76388e-09,-2.61641e-13,-92184.4,-1.59392], Tmin=(838.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-764.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'FCC(F)(F)[CH][C](F)F(1089)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-763.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0884347,'amu*angstrom^2'), symmetry=1, barrier=(2.03329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0893191,'amu*angstrom^2'), symmetry=1, barrier=(2.05362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754446,'amu*angstrom^2'), symmetry=1, barrier=(17.3462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107879,0.0977903,-0.000175158,1.64159e-07,-5.91987e-11,-91661.2,29.793], Tmin=(100,'K'), Tmax=(825.835,'K')), NASAPolynomial(coeffs=[8.21765,0.0351355,-1.88988e-05,3.74408e-09,-2.61818e-13,-92203.6,-2.95421], Tmin=(825.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][C](F)CC(F)(F)F(1094)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0867579,0.0954143,-0.000161403,1.43828e-07,-5.01751e-11,-96879.9,29.9832], Tmin=(100,'K'), Tmax=(808.618,'K')), NASAPolynomial(coeffs=[10.3662,0.0308676,-1.62589e-05,3.21525e-09,-2.25423e-13,-98094.5,-14.6565], Tmin=(808.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C[C](F)C(F)F(1073)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1034)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC(F)[C](F)F(1036)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C(F)(F)[CH]F(1055)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(911)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    products = ['FC1C(F)(F)CC1(F)F(1078)'],
    transitionState = 'TS6',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.68369,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C[C](F)F(607)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(231.223,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CF2(89)', '[CH2]C(F)(F)[CH]F(1055)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(88)', 'F[C](F)C[C](F)F(911)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(1093)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(1089)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    products = ['F[CH][C](F)CC(F)(F)F(1094)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(209.772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    products = ['F[C](F)C[C](F)C(F)F(1073)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(180.428,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #409',
    isomers = [
        'F[CH]C(F)(F)C[C](F)F(1034)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CF2(56)'),
    ],
