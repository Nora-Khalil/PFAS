...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81644,0.0171382,-3.27594e-05,2.86045e-08,-9.00905e-12,52027.9,8.68893], Tmin=(100,'K'), Tmax=(974.884,'K')), NASAPolynomial(coeffs=[4.85512,0.00251793,-6.39189e-07,5.7506e-11,-5.61501e-16,51927.7,0.429948], Tmin=(974.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.396,'kJ/mol'), Cp0=(29.1007,'J/(mol*K)'), CpInf=(87.302,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Acetyl)"""),
)
...
"""),
    E0 = (287.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([98,689,742,1025,1654,3206],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.30871,0.0168726,-2.74842e-05,2.4082e-08,-8.17122e-12,34557.3,6.83225], Tmin=(100,'K'), Tmax=(861.36,'K')), NASAPolynomial(coeffs=[4.92571,0.00604159,-2.83767e-06,5.28891e-10,-3.56849e-14,34402,-0.012156], Tmin=(861.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), label="""CCHF""", comment="""Thermo library: halogens"""),
)
...
reaction(
    ...
    products = ['C2HF(57)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(39.6837,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

network(
    label = 'PDepNetwork #193',
    isomers = [
        'C2HF(57)',
    ],
    reactants = [
