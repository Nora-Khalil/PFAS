...
"""),
    E0 = (-131.798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,341.424,522.271,522.275,522.381,3457.85],'cm^-1')),
        HinderedRotor(inertia=(1.78344,'amu*angstrom^2'), symmetry=1, barrier=(41.0049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0149075,'amu*angstrom^2'), symmetry=1, barrier=(2.88586,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02816,0.0366543,-3.84974e-05,1.93693e-08,-3.69753e-12,-15774.9,22.6682], Tmin=(100,'K'), Tmax=(1392.17,'K')), NASAPolynomial(coeffs=[12.3026,0.00456302,-1.15055e-06,1.58648e-10,-9.57111e-15,-18386.5,-29.4045], Tmin=(1392.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14577,0.023637,2.83429e-05,-6.86166e-08,3.17554e-11,-67745.9,20.7461], Tmin=(100,'K'), Tmax=(932.865,'K')), NASAPolynomial(coeffs=[19.0567,-0.00499825,3.83568e-06,-6.83652e-10,3.81104e-14,-72810.1,-69.8967], Tmin=(932.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(O2s-OsH) + group(COFOO)"""),
)
...
"""),
    E0 = (-189.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,511.382,511.416,511.425,511.809],'cm^-1')),
        HinderedRotor(inertia=(0.000642109,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246876,'amu*angstrom^2'), symmetry=1, barrier=(45.933,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0014,0.00571091,5.63191e-05,-8.74865e-08,3.66597e-11,-22722.6,17.7461], Tmin=(100,'K'), Tmax=(925.96,'K')), NASAPolynomial(coeffs=[14.8311,-0.00354108,3.51123e-06,-6.55214e-10,3.76087e-14,-26707.5,-48.1036], Tmin=(925.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-OdOsH) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06048,0.0401423,-4.84397e-05,2.82256e-08,-6.31286e-12,-21714.3,23.196], Tmin=(100,'K'), Tmax=(1107.17,'K')), NASAPolynomial(coeffs=[11.5068,0.006014,-2.20151e-06,3.83369e-10,-2.59369e-14,-23806,-23.3384], Tmin=(1107.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHOO) + radical(ROOJ) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2569,0.0313723,-1.72657e-05,-5.58399e-09,5.63496e-12,-9266.05,23.2678], Tmin=(100,'K'), Tmax=(982.895,'K')), NASAPolynomial(coeffs=[12.4199,0.00573498,-2.13409e-06,4.26879e-10,-3.32574e-14,-12023.3,-29.4508], Tmin=(982.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.6159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]OO[CH]OF(235)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (171.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,180,180,596.357,596.391,596.394,596.398],'cm^-1')),
        HinderedRotor(inertia=(0.00130199,'amu*angstrom^2'), symmetry=1, barrier=(14.7829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185031,'amu*angstrom^2'), symmetry=1, barrier=(46.6982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106001,'amu*angstrom^2'), symmetry=1, barrier=(14.783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51139,0.054079,-8.01787e-05,5.51084e-08,-1.43249e-11,20774,22.4271], Tmin=(100,'K'), Tmax=(959.79,'K')), NASAPolynomial(coeffs=[13.6581,0.00345378,-1.05522e-06,1.46676e-10,-8.00854e-15,18442.4,-35.6748], Tmin=(959.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(OCJO)"""),
)
...
"""),
    E0 = (208.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3025,407.5,1350,352.5,506.107,506.11,506.18,506.219,506.221],'cm^-1')),
        HinderedRotor(inertia=(0.000657974,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000658158,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000657703,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9762,0.0514689,-9.38106e-05,9.0072e-08,-3.32839e-11,25102.1,21.683], Tmin=(100,'K'), Tmax=(818.289,'K')), NASAPolynomial(coeffs=[5.53,0.0202904,-1.13487e-05,2.27018e-09,-1.59595e-13,24982.7,8.07514], Tmin=(818.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2sFO) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])F(227)'],
    products = ['[O]OOC([O])F(218)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[O](160)', '[O][CH]F(135)'],
    products = ['[O]OOC([O])F(218)'],
