...
reaction(
    label = 'reaction2',
    reactants = ['CHF(88)', 'O=C(O)OF(836)'],
    products = ['O=C(OF)OCF(1390)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(837)', 'CH2(S)(74)'],
    products = ['O=C(OF)OCF(1390)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=O)OF(1394)'],
    products = ['O=C(OF)OCF(1390)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(842)', 'CH2F(91)'],
    products = ['O=C(OF)OCF(1390)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(156)', 'O=[C]OCF(1396)'],
    products = ['O=C(OF)OCF(1390)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[CH]F(840)'],
    products = ['O=C(OF)OCF(1390)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(OF)OCF(1390)'],
    products = ['F2(108)', 'CO2(13)', 'CH2O(19)'],
