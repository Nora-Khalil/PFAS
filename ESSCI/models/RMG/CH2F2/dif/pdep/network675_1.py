...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.640169,'amu*angstrom^2'), symmetry=1, barrier=(14.7187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.63972,'amu*angstrom^2'), symmetry=1, barrier=(14.7084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.638962,'amu*angstrom^2'), symmetry=1, barrier=(14.691,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.75594,'amu*angstrom^2'), symmetry=1, barrier=(17.3806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757577,'amu*angstrom^2'), symmetry=1, barrier=(17.4182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-449.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.302469,'amu*angstrom^2'), symmetry=1, barrier=(6.95437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303856,'amu*angstrom^2'), symmetry=1, barrier=(6.98625,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.75916,0.018447,0.000128114,-4.36599e-07,3.9945e-10,-54018.8,10.558], Tmin=(10,'K'), Tmax=(402.512,'K')), NASAPolynomial(coeffs=[6.43765,0.024578,-1.67748e-05,5.50581e-09,-6.84868e-13,-54499.7,-3.22209], Tmin=(402.512,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-449.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""[CH2]OC(O)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-435.618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,580,1155,1237,1373,3147,180,180,2484.26],'cm^-1')),
        HinderedRotor(inertia=(0.494752,'amu*angstrom^2'), symmetry=1, barrier=(11.3753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14499,'amu*angstrom^2'), symmetry=1, barrier=(26.3256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.818041,'amu*angstrom^2'), symmetry=1, barrier=(18.8084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.817226,'amu*angstrom^2'), symmetry=1, barrier=(18.7896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-647.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,580,1155,1237,1373,3147,180,180,1249.15],'cm^-1')),
        HinderedRotor(inertia=(0.764793,'amu*angstrom^2'), symmetry=1, barrier=(17.5841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10323,'amu*angstrom^2'), symmetry=1, barrier=(25.3654,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)OCF(1602)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.65824e+14,'s^-1'), n=-0.436116, Ea=(151.083,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.9927400314419011, var=19.60363129417426, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_N-7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_N-7R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)F(608)'],
    products = ['OC(F)OCF(1602)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.34896e-06,'m^3/(mol*s)'), n=3.15288, Ea=(2.39296,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H
...
reaction(
    ...
    products = ['OC(F)OCF(1602)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(6.99981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[CH]OCF(1811)'],
    products = ['OC(F)OCF(1602)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)F(1812)'],
    products = ['OC(F)OCF(1602)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(172.122,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

network(
    label = 'PDepNetwork #675',
    isomers = [
        'OC(F)OCF(1602)',
    ],
    reactants = [
