...
"""),
    E0 = (239.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,167,640,1190,409.347,409.502,409.55,2154.48,2154.72],'cm^-1')),
        HinderedRotor(inertia=(0.111916,'amu*angstrom^2'), symmetry=1, barrier=(13.3275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111927,'amu*angstrom^2'), symmetry=1, barrier=(13.3281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12023,0.0433638,-6.44815e-05,4.90833e-08,-1.46401e-11,28906.9,22.7087], Tmin=(100,'K'), Tmax=(826.78,'K')), NASAPolynomial(coeffs=[8.92935,0.010416,-4.69633e-06,8.68874e-10,-5.8892e-14,27781.2,-8.84513], Tmin=(826.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (277.584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,239,401,1367,470.556,470.575,470.608,470.63,2323.9],'cm^-1')),
        HinderedRotor(inertia=(0.000761286,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170513,'amu*angstrom^2'), symmetry=1, barrier=(26.7887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0179,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35205,0.038375,-5.52391e-05,3.94714e-08,-1.10671e-11,33443.2,19.987], Tmin=(100,'K'), Tmax=(876.273,'K')), NASAPolynomial(coeffs=[8.83865,0.00876461,-4.55156e-06,9.07908e-10,-6.47978e-14,32306.4,-10.4503], Tmin=(876.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsOs) + group(O2s-OsH) + group(Ct-CtOs) + group(CtCF) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82996,0.0509091,-7.91724e-05,6.15451e-08,-1.87441e-11,39376.2,22.41], Tmin=(100,'K'), Tmax=(808.903,'K')), NASAPolynomial(coeffs=[9.82088,0.0113949,-5.90014e-06,1.15804e-09,-8.12289e-14,38083.4,-14.4471], Tmin=(808.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
