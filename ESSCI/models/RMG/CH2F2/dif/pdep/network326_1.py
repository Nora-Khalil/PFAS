...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.612329,'amu*angstrom^2'), symmetry=1, barrier=(14.0786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.613285,'amu*angstrom^2'), symmetry=1, barrier=(14.1006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51475,0.0450478,-4.82382e-05,2.42478e-08,-4.56694e-12,-44443.8,27.2206], Tmin=(100,'K'), Tmax=(1452.69,'K')), NASAPolynomial(coeffs=[14.7734,0.00366626,-4.7656e-07,1.95607e-11,5.57074e-17,-47781.7,-39.9254], Tmin=(1452.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(ROOJ)"""),
)
...
"""),
    E0 = (171.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,744.041,748.244,750.242,3896.98],'cm^-1')),
        HinderedRotor(inertia=(0.0065871,'amu*angstrom^2'), symmetry=1, barrier=(2.66102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0367119,'amu*angstrom^2'), symmetry=1, barrier=(15.0512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (82.996,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88455,0.0168411,3.25546e-06,-2.74102e-08,1.51779e-11,20712.3,18.8695], Tmin=(100,'K'), Tmax=(888.361,'K')), NASAPolynomial(coeffs=[12.5058,-0.00504901,4.03081e-06,-8.36267e-10,5.74009e-14,18157.2,-31.1679], Tmin=(888.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(O2s-OsH) + radical(ROOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20994,0.0504267,-5.62798e-05,2.88399e-08,-5.49355e-12,-72497.4,28.948], Tmin=(100,'K'), Tmax=(1447.54,'K')), NASAPolynomial(coeffs=[16.5718,0.00189865,3.05856e-07,-1.21644e-10,9.32403e-15,-76307.9,-48.6463], Tmin=(1447.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFFO) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0865327,0.0778976,-9.03129e-05,4.89909e-08,-1.01258e-11,-98028.8,34.0776], Tmin=(100,'K'), Tmax=(1199.75,'K')), NASAPolynomial(coeffs=[20.9767,0.00824941,-3.23464e-06,6.04118e-10,-4.31482e-14,-103041,-70.5097], Tmin=(1199.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-816.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-835.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,180,180,180,370.278,836.442,3188.51],'cm^-1')),
        HinderedRotor(inertia=(0.0301696,'amu*angstrom^2'), symmetry=1, barrier=(14.9524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303276,'amu*angstrom^2'), symmetry=1, barrier=(14.9749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15498,'amu*angstrom^2'), symmetry=1, barrier=(49.5471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.021,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764256,0.0733724,-9.73029e-05,6.33744e-08,-1.61366e-11,-100429,28.0438], Tmin=(100,'K'), Tmax=(964.258,'K')), NASAPolynomial(coeffs=[14.6188,0.0159012,-7.90261e-06,1.56634e-09,-1.12143e-13,-103101,-38.2925], Tmin=(964.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-835.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-382.712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642447,0.0735161,-9.62153e-05,6.03657e-08,-1.46105e-11,-45908.3,32.7897], Tmin=(100,'K'), Tmax=(1019.99,'K')), NASAPolynomial(coeffs=[16.3763,0.0118154,-5.48028e-06,1.06263e-09,-7.55938e-14,-49118.1,-43.429], Tmin=(1019.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OOOC(F)(F)[CH]F(967)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-389.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301759,0.0761452,-9.60411e-05,5.637e-08,-1.25695e-11,-46745.4,32.7898], Tmin=(100,'K'), Tmax=(1114.72,'K')), NASAPolynomial(coeffs=[19.6573,0.00669046,-2.58009e-06,4.74484e-10,-3.36599e-14,-51060.5,-62.6913], Tmin=(1114.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107188,0.0872584,-0.000125884,8.54655e-08,-2.22596e-11,-71280.8,34.184], Tmin=(100,'K'), Tmax=(950.835,'K')), NASAPolynomial(coeffs=[18.2423,0.0109721,-5.54512e-06,1.09675e-09,-7.82332e-14,-74729.7,-52.3941], Tmin=(950.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57602,0.0536072,-6.43311e-05,3.85674e-08,-9.0897e-12,-20391.2,29.1352], Tmin=(100,'K'), Tmax=(1037.64,'K')), NASAPolynomial(coeffs=[12.0144,0.0133673,-6.1593e-06,1.19198e-09,-8.45737e-14,-22557.4,-21.6093], Tmin=(1037.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(ROOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20117,0.0645235,-9.01598e-05,6.25769e-08,-1.7022e-11,-42820,31.195], Tmin=(100,'K'), Tmax=(903.261,'K')), NASAPolynomial(coeffs=[12.4637,0.0146487,-7.3355e-06,1.44724e-09,-1.02889e-13,-44854.6,-21.9943], Tmin=(903.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(ROOJ)"""),
)

species(
    label = 'OOOOC(F)(F)[C](F)F(971)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13245,0.0905726,-0.000120225,7.48933e-08,-1.7928e-11,-89552.3,34.2844], Tmin=(100,'K'), Tmax=(1031.98,'K')), NASAPolynomial(coeffs=[20.0956,0.0121674,-6.26139e-06,1.27138e-09,-9.28022e-14,-93727.3,-63.9409], Tmin=(1031.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)

species(
    label = 'FOOOO[C](F)C(F)F(972)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-439.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.126152,0.0854569,-0.000109383,6.6513e-08,-1.56599e-11,-52710.1,35.2686], Tmin=(100,'K'), Tmax=(1044.74,'K')), NASAPolynomial(coeffs=[18.6467,0.0145458,-7.56956e-06,1.54298e-09,-1.12705e-13,-56579.9,-54.8927], Tmin=(1044.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(F)(F)OOOOF(973)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
8  O u0 p2 c0 {4,S} {7,S}
9  C u0 p0 c0 {1,S} {2,S} {5,S} {10,S}
10 C u1 p0 c0 {3,S} {9,S} {11,S}
11 H u0 p0 c0 {10,S}
"""),
    E0 = (-446.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,253,525,597,667,842,1178,1324,334,575,1197,1424,3202,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.222966,0.0881923,-0.000109603,6.30423e-08,-1.38426e-11,-53546.8,35.2983], Tmin=(100,'K'), Tmax=(1127.34,'K')), NASAPolynomial(coeffs=[22.0226,0.00926008,-4.57682e-06,9.33005e-10,-6.89617e-14,-58562.4,-74.6896], Tmin=(1127.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)(F)C(F)F(637)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.98302e+08,'m^3/(mol*s)'), n=0.0472428, Ea=(64.1944,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C
Multiplied by reaction path degeneracy 2.0
Ea raised from 63.7 to 64.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]OOOC(F)F(177)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OOOF(221)', 'F[C]C(F)F(231)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(963)', 'CHF(40)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)(F)C(F)F(936)'],
    products = ['[O]OOOC(F)C(F)(F)F(964)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]OOC(F)(F)C(F)F(965)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OOOC(F)(F)C(F)F(936)'],
    products = ['[O-][O+]=O(233)', '[O]C(F)(F)C(F)F(247)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.88184e+13,'s^-1'), n=-0.182188, Ea=(172.753,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;Y_rad_intra;OOR]
Euclidian distance = 0
family: Cyclic_Ether_Formation
Ea raised from 172.2 to 172.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OOO[C](F)C(F)F(966)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OOOC(F)(F)[CH]F(967)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[O](152)', '[O]C(F)(F)C(F)F(247)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OO[O](224)', 'CHF2-CF2(68)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OOO[C](F)F(225)', 'CHF2(81)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OOOC(F)(F)[C](F)F(968)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(77)', '[O]OOOC(F)=CF(969)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OOOC(F)=C(F)F(970)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOOOO[C](F)C(F)F(972)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(64.3567,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)OOOOF(973)'],
    products = ['[O]OOOC(F)(F)C(F)F(936)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(66.0738,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #326',
    isomers = [
        '[O]OOOC(F)(F)C(F)F(936)',
    ],
    reactants = [
        ('O2(2)', '[O]OC(F)(F)C(F)F(637)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
