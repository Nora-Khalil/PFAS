...
"""),
    E0 = (-719.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,493,600,700,1144,1293,180,180,180,1468.81],'cm^-1')),
        HinderedRotor(inertia=(0.282978,'amu*angstrom^2'), symmetry=1, barrier=(6.50621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282396,'amu*angstrom^2'), symmetry=1, barrier=(6.49284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43083,'amu*angstrom^2'), symmetry=1, barrier=(32.8976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)OC(F)F(438)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(15.407,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)OF(505)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(77.3859,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(F)OF(506)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(8.65249,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[CH]OC(F)F(507)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)OF(508)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)OC(F)F(509)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(402)', '[O]C(F)F(146)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF2(81)', '[O]C(F)OF(189)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(248)', 'F[CH]OC(F)F(416)'],
    products = ['FOC(F)OC(F)F(438)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FO[C](F)OC(F)F(363)'],
    products = ['FOC(F)OC(F)F(438)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FOC(F)O[C](F)F(510)'],
    products = ['FOC(F)OC(F)F(438)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)F(186)'],
    products = ['FOC(F)OC(F)F(438)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(224.038,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
