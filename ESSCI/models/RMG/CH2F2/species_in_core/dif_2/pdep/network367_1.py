...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(868)'],
    products = ['O=C(O)OC(F)(F)F(822)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'O=[C]OC(F)(F)F(869)'],
    products = ['O=C(O)OC(F)(F)F(822)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(870)'],
    products = ['O=C(O)OC(F)(F)F(822)'],
    transitionState = 'TS8',
