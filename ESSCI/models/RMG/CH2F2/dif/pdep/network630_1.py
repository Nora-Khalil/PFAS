...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.260595,'amu*angstrom^2'), symmetry=1, barrier=(5.99159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262763,'amu*angstrom^2'), symmetry=1, barrier=(6.04144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-293.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,194,682,905,1196,1383,3221,180,1592.74],'cm^-1')),
        HinderedRotor(inertia=(0.4909,'amu*angstrom^2'), symmetry=1, barrier=(11.2868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-511.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,218.986,4000],'cm^-1')),
        HinderedRotor(inertia=(0.306248,'amu*angstrom^2'), symmetry=1, barrier=(10.4045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12275,'amu*angstrom^2'), symmetry=1, barrier=(37.373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13048,'amu*angstrom^2'), symmetry=1, barrier=(37.3297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857833,0.0748582,-0.000121335,1.02225e-07,-3.38941e-11,-61438.6,23.9263], Tmin=(100,'K'), Tmax=(797.305,'K')), NASAPolynomial(coeffs=[10.7173,0.0206536,-1.04387e-05,2.04199e-09,-1.42639e-13,-62860.1,-20.4615], Tmin=(797.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-157.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,334,575,1197,1424,3202,275.441,276.109,276.224],'cm^-1')),
        HinderedRotor(inertia=(0.123215,'amu*angstrom^2'), symmetry=1, barrier=(6.65595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122845,'amu*angstrom^2'), symmetry=1, barrier=(6.65571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424103,'amu*angstrom^2'), symmetry=1, barrier=(22.9036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69512,0.082133,-0.000147898,1.35789e-07,-4.79104e-11,-18820.8,23.3113], Tmin=(100,'K'), Tmax=(828.056,'K')), NASAPolynomial(coeffs=[8.94991,0.0251311,-1.36169e-05,2.70177e-09,-1.88805e-13,-19600.7,-11.4104], Tmin=(828.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-453.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,1618.87],'cm^-1')),
        HinderedRotor(inertia=(0.374228,'amu*angstrom^2'), symmetry=1, barrier=(8.60423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374001,'amu*angstrom^2'), symmetry=1, barrier=(8.59902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]F(807)'],
    products = ['[O]CC(F)(F)[CH]F(1560)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C(F)[CH]F(808)'],
    products = ['[O]CC(F)(F)[CH]F(1560)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(1682)'],
    products = ['[O]CC(F)(F)[CH]F(1560)'],
