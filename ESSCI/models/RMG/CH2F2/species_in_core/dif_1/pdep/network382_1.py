...
"""),
    E0 = (-455.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,1855,455,950,180,1561.16],'cm^-1')),
        HinderedRotor(inertia=(0.929505,'amu*angstrom^2'), symmetry=1, barrier=(21.3711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16994,'amu*angstrom^2'), symmetry=1, barrier=(49.8913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17243,'amu*angstrom^2'), symmetry=1, barrier=(49.9485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75066,0.0531874,-6.16349e-05,3.75473e-08,-9.36412e-12,-54706.1,20.0609], Tmin=(100,'K'), Tmax=(961.372,'K')), NASAPolynomial(coeffs=[9.61759,0.0204547,-1.05623e-05,2.13024e-09,-1.53932e-13,-56218.7,-17.5824], Tmin=(961.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02466,'amu*angstrom^2'), symmetry=1, barrier=(23.5589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3698,'amu*angstrom^2'), symmetry=1, barrier=(51.9303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10314,0.045836,-5.88818e-05,4.20697e-08,-1.24897e-11,-33967.1,15.9855], Tmin=(100,'K'), Tmax=(810.297,'K')), NASAPolynomial(coeffs=[7.4226,0.0195762,-1.02693e-05,2.07324e-09,-1.49406e-13,-34829.2,-8.55874], Tmin=(810.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-416.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,1855,455,950,252.087,254.589,254.839],'cm^-1')),
        HinderedRotor(inertia=(0.706441,'amu*angstrom^2'), symmetry=1, barrier=(32.8864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0307,'amu*angstrom^2'), symmetry=1, barrier=(46.1172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56427,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6378,0.0568831,-7.81599e-05,6.00781e-08,-1.90644e-11,-50011.3,20.9252], Tmin=(100,'K'), Tmax=(762.603,'K')), NASAPolynomial(coeffs=[8.02863,0.0233651,-1.22379e-05,2.4546e-09,-1.75748e-13,-50986.1,-8.17548], Tmin=(762.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical((O)CJOC)"""),
)

species(
    label = '[CH2][C](F)OC(=O)F(990)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(224)', '[CH2]C([O])(F)F(907)'],
    products = ['[CH2]C(F)(F)O[C]=O(950)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(68)', 'O=[C]O[C](F)F(292)'],
    products = ['[CH2]C(F)(F)O[C]=O(950)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[CH2]C([O])(F)F(907)'],
    products = ['[CH2]C(F)(F)O[C]=O(950)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C]=O(950)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(11.748,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
