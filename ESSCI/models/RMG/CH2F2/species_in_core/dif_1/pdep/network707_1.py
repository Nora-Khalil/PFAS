...
"""),
    E0 = (-934.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,90,150,250,247,323,377,431,433,1065,1274,220.599,1217.96,1231.19,1325.13,1381.76,1514.43,2199.12],'cm^-1')),
        HinderedRotor(inertia=(0.0938322,'amu*angstrom^2'), symmetry=1, barrier=(3.04103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0938322,'amu*angstrom^2'), symmetry=1, barrier=(3.04103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0938322,'amu*angstrom^2'), symmetry=1, barrier=(3.04103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0938322,'amu*angstrom^2'), symmetry=1, barrier=(3.04103,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67533,0.0814331,-0.000121351,8.84897e-08,-2.26514e-11,-112276,28.029], Tmin=(100,'K'), Tmax=(619.465,'K')), NASAPolynomial(coeffs=[11.136,0.025435,-1.37192e-05,2.75226e-09,-1.95718e-13,-113794,-19.2168], Tmin=(619.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-934.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CsFFFO) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-1174.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,441.06,3745.17],'cm^-1')),
        HinderedRotor(inertia=(1.75288,'amu*angstrom^2'), symmetry=1, barrier=(40.3021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.835201,'amu*angstrom^2'), symmetry=1, barrier=(19.2029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-873.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,493,600,700,1144,1293,180,180,180,1479.48],'cm^-1')),
        HinderedRotor(inertia=(0.214778,'amu*angstrom^2'), symmetry=1, barrier=(4.93816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218993,'amu*angstrom^2'), symmetry=1, barrier=(5.03508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21383,'amu*angstrom^2'), symmetry=1, barrier=(4.91638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217761,'amu*angstrom^2'), symmetry=1, barrier=(5.00675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
...
"""),
    E0 = (-420.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,184.162,2231.17],'cm^-1')),
        HinderedRotor(inertia=(1.40467,'amu*angstrom^2'), symmetry=1, barrier=(32.4331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34597,'amu*angstrom^2'), symmetry=1, barrier=(32.4314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20568,0.0464899,-5.41492e-05,1.59799e-08,1.38398e-11,-50482.5,18.7027], Tmin=(100,'K'), Tmax=(509.96,'K')), NASAPolynomial(coeffs=[6.85842,0.0209763,-1.14042e-05,2.32609e-09,-1.6756e-13,-51099.9,-2.01081], Tmin=(509.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-952.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,760.096,760.29],'cm^-1')),
        HinderedRotor(inertia=(0.177295,'amu*angstrom^2'), symmetry=1, barrier=(4.07636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177071,'amu*angstrom^2'), symmetry=1, barrier=(4.07121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177221,'amu*angstrom^2'), symmetry=1, barrier=(4.07465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
...
"""),
    E0 = (-1093.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,190,488,555,1236,1407,180,180,180,1634.4,1634.73],'cm^-1')),
        HinderedRotor(inertia=(0.210162,'amu*angstrom^2'), symmetry=1, barrier=(4.83203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21018,'amu*angstrom^2'), symmetry=1, barrier=(4.83246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21063,'amu*angstrom^2'), symmetry=1, barrier=(4.84281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.329236,0.0950043,-0.000180008,1.75161e-07,-6.45713e-11,-131363,32.7722], Tmin=(100,'K'), Tmax=(835.49,'K')), NASAPolynomial(coeffs=[6.14714,0.03662,-2.03749e-05,4.04679e-09,-2.8234e-13,-131270,12.1268], Tmin=(835.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1093.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OC(F)(F)F)[C](F)F(1759)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1113.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,360,370,350,190,488,555,1236,1407,186.275,200.169,1335.44,1338.52],'cm^-1')),
        HinderedRotor(inertia=(0.236011,'amu*angstrom^2'), symmetry=1, barrier=(6.60869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243913,'amu*angstrom^2'), symmetry=1, barrier=(6.64735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237228,'amu*angstrom^2'), symmetry=1, barrier=(6.61207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228296,'amu*angstrom^2'), symmetry=1, barrier=(6.62397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0258608,0.0981986,-0.000176993,1.6049e-07,-5.59409e-11,-133809,33.6904], Tmin=(100,'K'), Tmax=(831.182,'K')), NASAPolynomial(coeffs=[10.6355,0.0279039,-1.54191e-05,3.05225e-09,-2.1255e-13,-134908,-11.536], Tmin=(831.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1113.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC([C]F)OC(F)(F)F-2(1760)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1321.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,431,527,613,668,835,1199,1245,1322,360,370,350,234.198,234.199,234.199,234.199],'cm^-1')),
        HinderedRotor(inertia=(0.00307351,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154426,'amu*angstrom^2'), symmetry=1, barrier=(6.01055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154425,'amu*angstrom^2'), symmetry=1, barrier=(6.01055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228775,'amu*angstrom^2'), symmetry=1, barrier=(8.90436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0576215,0.0940917,-0.000147581,1.20498e-07,-3.91949e-11,-158778,32.0766], Tmin=(100,'K'), Tmax=(753.968,'K')), NASAPolynomial(coeffs=[12.6521,0.0272687,-1.46276e-05,2.9288e-09,-2.08056e-13,-160677,-25.1269], Tmin=(753.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1321.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(Cs_P)"""),
)

species(
    label = '[O]C(OC(F)(F)F)C(F)F(1762)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.264164,0.0921858,-0.00015587,1.43281e-07,-5.19489e-11,-156328,31.4968], Tmin=(100,'K'), Tmax=(795.294,'K')), NASAPolynomial(coeffs=[8.37404,0.0355999,-1.93495e-05,3.86601e-09,-2.72954e-13,-157118,-2.63039], Tmin=(795.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1300.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(CCOJ)"""),
)

species(
    label = 'OC(O[C](F)F)C(F)(F)F(1763)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1316.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,493,600,700,1144,1293,270.88,270.88,270.881,1136.12],'cm^-1')),
        HinderedRotor(inertia=(0.118579,'amu*angstrom^2'), symmetry=1, barrier=(6.17446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118585,'amu*angstrom^2'), symmetry=1, barrier=(6.17446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118582,'amu*angstrom^2'), symmetry=1, barrier=(6.17452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118581,'amu*angstrom^2'), symmetry=1, barrier=(6.17446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.098647,0.0995146,-0.000169488,1.49862e-07,-5.19789e-11,-158187,32.2695], Tmin=(100,'K'), Tmax=(800.363,'K')), NASAPolynomial(coeffs=[11.3558,0.0300481,-1.63949e-05,3.26643e-09,-2.29758e-13,-159629,-17.9958], Tmin=(800.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1316.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    ...
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(18.3464,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F(1753)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'O[CH]OC(F)(F)F(1149)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF3O(47)', 'OC=C(F)F(1125)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(10.0932,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['OH(4)', 'FC(F)=COC(F)(F)F(1754)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC(OC(F)(F)F)=C(F)F(1755)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(O[C](F)F)[C](F)F(1756)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF3O(47)', 'O[CH][C](F)F(1322)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF3(44)', '[O]C(O)[C](F)F(1757)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'F[C](F)[CH]OC(F)(F)F(379)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OC(F)(F)F)[C](F)F(1758)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[C](OC(F)(F)F)[C](F)F(1759)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F-2(1760)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(89)', 'O[CH]OC(F)(F)F(1149)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.56825,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction16',
    reactants = ['O[C](OC(F)(F)F)C(F)F(1761)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(OC(F)(F)F)[C](F)F(1652)'],
    products = ['[O]C(OC(F)(F)F)C(F)F(1762)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OC(O[C](F)F)C(F)(F)F(1763)'],
    products = ['OC(OC(F)(F)F)[C](F)F(1652)'],
...
network(
    label = 'PDepNetwork #707',
    isomers = [
        'OC(OC(F)(F)F)[C](F)F(1652)',
    ],
    reactants = [
