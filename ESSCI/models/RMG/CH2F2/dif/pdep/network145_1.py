...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.365184,'amu*angstrom^2'), symmetry=1, barrier=(8.3963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.36327,'amu*angstrom^2'), symmetry=1, barrier=(8.35229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0170057,'amu*angstrom^2'), symmetry=1, barrier=(46.7529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
...
"""),
    E0 = (-461.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,182,240,577,636,1210,1413,267.414,267.539],'cm^-1')),
        HinderedRotor(inertia=(0.13586,'amu*angstrom^2'), symmetry=1, barrier=(6.89383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00336572,'amu*angstrom^2'), symmetry=1, barrier=(6.89672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786023,'amu*angstrom^2'), symmetry=1, barrier=(40.0315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71596,0.0820031,-0.0001521,1.39486e-07,-4.86898e-11,-55382.5,24.754], Tmin=(100,'K'), Tmax=(843.877,'K')), NASAPolynomial(coeffs=[9.23895,0.0225464,-1.2541e-05,2.47211e-09,-1.71108e-13,-56142.4,-10.8972], Tmin=(843.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-461.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)(F)OF(451)',
...
"""),
    E0 = (-491.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,223,363,546,575,694,1179,1410,1380,1390,370,380,2900,435,180,180,1243.99,1245.02],'cm^-1')),
        HinderedRotor(inertia=(0.238232,'amu*angstrom^2'), symmetry=1, barrier=(5.47743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238569,'amu*angstrom^2'), symmetry=1, barrier=(5.48518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01553,0.0794817,-0.000158594,1.59726e-07,-6.01784e-11,-58974.9,25.9647], Tmin=(100,'K'), Tmax=(836.341,'K')), NASAPolynomial(coeffs=[4.32102,0.0325742,-1.86888e-05,3.74459e-09,-2.62138e-13,-58440.2,17.1106], Tmin=(836.341,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.097,0.0469187,-7.21925e-05,6.68206e-08,-2.50894e-11,-93041.8,20.9999], Tmin=(100,'K'), Tmax=(778.099,'K')), NASAPolynomial(coeffs=[5.01057,0.0239483,-1.25032e-05,2.47827e-09,-1.75052e-13,-93253.3,9.22942], Tmin=(778.099,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sF1sCO))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.269655,'amu*angstrom^2'), symmetry=1, barrier=(6.19989,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924139,0.0900983,-0.000217312,2.20667e-07,-7.88536e-11,-53316.6,21.1445], Tmin=(100,'K'), Tmax=(910.269,'K')), NASAPolynomial(coeffs=[3.56053,0.0220411,-1.2105e-05,2.22233e-09,-1.40816e-13,-51457,21.5245], Tmin=(910.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(428)', 'O=C(O)[C]F(447)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'O=C=C(F)OF(448)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(O)[C](F)OF(452)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)O(453)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(228)', 'O=C(O)[C](F)F(454)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'O=[C]C(F)(F)OF(455)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)OF(456)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)F(240)', 'O=[C]O(164)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(77)', 'O=C(O)C(=O)F(382)'],
    products = ['O=C(O)C(F)(F)OF(330)'],
