...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.159405,'amu*angstrom^2'), symmetry=1, barrier=(3.66504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163633,'amu*angstrom^2'), symmetry=1, barrier=(3.76225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433447,'amu*angstrom^2'), symmetry=1, barrier=(9.96581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06357,0.0726,-0.000125056,1.14155e-07,-4.04614e-11,-61957.4,23.4182], Tmin=(100,'K'), Tmax=(821.601,'K')), NASAPolynomial(coeffs=[7.86644,0.0254209,-1.32534e-05,2.6084e-09,-1.82149e-13,-62600.7,-5.17716], Tmin=(821.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-515.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-337.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,580,1155,1237,1373,3147,180,180,742.145],'cm^-1')),
        HinderedRotor(inertia=(0.222266,'amu*angstrom^2'), symmetry=1, barrier=(5.11034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222854,'amu*angstrom^2'), symmetry=1, barrier=(5.12386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.381373,'amu*angstrom^2'), symmetry=1, barrier=(8.7685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379196,'amu*angstrom^2'), symmetry=1, barrier=(8.71847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65263,'amu*angstrom^2'), symmetry=1, barrier=(15.0052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.891405,0.0794982,-0.000148495,1.40254e-07,-4.99122e-11,-55812.3,23.7568], Tmin=(100,'K'), Tmax=(856.495,'K')), NASAPolynomial(coeffs=[7.03885,0.0267217,-1.39177e-05,2.69634e-09,-1.84934e-13,-55982.6,0.204459], Tmin=(856.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)F(1233)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1998,0.0700797,-0.000121611,1.13904e-07,-4.14156e-11,-62164.7,25.2862], Tmin=(100,'K'), Tmax=(816.802,'K')), NASAPolynomial(coeffs=[6.66951,0.027531,-1.45259e-05,2.87614e-09,-2.01695e-13,-62532.4,3.22363], Tmin=(816.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-517.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(1180)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[CH2]C([O])(F)F(1171)'],
    products = ['[CH2]C(F)(F)O[CH]F(1180)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'F[CH]O[C](F)F(394)'],
    products = ['[CH2]C(F)(F)O[CH]F(1180)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(1231)'],
    products = ['[CH2]C(F)(F)O[CH]F(1180)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(1171)'],
    products = ['[CH2]C(F)(F)O[CH]F(1180)'],
    transitionState = 'TS9',
...
network(
    label = 'PDepNetwork #442',
    isomers = [
        '[CH2]C(F)(F)O[CH]F(1180)',
    ],
    reactants = [
        ('CHFO(46)', 'CH2CF2(56)'),
    ],
