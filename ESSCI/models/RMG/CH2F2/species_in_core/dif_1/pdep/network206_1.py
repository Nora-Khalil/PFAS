...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(463)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'F[C](F)O[C](F)F(361)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    products = ['FC1(F)OC(F)(F)C1(F)F(464)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2O(48)', 'F[C](F)[C](F)F(315)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(78.6584,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)OC(F)=C(F)F(375)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(178)', 'CF2CF2(60)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(5.3039,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(178)', 'F[C](F)[C](F)F(315)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(89)', 'F[C](F)O[C](F)F(361)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(89)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(4.15912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    products = ['F[C](F)O[C](F)C(F)(F)F(589)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(463)'],
    products = ['F[C](F)[C](F)OC(F)(F)F(590)'],
...
network(
    label = 'PDepNetwork #206',
    isomers = [
        'F[C](F)OC(F)(F)[C](F)F(463)',
    ],
    reactants = [
        ('CF2O(48)', 'CF2CF2(60)'),
    ],
