...
"""),
    E0 = (-938.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,375,361,584,565,722,1474,235,523,627,1123,1142,1372,1406,3097,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.350532,'amu*angstrom^2'), symmetry=1, barrier=(8.05943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350694,'amu*angstrom^2'), symmetry=1, barrier=(8.06314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21905,'amu*angstrom^2'), symmetry=1, barrier=(28.0284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
"""),
    E0 = (-955.838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.853191,'amu*angstrom^2'), symmetry=1, barrier=(19.6165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853885,'amu*angstrom^2'), symmetry=1, barrier=(19.6325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852784,'amu*angstrom^2'), symmetry=1, barrier=(19.6072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06965,'amu*angstrom^2'), symmetry=1, barrier=(24.5933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07059,'amu*angstrom^2'), symmetry=1, barrier=(24.6151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07181,'amu*angstrom^2'), symmetry=1, barrier=(24.643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913614,0.0688895,-9.17174e-05,5.75963e-08,-1.39565e-11,-63042.1,20.7944], Tmin=(100,'K'), Tmax=(1016.98,'K')), NASAPolynomial(coeffs=[15.7496,0.0105364,-5.64933e-06,1.1756e-09,-8.68591e-14,-66059.7,-51.0304], Tmin=(1016.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)C(O)(F)F(1137)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-692.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,180,1739.55],'cm^-1')),
        HinderedRotor(inertia=(0.537667,'amu*angstrom^2'), symmetry=1, barrier=(12.362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25211,'amu*angstrom^2'), symmetry=1, barrier=(28.7885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3477,0.0597344,-7.24206e-05,4.32873e-08,-1.01875e-11,-83242.8,23.4369], Tmin=(100,'K'), Tmax=(1036.39,'K')), NASAPolynomial(coeffs=[12.975,0.0148583,-7.47046e-06,1.50776e-09,-1.09438e-13,-85652.9,-33.074], Tmin=(1036.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-692.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01043,'amu*angstrom^2'), symmetry=1, barrier=(23.2317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01274,'amu*angstrom^2'), symmetry=1, barrier=(23.2848,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
...
"""),
    E0 = (-596.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,262,390,483,597,572,732,631,807,1275,1439,419.165],'cm^-1')),
        HinderedRotor(inertia=(1.25663,'amu*angstrom^2'), symmetry=1, barrier=(28.8923,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)OF(1108)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(19.1821,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OF(155)', 'OC(F)(F)[C]F(576)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(88)', 'OC(F)(F)OF(568)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(127.544,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CF2(89)', 'OC(F)OF(1115)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(209.626,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(155)', 'F[C]C(F)OF(1132)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(577)', 'OC(F)=CF(1133)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(579)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(155)', 'FOC=C(F)F(1134)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(1135)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)OF(1136)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(1137)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(156)', 'OC(F)(F)[CH]F(637)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'FOC(F)[C](F)F(1138)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(1139)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(179)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(582)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(108)', 'O=CC(O)(F)F(1140)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(1141)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(558)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(108)', 'OC(F)=COF(1142)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(588)'],
    products = ['OC(F)(F)C(F)OF(1108)'],
