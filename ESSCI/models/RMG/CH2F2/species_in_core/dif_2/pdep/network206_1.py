...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C(OF)[C](F)[C](F)F(541)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]C(=O)[C](F)F(291)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)(F)[C](F)F(542)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    products = ['O=C1OC(F)(F)C1(F)F(536)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    products = ['F[C](F)C(F)(F)[C]1OO1(543)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    products = ['[O][C]1OC(F)(F)C1(F)F(544)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    products = ['[O]C1([O])C(F)(F)C1(F)F(545)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(F)=C(F)F(427)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CO2(13)', 'F[C](F)[C](F)F(230)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(188)', 'F[C](F)[C](F)F(230)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(87)', '[O]C(=O)[C](F)F(291)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(534)'],
    products = ['[O]C(=O)[C](F)C(F)(F)F(546)'],
