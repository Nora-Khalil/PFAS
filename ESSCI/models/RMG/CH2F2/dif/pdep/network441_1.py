...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54634,0.0634972,-0.00011771,1.1327e-07,-4.10323e-11,-39862.8,20.7676], Tmin=(100,'K'), Tmax=(854.72,'K')), NASAPolynomial(coeffs=[5.3171,0.024746,-1.2666e-05,2.44886e-09,-1.68152e-13,-39736.5,7.67737], Tmin=(854.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FC1CC(F)(F)O1(1182)',
...
"""),
    E0 = (-482.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([391,562,707,872,1109,1210,1289,3137,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,762.644],'cm^-1')),
        HinderedRotor(inertia=(0.391501,'amu*angstrom^2'), symmetry=1, barrier=(9.00138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43514,'amu*angstrom^2'), symmetry=1, barrier=(32.9966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63842,0.0497956,-4.44198e-05,1.94024e-08,-3.37792e-12,-57927.1,23.2144], Tmin=(100,'K'), Tmax=(1365.65,'K')), NASAPolynomial(coeffs=[12.9987,0.0165213,-7.87204e-06,1.56099e-09,-1.11824e-13,-61029.9,-35.1325], Tmin=(1365.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = 'O[C](F)C[C](F)F(1239)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65935,0.0545163,-5.62749e-05,2.94655e-08,-6.27621e-12,-63585.1,22.984], Tmin=(100,'K'), Tmax=(1115.33,'K')), NASAPolynomial(coeffs=[11.1259,0.0205657,-1.06151e-05,2.17335e-09,-1.5873e-13,-65696.7,-23.72], Tmin=(1115.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(O2s-H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)CC(F)F(1240)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56337,0.0513105,-4.69917e-05,2.11116e-08,-3.77195e-12,-60446.3,22.8653], Tmin=(100,'K'), Tmax=(1336.48,'K')), NASAPolynomial(coeffs=[13.2462,0.0163447,-7.74787e-06,1.53587e-09,-1.10157e-13,-63569.1,-36.886], Tmin=(1336.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-503.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)[CH][C](F)F(1241)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74415,0.0528924,-5.33556e-05,2.73596e-08,-5.73663e-12,-61066.2,23.2978], Tmin=(100,'K'), Tmax=(1127.34,'K')), NASAPolynomial(coeffs=[10.7473,0.0209475,-1.08506e-05,2.22357e-09,-1.62405e-13,-63096.1,-21.2162], Tmin=(1127.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FO[CH]C[C](F)F(1242)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-194.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,190,488,555,1236,1407,319.135,319.142,319.148],'cm^-1')),
        HinderedRotor(inertia=(0.117277,'amu*angstrom^2'), symmetry=1, barrier=(8.47659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117292,'amu*angstrom^2'), symmetry=1, barrier=(8.47631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286036,'amu*angstrom^2'), symmetry=1, barrier=(20.6726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717562,0.0798818,-0.000137681,1.22302e-07,-4.23742e-11,-23258.8,24.5167], Tmin=(100,'K'), Tmax=(806.447,'K')), NASAPolynomial(coeffs=[10.0116,0.0231751,-1.24752e-05,2.48683e-09,-1.74946e-13,-24412.9,-16.1837], Tmin=(806.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]CC(F)(F)F(1243)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06253,0.0714421,-0.000105407,7.52424e-08,-1.83778e-11,-64100.9,20.2839], Tmin=(100,'K'), Tmax=(631.214,'K')), NASAPolynomial(coeffs=[10.7894,0.0206265,-1.03724e-05,2.03578e-09,-1.43007e-13,-65544.5,-23.8754], Tmin=(631.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-533.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]C([O])F(1234)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(1235)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(791)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC[C](F)F(1237)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(1129)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', '[CH2]C([O])F(1234)'],
    products = ['[O]C(F)C[C](F)F(1179)'],
