...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08326,'amu*angstrom^2'), symmetry=1, barrier=(24.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08295,'amu*angstrom^2'), symmetry=1, barrier=(24.8992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0834,'amu*angstrom^2'), symmetry=1, barrier=(24.9094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-600.455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,261,493,600,1152,1365,1422,3097,617,898,1187,308.499,308.771,311,312.046,313.226],'cm^-1')),
        HinderedRotor(inertia=(0.306786,'amu*angstrom^2'), symmetry=1, barrier=(21.2383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117192,'amu*angstrom^2'), symmetry=1, barrier=(7.90839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552203,'amu*angstrom^2'), symmetry=1, barrier=(37.0381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598121,0.0811908,-0.000119233,8.81538e-08,-2.58837e-11,-72101.2,25.7867], Tmin=(100,'K'), Tmax=(833.016,'K')), NASAPolynomial(coeffs=[12.9761,0.0217566,-1.22156e-05,2.5105e-09,-1.81964e-13,-74163.5,-31.6687], Tmin=(833.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-969.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,411.061,411.148],'cm^-1')),
        HinderedRotor(inertia=(0.068128,'amu*angstrom^2'), symmetry=1, barrier=(8.16696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31187,'amu*angstrom^2'), symmetry=1, barrier=(37.4602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-951.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,235,523,627,1123,1142,1372,1406,3097,528,1116,1182,1331,1402,1494,3075,3110,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.23603,'amu*angstrom^2'), symmetry=1, barrier=(28.4188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23822,'amu*angstrom^2'), symmetry=1, barrier=(28.4692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23864,'amu*angstrom^2'), symmetry=1, barrier=(28.4788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.24376,'amu*angstrom^2'), symmetry=1, barrier=(28.5966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303016,'amu*angstrom^2'), symmetry=1, barrier=(6.96693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14688,'amu*angstrom^2'), symmetry=1, barrier=(49.3611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689208,0.0823059,-0.000140525,1.30853e-07,-4.77925e-11,-66398.6,24.6232], Tmin=(100,'K'), Tmax=(802.699,'K')), NASAPolynomial(coeffs=[7.3251,0.0329155,-1.77277e-05,3.53375e-09,-2.49069e-13,-66938,-2.65728], Tmin=(802.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-552.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s))"""),
)
...
"""),
    E0 = (-755.708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,334,575,1197,1424,3202,180,180,2009.36],'cm^-1')),
        HinderedRotor(inertia=(0.204536,'amu*angstrom^2'), symmetry=1, barrier=(4.70268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36447,'amu*angstrom^2'), symmetry=1, barrier=(31.3719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36501,'amu*angstrom^2'), symmetry=1, barrier=(31.3842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(253)', 'F[C]CF-2(186)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(153)', 'F[C]C(F)(F)CF(1141)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(86)', 'FCC(F)(F)OF(1139)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(7)', 'F[C]C(F)(F)C(F)OF(2195)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(72)', 'FOC(F)C(F)(F)F(2196)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(716)', 'FC=C(F)CF(2198)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FC[C](F)C(F)OF(2199)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FCC(F)(F)[CH]OF(2200)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)OF(2201)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)C(F)(F)CF(2202)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(154)', 'F[CH]C(F)(F)CF(2203)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(177)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(89)', 'FOC(F)[C](F)F(1230)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)(F)[C](F)OF(1147)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)OF(2204)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', 'O=CC(F)(F)CF(1944)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(106)', 'FCC(F)=COF(2205)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(106)', 'C=C(F)C(F)OF(2206)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(698)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FCC(F)=C(F)OF(1152)'],
    products = ['FCC(F)(F)C(F)OF(2187)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FCC(F)(F)C(F)OF(2187)'],
    products = ['F2(106)', 'CHFO(46)', 'CH2CF2(56)'],
