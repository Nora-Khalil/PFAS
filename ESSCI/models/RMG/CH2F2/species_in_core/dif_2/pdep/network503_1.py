...
reaction(
    label = 'reaction3',
    reactants = ['CF2(87)', 'FOCC(F)F(1251)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(716)', 'F[C]CC(F)F(1252)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)(F)OF(1253)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(153)', 'FC(F)=CC(F)F(809)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[C](F)CC(F)F(1254)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)(F)OF(1255)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)CC(F)F(1256)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'F[C](F)CC(F)F(815)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(192)', 'CHF2-CH2(63)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(81)', '[CH2]C(F)(F)OF(1257)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)(F)[CH]C(F)F(1159)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)(F)C[C](F)F(1258)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(106)', 'O=C(F)CC(F)F(910)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FC=CC(F)(F)OF(1167)'],
    products = ['FOC(F)(F)CC(F)F(1199)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FOC(F)(F)CC(F)F(1199)'],
    products = ['F2(106)', 'CF2O(48)', 'CH2CHF(94)'],
