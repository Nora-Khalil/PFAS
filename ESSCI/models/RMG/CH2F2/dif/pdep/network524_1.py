...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.407931,'amu*angstrom^2'), symmetry=1, barrier=(9.37915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470515,'amu*angstrom^2'), symmetry=1, barrier=(10.8181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29364,'amu*angstrom^2'), symmetry=1, barrier=(29.7433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0264147,'amu*angstrom^2'), symmetry=1, barrier=(3.87771,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (46.0436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.50524,0.00692166,1.56039e-05,-2.26107e-08,8.49062e-12,9752.45,9.13909], Tmin=(100,'K'), Tmax=(981.313,'K')), NASAPolynomial(coeffs=[5.27395,0.0095814,-3.54753e-06,6.4881e-10,-4.59763e-14,8930.12,-1.78177], Tmin=(981.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.9091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.5398,'amu*angstrom^2'), symmetry=1, barrier=(12.4111,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.972199,'amu*angstrom^2'), symmetry=1, barrier=(22.3528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.976976,'amu*angstrom^2'), symmetry=1, barrier=(22.4626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9755,'amu*angstrom^2'), symmetry=1, barrier=(22.4287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
...
"""),
    E0 = (-382.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.258277,'amu*angstrom^2'), symmetry=1, barrier=(5.93829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703067,'amu*angstrom^2'), symmetry=1, barrier=(16.1649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258818,'amu*angstrom^2'), symmetry=1, barrier=(5.95074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03065,0.0753595,-0.000131203,1.25141e-07,-4.60501e-11,-45869.1,23.0683], Tmin=(100,'K'), Tmax=(827.907,'K')), NASAPolynomial(coeffs=[5.55944,0.0329498,-1.7171e-05,3.36673e-09,-2.34503e-13,-45915.4,6.32377], Tmin=(827.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s))"""),
)

species(
    label = 'CC(F)(F)[CH]OF(1449)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-408.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,205.665,205.68],'cm^-1')),
        HinderedRotor(inertia=(0.00398396,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502802,'amu*angstrom^2'), symmetry=1, barrier=(15.0975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503025,'amu*angstrom^2'), symmetry=1, barrier=(15.0977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07254,0.06931,-9.07284e-05,6.2569e-08,-1.73961e-11,-48980.1,21.9035], Tmin=(100,'K'), Tmax=(873.645,'K')), NASAPolynomial(coeffs=[11.1073,0.0233654,-1.1844e-05,2.37327e-09,-1.70586e-13,-50733.5,-25.153], Tmin=(873.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'CC(F)(F)C([O])F(1450)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-715.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2800,2850,1350,1500,750,1050,1375,1000,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(0.62142,'amu*angstrom^2'), symmetry=1, barrier=(14.2877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.62146,'amu*angstrom^2'), symmetry=1, barrier=(14.2886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74942,0.0173642,0.000182018,-5.1041e-07,4.03267e-10,-86028.5,12.1194], Tmin=(10,'K'), Tmax=(453.258,'K')), NASAPolynomial(coeffs=[6.6604,0.035741,-2.46299e-05,8.0278e-09,-9.90408e-13,-86745,-4.61431], Tmin=(453.258,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-715.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CC(F)(F)C([O])F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-541.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,180],'cm^-1')),
        HinderedRotor(inertia=(0.151255,'amu*angstrom^2'), symmetry=1, barrier=(3.47765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151185,'amu*angstrom^2'), symmetry=1, barrier=(3.47604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.81373,0.0226014,0.000260072,-1.82454e-06,3.73586e-09,-65079.3,10.8102], Tmin=(10,'K'), Tmax=(171.892,'K')), NASAPolynomial(coeffs=[4.29853,0.0331183,-2.19264e-05,6.93031e-09,-8.35502e-13,-65128.2,8.38823], Tmin=(171.892,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-541.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CC(F)(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.442879,'amu*angstrom^2'), symmetry=1, barrier=(10.1827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442645,'amu*angstrom^2'), symmetry=1, barrier=(10.1773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442713,'amu*angstrom^2'), symmetry=1, barrier=(10.1788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.365607,0.0914162,-0.000166145,1.54612e-07,-5.49424e-11,-72628.4,24.155], Tmin=(100,'K'), Tmax=(840.305,'K')), NASAPolynomial(coeffs=[8.36129,0.0304016,-1.62562e-05,3.18865e-09,-2.20964e-13,-73161.8,-8.20632], Tmin=(840.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-604.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)C(F)OF(1053)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-584.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,180,284.832],'cm^-1')),
        HinderedRotor(inertia=(0.585578,'amu*angstrom^2'), symmetry=1, barrier=(13.4636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68498,'amu*angstrom^2'), symmetry=1, barrier=(38.741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107681,'amu*angstrom^2'), symmetry=1, barrier=(2.4758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0691408,'amu*angstrom^2'), symmetry=1, barrier=(1.58968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717505,'amu*angstrom^2'), symmetry=1, barrier=(16.4969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292913,'amu*angstrom^2'), symmetry=1, barrier=(6.73464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292896,'amu*angstrom^2'), symmetry=1, barrier=(6.73426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.653727,'amu*angstrom^2'), symmetry=1, barrier=(15.0305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53913,'amu*angstrom^2'), symmetry=1, barrier=(35.3875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)OF(1442)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(46.6761,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'CC(F)OF(1445)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(339.451,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]C(F)OF(564)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(172.052,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(243)', 'C[C]F(1325)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(184.357,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'CC(F)(F)[C]F(1326)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(43.8915,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(F)(F)OF(1324)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(133.545,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(428)', 'CC(F)=CF(1447)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(1448)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(228)', 'CC(F)(F)[CH]F(1451)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(295)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(18)', 'FOC(F)[C](F)F(570)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(1330)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(1053)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', 'CC(F)(F)C=O(1452)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(71.5776,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'CC(F)=COF(1453)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(5.69668,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(1245)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(475.811,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(F)=C(F)OF(1333)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(190.736,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)C(F)OF(1059)'],
    products = ['CC(F)(F)C(F)OF(1442)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(10.477,'m^3/(mol*s)'), n=1.29062, Ea=(172.938,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R"""),
)
