...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9016,0.033501,1.98518e-06,-3.35547e-08,1.64915e-11,-4786.75,19.1964], Tmin=(100,'K'), Tmax=(984.418,'K')), NASAPolynomial(coeffs=[15.906,0.00660518,-2.75781e-06,6.2341e-10,-5.23707e-14,-8998.02,-55.5322], Tmin=(984.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.5215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsCt) + group(Cds-OdOsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (252.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06771,0.0246134,3.54633e-05,-8.58132e-08,4.2049e-11,30464.1,17.397], Tmin=(100,'K'), Tmax=(881.118,'K')), NASAPolynomial(coeffs=[20.4713,-0.00937348,8.95224e-06,-1.91913e-09,1.33681e-13,25297.1,-79.9776], Tmin=(881.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(124trioxene) + radical(OCJO) + radical(C=CJO)"""),
)
...
"""),
    E0 = (561.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2175,525,219.61,219.659],'cm^-1')),
        HinderedRotor(inertia=(1.31683,'amu*angstrom^2'), symmetry=1, barrier=(45.0855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31631,'amu*angstrom^2'), symmetry=1, barrier=(45.0856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31674,'amu*angstrom^2'), symmetry=1, barrier=(45.0856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83362,0.0499422,-5.98971e-05,3.68183e-08,-9.08296e-12,67654.4,20.0384], Tmin=(100,'K'), Tmax=(981.757,'K')), NASAPolynomial(coeffs=[10.1674,0.01599,-8.02571e-06,1.59708e-09,-1.14596e-13,66017.9,-20.0142], Tmin=(981.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(561.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsCt) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(OCOJ) + radical(Acetyl)"""),
)

species(
    label = '[C]#COO[CH]O(3676)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {4,S}
2 O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (523.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3025,407.5,1350,352.5,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(2.37447,'amu*angstrom^2'), symmetry=1, barrier=(54.5937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84612,'amu*angstrom^2'), symmetry=1, barrier=(19.454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.37604,'amu*angstrom^2'), symmetry=1, barrier=(54.6298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.846145,'amu*angstrom^2'), symmetry=1, barrier=(19.4545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.990108,0.072131,-0.000127293,1.07316e-07,-3.41772e-11,63058,22.3717], Tmin=(100,'K'), Tmax=(895.387,'K')), NASAPolynomial(coeffs=[11.4823,0.0124931,-5.99873e-06,1.08245e-09,-6.99721e-14,61690.8,-24.23], Tmin=(895.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(523.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsCt) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(OCJO) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.91185,'amu*angstrom^2'), symmetry=1, barrier=(43.9572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91184,'amu*angstrom^2'), symmetry=1, barrier=(43.957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91143,'amu*angstrom^2'), symmetry=1, barrier=(43.9476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0381,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93364,0.0369442,-2.02846e-05,-6.99063e-09,6.79919e-12,35757.4,19.8232], Tmin=(100,'K'), Tmax=(987.734,'K')), NASAPolynomial(coeffs=[14.2335,0.0061775,-2.48157e-06,5.12927e-10,-4.04997e-14,32398.6,-44.0672], Tmin=(987.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsCt) + group(Cds-OdOsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.70732,'amu*angstrom^2'), symmetry=1, barrier=(39.2546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70796,'amu*angstrom^2'), symmetry=1, barrier=(39.2693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70841,'amu*angstrom^2'), symmetry=1, barrier=(39.2797,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03709,0.0416617,-3.74856e-05,1.60753e-08,-2.74645e-12,13772.9,19.6516], Tmin=(100,'K'), Tmax=(1386.24,'K')), NASAPolynomial(coeffs=[11.8054,0.0134754,-6.98621e-06,1.40759e-09,-1.01226e-13,11064.7,-30.6649], Tmin=(1386.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-Cd)) + group(Cds-OdOsH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC=O(3281)'],
    products = ['CO2(13)', 'CH2CO(75)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(13.4343,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'C#COO(2906)'],
    products = ['C#COOC=O(3281)'],
    transitionState = 'TS2',
