...
"""),
    E0 = (-79.3926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,580,1155,1237,1373,3147,3120,650,792.5,1650,185.336,185.367,185.403],'cm^-1')),
        HinderedRotor(inertia=(0.304089,'amu*angstrom^2'), symmetry=1, barrier=(7.34137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.68794,'amu*angstrom^2'), symmetry=1, barrier=(16.9154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42669,0.0621996,-0.000107451,9.37131e-08,-3.16479e-11,-9461.44,19.4821], Tmin=(100,'K'), Tmax=(822.643,'K')), NASAPolynomial(coeffs=[9.3705,0.0156741,-8.21289e-06,1.61763e-09,-1.1277e-13,-10501.1,-15.6666], Tmin=(822.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.739302,'amu*angstrom^2'), symmetry=1, barrier=(16.998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371785,'amu*angstrom^2'), symmetry=1, barrier=(39.0043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-57.3584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([580,1155,1237,1373,3147,615,860,1140,1343,3152,1685,370,180,180,180,1419.74],'cm^-1')),
        HinderedRotor(inertia=(0.226277,'amu*angstrom^2'), symmetry=1, barrier=(5.20256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230294,'amu*angstrom^2'), symmetry=1, barrier=(5.29491,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]C(=O)F-2(1085)'],
    products = ['[CH]=C(F)O[CH]F(1610)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=C(F)O[CH]F(1610)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.8644,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(86)', '[CH]C(=O)F-2(1085)'],
    products = ['[CH]=C(F)O[CH]F(1610)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(10.269,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)O[CH]F(1610)'],
    products = ['[CH]=[C]OC(F)F(1618)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(223.593,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F[CH]O[C]=CF(1614)'],
    products = ['[CH]=C(F)O[CH]F(1610)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(143.841,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)
