...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(714)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'OC(F)[C]F(1213)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(153)', 'FC=C(F)OF(1216)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(153)', 'OC(F)=C(F)F(719)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(716)', 'OC=C(F)F(1217)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(1218)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)[C](F)OF(1219)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(1220)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'F[CH]C(F)(F)OF(1162)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(1221)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(154)', 'OC(F)[C](F)F(550)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(192)', 'O[CH]F(163)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(720)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(1222)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(106)', 'O=C(F)C(O)F(675)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', 'OC=C(F)OF(1223)'],
    products = ['OC(F)C(F)(F)OF(1194)'],
