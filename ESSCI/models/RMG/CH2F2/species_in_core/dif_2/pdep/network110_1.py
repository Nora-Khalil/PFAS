...
reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'F[C]C(F)F(180)'],
    products = ['[O]OC(F)C(F)F(318)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]O[CH]C(F)F(897)'],
    products = ['[O]OC(F)C(F)F(318)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)[CH]F(1303)'],
    products = ['[O]OC(F)C(F)F(318)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[O]O[CH]F(159)'],
    products = ['[O]OC(F)C(F)F(318)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(379)'],
    products = ['[O]OC(F)C(F)F(318)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(231)'],
    products = ['[O]OC(F)C(F)F(318)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]OC=C(F)F(266)'],
    products = ['[O]OC(F)C(F)F(318)'],
