...
reaction(
    ...
    products = ['C2HF(57)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(134.994,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)
