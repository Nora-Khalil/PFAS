...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.311895,'amu*angstrom^2'), symmetry=1, barrier=(7.17108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312316,'amu*angstrom^2'), symmetry=1, barrier=(7.18075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312012,'amu*angstrom^2'), symmetry=1, barrier=(7.17378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0758442,0.0993622,-0.000186543,1.72852e-07,-6.03122e-11,-82520.5,29.3552], Tmin=(100,'K'), Tmax=(863.51,'K')), NASAPolynomial(coeffs=[9.20176,0.0289532,-1.53619e-05,2.95994e-09,-2.01524e-13,-83047.6,-7.25909], Tmin=(863.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.327914,'amu*angstrom^2'), symmetry=1, barrier=(7.53938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328,'amu*angstrom^2'), symmetry=1, barrier=(7.54136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.217825,0.0923959,-0.000160005,1.41552e-07,-4.83074e-11,-80961.2,27.6983], Tmin=(100,'K'), Tmax=(841.309,'K')), NASAPolynomial(coeffs=[10.5834,0.0267778,-1.38878e-05,2.68683e-09,-1.84859e-13,-82127.2,-17.0825], Tmin=(841.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.44885,'amu*angstrom^2'), symmetry=1, barrier=(10.3199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.449014,'amu*angstrom^2'), symmetry=1, barrier=(10.3237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615377,0.0820822,-0.000139441,1.22647e-07,-4.21876e-11,-83986.1,26.946], Tmin=(100,'K'), Tmax=(810.833,'K')), NASAPolynomial(coeffs=[10.1465,0.0244249,-1.30977e-05,2.5869e-09,-1.80898e-13,-85182.1,-14.8812], Tmin=(810.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.892778,'amu*angstrom^2'), symmetry=1, barrier=(20.5267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.895135,'amu*angstrom^2'), symmetry=1, barrier=(20.5809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.68677,0.0825118,-0.000151771,1.40733e-07,-5.03203e-11,-44240.5,25.5911], Tmin=(100,'K'), Tmax=(812.967,'K')), NASAPolynomial(coeffs=[9.06933,0.0246516,-1.43556e-05,2.90574e-09,-2.05235e-13,-45054.4,-9.73712], Tmin=(812.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-F1sCd)(F1s)(F1s)) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.852191,'amu*angstrom^2'), symmetry=1, barrier=(19.5936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.849488,'amu*angstrom^2'), symmetry=1, barrier=(19.5314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498887,0.078051,-9.73919e-05,5.94921e-08,-1.42127e-11,-82343.9,27.4143], Tmin=(100,'K'), Tmax=(1025.62,'K')), NASAPolynomial(coeffs=[16.092,0.0172372,-8.4511e-06,1.68008e-09,-1.2093e-13,-85542.5,-48.2083], Tmin=(1025.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-685.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]C(F)(F)C(F)F(4326)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353168,0.0864506,-0.000138846,1.15384e-07,-3.75925e-11,-86750.7,27.55], Tmin=(100,'K'), Tmax=(823.563,'K')), NASAPolynomial(coeffs=[11.8933,0.0234999,-1.16216e-05,2.22228e-09,-1.52716e-13,-88417.4,-24.4635], Tmin=(823.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[C](F)C(F)(F)F(4327)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386758,0.0911167,-0.000166496,1.54124e-07,-5.41138e-11,-86287.5,29.6208], Tmin=(100,'K'), Tmax=(856.343,'K')), NASAPolynomial(coeffs=[8.33785,0.029407,-1.53657e-05,2.9633e-09,-2.02668e-13,-86748.4,-2.24544], Tmin=(856.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C(F)C[C](F)[C](F)F(4328)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437233,0.0939103,-0.000182809,1.7933e-07,-6.56644e-11,-83112.8,30.7491], Tmin=(100,'K'), Tmax=(855.5,'K')), NASAPolynomial(coeffs=[5.23392,0.03614,-1.9548e-05,3.81507e-09,-2.62425e-13,-82640.1,15.9154], Tmin=(855.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COCsFO) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['CF2CF2(60)', 'CH2CO(75)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)(F)[C](F)F(4299)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=[C]C[C](F)F(883)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(222)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['O=C1CC(F)(F)C1(F)F(4321)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['O=C=CC(F)(F)C(F)F(4322)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(12)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]CC(F)=C(F)F(3420)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2CF2(60)', '[CH2][C]=O(2901)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(230)', 'CH2CO(75)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=CC(F)(F)[C](F)F(4323)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)[C](F)F(230)', '[CH2][C]=O(2901)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C]C=C(F)[C](F)F(4324)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', 'O=[C]C[C](F)F(883)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=CC(F)(F)[C](F)F(4325)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['O=[C][CH]C(F)(F)C(F)F(4326)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['O=[C]C[C](F)C(F)(F)F(4327)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4301)'],
    products = ['O=C(F)C[C](F)[C](F)F(4328)'],
