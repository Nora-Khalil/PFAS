...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.445563,'amu*angstrom^2'), symmetry=1, barrier=(10.2444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812028,'amu*angstrom^2'), symmetry=1, barrier=(18.6701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.471,0.0629443,-0.000113272,1.04556e-07,-3.71535e-11,-50681,22.2496], Tmin=(100,'K'), Tmax=(822.797,'K')), NASAPolynomial(coeffs=[7.63469,0.0198595,-1.08076e-05,2.15421e-09,-1.51095e-13,-51251.2,-3.58565], Tmin=(822.797,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCOH)(F1s)(F1s)) + radical(COj(Cs-F1sCsH)(O2d))"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24276,0.0439277,-4.27198e-05,2.3502e-08,-5.73017e-12,-64490.8,22.1246], Tmin=(100,'K'), Tmax=(937.555,'K')), NASAPolynomial(coeffs=[6.51455,0.0257024,-1.35609e-05,2.7679e-09,-2.0139e-13,-65291.8,1.79108], Tmin=(937.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-536.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCFFO) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCOJ) + radical(Cs_P) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-690.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,234,347,1316,1464,190,488,555,1236,1407,419.747,419.747,419.748,419.748,419.748,2545.09],'cm^-1')),
        HinderedRotor(inertia=(0.277498,'amu*angstrom^2'), symmetry=1, barrier=(34.6947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.395704,'amu*angstrom^2'), symmetry=1, barrier=(49.4737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.395706,'amu*angstrom^2'), symmetry=1, barrier=(49.4738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25409,0.0651168,-9.09785e-05,6.58995e-08,-1.91189e-11,-82971.4,24.7015], Tmin=(100,'K'), Tmax=(840.663,'K')), NASAPolynomial(coeffs=[10.7284,0.0200382,-1.05469e-05,2.11734e-09,-1.51719e-13,-84564.4,-19.3624], Tmin=(840.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-690.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs) + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-578.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([288,410,724,839,1320,182,240,577,636,1210,1413,180,180,180,1788.63,1788.75,1788.76],'cm^-1')),
        HinderedRotor(inertia=(0.00155293,'amu*angstrom^2'), symmetry=1, barrier=(3.52575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76258,0.0607974,-0.000120083,1.23604e-07,-4.73162e-11,-69563,22.2719], Tmin=(100,'K'), Tmax=(842.016,'K')), NASAPolynomial(coeffs=[2.60799,0.0296727,-1.63438e-05,3.23298e-09,-2.24954e-13,-68744.3,24.0451], Tmin=(842.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36207,0.0602951,-7.47829e-05,4.61586e-08,-1.12748e-11,-86446.6,21.4787], Tmin=(100,'K'), Tmax=(997.417,'K')), NASAPolynomial(coeffs=[12.4025,0.0160191,-8.19711e-06,1.65317e-09,-1.19654e-13,-88649,-31.7565], Tmin=(997.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-719.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(166)', '[O]C([O])=CF(380)'],
    products = ['[O]C(=O)C(F)[C](F)F(687)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)[C](F)F(747)'],
    products = ['[O]C(=O)C(F)[C](F)F(687)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C=C(F)F(752)'],
    products = ['[O]C(=O)C(F)[C](F)F(687)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)C(F)=C(F)F(753)'],
    products = ['[O]C(=O)C(F)[C](F)F(687)'],
