...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.36836,'amu*angstrom^2'), symmetry=1, barrier=(8.46932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0722,'amu*angstrom^2'), symmetry=1, barrier=(24.6521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368735,'amu*angstrom^2'), symmetry=1, barrier=(8.47794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.535563,'amu*angstrom^2'), symmetry=1, barrier=(12.3136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.730597,'amu*angstrom^2'), symmetry=1, barrier=(16.7979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534138,'amu*angstrom^2'), symmetry=1, barrier=(12.2809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (152.02,'amu'),
...
"""),
    ...
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24998,0.0653559,-9.69481e-05,7.38857e-08,-2.23709e-11,-128882,21.2313], Tmin=(100,'K'), Tmax=(809.066,'K')), NASAPolynomial(coeffs=[10.7752,0.0182623,-9.63496e-06,1.93836e-09,-1.38754e-13,-130423,-22.704], Tmin=(809.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1072.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)(F)OF(421)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(173)', 'F[C]C(F)(F)OF(505)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(428)', 'OC(F)(F)[C]F(506)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(173)', 'FOC(F)=C(F)F(508)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(428)', 'OC(F)=C(F)F(509)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)C(F)(F)OF(510)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)[C](F)OF(511)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)F(512)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'FOC(F)(F)[C](F)F(513)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)OF(514)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(228)', 'OC(F)(F)[C](F)F(515)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)F(240)', 'O[C](F)F(239)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)OF(516)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'O=C(F)C(O)(F)F(403)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', 'OC(F)=C(F)OF(517)'],
    products = ['OC(F)(F)C(F)(F)OF(342)'],
