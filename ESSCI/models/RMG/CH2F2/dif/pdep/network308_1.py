...
"""),
    E0 = (-103.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,262,1290,180,180,180,1005,1005.05,1005.17],'cm^-1')),
        HinderedRotor(inertia=(0.163726,'amu*angstrom^2'), symmetry=1, barrier=(52.9758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.30406,'amu*angstrom^2'), symmetry=1, barrier=(52.9749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44534,0.0378912,-5.06823e-05,3.6121e-08,-1.05858e-11,-12411.6,16.0814], Tmin=(100,'K'), Tmax=(822.598,'K')), NASAPolynomial(coeffs=[7.23663,0.0145939,-8.20181e-06,1.69455e-09,-1.23553e-13,-13199.8,-6.09835], Tmin=(822.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-OdCsOs) + group(CJ2_singlet-FCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.82325,'amu*angstrom^2'), symmetry=1, barrier=(41.9201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81578,'amu*angstrom^2'), symmetry=1, barrier=(41.7483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81449,'amu*angstrom^2'), symmetry=1, barrier=(41.7188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86591,0.0755631,-0.000119936,9.97803e-08,-3.33297e-11,-67022.4,25.3449], Tmin=(100,'K'), Tmax=(732.233,'K')), NASAPolynomial(coeffs=[10.3963,0.0235082,-1.33142e-05,2.71893e-09,-1.95349e-13,-68418.3,-17.6646], Tmin=(732.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-679.534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,195,270,1147,1130,1359,1388,1409,3075,180,180,786.855,787.117,787.479,788.496],'cm^-1')),
        HinderedRotor(inertia=(1.1147,'amu*angstrom^2'), symmetry=1, barrier=(50.8708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.21325,'amu*angstrom^2'), symmetry=1, barrier=(50.887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26466,0.042206,-4.18261e-05,2.17405e-08,-4.77465e-12,-81670,18.1595], Tmin=(100,'K'), Tmax=(1058.13,'K')), NASAPolynomial(coeffs=[8.0483,0.0203424,-1.08322e-05,2.21307e-09,-1.60966e-13,-82893.9,-10.07], Tmin=(1058.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-874.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,230,274,587,678,790,1206,1241,1314,262.956,262.957,262.957,262.958,1533.44,1533.44],'cm^-1')),
        HinderedRotor(inertia=(0.121061,'amu*angstrom^2'), symmetry=1, barrier=(5.94017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.917663,'amu*angstrom^2'), symmetry=1, barrier=(45.0282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-391.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,212,931,1104,1251,1325,1474,3102,3155,323,467,575,827,1418,350,440,435,1725,180,180,1307.22],'cm^-1')),
        HinderedRotor(inertia=(0.174111,'amu*angstrom^2'), symmetry=1, barrier=(4.00315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174863,'amu*angstrom^2'), symmetry=1, barrier=(4.02045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174522,'amu*angstrom^2'), symmetry=1, barrier=(4.0126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.324699,0.0982472,-0.000196026,1.95558e-07,-7.2457e-11,-46919.9,27.6293], Tmin=(100,'K'), Tmax=(853.466,'K')), NASAPolynomial(coeffs=[4.39909,0.0390629,-2.155e-05,4.23406e-09,-2.92246e-13,-46155.3,17.1719], Tmin=(853.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'FCOC(OF)=C(F)F(820)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-719.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,182,240,577,636,1210,1413,231.293,231.322,231.35,1001.01],'cm^-1')),
        HinderedRotor(inertia=(0.00315001,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221212,'amu*angstrom^2'), symmetry=1, barrier=(8.40169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07495,'amu*angstrom^2'), symmetry=1, barrier=(40.8112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353968,0.0889665,-0.00015097,1.348e-07,-4.72122e-11,-86356.3,26.3344], Tmin=(100,'K'), Tmax=(805.623,'K')), NASAPolynomial(coeffs=[9.82193,0.0291378,-1.57055e-05,3.11451e-09,-2.18532e-13,-87465.8,-14.7147], Tmin=(805.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-719.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C(OF)C(F)(F)[CH]F(821)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.205767,'amu*angstrom^2'), symmetry=1, barrier=(4.73099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205516,'amu*angstrom^2'), symmetry=1, barrier=(4.72521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205827,'amu*angstrom^2'), symmetry=1, barrier=(4.73237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0226007,0.103349,-0.000201688,1.95115e-07,-7.08238e-11,-64135.6,30.7219], Tmin=(100,'K'), Tmax=(848.385,'K')), NASAPolynomial(coeffs=[7.13847,0.0351037,-1.96827e-05,3.89041e-09,-2.69474e-13,-64094.4,4.92064], Tmin=(848.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'O[C](OF)C(F)(F)[CH]F(822)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.12075,'amu*angstrom^2'), symmetry=1, barrier=(2.77627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121922,'amu*angstrom^2'), symmetry=1, barrier=(2.80323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122275,'amu*angstrom^2'), symmetry=1, barrier=(2.81135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670076,'amu*angstrom^2'), symmetry=1, barrier=(15.4064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.285667,0.106606,-0.000198921,1.8081e-07,-6.23707e-11,-66581.7,31.6573], Tmin=(100,'K'), Tmax=(849.693,'K')), NASAPolynomial(coeffs=[11.6384,0.0263668,-1.47146e-05,2.89285e-09,-1.99429e-13,-67737.8,-18.8065], Tmin=(849.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-519.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,249,341,381,651,928,1217,1251,3000,3100,440,815,1455,1000,269.808,269.819,269.827,269.83,269.839,2238.16],'cm^-1')),
        HinderedRotor(inertia=(0.713343,'amu*angstrom^2'), symmetry=1, barrier=(36.855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713245,'amu*angstrom^2'), symmetry=1, barrier=(36.8549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0190887,'amu*angstrom^2'), symmetry=1, barrier=(36.8548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02975,0.0718289,-0.00010497,8.36396e-08,-2.72363e-11,-62404.8,23.747], Tmin=(100,'K'), Tmax=(746.179,'K')), NASAPolynomial(coeffs=[9.40705,0.0269219,-1.46978e-05,2.98782e-09,-2.15119e-13,-63655,-14.216], Tmin=(746.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    E0 = (-459.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,179,346,818,1406,1524,319.153,319.293,319.465,319.576,319.692,1683.18],'cm^-1')),
        HinderedRotor(inertia=(0.122361,'amu*angstrom^2'), symmetry=1, barrier=(8.86459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.655107,'amu*angstrom^2'), symmetry=1, barrier=(47.4286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-316.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,288,410,724,839,1320,2950,3100,1380,975,1025,1650,322.437,323.125,324.408,324.617,2162.19,2162.45],'cm^-1')),
        HinderedRotor(inertia=(0.505315,'amu*angstrom^2'), symmetry=1, barrier=(37.548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0852312,'amu*angstrom^2'), symmetry=1, barrier=(6.32221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99439,0.0484757,-6.18137e-05,4.62876e-08,-1.46621e-11,-38022.7,19.9793], Tmin=(100,'K'), Tmax=(757.375,'K')), NASAPolynomial(coeffs=[6.76179,0.0232963,-1.19437e-05,2.38891e-09,-1.71191e-13,-38744.8,-1.69567], Tmin=(757.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'O=C(OF)C(F)=CF(829)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {4,S}
4 O u0 p2 c0 {3,S} {7,S}
...
"""),
    E0 = (-483.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,288,410,724,839,1320,194,682,905,1196,1383,3221,180,180,180,1266.72,1267.39,1267.43],'cm^-1')),
        HinderedRotor(inertia=(0.262076,'amu*angstrom^2'), symmetry=1, barrier=(6.02564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261781,'amu*angstrom^2'), symmetry=1, barrier=(6.01886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37603,0.0639836,-0.000104732,9.3819e-08,-3.34482e-11,-58072.4,22.9556], Tmin=(100,'K'), Tmax=(786.714,'K')), NASAPolynomial(coeffs=[7.57759,0.0241368,-1.29035e-05,2.56739e-09,-1.81138e-13,-58790.9,-3.84027], Tmin=(786.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'FCC(F)(F)OF(814)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'O=C([C]F)OF(426)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C(OF)C(F)(F)[C]F(815)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(OF)C(F)F(816)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(24)', 'O=C(OF)C(F)(F)F(817)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(428)', 'O=C=C(F)CF(818)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)C(F)(F)[CH]F(821)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C](OF)C(F)(F)[CH]F(822)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(OF)[C](F)CF(823)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)OF(824)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)CF(825)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(228)', 'O=[C]C(F)(F)CF(826)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(45)', 'O=C(OF)[C](F)F(435)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(142)', 'CH2F-CF2(67)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[CH]F(827)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'C=C(F)C(=O)OF(828)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(OF)C(F)=CF(829)'],
    products = ['O=C(OF)C(F)(F)CF(723)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(OF)C(F)(F)CF(723)'],
    products = ['F2(77)', 'CO2(13)', 'CH2CF2(56)'],
