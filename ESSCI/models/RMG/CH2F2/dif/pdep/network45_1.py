...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57491,0.0390015,-4.27644e-05,-1.76341e-08,4.80977e-11,-26139.8,17.0521], Tmin=(100,'K'), Tmax=(457.305,'K')), NASAPolynomial(coeffs=[7.0364,0.0143461,-9.02391e-06,1.88718e-09,-1.36015e-13,-26698.1,-2.62403], Tmin=(457.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)O2s) + radical(C=OC=OOJ) + radical(C=OC=OOJ)"""),
)
...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.07591,0.000855031,7.79575e-05,-1.08055e-07,4.2353e-11,-1895.68,18.6732], Tmin=(100,'K'), Tmax=(957.026,'K')), NASAPolynomial(coeffs=[14.9258,0.000850934,3.42398e-07,8.34254e-11,-2.03628e-14,-6431.75,-49.824], Tmin=(957.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.1855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + ring(Cyclobutane) + radical(C=OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(194)'],
    products = ['[O]C(=O)C([O])=O(182)'],
    transitionState = 'TS2',
