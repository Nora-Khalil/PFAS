...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.749278,'amu*angstrom^2'), symmetry=1, barrier=(17.2274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47964,'amu*angstrom^2'), symmetry=1, barrier=(11.0279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480692,'amu*angstrom^2'), symmetry=1, barrier=(11.0521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.282476,'amu*angstrom^2'), symmetry=1, barrier=(6.49469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282448,'amu*angstrom^2'), symmetry=1, barrier=(6.49403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.919886,0.0739485,-0.00011198,9.50202e-08,-3.28322e-11,-110073,21.6023], Tmin=(100,'K'), Tmax=(738.449,'K')), NASAPolynomial(coeffs=[8.90171,0.0283844,-1.46966e-05,2.92326e-09,-2.07404e-13,-111188,-14.0554], Tmin=(738.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-916.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-750.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,227.656],'cm^-1')),
        HinderedRotor(inertia=(0.174931,'amu*angstrom^2'), symmetry=1, barrier=(6.43502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174934,'amu*angstrom^2'), symmetry=1, barrier=(6.43502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]C(F)(F)OF(505)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(875)', 'C[C]F(1325)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(428)', 'CC(F)(F)[C]F(1326)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(428)', 'CC(F)=C(F)F(1328)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)C(F)(F)OF(1329)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)[C](F)OF(1330)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)F(1331)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', 'CC(F)(F)[C](F)F(1332)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(240)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(18)', 'FOC(F)(F)[C](F)F(513)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)OF(884)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'CC(F)(F)C(=O)F(1245)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', 'CC(F)=C(F)OF(1333)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)C(F)(F)OF(889)'],
    products = ['CC(F)(F)C(F)(F)OF(1317)'],
