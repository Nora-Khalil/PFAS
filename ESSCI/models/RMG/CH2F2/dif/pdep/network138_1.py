...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7239,0.0547716,-8.963e-05,7.75064e-08,-2.63704e-11,-47748.4,19.1554], Tmin=(100,'K'), Tmax=(803.987,'K')), NASAPolynomial(coeffs=[8.22452,0.0168716,-8.55006e-06,1.6762e-09,-1.17215e-13,-48614,-9.6709], Tmin=(803.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-397.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.511855,'amu*angstrom^2'), symmetry=1, barrier=(11.7685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.594792,'amu*angstrom^2'), symmetry=1, barrier=(13.6754,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0284,0.048801,-8.68601e-05,7.88662e-08,-2.74488e-11,-28640,16.0056], Tmin=(100,'K'), Tmax=(838.06,'K')), NASAPolynomial(coeffs=[7.1134,0.0145018,-7.51968e-06,1.47272e-09,-1.0215e-13,-29140.2,-5.52708], Tmin=(838.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'FC1OC(F)O1(414)',
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.99034,-0.000234773,9.90651e-05,-1.70918e-07,9.11609e-11,-87441.7,9.72421], Tmin=(10,'K'), Tmax=(602.956,'K')), NASAPolynomial(coeffs=[1.49331,0.032348,-2.18401e-05,6.82074e-09,-8.01274e-13,-87431.7,18.0932], Tmin=(602.956,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-727.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""FC1OC(F)O1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54398,0.0580726,-9.14622e-05,7.27284e-08,-2.26908e-11,-53839,20.1416], Tmin=(100,'K'), Tmax=(789.322,'K')), NASAPolynomial(coeffs=[10.3175,0.0136164,-6.98882e-06,1.38963e-09,-9.84167e-14,-55224.2,-20.1111], Tmin=(789.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-391.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,180,180,270.194,886.021],'cm^-1')),
        HinderedRotor(inertia=(0.0679451,'amu*angstrom^2'), symmetry=1, barrier=(37.6453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.567871,'amu*angstrom^2'), symmetry=1, barrier=(13.0565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13005,0.0397547,-3.86692e-05,1.86998e-08,-3.58789e-12,-47018.8,19.3148], Tmin=(100,'K'), Tmax=(1254.22,'K')), NASAPolynomial(coeffs=[10.8139,0.0120597,-5.54687e-06,1.09395e-09,-7.85575e-14,-49197.1,-24.5468], Tmin=(1254.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'F[CH]O[CH]OF(419)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-97.6024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,580,1155,1237,1373,3147,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.25258,'amu*angstrom^2'), symmetry=1, barrier=(51.7912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00238378,'amu*angstrom^2'), symmetry=1, barrier=(7.38155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322215,'amu*angstrom^2'), symmetry=1, barrier=(7.40837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34094,0.0749645,-0.000164748,1.69421e-07,-6.29184e-11,-11658.9,20.0588], Tmin=(100,'K'), Tmax=(871.927,'K')), NASAPolynomial(coeffs=[2.8914,0.0280597,-1.56007e-05,3.04461e-09,-2.07555e-13,-10416.6,21.4652], Tmin=(871.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.6024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O][CH]OC(F)F(420)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73948,0.0736797,-0.00018322,2.07772e-07,-8.20816e-11,-51861,17.1787], Tmin=(100,'K'), Tmax=(867.542,'K')), NASAPolynomial(coeffs=[-4.61311,0.0422646,-2.39418e-05,4.71728e-09,-3.24085e-13,-48474.4,60.0897], Tmin=(867.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)O[CH]F(323)'],
    products = ['CHFO(46)', 'CHFO(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[CH]F(323)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]O[CH]OF(419)'],
    products = ['[O]C(F)O[CH]F(323)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(80.6199,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)O[CH]F(323)'],
    products = ['[O][CH]OC(F)F(420)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
