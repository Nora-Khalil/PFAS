...
"""),
    E0 = (-342.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,617,898,1187,272.684,272.717,272.776,272.78,272.79,891.779],'cm^-1')),
        HinderedRotor(inertia=(0.812105,'amu*angstrom^2'), symmetry=1, barrier=(42.8709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811955,'amu*angstrom^2'), symmetry=1, barrier=(42.8709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812251,'amu*angstrom^2'), symmetry=1, barrier=(42.8708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45403,0.0618796,-8.54404e-05,6.43668e-08,-1.99812e-11,-41115.8,22.7555], Tmin=(100,'K'), Tmax=(778.561,'K')), NASAPolynomial(coeffs=[8.72306,0.0245348,-1.34931e-05,2.76171e-09,-2.00092e-13,-42247.8,-10.4942], Tmin=(778.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-438.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,350,440,435,1725,180,180,2398.17],'cm^-1')),
        HinderedRotor(inertia=(0.192113,'amu*angstrom^2'), symmetry=1, barrier=(4.41705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194903,'amu*angstrom^2'), symmetry=1, barrier=(4.48121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72194,'amu*angstrom^2'), symmetry=1, barrier=(39.5908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309357,0.0944835,-0.000176886,1.68525e-07,-6.0841e-11,-52578.3,27.7513], Tmin=(100,'K'), Tmax=(843.918,'K')), NASAPolynomial(coeffs=[7.24435,0.0334121,-1.82112e-05,3.57998e-09,-2.47956e-13,-52744.6,1.42069], Tmin=(843.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFFH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'FC=C(OF)OC(F)F(836)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-759.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,194,682,905,1196,1383,3221,213.572,213.572,213.572,1786.79],'cm^-1')),
        HinderedRotor(inertia=(0.289484,'amu*angstrom^2'), symmetry=1, barrier=(9.37011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289487,'amu*angstrom^2'), symmetry=1, barrier=(9.37011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09039,'amu*angstrom^2'), symmetry=1, barrier=(35.2937,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27706,0.0903356,-0.000152967,1.34831e-07,-4.65772e-11,-91168.7,26.487], Tmin=(100,'K'), Tmax=(806.724,'K')), NASAPolynomial(coeffs=[10.6036,0.027588,-1.48288e-05,2.93495e-09,-2.05619e-13,-92459.1,-18.7861], Tmin=(806.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-759.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C(OF)[C](F)C(F)F(837)',
...
"""),
    E0 = (-532.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,180,2349.64],'cm^-1')),
        HinderedRotor(inertia=(0.29166,'amu*angstrom^2'), symmetry=1, barrier=(6.70583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292924,'amu*angstrom^2'), symmetry=1, barrier=(6.73491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6865,'amu*angstrom^2'), symmetry=1, barrier=(38.776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245611,0.0966965,-0.000183362,1.76646e-07,-6.44186e-11,-63939,31.826], Tmin=(100,'K'), Tmax=(839.381,'K')), NASAPolynomial(coeffs=[6.90335,0.0349629,-1.94189e-05,3.84684e-09,-2.67686e-13,-63999.6,7.16873], Tmin=(839.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(OF)C(F)[C](F)F(838)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-521.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,180,2223],'cm^-1')),
        HinderedRotor(inertia=(0.213487,'amu*angstrom^2'), symmetry=1, barrier=(4.90848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216803,'amu*angstrom^2'), symmetry=1, barrier=(4.98474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63672,'amu*angstrom^2'), symmetry=1, barrier=(37.6313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22319,0.0967337,-0.000182026,1.74236e-07,-6.3309e-11,-62626.6,31.1997], Tmin=(100,'K'), Tmax=(837.353,'K')), NASAPolynomial(coeffs=[7.31758,0.0343011,-1.90557e-05,3.77772e-09,-2.631e-13,-62814.1,4.20781], Tmin=(837.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-521.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OF)C(F)[C](F)F(839)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.145636,'amu*angstrom^2'), symmetry=1, barrier=(3.34847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144518,'amu*angstrom^2'), symmetry=1, barrier=(3.32276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145285,'amu*angstrom^2'), symmetry=1, barrier=(3.34039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944681,'amu*angstrom^2'), symmetry=1, barrier=(21.7201,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0806336,0.0999337,-0.000179032,1.59595e-07,-5.46922e-11,-65072.9,32.1194], Tmin=(100,'K'), Tmax=(833.583,'K')), NASAPolynomial(coeffs=[11.8075,0.0255822,-1.40983e-05,2.78278e-09,-1.93278e-13,-66453.6,-19.4635], Tmin=(833.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-819.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,235,523,627,1123,1142,1372,1406,3097,490.001,490.33,490.354,490.458,490.58,490.616,490.666],'cm^-1')),
        HinderedRotor(inertia=(0.000700281,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000700238,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52048,0.0606744,-8.83251e-05,8.09177e-08,-3.12159e-11,-98477.3,22.4384], Tmin=(100,'K'), Tmax=(724.136,'K')), NASAPolynomial(coeffs=[5.34966,0.0330547,-1.77149e-05,3.57673e-09,-2.56381e-13,-98862.3,6.37165], Tmin=(724.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.156069,'amu*angstrom^2'), symmetry=1, barrier=(3.58834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782408,'amu*angstrom^2'), symmetry=1, barrier=(17.9891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'FOC(F)C(F)F(830)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'O=C(CF)OF(831)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(OF)C(F)[C]F(832)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(428)', 'O=C=CC(F)F(833)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(OF)[C](F)C(F)F(837)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C(F)[C](F)F(838)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C(F)[C](F)F(839)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C([CH]C(F)F)OF(841)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(OF)C(F)[CH]F(842)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(=O)C(F)C(F)F(843)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(228)', 'O=[C]C(F)C(F)F(844)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(81)', 'O=C([CH]F)OF(484)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(142)', 'CHF2-CHF(66)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(OF)[C](F)C(F)F(845)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(OF)C(F)[C](F)F(846)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'O=C(C=CF)OF(847)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(C=C(F)F)OF(848)'],
    products = ['O=C(OF)C(F)C(F)F(722)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(OF)C(F)C(F)F(722)'],
    products = ['F2(77)', 'CO2(13)', 'CHFCHF[Z](58)'],
...
network(
    label = 'PDepNetwork #307',
    isomers = [
        'O=C(OF)C(F)C(F)F(722)',
    ],
    reactants = [
