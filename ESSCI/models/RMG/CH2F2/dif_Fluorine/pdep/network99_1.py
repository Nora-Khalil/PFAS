...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(207)', '[O]C([O])(F)F(152)'],
    products = ['[O]C(F)(F)O[C]=O(261)'],
    transitionState = 'TS2',
