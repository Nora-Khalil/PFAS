...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224795,0.0900606,-0.000124515,8.84919e-08,-2.52189e-11,-129982,29.1199], Tmin=(100,'K'), Tmax=(854.331,'K')), NASAPolynomial(coeffs=[13.541,0.0277138,-1.50485e-05,3.07087e-09,-2.22334e-13,-132258,-33.0264], Tmin=(854.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1081.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.457829,'amu*angstrom^2'), symmetry=1, barrier=(10.5264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.97606,'amu*angstrom^2'), symmetry=1, barrier=(45.4336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.97723,'amu*angstrom^2'), symmetry=1, barrier=(45.4603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458949,'amu*angstrom^2'), symmetry=1, barrier=(10.5521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113745,0.0993835,-0.000161133,1.40324e-07,-4.9223e-11,-90405.7,30.9497], Tmin=(100,'K'), Tmax=(735.481,'K')), NASAPolynomial(coeffs=[11.2239,0.0336633,-1.88199e-05,3.82238e-09,-2.73458e-13,-91963.7,-19.5183], Tmin=(735.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-752.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(CsFFOO) + group(CdCFO) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C(F)[CH]OC(F)(F)OF(3893)',
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.542886,0.108527,-0.000173107,1.33711e-07,-3.89569e-11,-88814.5,31.9628], Tmin=(100,'K'), Tmax=(685.998,'K')), NASAPolynomial(coeffs=[16.0559,0.0234169,-1.25373e-05,2.47892e-09,-1.73914e-13,-91366.6,-43.8637], Tmin=(685.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsFFOO) + radical(O2sj(Cs-CsF1sH)) + radical(CCsJOCs)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.796557,0.0765192,-0.000102597,7.18852e-08,-2.03512e-11,-77285.7,28.59], Tmin=(100,'K'), Tmax=(857.257,'K')), NASAPolynomial(coeffs=[11.6781,0.0257451,-1.37538e-05,2.79323e-09,-2.01874e-13,-79151.3,-22.2311], Tmin=(857.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFHOO) + group(COCsFO) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'O=[C]COC(F)(F)OF(3896)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-673.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,435,565,619,662,854,1178,1396,1855,455,950,306.086,306.087,306.087,306.087],'cm^-1')),
        HinderedRotor(inertia=(0.12064,'amu*angstrom^2'), symmetry=1, barrier=(8.02062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.530251,'amu*angstrom^2'), symmetry=1, barrier=(35.253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37954,'amu*angstrom^2'), symmetry=1, barrier=(25.2333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12064,'amu*angstrom^2'), symmetry=1, barrier=(8.02062,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639007,0.0803121,-0.000111262,7.95088e-08,-2.28171e-11,-80845.8,27.3849], Tmin=(100,'K'), Tmax=(848.126,'K')), NASAPolynomial(coeffs=[12.3394,0.0251284,-1.3662e-05,2.78849e-09,-2.01875e-13,-82830.4,-27.1351], Tmin=(848.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-673.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)(F)OCC(=O)F(3897)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-949.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,486,617,768,1157,1926,270.538,273.218,273.494,2108.53],'cm^-1')),
        HinderedRotor(inertia=(0.116516,'amu*angstrom^2'), symmetry=1, barrier=(6.15668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434867,'amu*angstrom^2'), symmetry=1, barrier=(22.7335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437135,'amu*angstrom^2'), symmetry=1, barrier=(22.7543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00444,0.0685618,-7.78538e-05,4.44968e-08,-1.01954e-11,-114130,27.0368], Tmin=(100,'K'), Tmax=(1052.67,'K')), NASAPolynomial(coeffs=[13.3228,0.0217538,-1.11549e-05,2.2558e-09,-1.63573e-13,-116723,-33.0246], Tmin=(1052.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-791.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,493,600,700,1144,1293,180,180,180,554.69],'cm^-1')),
        HinderedRotor(inertia=(0.138975,'amu*angstrom^2'), symmetry=1, barrier=(3.19531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140793,'amu*angstrom^2'), symmetry=1, barrier=(3.23712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141344,'amu*angstrom^2'), symmetry=1, barrier=(3.24977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23599,0.0666141,-0.000103208,8.9376e-08,-3.13839e-11,-95086.7,25.9277], Tmin=(100,'K'), Tmax=(754.685,'K')), NASAPolynomial(coeffs=[8.13619,0.0257772,-1.35658e-05,2.70105e-09,-1.91384e-13,-96006.7,-4.61508], Tmin=(754.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(COCsFO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200177,0.0986259,-0.000149503,1.10292e-07,-3.17748e-11,-108263,30.0847], Tmin=(100,'K'), Tmax=(854.445,'K')), NASAPolynomial(coeffs=[16.6473,0.0197532,-1.10347e-05,2.25116e-09,-1.62156e-13,-111142,-48.5441], Tmin=(854.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-901.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFOO) + group(COCsFO) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (-950.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,482,664,788,1296,1923,180,180,998.472,998.621],'cm^-1')),
        HinderedRotor(inertia=(0.0832358,'amu*angstrom^2'), symmetry=1, barrier=(1.91471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1718,'amu*angstrom^2'), symmetry=1, barrier=(26.9421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17175,'amu*angstrom^2'), symmetry=1, barrier=(26.9408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    ...
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(708)', 'CH2CO(75)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OOC(F)(F)OF(3892)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)[CH]OC(F)(F)OF(3893)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)CO[C](F)OF(3895)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]COC(F)(F)OF(3896)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)OCC(=O)F(3897)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)OF(712)', 'CH2CFO(107)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(192)', '[O]CC(=O)F(1644)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'O=C(F)CO[C](F)F(3898)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(50)', '[CH2]OC(F)(F)OF(1204)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)(F)OF(3899)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(106)', 'O=C(F)COC(=O)F(3900)'],
    products = ['O=C(F)COC(F)(F)OF(3731)'],
...
network(
    label = 'PDepNetwork #1356',
    isomers = [
        'O=C(F)COC(F)(F)OF(3731)',
    ],
    reactants = [
