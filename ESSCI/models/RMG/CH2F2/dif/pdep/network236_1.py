...
"""),
    E0 = (-62.4972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,580,1155,1237,1373,3147,180,1704.23],'cm^-1')),
        HinderedRotor(inertia=(1.10267,'amu*angstrom^2'), symmetry=1, barrier=(25.3525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66842,'amu*angstrom^2'), symmetry=1, barrier=(38.3603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49438,0.0368259,-5.43688e-05,4.33032e-08,-1.40991e-11,-7465.87,15.6266], Tmin=(100,'K'), Tmax=(745.499,'K')), NASAPolynomial(coeffs=[6.81293,0.0136545,-7.74609e-06,1.61043e-09,-1.1757e-13,-8109.76,-3.93955], Tmin=(745.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.4972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s)"""),
)
...
reaction(
    ...
    products = ['[O]OC(F)F(168)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(21.831,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)F(170)'],
    products = ['[O]OC(F)F(168)'],
    transitionState = 'TS3',
