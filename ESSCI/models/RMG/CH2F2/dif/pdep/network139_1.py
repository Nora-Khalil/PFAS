...
"""),
    E0 = (-172.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,505,655,1117,1193,1185,1289,1311,1435,3104,3190,296.873],'cm^-1')),
        HinderedRotor(inertia=(0.510278,'amu*angstrom^2'), symmetry=1, barrier=(11.7323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99415,'amu*angstrom^2'), symmetry=1, barrier=(45.8495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99416,'amu*angstrom^2'), symmetry=1, barrier=(45.8497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06057,0.0476912,-6.60554e-05,5.26157e-08,-1.76124e-11,-20724.7,19.7766], Tmin=(100,'K'), Tmax=(719.153,'K')), NASAPolynomial(coeffs=[6.72095,0.0217667,-1.19762e-05,2.47771e-09,-1.80867e-13,-21394.9,-1.17011], Tmin=(719.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]O[CH]F(126)'],
    products = ['F[CH]OO[CH]F(324)'],
    transitionState = 'TS2',
