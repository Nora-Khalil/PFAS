...
"""),
    E0 = (-20.5054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,3120,650,792.5,1650,1855,455,950,187.48,187.537],'cm^-1')),
        HinderedRotor(inertia=(1.25555,'amu*angstrom^2'), symmetry=1, barrier=(31.7426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48312,'amu*angstrom^2'), symmetry=1, barrier=(37.5158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87577,0.0517275,-7.97726e-05,6.13045e-08,-1.76579e-11,-2394.44,16.916], Tmin=(100,'K'), Tmax=(639.319,'K')), NASAPolynomial(coeffs=[8.65836,0.0153181,-8.48776e-06,1.71591e-09,-1.22464e-13,-3384.86,-13.7351], Tmin=(639.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.5054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-F1sO2s)(H)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05665,0.0482371,-8.26949e-05,7.66146e-08,-2.7819e-11,-2702.09,19.317], Tmin=(100,'K'), Tmax=(805.249,'K')), NASAPolynomial(coeffs=[6.09134,0.0187546,-1.01899e-05,2.02858e-09,-1.42722e-13,-3045.8,2.62633], Tmin=(805.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(C=CJO) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=[C]OC(=O)F(1088)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0428,0.0442343,-5.71617e-05,3.58671e-08,-8.79372e-12,-3534.02,20.377], Tmin=(100,'K'), Tmax=(999.893,'K')), NASAPolynomial(coeffs=[10.7613,0.00935629,-4.83879e-06,9.81248e-10,-7.12851e-14,-5277.52,-21.6838], Tmin=(999.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.9617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(COFOO) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[CH]C(=O)F-2(1085)'],
    products = ['[CH]=C(F)O[C]=O(1049)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CO(12)', '[CH]C(=O)F-2(1085)'],
    products = ['[CH]=C(F)O[C]=O(1049)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(106.251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['[CH]=C(F)O[C]=O(1049)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(10.0801,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(F)O[C]=O(1049)'],
    products = ['[CH]=[C]OC(=O)F(1088)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(222.396,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
