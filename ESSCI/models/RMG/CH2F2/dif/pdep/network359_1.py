...
"""),
    ...
    molecularWeight = (63.9976,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.59423,-0.0495005,0.00021102,-2.59806e-07,1.02245e-10,30429.8,13.1354], Tmin=(100,'K'), Tmax=(907.946,'K')), NASAPolynomial(coeffs=[20.5663,-0.0259013,1.67943e-05,-3.20981e-09,2.06742e-13,23656.4,-83.7069], Tmin=(907.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + ring(Cyclobutane)"""),
)
