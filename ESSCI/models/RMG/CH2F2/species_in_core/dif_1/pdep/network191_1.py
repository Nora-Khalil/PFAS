...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50471,0.061867,-8.76391e-05,6.43973e-08,-1.72579e-11,-100086,21.002], Tmin=(100,'K'), Tmax=(593.328,'K')), NASAPolynomial(coeffs=[8.00907,0.0254187,-1.42064e-05,2.91343e-09,-2.10683e-13,-100988,-8.08031], Tmin=(593.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-832.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.65318,'amu*angstrom^2'), symmetry=1, barrier=(38.0097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64724,'amu*angstrom^2'), symmetry=1, barrier=(37.8733,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72346,0.0539003,-7.02234e-05,4.68824e-08,-1.25756e-11,-54662.9,18.4771], Tmin=(100,'K'), Tmax=(904.85,'K')), NASAPolynomial(coeffs=[10.0623,0.017036,-9.11004e-06,1.85433e-09,-1.34375e-13,-56171.9,-20.919], Tmin=(904.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49139,0.0612359,-8.77857e-05,7.05366e-08,-2.35474e-11,-74646.3,25.8544], Tmin=(100,'K'), Tmax=(724.16,'K')), NASAPolynomial(coeffs=[7.90614,0.0258004,-1.43803e-05,2.95386e-09,-2.14161e-13,-75575.3,-3.02224], Tmin=(724.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]O[CH]C(F)(F)F(533)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.808126,0.0716819,-0.000101313,6.78079e-08,-1.74667e-11,-79341.1,23.7028], Tmin=(100,'K'), Tmax=(959.798,'K')), NASAPolynomial(coeffs=[15.5683,0.0101686,-5.17917e-06,1.03486e-09,-7.43832e-14,-82174.5,-46.9012], Tmin=(959.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'O=C(F)O[CH][C](F)F(534)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856567,0.0745645,-0.000115915,8.93127e-08,-2.70404e-11,-77367.2,26.2377], Tmin=(100,'K'), Tmax=(812.067,'K')), NASAPolynomial(coeffs=[12.5556,0.0169385,-9.47137e-06,1.9277e-09,-1.3837e-13,-79267.2,-27.7678], Tmin=(812.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-644.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(COFOO) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(224)', '[O]C(F)[C](F)F(371)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=[C]O[CH]F(528)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[O]C(F)[C](F)F(371)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(99.9702,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OC=C(F)F(529)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['O=[C]OC(F)[C](F)F(449)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(10.3182,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C(F)F(530)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(89)', 'O=[C]O[CH]F(528)'],
    products = ['O=[C]OC(F)[C](F)F(449)'],
