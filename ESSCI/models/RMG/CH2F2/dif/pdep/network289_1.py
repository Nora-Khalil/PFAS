...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5689,'amu*angstrom^2'), symmetry=1, barrier=(36.0722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57029,'amu*angstrom^2'), symmetry=1, barrier=(36.1042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16196,0.0652541,-7.29526e-05,4.01402e-08,-8.81864e-12,-81495.8,23.0346], Tmin=(100,'K'), Tmax=(1095.54,'K')), NASAPolynomial(coeffs=[13.6312,0.0197269,-1.06178e-05,2.20805e-09,-1.62651e-13,-84227.9,-38.2603], Tmin=(1095.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-512.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,262,406,528,622,1148,1246,1368,1480,3164,3240,295.942,296.318],'cm^-1')),
        HinderedRotor(inertia=(0.139867,'amu*angstrom^2'), symmetry=1, barrier=(8.73786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139474,'amu*angstrom^2'), symmetry=1, barrier=(8.73751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.958859,0.0727716,-0.000123285,1.05192e-07,-3.48503e-11,-61489.6,22.3748], Tmin=(100,'K'), Tmax=(819.941,'K')), NASAPolynomial(coeffs=[10.8925,0.0172822,-8.91348e-06,1.74485e-09,-1.21305e-13,-62882.3,-22.1362], Tmin=(819.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'FC1OC(F)C1(F)F(709)',
...
"""),
    E0 = (-494.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([361,769,965,1078,1132,1246,3247,323,467,575,827,1418,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.165178,'amu*angstrom^2'), symmetry=1, barrier=(3.79776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70591,0.0282874,0.00014724,-7.81679e-07,1.06059e-09,-59432.1,11.9956], Tmin=(10,'K'), Tmax=(275.514,'K')), NASAPolynomial(coeffs=[5.56266,0.0302683,-2.1093e-05,6.86002e-09,-8.41495e-13,-59644.2,3.43828], Tmin=(275.514,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-494.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""[O]C(F)C(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.139168,'amu*angstrom^2'), symmetry=1, barrier=(3.19975,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66668,0.0568081,-9.44707e-05,8.42594e-08,-2.966e-11,-56404,21.8013], Tmin=(100,'K'), Tmax=(793.108,'K')), NASAPolynomial(coeffs=[7.65021,0.0194498,-1.02343e-05,2.03675e-09,-1.43699e-13,-57127.2,-4.2551], Tmin=(793.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446838,0.0870974,-0.00015326,1.38699e-07,-4.89782e-11,-85414.5,25.6017], Tmin=(100,'K'), Tmax=(797.428,'K')), NASAPolynomial(coeffs=[10.1235,0.0259628,-1.4571e-05,2.94522e-09,-2.08754e-13,-86557.3,-16.3815], Tmin=(797.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][C](F)C(F)(F)CF(810)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928356,0.0741273,-0.000109606,8.60438e-08,-2.72599e-11,-82141.8,23.6598], Tmin=(100,'K'), Tmax=(769.487,'K')), NASAPolynomial(coeffs=[10.4163,0.0248071,-1.34644e-05,2.74987e-09,-1.98675e-13,-83602,-19.6279], Tmin=(769.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-683.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'F[CH][C](F)C(F)OF(811)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-360.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,212,367,445,1450,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0431129,'amu*angstrom^2'), symmetry=1, barrier=(2.48506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577421,'amu*angstrom^2'), symmetry=1, barrier=(13.2761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23399,'amu*angstrom^2'), symmetry=1, barrier=(51.3639,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49566,0.0901756,-0.000172517,1.66297e-07,-6.06258e-11,-43272.3,25.8384], Tmin=(100,'K'), Tmax=(836.382,'K')), NASAPolynomial(coeffs=[7.11497,0.031104,-1.74095e-05,3.47298e-09,-2.42687e-13,-43420.7,0.81894], Tmin=(836.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)[C](F)C(F)F(796)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-671.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([391,562,707,872,1109,1210,1289,3137,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.449196,'amu*angstrom^2'), symmetry=1, barrier=(10.3279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.623133,'amu*angstrom^2'), symmetry=1, barrier=(14.327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865938,0.0757686,-0.00012487,1.0912e-07,-3.74987e-11,-80608,25.3876], Tmin=(100,'K'), Tmax=(807.086,'K')), NASAPolynomial(coeffs=[9.4313,0.0243065,-1.24779e-05,2.44835e-09,-1.71129e-13,-81697.1,-12.2813], Tmin=(807.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-671.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(F1s))"""),
)

species(
    label = 'F[CH]C(F)(F)[CH]OF(812)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-377.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,243.718,243.756,243.966],'cm^-1')),
        HinderedRotor(inertia=(0.273599,'amu*angstrom^2'), symmetry=1, barrier=(11.5429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386077,'amu*angstrom^2'), symmetry=1, barrier=(16.3114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55904,'amu*angstrom^2'), symmetry=1, barrier=(23.6234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235348,0.0921622,-0.000149599,1.10957e-07,-2.78865e-11,-45331.1,25.521], Tmin=(100,'K'), Tmax=(624.843,'K')), NASAPolynomial(coeffs=[14.0998,0.0188296,-1.05794e-05,2.13362e-09,-1.50827e-13,-47364.7,-37.2565], Tmin=(624.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(F)F(813)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92796,0.0763909,-0.000130949,1.2283e-07,-4.5373e-11,-83500.3,24.4878], Tmin=(100,'K'), Tmax=(789.468,'K')), NASAPolynomial(coeffs=[7.09901,0.030734,-1.68593e-05,3.39843e-09,-2.41352e-13,-84026.2,-0.98504], Tmin=(789.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-695.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(704)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C(F)[C](F)F(705)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', '[O]C(F)[C](F)F(402)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(804)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(806)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(43.4274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(127)', 'CHFCF2(54)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.4589e-08,'m^3/(mol*s)'), n=3.53001, Ea=(0.47777,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.4944253016374622, var=1.7828810760479818, Tref=1000.0, N=135, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(807)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(14.5529,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHFO(46)', 'F[CH][C](F)F(635)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(46.5733,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(775)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(26.2332,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(127)', 'F[CH][C](F)F(635)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[O]C=C(F)[CH]F(808)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(17.7024,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(776)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(263.938,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[O]C(F)[C](F)F(402)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][C](F)C(F)OF(811)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(99.3541,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)[C](F)C(F)F(796)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(8.71296e+12,'s^-1'), n=0.369741, Ea=(178.885,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_N-4R!H->C_Ext-2R!H-R_5R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_N-4R!H->C_Ext-2R!H-R_5R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(812)'],
    products = ['[O]C(F)C(F)(F)[CH]F(704)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(80.2295,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)(F)[CH]F(704)'],
    products = ['[O][CH]C(F)(F)C(F)F(813)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(219.632,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #289',
    isomers = [
        '[O]C(F)C(F)(F)[CH]F(704)',
    ],
    reactants = [
        ('CHFO(46)', 'CHFCF2(54)'),
    ],
