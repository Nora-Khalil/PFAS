...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'CO[O](826)'],
    products = ['CC(F)(F)O[O](1290)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(152)', 'C[C]F-2(309)'],
    products = ['CC(F)(F)O[O](1290)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(163)', 'CH2(S)(72)'],
    products = ['CC(F)(F)O[O](1290)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(171)', 'CH3(67)'],
    products = ['CC(F)(F)O[O](1290)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](317)'],
    products = ['CC(F)(F)O[O](1290)'],
    transitionState = 'TS9',
