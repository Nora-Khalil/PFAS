...
"""),
    E0 = (-707.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,482,664,788,1296,1923,249.355,4000],'cm^-1')),
        HinderedRotor(inertia=(0.299229,'amu*angstrom^2'), symmetry=1, barrier=(13.2007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299283,'amu*angstrom^2'), symmetry=1, barrier=(13.2008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(332)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(333)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(238)', '[O]C=O(142)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(334)', 'HCO(14)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(248)', 'O=CO[C](F)F(335)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(336)'],
    products = ['O=COC(F)(F)OF(322)'],
    transitionState = 'TS9',
