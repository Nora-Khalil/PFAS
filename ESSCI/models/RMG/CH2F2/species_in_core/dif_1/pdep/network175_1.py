...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.649264,'amu*angstrom^2'), symmetry=1, barrier=(14.9278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.646648,'amu*angstrom^2'), symmetry=1, barrier=(14.8677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39958,0.0613835,-0.000102357,8.44842e-08,-2.68334e-11,-28585.3,19.1591], Tmin=(100,'K'), Tmax=(853.693,'K')), NASAPolynomial(coeffs=[10.647,0.0122375,-5.78329e-06,1.08644e-09,-7.3459e-14,-29952.2,-22.7503], Tmin=(853.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]OC(F)[CH]F(1008)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.418913,'amu*angstrom^2'), symmetry=1, barrier=(9.63162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419243,'amu*angstrom^2'), symmetry=1, barrier=(9.63921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66575,0.0577501,-0.000101949,9.14581e-08,-3.12227e-11,-27473.1,20.2388], Tmin=(100,'K'), Tmax=(863.149,'K')), NASAPolynomial(coeffs=[7.65487,0.0169242,-8.28558e-06,1.57115e-09,-1.06546e-13,-28020,-4.95322], Tmin=(863.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-229.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-446.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,180],'cm^-1')),
        HinderedRotor(inertia=(0.410227,'amu*angstrom^2'), symmetry=1, barrier=(9.43192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410675,'amu*angstrom^2'), symmetry=1, barrier=(9.44223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25473,0.0750922,-0.000159693,1.59453e-07,-5.79275e-11,-53655.5,22.0923], Tmin=(100,'K'), Tmax=(876.592,'K')), NASAPolynomial(coeffs=[4.60515,0.0247255,-1.34818e-05,2.60584e-09,-1.76361e-13,-52895.2,14.0571], Tmin=(876.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OC(F)[C](F)F(233)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.402412,'amu*angstrom^2'), symmetry=1, barrier=(9.25223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38929,0.068339,-0.000134827,1.31275e-07,-4.76918e-11,-52054.9,22.2584], Tmin=(100,'K'), Tmax=(852.77,'K')), NASAPolynomial(coeffs=[5.85182,0.0231718,-1.27503e-05,2.51367e-09,-1.7378e-13,-51934.8,6.6067], Tmin=(852.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-303.828,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.58951,'amu*angstrom^2'), symmetry=1, barrier=(36.5459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20008,0.0712111,-0.000130067,1.23546e-07,-4.48019e-11,-36450.5,22.5652], Tmin=(100,'K'), Tmax=(835.44,'K')), NASAPolynomial(coeffs=[6.41084,0.0264897,-1.42697e-05,2.81226e-09,-1.95655e-13,-36631.1,2.4929], Tmin=(835.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO)"""),
)

species(
    label = 'F[CH]C(F)OOF(1011)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-284.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202],'cm^-1')),
        HinderedRotor(inertia=(1.34382,'amu*angstrom^2'), symmetry=1, barrier=(30.8972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.38258,0.0621742,-0.000115093,1.22388e-07,-5.37995e-11,-34242.7,12.757], Tmin=(10,'K'), Tmax=(545.277,'K')), NASAPolynomial(coeffs=[8.06258,0.0278431,-2.06516e-05,6.9223e-09,-8.60526e-13,-34753.1,-6.98302], Tmin=(545.277,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-284.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""F[CH]C(F)OOF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)C(F)F(432)'],
    products = ['HO2(10)', 'CHFCF2(54)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'F[C]C(F)F(182)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(44.9415,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(88)', '[O]OC(F)F(128)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(128.941,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CF2(89)', '[O]OCF(168)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(127.055,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(F)C(F)F(671)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]O[CH]C(F)F(1007)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)[CH]F(1008)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[O]O[CH]F(161)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(406)'],
    products = ['[O]OC(F)C(F)F(432)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(233)'],
    products = ['[O]OC(F)C(F)F(432)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(108)', '[O]OC=CF(1009)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(5.2642,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=CF(407)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(178.38,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]OC=C(F)F(353)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(223.334,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]OC(F)C(F)F(432)'],
    products = ['OH(4)', 'O=C(F)C(F)F(642)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOO[CH]C(F)F(1010)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(95.6876,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)OOF(1011)'],
    products = ['[O]OC(F)C(F)F(432)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(66.4155,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #175',
    isomers = [
        '[O]OC(F)C(F)F(432)',
    ],
    reactants = [
