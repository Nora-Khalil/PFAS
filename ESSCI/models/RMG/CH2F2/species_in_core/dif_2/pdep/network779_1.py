...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.286779,'amu*angstrom^2'), symmetry=1, barrier=(6.59361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286636,'amu*angstrom^2'), symmetry=1, barrier=(6.59033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.921188,'amu*angstrom^2'), symmetry=1, barrier=(21.1799,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0762265,'amu*angstrom^2'), symmetry=1, barrier=(1.7526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750144,'amu*angstrom^2'), symmetry=1, barrier=(1.72473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02126,'amu*angstrom^2'), symmetry=1, barrier=(46.4726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-622.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,180,2328.57],'cm^-1')),
        HinderedRotor(inertia=(0.192614,'amu*angstrom^2'), symmetry=1, barrier=(4.42857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.912859,'amu*angstrom^2'), symmetry=1, barrier=(20.9884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    E0 = (-613.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,239.524,1291.63],'cm^-1')),
        HinderedRotor(inertia=(0.0905923,'amu*angstrom^2'), symmetry=1, barrier=(2.0829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44695,'amu*angstrom^2'), symmetry=1, barrier=(33.2681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction5',
    reactants = ['FO[C](F)F(192)', 'CH3O(74)'],
    products = ['COC(F)(F)OF(1909)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(712)', 'CH3(67)'],
    products = ['COC(F)(F)OF(1909)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(154)', 'CO[C](F)F(1954)'],
    products = ['COC(F)(F)OF(1909)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC(F)(F)OF(1204)'],
    products = ['COC(F)(F)OF(1909)'],
    transitionState = 'TS8',
