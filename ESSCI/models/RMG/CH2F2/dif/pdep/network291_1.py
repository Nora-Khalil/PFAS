...
"""),
    E0 = (-691.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,580,1155,1237,1373,3147,180,180,180,1399.69],'cm^-1')),
        HinderedRotor(inertia=(0.285727,'amu*angstrom^2'), symmetry=1, barrier=(6.56943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284471,'amu*angstrom^2'), symmetry=1, barrier=(6.54056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96543,'amu*angstrom^2'), symmetry=1, barrier=(45.1891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876176,0.0762007,-0.000128048,1.14799e-07,-4.05925e-11,-83011.7,26.41], Tmin=(100,'K'), Tmax=(791.099,'K')), NASAPolynomial(coeffs=[8.87442,0.0258695,-1.3863e-05,2.77142e-09,-1.95902e-13,-83967.7,-8.34667], Tmin=(791.099,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-671.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,580,1155,1237,1373,3147,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.168193,'amu*angstrom^2'), symmetry=1, barrier=(3.8671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168157,'amu*angstrom^2'), symmetry=1, barrier=(3.86625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789109,'amu*angstrom^2'), symmetry=1, barrier=(18.1432,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901506,0.0795537,-0.000147891,1.43686e-07,-5.32863e-11,-80679.8,26.8974], Tmin=(100,'K'), Tmax=(823.423,'K')), NASAPolynomial(coeffs=[6.03531,0.0312355,-1.72824e-05,3.45993e-09,-2.4326e-13,-80732.6,7.93995], Tmin=(823.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-671.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'F[CH][C](F)OC(F)F(788)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.39451,0.0927969,-0.00018102,1.70517e-07,-5.9799e-11,-84027.7,27.065], Tmin=(100,'K'), Tmax=(870.906,'K')), NASAPolynomial(coeffs=[8.38897,0.025876,-1.37389e-05,2.64544e-09,-1.79361e-13,-84274.8,-3.82268], Tmin=(870.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(706)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C(F)(F)[CH]F(401)'],
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'F[CH]O[C](F)F(394)'],
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(57.296,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(787)'],
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(40.5901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.08336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(394)'],
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(401)'],
    products = ['F[CH]OC(F)(F)[CH]F(706)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OC(F)(F)[CH]F(706)'],
    products = ['F[CH][C](F)OC(F)F(788)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(224.37,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
