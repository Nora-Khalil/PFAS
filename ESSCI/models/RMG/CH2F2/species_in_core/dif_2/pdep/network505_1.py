...
"""),
    E0 = (-1410.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,209.046,214.017],'cm^-1')),
        HinderedRotor(inertia=(0.19179,'amu*angstrom^2'), symmetry=1, barrier=(5.74561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218694,'amu*angstrom^2'), symmetry=1, barrier=(5.68588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159213,'amu*angstrom^2'), symmetry=1, barrier=(5.7763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-600.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,617,898,1187,207.193],'cm^-1')),
        HinderedRotor(inertia=(0.193121,'amu*angstrom^2'), symmetry=1, barrier=(5.59824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199342,'amu*angstrom^2'), symmetry=1, barrier=(5.59542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86503,0.0501051,-5.93461e-05,3.76485e-08,-9.75535e-12,-72109.3,19.6186], Tmin=(100,'K'), Tmax=(929.588,'K')), NASAPolynomial(coeffs=[9.04986,0.0191892,-9.45989e-06,1.87215e-09,-1.33863e-13,-73445.1,-14.5194], Tmin=(929.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsFFF) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-982.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,395,473,707,1436,229.16,229.28],'cm^-1')),
        HinderedRotor(inertia=(0.12603,'amu*angstrom^2'), symmetry=1, barrier=(4.69483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125777,'amu*angstrom^2'), symmetry=1, barrier=(4.69583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600457,'amu*angstrom^2'), symmetry=1, barrier=(22.4749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1154.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,193,295,551,588,656,1146,1192,1350,210.822,1058.18],'cm^-1')),
        HinderedRotor(inertia=(0.216468,'amu*angstrom^2'), symmetry=1, barrier=(7.09211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229904,'amu*angstrom^2'), symmetry=1, barrier=(7.08355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1119.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,486,617,768,1157,1926,180,468.026],'cm^-1')),
        HinderedRotor(inertia=(0.107992,'amu*angstrom^2'), symmetry=1, barrier=(2.48295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105735,'amu*angstrom^2'), symmetry=1, barrier=(2.43104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0978146,'amu*angstrom^2'), symmetry=1, barrier=(16.5142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59857,'amu*angstrom^2'), symmetry=1, barrier=(36.7542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(87)', 'OCC(F)(F)F(1770)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(153)', 'F[C]CC(F)(F)F(1874)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC(F)=CC(F)(F)F(990)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)(F)F(254)', 'CH2CF2(56)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)CC(F)(F)F(1875)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)C[C](F)F(1876)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', 'F[C](F)CC(F)(F)F(1071)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)CC(F)(F)F(367)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(232)', '[CH2]C(F)(F)F(1097)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF3(44)', '[CH2]C(O)(F)F(1003)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]C(F)(F)F(1822)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)CC(F)(F)F(1877)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'OC(F)=CC(F)(F)F(1828)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'OC(F)(F)C=C(F)F(737)'],
    products = ['OC(F)(F)CC(F)(F)F(1201)'],
...
network(
    label = 'PDepNetwork #505',
    isomers = [
        'OC(F)(F)CC(F)(F)F(1201)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CH2CF2(56)'),
        ('O[C](F)F(232)', '[CH2]C(F)(F)F(1097)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
