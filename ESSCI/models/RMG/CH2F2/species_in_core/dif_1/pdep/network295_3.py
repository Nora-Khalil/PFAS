...
"""),
    ...
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86964,0.0508581,-7.79827e-05,5.94747e-08,-1.78386e-11,-57411.1,19.6868], Tmin=(100,'K'), Tmax=(818.882,'K')), NASAPolynomial(coeffs=[9.84673,0.0118931,-6.60907e-06,1.36914e-09,-9.96668e-14,-58717.5,-17.2043], Tmin=(818.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)F(521)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04091,0.0460852,-6.66518e-05,4.88823e-08,-1.41256e-11,-55167.2,18.5214], Tmin=(100,'K'), Tmax=(849.391,'K')), NASAPolynomial(coeffs=[9.34987,0.0116658,-5.86864e-06,1.1754e-09,-8.42624e-14,-56408.8,-15.547], Tmin=(849.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-459.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-283.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,180,180,426.373,1068.44,1068.44,1068.44,1068.44,1068.44,1068.44,1068.44],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0255,'amu'),
...
"""),
    E0 = (-262.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,419.557,419.561,419.572,419.618,743.745,1286.48,1286.49,1286.5,1286.51,1286.52],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0255,'amu'),
...
"""),
    E0 = (-474.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([462.642,462.653,462.66,462.739,462.81,462.963,561.268,1241.03,1241.12,1241.14,1241.15,1241.16],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0159,'amu'),
...
"""),
    E0 = (-29.4903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,235.296,802.191,802.351,802.378,802.492,802.599,802.676],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14413,0.0129867,6.6087e-06,-2.08032e-08,9.56909e-12,-3510.75,9.45212], Tmin=(100,'K'), Tmax=(957.7,'K')), NASAPolynomial(coeffs=[8.89009,0.00340752,-9.72891e-07,1.96217e-10,-1.66694e-14,-5272.62,-21.4729], Tmin=(957.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.4903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + ring(Cyclopropene)"""),
)
...
"""),
    E0 = (-171.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,180,180,707.438,1198.47,1198.53,1198.54,1198.59,1198.6],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0175,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.975,0.0268777,-4.73722e-05,4.88838e-08,-1.95184e-11,-20549.3,10.7701], Tmin=(100,'K'), Tmax=(799.924,'K')), NASAPolynomial(coeffs=[3.275,0.0158257,-8.73648e-06,1.75678e-09,-1.24506e-13,-20291.7,11.2999], Tmin=(799.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(CdCFO) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + ring(Cyclopropene)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0777301,'amu*angstrom^2'), symmetry=1, barrier=(1.78717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541413,'amu*angstrom^2'), symmetry=1, barrier=(12.4482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70475,0.0601571,-0.000120127,1.16867e-07,-4.23077e-11,-16273.9,19.388], Tmin=(100,'K'), Tmax=(854.961,'K')), NASAPolynomial(coeffs=[5.83697,0.019309,-1.0713e-05,2.11545e-09,-1.46161e-13,-16194.1,4.69868], Tmin=(854.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O(6)', 'CHFCF2(54)'],
    products = ['[O]C(F)[C](F)F(371)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)[C](F)F(371)'],
    products = ['FC1OC1(F)F(286)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(42)', 'CHFO(46)'],
    products = ['[O]C(F)[C](F)F(371)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(23.5761,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[C](F)F(526)'],
    products = ['[O]C(F)[C](F)F(371)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(514)'],
    products = ['FC1OC1(F)F(286)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]1OC1(F)F(516)'],
    products = ['FC1OC1(F)F(286)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(518)'],
    products = ['FC1OC1(F)F(286)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(8.28222,'m^3/(mol*s)'), n=1.29695, Ea=(121.554,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)
