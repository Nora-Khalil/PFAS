...
"""),
    E0 = (-468.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,3000,3100,440,815,1455,1000,232.367,233.547,1730.4],'cm^-1')),
        HinderedRotor(inertia=(0.233537,'amu*angstrom^2'), symmetry=1, barrier=(8.98848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234183,'amu*angstrom^2'), symmetry=1, barrier=(9.0032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774525,'amu*angstrom^2'), symmetry=1, barrier=(29.5513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1715,0.0679481,-0.000105768,8.99521e-08,-3.08725e-11,-56193,23.434], Tmin=(100,'K'), Tmax=(734.861,'K')), NASAPolynomial(coeffs=[9.02797,0.0236935,-1.23934e-05,2.48331e-09,-1.76862e-13,-57307.4,-11.7748], Tmin=(734.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.129843,'amu*angstrom^2'), symmetry=1, barrier=(2.98534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00862361,'amu*angstrom^2'), symmetry=1, barrier=(28.9961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99973,0.0247759,-2.47363e-05,1.68855e-08,-5.47156e-12,-4070.71,13.9787], Tmin=(100,'K'), Tmax=(707.376,'K')), NASAPolynomial(coeffs=[4.33729,0.0172122,-8.69677e-06,1.76857e-09,-1.28775e-13,-4259.93,7.98884], Tmin=(707.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.1244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(H)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74822,0.0259444,0.00021026,-1.19631e-06,1.86188e-09,-80577,11.9015], Tmin=(10,'K'), Tmax=(234.712,'K')), NASAPolynomial(coeffs=[5.15331,0.0320696,-2.10633e-05,6.58775e-09,-7.87112e-13,-80725.8,5.39471], Tmin=(234.712,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-669.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""COC(F)DC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.136245,'amu*angstrom^2'), symmetry=1, barrier=(3.13254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27292,0.0671095,-0.000111461,1.01858e-07,-3.67405e-11,-56731.1,23.9536], Tmin=(100,'K'), Tmax=(797.12,'K')), NASAPolynomial(coeffs=[7.21272,0.0262437,-1.37492e-05,2.73187e-09,-1.92622e-13,-57326.7,-1.15168], Tmin=(797.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[C](F)[C](F)F(1658)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-452.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,180,180,1627.97],'cm^-1')),
        HinderedRotor(inertia=(0.236315,'amu*angstrom^2'), symmetry=1, barrier=(5.43334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236291,'amu*angstrom^2'), symmetry=1, barrier=(5.43281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236251,'amu*angstrom^2'), symmetry=1, barrier=(5.43187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40457,0.0671052,-0.00012091,1.19221e-07,-4.50072e-11,-54332.9,24.1417], Tmin=(100,'K'), Tmax=(822.611,'K')), NASAPolynomial(coeffs=[4.42181,0.0311771,-1.66357e-05,3.30203e-09,-2.31636e-13,-54110.1,14.5458], Tmin=(822.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]O[CH]C(F)(F)F(1659)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56996,0.0585966,-8.00573e-05,5.77385e-08,-1.55548e-11,-61367.7,23.3375], Tmin=(100,'K'), Tmax=(650.138,'K')), NASAPolynomial(coeffs=[8.61307,0.0218621,-1.05275e-05,2.05214e-09,-1.44498e-13,-62423,-8.68136], Tmin=(650.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = 'FCO[CH][C](F)F(1230)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18233,0.0689752,-0.000114622,1.03155e-07,-3.6505e-11,-56504,24.7001], Tmin=(100,'K'), Tmax=(805.926,'K')), NASAPolynomial(coeffs=[7.86678,0.0250777,-1.2966e-05,2.55783e-09,-1.79434e-13,-57233.3,-3.9462], Tmin=(805.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]O[CH]F(1227)'],
    products = ['[CH2]OC(F)[C](F)F(1563)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]OC(F)[C](F)F(1563)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(35.7327,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(1655)'],
    products = ['[CH2]OC(F)[C](F)F(1563)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(47.1298,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[CH]F(1227)'],
    products = ['[CH2]OC(F)[C](F)F(1563)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(1563)'],
    products = ['[CH2]O[CH]C(F)(F)F(1659)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(5.38157e+14,'s^-1'), n=-0.447076, Ea=(167.016,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]OC(F)[C](F)F(1563)'],
    products = ['FCO[CH][C](F)F(1230)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(226.322,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
