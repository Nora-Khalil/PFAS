...
"""),
    E0 = (-548.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([377,639,914,1335,180.187,180.566,183.996,194.109,1309.26,1310.32,1311.14,1311.22,1312.44,1312.65],'cm^-1')),
        HinderedRotor(inertia=(0.0459977,'amu*angstrom^2'), symmetry=1, barrier=(56.2086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.71603,0.0199589,-8.12261e-06,3.65593e-10,1.339e-13,-66021.9,11.5686], Tmin=(100,'K'), Tmax=(2713.46,'K')), NASAPolynomial(coeffs=[36.7763,-0.013288,2.50918e-06,-3.43144e-10,2.38337e-14,-88580,-184.614], Tmin=(2713.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-548.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sF1sCO)) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-317.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,280,501,1494,1531,180,180,180,180,571.345,1508.49,1510.28],'cm^-1')),
        HinderedRotor(inertia=(0.0361107,'amu*angstrom^2'), symmetry=1, barrier=(58.398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.53535,'amu*angstrom^2'), symmetry=1, barrier=(58.2927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92255,0.0558789,-0.000109357,1.09403e-07,-4.05784e-11,-38083.3,19.8616], Tmin=(100,'K'), Tmax=(861.319,'K')), NASAPolynomial(coeffs=[3.50506,0.024548,-1.30297e-05,2.51858e-09,-1.72243e-13,-37466.3,17.6271], Tmin=(861.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH)) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-347.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([254,363,525,544,658,1137,1402,1855,455,950,2386.39],'cm^-1')),
        HinderedRotor(inertia=(0.474975,'amu*angstrom^2'), symmetry=1, barrier=(10.9206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10619,0.0543275,-0.000122232,1.26483e-07,-4.68852e-11,-41690.7,17.5876], Tmin=(100,'K'), Tmax=(879.3,'K')), NASAPolynomial(coeffs=[2.81792,0.0201227,-1.10556e-05,2.13906e-09,-1.44608e-13,-40618.7,21.0528], Tmin=(879.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sF1sCO)) + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)
...
"""),
    ...
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46733,0.0419791,-7.68448e-05,8.10137e-08,-3.19633e-11,-50884,19.0031], Tmin=(100,'K'), Tmax=(838.689,'K')), NASAPolynomial(coeffs=[1.48849,0.0267359,-1.397e-05,2.72726e-09,-1.89207e-13,-50019.5,27.7281], Tmin=(838.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(CsCFFO) + ring(Cs(O2)-Cs(F)(F)-O2s) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-318.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,280,501,1494,1531,460.622,460.627,460.63,460.63,460.632,460.635,460.645],'cm^-1')),
        HinderedRotor(inertia=(0.000794473,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000794523,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17265,0.0476225,-8.31834e-05,8.5075e-08,-3.38193e-11,-38194.9,19.2615], Tmin=(100,'K'), Tmax=(798.356,'K')), NASAPolynomial(coeffs=[2.94922,0.027606,-1.52777e-05,3.07031e-09,-2.17527e-13,-37805,18.9084], Tmin=(798.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCOF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(266)'],
    products = ['[O]C(=O)C([O])(F)F(248)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(271)'],
    products = ['[O]C(=O)C([O])(F)F(248)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(257)', '[O][C]=O(141)'],
    products = ['[O]C(=O)C([O])(F)F(248)'],
