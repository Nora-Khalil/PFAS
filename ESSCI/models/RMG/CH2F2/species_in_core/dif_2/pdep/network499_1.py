...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.480176,'amu*angstrom^2'), symmetry=1, barrier=(11.0402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37289,'amu*angstrom^2'), symmetry=1, barrier=(31.5654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.479582,'amu*angstrom^2'), symmetry=1, barrier=(11.0265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    ...
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.73062,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[C](F)OC(F)F(1236)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)O[CH]F(1237)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(232)', '[O]C(F)F(170)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(81)', '[O]C(O)(F)F(323)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(4)', 'F[C](F)OC(F)F(258)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)F(711)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)F(769)'],
    products = ['OC(F)(F)OC(F)F(1195)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(170.723,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

network(
    label = 'PDepNetwork #499',
    isomers = [
        'OC(F)(F)OC(F)F(1195)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CHFO(46)'),
        ('O[C](F)F(232)', '[O]C(F)F(170)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
