...
"""),
    E0 = (-302.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,282.216,283.723,4000],'cm^-1')),
        HinderedRotor(inertia=(0.384274,'amu*angstrom^2'), symmetry=1, barrier=(21.6086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379917,'amu*angstrom^2'), symmetry=1, barrier=(21.6249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15653,0.0567821,-5.60201e-05,2.76571e-08,-5.34977e-12,-36256.5,25.5036], Tmin=(100,'K'), Tmax=(1261.69,'K')), NASAPolynomial(coeffs=[14.5385,0.0143566,-5.58117e-06,1.0056e-09,-6.887e-14,-39633.3,-42.1675], Tmin=(1261.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69661,0.0242908,-7.63705e-06,-9.31801e-09,6.21013e-12,13330.3,14.3522], Tmin=(100,'K'), Tmax=(924.139,'K')), NASAPolynomial(coeffs=[8.66416,0.00984172,-2.65662e-06,4.14897e-10,-2.77491e-14,11741.3,-16.5963], Tmin=(924.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.174504,'amu*angstrom^2'), symmetry=1, barrier=(4.01219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173345,'amu*angstrom^2'), symmetry=1, barrier=(3.98555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85086,0.0534167,-8.25258e-05,7.69593e-08,-2.85937e-11,705.562,20.6253], Tmin=(100,'K'), Tmax=(806.808,'K')), NASAPolynomial(coeffs=[4.76331,0.0276677,-1.36269e-05,2.65376e-09,-1.85498e-13,603.698,9.48072], Tmin=(806.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.27255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.324536,0.0667377,-7.19642e-05,3.67102e-08,-7.00302e-12,-61530.5,22.2963], Tmin=(100,'K'), Tmax=(1447.1,'K')), NASAPolynomial(coeffs=[19.4931,0.0057592,-4.70531e-07,-4.36423e-11,6.02918e-15,-66241.2,-74.3728], Tmin=(1447.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)C[C]1CO1(3589)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26291,0.0636221,-8.92596e-05,6.94719e-08,-2.07229e-11,-18776,23.0259], Tmin=(100,'K'), Tmax=(984.671,'K')), NASAPolynomial(coeffs=[8.24362,0.0226319,-7.57319e-06,1.13757e-09,-6.54144e-14,-19538.3,-7.43442], Tmin=(984.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C]1CC(F)(F)C1(3590)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59718,0.0456059,-2.90879e-05,6.47166e-09,2.36976e-13,-22961.1,20.81], Tmin=(100,'K'), Tmax=(1205.81,'K')), NASAPolynomial(coeffs=[12.3753,0.0194,-8.36614e-06,1.58198e-09,-1.10786e-13,-26254.5,-36.0837], Tmin=(1205.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsCsFF) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])CC1(F)F(3591)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32175,0.0584806,-6.4561e-05,3.73851e-08,-8.62887e-12,-41000.7,23.5986], Tmin=(100,'K'), Tmax=(1054.07,'K')), NASAPolynomial(coeffs=[11.8523,0.0185181,-7.69083e-06,1.4157e-09,-9.76144e-14,-43220.7,-27.7597], Tmin=(1054.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C[C](F)F(3593)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {11,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800788,0.0642738,-6.74608e-05,3.18248e-08,-4.85906e-12,-38460.4,24.1104], Tmin=(100,'K'), Tmax=(977.003,'K')), NASAPolynomial(coeffs=[16.7515,0.0108022,-3.53277e-06,5.99536e-10,-4.10997e-14,-42141.9,-55.3615], Tmin=(977.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = '[CH]=C(O)C[C](F)F(3594)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-193.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,190,488,555,1236,1407,3120,650,792.5,1650,231.847],'cm^-1')),
        HinderedRotor(inertia=(0.436225,'amu*angstrom^2'), symmetry=1, barrier=(16.6271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437216,'amu*angstrom^2'), symmetry=1, barrier=(16.628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437899,'amu*angstrom^2'), symmetry=1, barrier=(16.6255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.518086,0.0665983,-7.31889e-05,3.82639e-08,-7.60509e-12,-23085.2,26.6983], Tmin=(100,'K'), Tmax=(1293.43,'K')), NASAPolynomial(coeffs=[18.9407,0.00745743,-2.08848e-06,3.21008e-10,-2.08343e-14,-27669.5,-66.2191], Tmin=(1293.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])CC(F)F(3595)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-256.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,3120,650,792.5,1650,289.957,296.848],'cm^-1')),
        HinderedRotor(inertia=(0.181956,'amu*angstrom^2'), symmetry=1, barrier=(11.0684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185865,'amu*angstrom^2'), symmetry=1, barrier=(11.0403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11131,0.0619672,-6.94011e-05,3.94626e-08,-8.83143e-12,-30746.9,24.1351], Tmin=(100,'K'), Tmax=(1092.2,'K')), NASAPolynomial(coeffs=[13.5529,0.0164011,-6.82071e-06,1.26356e-09,-8.77025e-14,-33464.6,-36.9857], Tmin=(1092.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19478,0.0448707,-3.97111e-05,2.25988e-08,-6.23056e-12,-62398.7,19.7733], Tmin=(100,'K'), Tmax=(805.118,'K')), NASAPolynomial(coeffs=[4.7122,0.0323634,-1.64084e-05,3.30288e-09,-2.38785e-13,-62804.1,8.17393], Tmin=(805.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(CdCFF)"""),
)

species(
    label = '[CH2][C]1CC(F)(F)O1(3598)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49915,0.0593133,-7.92848e-05,6.35542e-08,-2.1228e-11,-26848.6,21.4487], Tmin=(100,'K'), Tmax=(750.412,'K')), NASAPolynomial(coeffs=[7.27438,0.0273283,-1.29495e-05,2.48939e-09,-1.73779e-13,-27681.5,-4.52985], Tmin=(750.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC([O])=C[C](F)F(3599)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C(=C)[O](3587)'],
    products = ['C=C([O])C[C](F)F(3319)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(2840)'],
    products = ['C=C([O])C[C](F)F(3319)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C[C](F)F(3319)'],
    products = ['[CH2]C1([O])CC1(F)F(3591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(3448)'],
    products = ['C=C([O])C[C](F)F(3319)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]C(=C)[O](3587)'],
    products = ['C=C([O])C[C](F)F(3319)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C([O])C[C](F)F(3319)'],
    products = ['[CH2][C]1CC(F)(F)O1(3598)'],
