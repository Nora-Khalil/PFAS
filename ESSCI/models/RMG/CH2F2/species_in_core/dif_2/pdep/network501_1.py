...
reaction(
    label = 'reaction3',
    reactants = ['CHF(86)', 'FOC(F)OF(1208)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[CH]OC(F)F(1209)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)OF(1210)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)OC(F)F(1211)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(177)', '[O]C(F)F(170)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF2(81)', '[O]C(F)OF(481)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(154)', 'F[CH]OC(F)F(600)'],
    products = ['FOC(F)OC(F)F(1197)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FO[C](F)OC(F)F(709)'],
    products = ['FOC(F)OC(F)F(1197)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FOC(F)O[C](F)F(1212)'],
    products = ['FOC(F)OC(F)F(1197)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(106)', 'O=COC(F)F(219)'],
    products = ['FOC(F)OC(F)F(1197)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)F(430)'],
    products = ['FOC(F)OC(F)F(1197)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FOC(F)OC(F)F(1197)'],
    products = ['F2(106)', 'CHFO(46)', 'CHFO(46)'],
