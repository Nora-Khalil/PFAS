...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43309,0.0217557,2.13597e-05,-5.43763e-08,2.57342e-11,35084.9,15.367], Tmin=(100,'K'), Tmax=(913.224,'K')), NASAPolynomial(coeffs=[15.0499,-0.000117369,2.44369e-06,-5.30933e-10,3.35724e-14,31388.2,-51.9794], Tmin=(913.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34784,'amu*angstrom^2'), symmetry=1, barrier=(30.9896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34511,'amu*angstrom^2'), symmetry=1, barrier=(30.9267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0552,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29724,0.0273106,-9.98051e-07,-3.00096e-08,1.6845e-11,30047.2,11.2127], Tmin=(100,'K'), Tmax=(914.819,'K')), NASAPolynomial(coeffs=[15.0392,-0.00160281,2.46719e-06,-5.11591e-10,3.26296e-14,26594.4,-55.2548], Tmin=(914.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (338.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,207.88],'cm^-1')),
        HinderedRotor(inertia=(0.500942,'amu*angstrom^2'), symmetry=1, barrier=(15.8883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499386,'amu*angstrom^2'), symmetry=1, barrier=(15.8901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53118,0.0255655,-3.74039e-06,-1.83314e-08,1.0422e-11,40817.1,15.6576], Tmin=(100,'K'), Tmax=(927.149,'K')), NASAPolynomial(coeffs=[10.8838,0.00685768,-1.5076e-06,2.20897e-10,-1.59683e-14,38523.5,-28.0233], Tmin=(927.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(66)', '[CH]=C[O](2806)'],
    products = ['[CH]=CO[CH2](2932)'],
    transitionState = 'TS2',
