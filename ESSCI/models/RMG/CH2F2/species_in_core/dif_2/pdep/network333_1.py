...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[CH2]C([O])(F)F(732)'],
    products = ['[CH2]C(F)(F)O[C]=O(794)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(66)', 'O=[C]O[C](F)F(282)'],
    products = ['[CH2]C(F)(F)O[C]=O(794)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[CH2]C([O])(F)F(732)'],
    products = ['[CH2]C(F)(F)O[C]=O(794)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C]=O(877)'],
    products = ['[CH2]C(F)(F)O[C]=O(794)'],
    transitionState = 'TS7',
