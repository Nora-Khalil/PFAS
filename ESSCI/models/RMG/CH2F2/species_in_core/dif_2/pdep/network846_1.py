...
"""),
    E0 = (-427.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,386.819,387.71,388.188],'cm^-1')),
        HinderedRotor(inertia=(0.265997,'amu*angstrom^2'), symmetry=1, barrier=(28.2475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265335,'amu*angstrom^2'), symmetry=1, barrier=(28.243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264159,'amu*angstrom^2'), symmetry=1, barrier=(28.2366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84394,0.0297613,2.60762e-05,-6.8223e-08,3.15233e-11,-51324.8,19.5159], Tmin=(100,'K'), Tmax=(940.382,'K')), NASAPolynomial(coeffs=[19.2577,0.000415748,1.54356e-06,-2.54694e-10,8.27092e-15,-56577.5,-73.9399], Tmin=(940.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-31.3248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,419.686,419.686,419.69,419.692,419.696],'cm^-1')),
        HinderedRotor(inertia=(0.000957064,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18824,'amu*angstrom^2'), symmetry=1, barrier=(23.5292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188242,'amu*angstrom^2'), symmetry=1, barrier=(23.5292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45439,0.0550334,-6.39598e-05,3.62131e-08,-8.00725e-12,-3674.95,20.7226], Tmin=(100,'K'), Tmax=(1106.59,'K')), NASAPolynomial(coeffs=[13.3396,0.012072,-5.72504e-06,1.12951e-09,-8.12103e-14,-6305.37,-37.8204], Tmin=(1106.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'O[CH]O[CH]OF(2105)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (-69.7626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,180,180,669.87,669.874],'cm^-1')),
        HinderedRotor(inertia=(0.0569937,'amu*angstrom^2'), symmetry=1, barrier=(12.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0403504,'amu*angstrom^2'), symmetry=1, barrier=(12.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558819,'amu*angstrom^2'), symmetry=1, barrier=(12.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558819,'amu*angstrom^2'), symmetry=1, barrier=(12.8483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.715063,0.0759107,-0.000126409,9.98367e-08,-2.99873e-11,-8275.66,22.688], Tmin=(100,'K'), Tmax=(894.759,'K')), NASAPolynomial(coeffs=[14.1301,0.00948486,-4.23048e-06,7.42022e-10,-4.722e-14,-10417.9,-39.096], Tmin=(894.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.7626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCJO)"""),
)
...
"""),
    E0 = (-334.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,534.548,534.647,534.715],'cm^-1')),
        HinderedRotor(inertia=(0.000589386,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227965,'amu*angstrom^2'), symmetry=1, barrier=(46.2775,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89275,0.0142604,2.98241e-05,-4.65688e-08,1.76371e-11,-40197.9,16.0585], Tmin=(100,'K'), Tmax=(1016.29,'K')), NASAPolynomial(coeffs=[9.44068,0.0135447,-6.1013e-06,1.25702e-09,-9.53415e-14,-42822.7,-22.0034], Tmin=(1016.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79262,0.0222941,-9.08437e-06,-2.4031e-09,1.8225e-12,-20487.5,13.1527], Tmin=(100,'K'), Tmax=(1184.75,'K')), NASAPolynomial(coeffs=[8.25878,0.0116085,-5.39244e-06,1.05479e-09,-7.52243e-14,-22328,-16.4462], Tmin=(1184.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""CH2OCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-231.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1855,455,950,217.214,217.237,217.271],'cm^-1')),
        HinderedRotor(inertia=(0.951662,'amu*angstrom^2'), symmetry=1, barrier=(31.8974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.952256,'amu*angstrom^2'), symmetry=1, barrier=(31.8977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.952563,'amu*angstrom^2'), symmetry=1, barrier=(31.8983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64073,0.0374463,-1.71748e-06,-4.0416e-08,2.24074e-11,-27693,18.8731], Tmin=(100,'K'), Tmax=(927.986,'K')), NASAPolynomial(coeffs=[19.5698,-0.00263425,2.93713e-06,-5.6108e-10,3.27424e-14,-32622.4,-74.9147], Tmin=(927.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C=O(135)', '[CH2]OF(1634)'],
    products = ['O=COCOF(2098)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(154)', '[CH2]OC=O(2013)'],
    products = ['O=COCOF(2098)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
