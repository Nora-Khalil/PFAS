...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(339)'],
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(361)'],
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(75.4064,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(380)'],
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(9.91873,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(88)', 'F[C](F)O[C](F)F(361)'],
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(4.05042,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(376)'],
    products = ['F[CH]C(F)(F)O[C](F)F(339)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(339)'],
    products = ['F[CH][C](F)OC(F)(F)F(381)'],
