...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(509)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=CF(507)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(106)', 'F[CH]C(F)=C(F)[CH]F(508)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(86)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(368)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(509)'],
