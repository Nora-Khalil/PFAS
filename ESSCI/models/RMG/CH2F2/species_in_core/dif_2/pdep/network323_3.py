...
"""),
    E0 = (-67.1834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,180,180,180,1651.24,1651.77,1651.92,1652.11,1652.21],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0175,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88954,0.0402429,-0.000108338,1.2864e-07,-5.2141e-11,-8055.5,11.7343], Tmin=(100,'K'), Tmax=(866.191,'K')), NASAPolynomial(coeffs=[-3.25781,0.0277901,-1.60482e-05,3.17555e-09,-2.18683e-13,-5458.43,49.3526], Tmin=(866.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.1834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(CdCFO) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + ring(oxirene)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)[C](F)F(386)'],
    products = ['FC1OC1(F)F(275)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(387)'],
    products = ['FC1OC1(F)F(275)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]1OC1(F)F(389)'],
    products = ['FC1OC1(F)F(275)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(391)'],
    products = ['FC1OC1(F)F(275)'],
