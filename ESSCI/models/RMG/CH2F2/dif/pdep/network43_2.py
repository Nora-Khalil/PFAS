...
reaction(
    label = 'reaction3',
    reactants = ['OH(4)', 'CO(12)'],
    products = ['O=[C]O(164)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(4.34514,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[O][C]=O(141)'],
    products = ['O=[C]O(164)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C=O(135)'],
    products = ['[CH]1OO1(132)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(310.953,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 309.5 to 311.0 kJ/mol to match endothermicity of reaction."""),
)
