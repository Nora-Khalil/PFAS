...
reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'OC(O)(F)F(1143)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[C](F)OC(F)F(1144)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)O[CH]F(1145)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(220)', '[O]C(F)F(146)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(81)', '[O]C(O)(F)F(257)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)F(572)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)F(624)'],
    products = ['OC(F)(F)OC(F)F(1107)'],
...
network(
    label = 'PDepNetwork #423',
    isomers = [
        'OC(F)(F)OC(F)F(1107)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CHFO(46)'),
        ('O[C](F)F(220)', '[O]C(F)F(146)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
