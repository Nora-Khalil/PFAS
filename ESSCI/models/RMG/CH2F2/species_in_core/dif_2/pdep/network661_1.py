...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.61912,'amu*angstrom^2'), symmetry=1, barrier=(14.2348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92897,0.0501247,-7.24391e-05,5.46042e-08,-1.56376e-11,-10212,17.6887], Tmin=(100,'K'), Tmax=(649.478,'K')), NASAPolynomial(coeffs=[8.13551,0.0172054,-8.66371e-06,1.7185e-09,-1.22011e-13,-11130.1,-10.437], Tmin=(649.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.4923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sCdH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10045,0.035391,-2.30396e-05,4.35048e-09,4.35281e-13,-22882,17.3379], Tmin=(100,'K'), Tmax=(1274.67,'K')), NASAPolynomial(coeffs=[12.6728,0.0116022,-6.0928e-06,1.26494e-09,-9.27513e-14,-26339.9,-39.2247], Tmin=(1274.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.599344,'amu*angstrom^2'), symmetry=1, barrier=(13.7801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65429,0.0573879,-9.86631e-05,8.84078e-08,-3.08164e-11,-5930.54,19.7777], Tmin=(100,'K'), Tmax=(815.699,'K')), NASAPolynomial(coeffs=[7.87644,0.0178491,-9.35485e-06,1.84982e-09,-1.29564e-13,-6645.32,-7.13228], Tmin=(815.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.9652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sO2sH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (149.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,167,640,1190,403.96,404.645],'cm^-1')),
        HinderedRotor(inertia=(0.0161475,'amu*angstrom^2'), symmetry=1, barrier=(27.9064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239683,'amu*angstrom^2'), symmetry=1, barrier=(27.9074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08862,0.0402065,-3.77605e-05,1.72254e-08,-3.10648e-12,18096.2,19.8659], Tmin=(100,'K'), Tmax=(1329.67,'K')), NASAPolynomial(coeffs=[11.5405,0.0117727,-5.68419e-06,1.14298e-09,-8.27131e-14,15582.6,-28.4271], Tmin=(1329.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CCJO) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=CF(1120)'],
    products = ['[O]C(F)C=[C]F(1609)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(F)C=[C]F(1097)'],
    products = ['[O]C(F)C=[C]F(1609)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C=C=[C]F(1622)'],
    products = ['[O]C(F)C=[C]F(1609)'],
