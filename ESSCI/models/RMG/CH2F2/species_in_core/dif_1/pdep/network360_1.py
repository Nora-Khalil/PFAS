...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(68)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)F(918)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C([O])(F)F(919)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(108)', '[CH2][C](F)C(=O)F(920)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)C(F)(F)OF(921)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[C](F)OF(923)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(870)'],
