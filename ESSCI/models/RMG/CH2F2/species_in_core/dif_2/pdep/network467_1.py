...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.160728,'amu*angstrom^2'), symmetry=1, barrier=(3.69545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-346.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([190,359,486,598,681,1014,1151,334,575,1197,1424,3202,2175,525,239,401,1367,180,217.327],'cm^-1')),
        HinderedRotor(inertia=(1.7733,'amu*angstrom^2'), symmetry=1, barrier=(40.7717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0101269,'amu*angstrom^2'), symmetry=1, barrier=(40.7713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.372329,'amu*angstrom^2'), symmetry=1, barrier=(74.1931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54485,0.0618994,-0.000110674,1.05465e-07,-3.89175e-11,-2521.5,22.1153], Tmin=(100,'K'), Tmax=(808.794,'K')), NASAPolynomial(coeffs=[6.2178,0.0240757,-1.32393e-05,2.66016e-09,-1.87992e-13,-2796.17,3.53766], Tmin=(808.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.6362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCdd)(F1s)(H)) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.302706,'amu*angstrom^2'), symmetry=1, barrier=(6.95982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670962,'amu*angstrom^2'), symmetry=1, barrier=(15.4267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981064,0.0750532,-0.000129723,1.20488e-07,-4.36582e-11,-35967.3,25.3956], Tmin=(100,'K'), Tmax=(807.987,'K')), NASAPolynomial(coeffs=[7.39293,0.0283294,-1.51701e-05,3.02257e-09,-2.12847e-13,-36514.5,-1.14475], Tmin=(807.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[CH]F(1058)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[C]C=C(F)F(1096)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]=CC(F)=CF(1184)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC#CC(F)(F)[CH]F(1185)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[C]=C=C(F)[CH]F(1186)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(86)', 'F[C]C=C(F)F(1096)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)[C]=CF(1187)'],
    products = ['F[C]=CC(F)(F)[CH]F(1058)'],
