...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.275843,'amu*angstrom^2'), symmetry=1, barrier=(6.34217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275196,'amu*angstrom^2'), symmetry=1, barrier=(6.32729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275374,'amu*angstrom^2'), symmetry=1, barrier=(6.33138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.713716,0.0822925,-0.000144914,1.33388e-07,-4.7021e-11,-56239,27.6424], Tmin=(100,'K'), Tmax=(848.551,'K')), NASAPolynomial(coeffs=[7.62063,0.0292654,-1.49938e-05,2.8889e-09,-1.98265e-13,-56674.3,-0.203056], Tmin=(848.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512626,0.0889179,-0.000164637,1.544e-07,-5.46255e-11,-57748,27.1661], Tmin=(100,'K'), Tmax=(860.916,'K')), NASAPolynomial(coeffs=[7.42999,0.0300879,-1.56325e-05,3.00437e-09,-2.04871e-13,-57949.9,0.574332], Tmin=(860.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-481.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(CCCJ=O)"""),
)

species(
    label = 'C=C([O])C(F)[C](F)F(3309)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.2944,'amu*angstrom^2'), symmetry=1, barrier=(6.76884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17152,0.0449931,-7.30838e-05,6.55893e-08,-2.28963e-11,-3506.27,18.2369], Tmin=(100,'K'), Tmax=(842.401,'K')), NASAPolynomial(coeffs=[6.00336,0.0177248,-8.37272e-06,1.59164e-09,-1.09159e-13,-3829.91,2.31847], Tmin=(842.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-COHH)(F1s)(H)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48067,0.0479342,-3.27595e-05,9.04961e-09,-4.44664e-13,-83929.7,22.2405], Tmin=(100,'K'), Tmax=(1224.84,'K')), NASAPolynomial(coeffs=[12.9842,0.0191411,-8.2436e-06,1.55448e-09,-1.08587e-13,-87405.9,-38.2772], Tmin=(1224.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFF) + group(Cds-OdCsCs) + longDistanceInteraction_cyclic(Cs(F)2-CO) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cyclobutanone)"""),
)

species(
    label = 'O=CCC(F)=C(F)F(3417)',
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92511,0.0518492,-4.2377e-05,1.66466e-08,-2.7314e-12,-78719.5,20.6838], Tmin=(100,'K'), Tmax=(1357.82,'K')), NASAPolynomial(coeffs=[10.4733,0.0266669,-1.45576e-05,2.98767e-09,-2.16532e-13,-81040.9,-23.1712], Tmin=(1357.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-655.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'O=C=CC(F)C(F)F(3418)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,D}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32404,0.0639758,-7.80252e-05,5.21789e-08,-1.44198e-11,-82654.9,22.8056], Tmin=(100,'K'), Tmax=(869.488,'K')), NASAPolynomial(coeffs=[9.45677,0.0265642,-1.34881e-05,2.69898e-09,-1.93925e-13,-84069.3,-15.2932], Tmin=(869.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83747,0.0433862,-3.22194e-05,1.08233e-08,-1.422e-12,-39127.7,22.1243], Tmin=(100,'K'), Tmax=(1780.42,'K')), NASAPolynomial(coeffs=[15.1504,0.0134762,-7.02007e-06,1.38754e-09,-9.70446e-14,-43868.2,-49.7824], Tmin=(1780.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFF) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73025,0.0559442,-6.02282e-05,3.34579e-08,-7.76065e-12,-59472.9,22.2261], Tmin=(100,'K'), Tmax=(1012.74,'K')), NASAPolynomial(coeffs=[9.67041,0.0245826,-1.37768e-05,2.87942e-09,-2.12064e-13,-61081.1,-16.181], Tmin=(1012.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-495.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.205619,'amu*angstrom^2'), symmetry=1, barrier=(4.72759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870311,'amu*angstrom^2'), symmetry=1, barrier=(20.0102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53358,0.0617743,-7.94407e-05,4.66893e-08,-4.88129e-12,-58213.3,23.8954], Tmin=(100,'K'), Tmax=(564.481,'K')), NASAPolynomial(coeffs=[7.99496,0.0265931,-1.41349e-05,2.84438e-09,-2.03536e-13,-59111.7,-5.07871], Tmin=(564.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-191.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,161,297,490,584,780,1358,1855,455,950],'cm^-1')),
        HinderedRotor(inertia=(0.904498,'amu*angstrom^2'), symmetry=1, barrier=(20.7962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903164,'amu*angstrom^2'), symmetry=1, barrier=(20.7655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83102,0.0575005,-6.37636e-05,-1.62203e-09,3.99017e-11,-23021.8,20.5869], Tmin=(100,'K'), Tmax=(484.623,'K')), NASAPolynomial(coeffs=[7.96509,0.0240925,-1.36639e-05,2.78629e-09,-1.99398e-13,-23818.5,-6.64952], Tmin=(484.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736039,0.0822572,-0.00014626,1.3582e-07,-4.81456e-11,-57551.4,28.269], Tmin=(100,'K'), Tmax=(850.697,'K')), NASAPolynomial(coeffs=[7.20466,0.0299302,-1.53587e-05,2.95843e-09,-2.02885e-13,-57859.1,2.76759], Tmin=(850.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=CC(F)[C](F)F(3424)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-471.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,2995,3025,975,1000,1300,1375,400,500,1630,1680,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00622,'amu*angstrom^2'), symmetry=1, barrier=(23.1351,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948126,0.0642727,-6.62182e-05,3.33261e-08,-6.60121e-12,-56551.2,25.9888], Tmin=(100,'K'), Tmax=(1223.89,'K')), NASAPolynomial(coeffs=[15.5076,0.0166874,-7.89645e-06,1.55704e-09,-1.11713e-13,-60115,-47.1937], Tmin=(1223.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]C(F)C(F)F(3425)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975595,0.0702619,-9.40639e-05,6.68891e-08,-1.90317e-11,-60312.9,25.1713], Tmin=(100,'K'), Tmax=(858.539,'K')), NASAPolynomial(coeffs=[11.2394,0.0224422,-1.0516e-05,2.01355e-09,-1.40591e-13,-62075.3,-22.7805], Tmin=(858.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C](F)[C](F)F(3426)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-437.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,2782.5,750,1395,475,1775,1000,190,488,555,1236,1407,180,1840.59],'cm^-1')),
        HinderedRotor(inertia=(0.30166,'amu*angstrom^2'), symmetry=1, barrier=(6.93576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301971,'amu*angstrom^2'), symmetry=1, barrier=(6.94292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301878,'amu*angstrom^2'), symmetry=1, barrier=(6.94078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.846306,0.0832269,-0.000157861,1.55797e-07,-5.76073e-11,-52577.6,28.3563], Tmin=(100,'K'), Tmax=(852.833,'K')), NASAPolynomial(coeffs=[4.17706,0.0359348,-1.89787e-05,3.68834e-09,-2.53788e-13,-51994,19.5699], Tmin=(852.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]C[CH]C(F)(F)F(3427)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22204,0.0656906,-8.97656e-05,6.78693e-08,-2.08684e-11,-62991.5,27.2683], Tmin=(100,'K'), Tmax=(791.423,'K')), NASAPolynomial(coeffs=[9.34526,0.0246347,-1.19522e-05,2.32264e-09,-1.63289e-13,-64277.3,-10.0214], Tmin=(791.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C(F)C[CH][C](F)F(3428)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11206,0.0711235,-0.000114751,1.04545e-07,-3.77342e-11,-58956.3,28.5072], Tmin=(100,'K'), Tmax=(807.606,'K')), NASAPolynomial(coeffs=[6.67436,0.0306987,-1.57543e-05,3.08441e-09,-2.15554e-13,-59434.9,5.46043], Tmin=(807.606,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(COCsFO) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)[C](F)F(3311)'],
    products = ['CHFCF2(54)', 'CH2CO(75)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'O=[C]C[CH]F(3415)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(222)', '[CH2]C(F)[C](F)F(929)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][C](F)F(183)', '[CH2][C]=O(2901)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C[C](F)F(3422)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(264.777,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CF2(87)', 'O=[C]C[CH]F(3415)'],
    products = ['O=[C]CC(F)[C](F)F(3311)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]CC(F)[C](F)F(3311)'],
    products = ['O=[C][CH]C(F)C(F)F(3425)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)[C](F)F(3311)'],
    products = ['O=[C]C[CH]C(F)(F)F(3427)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]CC(F)[C](F)F(3311)'],
    products = ['O=C(F)C[CH][C](F)F(3428)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(215.841,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
