...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(208)', '[CH]F(125)'],
    products = ['[O]C(=O)O[CH]F(425)'],
    transitionState = 'TS2',
