...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)O(1030)'],
    products = ['O=C(O)OC(=O)F(1009)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(136)', 'O=[C]O(189)'],
    products = ['O=C(O)OC(=O)F(1009)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(513)'],
    products = ['O=C(O)OC(=O)F(1009)'],
