...
"""),
    E0 = (-57.2134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,627.256,627.257,627.257,627.258,951.568,1554.58,1554.58,1554.58],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17397,0.0464429,-8.4546e-05,7.96917e-08,-2.84824e-11,5458.09,18.6478], Tmin=(100,'K'), Tmax=(849.592,'K')), NASAPolynomial(coeffs=[5.69312,0.0166194,-8.48888e-06,1.64701e-09,-1.13471e-13,5338.49,5.05884], Tmin=(849.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43603,0.0332746,-3.37965e-05,1.70828e-08,-3.4046e-12,-28931.2,16.3061], Tmin=(100,'K'), Tmax=(1215.46,'K')), NASAPolynomial(coeffs=[9.738,0.00924404,-4.14002e-06,8.16314e-10,-5.88297e-14,-30706.2,-20.3464], Tmin=(1215.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C[C](F)F(728)'],
    products = ['FC1(F)CO1(1188)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'FC1=CO1(390)'],
    products = ['FC1(F)CO1(1188)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(103.683,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH2][C](F)F(185)'],
    products = ['[CH2]C([O])(F)F(732)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(176)', 'CH2(T)(66)'],
    products = ['[CH2]C([O])(F)F(732)'],
