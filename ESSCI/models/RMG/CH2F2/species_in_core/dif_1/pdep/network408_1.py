species(
    label = '[CH2]C(F)(F)C(F)(F)[CH]F(1033)',
...
"""),
    E0 = (-766.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.110522,'amu*angstrom^2'), symmetry=1, barrier=(2.54113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117412,'amu*angstrom^2'), symmetry=1, barrier=(2.69953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420738,'amu*angstrom^2'), symmetry=1, barrier=(9.67359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.127825,0.101871,-0.000179645,1.62811e-07,-5.69258e-11,-92094,29.2006], Tmin=(100,'K'), Tmax=(828.867,'K')), NASAPolynomial(coeffs=[10.4315,0.0313668,-1.66802e-05,3.28546e-09,-2.28818e-13,-93173,-15.7096], Tmin=(828.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-771.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,190,488,555,1236,1407,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.244964,'amu*angstrom^2'), symmetry=1, barrier=(5.6322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245047,'amu*angstrom^2'), symmetry=1, barrier=(5.63412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244934,'amu*angstrom^2'), symmetry=1, barrier=(5.63151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
...
species(
    label = '[CH2]C(F)(F)C(F)[C](F)F(1035)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-612.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,323,467,575,827,1418,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.317922,'amu*angstrom^2'), symmetry=1, barrier=(7.30965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55921,'amu*angstrom^2'), symmetry=1, barrier=(35.8494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.47866,0.0453194,8.73634e-06,-1.15703e-07,9.96862e-11,-73642.5,13.765], Tmin=(10,'K'), Tmax=(502.697,'K')), NASAPolynomial(coeffs=[7.03391,0.0368903,-2.53735e-05,8.12403e-09,-9.79712e-13,-74250.9,-3.43776], Tmin=(502.697,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-612.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), label="""CDC(F)C(F)(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-302.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,336,431,607,515,611,528,696,1312,1446,234,589,736,816,1240,3237,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.155377,'amu*angstrom^2'), symmetry=1, barrier=(3.57241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141848,'amu*angstrom^2'), symmetry=1, barrier=(55.3534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41856,0.057337,-6.24955e-05,3.48807e-08,-7.76523e-12,-36241.4,21.1833], Tmin=(100,'K'), Tmax=(1087.34,'K')), NASAPolynomial(coeffs=[12.1126,0.0179965,-8.22452e-06,1.6061e-09,-1.14727e-13,-38567,-31.3047], Tmin=(1087.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.235824,'amu*angstrom^2'), symmetry=1, barrier=(5.42206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235819,'amu*angstrom^2'), symmetry=1, barrier=(5.42194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64904,'amu*angstrom^2'), symmetry=1, barrier=(37.9147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0284809,0.101057,-0.000182051,1.70094e-07,-6.11045e-11,-88522,29.2733], Tmin=(100,'K'), Tmax=(825.859,'K')), NASAPolynomial(coeffs=[8.75854,0.0348674,-1.89103e-05,3.754e-09,-2.62662e-13,-89167.5,-6.55886], Tmin=(825.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)C(F)F(1099)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0841175,0.0947985,-0.000157136,1.37983e-07,-4.77272e-11,-92650,28.9836], Tmin=(100,'K'), Tmax=(799.479,'K')), NASAPolynomial(coeffs=[10.7606,0.0304599,-1.59312e-05,3.14924e-09,-2.21097e-13,-94008.1,-17.9522], Tmin=(799.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'F[CH][C](F)C(F)(F)CF(1100)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.656698,'amu*angstrom^2'), symmetry=1, barrier=(15.0988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237067,'amu*angstrom^2'), symmetry=1, barrier=(5.45065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55542,'amu*angstrom^2'), symmetry=1, barrier=(35.7621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143075,0.101959,-0.000178329,1.62028e-07,-5.72832e-11,-89356.3,29.0761], Tmin=(100,'K'), Tmax=(809.74,'K')), NASAPolynomial(coeffs=[10.4468,0.0324436,-1.76865e-05,3.53255e-09,-2.48615e-13,-90507.3,-16.2967], Tmin=(809.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-744.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)[C](F)C(F)F(1085)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0299843,0.102984,-0.00019228,1.83068e-07,-6.6076e-11,-92008.5,30.2048], Tmin=(100,'K'), Tmax=(841.843,'K')), NASAPolynomial(coeffs=[7.74486,0.036014,-1.94498e-05,3.83183e-09,-2.66004e-13,-92253.6,0.353831], Tmin=(841.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(1035)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(68)', 'F[CH]C(F)(F)[C](F)F(394)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C](F)F(918)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    products = ['FC1CC(F)(F)C1(F)F(1067)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[CH]F(1095)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(51.4309,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F[CH][C](F)F(185)', 'CH2CF2(56)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.5756,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=CF(1096)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(48.3948,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHFCF2(54)', '[CH2][C](F)F(187)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.00781142,'m^3/(mol*s)'), n=2.1171, Ea=(8.19698,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3700065605304284, var=1.2130620758961872, Tref=1000.0, N=120, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R_Ext-2R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[CH][C](F)F(185)', '[CH2][C](F)F(187)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(108)', '[CH2]C(F)=C(F)[CH]F(1097)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(12.8438,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CHF(88)', '[CH2]C(F)(F)[C](F)F(918)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)[C](F)CF(1098)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(139.268,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(1099)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(224.932,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['F[CH][C](F)C(F)(F)CF(1100)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(216.381,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1033)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)F(1085)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(182.606,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #408',
    isomers = [
        '[CH2]C(F)(F)C(F)(F)[CH]F(1033)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CF2(56)'),
    ],
