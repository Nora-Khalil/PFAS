...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
...
reaction(
    ...
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)C(F)(F)[C](F)F(617)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)C(F)=C(F)F(384)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(84.2308,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F2(108)', 'O=C(F)[C](F)[C](F)F(387)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)[C](F)[C](F)F(619)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    products = ['[O]C(F)(F)[C](F)C(F)(F)F(620)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)C(F)(F)[C](F)F(621)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(462)'],
    products = ['[O][C](F)C(F)(F)C(F)(F)F(622)'],
