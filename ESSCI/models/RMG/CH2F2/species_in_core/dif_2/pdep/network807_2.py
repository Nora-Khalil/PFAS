...
"""),
    E0 = (-240.886,'kJ/mol'),
    modes = [
        IdealGasTranslation(mass=(80.9952,'amu')),
        NonlinearRotor(inertia=([44.73,134.434,179.163],'amu*angstrom^2'), symmetry=1),
        HarmonicOscillator(frequencies=([204.684,238.859,485.685,497.762,618.309,927.207,1255.19,1318.81,1858.89],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90596,0.00655706,6.55459e-05,-1.79549e-07,1.38955e-10,-28970,10.2853], Tmin=(10,'K'), Tmax=(456.79,'K')), NASAPolynomial(coeffs=[4.65237,0.0149422,-1.09875e-05,3.65912e-09,-4.5294e-13,-29193.9,5.56522], Tmin=(456.79,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-240.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""F[C]DC(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH]C(F)(F)F-2(217)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 F u0 p3 c0 {4,S}
...
"""),
    E0 = (-258.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,346,529,1231,1306,180,1015.28,1015.46,1015.72,1016.53,3574.18],'cm^-1')),
        HinderedRotor(inertia=(0.0987842,'amu*angstrom^2'), symmetry=1, barrier=(2.27124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.0245,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89134,0.0254899,-2.37615e-05,1.09735e-08,-2.07038e-12,-31015.3,11.9194], Tmin=(100,'K'), Tmax=(1240.44,'K')), NASAPolynomial(coeffs=[7.60523,0.0102892,-5.38008e-06,1.09448e-09,-7.9354e-14,-32184.8,-11.838], Tmin=(1240.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsC2sFFF) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', 'F[C]=C(F)F(216)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.4e+34,'cm^3/(mol*s)'), n=-7.11, Ea=(5040,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 199 C2F3 + H <=> C2HF3 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_N-5CF->C_N-Sp-4C-2C_Ext-4C-R]
family: R_Recombination"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH]C(F)(F)F-2(217)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5.73099e+10,'s^-1'), n=0.827, Ea=(113.604,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F2(106)', 'C2HF(57)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'C2F2(96)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.28966e+40,'m^3/(mol*s)'), n=-10.004, Ea=(262.348,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CF2(87)', 'CHF(86)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.1e+24,'cm^3/(mol*s)'), n=-3.8, Ea=(2830,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 4 CHF + CF2-2 <=> C2HF3 in halocarbene_recombination_double/training
This reaction matched rate rule [CF]
family: halocarbene_recombination_double"""),
)

network(
    label = 'PDepNetwork #807',
    isomers = [
        'CHFCF2(54)',
        'F[C]C(F)F(180)',
    ],
