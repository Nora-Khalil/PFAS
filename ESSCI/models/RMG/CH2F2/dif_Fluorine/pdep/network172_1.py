...
"""),
    E0 = (-954.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,223,363,546,575,694,1179,1410,261,493,600,1152,1365,1422,3097,215.247,1600.27],'cm^-1')),
        HinderedRotor(inertia=(0.382214,'amu*angstrom^2'), symmetry=1, barrier=(13.0017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5061,'amu*angstrom^2'), symmetry=1, barrier=(16.5228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18784,'amu*angstrom^2'), symmetry=1, barrier=(39.2286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.854166,'amu*angstrom^2'), symmetry=1, barrier=(19.639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852324,'amu*angstrom^2'), symmetry=1, barrier=(19.5966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.350865,'amu*angstrom^2'), symmetry=1, barrier=(8.06708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350383,'amu*angstrom^2'), symmetry=1, barrier=(8.05599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21904,'amu*angstrom^2'), symmetry=1, barrier=(28.0282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)OF(505)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(172)', 'F[C]C(F)OF(524)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(172)', 'OC(F)(F)[C]F(374)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'OC(F)(F)OF(331)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(376)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(172)', 'FOC=C(F)F(525)'],
    products = ['OC(F)(F)C(F)OF(439)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[C](F)C(F)OF(527)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(528)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(529)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'FOC(F)[C](F)F(530)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(531)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(248)', 'OC(F)(F)[CH]F(532)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(402)', 'O[C](F)F(237)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(379)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(533)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'O=CC(O)(F)F(534)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(385)'],
    products = ['OC(F)(F)C(F)OF(439)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(386)'],
    products = ['OC(F)(F)C(F)OF(439)'],
