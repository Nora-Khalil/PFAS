...
"""),
    ...
    molecularWeight = (76.0082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.58381,-0.035824,0.000219115,-2.8565e-07,1.13712e-10,-37457.4,13.7518], Tmin=(100,'K'), Tmax=(922.45,'K')), NASAPolynomial(coeffs=[28.3375,-0.0272165,1.65766e-05,-3.01203e-09,1.83224e-13,-46957.2,-130.411], Tmin=(922.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(O2s-OsOs) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (60.0088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.47735,0.00697974,9.25552e-06,-1.89202e-08,8.13884e-12,-20466.3,8.68642], Tmin=(100,'K'), Tmax=(959.181,'K')), NASAPolynomial(coeffs=[7.36876,0.00200087,-5.50254e-07,1.22222e-10,-1.12062e-14,-21730.3,-12.6227], Tmin=(959.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), label="""CO3s1""", comment="""Thermo library: primaryThermoLibrary"""),
)

species(
    label = '[O]O[C]1OO1(989)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (76.0082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98587,0.0229599,-2.78587e-05,1.66945e-08,-3.36395e-12,26768.1,15.0958], Tmin=(100,'K'), Tmax=(751.1,'K')), NASAPolynomial(coeffs=[6.70014,0.00671022,-2.45788e-06,4.07369e-10,-2.59419e-14,26110.5,-2.4233], Tmin=(751.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(ROOJ) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (76.0082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.15454,-0.00112271,2.78931e-05,-2.48786e-08,6.21377e-12,32148.6,13.6707], Tmin=(100,'K'), Tmax=(1408.75,'K')), NASAPolynomial(coeffs=[3.63793,0.0177994,-1.08405e-05,2.24686e-09,-1.60835e-13,30562.1,10.1926], Tmin=(1408.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-OsOsOsH) + ring(Cyclobutane) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])OO1(991)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {5,S}
2 O u0 p2 c0 {1,S} {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (76.0082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.71522,0.0198305,-5.84572e-05,8.28681e-08,-3.66397e-11,8774.59,11.5044], Tmin=(100,'K'), Tmax=(874.459,'K')), NASAPolynomial(coeffs=[-6.87605,0.0318086,-1.64468e-05,3.14853e-09,-2.13943e-13,12021.3,69.1529], Tmin=(874.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.9789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + ring(dioxirane) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=O(188)'],
    products = ['[O]OC([O])=O(165)'],
    transitionState = 'TS2',
