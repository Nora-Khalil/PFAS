...
"""),
    E0 = (-410.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,180,180,180,737.743,4000],'cm^-1')),
        HinderedRotor(inertia=(1.24433,'amu*angstrom^2'), symmetry=1, barrier=(28.6096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607607,'amu*angstrom^2'), symmetry=1, barrier=(13.9701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98724,0.0484699,-7.69056e-05,6.26649e-08,-2.02744e-11,-49264.9,16.9419], Tmin=(100,'K'), Tmax=(758.087,'K')), NASAPolynomial(coeffs=[8.64798,0.013326,-7.36986e-06,1.51673e-09,-1.09721e-13,-50274.8,-13.3478], Tmin=(758.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6088,0.0337709,-3.48612e-05,1.95945e-08,-4.68132e-12,-77847.6,14.9817], Tmin=(100,'K'), Tmax=(979.417,'K')), NASAPolynomial(coeffs=[6.80001,0.0166541,-8.64694e-06,1.75139e-09,-1.26883e-13,-78668.6,-5.15136], Tmin=(979.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsFFHO) + group(CJ2_singlet-FO)"""),
)

species(
    label = 'F[CH]OC(F)(F)F(605)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(166)', '[O]C(F)F(170)'],
    products = ['F[C](F)OC(F)F(246)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]O[C](F)F(394)'],
    products = ['F[C](F)OC(F)F(246)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)O[C](F)F(273)'],
    products = ['F[C](F)OC(F)F(246)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(631)'],
    products = ['F[C](F)OC(F)F(246)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)F(246)'],
    products = ['F[CH]OC(F)(F)F(605)'],
