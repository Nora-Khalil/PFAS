...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.165101,'amu*angstrom^2'), symmetry=1, barrier=(8.37921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00362905,'amu*angstrom^2'), symmetry=1, barrier=(8.37915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72528,0.0310823,-2.68024e-05,1.62417e-08,-4.85262e-12,-16036.4,17.2618], Tmin=(100,'K'), Tmax=(748.773,'K')), NASAPolynomial(coeffs=[4.20203,0.0231938,-1.10006e-05,2.17351e-09,-1.55832e-13,-16257.6,10.5645], Tmin=(748.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(RCCJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-263.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180,1549.95],'cm^-1')),
        HinderedRotor(inertia=(0.350438,'amu*angstrom^2'), symmetry=1, barrier=(8.05727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35137,'amu*angstrom^2'), symmetry=1, barrier=(8.07869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6466,0.0612095,-0.000107433,1.06708e-07,-4.05667e-11,-31580.5,21.0662], Tmin=(100,'K'), Tmax=(828.514,'K')), NASAPolynomial(coeffs=[3.4837,0.0316134,-1.6325e-05,3.20292e-09,-2.23397e-13,-31173.5,16.842], Tmin=(828.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = 'O[CH]C[C](F)F(1713)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-313.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,190,488,555,1236,1407,246.43,250.036],'cm^-1')),
        HinderedRotor(inertia=(0.133853,'amu*angstrom^2'), symmetry=1, barrier=(6.10396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125662,'amu*angstrom^2'), symmetry=1, barrier=(6.10295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282244,'amu*angstrom^2'), symmetry=1, barrier=(13.6143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13606,0.0713691,-0.000125409,1.15087e-07,-4.05448e-11,-37562.5,20.8688], Tmin=(100,'K'), Tmax=(840.299,'K')), NASAPolynomial(coeffs=[7.59142,0.024365,-1.24502e-05,2.42002e-09,-1.67283e-13,-38072.8,-5.73238], Tmin=(840.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]CC(F)F(1714)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41472,0.0662521,-0.000116849,1.13351e-07,-4.22408e-11,-34547,19.3671], Tmin=(100,'K'), Tmax=(826.852,'K')), NASAPolynomial(coeffs=[4.81042,0.0301752,-1.57543e-05,3.10091e-09,-2.16536e-13,-34436.8,7.69232], Tmin=(826.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[CH][C](F)F(1715)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {10,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36835,0.0663216,-0.000115976,1.08422e-07,-3.88623e-11,-34596,22.5664], Tmin=(100,'K'), Tmax=(841.705,'K')), NASAPolynomial(coeffs=[6.26265,0.0258068,-1.30231e-05,2.52255e-09,-1.74187e-13,-34808.7,3.42865], Tmin=(841.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]C[O](1710)'],
    products = ['[O]CC[C](F)F(1569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C[C](F)F(1342)'],
    products = ['[O]CC[C](F)F(1569)'],
    transitionState = 'TS4',
