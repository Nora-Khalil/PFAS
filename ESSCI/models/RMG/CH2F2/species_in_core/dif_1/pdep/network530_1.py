...
"""),
    E0 = (-682.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,232,360,932,1127,1349,1365,3045,180,259.228,542.69,542.814,544.427,2073.54],'cm^-1')),
        HinderedRotor(inertia=(0.207052,'amu*angstrom^2'), symmetry=1, barrier=(43.21,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87929,'amu*angstrom^2'), symmetry=1, barrier=(43.2086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152094,'amu*angstrom^2'), symmetry=1, barrier=(31.808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-216.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,175,287,726,856,350,440,435,1725,3010,987.5,1337.5,450,1655,196.856,196.985],'cm^-1')),
        HinderedRotor(inertia=(0.668462,'amu*angstrom^2'), symmetry=1, barrier=(18.3879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668478,'amu*angstrom^2'), symmetry=1, barrier=(18.3857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668444,'amu*angstrom^2'), symmetry=1, barrier=(18.387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674075,0.0741975,-0.000111535,7.92955e-08,-2.15156e-11,-25975.5,21.7385], Tmin=(100,'K'), Tmax=(916.089,'K')), NASAPolynomial(coeffs=[15.8002,0.00815166,-3.39348e-06,5.98098e-10,-3.9337e-14,-28746.9,-49.9108], Tmin=(916.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OC(=CF)OOF(1417)',
...
"""),
    E0 = (-268.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,194,682,905,1196,1383,3221,259.925,1732.82],'cm^-1')),
        HinderedRotor(inertia=(0.168441,'amu*angstrom^2'), symmetry=1, barrier=(8.083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168396,'amu*angstrom^2'), symmetry=1, barrier=(8.07572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.707499,'amu*angstrom^2'), symmetry=1, barrier=(34.054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    E0 = (-256.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,180,180,1733.15,1733.75],'cm^-1')),
        HinderedRotor(inertia=(0.190274,'amu*angstrom^2'), symmetry=1, barrier=(4.37478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88704,'amu*angstrom^2'), symmetry=1, barrier=(43.3868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.269052,'amu*angstrom^2'), symmetry=1, barrier=(6.18603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268965,'amu*angstrom^2'), symmetry=1, barrier=(6.18405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268904,'amu*angstrom^2'), symmetry=1, barrier=(6.18263,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08846,0.0763464,-0.000150344,1.46669e-07,-5.34484e-11,-34493.9,26.1331], Tmin=(100,'K'), Tmax=(852.532,'K')), NASAPolynomial(coeffs=[5.76471,0.0268986,-1.49444e-05,2.94183e-09,-2.03165e-13,-34291.6,10.1817], Tmin=(852.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(O)=C(F)OF(1420)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.561263,'amu*angstrom^2'), symmetry=1, barrier=(12.9045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560448,'amu*angstrom^2'), symmetry=1, barrier=(12.8858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    E0 = (-315.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,3025,407.5,1350,352.5,299.147,299.855,299.996,300.192,1206.07,1206.32],'cm^-1')),
        HinderedRotor(inertia=(0.0482285,'amu*angstrom^2'), symmetry=1, barrier=(49.7616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10802,'amu*angstrom^2'), symmetry=1, barrier=(49.756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.779439,'amu*angstrom^2'), symmetry=1, barrier=(49.7613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-590.917,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,241,322,589,815,1096,1220,1302,2892,180,180,1179.07,1181,1181.2],'cm^-1')),
        HinderedRotor(inertia=(0.205124,'amu*angstrom^2'), symmetry=1, barrier=(4.71621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205784,'amu*angstrom^2'), symmetry=1, barrier=(4.73137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10041,0.0477035,-7.92269e-05,7.35284e-08,-2.64171e-11,-71008.2,18.8356], Tmin=(100,'K'), Tmax=(845.473,'K')), NASAPolynomial(coeffs=[5.03918,0.0213936,-1.0538e-05,2.01039e-09,-1.37759e-13,-71061.7,7.77338], Tmin=(845.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.526026,'amu*angstrom^2'), symmetry=1, barrier=(12.0944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62376,'amu*angstrom^2'), symmetry=1, barrier=(37.3334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-457.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,421.861,423.406,423.541,424.277,424.382,424.595,425.673],'cm^-1')),
        HinderedRotor(inertia=(0.000941326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000940691,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90377,0.0514479,-7.85112e-05,7.27208e-08,-2.80313e-11,-54928.1,19.3183], Tmin=(100,'K'), Tmax=(724.353,'K')), NASAPolynomial(coeffs=[5.44694,0.0262003,-1.44627e-05,2.94457e-09,-2.11756e-13,-55292.3,4.39601], Tmin=(724.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-543.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,280,501,1494,1531,180,180,180,580.734,924.386,926.074],'cm^-1')),
        HinderedRotor(inertia=(0.0914187,'amu*angstrom^2'), symmetry=1, barrier=(55.4507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0915856,'amu*angstrom^2'), symmetry=1, barrier=(55.4321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.41074,'amu*angstrom^2'), symmetry=1, barrier=(55.4278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
...
"""),
    E0 = (-481.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2782.5,750,1395,475,1775,1000,446.076,447.463,450.966,453.212],'cm^-1')),
        HinderedRotor(inertia=(0.000844533,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343571,'amu*angstrom^2'), symmetry=1, barrier=(49.2039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79803,0.025593,-1.64983e-05,4.66667e-09,-5.12198e-13,-57904.5,13.8298], Tmin=(100,'K'), Tmax=(2089.57,'K')), NASAPolynomial(coeffs=[11.4246,0.00907938,-4.64396e-06,8.84583e-10,-5.96999e-14,-61509.7,-34.1456], Tmin=(2089.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-481.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'O=C(O)C(=O)F(706)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
...
"""),
    E0 = (-745.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,619,818,1246,1924,479.045,479.048,479.05,479.052,479.052],'cm^-1')),
        HinderedRotor(inertia=(0.29331,'amu*angstrom^2'), symmetry=1, barrier=(47.7668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000734585,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59222,0.0330992,-3.01294e-05,1.35018e-08,-2.49236e-12,-89590.7,15.5669], Tmin=(100,'K'), Tmax=(1253.93,'K')), NASAPolynomial(coeffs=[8.47137,0.0143448,-7.6946e-06,1.57405e-09,-1.14283e-13,-91065.1,-14.1269], Tmin=(1253.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)O2s) + group(COCFO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OF(155)', 'O=C(O)[C]F(826)'],
    products = ['O=C(O)C(F)OF(1388)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(827)'],
    products = ['O=C(O)C(F)OF(1388)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(1421)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(1422)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(156)', 'O=C(O)[CH]F(1300)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'O=[C]C(F)OF(1423)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(1424)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(179)', 'O=[C]O(191)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(831)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(108)', 'O=CC(=O)O(1425)'],
    products = ['O=C(O)C(F)OF(1388)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(706)'],
    products = ['O=C(O)C(F)OF(1388)'],
