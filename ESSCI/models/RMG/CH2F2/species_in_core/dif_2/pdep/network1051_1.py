...
"""),
    E0 = (-348.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,215,315,519,588,595,1205,1248,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1435,0.0627617,-6.51435e-05,3.41407e-08,-7.15943e-12,-43925.1,22.3238], Tmin=(100,'K'), Tmax=(1147.88,'K')), NASAPolynomial(coeffs=[13.3389,0.0202646,-9.60986e-06,1.88771e-09,-1.34937e-13,-46724.9,-38.1937], Tmin=(1147.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-366.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(Csj(Cs-F1sCsH)(F1s)(O2s-Cs)_ring) + radical(CJC(C)OC) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3293.31,'J/mol'), sigma=(6.02549,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=514.41 K, Pc=34.16 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30339,0.0683671,-0.000114243,1.11002e-07,-4.23967e-11,-48056.6,22.0365], Tmin=(100,'K'), Tmax=(801.576,'K')), NASAPolynomial(coeffs=[4.37669,0.0351639,-1.86752e-05,3.71143e-09,-2.61601e-13,-47975.3,11.4697], Tmin=(801.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(Cd(C-FF)-Cd-O2s)"""),
)
...
species(
    label = '[CH2]C(F)(F)C1=C(F)O1(2749)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-188.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,3000,3100,440,815,1455,1000,180,180,180,180,1883.2,1884.81,1885.75,1887.06],'cm^-1')),
        HinderedRotor(inertia=(0.12255,'amu*angstrom^2'), symmetry=1, barrier=(2.81766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123845,'amu*angstrom^2'), symmetry=1, barrier=(2.84745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16644,0.0741265,-0.000138822,1.38235e-07,-5.22574e-11,-22630.8,23.8256], Tmin=(100,'K'), Tmax=(827.81,'K')), NASAPolynomial(coeffs=[4.24216,0.0334818,-1.84546e-05,3.67439e-09,-2.57446e-13,-22256.6,14.9041], Tmin=(827.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-231.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,180,861.381,861.392,861.408,861.412,861.424,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.633545,'amu*angstrom^2'), symmetry=1, barrier=(31.5252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70548,0.0455318,-3.89627e-05,1.65103e-08,-2.77781e-12,-27740.1,23.6203], Tmin=(100,'K'), Tmax=(1422.13,'K')), NASAPolynomial(coeffs=[12.7349,0.0145094,-6.24152e-06,1.17122e-09,-8.12969e-14,-30877.1,-33.4743], Tmin=(1422.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(CsCFHO) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs-Cs(F)-O2s) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-51.2597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,2950,3100,1380,975,1025,1650,180,180,180,533.211,906.99,907.937,911.886,2395.66,4000],'cm^-1')),
        HinderedRotor(inertia=(0.196753,'amu*angstrom^2'), symmetry=1, barrier=(4.52374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97315,0.0483777,-6.21635e-05,4.50422e-08,-1.3493e-11,-6095.53,23.7788], Tmin=(100,'K'), Tmax=(806.006,'K')), NASAPolynomial(coeffs=[7.60742,0.020416,-1.01254e-05,1.99972e-09,-1.4233e-13,-7003.77,-2.18807], Tmin=(806.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.2597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(CsCFHO) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs-Cs(F)-O2s) + radical(C2CsJO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)[C]1OC1F(2742)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40079,0.064544,-7.91249e-05,4.57899e-08,-5.2083e-12,-46982.3,24.2603], Tmin=(100,'K'), Tmax=(576.725,'K')), NASAPolynomial(coeffs=[7.95463,0.0294939,-1.50266e-05,2.97935e-09,-2.11764e-13,-47911.3,-5.25125], Tmin=(576.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C]1O[C]1F(2752)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66119,0.0605282,-5.95404e-05,9.28967e-10,3.05147e-11,-45667.3,22.536], Tmin=(100,'K'), Tmax=(506.941,'K')), NASAPolynomial(coeffs=[7.47565,0.0301224,-1.53553e-05,3.03115e-09,-2.14272e-13,-46455.6,-3.52625], Tmin=(506.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)

species(
    label = '[CH2][C](F)C1OC1(F)F(2753)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43143,0.061131,-7.4876e-05,5.26363e-08,-1.5448e-11,-44563.9,26.1386], Tmin=(100,'K'), Tmax=(819.071,'K')), NASAPolynomial(coeffs=[8.30149,0.0275821,-1.34395e-05,2.63376e-09,-1.86781e-13,-45689.3,-5.63464], Tmin=(819.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsHHH) + ring(Cs(C)-Cs(F)(F)-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C1O[C]1F(2754)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-312.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['FC1=CO1(390)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(61.201,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['[CH2]C1(F)O[C](F)C1F(2746)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(66)', 'F[C](F)C1O[C]1F(2645)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['CC(F)(F)C1=C(F)O1(2747)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=O)F(2748)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)O1(2749)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1O[C]1F(2750)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(62.2069,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=C(F)[C]1O[C]1F(2751)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(218.626,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['[CH2]C(F)(F)[C]1OC1F(2742)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['CC(F)(F)[C]1O[C]1F(2752)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
    products = ['[CH2][C](F)C1OC1(F)F(2753)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(216.112,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)C1O[C]1F(2754)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2713)'],
...
network(
    label = 'PDepNetwork #1051',
    isomers = [
        '[CH2]C(F)(F)C1O[C]1F(2713)',
    ],
    reactants = [
