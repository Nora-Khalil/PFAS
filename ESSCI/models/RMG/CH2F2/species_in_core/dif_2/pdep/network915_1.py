...
"""),
    E0 = (-592.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,194.183,194.194],'cm^-1')),
        HinderedRotor(inertia=(0.176884,'amu*angstrom^2'), symmetry=1, barrier=(4.73229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176886,'amu*angstrom^2'), symmetry=1, barrier=(4.73282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595282,'amu*angstrom^2'), symmetry=1, barrier=(15.9279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.655302,'amu*angstrom^2'), symmetry=1, barrier=(15.0667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65552,'amu*angstrom^2'), symmetry=1, barrier=(15.0717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34896,'amu*angstrom^2'), symmetry=1, barrier=(31.0153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.066,'amu'),
...
"""),
    E0 = (-496.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,363.09,368.133],'cm^-1')),
        HinderedRotor(inertia=(0.0743496,'amu*angstrom^2'), symmetry=1, barrier=(7.20609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0757312,'amu*angstrom^2'), symmetry=1, barrier=(7.28983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'CCOF(2335)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(85)', 'F[C]COF(1988)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FCOF(585)', 'C[C]F-2(309)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(72)', 'CC(F)(F)OF(1242)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(72)', 'FOCC(F)F(1251)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(716)', 'C=C(C)F(2337)'],
    products = ['CC(F)(F)COF(2183)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](2339)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(154)', '[CH2]C(C)(F)F(2340)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(1634)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(67)', 'FOC[C](F)F(1461)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(2227)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(2317)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(1977)'],
    products = ['CC(F)(F)COF(2183)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)COF(2321)'],
    products = ['CC(F)(F)COF(2183)'],
