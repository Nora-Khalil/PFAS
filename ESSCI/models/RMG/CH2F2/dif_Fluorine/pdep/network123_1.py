...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(367)', 'CHF(40)'],
    products = ['O=C(OF)OC(F)F(326)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(370)'],
    products = ['O=C(OF)OC(F)F(326)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(371)'],
    products = ['O=C(OF)OC(F)F(326)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(246)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(326)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(150)', '[O]C(F)F(146)'],
    products = ['O=C(OF)OC(F)F(326)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(248)', 'O=[C]OC(F)F(187)'],
    products = ['O=C(OF)OC(F)F(326)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(372)'],
    products = ['O=C(OF)OC(F)F(326)'],
