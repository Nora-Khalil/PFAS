...
"""),
    E0 = (330.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([145,326,398,834,1303,2950,3100,1380,975,1025,1650,540,610,2055,246.176,263.361,272.577],'cm^-1')),
        HinderedRotor(inertia=(1.07048,'amu*angstrom^2'), symmetry=1, barrier=(50.6645,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0649,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49574,0.0331483,-2.03113e-05,6.20312e-09,-7.87555e-13,39845.1,15.2364], Tmin=(100,'K'), Tmax=(1712.17,'K')), NASAPolynomial(coeffs=[8.39363,0.0193697,-8.24022e-06,1.50307e-09,-1.01293e-13,37825.4,-16.3893], Tmin=(1712.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C1OC=C1F(4032)',
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39594,0.0288717,-7.082e-06,-9.22404e-09,4.68599e-12,-5756.81,13.0181], Tmin=(100,'K'), Tmax=(1108.65,'K')), NASAPolynomial(coeffs=[9.63058,0.0158158,-7.06946e-06,1.38318e-09,-9.95525e-14,-8162.72,-26.2471], Tmin=(1108.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.3897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(Cds-CdsHH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Oxetene)"""),
)

species(
    label = '[CH]C(F)=C1CO1(4192)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09312,0.037935,-2.27508e-05,6.602e-09,-7.76012e-13,26166,19.4034], Tmin=(100,'K'), Tmax=(1908.46,'K')), NASAPolynomial(coeffs=[11.2282,0.0187883,-7.70194e-06,1.3451e-09,-8.7378e-14,22679.2,-30.5722], Tmin=(1908.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + ring(Cd(Cd-F)-Cs-O2s) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'O=C1C[CH][C]1F(4193)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,D}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08375,0.00517718,6.65625e-05,-8.84082e-08,3.33195e-11,5234.52,18.9726], Tmin=(100,'K'), Tmax=(971.304,'K')), NASAPolynomial(coeffs=[10.3329,0.0133925,-4.91411e-06,1.00168e-09,-7.91831e-14,2030.56,-25.033], Tmin=(971.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJCC=O) + radical(CsCOCsF1s)"""),
)

species(
    label = '[CH2]C1([O])C=C1F(4062)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {3,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75327,0.039898,-3.953e-05,1.90722e-08,-3.46978e-12,23496.3,15.7033], Tmin=(100,'K'), Tmax=(1523.18,'K')), NASAPolynomial(coeffs=[12.8232,0.00584995,-1.0982e-06,1.05904e-10,-4.70738e-15,20701.4,-40.4652], Tmin=(1523.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52419,0.0518712,-5.9644e-05,3.40708e-08,-7.56045e-12,8490.99,18.5993], Tmin=(100,'K'), Tmax=(1109.21,'K')), NASAPolynomial(coeffs=[12.89,0.0108836,-4.21534e-06,7.56209e-10,-5.17482e-14,5969.6,-37.4123], Tmin=(1109.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.8382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=C([CH2])OF(4197)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60293,0.0546971,-7.09431e-05,4.42797e-08,-9.27583e-12,48595.6,20.4826], Tmin=(100,'K'), Tmax=(737.452,'K')), NASAPolynomial(coeffs=[10.8573,0.0133498,-4.84057e-06,7.93616e-10,-4.99194e-14,46990.1,-22.9772], Tmin=(737.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C=C([O])[C]=CF(4064)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3867,0.055095,-7.02869e-05,4.52422e-08,-1.11444e-11,3107.51,18.5669], Tmin=(100,'K'), Tmax=(1077.31,'K')), NASAPolynomial(coeffs=[12.5821,0.0100046,-2.6008e-06,3.21463e-10,-1.58529e-14,899.713,-35.3297], Tmin=(1077.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.0377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(C=C(C)OJ) + radical(C=CJC=C)"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86949,0.0150529,3.1999e-05,-4.48722e-08,1.51752e-11,-20550,14.3078], Tmin=(100,'K'), Tmax=(1122.23,'K')), NASAPolynomial(coeffs=[9.19884,0.0198276,-1.09189e-05,2.32765e-09,-1.74561e-13,-23691.9,-24.6265], Tmin=(1122.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCCF) + longDistanceInteraction_cyclic(Cd(F)-CO) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C1O[CH][C]1F(4198)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {5,S}
3 C u0 p0 c0 {2,S} {4,S} {6,D}
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(66)', '[CH]=C(F)[C]=O(1111)'],
    products = ['[CH]=C(F)C(=C)[O](3326)'],
