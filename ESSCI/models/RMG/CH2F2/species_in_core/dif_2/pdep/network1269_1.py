...
"""),
    E0 = (-354.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,1685,370,181.466,181.467,181.467,181.467],'cm^-1')),
        HinderedRotor(inertia=(1.09177,'amu*angstrom^2'), symmetry=1, barrier=(25.5124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09177,'amu*angstrom^2'), symmetry=1, barrier=(25.5124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09176,'amu*angstrom^2'), symmetry=1, barrier=(25.5124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.470013,0.0709173,-7.74739e-05,4.02318e-08,-8.04633e-12,-42449.3,28.3011], Tmin=(100,'K'), Tmax=(1230.71,'K')), NASAPolynomial(coeffs=[18.7719,0.0114332,-4.97401e-06,9.5905e-10,-6.86386e-14,-46954.2,-63.794], Tmin=(1230.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.21022,'amu*angstrom^2'), symmetry=1, barrier=(4.83337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21021,'amu*angstrom^2'), symmetry=1, barrier=(4.83315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27811,0.0460003,-8.51495e-05,8.66441e-08,-3.30982e-11,12716,19.0826], Tmin=(100,'K'), Tmax=(840.558,'K')), NASAPolynomial(coeffs=[2.9825,0.0239295,-1.23593e-05,2.41879e-09,-1.67999e-13,13258.9,19.7402], Tmin=(840.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cd)(H)) + radical(C=CJO)"""),
)

species(
    label = 'C=C1OC(F)C1(F)F(3312)',
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2452,0.064462,-7.59996e-05,4.79403e-08,-1.23377e-11,-68319.6,23.8312], Tmin=(100,'K'), Tmax=(936.25,'K')), NASAPolynomial(coeffs=[10.5954,0.0245149,-1.19993e-05,2.3686e-09,-1.69157e-13,-70070.4,-20.6622], Tmin=(936.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203593,'amu*angstrom^2'), symmetry=1, barrier=(4.68101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204463,'amu*angstrom^2'), symmetry=1, barrier=(4.70101,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18258,0.0696774,-0.000116242,1.06167e-07,-3.7955e-11,-39487,27.1688], Tmin=(100,'K'), Tmax=(820.887,'K')), NASAPolynomial(coeffs=[6.92125,0.0278177,-1.4359e-05,2.80306e-09,-1.9502e-13,-39960.9,3.46747], Tmin=(820.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-329.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC(F)[C](F)F(3432)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.44887,'amu*angstrom^2'), symmetry=1, barrier=(33.3125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4479,'amu*angstrom^2'), symmetry=1, barrier=(33.2901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45004,'amu*angstrom^2'), symmetry=1, barrier=(33.3393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27936,'amu*angstrom^2'), symmetry=1, barrier=(29.415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27402,'amu*angstrom^2'), symmetry=1, barrier=(29.2922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27658,'amu*angstrom^2'), symmetry=1, barrier=(29.3511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184091,0.0727704,-6.79035e-05,2.02898e-08,1.32427e-12,-41550.5,26.5985], Tmin=(100,'K'), Tmax=(977.018,'K')), NASAPolynomial(coeffs=[22.4815,0.00556723,-1.70418e-06,3.49715e-10,-2.95584e-14,-47057,-86.338], Tmin=(977.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Cds_P)"""),
)

species(
    label = 'C=CO[C](F)[C](F)F(3435)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.13819,'amu*angstrom^2'), symmetry=1, barrier=(26.1693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13587,'amu*angstrom^2'), symmetry=1, barrier=(26.1159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13791,'amu*angstrom^2'), symmetry=1, barrier=(26.1628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[C](F)F(386)', '[C]=C(2065)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'C=[C]O[CH]F(2857)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=[C]OC=C(F)F(3430)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=C(F)F(3431)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)[C](F)F(3432)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', 'C=[C]O[CH]F(2857)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]OC(F)C(F)F(3436)'],
    products = ['C=[C]OC(F)[C](F)F(3310)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC(F)[C](F)F(3310)'],
    products = ['C=[C]O[CH]C(F)(F)F(3437)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC(F)[C](F)F(3310)'],
    products = ['C=C(F)O[CH][C](F)F(3438)'],
