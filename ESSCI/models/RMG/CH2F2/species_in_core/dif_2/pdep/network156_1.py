...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C(F)=CF(474)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(F)C(F)(F)[CH]F(475)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(106)', 'O=C(F)[C](F)[CH]F(476)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)C(F)(F)OF(477)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)[C](F)OF(478)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
    products = ['[O][C](F)C(F)(F)C(F)F(479)'],
