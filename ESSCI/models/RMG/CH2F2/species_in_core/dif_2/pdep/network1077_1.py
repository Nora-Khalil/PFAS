...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02822,0.0473239,-7.31722e-05,6.26711e-08,-2.15718e-11,13613.3,17.257], Tmin=(100,'K'), Tmax=(766.869,'K')), NASAPolynomial(coeffs=[7.27057,0.0171411,-8.58217e-06,1.69383e-09,-1.19587e-13,12892.8,-6.09863], Tmin=(766.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=C[O](2806)'],
    products = ['[CH]=CO[CH]F(2850)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(86)', '[CH]=C[O](2806)'],
    products = ['[CH]=CO[CH]F(2850)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(16.0947,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH]=CO[CH]F(2850)'],
    products = ['C=[C]O[CH]F(2857)'],
    transitionState = 'TS9',
