...
"""),
    E0 = (-929.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,519,593,830,1115,1166,1389,1413,3114,195.566,195.566,195.567,195.567],'cm^-1')),
        HinderedRotor(inertia=(0.339234,'amu*angstrom^2'), symmetry=1, barrier=(9.20694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339236,'amu*angstrom^2'), symmetry=1, barrier=(9.20694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12683,'amu*angstrom^2'), symmetry=1, barrier=(30.5824,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-832.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,451,553,637,1069,1180,1265,1301,3056,180,180,180],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.35387,'amu*angstrom^2'), symmetry=1, barrier=(31.1282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00193046,'amu*angstrom^2'), symmetry=1, barrier=(10.7431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-719.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,493,600,700,1144,1293,180,180,180,1468.77],'cm^-1')),
        HinderedRotor(inertia=(0.282959,'amu*angstrom^2'), symmetry=1, barrier=(6.50578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282396,'amu*angstrom^2'), symmetry=1, barrier=(6.49284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43081,'amu*angstrom^2'), symmetry=1, barrier=(32.8971,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.60721,0.0503517,0.000250667,-2.96205e-06,7.50813e-09,-86576.4,12.8529], Tmin=(10,'K'), Tmax=(159.185,'K')), NASAPolynomial(coeffs=[6.08703,0.0339076,-2.66005e-05,9.29042e-09,-1.192e-12,-86713.5,3.62097], Tmin=(159.185,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-719.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""FOC(F)O[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)OC(F)F(344)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(19.1573,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)OF(468)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(79.5191,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(F)OF(527)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.60597,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[CH]OC(F)F(528)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)OF(529)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)OC(F)F(530)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(295)', '[O]C(F)F(170)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF2(81)', '[O]C(F)OF(154)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(228)', 'F[CH]OC(F)F(299)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FO[C](F)OC(F)F(489)'],
    products = ['FOC(F)OC(F)F(344)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FOC(F)O[C](F)F(531)'],
    products = ['FOC(F)OC(F)F(344)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', 'O=COC(F)F(162)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(92.7259,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)F(200)'],
    products = ['FOC(F)OC(F)F(344)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(501.784,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['FOC(F)OC(F)F(344)'],
    products = ['F2(77)', 'CHFO(46)', 'CHFO(46)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(214.613,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #159',
    isomers = [
        'FOC(F)OC(F)F(344)',
    ],
    reactants = [
