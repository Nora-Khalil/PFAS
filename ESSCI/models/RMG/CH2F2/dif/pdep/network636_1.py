...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.20141,0.0259571,-5.56217e-05,6.79641e-08,-2.90802e-11,5760.79,12.7813], Tmin=(100,'K'), Tmax=(837.446,'K')), NASAPolynomial(coeffs=[-1.03159,0.0241472,-1.29231e-05,2.56268e-09,-1.79326e-13,7242.22,37.064], Tmin=(837.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCOJ) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.46869,-0.0219082,0.000160129,-2.12634e-07,8.544e-11,2990.31,11.144], Tmin=(100,'K'), Tmax=(918.185,'K')), NASAPolynomial(coeffs=[22.5079,-0.0180859,1.214e-05,-2.26687e-09,1.40366e-13,-4163.43,-99.0008], Tmin=(918.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.54046,-0.017744,0.000131418,-1.83783e-07,7.77284e-11,-1973.83,7.10173], Tmin=(100,'K'), Tmax=(885.258,'K')), NASAPolynomial(coeffs=[21.1789,-0.0237534,1.67397e-05,-3.39204e-09,2.3118e-13,-7984.18,-92.1523], Tmin=(885.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsHH) + ring(dioxirane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CO[O](1528)'],
    products = ['O=O(176)', 'CH2O(19)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[O](1545)'],
    products = ['[O]CO[O](1528)'],
    transitionState = 'TS2',
