...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.367915,'amu*angstrom^2'), symmetry=1, barrier=(8.45909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07194,'amu*angstrom^2'), symmetry=1, barrier=(24.6461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369212,'amu*angstrom^2'), symmetry=1, barrier=(8.48892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.534747,'amu*angstrom^2'), symmetry=1, barrier=(12.2949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53381,'amu*angstrom^2'), symmetry=1, barrier=(12.2733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.732223,'amu*angstrom^2'), symmetry=1, barrier=(16.8353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (152.02,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.171702,'amu*angstrom^2'), symmetry=1, barrier=(3.94777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24997,0.0653559,-9.69483e-05,7.3886e-08,-2.2371e-11,-128882,21.2313], Tmin=(100,'K'), Tmax=(809.036,'K')), NASAPolynomial(coeffs=[10.7752,0.0182623,-9.63497e-06,1.93837e-09,-1.38754e-13,-130423,-22.704], Tmin=(809.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1072.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.824484,'amu*angstrom^2'), symmetry=1, barrier=(18.9565,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)OF(329)'],
    products = ['HF(38)', 'CF2O(48)', 'CF2O(48)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(11.8178,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)(F)OF(331)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.81816e-07,'m^3/(mol*s)'), n=3.45227, Ea=(216.481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(172)', 'F[C]C(F)(F)OF(373)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(340)', 'OC(F)(F)[C]F(374)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(172)', 'FOC(F)=C(F)F(376)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(340)', 'OC(F)=C(F)F(377)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)C(F)(F)OF(378)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)[C](F)OF(379)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)F(380)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'FOC(F)(F)[C](F)F(381)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)OF(382)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(248)', 'OC(F)(F)[C](F)F(383)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)F(238)', 'O[C](F)F(237)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)OF(384)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'O=C(F)C(O)(F)F(385)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', 'OC(F)=C(F)OF(386)'],
    products = ['OC(F)(F)C(F)(F)OF(329)'],
