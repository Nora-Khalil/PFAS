...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12397,'amu*angstrom^2'), symmetry=1, barrier=(48.8343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473992,'amu*angstrom^2'), symmetry=1, barrier=(10.898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12529,'amu*angstrom^2'), symmetry=1, barrier=(48.8646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(147)', '[CH]F(125)'],
    products = ['F[CH]OO[C](F)F(432)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(126)', '[O]O[CH]F(134)'],
    products = ['F[CH]OO[C](F)F(432)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
