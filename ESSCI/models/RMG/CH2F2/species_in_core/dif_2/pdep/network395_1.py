...
reaction(
    label = 'reaction1',
    reactants = ['CF2(87)', 'CF2O(48)'],
    products = ['FC1(F)OC1(F)F(776)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(389)'],
    products = ['FC1(F)OC1(F)F(776)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(106)', 'FC1=C(F)O1(391)'],
    products = ['FC1(F)OC1(F)F(776)'],
    transitionState = 'TS6',
