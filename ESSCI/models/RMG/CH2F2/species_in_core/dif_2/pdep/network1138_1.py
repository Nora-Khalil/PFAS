...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.585682,'amu*angstrom^2'), symmetry=1, barrier=(13.466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.586384,'amu*angstrom^2'), symmetry=1, barrier=(13.4821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702441,0.0818544,-0.000145631,1.33448e-07,-4.70939e-11,-46492.1,24.7389], Tmin=(100,'K'), Tmax=(828.161,'K')), NASAPolynomial(coeffs=[8.75058,0.0260601,-1.39243e-05,2.75108e-09,-1.91953e-13,-47244.9,-9.0677], Tmin=(828.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.763484,0.0808873,-0.000144784,1.34371e-07,-4.7984e-11,-47049.9,25.3732], Tmin=(100,'K'), Tmax=(826.776,'K')), NASAPolynomial(coeffs=[8.08343,0.0273232,-1.46749e-05,2.90643e-09,-2.03136e-13,-47640,-4.79743], Tmin=(826.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH))"""),
)
...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32238,0.0602873,-5.96538e-05,3.14671e-08,-6.8141e-12,-59220,22.7624], Tmin=(100,'K'), Tmax=(1098.85,'K')), NASAPolynomial(coeffs=[11.0302,0.0249488,-1.1414e-05,2.19993e-09,-1.55425e-13,-61353.4,-24.9872], Tmin=(1098.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    products = ['CF2CF2(60)', 'C2H2(70)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[CH]C=C(F)F(2940)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=CC(F)=C(F)F(2827)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2CF2(60)', '[CH]=[CH](2414)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(230)', 'C2H2(70)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#CC(F)(F)[C](F)F(1809)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(230)', '[CH]=[CH](2414)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', '[CH]C=C(F)F(2940)'],
    products = ['[CH]=CC(F)(F)[C](F)F(2939)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC(F)(F)[C](F)F(2939)'],
    products = ['[CH]C=C(F)C(F)(F)F(2943)'],
...
network(
    label = 'PDepNetwork #1138',
    isomers = [
        '[CH]=CC(F)(F)[C](F)F(2939)',
    ],
    reactants = [
        ('CF2CF2(60)', 'C2H2(70)'),
    ],
