...
"""),
    E0 = (-682.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,232,360,932,1127,1349,1365,3045,386.844,386.844,386.844,386.844,386.844,386.844],'cm^-1')),
        HinderedRotor(inertia=(0.427508,'amu*angstrom^2'), symmetry=1, barrier=(45.3986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427508,'amu*angstrom^2'), symmetry=1, barrier=(45.3986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0118015,'amu*angstrom^2'), symmetry=1, barrier=(28.2728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80387,0.0509163,-5.35704e-05,2.87256e-08,-6.28185e-12,-82067.5,19.5198], Tmin=(100,'K'), Tmax=(1088.13,'K')), NASAPolynomial(coeffs=[10.4059,0.0192955,-9.98154e-06,2.02042e-09,-1.46403e-13,-83939.6,-22.7068], Tmin=(1088.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-216.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,197.07,197.468],'cm^-1')),
        HinderedRotor(inertia=(0.669002,'amu*angstrom^2'), symmetry=1, barrier=(18.3906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673132,'amu*angstrom^2'), symmetry=1, barrier=(18.3838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668,'amu*angstrom^2'), symmetry=1, barrier=(18.3863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674078,0.0741975,-0.000111535,7.92954e-08,-2.15155e-11,-25975.5,21.7385], Tmin=(100,'K'), Tmax=(916.153,'K')), NASAPolynomial(coeffs=[15.8002,0.00815164,-3.39347e-06,5.98095e-10,-3.93367e-14,-28746.9,-49.9109], Tmin=(916.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OOC(=CF)OF(1405)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.157825,'amu*angstrom^2'), symmetry=1, barrier=(3.6287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158245,'amu*angstrom^2'), symmetry=1, barrier=(3.63837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158032,'amu*angstrom^2'), symmetry=1, barrier=(3.63347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27274,0.074102,-0.000150434,1.52709e-07,-5.72578e-11,-24748.8,22.7616], Tmin=(100,'K'), Tmax=(853.491,'K')), NASAPolynomial(coeffs=[3.3111,0.031486,-1.74294e-05,3.42981e-09,-2.36953e-13,-23892.5,20.3052], Tmin=(853.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C(OF)[C](O)F(1406)',
...
"""),
    E0 = (-287.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,395,473,707,1436,180,180,1109.36],'cm^-1')),
        HinderedRotor(inertia=(0.269017,'amu*angstrom^2'), symmetry=1, barrier=(6.18524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268962,'amu*angstrom^2'), symmetry=1, barrier=(6.18396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268914,'amu*angstrom^2'), symmetry=1, barrier=(6.18287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08815,0.0763503,-0.000150359,1.46692e-07,-5.34597e-11,-34493.9,26.1342], Tmin=(100,'K'), Tmax=(852.478,'K')), NASAPolynomial(coeffs=[5.76535,0.0268975,-1.49437e-05,2.94166e-09,-2.03151e-13,-34291.8,10.1781], Tmin=(852.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)C([O])OF(1407)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-255.552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,180,180,1586.29],'cm^-1')),
        HinderedRotor(inertia=(0.258302,'amu*angstrom^2'), symmetry=1, barrier=(5.93887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257304,'amu*angstrom^2'), symmetry=1, barrier=(5.91593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43383,0.0643231,-0.000112255,1.05256e-07,-3.83093e-11,-30651,24.9937], Tmin=(100,'K'), Tmax=(818.337,'K')), NASAPolynomial(coeffs=[6.34833,0.0254161,-1.36552e-05,2.70255e-09,-1.89215e-13,-30957,5.31462], Tmin=(818.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(F)[C](O)OF(1408)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-276.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,391,562,707,872,1109,1210,1289,3137,360,370,350,233.077,233.422],'cm^-1')),
        HinderedRotor(inertia=(0.00601838,'amu*angstrom^2'), symmetry=1, barrier=(9.79982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253266,'amu*angstrom^2'), symmetry=1, barrier=(9.79907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251578,'amu*angstrom^2'), symmetry=1, barrier=(9.79429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25945,0.0657295,-0.000101473,7.76693e-08,-2.24736e-11,-33102.8,25.4647], Tmin=(100,'K'), Tmax=(674.017,'K')), NASAPolynomial(coeffs=[10.6661,0.0170174,-8.89446e-06,1.75621e-09,-1.2356e-13,-34532.4,-17.4046], Tmin=(674.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Cs_P)"""),
)

species(
    label = 'OC(F)=C(O)OF(1409)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.561309,'amu*angstrom^2'), symmetry=1, barrier=(12.9056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560406,'amu*angstrom^2'), symmetry=1, barrier=(12.8848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.950292,'amu*angstrom^2'), symmetry=1, barrier=(21.8491,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730392,0.0769998,-0.000129542,1.06467e-07,-3.37713e-11,-64013.7,21.0842], Tmin=(100,'K'), Tmax=(837.714,'K')), NASAPolynomial(coeffs=[12.746,0.0141723,-7.27781e-06,1.39538e-09,-9.5324e-14,-65835.4,-33.6144], Tmin=(837.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-533.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-591.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,232,360,932,1127,1349,1365,3045,180,180,230.283,1293.86,1296.18,1296.89],'cm^-1')),
        HinderedRotor(inertia=(0.0444768,'amu*angstrom^2'), symmetry=1, barrier=(53.2488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31294,'amu*angstrom^2'), symmetry=1, barrier=(53.179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41906,0.0385866,-4.98593e-05,4.49949e-08,-1.79802e-11,-71122.7,17.3003], Tmin=(100,'K'), Tmax=(694.967,'K')), NASAPolynomial(coeffs=[4.18539,0.0249903,-1.31106e-05,2.64125e-09,-1.89764e-13,-71285.3,10.0174], Tmin=(694.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.784592,'amu*angstrom^2'), symmetry=1, barrier=(18.0393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787766,'amu*angstrom^2'), symmetry=1, barrier=(18.1123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-543.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,280,501,1494,1531,180,381.592,862.024,862.228,862.243,862.305],'cm^-1')),
        HinderedRotor(inertia=(2.40083,'amu*angstrom^2'), symmetry=1, barrier=(55.1999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.40078,'amu*angstrom^2'), symmetry=1, barrier=(55.1986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.40077,'amu*angstrom^2'), symmetry=1, barrier=(55.1984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06012,0.0471011,-5.77735e-05,4.01719e-08,-1.17949e-11,-65333.5,18.8254], Tmin=(100,'K'), Tmax=(813.302,'K')), NASAPolynomial(coeffs=[7.14777,0.0220803,-1.16296e-05,2.34976e-09,-1.69498e-13,-66161.1,-4.66852], Tmin=(813.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-543.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=CC(=O)OF(1414)',
    structure = adjacencyList("""1 F u0 p3 c0 {2,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(O)F(1389)'],
    products = ['HF(38)', 'CO2(13)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(15.6782,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)OF(1115)'],
    products = ['O=C(OF)C(O)F(1389)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)OF(814)'],
    products = ['O=C(OF)C(O)F(1389)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(155)', 'O=C=C(O)F(815)'],
    products = ['O=C(OF)C(O)F(1389)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C([CH]O)OF(1410)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)C(O)F(1411)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'O=C([CH]F)OF(1240)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(=O)OF(1412)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(156)', 'O=[C]C(O)F(1413)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(192)', 'O[CH]F(165)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)[C](O)F(820)'],
    products = ['O=C(OF)C(O)F(1389)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(=O)OF(1414)'],
    products = ['O=C(OF)C(O)F(1389)'],
