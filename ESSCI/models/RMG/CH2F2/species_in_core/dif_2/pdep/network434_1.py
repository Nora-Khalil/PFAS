...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.606314,0.0521457,-5.6814e-05,2.88238e-08,-5.21847e-12,10708.9,25.3072], Tmin=(100,'K'), Tmax=(1687.26,'K')), NASAPolynomial(coeffs=[14.4866,0.00212238,2.87507e-06,-7.7313e-10,5.7795e-14,8461.5,-41.6978], Tmin=(1687.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.8612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + ring(124trioxolane) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = '[O]C(OF)O[C]=O(1012)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-193.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,1855,455,950,180,714.394,714.768,718.424],'cm^-1')),
        HinderedRotor(inertia=(0.100648,'amu*angstrom^2'), symmetry=1, barrier=(2.3141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00682787,'amu*angstrom^2'), symmetry=1, barrier=(2.48899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114187,'amu*angstrom^2'), symmetry=1, barrier=(2.62539,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03369,0.0611481,-0.000139602,1.61557e-07,-6.65138e-11,-23206.8,21.7235], Tmin=(100,'K'), Tmax=(837.75,'K')), NASAPolynomial(coeffs=[-3.66587,0.0426561,-2.46554e-05,4.96073e-09,-3.48294e-13,-20648,57.7841], Tmin=(837.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]O[C](O)OF(1013)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-215.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,1855,455,950,180,577.144,2649.14],'cm^-1')),
        HinderedRotor(inertia=(0.214734,'amu*angstrom^2'), symmetry=1, barrier=(4.93715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57951,'amu*angstrom^2'), symmetry=1, barrier=(36.3159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57976,'amu*angstrom^2'), symmetry=1, barrier=(36.3217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00729162,'amu*angstrom^2'), symmetry=1, barrier=(36.3318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52202,0.0646157,-0.00012497,1.23218e-07,-4.59325e-11,-25845,23.7772], Tmin=(100,'K'), Tmax=(830.331,'K')), NASAPolynomial(coeffs=[5.19598,0.0251626,-1.43983e-05,2.88769e-09,-2.02552e-13,-25705.2,11.2515], Tmin=(830.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54764,0.0542376,-7.26913e-05,4.46429e-08,-1.05169e-11,-46952.1,21.6597], Tmin=(100,'K'), Tmax=(1047.44,'K')), NASAPolynomial(coeffs=[14.1308,0.00618556,-3.8795e-06,8.47062e-10,-6.40914e-14,-49588.1,-39.6305], Tmin=(1047.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2sCF) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'O=C(O)OF(854)'],
    products = ['O=COC(=O)OF(1008)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(=O)OC=O(1014)'],
    products = ['O=COC(=O)OF(1008)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(190)', '[O]C=O(135)'],
    products = ['O=COC(=O)OF(1008)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(154)', 'O=[C]OC=O(643)'],
    products = ['O=COC(=O)OF(1008)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(=O)OF(1015)'],
    products = ['O=COC(=O)OF(1008)'],
