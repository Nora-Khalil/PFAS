...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.966306,'amu*angstrom^2'), symmetry=1, barrier=(22.2173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966109,'amu*angstrom^2'), symmetry=1, barrier=(22.2127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.967677,'amu*angstrom^2'), symmetry=1, barrier=(22.2488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4889,'amu*angstrom^2'), symmetry=1, barrier=(34.2326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47911,'amu*angstrom^2'), symmetry=1, barrier=(34.0078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16044,0.0509472,-3.36773e-05,-2.75582e-09,6.65638e-12,-100984,20.691], Tmin=(100,'K'), Tmax=(1012.81,'K')), NASAPolynomial(coeffs=[18.8216,0.00560393,-2.67179e-06,6.30126e-10,-5.29161e-14,-105814,-70.9189], Tmin=(1012.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-840.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(428)', 'OC(F)[C]F(532)'],
    products = ['OC(F)C(F)(F)OF(347)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(505)'],
    products = ['OC(F)C(F)(F)OF(347)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(173)', 'OC(F)=C(F)F(509)'],
    products = ['OC(F)C(F)(F)OF(347)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(428)', 'OC=C(F)F(535)'],
    products = ['OC(F)C(F)(F)OF(347)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(173)', 'FC=C(F)OF(536)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[C](F)OF(537)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(538)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(539)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(228)', 'OC(F)[C](F)F(540)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'F[CH]C(F)(F)OF(541)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(542)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(240)', 'O[CH]F(290)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(510)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(F)C(O)F(440)'],
    products = ['OC(F)C(F)(F)OF(347)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(543)'],
    products = ['OC(F)C(F)(F)OF(347)'],
