...
"""),
    E0 = (-993.079,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,282.924],'cm^-1')),
        HinderedRotor(inertia=(0.725789,'amu*angstrom^2'), symmetry=1, barrier=(16.6873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890007,'amu*angstrom^2'), symmetry=1, barrier=(20.463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88998,'amu*angstrom^2'), symmetry=1, barrier=(20.4624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666521,0.0703466,-7.92621e-05,4.3119e-08,-9.1237e-12,-119317,23.3172], Tmin=(100,'K'), Tmax=(1157.51,'K')), NASAPolynomial(coeffs=[16.8749,0.0143352,-6.6774e-06,1.31373e-09,-9.45052e-14,-123070,-57.2495], Tmin=(1157.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-993.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892376,0.074471,-0.000115375,9.82665e-08,-3.36802e-11,-129494,24.5516], Tmin=(100,'K'), Tmax=(770.007,'K')), NASAPolynomial(coeffs=[9.19751,0.0268243,-1.37842e-05,2.71439e-09,-1.9096e-13,-130640,-12.4783], Tmin=(770.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1077.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFFO) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)OC([O])(F)F(4199)',
...
"""),
    E0 = (-642.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,3000,3100,440,815,1455,1000,180,180,1450.2],'cm^-1')),
        HinderedRotor(inertia=(0.407652,'amu*angstrom^2'), symmetry=1, barrier=(9.37272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.727762,'amu*angstrom^2'), symmetry=1, barrier=(16.7327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59811,'amu*angstrom^2'), symmetry=1, barrier=(36.7436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07075,0.067933,-7.89167e-05,4.68732e-08,-1.12206e-11,-77140.6,25.535], Tmin=(100,'K'), Tmax=(1007.27,'K')), NASAPolynomial(coeffs=[12.447,0.0227571,-1.16431e-05,2.34846e-09,-1.69935e-13,-79432.4,-29.4314], Tmin=(1007.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)OC([O])(F)F(4200)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-660.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,395,473,707,1436,199.342,200.728,200.738],'cm^-1')),
        HinderedRotor(inertia=(0.163825,'amu*angstrom^2'), symmetry=1, barrier=(4.61019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161861,'amu*angstrom^2'), symmetry=1, barrier=(4.61607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80188,'amu*angstrom^2'), symmetry=1, barrier=(23.0279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13859,0.0678504,-8.33482e-05,5.404e-08,-1.42661e-11,-79330.3,24.7133], Tmin=(100,'K'), Tmax=(913.67,'K')), NASAPolynomial(coeffs=[10.95,0.0248963,-1.28283e-05,2.58413e-09,-1.86463e-13,-81123.1,-21.735], Tmin=(913.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-554.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357,482,586,761,1411,2950,3100,1380,975,1025,1650,183.77,185.892,1223.37],'cm^-1')),
        HinderedRotor(inertia=(1.02948,'amu*angstrom^2'), symmetry=1, barrier=(25.6679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.594407,'amu*angstrom^2'), symmetry=1, barrier=(14.7155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970799,'amu*angstrom^2'), symmetry=1, barrier=(23.0406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13823,0.0579512,-6.11939e-05,3.12925e-08,-6.21325e-12,-66616.2,23.1484], Tmin=(100,'K'), Tmax=(1233.96,'K')), NASAPolynomial(coeffs=[15.3859,0.0117659,-5.05101e-06,9.60275e-10,-6.79168e-14,-70132.4,-48.5833], Tmin=(1233.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(CdCFO) + group(Cds-CdsHH) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'C=[C]OC(O)(F)F(4202)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.862295,'amu*angstrom^2'), symmetry=1, barrier=(19.8259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862354,'amu*angstrom^2'), symmetry=1, barrier=(19.8272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862556,'amu*angstrom^2'), symmetry=1, barrier=(19.8319,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706784,0.0627142,-6.99606e-05,3.67086e-08,-7.29316e-12,-68203.4,24.8923], Tmin=(100,'K'), Tmax=(1304.9,'K')), NASAPolynomial(coeffs=[18.469,0.00570525,-1.48376e-06,2.19952e-10,-1.42779e-14,-72620.9,-64.6915], Tmin=(1304.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-726.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,326,540,652,719,1357,2950,3100,1380,975,1025,1650,324.764,326.039,328.591],'cm^-1')),
        HinderedRotor(inertia=(0.927414,'amu*angstrom^2'), symmetry=1, barrier=(21.5287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.833729,'amu*angstrom^2'), symmetry=1, barrier=(21.5165,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.707644,0.0640665,-6.8219e-05,3.41441e-08,-6.54882e-12,-87260.2,24.0712], Tmin=(100,'K'), Tmax=(1286.13,'K')), NASAPolynomial(coeffs=[18.4847,0.00877762,-3.73591e-06,7.19018e-10,-5.15839e-14,-91832.9,-66.1664], Tmin=(1286.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-726.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = '[CH]=C(F)OC(O)(F)F(4204)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-730.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,293,496,537,1218,3120,650,792.5,1650,195.825,195.827,195.827],'cm^-1')),
        HinderedRotor(inertia=(0.748543,'amu*angstrom^2'), symmetry=1, barrier=(20.3703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748565,'amu*angstrom^2'), symmetry=1, barrier=(20.3704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748509,'amu*angstrom^2'), symmetry=1, barrier=(20.3704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.564705,0.0747993,-9.55946e-05,5.78608e-08,-1.35018e-11,-87749.8,23.7969], Tmin=(100,'K'), Tmax=(1056.6,'K')), NASAPolynomial(coeffs=[17.2883,0.0114882,-5.71515e-06,1.15092e-09,-8.37611e-14,-91283.9,-57.8057], Tmin=(1056.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-730.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.73909,'amu*angstrom^2'), symmetry=1, barrier=(39.985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73899,'amu*angstrom^2'), symmetry=1, barrier=(39.9828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73912,'amu*angstrom^2'), symmetry=1, barrier=(39.9859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.556535,0.0857168,-0.000147621,1.36266e-07,-4.88834e-11,-75495.5,35.9232], Tmin=(100,'K'), Tmax=(823.593,'K')), NASAPolynomial(coeffs=[7.63469,0.0327579,-1.73241e-05,3.40132e-09,-2.36964e-13,-76031.2,6.97494], Tmin=(823.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-628.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(O)(F)F(4206)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645722,0.0806191,-0.000122569,9.88672e-08,-3.21172e-11,-80509.9,24.6035], Tmin=(100,'K'), Tmax=(751.896,'K')), NASAPolynomial(coeffs=[10.8427,0.0263702,-1.43396e-05,2.90174e-09,-2.07955e-13,-82043.3,-21.6826], Tmin=(751.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(F)OC(=O)F(4207)',
...
"""),
    E0 = (-702.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,482,664,788,1296,1923,180,180,776.195],'cm^-1')),
        HinderedRotor(inertia=(0.509167,'amu*angstrom^2'), symmetry=1, barrier=(11.7067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03424,'amu*angstrom^2'), symmetry=1, barrier=(23.7791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88768,0.0504499,-5.66516e-05,3.31097e-08,-7.95643e-12,-84359.2,18.8189], Tmin=(100,'K'), Tmax=(991.673,'K')), NASAPolynomial(coeffs=[9.43017,0.0200278,-1.06372e-05,2.17714e-09,-1.58662e-13,-85855.2,-17.5065], Tmin=(991.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-702.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(COFOO)"""),
)
...
"""),
    E0 = (-860.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,201.601,201.605,201.611,201.614,201.614,201.615],'cm^-1')),
        HinderedRotor(inertia=(1.43306,'amu*angstrom^2'), symmetry=1, barrier=(41.3527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43346,'amu*angstrom^2'), symmetry=1, barrier=(41.353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)OC([O])(F)F(4199)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=C(F)O[C](O)F(4201)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(O)(F)F(4202)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C](F)F(232)', 'CH2CFO(107)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(O)(F)F(323)', 'CH2CF(100)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(4)', 'C=C(F)O[C](F)F(733)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OC([O])(F)F(4203)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)OC(O)(F)F(4204)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(F)OC(O)(F)F(4206)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)OC(=O)F(4207)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#COC(O)(F)F(3305)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(72)', 'OC(F)(F)[O+]=[C-]F(3258)'],
    products = ['C=C(F)OC(O)(F)F(3353)'],
