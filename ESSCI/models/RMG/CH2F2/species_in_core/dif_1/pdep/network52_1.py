...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86833,0.0252551,-3.00287e-05,1.88689e-08,-4.99936e-12,-27765.2,13.4445], Tmin=(298,'K'), Tmax=(1050,'K')), NASAPolynomial(coeffs=[9.38451,0.00387155,-1.53696e-06,2.69644e-10,-1.76406e-14,-29433.5,-19.4758], Tmin=(1050,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-231.01,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(108.088,'J/mol/K'), label="""CF2CF""", comment="""Thermo library: Fluorine"""),
)

species(
    label = '[CH]C(F)(F)F-2(219)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 F u0 p3 c0 {4,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(F)(F)F-2(219)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5.73099e+10,'s^-1'), n=0.827, Ea=(115.551,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'C2F2(98)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.28966e+40,'m^3/(mol*s)'), n=-10.004, Ea=(259.027,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CF2(89)', 'CHF(88)'],
    products = ['CHFCF2(54)'],
    transitionState = 'TS8',
