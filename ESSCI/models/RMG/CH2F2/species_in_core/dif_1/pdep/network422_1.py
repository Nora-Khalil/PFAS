...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(575)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(577)', 'OC(F)[C]F(1121)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(155)', 'FC=C(F)OF(1124)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(155)', 'OC(F)=C(F)F(580)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(577)', 'OC=C(F)F(1125)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(1126)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)[C](F)OF(1127)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(1128)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'F[CH]C(F)(F)OF(930)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(1129)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(156)', 'OC(F)[C](F)F(636)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(194)', 'O[CH]F(165)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(581)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(1130)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(108)', 'O=C(F)C(O)F(722)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(108)', 'OC=C(F)OF(1131)'],
    products = ['OC(F)C(F)(F)OF(1106)'],
