...
"""),
    E0 = (-30.1813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1556.94,1557.37,1557.57],'cm^-1')),
        HinderedRotor(inertia=(0.140608,'amu*angstrom^2'), symmetry=1, barrier=(3.23285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140525,'amu*angstrom^2'), symmetry=1, barrier=(3.23095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140525,'amu*angstrom^2'), symmetry=1, barrier=(3.23094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09404,0.0602009,-0.000137086,1.59455e-07,-6.55809e-11,-3579.07,21.3001], Tmin=(100,'K'), Tmax=(844.179,'K')), NASAPolynomial(coeffs=[-4.32902,0.0437802,-2.46528e-05,4.91533e-09,-3.43232e-13,-825.086,61.0882], Tmin=(844.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.1813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]O[C](O)OF(1670)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (-52.3328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,3000,3100,440,815,1455,1000,180,1466.44,1470.89],'cm^-1')),
        HinderedRotor(inertia=(0.189801,'amu*angstrom^2'), symmetry=1, barrier=(4.36389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19344,'amu*angstrom^2'), symmetry=1, barrier=(4.44757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191832,'amu*angstrom^2'), symmetry=1, barrier=(4.4106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19367,'amu*angstrom^2'), symmetry=1, barrier=(4.45285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57904,0.0637105,-0.000122615,1.21342e-07,-4.51028e-11,-6217.12,23.3655], Tmin=(100,'K'), Tmax=(842.898,'K')), NASAPolynomial(coeffs=[4.54343,0.0262678,-1.43845e-05,2.83956e-09,-1.9726e-13,-5886.47,14.4964], Tmin=(842.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.3328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-363.705,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,315.398,315.787,315.849,1460.55,1460.61,1460.74,3778.92],'cm^-1')),
        HinderedRotor(inertia=(0.415714,'amu*angstrom^2'), symmetry=1, barrier=(29.2751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.067565,'amu*angstrom^2'), symmetry=1, barrier=(29.2833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81904,0.0207218,1.00159e-06,-1.30351e-08,5.43432e-12,-43696.7,15.3388], Tmin=(100,'K'), Tmax=(1087.93,'K')), NASAPolynomial(coeffs=[7.6703,0.014454,-6.30725e-06,1.21809e-09,-8.71062e-14,-45436.9,-11.6211], Tmin=(1087.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
