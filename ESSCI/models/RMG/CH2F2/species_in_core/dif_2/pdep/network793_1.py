...
"""),
    E0 = (-718.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,190,488,555,1236,1407,180,1495.88],'cm^-1')),
        HinderedRotor(inertia=(0.430407,'amu*angstrom^2'), symmetry=1, barrier=(9.89591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.715343,'amu*angstrom^2'), symmetry=1, barrier=(16.4471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83354,'amu*angstrom^2'), symmetry=1, barrier=(42.1567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.482663,0.0852678,-0.000147037,1.29602e-07,-4.45916e-11,-86253.6,25.8], Tmin=(100,'K'), Tmax=(802.105,'K')), NASAPolynomial(coeffs=[10.8979,0.0233943,-1.27518e-05,2.55036e-09,-1.79702e-13,-87604.9,-20.1588], Tmin=(802.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-359.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.118158,'amu*angstrom^2'), symmetry=1, barrier=(2.71668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115506,'amu*angstrom^2'), symmetry=1, barrier=(2.65571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662346,'amu*angstrom^2'), symmetry=1, barrier=(15.2286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468007,0.0914099,-0.000177843,1.70795e-07,-6.14619e-11,-43143.9,27.2893], Tmin=(100,'K'), Tmax=(852.185,'K')), NASAPolynomial(coeffs=[7.29858,0.0294632,-1.62018e-05,3.19048e-09,-2.20436e-13,-43222.9,1.79526], Tmin=(852.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O]C[C](F)C(F)(F)F(2031)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.875303,0.0792681,-0.000144177,1.36108e-07,-4.89888e-11,-83321.7,24.8604], Tmin=(100,'K'), Tmax=(839.648,'K')), NASAPolynomial(coeffs=[6.9433,0.0287106,-1.51803e-05,2.97711e-09,-2.06529e-13,-83577.5,1.19102], Tmin=(839.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]CC(F)=C(F)F(1689)'],
    products = ['[O]CC(F)(F)[C](F)F(1694)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(43.4922,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(251.86,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C(F)(F)[C](F)F(2029)'],
    products = ['[O]CC(F)(F)[C](F)F(1694)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FOC[C](F)[C](F)F(2030)'],
    products = ['[O]CC(F)(F)[C](F)F(1694)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(102.425,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]CC(F)(F)[C](F)F(1694)'],
    products = ['[O]C[C](F)C(F)(F)F(2031)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(169.689,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
