...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C(F)F(564)'],
    products = ['O=C(F)[CH]F(392)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction1',
    reactants = ['F(37)', 'O=C[C]F-2(964)'],
    products = ['O=C[C](F)F(1009)'],
    transitionState = 'TS9',
