...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.445555,'amu*angstrom^2'), symmetry=1, barrier=(10.2442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812049,'amu*angstrom^2'), symmetry=1, barrier=(18.6706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47085,0.0629463,-0.00011328,1.04568e-07,-3.71596e-11,-50681,22.2501], Tmin=(100,'K'), Tmax=(822.744,'K')), NASAPolynomial(coeffs=[7.63497,0.019859,-1.08073e-05,2.15413e-09,-1.51089e-13,-51251.3,-3.58721], Tmin=(822.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCOH)(F1s)(F1s)) + radical(COj(Cs-F1sCsH)(O2d))"""),
)

species(
    label = 'O=C1OC(F)(F)C1F(340)',
...
"""),
    E0 = (-690.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,234,347,1316,1464,190,488,555,1236,1407,419.643,419.763,419.809,419.812,419.851,2545.04],'cm^-1')),
        HinderedRotor(inertia=(0.395833,'amu*angstrom^2'), symmetry=1, barrier=(49.4748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277644,'amu*angstrom^2'), symmetry=1, barrier=(34.6935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.395632,'amu*angstrom^2'), symmetry=1, barrier=(49.4753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25409,0.0651168,-9.09783e-05,6.58993e-08,-1.91189e-11,-82971.4,24.7015], Tmin=(100,'K'), Tmax=(840.678,'K')), NASAPolynomial(coeffs=[10.7284,0.0200381,-1.05469e-05,2.11734e-09,-1.51719e-13,-84564.4,-19.3624], Tmin=(840.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-690.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs) + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36207,0.060295,-7.47829e-05,4.61585e-08,-1.12748e-11,-86446.6,21.4787], Tmin=(100,'K'), Tmax=(997.421,'K')), NASAPolynomial(coeffs=[12.4025,0.0160191,-8.19711e-06,1.65317e-09,-1.19654e-13,-88649,-31.7565], Tmin=(997.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-719.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(336)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)[C](F)F(421)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)C(F)[C](F)F(337)'],
    products = ['[O]C1([O])C(F)C1(F)F(424)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C=C(F)F(426)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)C(F)=C(F)F(427)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CO2(13)', 'F[CH][C](F)F(183)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O][C]=O(188)', 'F[CH][C](F)F(183)'],
    products = ['[O]C(=O)C(F)[C](F)F(337)'],
