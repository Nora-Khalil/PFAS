...
"""),
    E0 = (234.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,180,723.218,723.235,723.24],'cm^-1')),
        HinderedRotor(inertia=(0.00984527,'amu*angstrom^2'), symmetry=1, barrier=(3.65427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0098447,'amu*angstrom^2'), symmetry=1, barrier=(3.65406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.01452,0.0178058,-4.92918e-06,-9.0594e-09,5.69375e-12,28256.2,14.7563], Tmin=(100,'K'), Tmax=(922.624,'K')), NASAPolynomial(coeffs=[8.13507,0.00563941,-1.46155e-06,2.2198e-10,-1.50717e-14,26884.3,-11.8493], Tmin=(922.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CsJOO)"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47653,0.0587916,-8.24502e-05,6.02875e-08,-1.7514e-11,-26369.3,24.4671], Tmin=(100,'K'), Tmax=(843.41,'K')), NASAPolynomial(coeffs=[10.2816,0.0170306,-8.17558e-06,1.57539e-09,-1.10147e-13,-27854.5,-16.5123], Tmin=(843.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(ROOJ) + radical(CCsJOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC[C](F)F(1490)'],
    products = ['O2(2)', 'FC1(F)CO1(1321)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.09e+12,'s^-1'), n=0, Ea=(54.7981,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;C_ter_rad_intra;OO_intra]
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[C](F)F(1156)'],
    products = ['[O]OOC[C](F)F(1490)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]OO[O](1499)'],
    products = ['[O]OOC[C](F)F(1490)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.76e+09,'s^-1'), n=0.311, Ea=(7.1128,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SSSS;Y_rad_out;Cpri_rad_out_single] for rate rule [R5_SSSS;O_rad;Cpri_rad_out_noH]
...
reaction(
    label = 'reaction9',
    reactants = ['O2(2)', '[O]C[C](F)F(1170)'],
    products = ['[O]OOC[C](F)F(1490)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(55.4988,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]OO[O](1499)'],
    products = ['[O]OOC[C](F)F(1490)'],
