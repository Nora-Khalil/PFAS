...
reaction(
    label = 'reaction3',
    reactants = ['OF(153)', 'O=C(O)[C]F(844)'],
    products = ['O=C(O)C(F)OF(1363)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(845)'],
    products = ['O=C(O)C(F)OF(1363)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(1396)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(1397)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', 'O=C(O)[CH]F(1398)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'O=[C]C(F)OF(1399)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(1400)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(177)', 'O=[C]O(189)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(849)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'O=CC(=O)O(1401)'],
    products = ['O=C(O)C(F)OF(1363)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(652)'],
    products = ['O=C(O)C(F)OF(1363)'],
