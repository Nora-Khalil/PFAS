...
"""),
    E0 = (-710.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,180,921.507],'cm^-1')),
        HinderedRotor(inertia=(0.248835,'amu*angstrom^2'), symmetry=1, barrier=(5.72121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247903,'amu*angstrom^2'), symmetry=1, barrier=(5.69978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['OH(4)', '[CH2]OC(F)(F)F(1798)'],
    products = ['OCOC(F)(F)F(1593)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]COC(F)(F)F(1799)'],
    products = ['OCOC(F)(F)F(1593)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(603)'],
    products = ['OCOC(F)(F)F(1593)'],
    transitionState = 'TS8',
