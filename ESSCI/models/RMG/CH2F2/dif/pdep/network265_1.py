...
"""),
    E0 = (-529.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([235,523,627,1123,1142,1372,1406,3097,90,150,250,247,323,377,431,433,1065,1274,2227.29],'cm^-1')),
        HinderedRotor(inertia=(0.00118407,'amu*angstrom^2'), symmetry=1, barrier=(4.16934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00937969,'amu*angstrom^2'), symmetry=1, barrier=(33.2415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44917,0.0629879,-0.000106331,9.77304e-08,-3.529e-11,-63573.9,20.0334], Tmin=(100,'K'), Tmax=(801.091,'K')), NASAPolynomial(coeffs=[7.00714,0.0241234,-1.27518e-05,2.53786e-09,-1.78919e-13,-64107.9,-3.32241], Tmin=(801.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-554.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,190,488,555,1236,1407,180,2250.73],'cm^-1')),
        HinderedRotor(inertia=(0.397588,'amu*angstrom^2'), symmetry=1, barrier=(9.14133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399335,'amu*angstrom^2'), symmetry=1, barrier=(9.1815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45412,0.0670936,-0.000128682,1.28363e-07,-4.81509e-11,-66597.3,23.7222], Tmin=(100,'K'), Tmax=(836.717,'K')), NASAPolynomial(coeffs=[4.3494,0.0286336,-1.55991e-05,3.09727e-09,-2.16319e-13,-66220,15.4201], Tmin=(836.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.199797,'amu*angstrom^2'), symmetry=1, barrier=(4.59373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200236,'amu*angstrom^2'), symmetry=1, barrier=(4.60383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05555,0.0738349,-0.000134465,1.2444e-07,-4.39144e-11,-86806.2,27.4999], Tmin=(100,'K'), Tmax=(841.942,'K')), NASAPolynomial(coeffs=[7.93545,0.0232112,-1.23156e-05,2.41523e-09,-1.6731e-13,-87328.9,-0.732368], Tmin=(841.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C(F)F(683)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]C(F)C(F)F-2(974)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(166)', 'CHF2-CHF(66)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC(F)=CC(F)F(894)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC(F)=C(F)C(F)F(718)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)[CH]C(F)F(975)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(F)[C](F)F(789)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', 'F[CH][C](F)F(635)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C](F)[C](F)C(F)F(976)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)[C](F)F(761)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(77)', 'F[CH]C=C(F)F(977)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'FC=C(F)[C](F)F(978)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[C](F)C=C(F)F(979)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'F[C]C(F)C(F)F(891)'],
    products = ['F[C](F)C(F)C(F)F(682)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)F(682)'],
    products = ['F[C](C(F)F)C(F)F(980)'],
