...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(152)', '[CH]F(125)'],
    products = ['[O]C(F)(F)O[CH]F(430)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(472)'],
    products = ['[O]C(F)(F)O[CH]F(430)'],
    transitionState = 'TS6',
