...
"""),
    E0 = (-172.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,505,655,1117,1193,1185,1289,1311,1435,3104,3190,180],'cm^-1')),
        HinderedRotor(inertia=(0.510936,'amu*angstrom^2'), symmetry=1, barrier=(11.7474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9951,'amu*angstrom^2'), symmetry=1, barrier=(45.8712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.723615,'amu*angstrom^2'), symmetry=1, barrier=(45.851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06055,0.0476914,-6.60564e-05,5.2617e-08,-1.7613e-11,-20724.7,19.7766], Tmin=(100,'K'), Tmax=(719.058,'K')), NASAPolynomial(coeffs=[6.72093,0.0217667,-1.19763e-05,2.47772e-09,-1.80868e-13,-21394.9,-1.16998], Tmin=(719.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]O[CH]F(159)'],
    products = ['F[CH]OO[CH]F(588)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['F[CH]OO[CH]F(588)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(241.117,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 238.2 to 241.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['F[CH]OO[CH]F(588)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.69158e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(12.7336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CHF(86)', '[O]O[CH]F(159)'],
    products = ['F[CH]OO[CH]F(588)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(1.63566,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)
