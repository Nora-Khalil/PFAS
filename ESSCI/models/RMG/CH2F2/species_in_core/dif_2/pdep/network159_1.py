...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)[C](F)F(356)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(F)[C](F)F(386)'],
    products = ['F[C](F)OC(F)[C](F)F(356)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OC=C(F)F(451)'],
    products = ['F[C](F)OC(F)[C](F)F(356)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)OC(F)=C(F)F(452)'],
    products = ['F[C](F)OC(F)[C](F)F(356)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', '[O]C(F)[C](F)F(386)'],
    products = ['F[C](F)OC(F)[C](F)F(356)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)OC(F)[C](F)F(356)'],
    products = ['F[C](F)O[C](F)C(F)F(453)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)OC(F)[C](F)F(356)'],
    products = ['F[C](F)O[CH]C(F)(F)F(455)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)OC(F)[C](F)F(356)'],
    products = ['F[C](F)[CH]OC(F)(F)F(456)'],
