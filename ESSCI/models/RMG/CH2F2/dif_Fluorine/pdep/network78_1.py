...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)F(128)', '[O]OC(F)F(128)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OOOOC(F)F(220)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOOOOC(F)F(312)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[CH]OOOOC(F)F(313)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(146)', '[O]OOC(F)F(165)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF2(81)', '[O]OOOC(F)F(163)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)OOOOC(F)F(314)'],
    products = ['FC(F)OOOOC(F)F(221)'],
    transitionState = 'TS7',
...
network(
    label = 'PDepNetwork #78',
    isomers = [
        'FC(F)OOOOC(F)F(221)',
    ],
    reactants = [
        ('[O]OC(F)F(128)', '[O]OC(F)F(128)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
