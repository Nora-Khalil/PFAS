...
"""),
    E0 = (-62.4972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,580,1155,1237,1373,3147,180,1704.32],'cm^-1')),
        HinderedRotor(inertia=(1.10281,'amu*angstrom^2'), symmetry=1, barrier=(25.3558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6681,'amu*angstrom^2'), symmetry=1, barrier=(38.3529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49438,0.0368259,-5.43687e-05,4.3303e-08,-1.4099e-11,-7465.87,15.6266], Tmin=(100,'K'), Tmax=(745.513,'K')), NASAPolynomial(coeffs=[6.81293,0.0136545,-7.74609e-06,1.61043e-09,-1.1757e-13,-8109.76,-3.93956], Tmin=(745.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.4972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'CF2(42)'],
    products = ['[O]OC(F)F(128)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(72.2052,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(124)', 'CHF(40)'],
    products = ['[O]OC(F)F(128)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(20.1432,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)F(146)'],
    products = ['[O]OC(F)F(128)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(128)'],
    products = ['OH(4)', 'CF2O(48)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OOF(148)'],
    products = ['[O]OC(F)F(128)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(85.3834,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #19',
    isomers = [
        '[O]OC(F)F(128)',
    ],
    reactants = [
