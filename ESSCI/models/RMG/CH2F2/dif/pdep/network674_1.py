...
"""),
    E0 = (-490.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,2750,2800,2850,1350,1500,750,1050,1375,1000,184.815,185.787,1873.26],'cm^-1')),
        HinderedRotor(inertia=(0.267171,'amu*angstrom^2'), symmetry=1, barrier=(6.50718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272705,'amu*angstrom^2'), symmetry=1, barrier=(6.48807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.989858,'amu*angstrom^2'), symmetry=1, barrier=(24.4839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-79.3708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1555.79,1556.02],'cm^-1')),
        HinderedRotor(inertia=(0.276549,'amu*angstrom^2'), symmetry=1, barrier=(6.3584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276273,'amu*angstrom^2'), symmetry=1, barrier=(6.35207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276562,'amu*angstrom^2'), symmetry=1, barrier=(6.35871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16838,0.0551049,-0.000117539,1.30586e-07,-5.18351e-11,-9494.42,16.9822], Tmin=(100,'K'), Tmax=(859.387,'K')), NASAPolynomial(coeffs=[-1.69405,0.0358495,-1.89417e-05,3.6853e-09,-2.53459e-13,-7455.64,43.0303], Tmin=(859.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.300781,'amu*angstrom^2'), symmetry=1, barrier=(6.91555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300778,'amu*angstrom^2'), symmetry=1, barrier=(6.91547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0105058,'amu*angstrom^2'), symmetry=1, barrier=(5.31906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0943221,'amu*angstrom^2'), symmetry=1, barrier=(47.8214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28125,0.0113178,1.84485e-05,-2.41954e-08,7.75171e-12,-44672.6,12.0363], Tmin=(100,'K'), Tmax=(1141.76,'K')), NASAPolynomial(coeffs=[4.90974,0.0187532,-8.58342e-06,1.6685e-09,-1.18615e-13,-45900.9,0.213053], Tmin=(1141.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""methyl_formate""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(228)', 'CO[CH]F(1721)'],
    products = ['COC(F)OF(1601)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
