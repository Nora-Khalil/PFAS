...
"""),
    E0 = (34.4821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,580,1155,1237,1373,3147],'cm^-1')),
        HinderedRotor(inertia=(2.1722,'amu*angstrom^2'), symmetry=1, barrier=(49.9432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350272,'amu*angstrom^2'), symmetry=1, barrier=(8.05345,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17186,0.0448324,-5.95953e-05,4.02672e-08,-8.95411e-12,4208.72,16.0053], Tmin=(100,'K'), Tmax=(608.435,'K')), NASAPolynomial(coeffs=[7.21441,0.0179806,-8.926e-06,1.76426e-09,-1.25225e-13,3478.51,-6.77475], Tmin=(608.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.4821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsJOOC) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(126)', 'CH2(T)(17)'],
    products = ['[CH2]OO[CH]F(1553)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', '[CH2]O[O](1157)'],
    products = ['[CH2]OO[CH]F(1553)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[CH]F(1553)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(177.263,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['[CH2]OO[CH]F(1553)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(11.9785,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', '[CH2]O[O](1157)'],
    products = ['[CH2]OO[CH]F(1553)'],
    transitionState = 'TS8',
