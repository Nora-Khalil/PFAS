...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(1149)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(1150)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'F[CH]OC(F)(F)F(1151)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(1152)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(623)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(442)'],
    products = ['OC(F)OC(F)(F)F(1110)'],
