...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.99132,'amu*angstrom^2'), symmetry=1, barrier=(22.7924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93755,'amu*angstrom^2'), symmetry=1, barrier=(44.548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.235529,'amu*angstrom^2'), symmetry=1, barrier=(5.41527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235513,'amu*angstrom^2'), symmetry=1, barrier=(5.4149,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00745154,0.104239,-0.00021008,2.01253e-07,-7.16108e-11,-69117.9,30.1177], Tmin=(100,'K'), Tmax=(861.985,'K')), NASAPolynomial(coeffs=[8.6107,0.0285205,-1.61456e-05,3.17988e-09,-2.18373e-13,-69276.3,-2.48092], Tmin=(861.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-575.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.285125,'amu*angstrom^2'), symmetry=1, barrier=(6.55559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24179,'amu*angstrom^2'), symmetry=1, barrier=(28.5511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287196,'amu*angstrom^2'), symmetry=1, barrier=(6.60321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.157646,0.103937,-0.000197634,1.80182e-07,-6.18727e-11,-67749,28.8663], Tmin=(100,'K'), Tmax=(859.331,'K')), NASAPolynomial(coeffs=[11.6234,0.0236575,-1.30926e-05,2.56245e-09,-1.75582e-13,-68834.4,-20.7186], Tmin=(859.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-564.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][C](F)C(F)(F)C(F)F(400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0974746,0.104473,-0.000217372,2.12569e-07,-7.61301e-11,-106618,27.6412], Tmin=(100,'K'), Tmax=(876.931,'K')), NASAPolynomial(coeffs=[6.55909,0.0311779,-1.70432e-05,3.28878e-09,-2.22206e-13,-106067,6.92335], Tmin=(876.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-887.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[C](F)F(394)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C(F)=CF(395)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(80.4921,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['F2(108)', 'O=C(F)[C](F)[CH]F(397)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(88)', '[O]C(F)(F)[C](F)F(366)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)C(F)(F)OF(398)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)[C](F)OF(399)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)C(F)(F)[CH]F(337)'],
    products = ['[O][C](F)C(F)(F)C(F)F(400)'],
...
network(
    label = 'PDepNetwork #140',
    isomers = [
        '[O]C(F)(F)C(F)(F)[CH]F(337)',
    ],
    reactants = [
        ('CF2O(48)', 'CHFCF2(54)'),
    ],
