...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.57667,'amu*angstrom^2'), symmetry=1, barrier=(36.2507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57569,'amu*angstrom^2'), symmetry=1, barrier=(36.2282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57662,'amu*angstrom^2'), symmetry=1, barrier=(36.2496,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26895,'amu*angstrom^2'), symmetry=1, barrier=(29.1758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27492,'amu*angstrom^2'), symmetry=1, barrier=(29.3129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-538.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,528,1116,1182,1331,1402,1494,3075,3110,617,898,1187,258.271,258.32,258.573,258.739],'cm^-1')),
        HinderedRotor(inertia=(0.213398,'amu*angstrom^2'), symmetry=1, barrier=(10.1316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.554786,'amu*angstrom^2'), symmetry=1, barrier=(26.3902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70366,0.0545346,-6.85392e-05,4.54572e-08,-1.22533e-11,-64658.7,19.7087], Tmin=(100,'K'), Tmax=(896.436,'K')), NASAPolynomial(coeffs=[9.52133,0.0196516,-1.01702e-05,2.04944e-09,-1.47815e-13,-66060.3,-17.1525], Tmin=(896.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-734.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,347,453,1141,1468,617,898,1187,258.916,259.001,259.012,259.016],'cm^-1')),
        HinderedRotor(inertia=(0.00251299,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256238,'amu*angstrom^2'), symmetry=1, barrier=(12.2012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602576,'amu*angstrom^2'), symmetry=1, barrier=(28.685,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08521,0.0687431,-9.24283e-05,6.34109e-08,-1.73652e-11,-88294.6,23.8648], Tmin=(100,'K'), Tmax=(889.785,'K')), NASAPolynomial(coeffs=[11.8714,0.0202534,-1.06828e-05,2.16242e-09,-1.56124e-13,-90214.1,-26.9125], Tmin=(889.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(F)C(F)F(321)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
4 O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4641,'amu*angstrom^2'), symmetry=1, barrier=(33.6626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46704,'amu*angstrom^2'), symmetry=1, barrier=(33.7301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46631,'amu*angstrom^2'), symmetry=1, barrier=(33.7133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-708.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.028424,'amu*angstrom^2'), symmetry=1, barrier=(28.9892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26176,'amu*angstrom^2'), symmetry=1, barrier=(29.0103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399685,'amu*angstrom^2'), symmetry=1, barrier=(9.18954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    E0 = (-727.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,193.963],'cm^-1')),
        HinderedRotor(inertia=(0.885555,'amu*angstrom^2'), symmetry=1, barrier=(23.4978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.895114,'amu*angstrom^2'), symmetry=1, barrier=(23.5099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.881969,'amu*angstrom^2'), symmetry=1, barrier=(23.4553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18017,'amu*angstrom^2'), symmetry=1, barrier=(27.1343,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.625158,'amu*angstrom^2'), symmetry=1, barrier=(14.3736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625033,'amu*angstrom^2'), symmetry=1, barrier=(14.3707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.624706,'amu*angstrom^2'), symmetry=1, barrier=(14.3632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.722964,'amu*angstrom^2'), symmetry=1, barrier=(16.6224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720512,'amu*angstrom^2'), symmetry=1, barrier=(16.566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931266,'amu*angstrom^2'), symmetry=1, barrier=(21.4116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.723272,'amu*angstrom^2'), symmetry=1, barrier=(16.6295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.723834,'amu*angstrom^2'), symmetry=1, barrier=(16.6424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1152,'amu*angstrom^2'), symmetry=1, barrier=(25.6406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11427,'amu*angstrom^2'), symmetry=1, barrier=(25.6192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'OC(F)CF(2372)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'OC(F)[C]F(1213)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)F(162)', 'F[C]CF-2(186)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)(F)CF(1141)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(86)', 'OC(F)(F)CF(320)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(7)', 'OC(F)C(F)(F)[C]F(2373)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(86)', 'OC(F)C(F)F(321)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(72)', 'OC(F)C(F)(F)F(1562)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OF(153)', 'FC=C(F)CF(2198)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)[C](F)CF(2375)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[CH]C(F)(F)CF(2376)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)F(2377)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(4)', 'F[CH]C(F)(F)CF(2203)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)C(F)(F)CF(2202)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[CH]F(163)', 'CH2F-CF2(67)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(89)', 'OC(F)[C](F)F(550)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)(F)CF(1344)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)(F)[CH]F(2378)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)(F)CF(1944)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(106)', 'OC=C(F)CF(2379)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(106)', 'C=C(F)C(O)F(2380)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'OC(F)=C(F)CF(1347)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'OC(F)C(F)=CF(2381)'],
    products = ['OC(F)C(F)(F)CF(2193)'],
