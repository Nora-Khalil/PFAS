...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C(F)(F)[CH]F(474)'],
    products = ['O=[C]OC(F)(F)[CH]F(338)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(282)'],
    products = ['O=[C]OC(F)(F)[CH]F(338)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[O]C(F)(F)[CH]F(474)'],
    products = ['O=[C]OC(F)(F)[CH]F(338)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(413)'],
    products = ['O=[C]OC(F)(F)[CH]F(338)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(86)', 'O=[C]O[C](F)F(282)'],
    products = ['O=[C]OC(F)(F)[CH]F(338)'],
