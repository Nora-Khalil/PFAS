...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.11138,'amu*angstrom^2'), symmetry=1, barrier=(2.56084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116642,'amu*angstrom^2'), symmetry=1, barrier=(2.68184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420606,'amu*angstrom^2'), symmetry=1, barrier=(9.67056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.245195,'amu*angstrom^2'), symmetry=1, barrier=(5.63751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244822,'amu*angstrom^2'), symmetry=1, barrier=(5.62895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244927,'amu*angstrom^2'), symmetry=1, barrier=(5.63136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.171732,0.108499,-0.000210164,2.0316e-07,-7.35564e-11,-92661.4,28.8351], Tmin=(100,'K'), Tmax=(852.749,'K')), NASAPolynomial(coeffs=[7.0768,0.0375573,-2.03958e-05,4.00143e-09,-2.76115e-13,-92554.5,2.89516], Tmin=(852.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.96641,0.0747963,-0.000133966,1.20568e-07,-4.15333e-11,-65464.7,22.6034], Tmin=(100,'K'), Tmax=(841.854,'K')), NASAPolynomial(coeffs=[9.27906,0.0204804,-1.07826e-05,2.10876e-09,-1.45812e-13,-66339.2,-12.9504], Tmin=(841.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-545.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = 'FC1CC(F)(F)C1(F)F(1256)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.317901,'amu*angstrom^2'), symmetry=1, barrier=(7.30916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55871,'amu*angstrom^2'), symmetry=1, barrier=(35.8379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.155378,'amu*angstrom^2'), symmetry=1, barrier=(3.57244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141847,'amu*angstrom^2'), symmetry=1, barrier=(55.3533,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41856,0.057337,-6.24955e-05,3.48808e-08,-7.76524e-12,-36241.4,21.1834], Tmin=(100,'K'), Tmax=(1087.33,'K')), NASAPolynomial(coeffs=[12.1126,0.0179965,-8.22453e-06,1.6061e-09,-1.14727e-13,-38567,-31.3047], Tmin=(1087.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.23587,'amu*angstrom^2'), symmetry=1, barrier=(5.42311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235768,'amu*angstrom^2'), symmetry=1, barrier=(5.42076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64898,'amu*angstrom^2'), symmetry=1, barrier=(37.9134,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0288289,0.101062,-0.000182069,1.70122e-07,-6.11186e-11,-88522,29.2745], Tmin=(100,'K'), Tmax=(825.792,'K')), NASAPolynomial(coeffs=[8.75919,0.0348662,-1.89096e-05,3.75383e-09,-2.62647e-13,-89167.8,-6.56248], Tmin=(825.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)C(F)F(1288)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0840321,0.0947997,-0.00015714,1.3799e-07,-4.77309e-11,-92650,28.9839], Tmin=(100,'K'), Tmax=(799.446,'K')), NASAPolynomial(coeffs=[10.7608,0.0304596,-1.59311e-05,3.1492e-09,-2.21094e-13,-94008.2,-17.953], Tmin=(799.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'F[CH][C](F)C(F)(F)CF(1289)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.656637,'amu*angstrom^2'), symmetry=1, barrier=(15.0974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237088,'amu*angstrom^2'), symmetry=1, barrier=(5.45113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55587,'amu*angstrom^2'), symmetry=1, barrier=(35.7726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143078,0.10196,-0.000178329,1.62028e-07,-5.72833e-11,-89356.3,29.0761], Tmin=(100,'K'), Tmax=(809.74,'K')), NASAPolynomial(coeffs=[10.4468,0.0324436,-1.76865e-05,3.53255e-09,-2.48615e-13,-90507.3,-16.2967], Tmin=(809.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-744.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', 'F[CH]C(F)(F)[C](F)F(773)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(128)', '[CH2]C(F)(F)[C](F)F(1221)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    products = ['FC1CC(F)(F)C1(F)F(1256)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[CH]F(1284)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(7.98827,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=CF(1285)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH2]C(F)=C(F)[CH]F(1286)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C](F)F(1221)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)[C](F)CF(1287)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(1288)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][C](F)C(F)(F)CF(1289)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1187)'],
...
network(
    label = 'PDepNetwork #451',
    isomers = [
        '[CH2]C(F)(F)C(F)(F)[CH]F(1187)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CF2(56)'),
    ],
