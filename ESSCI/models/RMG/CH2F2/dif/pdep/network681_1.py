...
"""),
    E0 = (-244.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,2750,2850,1437.5,1250,1305,750,350,401.848,401.851],'cm^-1')),
        HinderedRotor(inertia=(0.188027,'amu*angstrom^2'), symmetry=1, barrier=(21.5478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188053,'amu*angstrom^2'), symmetry=1, barrier=(21.5475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187928,'amu*angstrom^2'), symmetry=1, barrier=(21.5473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.0312,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80034,0.0347566,-9.88433e-07,-3.98292e-08,2.23082e-11,-29275.5,17.9374], Tmin=(100,'K'), Tmax=(917.174,'K')), NASAPolynomial(coeffs=[18.9222,-0.00407386,3.89944e-06,-7.74504e-10,4.90258e-14,-33923.7,-71.4038], Tmin=(917.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.501208,'amu*angstrom^2'), symmetry=1, barrier=(11.5238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501308,'amu*angstrom^2'), symmetry=1, barrier=(11.5261,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69194,0.0271135,-2.49832e-05,1.1931e-08,-2.28597e-12,-21673.7,14.0558], Tmin=(100,'K'), Tmax=(1253.49,'K')), NASAPolynomial(coeffs=[8.2138,0.00949297,-3.89779e-06,7.16893e-10,-4.94198e-14,-23058.1,-13.8317], Tmin=(1253.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""HOCH2OO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (134.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3000,3100,440,815,1455,1000,597.989],'cm^-1')),
        HinderedRotor(inertia=(0.000471149,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205807,'amu*angstrom^2'), symmetry=1, barrier=(52.051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94139,0.0233296,-2.00299e-05,8.75636e-09,-1.56469e-12,16176.6,12.1985], Tmin=(100,'K'), Tmax=(1308.55,'K')), NASAPolynomial(coeffs=[7.34113,0.00988035,-4.61293e-06,9.01901e-10,-6.40903e-14,15025.2,-10.2109], Tmin=(1308.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsJOO)"""),
)
...
"""),
    E0 = (-16.7763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2850,1437.5,1250,1305,750,350,464.176,464.408,464.784],'cm^-1')),
        HinderedRotor(inertia=(0.000781959,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296379,'amu*angstrom^2'), symmetry=1, barrier=(45.4428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0232,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23333,0.0331039,-2.83823e-05,1.13529e-08,-1.76475e-12,-1949.31,16.8716], Tmin=(100,'K'), Tmax=(1553.35,'K')), NASAPolynomial(coeffs=[12.2269,0.00737035,-3.53317e-06,6.8845e-10,-4.84355e-14,-5054.09,-35.7431], Tmin=(1553.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsHH) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OCOOF(1608)'],
    products = ['O=O(176)', 'HF(38)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(107.43,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]OCO(1541)'],
    products = ['OCOOF(1608)'],
    transitionState = 'TS2',
