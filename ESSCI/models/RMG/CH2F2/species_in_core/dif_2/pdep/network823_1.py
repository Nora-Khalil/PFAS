...
"""),
    E0 = (25.0348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,421.552,421.556,421.564],'cm^-1')),
        HinderedRotor(inertia=(0.00094858,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00094862,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74079,0.0211543,3.72345e-06,-1.92874e-08,8.49829e-12,3062.05,15.022], Tmin=(100,'K'), Tmax=(1016.3,'K')), NASAPolynomial(coeffs=[8.92514,0.0118918,-4.86006e-06,9.4136e-10,-6.87764e-14,1026.33,-18.7449], Tmin=(1016.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.0348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95179,-0.0183993,0.000183534,-2.55046e-07,1.0504e-10,-27998.3,9.76015], Tmin=(100,'K'), Tmax=(910.355,'K')), NASAPolynomial(coeffs=[29.0323,-0.0252588,1.7321e-05,-3.32826e-09,2.13465e-13,-37211,-138.133], Tmin=(910.355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28123,0.0113181,1.84477e-05,-2.41945e-08,7.75136e-12,-44672.6,12.0364], Tmin=(100,'K'), Tmax=(1141.77,'K')), NASAPolynomial(coeffs=[4.90989,0.018753,-8.58328e-06,1.66847e-09,-1.18612e-13,-45901,0.212187], Tmin=(1141.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""methyl_formate""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19801,0.0396778,-5.03099e-05,3.31155e-08,-8.53807e-12,-1547.15,16.2847], Tmin=(100,'K'), Tmax=(955.298,'K')), NASAPolynomial(coeffs=[9.27221,0.0100563,-3.79754e-06,6.55633e-10,-4.32052e-14,-2898.72,-17.5206], Tmin=(955.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.4029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (26.1241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1585.51,1585.99],'cm^-1')),
        HinderedRotor(inertia=(0.178484,'amu*angstrom^2'), symmetry=1, barrier=(4.1037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178649,'amu*angstrom^2'), symmetry=1, barrier=(4.10749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85384,0.0354443,-7.02815e-05,8.23549e-08,-3.43438e-11,3173.35,13.6115], Tmin=(100,'K'), Tmax=(849.202,'K')), NASAPolynomial(coeffs=[-1.87199,0.0312396,-1.61081e-05,3.12772e-09,-2.16046e-13,4930.23,41.2569], Tmin=(849.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(66)', '[O]C[O](194)'],
    products = ['[CH2]OC[O](2072)'],
    transitionState = 'TS2',
