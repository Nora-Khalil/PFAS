...
"""),
    E0 = (-163.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,1855,455,950,293.181,293.439,2053.61],'cm^-1')),
        HinderedRotor(inertia=(0.17322,'amu*angstrom^2'), symmetry=1, barrier=(10.5762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173171,'amu*angstrom^2'), symmetry=1, barrier=(10.5788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513593,'amu*angstrom^2'), symmetry=1, barrier=(31.2745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21597,0.044737,-5.03987e-05,2.35435e-08,1.78319e-12,-19592.9,20.3515], Tmin=(100,'K'), Tmax=(554.775,'K')), NASAPolynomial(coeffs=[6.40262,0.0224292,-1.13848e-05,2.25921e-09,-1.60832e-13,-20178.7,1.52741], Tmin=(554.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(Cds-OdCsH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61889,0.0420472,-1.96454e-05,-1.64208e-08,1.26183e-11,-46764.9,17.668], Tmin=(100,'K'), Tmax=(929.887,'K')), NASAPolynomial(coeffs=[16.7834,0.00326666,2.43108e-07,-8.91107e-11,3.26931e-15,-50728.8,-60.5389], Tmin=(929.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFHHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-191.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,580,1155,1237,1373,3147,2120,512.5,787.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08024,'amu*angstrom^2'), symmetry=1, barrier=(24.8369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07986,'amu*angstrom^2'), symmetry=1, barrier=(24.8282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01925,0.0522832,-6.00648e-05,3.12115e-08,-5.93633e-12,-22964.8,20.5705], Tmin=(100,'K'), Tmax=(1498.59,'K')), NASAPolynomial(coeffs=[17.1964,-0.000182169,1.74443e-06,-4.19885e-10,3.03133e-14,-26770.7,-60.5401], Tmin=(1498.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFHHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28205,0.0421157,2.53946e-06,-5.56436e-08,3.07604e-11,-27781.6,20.2312], Tmin=(100,'K'), Tmax=(908.853,'K')), NASAPolynomial(coeffs=[23.2596,-0.00739928,6.34132e-06,-1.27661e-09,8.35695e-14,-33726.3,-94.4243], Tmin=(908.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57463,0.0396886,-4.93449e-06,-3.73437e-08,2.15067e-11,-22738.1,21.562], Tmin=(100,'K'), Tmax=(920.035,'K')), NASAPolynomial(coeffs=[19.0613,-0.000607092,2.50888e-06,-5.26021e-10,3.23211e-14,-27468,-69.5619], Tmin=(920.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C[C]=O(1921)'],
    products = ['O=[C]CO[CH]F(3291)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', '[CH2]O[CH]F(900)'],
    products = ['O=[C]CO[CH]F(3291)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['O=[C]CO[CH]F(3291)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(97.9771,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
