...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28608,0.0503585,-3.51657e-05,5.96411e-09,1.65713e-12,-101401,26.3087], Tmin=(100,'K'), Tmax=(1115.39,'K')), NASAPolynomial(coeffs=[15.8369,0.0136612,-6.63871e-06,1.3603e-09,-1.00775e-13,-105610,-49.7974], Tmin=(1115.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(COCsFO) + ring(O2s-Cs(F)(F)-Cs-O2s)"""),
)

species(
    label = 'F[C](F)OOC1O[C]1F(3029)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.831563,'amu*angstrom^2'), symmetry=1, barrier=(19.1193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28293,'amu*angstrom^2'), symmetry=1, barrier=(52.4891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832236,'amu*angstrom^2'), symmetry=1, barrier=(19.1348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15655,0.0653794,-8.8475e-05,5.95493e-08,-1.57528e-11,-35778.1,25.4517], Tmin=(100,'K'), Tmax=(926.917,'K')), NASAPolynomial(coeffs=[12.7026,0.0155534,-7.84245e-06,1.55547e-09,-1.11112e-13,-37918.5,-29.3749], Tmin=(926.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = 'O=[C]C(F)OO[C](F)F(3020)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.639869,'amu*angstrom^2'), symmetry=1, barrier=(14.7118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17377,'amu*angstrom^2'), symmetry=1, barrier=(49.9793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.642926,'amu*angstrom^2'), symmetry=1, barrier=(14.7821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16968,'amu*angstrom^2'), symmetry=1, barrier=(49.8852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232912,0.0906443,-0.000155033,1.33864e-07,-4.49972e-11,-66094.3,29.42], Tmin=(100,'K'), Tmax=(816.999,'K')), NASAPolynomial(coeffs=[11.9781,0.0230709,-1.24818e-05,2.45785e-09,-1.71162e-13,-67677.4,-22.8134], Tmin=(816.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=[C][CH]OOC(F)(F)F(3033)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86185,0.0756617,-0.000110405,8.60149e-08,-2.71896e-11,-76711.6,27.9503], Tmin=(100,'K'), Tmax=(769.87,'K')), NASAPolynomial(coeffs=[10.336,0.0264332,-1.44817e-05,2.94406e-09,-2.11964e-13,-78170.3,-15.2785], Tmin=(769.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFFO) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)(C=O)O[C](F)F(3010)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399418,'amu*angstrom^2'), symmetry=1, barrier=(9.1834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.447236,'amu*angstrom^2'), symmetry=1, barrier=(10.2828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219064,'amu*angstrom^2'), symmetry=1, barrier=(5.0367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.3869,'amu*angstrom^2'), symmetry=1, barrier=(54.8795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.027,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17571,0.0695573,-0.000124698,1.11885e-07,-3.84888e-11,-6948.93,28.5004], Tmin=(100,'K'), Tmax=(842.103,'K')), NASAPolynomial(coeffs=[8.93105,0.0190275,-1.03032e-05,2.01419e-09,-1.39012e-13,-7769.62,-4.69936], Tmin=(842.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.5629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(C=CJO)"""),
)

species(
    label = 'OC(F)=[C]OO[C](F)F(3037)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.133082,'amu*angstrom^2'), symmetry=1, barrier=(3.05982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132791,'amu*angstrom^2'), symmetry=1, barrier=(3.05312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.38334,'amu*angstrom^2'), symmetry=1, barrier=(100.782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.48412,'amu*angstrom^2'), symmetry=1, barrier=(34.123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.550202,'amu*angstrom^2'), symmetry=1, barrier=(12.6502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787077,'amu*angstrom^2'), symmetry=1, barrier=(18.0965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48488,'amu*angstrom^2'), symmetry=1, barrier=(34.1403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540718,0.0832235,-0.000124928,9.45648e-08,-2.85033e-11,-58997.4,27.6947], Tmin=(100,'K'), Tmax=(811.031,'K')), NASAPolynomial(coeffs=[12.7869,0.0228257,-1.32231e-05,2.74394e-09,-1.99722e-13,-60983.8,-28.8211], Tmin=(811.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(COCsFO) + radical(CH2_triplet)"""),
)

species(
    label = 'FO[C]=COO[C](F)F(3039)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-82.2325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,231,791,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,1685,370,291.961,294.534],'cm^-1')),
        HinderedRotor(inertia=(0.717483,'amu*angstrom^2'), symmetry=1, barrier=(42.5346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157047,'amu*angstrom^2'), symmetry=1, barrier=(9.56537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07445,'amu*angstrom^2'), symmetry=1, barrier=(66.3271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157463,'amu*angstrom^2'), symmetry=1, barrier=(9.58048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.462719,0.0830838,-0.000127498,9.8101e-08,-2.96408e-11,-9767.75,32.7322], Tmin=(100,'K'), Tmax=(814.535,'K')), NASAPolynomial(coeffs=[13.4467,0.0193199,-1.00702e-05,1.98685e-09,-1.40003e-13,-11882.9,-27.2442], Tmin=(814.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.2325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(171)', '[CH]C(=O)F-2(2781)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]O[CH]C(=O)F(2756)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['O=C(F)C1OOC1(F)F(3012)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['F[C](F)OOC1O[C]1F(3029)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['[O]C1(F)[CH]OOC1(F)F(3031)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COO[C](F)F(3032)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', '[O]O[CH]C(=O)F(2756)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]C(F)OO[C](F)F(3020)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['O=[C][CH]OOC(F)(F)F(3033)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'F[C]=COO[C](F)F(3034)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['[O][C](F)F(176)', 'FC1=COO1(1838)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C(F)[CH]OO[C](F)F(2985)'],
    products = ['[O][C](F)C1OOC1(F)F(3036)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C=[C]OO[C](F)F(3025)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OC(F)=[C]OO[C](F)F(3037)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(F)[C]OOC(F)F(3038)'],
    products = ['O=C(F)[CH]OO[C](F)F(2985)'],
...
network(
    label = 'PDepNetwork #1186',
    isomers = [
        'O=C(F)[CH]OO[C](F)F(2985)',
    ],
    reactants = [
        ('CF2O(48)', 'O=CC(=O)F(557)'),
        ('CF2(42)', '[O]O[CH]C(=O)F(2756)'),
        ('CF2(87)', '[O]O[CH]C(=O)F(2756)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
