...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53663,0.0277017,-1.54809e-05,2.36577e-10,1.90182e-12,30018.1,13.5], Tmin=(100,'K'), Tmax=(1049.25,'K')), NASAPolynomial(coeffs=[9.01129,0.0114511,-4.30421e-06,7.94584e-10,-5.61067e-14,28195.2,-20.2597], Tmin=(1049.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CsJOOC) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]O[O](1157)'],
    products = ['[CH2]OO[CH2](1583)'],
    transitionState = 'TS2',
