...
"""),
    ...
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53762,0.0408917,-1.09249e-05,-4.89173e-08,4.05569e-11,-104600,13.1363], Tmin=(10,'K'), Tmax=(613.366,'K')), NASAPolynomial(coeffs=[8.37338,0.0267679,-1.89664e-05,6.10476e-09,-7.33235e-13,-105521,-10.4997], Tmin=(613.366,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-869.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[O]OC(F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.423859,'amu*angstrom^2'), symmetry=1, barrier=(9.74534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427728,'amu*angstrom^2'), symmetry=1, barrier=(9.8343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752133,0.0844089,-0.000171854,1.63425e-07,-5.74727e-11,-78847.6,24.213], Tmin=(100,'K'), Tmax=(870.769,'K')), NASAPolynomial(coeffs=[8.29005,0.020595,-1.16481e-05,2.27713e-09,-1.5498e-13,-79053.8,-4.75611], Tmin=(870.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-810.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,253,525,597,667,842,1178,1324,190,488,555,1236,1407,180],'cm^-1')),
        HinderedRotor(inertia=(0.642079,'amu*angstrom^2'), symmetry=1, barrier=(14.7627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.64083,'amu*angstrom^2'), symmetry=1, barrier=(14.734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640262,'amu*angstrom^2'), symmetry=1, barrier=(14.7209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.49479,0.0412112,0.000112381,-5.36895e-07,5.44476e-10,-97541.4,13.6758], Tmin=(10,'K'), Tmax=(396.217,'K')), NASAPolynomial(coeffs=[9.96686,0.0261339,-2.0819e-05,7.38505e-09,-9.58136e-13,-98448.8,-16.535], Tmin=(396.217,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-810.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""OOC(F)(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FOO[C](F)C(F)F(410)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-498.442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436],'cm^-1')),
        HinderedRotor(inertia=(1.29455,'amu*angstrom^2'), symmetry=1, barrier=(29.7642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7654,0.0821418,-0.000155411,1.47632e-07,-5.34188e-11,-59842.9,24.4519], Tmin=(100,'K'), Tmax=(828.229,'K')), NASAPolynomial(coeffs=[7.80697,0.0264081,-1.5124e-05,3.03889e-09,-2.13333e-13,-60264.2,-3.694], Tmin=(828.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(F)(F)OOF(411)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-503.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,253,525,597,667,842,1178,1324,334,575,1197,1424,3202],'cm^-1')),
        HinderedRotor(inertia=(1.38363,'amu*angstrom^2'), symmetry=1, barrier=(31.8124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45553,0.0469211,9.70903e-05,-5.73152e-07,6.50389e-10,-60554.3,13.3039], Tmin=(10,'K'), Tmax=(361.046,'K')), NASAPolynomial(coeffs=[9.30987,0.0289345,-2.29225e-05,8.03533e-09,-1.03259e-12,-61282.6,-13.2066], Tmin=(361.046,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-503.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""F[CH]C(F)(F)OOF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(89)', '[O]OC(F)F(128)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(215.665,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(154)', 'F[C]C(F)F(182)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(23.1681,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)(F)F(416)', 'CHF(88)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.4885e-05,'m^3/(mol*s)'), n=3.30609, Ea=(153.491,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)C(F)F(406)'],
    products = ['[O]OC(F)C(F)(F)F(405)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C(F)F(259)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)(F)C(F)F(406)'],
    products = ['HO2(10)', 'CF2CF2(60)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.58174e+10,'s^-1'), n=0.573333, Ea=(185.202,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)C(F)F(406)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]F(234)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(147)', 'CHF2(81)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)F(356)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(108)', '[O]OC(F)=CF(407)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(408)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(159.659,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['OOC(F)(F)[C](F)F(409)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FOO[C](F)C(F)F(410)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(88.4244,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)OOF(411)'],
    products = ['[O]OC(F)(F)C(F)F(406)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(66.2465,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #155',
    isomers = [
        '[O]OC(F)(F)C(F)F(406)',
    ],
    reactants = [
        ('[O]OC(F)(F)F(416)', 'CHF(88)'),
        ('HO2(10)', 'CF2CF2(60)'),
        ('O2(2)', 'CHF2-CF2(68)'),
        ('[O]O[C](F)F(147)', 'CHF2(81)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
