...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.88972,'amu*angstrom^2'), symmetry=1, barrier=(43.4485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06028,0.0235152,3.48167e-05,-7.80744e-08,3.54799e-11,-25689.8,18.2991], Tmin=(100,'K'), Tmax=(937.225,'K')), NASAPolynomial(coeffs=[20.392,-0.00598453,4.02562e-06,-6.86045e-10,3.6242e-14,-31266.6,-80.3719], Tmin=(937.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03642,-0.0092689,0.000132092,-1.77162e-07,6.94162e-11,-55702.5,13.9658], Tmin=(100,'K'), Tmax=(948.185,'K')), NASAPolynomial(coeffs=[20.7699,-0.00621483,4.08121e-06,-5.51437e-10,1.57837e-14,-62565.6,-89.102], Tmin=(948.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)O2s) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]O[C]=O(186)'],
    products = ['O=[C]OO[C]=O(184)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['O=[C]OO[C]=O(184)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.64086e-07,'m^3/(mol*s)'), n=3.71185, Ea=(162.529,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
