...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.111771,'amu*angstrom^2'), symmetry=1, barrier=(2.56983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.06299,0.0306916,-6.02109e-05,7.38374e-08,-3.15457e-11,4234.93,14.9106], Tmin=(100,'K'), Tmax=(854.476,'K')), NASAPolynomial(coeffs=[-2.91924,0.0321474,-1.61619e-05,3.10896e-09,-2.13694e-13,6226.45,48.5018], Tmin=(854.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.0118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14403,0.016134,3.9754e-06,-9.75365e-09,3.12581e-12,-1856.7,8.1606], Tmin=(100,'K'), Tmax=(1249.44,'K')), NASAPolynomial(coeffs=[4.88628,0.0182402,-7.778e-06,1.43975e-09,-9.873e-14,-2891.83,-3.03285], Tmin=(1249.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75092,0.0145255,3.55413e-05,-6.1234e-08,2.54827e-11,-39934.3,13.5048], Tmin=(100,'K'), Tmax=(953.77,'K')), NASAPolynomial(coeffs=[12.7142,0.00531893,-1.21596e-06,2.71915e-10,-2.64252e-14,-43316.6,-41.859], Tmin=(953.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""HOCH2CHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-10.3955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,2261.06],'cm^-1')),
        HinderedRotor(inertia=(0.223718,'amu*angstrom^2'), symmetry=1, barrier=(5.14373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223267,'amu*angstrom^2'), symmetry=1, barrier=(5.13334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47469,0.041632,-7.70015e-05,7.78831e-08,-2.90449e-11,-1203.08,16.4059], Tmin=(100,'K'), Tmax=(877.58,'K')), NASAPolynomial(coeffs=[2.29999,0.0226911,-1.08909e-05,2.03336e-09,-1.36526e-13,-412.393,21.5561], Tmin=(877.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C[O](1970)'],
    products = ['[O]CC[O](2071)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](1639)', '[CH2][O](1639)'],
    products = ['[O]CC[O](2071)'],
    transitionState = 'TS7',
