...
"""),
    E0 = (-763.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,805.854,1505.11],'cm^-1')),
        HinderedRotor(inertia=(1.57455,'amu*angstrom^2'), symmetry=1, barrier=(36.202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57572,'amu*angstrom^2'), symmetry=1, barrier=(36.2289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00685,0.0371,-2.51039e-05,4.68035e-09,7.59551e-13,-91747.1,20.8435], Tmin=(100,'K'), Tmax=(1171.65,'K')), NASAPolynomial(coeffs=[12.414,0.0118129,-5.84354e-06,1.18276e-09,-8.62509e-14,-94888.9,-34.014], Tmin=(1171.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-699.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,1855,455,950,236.813,236.822,237.094],'cm^-1')),
        HinderedRotor(inertia=(1.20655,'amu*angstrom^2'), symmetry=1, barrier=(48.0674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20884,'amu*angstrom^2'), symmetry=1, barrier=(48.0922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.803456,'amu*angstrom^2'), symmetry=1, barrier=(32.013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39406,0.0620106,-8.50825e-05,5.84245e-08,-1.59943e-11,-83983.9,20.9508], Tmin=(100,'K'), Tmax=(889.671,'K')), NASAPolynomial(coeffs=[11.3207,0.0173792,-9.83214e-06,2.03556e-09,-1.48612e-13,-85750.2,-25.7791], Tmin=(889.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(422)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(423)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(240)', '[O]C=O(135)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(424)', 'HCO(14)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(228)', 'O=CO[C](F)F(396)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(425)'],
    products = ['O=COC(F)(F)OF(329)'],
    transitionState = 'TS9',
