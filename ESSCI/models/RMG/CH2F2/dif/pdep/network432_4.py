...
"""),
    ...
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09213,0.046725,-7.94777e-05,7.1355e-08,-2.49589e-11,-30696.7,15.5486], Tmin=(100,'K'), Tmax=(816.609,'K')), NASAPolynomial(coeffs=[6.94858,0.0153516,-7.91628e-06,1.55899e-09,-1.09044e-13,-31237,-5.34854], Tmin=(816.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    E0 = (-268.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,493,600,700,1144,1293,277.823,1868.07],'cm^-1')),
        HinderedRotor(inertia=(0.140027,'amu*angstrom^2'), symmetry=1, barrier=(7.64386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138378,'amu*angstrom^2'), symmetry=1, barrier=(7.65198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4756,0.0365909,-5.19925e-05,4.12112e-08,-1.33063e-11,-32228.9,16.5036], Tmin=(100,'K'), Tmax=(753.788,'K')), NASAPolynomial(coeffs=[6.7391,0.0139661,-6.96974e-06,1.39137e-09,-9.94946e-14,-32871.6,-2.86013], Tmin=(753.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsJOCH3) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-57.2134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,627.241,627.262,627.262,627.263,951.568,1554.58,1554.58,1554.58],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-283.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,180,180,426.625,1067.59,1068.24,1068.44,1068.47,1068.68,1068.71,1068.72],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0255,'amu'),
...
"""),
    E0 = (-29.4903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,235.297,802.425,802.426,802.444,802.457,802.462,802.472],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14416,0.0129864,6.60986e-06,-2.08047e-08,9.56978e-12,-3510.75,9.45203], Tmin=(100,'K'), Tmax=(957.688,'K')), NASAPolynomial(coeffs=[8.89,0.00340767,-9.7298e-07,1.96238e-10,-1.66712e-14,-5272.58,-21.4724], Tmin=(957.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.4903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + ring(Cyclopropene)"""),
)
...
"""),
    ...
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17396,0.0464429,-8.45463e-05,7.96921e-08,-2.84826e-11,5458.09,18.6478], Tmin=(100,'K'), Tmax=(849.59,'K')), NASAPolynomial(coeffs=[5.69313,0.0166193,-8.48887e-06,1.64701e-09,-1.13471e-13,5338.49,5.05877], Tmin=(849.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.778175,'amu*angstrom^2'), symmetry=1, barrier=(17.8918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
...
"""),
    E0 = (-49.0861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(0.64933,'amu*angstrom^2'), symmetry=1, barrier=(14.9294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89393,0.00695719,7.47393e-05,-1.98307e-07,1.46864e-10,-5898.44,8.87214], Tmin=(10,'K'), Tmax=(491.115,'K')), NASAPolynomial(coeffs=[5.76901,0.012941,-8.4583e-06,2.75774e-09,-3.47856e-13,-6338.95,-1.45049], Tmin=(491.115,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-49.0861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""OCD[C]F""", comment="""Thermo library: CHOF_G4"""),
)
...
species(
    label = '[OH+]=[C-]C(F)F(1524)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 O u0 p1 c+1 {5,D} {7,S}
4 C u0 p0 c0 {1,S} {2,S} {5,S} {6,S}
5 C u0 p1 c-1 {3,D} {4,S}
6 H u0 p0 c0 {4,S}
7 H u0 p0 c0 {3,S}
"""),
    E0 = (-140.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,1221.55],'cm^-1')),
        HinderedRotor(inertia=(0.279746,'amu*angstrom^2'), symmetry=1, barrier=(6.43192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48929,0.0417619,-8.19111e-05,8.67139e-08,-3.40533e-11,-16892.6,15.576], Tmin=(100,'K'), Tmax=(836.264,'K')), NASAPolynomial(coeffs=[2.00214,0.0236988,-1.29321e-05,2.56328e-09,-1.78996e-13,-16098,22.1027], Tmin=(836.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (99.3955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1016.99,1276.26,1338.93,1561.78,2152.05,2154.68],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (30.026,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2][O](1485)'],
    products = ['[O]C[C](F)F(1170)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C[C](F)F(1170)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C[C](F)F(1170)'],
    products = ['[O][CH]C(F)F(1486)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.87682e+08,'s^-1'), n=1.54973, Ea=(193.413,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2H_S;C_rad_out_noH;XH_out]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['CF2O(48)', 'CH2(S)(24)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(48.1575,'cm^3/(mol*s)'), n=2.76922, Ea=(37.8393,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Estimated using template [carbene;mb_carbonyl_2H] for rate rule [CH2;mb_carbonyl_2H]
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(42)', 'CH2O(19)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(48.1575,'cm^3/(mol*s)'), n=2.76922, Ea=(37.8393,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.09911, dn = +|- 0.0124151, dEa = +|- 0.0675623 kJ/molMatched reaction 18 CF2 + CH2O <=> C2H2F2O in 1+2_Cycloaddition/training
This reaction matched rate rule [CF2;mb_carbonyl_2H]
family: 1+2_Cycloaddition"""),
)

reaction(
    label = 'reaction14',
    reactants = ['O-2(130)', 'CH2CF2(56)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2.66944,'m^3/(mol*s)'), n=1.43579, Ea=(20.2688,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [elec_def;CH2CF2] + [o_atom_singlet;mb_db_unsub] for rate rule [o_atom_singlet;CH2CF2]
Euclidian distance = 1.0
family: 1+2_Cycloaddition"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[C](F)F(1197)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.38971e+10,'s^-1'), n=0.0476667, Ea=(8.08907,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_2H;Cpri_rad_out_single] for rate rule [R3_SS;C_rad_out_2H;Cpri_rad_out_noH]
Euclidian distance = 2.23606797749979
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC1(F)[CH]O1(1104)'],
    products = ['FC1(F)CO1(1321)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FC1=CO1(1107)'],
    products = ['FC1(F)CO1(1321)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(139.426,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH2][C](F)F(1124)'],
    products = ['[CH2]C([O])(F)F(1171)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(257)', 'CH2(T)(17)'],
    products = ['[CH2]C([O])(F)F(1171)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(21.2219,'m^3/(mol*s)'), n=1.70304, Ea=(9.29447,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_N-3BrFOS->F_1CS->C_2CS->C_N-3BrOS->S_Sp-2C=1C_Ext-1C-R_Ext-1C-R_N-3BrO-u1',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_N-3BrFOS->F_1CS->C_2CS->C_N-3BrOS->S_Sp-2C=1C_Ext-1C-R_Ext-1C-R_N-3BrO-u1"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[CH2][C](F)OF(1513)'],
    products = ['[CH2]C([O])(F)F(1171)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(77.1959,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['[O][C](F)CF(1514)'],
    products = ['[CH2]C([O])(F)F(1171)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(140.378,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction27',
    reactants = ['OC=C(F)F(535)'],
    products = ['O=CC(F)F(618)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(75.1006,'s^-1'), n=3.11041, Ea=(182.449,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.00848789959541425, var=6.520606768146176, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_3R!H->C',), comment="""Estimated from node Root_3R!H->C"""),
)

reaction(
    label = 'reaction28',
    reactants = ['F(37)', 'OC=[C]F(1522)'],
    products = ['OC=C(F)F(535)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(4.08667,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction31',
    reactants = ['H(5)', 'O[C]=C(F)F(1523)'],
    products = ['OC=C(F)F(535)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[OH+]=[C-]C(F)F(1524)'],
    products = ['OC=C(F)F(535)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(1.18269e+17,'s^-1'), n=-1.42952, Ea=(9.24206,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.5517143818398826, var=16.398565006535087, Tref=1000.0, N=6, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br"""),
)

reaction(
    label = 'reaction33',
    reactants = ['OC(F)[C]F(532)'],
    products = ['OC=C(F)F(535)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(133.223,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction34',
    reactants = ['HF(38)', 'OC#CF(1525)'],
    products = ['OC=C(F)F(535)'],
    transitionState = 'TS34',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(273.172,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction35',
    reactants = ['CF2(42)', '[CH-]=[OH+](1526)'],
    products = ['OC=C(F)F(535)'],
