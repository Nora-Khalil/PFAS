...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30344,0.038995,-5.35335e-05,3.63417e-08,-9.66956e-12,-46716.1,17.5892], Tmin=(100,'K'), Tmax=(922.714,'K')), NASAPolynomial(coeffs=[9.26777,0.00880528,-4.45747e-06,8.85014e-10,-6.32285e-14,-48001.3,-15.4497], Tmin=(922.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-388.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.487147,'amu*angstrom^2'), symmetry=1, barrier=(11.2005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.65456,'amu*angstrom^2'), symmetry=1, barrier=(61.0335,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99609,0.048365,-8.43392e-05,7.31683e-08,-2.45453e-11,-9867.82,19.4834], Tmin=(100,'K'), Tmax=(828.636,'K')), NASAPolynomial(coeffs=[8.32748,0.0115259,-6.29192e-06,1.2362e-09,-8.57195e-14,-10701.6,-8.57164], Tmin=(828.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.6114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFHOO) + radical(ROOJ) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (98.0056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54347,0.0340324,-3.86414e-05,2.20668e-08,-5.09553e-12,-2149.23,19.5127], Tmin=(100,'K'), Tmax=(1038.76,'K')), NASAPolynomial(coeffs=[8.36673,0.0116082,-6.25977e-06,1.2843e-09,-9.36909e-14,-3359.01,-8.80254], Tmin=(1038.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.2922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(144)'],
    products = ['[O]OC([O])(F)F(242)'],
    transitionState = 'TS2',
