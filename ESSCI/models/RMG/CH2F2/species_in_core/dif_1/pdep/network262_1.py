...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(721)'],
    products = ['[O]C(F)C([O])F(658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[O][CH]C(=O)F(561)'],
    products = ['[O]C(F)C([O])F(658)'],
