...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C(F)[C](F)F(386)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=[C]O[CH]F(406)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[O]C(F)[C](F)F(386)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OC=C(F)F(407)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C(F)F(408)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(87)', 'O=[C]O[CH]F(406)'],
    products = ['O=[C]OC(F)[C](F)F(339)'],
