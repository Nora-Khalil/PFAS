...
"""),
    ...
    molecularWeight = (79.0072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.48413,-0.00703079,8.42507e-05,-1.10326e-07,4.27361e-11,-590.699,13.7891], Tmin=(100,'K'), Tmax=(949.387,'K')), NASAPolynomial(coeffs=[13.3997,-0.0017933,1.69506e-06,-1.9444e-10,1.33504e-16,-4592.21,-44.6912], Tmin=(949.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.20544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsFHOO) + ring(Cyclobutane) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C1(F)OO1(1463)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (79.0072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.89021,0.00506235,7.72082e-06,-7.20029e-09,1.4147e-12,-30424.1,6.56283], Tmin=(100,'K'), Tmax=(2076.09,'K')), NASAPolynomial(coeffs=[12.8333,0.00696638,-6.08776e-06,1.22626e-09,-8.07691e-14,-37430.6,-46.4915], Tmin=(2076.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFOOO) + ring(O2s-O2s-Cs(F)) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(=O)F(213)'],
    products = ['F[C]1OOO1(1462)'],
    transitionState = 'TS4',
