...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744484,0.0746956,-8.53262e-05,4.7818e-08,-1.0693e-11,-86284.9,26.8809], Tmin=(100,'K'), Tmax=(1078.27,'K')), NASAPolynomial(coeffs=[14.9523,0.0219892,-1.20048e-05,2.4848e-09,-1.82308e-13,-89348.8,-42.7339], Tmin=(1078.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-328.755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,566.454],'cm^-1')),
        HinderedRotor(inertia=(0.000525333,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155236,'amu*angstrom^2'), symmetry=1, barrier=(35.3448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155227,'amu*angstrom^2'), symmetry=1, barrier=(35.3441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155224,'amu*angstrom^2'), symmetry=1, barrier=(35.3441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17838,0.0628844,-6.61291e-05,3.35124e-08,-6.75671e-12,-39439.2,23.3085], Tmin=(100,'K'), Tmax=(1190.21,'K')), NASAPolynomial(coeffs=[14.4321,0.0183409,-9.99044e-06,2.0669e-09,-1.51507e-13,-42594.1,-42.9403], Tmin=(1190.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70095,0.0688886,-9.25966e-05,6.09392e-08,-1.49281e-11,-76417.4,23.1022], Tmin=(100,'K'), Tmax=(1156.63,'K')), NASAPolynomial(coeffs=[15.0383,0.00856224,-4.28455e-07,-2.16005e-10,2.60534e-14,-79015.4,-45.0469], Tmin=(1156.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(Cs_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603548,0.073159,-8.26491e-05,4.36046e-08,-8.95328e-12,-90618.3,24.956], Tmin=(100,'K'), Tmax=(1186.72,'K')), NASAPolynomial(coeffs=[18.109,0.0141546,-8.06829e-06,1.70714e-09,-1.26961e-13,-94773.1,-62.4944], Tmin=(1186.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-754.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C(=O)OC[C](F)F(2255)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44216,0.0608842,-7.40112e-05,4.74257e-08,-1.24096e-11,-73172.8,24.6872], Tmin=(100,'K'), Tmax=(919.747,'K')), NASAPolynomial(coeffs=[10.1991,0.0228015,-1.19054e-05,2.41099e-09,-1.7449e-13,-74783.7,-16.8279], Tmin=(919.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-417.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,1855,455,950,424.041,424.096,424.286],'cm^-1')),
        HinderedRotor(inertia=(0.0642726,'amu*angstrom^2'), symmetry=1, barrier=(8.20434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0642505,'amu*angstrom^2'), symmetry=1, barrier=(8.20428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182948,'amu*angstrom^2'), symmetry=1, barrier=(23.3692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5588,0.0575762,-7.81292e-05,5.51684e-08,-1.56053e-11,-50166.4,22.4983], Tmin=(100,'K'), Tmax=(861.67,'K')), NASAPolynomial(coeffs=[10.0899,0.0179744,-9.19138e-06,1.83277e-09,-1.31071e-13,-51636.7,-17.3893], Tmin=(861.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical((O)CJOCC)"""),
)

species(
    label = 'O=C(OF)O[CH][C](F)F(2256)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309051,0.0848404,-0.000114603,7.33474e-08,-1.82936e-11,-62945.6,28.6144], Tmin=(100,'K'), Tmax=(983.182,'K')), NASAPolynomial(coeffs=[17.266,0.0158527,-9.35225e-06,1.98045e-09,-1.46834e-13,-66280,-52.9058], Tmin=(983.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(OF)OC[C]F-2(2257)',
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1394,0.0603335,-6.05263e-05,2.90383e-08,-5.48688e-12,-39926.4,25.1403], Tmin=(100,'K'), Tmax=(1276.18,'K')), NASAPolynomial(coeffs=[15.3784,0.0157033,-8.06856e-06,1.63473e-09,-1.18574e-13,-43560.7,-47.027], Tmin=(1276.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cds-OdOsOs) + group(CJ2_singlet-FCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OC[C](F)F(2172)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O=C(OF)OC[C]F(2252)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]OC(=O)OF(1369)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(OF)OC[C](F)F(2172)'],
    products = ['FO[C]1OCC(F)(F)O1(2253)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(860)', 'CH2CF2(56)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(OF)OC=C(F)F(2254)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(=O)OC[C](F)F(2255)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)OF(860)', '[CH2][C](F)F(185)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(154)', 'O=[C]OC[C](F)F(795)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(OF)O[CH][C](F)F(2256)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(OF)OC[C]F-2(2257)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]OC(=O)OF(1369)'],
    products = ['O=C(OF)OC[C](F)F(2172)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(OF)OC[C](F)F(2172)'],
    products = ['O=C(OF)O[CH]C(F)F(2258)'],
...
network(
    label = 'PDepNetwork #904',
    isomers = [
        'O=C(OF)OC[C](F)F(2172)',
    ],
    reactants = [
