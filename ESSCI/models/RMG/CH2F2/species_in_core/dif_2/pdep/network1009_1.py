species(
    label = '[O]OC(F)(F)C(F)OC(O)(F)F(2485)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.489939,'amu*angstrom^2'), symmetry=1, barrier=(11.2647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489922,'amu*angstrom^2'), symmetry=1, barrier=(11.2643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489751,'amu*angstrom^2'), symmetry=1, barrier=(11.2603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95354,'amu*angstrom^2'), symmetry=1, barrier=(44.9156,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.02,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235111,0.101109,-0.000170914,1.45053e-07,-4.81871e-11,-155559,30.2201], Tmin=(100,'K'), Tmax=(792.08,'K')), NASAPolynomial(coeffs=[13.8604,0.0238675,-1.31638e-05,2.62275e-09,-1.84273e-13,-157602,-33.297], Tmin=(792.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1294.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsFFOO) + group(CsFFOO) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.492848,'amu*angstrom^2'), symmetry=1, barrier=(11.3315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492692,'amu*angstrom^2'), symmetry=1, barrier=(11.328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51387,'amu*angstrom^2'), symmetry=1, barrier=(34.8068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492905,'amu*angstrom^2'), symmetry=1, barrier=(11.3329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0634871,0.0938564,-0.000156469,1.32259e-07,-4.37633e-11,-127651,28.4909], Tmin=(100,'K'), Tmax=(803.474,'K')), NASAPolynomial(coeffs=[12.8965,0.0233291,-1.24064e-05,2.44041e-09,-1.70291e-13,-129499,-29.2792], Tmin=(803.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1062.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsFHOO) + group(CsFFOO) + radical(ROOJ)"""),
)
...
species(
    label = '[O]OC(F)(OC(O)(F)F)C(F)F(2569)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (197.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66171,0.135579,-0.00023183,1.98314e-07,-6.6121e-11,-179835,37.1906], Tmin=(100,'K'), Tmax=(806.172,'K')), NASAPolynomial(coeffs=[16.9463,0.0318169,-1.74908e-05,3.47124e-09,-2.42934e-13,-182464,-46.2685], Tmin=(806.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1496.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(ROOJ)"""),
)

species(
    label = '[O]OC(OC(O)(F)F)C(F)(F)F(2570)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {11,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = '[O]C(F)(F)C(F)OC(O)(F)F(2571)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1461.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,435,565,619,662,854,1178,1396,240.985,240.985,240.985,240.985],'cm^-1')),
        HinderedRotor(inertia=(0.159134,'amu*angstrom^2'), symmetry=1, barrier=(6.55798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.383742,'amu*angstrom^2'), symmetry=1, barrier=(15.8142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159134,'amu*angstrom^2'), symmetry=1, barrier=(6.55798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84274,'amu*angstrom^2'), symmetry=1, barrier=(34.7297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.456671,0.105521,-0.000151499,1.09406e-07,-3.13088e-11,-175664,32.5679], Tmin=(100,'K'), Tmax=(855.098,'K')), NASAPolynomial(coeffs=[16.1628,0.0277778,-1.51205e-05,3.07936e-09,-2.22379e-13,-178506,-45.0096], Tmin=(855.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1461.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
species(
    label = '[O]OC(F)(F)[CH]OC(O)(F)F(2572)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4233,0.129687,-0.000226215,1.9237e-07,-6.29617e-11,-133559,35.7546], Tmin=(100,'K'), Tmax=(837.348,'K')), NASAPolynomial(coeffs=[17.3469,0.0255824,-1.38585e-05,2.70459e-09,-1.86295e-13,-136197,-48.4457], Tmin=(837.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1112.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFFOO) + radical(ROOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[O]O[C](F)C(F)OC(O)(F)F(2573)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (178.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0295,0.121867,-0.000212082,1.86042e-07,-6.33919e-11,-129032,36.0292], Tmin=(100,'K'), Tmax=(816.458,'K')), NASAPolynomial(coeffs=[14.1571,0.031696,-1.74479e-05,3.46059e-09,-2.41868e-13,-130986,-30.9391], Tmin=(816.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1074.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFOO) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OC(F)(F)C(F)O[C](O)F(2574)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (178.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.578436,0.107531,-0.000153624,1.09152e-07,-3.05718e-11,-127491,35.1488], Tmin=(100,'K'), Tmax=(875.135,'K')), NASAPolynomial(coeffs=[17.2284,0.0261371,-1.41044e-05,2.86213e-09,-2.06373e-13,-130607,-48.3828], Tmin=(875.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1061.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(ROOJ) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.500901,'amu*angstrom^2'), symmetry=1, barrier=(11.5167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50032,'amu*angstrom^2'), symmetry=1, barrier=(11.5033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968396,0.0716143,-0.00011463,9.37904e-08,-3.02306e-11,-75973.6,24.8434], Tmin=(100,'K'), Tmax=(780.728,'K')), NASAPolynomial(coeffs=[11.1816,0.0180435,-9.31465e-06,1.82046e-09,-1.27012e-13,-77530.4,-21.6586], Tmin=(780.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(ROOJ)"""),
)
...
species(
    label = '[O]OC(F)(F)C(F)O[C](F)F(2575)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.18073,'amu*angstrom^2'), symmetry=1, barrier=(4.15534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.409647,'amu*angstrom^2'), symmetry=1, barrier=(9.41859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171145,'amu*angstrom^2'), symmetry=1, barrier=(3.93496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04083,'amu*angstrom^2'), symmetry=1, barrier=(46.9227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (180.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.629055,0.112754,-0.000197596,1.75454e-07,-6.05613e-11,-128938,34.7244], Tmin=(100,'K'), Tmax=(812.519,'K')), NASAPolynomial(coeffs=[12.7729,0.0309143,-1.72276e-05,3.43582e-09,-2.41002e-13,-130592,-23.9277], Tmin=(812.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1073.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFHO) + radical(ROOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
species(
    label = '[O]OC(F)(F)C(F)OC([O])(F)F(2576)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1231.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,261,493,600,1152,1365,1422,3097,223,363,546,575,694,1179,1410,375,486,586,623,710,938,1161,1294,249.014,249.046,249.334,249.347],'cm^-1')),
        HinderedRotor(inertia=(0.553624,'amu*angstrom^2'), symmetry=1, barrier=(24.3525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169472,'amu*angstrom^2'), symmetry=1, barrier=(7.47114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.995257,'amu*angstrom^2'), symmetry=1, barrier=(43.8614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169512,'amu*angstrom^2'), symmetry=1, barrier=(7.46996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (196.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799249,0.113761,-0.000167988,1.23859e-07,-3.60739e-11,-147983,35.6281], Tmin=(100,'K'), Tmax=(841.639,'K')), NASAPolynomial(coeffs=[17.1816,0.0282998,-1.56668e-05,3.19814e-09,-2.30841e-13,-151010,-48.0181], Tmin=(841.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1231.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(ROOJ)"""),
)
...
species(
    label = '[O]OC(F)(F)[C](F)OC(O)(F)F(2577)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (196.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55607,0.135745,-0.000246129,2.18241e-07,-7.41568e-11,-156616,38.2238], Tmin=(100,'K'), Tmax=(836.707,'K')), NASAPolynomial(coeffs=[15.5713,0.0310374,-1.74916e-05,3.46214e-09,-2.40232e-13,-158683,-36.5776], Tmin=(836.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1303.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OC(F)(F)C(F)OC(=O)F(2578)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1232.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,261,493,600,1152,1365,1422,3097,223,363,546,575,694,1179,1410,482,664,788,1296,1923,323.105,323.105,323.105,323.106],'cm^-1')),
        HinderedRotor(inertia=(0.2232,'amu*angstrom^2'), symmetry=1, barrier=(16.5352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535398,'amu*angstrom^2'), symmetry=1, barrier=(39.6636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535398,'amu*angstrom^2'), symmetry=1, barrier=(39.6636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0783458,'amu*angstrom^2'), symmetry=1, barrier=(5.80404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (177.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0509285,0.0936368,-0.000125988,8.54386e-08,-2.3128e-11,-148132,31.6508], Tmin=(100,'K'), Tmax=(899.105,'K')), NASAPolynomial(coeffs=[15.0196,0.0270436,-1.48893e-05,3.0619e-09,-2.22968e-13,-150824,-38.9724], Tmin=(899.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1232.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COFOO) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.516537,'amu*angstrom^2'), symmetry=1, barrier=(11.8762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927494,'amu*angstrom^2'), symmetry=1, barrier=(21.3249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516841,'amu*angstrom^2'), symmetry=1, barrier=(11.8832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516645,'amu*angstrom^2'), symmetry=1, barrier=(11.8787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.129335,0.0968284,-0.000142543,1.04634e-07,-3.0187e-11,-107931,31.454], Tmin=(100,'K'), Tmax=(851.572,'K')), NASAPolynomial(coeffs=[15.6548,0.0226864,-1.19435e-05,2.39079e-09,-1.7068e-13,-110619,-42.1588], Tmin=(851.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ)"""),
)

species(
    label = '[O]OC(F)=C(F)OC(O)(F)F(2580)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.455769,'amu*angstrom^2'), symmetry=1, barrier=(10.479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379,'amu*angstrom^2'), symmetry=1, barrier=(8.71395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.378908,'amu*angstrom^2'), symmetry=1, barrier=(8.71185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.378986,'amu*angstrom^2'), symmetry=1, barrier=(8.71364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (177.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.763371,0.115186,-0.000202192,1.7645e-07,-5.95887e-11,-130413,34.432], Tmin=(100,'K'), Tmax=(821.647,'K')), NASAPolynomial(coeffs=[14.2535,0.0274192,-1.52005e-05,3.01346e-09,-2.10186e-13,-132386,-32.0543], Tmin=(821.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1085.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(CsFFOO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(ROOJ)"""),
)

species(
    label = 'OOC(F)(F)[C](F)OC(O)(F)F(2581)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (197.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77861,0.138841,-0.000239717,2.0693e-07,-6.9737e-11,-174888,38.2647], Tmin=(100,'K'), Tmax=(796.347,'K')), NASAPolynomial(coeffs=[17.0157,0.0329535,-1.86347e-05,3.73959e-09,-2.63457e-13,-177518,-45.8406], Tmin=(796.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1455.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)OC(F)C(F)(F)OO(2582)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (197.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.89892,0.115351,-0.000155961,1.04526e-07,-2.77678e-11,-166261,35.2314], Tmin=(100,'K'), Tmax=(918.304,'K')), NASAPolynomial(coeffs=[18.6657,0.0301284,-1.67503e-05,3.45981e-09,-2.52646e-13,-169854,-57.4885], Tmin=(918.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1383.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = 'OC(F)(F)O[CH]C(F)(F)OOF(2583)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (197.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99146,0.142264,-0.000241803,2.02151e-07,-6.58979e-11,-140359,38.4186], Tmin=(100,'K'), Tmax=(784.556,'K')), NASAPolynomial(coeffs=[19.4258,0.0286547,-1.61522e-05,3.23458e-09,-2.27611e-13,-143584,-58.8446], Tmin=(784.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1168.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFFOO) + radical(CCsJOCs)"""),
)

species(
    label = 'OC(F)(F)OC(F)[C](F)OOF(2584)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (197.037,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59972,0.13448,-0.000227875,1.96266e-07,-6.66358e-11,-135831,38.6999], Tmin=(100,'K'), Tmax=(769.926,'K')), NASAPolynomial(coeffs=[16.2039,0.0348256,-1.97759e-05,3.99888e-09,-2.83885e-13,-138361,-41.1592], Tmin=(769.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1130.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFOO) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O[C](F)OC(F)C(F)(F)OOF(2585)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(86)', '[O]OC(F)(F)OC(O)(F)F(2567)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(87)', '[O]OC(F)OC(O)(F)F(2568)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OF(152)', 'OC(F)(F)OC(F)[C]F-2(1784)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(OC(O)(F)F)C(F)F(2569)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    products = ['[O]OC(OC(O)(F)F)C(F)(F)F(2570)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)(F)OF(707)', '[O]OC(F)=CF(380)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', '[O]C(F)(F)C(F)OC(O)(F)F(2571)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
    products = ['HO2(10)', 'OC(F)(F)OC(F)=C(F)F(1779)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]OC(O)(F)F(2572)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]O[C](F)C(F)OC(O)(F)F(2573)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]OC(F)(F)C(F)O[C](O)F(2574)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)(F)F(323)', '[O]OC(F)(F)[CH]F(232)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)F(232)', '[O]OC(F)(F)C([O])F(1524)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O2(2)', 'OC(F)(F)OC(F)[C](F)F(1672)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(4)', '[O]OC(F)(F)C(F)O[C](F)F(2575)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]OC(F)(F)C(F)OC([O])(F)F(2576)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]O[C](F)F(171)', 'OC(F)(F)O[CH]F(1237)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)OC(O)(F)F(2577)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[O]OC(F)(F)C(F)OC(=O)F(2578)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', '[O]OC(F)=COC(O)(F)F(2579)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[O]OC(F)=C(F)OC(O)(F)F(2580)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OOC(F)(F)[C](F)OC(O)(F)F(2581)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(F)OC(F)C(F)(F)OO(2582)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)O[CH]C(F)(F)OOF(2583)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(F)(F)OC(F)[C](F)OOF(2584)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C](F)OC(F)C(F)(F)OOF(2585)'],
    products = ['[O]OC(F)(F)C(F)OC(O)(F)F(2485)'],
