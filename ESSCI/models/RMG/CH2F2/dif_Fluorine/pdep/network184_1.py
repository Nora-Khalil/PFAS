...
"""),
    E0 = (-315.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,3025,407.5,1350,352.5,299.822,299.889,805.67,1206.07,1206.07,1206.07],'cm^-1')),
        HinderedRotor(inertia=(0.780047,'amu*angstrom^2'), symmetry=1, barrier=(49.7595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780031,'amu*angstrom^2'), symmetry=1, barrier=(49.7604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780299,'amu*angstrom^2'), symmetry=1, barrier=(49.7591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['OF(172)', 'O=C(O)[C]F(351)'],
    products = ['O=C(O)C(F)OF(569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(352)'],
    products = ['O=C(O)C(F)OF(569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(606)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(607)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(248)', 'O=C(O)[CH]F(608)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(610)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(402)', 'O=[C]O(175)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(356)'],
    products = ['O=C(O)C(F)OF(569)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(361)'],
    products = ['O=C(O)C(F)OF(569)'],
