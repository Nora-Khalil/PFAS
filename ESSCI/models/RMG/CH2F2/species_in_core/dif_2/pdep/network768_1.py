...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92651,0.0263718,-2.23153e-05,9.97007e-09,-1.90353e-12,-1963.41,13.4258], Tmin=(100,'K'), Tmax=(1184.02,'K')), NASAPolynomial(coeffs=[6.46074,0.0144321,-7.18931e-06,1.45334e-09,-1.05267e-13,-2800.33,-4.22177], Tmin=(1184.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.6263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-494.365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,3025,407.5,1350,352.5,190,488,555,1236,1407,180,2308.33],'cm^-1')),
        HinderedRotor(inertia=(0.386926,'amu*angstrom^2'), symmetry=1, barrier=(8.89619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47222,'amu*angstrom^2'), symmetry=1, barrier=(33.8493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47201,'amu*angstrom^2'), symmetry=1, barrier=(33.8445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07455,0.0716042,-0.000119274,1.07851e-07,-3.85622e-11,-59360.1,23.8479], Tmin=(100,'K'), Tmax=(790.206,'K')), NASAPolynomial(coeffs=[8.04131,0.0262246,-1.39334e-05,2.78197e-09,-1.96687e-13,-60145.3,-6.1243], Tmin=(790.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-494.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(O2s-H)(H)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]C(F)C(F)F(1940)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38659,0.0651324,-0.000106061,1.01025e-07,-3.8507e-11,-56445.4,22.2839], Tmin=(100,'K'), Tmax=(775.175,'K')), NASAPolynomial(coeffs=[5.39792,0.0317854,-1.70586e-05,3.43299e-09,-2.4445e-13,-56687.3,6.4042], Tmin=(775.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(O2s-H)(H))"""),
)

species(
    label = 'OC[C](F)[C](F)F(1941)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9777,0.0796649,-0.000155391,1.52564e-07,-5.58354e-11,-57386.9,24.7207], Tmin=(100,'K'), Tmax=(855.06,'K')), NASAPolynomial(coeffs=[5.19534,0.0300967,-1.60917e-05,3.14566e-09,-2.16722e-13,-57017.4,11.4118], Tmin=(855.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'FOC[CH][C](F)F(1942)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.109497,'amu*angstrom^2'), symmetry=1, barrier=(2.51755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110036,'amu*angstrom^2'), symmetry=1, barrier=(2.52994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276639,'amu*angstrom^2'), symmetry=1, barrier=(6.36048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883572,0.0799803,-0.00015004,1.43154e-07,-5.15678e-11,-20705.4,25.7986], Tmin=(100,'K'), Tmax=(848.111,'K')), NASAPolynomial(coeffs=[6.70256,0.0280619,-1.493e-05,2.92352e-09,-2.02063e-13,-20812.2,3.87316], Tmin=(848.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C[CH]C(F)(F)F(1943)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26721,0.0670139,-0.000109122,9.93081e-08,-3.59875e-11,-60793.3,22.6678], Tmin=(100,'K'), Tmax=(785.153,'K')), NASAPolynomial(coeffs=[7.15815,0.0271839,-1.42713e-05,2.84409e-09,-2.01194e-13,-61415.8,-2.40048], Tmin=(785.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sF1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]C[CH]F(1934)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)[C](F)F(929)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]CC=C(F)F(1937)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](1639)', 'CHFCF2(54)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]CC(F)=C(F)F(1689)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2O(19)', 'F[CH][C](F)F(183)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=CC(F)[C](F)F(687)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](1639)', 'F[CH][C](F)F(183)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[C](F)F(688)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(87)', '[O]C[CH]F(1934)'],
    products = ['[O]CC(F)[C](F)F(1899)'],
