...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0023451,'amu*angstrom^2'), symmetry=1, barrier=(8.03457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349676,'amu*angstrom^2'), symmetry=1, barrier=(8.03974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99035,'amu*angstrom^2'), symmetry=1, barrier=(45.7621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.403383,0.0890332,-0.000160425,1.46526e-07,-5.15369e-11,-109305,29.1497], Tmin=(100,'K'), Tmax=(823.377,'K')), NASAPolynomial(coeffs=[9.808,0.0261112,-1.43994e-05,2.87191e-09,-2.01267e-13,-110270,-10.847], Tmin=(823.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.264834,'amu*angstrom^2'), symmetry=1, barrier=(6.08906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264639,'amu*angstrom^2'), symmetry=1, barrier=(6.08457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265042,'amu*angstrom^2'), symmetry=1, barrier=(6.09384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248193,0.0903051,-0.000157409,1.35805e-07,-4.5154e-11,-112502,28.8632], Tmin=(100,'K'), Tmax=(832.762,'K')), NASAPolynomial(coeffs=[12.537,0.0200412,-1.0606e-05,2.07774e-09,-1.43894e-13,-114160,-25.8346], Tmin=(832.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-936.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(355)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(F)(F)[CH]F(474)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(298)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2O(48)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(457)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(176)', 'CHFCF2(54)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(176)', 'F[CH][C](F)F(183)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(86)', 'F[C](F)O[C](F)F(298)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', '[O]C(F)(F)[CH]F(474)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(453)'],
    products = ['F[CH]C(F)(F)O[C](F)F(355)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(355)'],
    products = ['F[CH][C](F)OC(F)(F)F(458)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)(F)O[C](F)F(355)',
    ],
    reactants = [
        ('CF2O(48)', 'CHFCF2(54)'),
        ('CF2(42)', '[O]C(F)(F)[CH]F(474)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
