...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C([O])F(131)'],
    products = ['[O]C(F)O[C]=O(576)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(188)', '[O][CH]F(168)'],
    products = ['[O]C(F)O[C]=O(576)'],
