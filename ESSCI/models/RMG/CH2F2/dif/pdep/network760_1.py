...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41747,0.0445697,-9.6043e-05,9.84623e-08,-3.64126e-11,-2891.1,20.2578], Tmin=(100,'K'), Tmax=(877.912,'K')), NASAPolynomial(coeffs=[3.16554,0.0174565,-9.21532e-06,1.7709e-09,-1.19713e-13,-2108.95,21.9489], Tmin=(877.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(923)'],
    products = ['FC1(F)[CH]OO1(1861)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(1864)'],
    products = ['[O]OC=C(F)F(923)'],
    transitionState = 'TS6',
