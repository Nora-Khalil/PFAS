...
"""),
    E0 = (-267.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,180,180,1677.9],'cm^-1')),
        HinderedRotor(inertia=(0.235245,'amu*angstrom^2'), symmetry=1, barrier=(5.40874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235582,'amu*angstrom^2'), symmetry=1, barrier=(5.41648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72322,0.0604479,-0.00010875,1.11358e-07,-4.32738e-11,-32124.4,20.0709], Tmin=(100,'K'), Tmax=(827.274,'K')), NASAPolynomial(coeffs=[2.32594,0.0339005,-1.77631e-05,3.50331e-09,-2.45002e-13,-31415.4,22.1651], Tmin=(827.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6058,0.0557803,-6.52295e-05,4.02123e-08,-1.00286e-11,-33768,19.5739], Tmin=(100,'K'), Tmax=(967.989,'K')), NASAPolynomial(coeffs=[10.2904,0.0198938,-9.62085e-06,1.91471e-09,-1.37765e-13,-35449.4,-22.0419], Tmin=(967.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.57171,0.0102136,5.90917e-06,-7.99873e-09,2.0708e-12,22733,11.7517], Tmin=(100,'K'), Tmax=(1490.84,'K')), NASAPolynomial(coeffs=[4.74096,0.01502,-6.91916e-06,1.3118e-09,-8.98245e-14,21501.6,2.68313], Tmin=(1490.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(CCOJ) + radical(CJCO)"""),
)
...
"""),
    E0 = (-133.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,190,488,555,1236,1407,1803.81],'cm^-1')),
        HinderedRotor(inertia=(0.165086,'amu*angstrom^2'), symmetry=1, barrier=(8.37928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00362904,'amu*angstrom^2'), symmetry=1, barrier=(8.37929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7253,0.031082,-2.68017e-05,1.62407e-08,-4.85219e-12,-16036.4,17.2618], Tmin=(100,'K'), Tmax=(748.849,'K')), NASAPolynomial(coeffs=[4.20206,0.0231938,-1.10006e-05,2.1735e-09,-1.55831e-13,-16257.6,10.5644], Tmin=(748.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(RCCJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FC1(F)CCO1(1907)',
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.95046,0.00289403,0.000107858,-1.90161e-07,1.04903e-10,-70228.7,10.2996], Tmin=(10,'K'), Tmax=(544.414,'K')), NASAPolynomial(coeffs=[-0.313051,0.0434997,-2.959e-05,9.46353e-09,-1.14527e-12,-69902,27.0131], Tmin=(544.414,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-583.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), label="""FC1(F)CCO1""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OCC=C(F)F(1971)',
...
"""),
    E0 = (-263.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180,1549.84],'cm^-1')),
        HinderedRotor(inertia=(0.350702,'amu*angstrom^2'), symmetry=1, barrier=(8.06333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35109,'amu*angstrom^2'), symmetry=1, barrier=(8.07226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6466,0.0612096,-0.000107433,1.06708e-07,-4.05668e-11,-31580.5,21.0662], Tmin=(100,'K'), Tmax=(828.514,'K')), NASAPolynomial(coeffs=[3.4837,0.0316134,-1.6325e-05,3.20292e-09,-2.23397e-13,-31173.6,16.8419], Tmin=(828.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = 'O[CH]C[C](F)F(1974)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-313.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,190,488,555,1236,1407,256.5,257.752],'cm^-1')),
        HinderedRotor(inertia=(0.136213,'amu*angstrom^2'), symmetry=1, barrier=(6.10525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135054,'amu*angstrom^2'), symmetry=1, barrier=(6.10293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296288,'amu*angstrom^2'), symmetry=1, barrier=(13.6137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13617,0.0713676,-0.000125403,1.15078e-07,-4.05403e-11,-37562.5,20.8684], Tmin=(100,'K'), Tmax=(840.333,'K')), NASAPolynomial(coeffs=[7.59118,0.0243654,-1.24505e-05,2.42008e-09,-1.67288e-13,-38072.7,-5.73108], Tmin=(840.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]CC(F)F(1975)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41461,0.0662536,-0.000116855,1.1336e-07,-4.22454e-11,-34547,19.3675], Tmin=(100,'K'), Tmax=(826.825,'K')), NASAPolynomial(coeffs=[4.81063,0.0301748,-1.5754e-05,3.10085e-09,-2.16532e-13,-34436.9,7.69114], Tmin=(826.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[CH][C](F)F(1976)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {10,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36848,0.0663198,-0.000115969,1.08412e-07,-3.88572e-11,-34596.1,22.5659], Tmin=(100,'K'), Tmax=(841.742,'K')), NASAPolynomial(coeffs=[6.26238,0.0258073,-1.30234e-05,2.52262e-09,-1.74193e-13,-34808.6,3.43018], Tmin=(841.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C[O](1970)'],
    products = ['[O]CC[C](F)F(1904)'],
    transitionState = 'TS3',
