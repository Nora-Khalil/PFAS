...
"""),
    E0 = (-795.444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,257.175,257.179,257.221],'cm^-1')),
        HinderedRotor(inertia=(0.224184,'amu*angstrom^2'), symmetry=1, barrier=(10.5275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749295,'amu*angstrom^2'), symmetry=1, barrier=(35.1754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315727,'amu*angstrom^2'), symmetry=1, barrier=(14.8171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13791,0.0437332,-4.65404e-05,2.72465e-08,-6.654e-12,-42416.9,18.0261], Tmin=(100,'K'), Tmax=(973.03,'K')), NASAPolynomial(coeffs=[7.98246,0.0197063,-9.49987e-06,1.86756e-09,-1.33199e-13,-43554.2,-10.0105], Tmin=(973.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsFFH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-193.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,617,898,1187,272.784,277.504],'cm^-1')),
        HinderedRotor(inertia=(0.167063,'amu*angstrom^2'), symmetry=1, barrier=(8.74544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27567,'amu*angstrom^2'), symmetry=1, barrier=(14.5231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.765303,'amu*angstrom^2'), symmetry=1, barrier=(39.9614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51288,0.058562,-6.95355e-05,4.35694e-08,-1.11246e-11,-23234.5,21.593], Tmin=(100,'K'), Tmax=(942.974,'K')), NASAPolynomial(coeffs=[10.1815,0.021789,-1.10376e-05,2.21056e-09,-1.59129e-13,-24869.2,-19.7186], Tmin=(942.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-394.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,180,180,676.599],'cm^-1')),
        HinderedRotor(inertia=(0.675178,'amu*angstrom^2'), symmetry=1, barrier=(15.5237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675744,'amu*angstrom^2'), symmetry=1, barrier=(15.5367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676345,'amu*angstrom^2'), symmetry=1, barrier=(15.5505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.871161,0.074386,-0.000104292,7.66005e-08,-2.25538e-11,-47381,22.6264], Tmin=(100,'K'), Tmax=(828.529,'K')), NASAPolynomial(coeffs=[11.4176,0.0234702,-1.2114e-05,2.4312e-09,-1.74354e-13,-49128.7,-26.2705], Tmin=(828.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'F[CH]CC(F)OF(1456)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.225987,'amu*angstrom^2'), symmetry=1, barrier=(5.19588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225934,'amu*angstrom^2'), symmetry=1, barrier=(5.19467,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.762476,'amu*angstrom^2'), symmetry=1, barrier=(17.5308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.76282,'amu*angstrom^2'), symmetry=1, barrier=(17.5387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.348473,'amu*angstrom^2'), symmetry=1, barrier=(8.01208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348656,'amu*angstrom^2'), symmetry=1, barrier=(8.01628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03042,'amu*angstrom^2'), symmetry=1, barrier=(23.6914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4589,0.0857594,-0.00014357,1.25684e-07,-4.30132e-11,-72065.8,25.6367], Tmin=(100,'K'), Tmax=(818.014,'K')), NASAPolynomial(coeffs=[10.2682,0.0263419,-1.36174e-05,2.66185e-09,-1.85198e-13,-73287.5,-17.375], Tmin=(818.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FOC(F)C[C](F)F(1460)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-593.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,180,180,720.508],'cm^-1')),
        HinderedRotor(inertia=(0.139,'amu*angstrom^2'), symmetry=1, barrier=(3.19588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135882,'amu*angstrom^2'), symmetry=1, barrier=(3.1242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.74767,'amu*angstrom^2'), symmetry=1, barrier=(40.1824,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.156582,'amu*angstrom^2'), symmetry=1, barrier=(3.60013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361081,'amu*angstrom^2'), symmetry=1, barrier=(8.30197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['OF(173)', 'F[C]CC(F)F(1372)'],
    products = ['FOC(F)CC(F)F(1441)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)OF(1454)'],
    products = ['FOC(F)CC(F)F(1441)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FCC(F)OF(1046)'],
    products = ['FOC(F)CC(F)F(1441)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(173)', 'FC=CC(F)F(1063)'],
    products = ['FOC(F)CC(F)F(1441)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[CH]CC(F)F(1455)'],
    products = ['FOC(F)CC(F)F(1441)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)OF(1456)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)CC(F)F(1457)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', 'F[CH]CC(F)F(1458)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OF(295)', 'CHF2-CH2(63)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(81)', '[CH2]C(F)OF(1459)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)[CH]C(F)F(1064)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FO[C](F)CC(F)F(1374)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)C[C](F)F(1460)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', 'O=CCC(F)F(1461)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'FC=CC(F)OF(1074)'],
    products = ['FOC(F)CC(F)F(1441)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)CC(F)F(1236)'],
    products = ['FOC(F)CC(F)F(1441)'],
