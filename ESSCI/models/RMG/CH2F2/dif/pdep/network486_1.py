...
"""),
    E0 = (-1334.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.39024,'amu*angstrom^2'), symmetry=1, barrier=(31.9645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39055,'amu*angstrom^2'), symmetry=1, barrier=(31.9714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39066,'amu*angstrom^2'), symmetry=1, barrier=(31.974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.62881,0.0259699,0.000218318,-6.25656e-07,4.9114e-10,-160480,12.7909], Tmin=(10,'K'), Tmax=(460.88,'K')), NASAPolynomial(coeffs=[7.86846,0.0466043,-3.57554e-05,1.22371e-08,-1.54146e-12,-161481,-10.996], Tmin=(460.88,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1334.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(F)(F)C(F)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.108196,'amu*angstrom^2'), symmetry=1, barrier=(2.48765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105352,'amu*angstrom^2'), symmetry=1, barrier=(2.42224,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.138226,'amu*angstrom^2'), symmetry=1, barrier=(3.17808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407756,'amu*angstrom^2'), symmetry=1, barrier=(9.37512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.409519,'amu*angstrom^2'), symmetry=1, barrier=(9.41566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.093,'amu*angstrom^2'), symmetry=1, barrier=(25.1302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410523,'amu*angstrom^2'), symmetry=1, barrier=(9.43874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.351704,'amu*angstrom^2'), symmetry=1, barrier=(8.08636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351303,'amu*angstrom^2'), symmetry=1, barrier=(8.07714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)CF(1319)'],
    products = ['HF(38)', 'CF2O(48)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.98542e+10,'s^-1'), n=0.978818, Ea=(221.446,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)(F)CF(680)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(343.171,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'OC(F)(F)[C]F(506)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(190.295,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(244)', 'F[C]CF(874)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(201.459,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'F[C]C(F)(F)CF(876)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.6143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'OC(F)(F)C(F)(F)[C]F(1018)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.26413e-09,'m^3/(mol*s)'), n=4.30786, Ea=(75.2564,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HH_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node HH_N-2Br1sCl1sF1sHI1s->H"""),
)
...
reaction(
    ...
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(23.6273,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(24)', 'OC(F)(F)C(F)(F)F(1019)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(164.032,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OF(173)', 'FCC(F)=C(F)F(881)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[C](F)CF(1380)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.0404611,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)(F)CF(1381)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)F(1382)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(4)', 'FCC(F)(F)[C](F)F(886)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)CF(885)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(239)', 'CH2F-CF2(67)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(45)', 'OC(F)(F)[C](F)F(515)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[CH]F(1023)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(805)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(157.883,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'OC(F)=C(F)CF(1383)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'C=C(F)C(O)(F)F(1384)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.21457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=CF(1027)'],
    products = ['OC(F)(F)C(F)(F)CF(1319)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(187.14,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

network(
    label = 'PDepNetwork #486',
    isomers = [
        'OC(F)(F)C(F)(F)CF(1319)',
    ],
    reactants = [
