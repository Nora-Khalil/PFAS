...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.242775,'amu*angstrom^2'), symmetry=1, barrier=(5.58187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.20145,0.0259565,-5.56191e-05,6.79603e-08,-2.90783e-11,5760.79,12.7811], Tmin=(100,'K'), Tmax=(837.457,'K')), NASAPolynomial(coeffs=[-1.03169,0.0241474,-1.29232e-05,2.5627e-09,-1.79328e-13,7242.26,37.0646], Tmin=(837.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCOJ) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.4688,-0.0219095,0.000160134,-2.1264e-07,8.54431e-11,2990.31,11.1437], Tmin=(100,'K'), Tmax=(918.178,'K')), NASAPolynomial(coeffs=[22.5076,-0.0180854,1.21397e-05,-2.26679e-09,1.40359e-13,-4163.31,-98.9992], Tmin=(918.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.54061,-0.0177459,0.000131425,-1.83793e-07,7.77334e-11,-1973.83,7.1012], Tmin=(100,'K'), Tmax=(885.247,'K')), NASAPolynomial(coeffs=[21.1785,-0.0237528,1.67394e-05,-3.39194e-09,2.31172e-13,-7984.03,-92.1502], Tmin=(885.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsHH) + ring(dioxirane)"""),
)
...
"""),
    ...
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52176,0.0292763,-3.46797e-05,1.99827e-08,-4.36097e-12,-36539.7,12.1191], Tmin=(100,'K'), Tmax=(1220.23,'K')), NASAPolynomial(coeffs=[9.73196,0.00362919,-6.79503e-07,5.58352e-11,-1.58408e-15,-38149.5,-23.4874], Tmin=(1220.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), label="""OCHOOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.156408,'amu*angstrom^2'), symmetry=1, barrier=(3.59612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156803,'amu*angstrom^2'), symmetry=1, barrier=(3.60521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58851,0.045253,-0.000111972,1.2256e-07,-4.65599e-11,1154.51,14.2976], Tmin=(100,'K'), Tmax=(891.496,'K')), NASAPolynomial(coeffs=[-0.0457627,0.0212292,-1.12416e-05,2.1332e-09,-1.41935e-13,3048.56,34.6925], Tmin=(891.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.28844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CO[O](1577)'],
    products = ['O=O(177)', 'CH2O(19)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[O](194)'],
    products = ['[O]CO[O](1577)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]CO[O](1577)'],
    products = ['O(6)', 'C1OO1(2076)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(179.634,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;Y_rad_intra;OOJ]
Euclidian distance = 0
