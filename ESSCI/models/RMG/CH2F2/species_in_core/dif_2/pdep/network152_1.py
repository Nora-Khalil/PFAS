...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(385)'],
    products = ['[O]C(F)O[C](F)F(349)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(300)'],
    products = ['[O]C(F)O[C](F)F(349)'],
    transitionState = 'TS9',
