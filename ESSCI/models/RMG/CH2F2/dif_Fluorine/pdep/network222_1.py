...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(124)', 'F[C]C(F)F(315)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)(F)F(679)', 'CHF(40)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)C(F)F(664)'],
    products = ['[O]OC(F)C(F)(F)F(680)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C(F)F(251)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)C(F)F(681)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]F(682)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)F(683)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(685)'],
    products = ['[O]OC(F)(F)C(F)F(664)'],
