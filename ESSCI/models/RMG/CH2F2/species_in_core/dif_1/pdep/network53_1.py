...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936646,0.023455,-2.60991e-05,1.68334e-08,-4.66583e-12,12014,19.5947], Tmin=(298,'K'), Tmax=(1050,'K')), NASAPolynomial(coeffs=[5.93667,0.00654409,-2.37413e-06,3.82235e-10,-2.2536e-14,10745.2,-5.57304], Tmin=(1050,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(97.1583,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(108.088,'J/mol/K'), label="""CH2CF""", comment="""Thermo library: Fluorine"""),
)

species(
    label = '[CH]C(F)F-2(220)',
...
"""),
    E0 = (-39.6093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([257,409,1143,1361,2944,180,1140.44,1140.48,1140.72,1140.92,2918.18],'cm^-1')),
    ...
    molecularWeight = (64.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.05587,0.0230321,-2.84047e-05,2.46601e-08,-9.727e-12,-4732.03,11.4096], Tmin=(100,'K'), Tmax=(661.456,'K')), NASAPolynomial(coeffs=[4.21186,0.0150074,-7.8618e-06,1.59181e-09,-1.14935e-13,-4862.33,6.48141], Tmin=(661.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.6093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', 'CF2CH(72)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.4e+34,'cm^3/(mol*s)'), n=-7.11, Ea=(5040,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 197 C2HF2 + H <=> C2H2F2 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_N-4R!H->C_N-Sp-3C-2C_Ext-3C-R]
family: R_Recombination"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(220)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(15.7031,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C]CF-2(188)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(116.726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'C2HF(96)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(267.68,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CF2(89)', 'CH2(S)(74)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.1e+24,'cm^3/(mol*s)'), n=-3.8, Ea=(2830,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 2 CH2 + CF2 <=> C2H2F2 in halocarbene_recombination_double/training
This reaction matched rate rule [CF2]
