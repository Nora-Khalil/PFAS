...
"""),
    E0 = (-518.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,248,333,466,604,684,796,1061,1199,350,440,435,1725,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,284.047,284.057,284.061],'cm^-1')),
        HinderedRotor(inertia=(0.134281,'amu*angstrom^2'), symmetry=1, barrier=(7.68868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134289,'amu*angstrom^2'), symmetry=1, barrier=(7.68867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.515481,'amu*angstrom^2'), symmetry=1, barrier=(29.5135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354498,0.103263,-0.000160838,1.22865e-07,-3.56364e-11,-62244.6,32.8145], Tmin=(100,'K'), Tmax=(701.98,'K')), NASAPolynomial(coeffs=[15.508,0.0232009,-1.18216e-05,2.2974e-09,-1.59851e-13,-64726.1,-39.9119], Tmin=(701.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(F)C1(F)[CH]OO1(3861)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O]C1OC1(F)C(F)(F)[CH]F(3862)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-679.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,375,552.5,462.5,1710,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,180,1164.74],'cm^-1')),
        HinderedRotor(inertia=(0.371516,'amu*angstrom^2'), symmetry=1, barrier=(8.54187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.603459,'amu*angstrom^2'), symmetry=1, barrier=(13.8747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.166,'amu*angstrom^2'), symmetry=1, barrier=(49.8006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.458324,0.0854101,-0.000138971,1.20907e-07,-4.17972e-11,-81633.9,27.994], Tmin=(100,'K'), Tmax=(786.192,'K')), NASAPolynomial(coeffs=[10.0969,0.0284216,-1.50749e-05,2.98619e-09,-2.10079e-13,-82903.8,-14.6255], Tmin=(786.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(Cs-F1sF1sCO)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19731,'amu*angstrom^2'), symmetry=1, barrier=(27.5284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773458,'amu*angstrom^2'), symmetry=1, barrier=(17.7833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382619,0.0873121,-0.000144714,1.25636e-07,-4.27307e-11,-75025.3,27.3023], Tmin=(100,'K'), Tmax=(818.73,'K')), NASAPolynomial(coeffs=[10.5046,0.0268745,-1.38598e-05,2.69812e-09,-1.87256e-13,-76314.5,-17.2578], Tmin=(818.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-411.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,350,440,435,1725,194,682,905,1196,1383,3221,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08805,'amu*angstrom^2'), symmetry=1, barrier=(25.0164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.451116,0.0712961,-8.12198e-05,4.00355e-08,-6.35795e-12,-49353.2,24.0868], Tmin=(100,'K'), Tmax=(962.674,'K')), NASAPolynomial(coeffs=[19.605,0.00595093,-1.59128e-06,2.58251e-10,-1.86842e-14,-53700.8,-71.0183], Tmin=(962.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
species(
    label = 'O=[C]C(O)(F)C(F)(F)[CH]F(3867)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.752687,0.115641,-0.000206909,1.81282e-07,-6.07157e-11,-103784,33.0601], Tmin=(100,'K'), Tmax=(850.324,'K')), NASAPolynomial(coeffs=[14.1007,0.0260217,-1.39828e-05,2.71387e-09,-1.85958e-13,-105597,-31.9925], Tmin=(850.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-864.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)C(F)(F)CF(3868)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-515.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,248,333,466,604,684,796,1061,1199,350,440,435,1725,334,575,1197,1424,3202,3010,987.5,1337.5,450,1655,330.195,342.41,342.425],'cm^-1')),
        HinderedRotor(inertia=(0.483499,'amu*angstrom^2'), symmetry=1, barrier=(38.5805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107704,'amu*angstrom^2'), symmetry=1, barrier=(8.54189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218571,'amu*angstrom^2'), symmetry=1, barrier=(16.9385,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.213864,0.0991993,-0.000146644,1.08916e-07,-3.18914e-11,-61808.7,32.2167], Tmin=(100,'K'), Tmax=(838.342,'K')), NASAPolynomial(coeffs=[15.4481,0.0244718,-1.29387e-05,2.59134e-09,-1.84944e-13,-64434.7,-40.5815], Tmin=(838.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-515.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)

species(
    label = '[O]C=C([O])C(F)(F)C(F)F(3870)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22951,'amu*angstrom^2'), symmetry=1, barrier=(28.2688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22937,'amu*angstrom^2'), symmetry=1, barrier=(28.2657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09153,'amu*angstrom^2'), symmetry=1, barrier=(25.0965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09135,'amu*angstrom^2'), symmetry=1, barrier=(25.0924,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.656141,0.11451,-0.000205354,1.84999e-07,-6.42494e-11,-58138.4,33.5129], Tmin=(100,'K'), Tmax=(826.002,'K')), NASAPolynomial(coeffs=[12.2464,0.0315774,-1.76132e-05,3.49961e-09,-2.44344e-13,-59572.3,-22.0451], Tmin=(826.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(=COF)C(F)(F)[CH]F(3860)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'O=C[C](F)C(F)(F)[CH]F(2877)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', '[O]C(F)(C=O)[C](F)F(3093)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]OO1(3861)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    products = ['[O]C1OC1(F)C(F)(F)[CH]F(3862)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)C(F)(F)[CH]F(3863)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(14)', 'O=C(F)C(F)(F)[CH]F(475)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(C=O)C(F)=CF(3864)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', '[O]C=C([O])C(F)=CF(3865)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF(86)', '[O]C(F)(C=O)[C](F)F(3093)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    products = ['O=[C]C(O)(F)C(F)(F)[CH]F(3867)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    products = ['[O]C(F)([C]=O)C(F)(F)CF(3868)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C=C(OF)C(F)(F)[CH]F(3869)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
    products = ['[O]C=C([O])C(F)(F)C(F)F(3870)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=CC(F)(OF)[C](F)[CH]F(3871)'],
    products = ['[O]C(F)(C=O)C(F)(F)[CH]F(3695)'],
...
network(
    label = 'PDepNetwork #1320',
    isomers = [
        '[O]C(F)(C=O)C(F)(F)[CH]F(3695)',
    ],
    reactants = [
