...
"""),
    E0 = (-372.635,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([580,1155,1237,1373,3147,362.364,362.409,362.461,362.559,362.56,1310.38,1310.52,1310.56],'cm^-1')),
        HinderedRotor(inertia=(0.290461,'amu*angstrom^2'), symmetry=1, barrier=(27.0774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00128265,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35571,0.0344604,-3.34596e-05,1.57362e-08,-2.92586e-12,-44757.1,18.2454], Tmin=(100,'K'), Tmax=(1293.7,'K')), NASAPolynomial(coeffs=[10.3603,0.00971071,-4.76303e-06,9.4832e-10,-6.81561e-14,-46828.2,-22.4334], Tmin=(1293.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFHHO) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(F1s)(O2s-CO)(H))"""),
)
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48385,0.0367266,-4.64037e-05,2.89115e-08,-5.29618e-12,514.257,18.5894], Tmin=(100,'K'), Tmax=(624.613,'K')), NASAPolynomial(coeffs=[6.83331,0.0145678,-6.86598e-06,1.30895e-09,-9.0815e-14,-140.18,-1.23652], Tmin=(624.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.84803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(CsFHHO) + ring(dioxirane) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O][C]1OC(F)O1(377)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[6.19612,-0.00396417,2.80038e-05,-1.91414e-08,3.54883e-12,-29188.2,7.55394], Tmin=(100,'K'), Tmax=(2002.25,'K')), NASAPolynomial(coeffs=[11.9111,0.0172332,-1.23099e-05,2.41676e-09,-1.58702e-13,-38014.4,-40.3111], Tmin=(2002.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(188)', '[CH]F(128)'],
    products = ['[O]C(=O)O[CH]F(305)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]C(=O)O[CH]F(305)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(64.2789,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)
