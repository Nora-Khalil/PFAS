...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)F(253)'],
    products = ['HF(38)', 'CF2O(48)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.94e+11,'s^-1'), n=0.45, Ea=(45.2,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 13 CF3OH <=> CF2O + HF in XY_Addition_MultipleBond/training
This reaction matched rate rule [HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd]
family: XY_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OF(172)', 'CF2(42)'],
    products = ['OC(F)(F)F(253)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(16.2917,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[C](F)F(237)'],
    products = ['OC(F)(F)F(253)'],
    transitionState = 'TS3',
