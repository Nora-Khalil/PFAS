...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'CF2O(48)'],
    products = ['CF3O(47)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(35.7639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)

reaction(
    label = 'reaction1',
    reactants = ['O(6)', 'CF3(44)'],
    products = ['CF3O(47)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FO[C](F)F(194)'],
    products = ['CF3O(47)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(66.7532,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
