...
reaction(
    label = 'reaction1',
    reactants = ['CF2(42)', 'CF2O(48)'],
    products = ['FC1(F)OC1(F)F(678)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O-2(137)', 'CF2CF2(60)'],
    products = ['FC1(F)OC1(F)F(678)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.69472,'m^3/(mol*s)'), n=1.53739, Ea=(10.8477,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [elec_def;CF2CF2] + [o_atom_singlet;mb_db_unsub] for rate rule [o_atom_singlet;CF2CF2]
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(719)'],
    products = ['FC1(F)OC1(F)F(678)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', 'FC1=C(F)O1(720)'],
    products = ['FC1(F)OC1(F)F(678)'],
    transitionState = 'TS6',
