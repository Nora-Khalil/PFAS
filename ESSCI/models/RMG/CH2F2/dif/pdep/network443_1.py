...
"""),
    E0 = (-457.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,580,1155,1237,1373,3147,258.085,258.124,258.129,2520.39],'cm^-1')),
        HinderedRotor(inertia=(0.173374,'amu*angstrom^2'), symmetry=1, barrier=(8.19404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173313,'amu*angstrom^2'), symmetry=1, barrier=(8.19401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692415,'amu*angstrom^2'), symmetry=1, barrier=(32.7336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20504,0.0695329,-0.000119125,1.10375e-07,-3.98189e-11,-54982.2,24.2592], Tmin=(100,'K'), Tmax=(816.239,'K')), NASAPolynomial(coeffs=[6.95566,0.0268485,-1.40317e-05,2.77024e-09,-1.94044e-13,-55437.8,0.642979], Tmin=(816.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10141,0.0713585,-0.000121241,1.09874e-07,-3.88005e-11,-56955.9,24.4084], Tmin=(100,'K'), Tmax=(819.122,'K')), NASAPolynomial(coeffs=[7.92242,0.0251501,-1.30011e-05,2.55397e-09,-1.7832e-13,-57640.6,-4.49651], Tmin=(819.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C[C](F)F(1170)'],
    products = ['F[CH]OC[C](F)F(1181)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(781)'],
    products = ['F[CH]OC[C](F)F(1181)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C[C](F)F(1170)'],
    products = ['F[CH]OC[C](F)F(1181)'],
