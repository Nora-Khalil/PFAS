...
species(
    label = 'F[CH]C(F)(F)C(F)(F)OF(1151)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)(F)C(F)(F)OF(1136)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(44.913,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'FCC(F)(F)OF(1139)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(347.252,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]C(F)(F)OF(714)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(202.597,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(1140)', 'F[C]CF-2(186)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'F[C]C(F)(F)CF(1141)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'F[C]C(F)(F)C(F)(F)OF(1142)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['FCC(F)(F)C(F)(F)OF(1136)'],
    products = ['FCC(F)(OF)C(F)(F)F(1145)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(716)', 'FCC(F)=C(F)F(811)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)C(F)(F)OF(1146)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)(F)[C](F)OF(1147)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)(F)OF(1148)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)CF(1149)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(154)', 'FCC(F)(F)[C](F)F(1150)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(192)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(89)', 'FOC(F)(F)[C](F)F(723)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)(F)OF(1151)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'O=C(F)C(F)(F)CF(698)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(106)', 'FCC(F)=C(F)OF(1152)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', 'C=C(F)C(F)(F)OF(1153)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)C(F)(F)OF(1154)'],
    products = ['FCC(F)(F)C(F)(F)OF(1136)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)C(F)(F)OF(1136)'],
    products = ['F2(106)', 'CF2O(48)', 'CH2CF2(56)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(243.389,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

network(
    label = 'PDepNetwork #486',
    isomers = [
        'FCC(F)(F)C(F)(F)OF(1136)',
    ],
    reactants = [
