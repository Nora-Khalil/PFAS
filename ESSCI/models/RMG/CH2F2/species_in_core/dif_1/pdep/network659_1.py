...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]O[CH]F(1038)'],
    products = ['[CH2]OC(F)[C](F)F(1547)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]OC(F)[C](F)F(1547)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(34.8999,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(1551)'],
    products = ['[CH2]OC(F)[C](F)F(1547)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(89)', '[CH2]O[CH]F(1038)'],
    products = ['[CH2]OC(F)[C](F)F(1547)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(1547)'],
    products = ['[CH2]O[CH]C(F)(F)F(1555)'],
