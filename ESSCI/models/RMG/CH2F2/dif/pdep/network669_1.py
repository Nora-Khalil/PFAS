...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19943,'amu*angstrom^2'), symmetry=1, barrier=(27.5773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1987,'amu*angstrom^2'), symmetry=1, barrier=(27.5605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19897,'amu*angstrom^2'), symmetry=1, barrier=(27.5666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.301865,'amu*angstrom^2'), symmetry=1, barrier=(6.94047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302031,'amu*angstrom^2'), symmetry=1, barrier=(6.94428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-645.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,209.775,212.268,213.618],'cm^-1')),
        HinderedRotor(inertia=(0.990769,'amu*angstrom^2'), symmetry=1, barrier=(31.8991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.994721,'amu*angstrom^2'), symmetry=1, barrier=(31.9171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.989585,'amu*angstrom^2'), symmetry=1, barrier=(31.9318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-826.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,375,486,586,623,710,938,1161,1294,180,180,669.673],'cm^-1')),
        HinderedRotor(inertia=(0.246502,'amu*angstrom^2'), symmetry=1, barrier=(5.66757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960622,'amu*angstrom^2'), symmetry=1, barrier=(22.0866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-812.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,482,664,788,1296,1923,180,467.168,1397.04],'cm^-1')),
        HinderedRotor(inertia=(1.16429,'amu*angstrom^2'), symmetry=1, barrier=(26.7694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26311,'amu*angstrom^2'), symmetry=1, barrier=(29.0413,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(600)'],
    products = ['OC(F)(F)OCF(1596)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(1801)'],
    products = ['OC(F)(F)OCF(1596)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(239)', '[O]CF(294)'],
    products = ['OC(F)(F)OCF(1596)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(155)', 'CH2F(45)'],
    products = ['OC(F)(F)OCF(1596)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(602)'],
    products = ['OC(F)(F)OCF(1596)'],
