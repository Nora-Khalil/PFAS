...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(1016)'],
    products = ['O=C(O)C(=O)OF(1010)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(1021)'],
    products = ['O=C(O)C(=O)OF(1010)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(4)', 'O=[C]C(=O)OF(1022)'],
    products = ['O=C(O)C(=O)OF(1010)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(1023)'],
    products = ['O=C(O)C(=O)OF(1010)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(154)', 'O=[C]C(=O)O(1024)'],
    products = ['O=C(O)C(=O)OF(1010)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(190)', 'O=[C]O(189)'],
    products = ['O=C(O)C(=O)OF(1010)'],
