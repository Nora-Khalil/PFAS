...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'FC1(F)[CH]OO1(1440)'],
    products = ['[O]C1OOC1(F)F(632)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C1OOC1(F)F(250)'],
    products = ['[O]C1OOC1(F)F(632)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(1816)'],
    products = ['[O]C1OOC1(F)F(632)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[O][C]1OOC1(F)F(294)'],
    products = ['[O]C1OOC1(F)F(632)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(1817)'],
    products = ['[O]C1OOC1(F)F(632)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(632)'],
    products = ['O[C]1OOC1(F)F(1818)'],
