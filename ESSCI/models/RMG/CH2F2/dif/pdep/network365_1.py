...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08305,'amu*angstrom^2'), symmetry=1, barrier=(24.9015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08343,'amu*angstrom^2'), symmetry=1, barrier=(24.9101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08318,'amu*angstrom^2'), symmetry=1, barrier=(24.9044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-600.455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,261,493,600,1152,1365,1422,3097,617,898,1187,310.128,310.172,310.212,310.22,310.247],'cm^-1')),
        HinderedRotor(inertia=(0.310747,'amu*angstrom^2'), symmetry=1, barrier=(21.2382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115837,'amu*angstrom^2'), symmetry=1, barrier=(7.90855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.542449,'amu*angstrom^2'), symmetry=1, barrier=(37.038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598134,0.0811907,-0.000119233,8.81533e-08,-2.58834e-11,-72101.2,25.7867], Tmin=(100,'K'), Tmax=(833.047,'K')), NASAPolynomial(coeffs=[12.9761,0.0217565,-1.22155e-05,2.5105e-09,-1.81963e-13,-74163.5,-31.6689], Tmin=(833.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-969.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,234.125,234.313],'cm^-1')),
        HinderedRotor(inertia=(0.0030638,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9744,'amu*angstrom^2'), symmetry=1, barrier=(37.7531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23817,'amu*angstrom^2'), symmetry=1, barrier=(28.468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.24314,'amu*angstrom^2'), symmetry=1, barrier=(28.5823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303643,'amu*angstrom^2'), symmetry=1, barrier=(6.98136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15911,'amu*angstrom^2'), symmetry=1, barrier=(49.6423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689354,0.0823039,-0.000140517,1.30841e-07,-4.77861e-11,-66398.6,24.6226], Tmin=(100,'K'), Tmax=(802.738,'K')), NASAPolynomial(coeffs=[7.32486,0.0329159,-1.7728e-05,3.53382e-09,-2.49075e-13,-66938,-2.65593], Tmin=(802.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-552.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.36446,'amu*angstrom^2'), symmetry=1, barrier=(31.3716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36502,'amu*angstrom^2'), symmetry=1, barrier=(31.3844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(243)', 'F[C]CF(874)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FCC(F)(F)OF(814)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(7)', 'F[C]C(F)(F)C(F)OF(1047)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(24)', 'FOC(F)C(F)(F)F(1048)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(428)', 'FC=C(F)CF(1050)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FC[C](F)C(F)OF(1051)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FCC(F)(F)[CH]OF(1052)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)OF(1053)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)C(F)(F)CF(1054)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(228)', 'F[CH]C(F)(F)CF(1055)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(295)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(45)', 'FOC(F)[C](F)F(570)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)(F)[C](F)OF(883)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)OF(1056)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'O=CC(F)(F)CF(1057)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'FCC(F)=COF(1058)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'C=C(F)C(F)OF(1059)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FCC(F)=C(F)OF(888)'],
    products = ['FCC(F)(F)C(F)OF(1043)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FCC(F)(F)C(F)OF(1043)'],
    products = ['F2(77)', 'CHFO(46)', 'CH2CF2(56)'],
