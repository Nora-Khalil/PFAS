...
"""),
    ...
    molecularWeight = (63.9976,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.59435,-0.0495019,0.000211025,-2.59814e-07,1.02248e-10,30429.8,13.135], Tmin=(100,'K'), Tmax=(907.939,'K')), NASAPolynomial(coeffs=[20.566,-0.0259008,1.6794e-05,-3.20973e-09,2.06735e-13,23656.5,-83.7052], Tmin=(907.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[O](207)'],
    products = ['O=O(177)', 'O=O(177)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['O1OOO1(208)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.62e+12,'s^-1'), n=-0.305, Ea=(24.3811,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_SSS;Y_rad_out;Ypri_rad_out] for rate rule [R4_SSS;O_rad;Opri_rad]
Euclidian distance = 1.4142135623730951
family: Birad_recombination
Ea raised from 18.0 to 24.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OO[O](207)'],
    products = ['O(6)', '[O-][O+]=O(209)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.60322e+09,'s^-1'), n=1.08, Ea=(235.857,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;Y_rad_intra;OOJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Cyclic_Ether_Formation
Ea raised from 235.8 to 235.9 kJ/mol to match endothermicity of reaction."""),
)

network(
    label = 'PDepNetwork #51',
    isomers = [
        '[O]OO[O](207)',
    ],
    reactants = [
