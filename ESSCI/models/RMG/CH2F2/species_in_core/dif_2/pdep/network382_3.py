...
reaction(
    label = 'reaction5',
    reactants = ['O2(2)', 'CF2(87)'],
    products = ['[O]O[C](F)F(171)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(171)'],
    products = ['FC1(F)OO1(924)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]O[C](F)F(171)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.18075e+08,'m^3/(mol*s)'), n=-0.990129, Ea=(179.934,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05768407177011316, var=24.87296733003861, Tref=1000.0, N=33, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C
Ea raised from 178.8 to 179.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['O(170)', 'CF2O(48)'],
    products = ['FC1(F)OO1(924)'],
    transitionState = 'TS6',
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(75.1985,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)OF(197)'],
    products = ['[O]C([O])(F)F(144)'],
