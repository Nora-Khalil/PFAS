...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C([O])(F)F(732)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(736)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=C(F)F(461)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[C](F)F(738)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][C](F)F(464)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(87)', '[CH2]C([O])(F)F(732)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(739)'],
    products = ['[O]C(F)(F)C[C](F)F(605)'],
