...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C](F)F(535)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=[C]O[C](F)F(282)'],
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.63031e-05,'m^3/(mol*s)'), n=3.04336, Ea=(91.8212,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C(F)F(408)'],
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.64086e-07,'m^3/(mol*s)'), n=3.71185, Ea=(4.7317,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', 'O=[C]O[C](F)F(282)'],
    products = ['O=[C]OC(F)(F)[C](F)F(535)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC(F)(F)[C](F)F(535)'],
    products = ['O=[C]O[C](F)C(F)(F)F(538)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C](F)F(535)'],
    products = ['O=C(F)O[C](F)[C](F)F(539)'],
