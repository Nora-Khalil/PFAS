...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.477206,'amu*angstrom^2'), symmetry=1, barrier=(10.9719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476152,'amu*angstrom^2'), symmetry=1, barrier=(10.9477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.648327,'amu*angstrom^2'), symmetry=1, barrier=(14.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.647839,'amu*angstrom^2'), symmetry=1, barrier=(14.8951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39959,0.0613834,-0.000102357,8.44839e-08,-2.68333e-11,-28585.3,19.1591], Tmin=(100,'K'), Tmax=(853.696,'K')), NASAPolynomial(coeffs=[10.647,0.0122375,-5.7833e-06,1.08644e-09,-7.34592e-14,-29952.2,-22.7503], Tmin=(853.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]OC(F)[CH]F(921)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.420094,'amu*angstrom^2'), symmetry=1, barrier=(9.65878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.418465,'amu*angstrom^2'), symmetry=1, barrier=(9.62133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66564,0.0577515,-0.000101955,9.14664e-08,-3.12267e-11,-27473.1,20.2392], Tmin=(100,'K'), Tmax=(863.106,'K')), NASAPolynomial(coeffs=[7.65512,0.0169238,-8.28531e-06,1.57108e-09,-1.06541e-13,-28020.1,-4.95462], Tmin=(863.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-229.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.410312,'amu*angstrom^2'), symmetry=1, barrier=(9.43387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410591,'amu*angstrom^2'), symmetry=1, barrier=(9.44029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25475,0.0750919,-0.000159692,1.59451e-07,-5.79267e-11,-53655.5,22.0922], Tmin=(100,'K'), Tmax=(876.596,'K')), NASAPolynomial(coeffs=[4.60509,0.0247256,-1.34818e-05,2.60586e-09,-1.76362e-13,-52895.2,14.0574], Tmin=(876.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OC(F)[C](F)F(679)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.402948,'amu*angstrom^2'), symmetry=1, barrier=(9.26457,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3385.36,'J/mol'), sigma=(5.43578,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=528.79 K, Pc=47.83 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38925,0.0683394,-0.000134829,1.31278e-07,-4.76929e-11,-52054.9,22.2585], Tmin=(100,'K'), Tmax=(852.763,'K')), NASAPolynomial(coeffs=[5.85189,0.0231717,-1.27502e-05,2.51365e-09,-1.73779e-13,-51934.8,6.60632], Tmin=(852.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.666916,'amu*angstrom^2'), symmetry=1, barrier=(15.3337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666192,'amu*angstrom^2'), symmetry=1, barrier=(15.3171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79137,'amu*angstrom^2'), symmetry=1, barrier=(41.187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.58951,'amu*angstrom^2'), symmetry=1, barrier=(36.546,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20013,0.0712104,-0.000130064,1.23542e-07,-4.47997e-11,-36450.5,22.565], Tmin=(100,'K'), Tmax=(835.453,'K')), NASAPolynomial(coeffs=[6.41073,0.0264899,-1.42698e-05,2.81229e-09,-1.95658e-13,-36631.1,2.49349], Tmin=(835.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO)"""),
)

species(
    label = 'F[CH]C(F)OOF(925)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
reaction(
    ...
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0.894561,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'F[C]C(F)F(231)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC(F)F(168)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(133.699,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[O]OCF(907)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(129.442,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(F)C(F)F(300)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]O[CH]C(F)F(920)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)[CH]F(921)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[O]O[CH]F(126)'],
    products = ['[O]OC(F)C(F)F(692)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(656)'],
    products = ['[O]OC(F)C(F)F(692)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(679)'],
    products = ['[O]OC(F)C(F)F(692)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]OC=C(F)F(923)'],
    products = ['[O]OC(F)C(F)F(692)'],
