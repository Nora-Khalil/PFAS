...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]O[C]=O(233)'],
    products = ['O=[C]OO[C]=O(244)'],
    transitionState = 'TS2',
