...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(138)', 'CH2(T)(68)'],
    products = ['[CH2]OC([O])F(1619)'],
    transitionState = 'TS2',
