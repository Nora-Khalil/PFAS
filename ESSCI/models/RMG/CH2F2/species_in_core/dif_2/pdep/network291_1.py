...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C[C](F)F(728)'],
    products = ['F[C](F)CO[C](F)F(607)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(451)'],
    products = ['F[C](F)CO[C](F)F(607)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(87)', '[O]C[C](F)F(728)'],
    products = ['F[C](F)CO[C](F)F(607)'],
