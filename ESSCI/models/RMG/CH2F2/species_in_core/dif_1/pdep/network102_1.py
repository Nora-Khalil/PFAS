...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OC(F)F(1349)'],
    products = ['F[C](F)OC(F)F(258)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]O[C](F)F(372)'],
    products = ['F[C](F)OC(F)F(258)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)O[C](F)F(361)'],
    products = ['F[C](F)OC(F)F(258)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(1350)'],
    products = ['F[C](F)OC(F)F(258)'],
    transitionState = 'TS9',
