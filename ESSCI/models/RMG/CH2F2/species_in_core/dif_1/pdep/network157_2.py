...
"""),
    E0 = (94.6756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,418.237,2471.22],'cm^-1')),
        HinderedRotor(inertia=(0.172049,'amu*angstrom^2'), symmetry=1, barrier=(21.4409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.48434,0.0073885,1.37168e-05,-1.9457e-08,6.84571e-12,11408.8,8.8711], Tmin=(100,'K'), Tmax=(1062.36,'K')), NASAPolynomial(coeffs=[5.55791,0.00981333,-4.15439e-06,8.23956e-10,-6.04226e-14,10390.8,-3.97569], Tmin=(1062.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.6756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: Fluorine + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-66.6792,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([235,523,627,1123,1142,1372,1406,3097,757.949,760.475,1531.33],'cm^-1')),
        HinderedRotor(inertia=(0.155138,'amu*angstrom^2'), symmetry=1, barrier=(3.56757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (64.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97934,0.0175278,-2.16647e-06,-1.04948e-08,5.29939e-12,-7978.6,13.0508], Tmin=(100,'K'), Tmax=(1018.37,'K')), NASAPolynomial(coeffs=[8.56696,0.00670628,-2.61462e-06,5.26763e-10,-3.99818e-14,-9693.56,-16.8404], Tmin=(1018.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.6792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: Fluorine + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00506785,'amu*angstrom^2'), symmetry=1, barrier=(6.80244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.32682,0.0133921,-4.86111e-06,-3.49777e-10,3.95028e-13,15010.6,12.2916], Tmin=(100,'K'), Tmax=(1469.92,'K')), NASAPolynomial(coeffs=[6.21451,0.0089033,-3.71871e-06,6.91462e-10,-4.72738e-14,13797.7,-3.9903], Tmin=(1469.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: Fluorine + radical(Cs_P) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-253.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,334,575,1197,1424,3202,239.796],'cm^-1')),
        HinderedRotor(inertia=(0.254192,'amu*angstrom^2'), symmetry=1, barrier=(10.3569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28983,0.0255773,-1.99128e-05,7.58804e-09,-1.12378e-12,-30343.3,15.4313], Tmin=(298,'K'), Tmax=(1250,'K')), NASAPolynomial(coeffs=[8.72145,0.00868155,-3.54229e-06,6.63135e-10,-4.47423e-14,-32272.9,-18.2518], Tmin=(1250,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-253.074,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(153.818,'J/mol/K'), label="""CH2F-CHF""", comment="""Thermo library: Fluorine"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', 'CH2CF2(56)'],
    products = ['CH3-CF2(64)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(464.171,'m^3/(mol*s)'), n=1.61036, Ea=(8.22687,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_N-1COS->O_Sp-2CS=1CCSS_1CS->C_2CS->C_Ext-2C-R_N-4R!H->O_N-4BrCClFINPSSi-inRing_4BrCClFINPSSi->F',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_N-1COS->O_Sp-2CS=1CCSS_1CS->C_2CS->C_Ext-2C-R_N-4R!H->O_N-4BrCClFINPSSi-inRing_4BrCClFINPSSi->F"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH2][C](F)F(187)'],
    products = ['CH3-CF2(64)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CF2(89)', 'CH3(69)'],
    products = ['CH3-CF2(64)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.1e+13,'cm^3/(mol*s)'), n=-0.207, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 1 CF2 + CH3 <=> CF2CH3 in halocarbene_recombination/training
This reaction matched rate rule [Root_N-3R->H_N-2Br1sCl1sF1s->Cl1s_N-3BrCClFINOPSSi->F_3CClO->C]
family: halocarbene_recombination"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CH3-CF2(64)'],
    products = ['CHF2-CH2(63)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'CH2CHF(95)'],
    products = ['CHF2-CH2(63)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(55.2867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.90705e+22,'m^3/(mol*s)'), n=-6.09098, Ea=(1.55046,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Sp-4C-2C_Ext-2C-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Sp-4C-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CH2F-CHF(101)'],
    products = ['CHF2-CH2(63)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(134.905,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #157',
    isomers = [
        'CHF2-CH2(63)',
        'CH3-CF2(64)',
    ],
