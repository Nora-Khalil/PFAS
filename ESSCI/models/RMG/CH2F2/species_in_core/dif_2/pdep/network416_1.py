...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'C2HF(57)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(270.153,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction1',
    reactants = ['F(37)', 'CH2CF(100)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(218)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(13.867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C]CF-2(186)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(112.383,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CF2(87)', 'CH2(S)(72)'],
    products = ['CH2CF2(56)'],
    transitionState = 'TS6',
