...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0402,0.0707979,-0.000103067,7.9807e-08,-2.49087e-11,-52896.6,27.0956], Tmin=(100,'K'), Tmax=(781.598,'K')), NASAPolynomial(coeffs=[10.2671,0.0235743,-1.24327e-05,2.4952e-09,-1.78382e-13,-54338.8,-15.1446], Tmin=(781.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCFFO) + ring(Cs-Cs(F)-O2s-O2s) + radical(O2sj(Cs-CsF1sF1s)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C1[C](F)OOC1(F)F(3018)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247028,0.0701339,-7.92199e-05,4.30468e-08,-8.73657e-12,-66978.3,25.2412], Tmin=(100,'K'), Tmax=(1376.41,'K')), NASAPolynomial(coeffs=[18.6399,0.00721945,-3.43879e-07,-1.51746e-10,1.68892e-14,-71145.1,-66.114], Tmin=(1376.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCFHO) + ring(12dioxolane) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)C1OC1([O])F(3109)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-797.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,377,639,914,1335,375,552.5,462.5,1710,280,501,1494,1531,180,180,180,1379.31,1379.51,1379.54],'cm^-1')),
        HinderedRotor(inertia=(0.220903,'amu*angstrom^2'), symmetry=1, barrier=(5.07899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221534,'amu*angstrom^2'), symmetry=1, barrier=(5.0935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.47348,'amu*angstrom^2'), symmetry=1, barrier=(56.8702,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859585,0.0810603,-0.000150421,1.44408e-07,-5.23854e-11,-95873.8,28.0316], Tmin=(100,'K'), Tmax=(851.154,'K')), NASAPolynomial(coeffs=[5.77453,0.0315721,-1.66991e-05,3.24308e-09,-2.23077e-13,-95754.5,10.7275], Tmin=(851.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-797.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(O2sj(Cs-F1sF1sCO)) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-879.924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([377,639,914,1335,375,552.5,462.5,1710,286,619,818,1246,1924,180,180,180,1154.59,1154.6,1154.84],'cm^-1')),
        HinderedRotor(inertia=(0.232948,'amu*angstrom^2'), symmetry=1, barrier=(5.35592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23302,'amu*angstrom^2'), symmetry=1, barrier=(5.35758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03732,0.0743435,-0.00013374,1.25093e-07,-4.50896e-11,-105733,26.935], Tmin=(100,'K'), Tmax=(823.862,'K')), NASAPolynomial(coeffs=[7.3403,0.0262906,-1.44781e-05,2.8761e-09,-2.01239e-13,-106179,1.34227], Tmin=(823.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-879.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(COCFO) + radical(O2sj(Cs-F1sF1sCO))"""),
)
...
"""),
    E0 = (-557.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,280,501,1494,1531,286,619,818,1246,1924,180,180,1167.56],'cm^-1')),
        HinderedRotor(inertia=(0.211771,'amu*angstrom^2'), symmetry=1, barrier=(4.86904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211851,'amu*angstrom^2'), symmetry=1, barrier=(4.87087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.027,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37936,0.070457,-0.000142481,1.40596e-07,-5.10103e-11,-66968.7,23.7728], Tmin=(100,'K'), Tmax=(874.111,'K')), NASAPolynomial(coeffs=[4.49479,0.0258146,-1.37302e-05,2.63154e-09,-1.7797e-13,-66352.5,15.802], Tmin=(874.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(COCFO) + radical(O2sj(Cs-F1sCOH)) + radical(CsCOF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.571859,0.0812018,-0.000127415,1.00082e-07,-3.091e-11,-97404.1,30.5378], Tmin=(100,'K'), Tmax=(796.472,'K')), NASAPolynomial(coeffs=[12.9526,0.0190252,-1.03205e-05,2.07313e-09,-1.47519e-13,-99376.3,-26.3752], Tmin=(796.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(COCsFO) + radical(O2sj(Cs-CsF1sF1s)) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C(F)=C([O])C(O)(F)F(3115)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-457.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,395,473,707,1436,486,617,768,1157,1926,335.089,335.091,335.096,335.1],'cm^-1')),
        HinderedRotor(inertia=(0.00239799,'amu*angstrom^2'), symmetry=1, barrier=(8.088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261482,'amu*angstrom^2'), symmetry=1, barrier=(20.836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10151,'amu*angstrom^2'), symmetry=1, barrier=(8.08807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.627861,0.0801626,-0.000127613,1.03893e-07,-3.34556e-11,-54860.5,31.9889], Tmin=(100,'K'), Tmax=(763.171,'K')), NASAPolynomial(coeffs=[11.9255,0.0209517,-1.12413e-05,2.24238e-09,-1.58677e-13,-56585,-19.4627], Tmin=(763.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFHO) + group(COCsFO) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C([C](F)OF)C(=O)F(3117)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-439.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,395,473,707,1436,486,617,768,1157,1926,321.13,321.132,321.255,1994.62],'cm^-1')),
        HinderedRotor(inertia=(0.112665,'amu*angstrom^2'), symmetry=1, barrier=(8.24803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269777,'amu*angstrom^2'), symmetry=1, barrier=(19.7405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112851,'amu*angstrom^2'), symmetry=1, barrier=(8.25014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.715128,0.0797313,-0.000123678,9.43304e-08,-2.66799e-11,-52801.2,31.5721], Tmin=(100,'K'), Tmax=(645.343,'K')), NASAPolynomial(coeffs=[11.6299,0.021867,-1.19331e-05,2.39582e-09,-1.70147e-13,-54413.8,-17.8842], Tmin=(645.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFHO) + group(COCsFO) + radical(C=OCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)C([C]=O)OF(3118)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-439.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,1855,455,950,251.478,251.854],'cm^-1')),
        HinderedRotor(inertia=(0.00265594,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270388,'amu*angstrom^2'), symmetry=1, barrier=(12.2154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271417,'amu*angstrom^2'), symmetry=1, barrier=(12.2168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67566,0.0760095,-0.000103029,6.75073e-08,-1.72508e-11,-52683.6,30.8086], Tmin=(100,'K'), Tmax=(961.094,'K')), NASAPolynomial(coeffs=[15.2903,0.0151828,-8.09329e-06,1.65254e-09,-1.20208e-13,-55492.7,-39.1182], Tmin=(961.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C([C]=O)C(F)(F)OF(3119)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-455.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,1855,455,950,347.216,348.64,348.985],'cm^-1')),
        HinderedRotor(inertia=(0.00139433,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119895,'amu*angstrom^2'), symmetry=1, barrier=(10.4472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122078,'amu*angstrom^2'), symmetry=1, barrier=(10.4585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
...
reaction(
    ...
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)=CC([O])(F)F(2647)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C([C](F)F)C(=O)F(3106)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C(F)(F)C1OO[C]1F(3108)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C1[C](F)OOC1(F)F(3018)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C(F)(F)C1OC1([O])F(3109)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C1C([O])(F)OC1(F)F(3046)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)C(=O)[C](O)F(3110)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CFO(50)', '[O]C(F)(F)C=O(437)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)C(=O)F(3111)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(C(=O)F)C(=O)F(3112)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O][C](F)C(=O)C(=O)F(3113)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C(F)(F)[C](O)C(=O)F(3114)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
    products = ['[O]C(F)=C([O])C(O)(F)F(3115)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O][C](F)C(OF)C(=O)F(3116)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C([C](F)OF)C(=O)F(3117)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(F)C([C]=O)OF(3118)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C([C]=O)C(F)(F)OF(3119)'],
    products = ['[O]C(C(=O)F)C([O])(F)F(3005)'],
