...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63974,0.0441336,-3.27823e-05,7.42914e-09,7.62145e-13,-126703,21.6548], Tmin=(100,'K'), Tmax=(1111.35,'K')), NASAPolynomial(coeffs=[14.1816,0.0114357,-5.44442e-06,1.10464e-09,-8.14719e-14,-130259,-43.6339], Tmin=(1111.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1054.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFHO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-571.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,1380,1390,370,380,2900,435,180,1683.57,1684.76,1685.08,1686.35],'cm^-1')),
        HinderedRotor(inertia=(0.00324463,'amu*angstrom^2'), symmetry=1, barrier=(6.51612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28309,'amu*angstrom^2'), symmetry=1, barrier=(6.50879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40947,0.0640009,-0.000174446,2.22581e-07,-9.52314e-11,-68759.5,21.5424], Tmin=(100,'K'), Tmax=(850.385,'K')), NASAPolynomial(coeffs=[-13.7511,0.062757,-3.59742e-05,7.18902e-09,-5.01392e-13,-63217.4,113.314], Tmin=(850.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-571.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(O)O[C](F)F(597)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-587.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,2054.19,2054.81,2055.53],'cm^-1')),
        HinderedRotor(inertia=(0.187874,'amu*angstrom^2'), symmetry=1, barrier=(4.31959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187889,'amu*angstrom^2'), symmetry=1, barrier=(4.31994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187671,'amu*angstrom^2'), symmetry=1, barrier=(4.31492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9092,0.0686167,-0.000166473,1.93767e-07,-7.87524e-11,-70610.1,24.7197], Tmin=(100,'K'), Tmax=(854.451,'K')), NASAPolynomial(coeffs=[-5.87575,0.047053,-2.6784e-05,5.32421e-09,-3.69646e-13,-67162.1,73.4443], Tmin=(854.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[C](O)O[C](F)F(598)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-609.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,360,370,350,493,600,700,1144,1293,180,2436.79,2436.9],'cm^-1')),
        HinderedRotor(inertia=(0.235054,'amu*angstrom^2'), symmetry=1, barrier=(5.40436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235371,'amu*angstrom^2'), symmetry=1, barrier=(5.41165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235246,'amu*angstrom^2'), symmetry=1, barrier=(5.40876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235206,'amu*angstrom^2'), symmetry=1, barrier=(5.40784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39038,0.0721772,-0.00015221,1.55978e-07,-5.84419e-11,-73247.9,26.1054], Tmin=(100,'K'), Tmax=(859.977,'K')), NASAPolynomial(coeffs=[3.00036,0.0295337,-1.65115e-05,3.24739e-09,-2.23584e-13,-72224.9,26.1391], Tmin=(859.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C(O)O(595)'],
    products = ['O=C(O)OC(F)F(340)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(599)'],
    products = ['O=C(O)OC(F)F(340)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(170)', 'O=[C]O(164)'],
    products = ['O=C(O)OC(F)F(340)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(461)'],
    products = ['O=C(O)OC(F)F(340)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(556)'],
    products = ['O=C(O)OC(F)F(340)'],
