...
"""),
    ...
    molecularWeight = (79.0072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.48425,-0.00703224,8.4256e-05,-1.10333e-07,4.27394e-11,-590.704,13.7887], Tmin=(100,'K'), Tmax=(949.372,'K')), NASAPolynomial(coeffs=[13.3993,-0.00179262,1.69467e-06,-1.94346e-10,1.25676e-16,-4592.04,-44.689], Tmin=(949.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.20544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsFHOO) + ring(Cyclobutane) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C1(F)OO1(1833)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(=O)F(148)'],
    products = ['F[C]1OOO1(1832)'],
    transitionState = 'TS4',
