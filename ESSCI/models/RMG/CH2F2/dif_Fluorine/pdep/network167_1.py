...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49935,0.0452506,-3.2977e-05,-8.20476e-10,6.17987e-12,-52817.2,20.0464], Tmin=(100,'K'), Tmax=(976.775,'K')), NASAPolynomial(coeffs=[17.5453,0.00174079,-2.52771e-07,1.13156e-10,-1.45362e-14,-57010.9,-62.4103], Tmin=(976.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(F1s)(O2s-H))"""),
)

species(
    label = '[O][C](F)C(O)F(498)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31141,0.0657198,-0.000117473,1.04195e-07,-3.53987e-11,-12476,20.2009], Tmin=(100,'K'), Tmax=(840.391,'K')), NASAPolynomial(coeffs=[9.36743,0.0160199,-8.49539e-06,1.66584e-09,-1.15283e-13,-13429,-14.8781], Tmin=(840.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(CCsJO)"""),
)

species(
    label = '[O][CH]C(F)OF(500)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203094,'amu*angstrom^2'), symmetry=1, barrier=(4.66952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203217,'amu*angstrom^2'), symmetry=1, barrier=(4.67236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47624,0.0658676,-0.000128668,1.2354e-07,-4.41426e-11,-12073.4,20.5538], Tmin=(100,'K'), Tmax=(867.608,'K')), NASAPolynomial(coeffs=[5.91722,0.0217822,-1.16287e-05,2.24172e-09,-1.52446e-13,-11955.3,4.88058], Tmin=(867.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(493)'],
    products = ['[O]C(F)C([O])F(434)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFO(46)', '[O][CH]F(135)'],
    products = ['[O]C(F)C([O])F(434)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(56.3704,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)C(=O)F(477)'],
    products = ['[O]C(F)C([O])F(434)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(135)', '[O][CH]F(135)'],
    products = ['[O]C(F)C([O])F(434)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[O][CH]C(=O)F(478)'],
    products = ['[O]C(F)C([O])F(434)'],
