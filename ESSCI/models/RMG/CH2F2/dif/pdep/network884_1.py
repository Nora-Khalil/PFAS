...
"""),
    E0 = (-39.6093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([257,409,1143,1361,2944,180,1140.6,1140.63,1140.65,1140.67,2918.19],'cm^-1')),
        HinderedRotor(inertia=(0.196822,'amu*angstrom^2'), symmetry=1, barrier=(4.52532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (64.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.05583,0.0230326,-2.84072e-05,2.46646e-08,-9.72974e-12,-4732.02,11.4097], Tmin=(100,'K'), Tmax=(661.351,'K')), NASAPolynomial(coeffs=[4.21189,0.0150073,-7.86176e-06,1.5918e-09,-1.14934e-13,-4862.34,6.48125], Tmin=(661.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.6093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)
