...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26051,'amu*angstrom^2'), symmetry=1, barrier=(28.9815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2619,'amu*angstrom^2'), symmetry=1, barrier=(29.0135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25874,'amu*angstrom^2'), symmetry=1, barrier=(28.9409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.958947,'amu*angstrom^2'), symmetry=1, barrier=(22.0481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959231,'amu*angstrom^2'), symmetry=1, barrier=(22.0546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959405,'amu*angstrom^2'), symmetry=1, barrier=(22.0586,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.470624,'amu*angstrom^2'), symmetry=1, barrier=(10.8206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47045,'amu*angstrom^2'), symmetry=1, barrier=(10.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470625,'amu*angstrom^2'), symmetry=1, barrier=(10.8206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13398,0.068361,-0.000115394,9.70214e-08,-3.13388e-11,-39202.3,20.9229], Tmin=(100,'K'), Tmax=(863.741,'K')), NASAPolynomial(coeffs=[10.5819,0.0154118,-7.47131e-06,1.39691e-09,-9.38602e-14,-40491.4,-21.2883], Tmin=(863.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)

species(
    label = 'OC(F)[CH]OF(548)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.72034,'amu*angstrom^2'), symmetry=1, barrier=(16.562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.718722,'amu*angstrom^2'), symmetry=1, barrier=(16.5248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717782,'amu*angstrom^2'), symmetry=1, barrier=(16.5032,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09883,0.0691915,-0.000115036,9.73229e-08,-3.22832e-11,-39717.3,20.0665], Tmin=(100,'K'), Tmax=(792.862,'K')), NASAPolynomial(coeffs=[10.5833,0.0172772,-9.13033e-06,1.80696e-09,-1.26777e-13,-41093.5,-22.6834], Tmin=(792.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = '[O]C(F)C(O)F(549)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4637,'amu*angstrom^2'), symmetry=1, barrier=(33.6533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4669,'amu*angstrom^2'), symmetry=1, barrier=(33.727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.800311,'amu*angstrom^2'), symmetry=1, barrier=(18.4007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797575,'amu*angstrom^2'), symmetry=1, barrier=(18.3378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56509,'amu*angstrom^2'), symmetry=1, barrier=(35.9845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21064,'amu*angstrom^2'), symmetry=1, barrier=(27.8351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22059,'amu*angstrom^2'), symmetry=1, barrier=(28.0637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69975,0.0366011,-2.17285e-06,-4.33544e-08,2.53414e-11,-26078.8,15.8032], Tmin=(100,'K'), Tmax=(894.674,'K')), NASAPolynomial(coeffs=[20.121,-0.00708398,6.22787e-06,-1.29769e-09,8.83319e-14,-30922.8,-79.6686], Tmin=(894.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)C(F)OF(445)'],
    products = ['HF(38)', 'CHFO(46)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(24.9223,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)OF(524)'],
    products = ['OC(F)C(F)OF(445)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)OF(505)'],
    products = ['OC(F)C(F)OF(445)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.25106e-07,'m^3/(mol*s)'), n=3.34134, Ea=(128.067,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OF(172)', 'OC(F)[C]F(511)'],
    products = ['OC(F)C(F)OF(445)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(547)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(549)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(4)', 'F[CH]C(F)OF(550)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(551)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(248)', 'OC(F)[CH]F(552)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(402)', 'O[CH]F(180)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(527)'],
    products = ['OC(F)C(F)OF(445)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(F)C(O)F(494)'],
    products = ['OC(F)C(F)OF(445)'],
