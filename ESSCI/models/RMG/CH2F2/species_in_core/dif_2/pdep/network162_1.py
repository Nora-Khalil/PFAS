...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.34809,'amu*angstrom^2'), symmetry=1, barrier=(8.00328,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254211,0.103289,-0.000186904,1.63184e-07,-5.42768e-11,-129449,29.3478], Tmin=(100,'K'), Tmax=(851.836,'K')), NASAPolynomial(coeffs=[13.7772,0.0204154,-1.10609e-05,2.15688e-09,-1.47912e-13,-131223,-32.4785], Tmin=(851.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1077.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.839887,0.0682965,-7.67374e-05,4.19037e-08,-8.97138e-12,-169796,22.9648], Tmin=(100,'K'), Tmax=(1138.29,'K')), NASAPolynomial(coeffs=[15.7086,0.0160458,-7.88121e-06,1.57527e-09,-1.13905e-13,-173181,-50.6937], Tmin=(1138.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1412.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCsCsFF) + group(CsCFFO) + group(CsCFFO) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + ring(Cs-Cs(F)(F)-O2s-Cs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.332332,'amu*angstrom^2'), symmetry=1, barrier=(7.64097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333042,'amu*angstrom^2'), symmetry=1, barrier=(7.65728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.023,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.200092,'amu*angstrom^2'), symmetry=1, barrier=(4.6005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04125,0.0516239,-0.000104942,1.02887e-07,-3.74503e-11,-59293.5,18.0917], Tmin=(100,'K'), Tmax=(852.08,'K')), NASAPolynomial(coeffs=[5.53325,0.0162398,-9.21972e-06,1.83691e-09,-1.27509e-13,-59199.1,5.8493], Tmin=(852.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sF1s) + radical(CsCsF1sF1s)"""),
)
...
"""),
    E0 = (-770.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,212,367,445,1450,190,488,555,1236,1407,180,180,1396.68],'cm^-1')),
        HinderedRotor(inertia=(0.295967,'amu*angstrom^2'), symmetry=1, barrier=(6.80487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295582,'amu*angstrom^2'), symmetry=1, barrier=(6.796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295134,'amu*angstrom^2'), symmetry=1, barrier=(6.78572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.000114577,0.10354,-0.000205452,1.97492e-07,-7.10518e-11,-92516.9,32.6638], Tmin=(100,'K'), Tmax=(849.016,'K')), NASAPolynomial(coeffs=[8.34393,0.0307228,-1.76039e-05,3.50646e-09,-2.43456e-13,-92726.1,0.887268], Tmin=(849.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-770.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)(F)[C](F)C(F)(F)F(522)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.59511,0.083395,-0.000129315,9.79516e-08,-2.6852e-11,-133000,29.4098], Tmin=(100,'K'), Tmax=(625.121,'K')), NASAPolynomial(coeffs=[11.6577,0.0237921,-1.31311e-05,2.66593e-09,-1.9072e-13,-134602,-20.5112], Tmin=(625.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1106.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sF1s)(F1s))"""),
)

species(
    label = 'FO[C](F)C(F)(F)[C](F)F(523)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-762.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,395,473,707,1436,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.184631,'amu*angstrom^2'), symmetry=1, barrier=(4.24503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184697,'amu*angstrom^2'), symmetry=1, barrier=(4.24655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958723,'amu*angstrom^2'), symmetry=1, barrier=(22.0429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.276701,0.106006,-0.000198965,1.79871e-07,-6.16097e-11,-91566.4,30.9266], Tmin=(100,'K'), Tmax=(850.008,'K')), NASAPolynomial(coeffs=[12.3774,0.0236192,-1.32743e-05,2.62155e-09,-1.80988e-13,-92892.6,-23.2122], Tmin=(850.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-762.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)(F)C(F)(F)F(524)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.301595,0.112803,-0.000231338,2.2205e-07,-7.8625e-11,-134339,28.5891], Tmin=(100,'K'), Tmax=(871.894,'K')), NASAPolynomial(coeffs=[8.79681,0.0295294,-1.66229e-05,3.24054e-09,-2.20245e-13,-134347,-5.00521], Tmin=(871.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1118.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    products = ['CF2O(48)', 'CF2CF2(60)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)C(F)(F)[C](F)F(519)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    products = ['FC1(F)OC(F)(F)C1(F)F(361)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(106)', 'O=C(F)[C](F)[C](F)F(465)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.2243,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF2(87)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)[C](F)[C](F)F(521)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(103.366,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    products = ['[O]C(F)(F)[C](F)C(F)(F)F(522)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(166.889,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)C(F)(F)[C](F)F(523)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(76.9985,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(359)'],
    products = ['[O][C](F)C(F)(F)C(F)(F)F(524)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(208.304,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
