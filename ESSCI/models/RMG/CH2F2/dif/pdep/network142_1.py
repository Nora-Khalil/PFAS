...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1158,0.047492,-5.09625e-05,2.86287e-08,-6.84812e-12,-72866.4,17.3002], Tmin=(100,'K'), Tmax=(972.673,'K')), NASAPolynomial(coeffs=[8.0618,0.0230399,-1.3254e-05,2.78357e-09,-2.0534e-13,-74023.1,-11.2211], Tmin=(972.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-606.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2sCF) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)O2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27857,'amu*angstrom^2'), symmetry=1, barrier=(29.3969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27857,'amu*angstrom^2'), symmetry=1, barrier=(29.3968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27617,'amu*angstrom^2'), symmetry=1, barrier=(29.3416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.80801,0.0741514,-9.15494e-05,4.72643e-08,-8.59239e-12,-19489.7,27.4805], Tmin=(100,'K'), Tmax=(1657.91,'K')), NASAPolynomial(coeffs=[24.6894,-0.0116367,8.02712e-06,-1.60678e-09,1.08503e-13,-24608.5,-98.36], Tmin=(1657.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)OsOs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'O=C=C(OO)OF(362)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31709,'amu*angstrom^2'), symmetry=1, barrier=(30.2826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31793,'amu*angstrom^2'), symmetry=1, barrier=(30.3017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31975,'amu*angstrom^2'), symmetry=1, barrier=(30.3435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.234506,0.0669576,-8.288e-05,4.45691e-08,-8.70847e-12,-12023.2,24.8052], Tmin=(100,'K'), Tmax=(1453.1,'K')), NASAPolynomial(coeffs=[22.1829,-0.00524069,3.80894e-06,-7.81897e-10,5.3821e-14,-17158.2,-85.0057], Tmin=(1453.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)OsOs) + missing(Cdd-CdO2d)"""),
)

species(
    label = '[O]C([O])C(=O)OF(363)',
...
"""),
    E0 = (-181.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,1380,1390,370,380,2900,435,180,180,180,942.989,943.041,943.182,943.229,943.367],'cm^-1')),
        HinderedRotor(inertia=(0.0966175,'amu*angstrom^2'), symmetry=1, barrier=(2.22143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0967034,'amu*angstrom^2'), symmetry=1, barrier=(2.2234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87627,0.0511829,-7.83472e-05,6.77766e-08,-2.38815e-11,-21760,23.8572], Tmin=(100,'K'), Tmax=(751.404,'K')), NASAPolynomial(coeffs=[7.02632,0.020554,-1.07893e-05,2.1462e-09,-1.52061e-13,-22443.3,1.08673], Tmin=(751.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)

species(
    label = '[O]C(=O)C([O])OF(364)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (-199.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,222.808,222.905,409.57,1627.62,1627.63,1627.63,1627.63,1627.65],'cm^-1')),
        HinderedRotor(inertia=(1.22527,'amu*angstrom^2'), symmetry=1, barrier=(43.2505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22615,'amu*angstrom^2'), symmetry=1, barrier=(43.2504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97531,0.0516889,-8.83324e-05,8.72388e-08,-3.37975e-11,-23934.6,23.5777], Tmin=(100,'K'), Tmax=(795.909,'K')), NASAPolynomial(coeffs=[4.03294,0.0269986,-1.47569e-05,2.95884e-09,-2.09499e-13,-23807.6,16.9757], Tmin=(795.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C([O])=C(O)OF(365)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u0 p2 c0 {6,S} {8,S}
...
"""),
    E0 = (-248.978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,325,375,415,465,420,450,1700,1750,306.96,307.179,307.527],'cm^-1')),
        HinderedRotor(inertia=(0.258347,'amu*angstrom^2'), symmetry=1, barrier=(17.1821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255513,'amu*angstrom^2'), symmetry=1, barrier=(17.18,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790831,0.0735639,-0.000120322,9.24372e-08,-2.714e-11,-29832.4,21.4601], Tmin=(100,'K'), Tmax=(846.398,'K')), NASAPolynomial(coeffs=[14.6872,0.00788235,-3.90491e-06,7.29573e-10,-4.8905e-14,-32184.4,-43.2628], Tmin=(846.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37565,0.0405149,-5.30678e-05,3.85792e-08,-1.18683e-11,-57590.7,17.2781], Tmin=(100,'K'), Tmax=(775.686,'K')), NASAPolynomial(coeffs=[6.61176,0.0186706,-1.0826e-05,2.2744e-09,-1.6752e-13,-58247.9,-2.08265], Tmin=(775.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)O2s) + radical(C=OC=OOJ)"""),
)
...
"""),
    E0 = (-188.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,1855,455,950,439.22,439.222,439.222,439.223,439.223],'cm^-1')),
        HinderedRotor(inertia=(0.314768,'amu*angstrom^2'), symmetry=1, barrier=(43.0908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314763,'amu*angstrom^2'), symmetry=1, barrier=(43.0907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0179,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48529,0.0357767,-3.99735e-05,2.1816e-08,-4.80653e-12,-22651.7,15.8971], Tmin=(100,'K'), Tmax=(1083.62,'K')), NASAPolynomial(coeffs=[8.96524,0.011857,-6.86242e-06,1.44524e-09,-1.06805e-13,-24056.1,-15.8853], Tmin=(1083.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(OC=OCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81284,0.0539932,-8.42045e-05,7.01836e-08,-2.3988e-11,-41394.1,19.4633], Tmin=(100,'K'), Tmax=(710.067,'K')), NASAPolynomial(coeffs=[7.86584,0.0198995,-1.2192e-05,2.58153e-09,-1.89865e-13,-42253.8,-7.66726], Tmin=(710.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)O2s) + radical(C=OC=OOJ)"""),
)
...
"""),
    E0 = (-323.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,341.75,342.056,342.217,964.232],'cm^-1')),
        HinderedRotor(inertia=(0.0227211,'amu*angstrom^2'), symmetry=1, barrier=(34.6431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41953,'amu*angstrom^2'), symmetry=1, barrier=(34.643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(361)'],
    products = ['O=C(O)C(=O)OF(327)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(366)'],
    products = ['O=C(O)C(=O)OF(327)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(368)'],
    products = ['O=C(O)C(=O)OF(327)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(228)', 'O=[C]C(=O)O(369)'],
    products = ['O=C(O)C(=O)OF(327)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(142)', 'O=[C]O(164)'],
    products = ['O=C(O)C(=O)OF(327)'],
