...
"""),
    E0 = (-712.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,435,565,619,662,854,1178,1396,180,385.808],'cm^-1')),
        HinderedRotor(inertia=(0.145498,'amu*angstrom^2'), symmetry=1, barrier=(3.34529,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44724,0.060634,-8.92256e-05,6.57626e-08,-1.91835e-11,-85561.8,20.3931], Tmin=(100,'K'), Tmax=(839.603,'K')), NASAPolynomial(coeffs=[10.9173,0.0155177,-8.62389e-06,1.7636e-09,-1.27448e-13,-87152,-23.639], Tmin=(839.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsFFOO)"""),
)
...
"""),
    E0 = (-273.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,482,586,761,1411,331.008,332.053],'cm^-1')),
        HinderedRotor(inertia=(0.123298,'amu*angstrom^2'), symmetry=1, barrier=(9.71191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0160636,'amu*angstrom^2'), symmetry=1, barrier=(40.4688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51902,'amu*angstrom^2'), symmetry=1, barrier=(40.4692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0136,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0185,0.0470976,-6.7322e-05,4.91686e-08,-1.43192e-11,-32865.1,19.865], Tmin=(100,'K'), Tmax=(838.779,'K')), NASAPolynomial(coeffs=[9.05249,0.0135528,-7.33157e-06,1.48656e-09,-1.0704e-13,-34045,-12.8331], Tmin=(838.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsFHOO) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]OC(O)(F)F(324)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-263.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,493,600,700,1144,1293,498.996,499.091],'cm^-1')),
        HinderedRotor(inertia=(0.000676834,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28361,'amu*angstrom^2'), symmetry=1, barrier=(50.1252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60123,0.0323819,-3.27415e-05,1.59276e-08,-3.11782e-12,-31619.6,17.5737], Tmin=(100,'K'), Tmax=(1209.91,'K')), NASAPolynomial(coeffs=[9.07553,0.0109772,-6.20436e-06,1.30529e-09,-9.63936e-14,-33186.3,-14.8946], Tmin=(1209.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    E0 = (-445.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,375,486,586,623,710,938,1161,1294,204.583,204.598],'cm^-1')),
        HinderedRotor(inertia=(0.0102145,'amu*angstrom^2'), symmetry=1, barrier=(23.8017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43926,'amu*angstrom^2'), symmetry=1, barrier=(42.7477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80701,0.0506916,-6.58084e-05,4.12882e-08,-1.01924e-11,-53518.7,19.9976], Tmin=(100,'K'), Tmax=(988.603,'K')), NASAPolynomial(coeffs=[11.4451,0.0116948,-6.63886e-06,1.38719e-09,-1.02154e-13,-55424.4,-26.3903], Tmin=(988.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = 'O=C(F)OOF(1005)',
...
"""),
    E0 = (-504.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,482,664,788,1296,1923,311.916,311.979],'cm^-1')),
        HinderedRotor(inertia=(0.585745,'amu*angstrom^2'), symmetry=1, barrier=(41.897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576191,'amu*angstrom^2'), symmetry=1, barrier=(41.9147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15517,0.0296529,-5.17651e-06,-2.46275e-08,1.37875e-11,-60617.1,17.9793], Tmin=(100,'K'), Tmax=(963.303,'K')), NASAPolynomial(coeffs=[15.7847,-0.000462265,4.84514e-07,-9.72784e-12,-7.0722e-15,-64471.6,-53.6425], Tmin=(963.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2sFO) + group(COFOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OOF(963)'],
    products = ['O=O(176)', 'HF(38)', 'CF2O(48)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(80.7727,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C](F)OOF(402)'],
    products = ['OC(F)(F)OOF(963)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(156)', '[O]C(O)(F)F(257)'],
    products = ['OC(F)(F)OOF(963)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OF(154)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)OOF(963)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OOF(1004)'],
    products = ['OC(F)(F)OOF(963)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=C(F)OOF(1005)'],
    products = ['OC(F)(F)OOF(963)'],
    transitionState = 'TS8',
