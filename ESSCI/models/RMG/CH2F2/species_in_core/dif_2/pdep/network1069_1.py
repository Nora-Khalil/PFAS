...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50653,0.0596818,-8.90435e-05,7.53469e-08,-2.58487e-11,673.07,20.2218], Tmin=(100,'K'), Tmax=(763.918,'K')), NASAPolynomial(coeffs=[7.84782,0.0233259,-1.14676e-05,2.24585e-09,-1.58054e-13,-203.81,-8.06169], Tmin=(763.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.88806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.314007,'amu*angstrom^2'), symmetry=1, barrier=(7.21963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31425,'amu*angstrom^2'), symmetry=1, barrier=(7.22523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32404,0.0441648,-3.14038e-05,-2.55196e-08,4.26219e-11,1800.05,18.9689], Tmin=(100,'K'), Tmax=(480.227,'K')), NASAPolynomial(coeffs=[6.05484,0.0255977,-1.24793e-05,2.44699e-09,-1.72849e-13,1297.49,2.20473], Tmin=(480.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.5269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.93975,0.00343397,0.000107829,-1.89045e-07,1.02231e-10,-34046.9,9.64791], Tmin=(10,'K'), Tmax=(574.992,'K')), NASAPolynomial(coeffs=[0.0835845,0.0432107,-2.97229e-05,9.60905e-09,-1.17356e-12,-33817.5,24.2561], Tmin=(574.992,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-283.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), label="""FC1(F)CDCC1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56032,0.0588116,-8.85963e-05,7.68938e-08,-2.70607e-11,115.58,20.8814], Tmin=(100,'K'), Tmax=(771.137,'K')), NASAPolynomial(coeffs=[7.19339,0.0245655,-1.22038e-05,2.39769e-09,-1.68937e-13,-603.74,-3.8619], Tmin=(771.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.271668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH))"""),
)

species(
    label = '[CH]=[C]C(C)(F)F(2845)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.503535,'amu*angstrom^2'), symmetry=1, barrier=(11.5773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79013,0.0540946,-6.88915e-05,4.54357e-08,-9.80107e-12,4402.42,19.1911], Tmin=(100,'K'), Tmax=(609.382,'K')), NASAPolynomial(coeffs=[7.57523,0.0234326,-1.14138e-05,2.24391e-09,-1.59038e-13,3561.6,-6.96712], Tmin=(609.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C=C(F)CF(2846)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37903,0.0399434,-2.31524e-05,6.47814e-09,-7.57225e-13,-4228.33,18.524], Tmin=(100,'K'), Tmax=(1758.98,'K')), NASAPolynomial(coeffs=[8.19433,0.0267192,-1.18753e-05,2.20404e-09,-1.4976e-13,-6274.13,-12.8156], Tmin=(1758.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.6023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(F)=C[CH]F(2847)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83052,0.0450237,-3.7359e-05,1.56919e-08,-2.6554e-12,-16549.4,19.266], Tmin=(100,'K'), Tmax=(1395.91,'K')), NASAPolynomial(coeffs=[11.5348,0.0172154,-7.47651e-06,1.42016e-09,-9.93461e-14,-19258.6,-30.788], Tmin=(1395.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])(F)F(2803)'],
    products = ['C2H2(70)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C](F)F(2804)'],
    products = ['[CH]=CC([CH2])(F)F(2803)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(66)', '[CH]C=C(F)F(2812)'],
    products = ['[CH]=CC([CH2])(F)F(2803)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C([CH2])F(1518)'],
    products = ['[CH]=CC([CH2])(F)F(2803)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(274.794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[CH]=CC([CH2])(F)F(2803)'],
    products = ['[CH2]C(F)(F)[C]=C(2844)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC([CH2])(F)F(2803)'],
    products = ['[CH]C=C(F)CF(2846)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(161.918,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC([CH2])(F)F(2803)'],
    products = ['[CH2]C(F)=C[CH]F(2847)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(161.769,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #1069',
    isomers = [
        '[CH]=CC([CH2])(F)F(2803)',
    ],
    reactants = [
