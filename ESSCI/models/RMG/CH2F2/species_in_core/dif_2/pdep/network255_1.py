...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83314,'amu*angstrom^2'), symmetry=1, barrier=(42.1475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83254,'amu*angstrom^2'), symmetry=1, barrier=(42.1337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83251,'amu*angstrom^2'), symmetry=1, barrier=(42.1329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80136,0.0414389,-3.56365e-05,1.06126e-08,4.92345e-14,-23516.9,19.9072], Tmin=(100,'K'), Tmax=(1062.59,'K')), NASAPolynomial(coeffs=[14.0939,0.0068555,-3.31963e-06,6.90639e-10,-5.22966e-14,-26789.3,-43.2489], Tmin=(1062.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsFHHO) + group(Cds-OdOsH) + radical(CsF1sHO2s) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(233)', 'CHF(40)'],
    products = ['O=[C]OO[CH]F(577)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', '[O]O[CH]F(159)'],
    products = ['O=[C]OO[CH]F(577)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
