...
"""),
    E0 = (-119.408,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,180,1026.34,1026.4,1026.41,1026.42,1026.45,1026.47],'cm^-1')),
        HinderedRotor(inertia=(0.224502,'amu*angstrom^2'), symmetry=1, barrier=(5.16174,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.37357,-0.0119252,0.000125416,-1.61014e-07,6.1961e-11,-30083.8,12.969], Tmin=(100,'K'), Tmax=(945.787,'K')), NASAPolynomial(coeffs=[16.0493,0.000291959,1.63972e-06,-1.77657e-10,-4.76652e-15,-35425.6,-63.0422], Tmin=(945.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-250.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74116,0.0235306,-8.23722e-06,-8.48805e-09,5.91972e-12,25129.9,17.2975], Tmin=(100,'K'), Tmax=(918.054,'K')), NASAPolynomial(coeffs=[8.51931,0.00925101,-2.70891e-06,4.25486e-10,-2.80743e-14,23609.8,-12.5855], Tmin=(918.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(dioxirane) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O][C]1COO1(1541)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96454,0.0281388,-4.39248e-05,4.93921e-08,-2.14306e-11,25891.7,14.1933], Tmin=(100,'K'), Tmax=(798.227,'K')), NASAPolynomial(coeffs=[0.887649,0.0251379,-1.30891e-05,2.59476e-09,-1.83167e-13,26650.4,26.4208], Tmin=(798.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])CO1(1538)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641374,0.049514,-5.71631e-05,2.85306e-08,-5.01909e-12,-29883.6,19.7649], Tmin=(100,'K'), Tmax=(1733.82,'K')), NASAPolynomial(coeffs=[16.4067,-0.00425592,4.40777e-06,-9.31608e-10,6.3601e-14,-32735.2,-57.4279], Tmin=(1733.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(991)'],
    products = ['[O]CC([O])=O(1527)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(190)', '[CH2][O](1485)'],
    products = ['[O]CC([O])=O(1527)'],
