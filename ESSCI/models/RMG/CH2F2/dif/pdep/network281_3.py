...
"""),
    E0 = (-477.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,395,473,707,1436,190,488,555,1236,1407,180],'cm^-1')),
        HinderedRotor(inertia=(0.530652,'amu*angstrom^2'), symmetry=1, barrier=(12.2007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.848285,'amu*angstrom^2'), symmetry=1, barrier=(19.5037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86964,0.0508581,-7.79826e-05,5.94746e-08,-1.78386e-11,-57411.1,19.6868], Tmin=(100,'K'), Tmax=(818.89,'K')), NASAPolynomial(coeffs=[9.84673,0.011893,-6.60907e-06,1.36914e-09,-9.96667e-14,-58717.5,-17.2043], Tmin=(818.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)F(1091)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04091,0.0460853,-6.66519e-05,4.88824e-08,-1.41257e-11,-55167.2,18.5214], Tmin=(100,'K'), Tmax=(849.372,'K')), NASAPolynomial(coeffs=[9.34986,0.0116658,-5.86865e-06,1.1754e-09,-8.42626e-14,-56408.8,-15.547], Tmin=(849.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-459.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-262.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,419.576,419.577,419.577,419.579,743.745,1286.5,1286.5,1286.5,1286.5,1286.5],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0255,'amu'),
...
"""),
    E0 = (-474.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([462.681,462.739,462.761,462.766,462.779,462.824,561.182,1240.89,1240.95,1241.09,1241.27,1241.41],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0159,'amu'),
...
"""),
    E0 = (-171.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,180,180,707.44,1198.29,1198.33,1198.44,1198.82,1198.86],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0175,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.975,0.0268778,-4.73725e-05,4.88843e-08,-1.95186e-11,-20549.3,10.7701], Tmin=(100,'K'), Tmax=(799.922,'K')), NASAPolynomial(coeffs=[3.27501,0.0158257,-8.73647e-06,1.75678e-09,-1.24506e-13,-20291.7,11.2998], Tmin=(799.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(CdCFO) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + longDistanceInteraction_cyclic(Cds(F)=Cds(F)) + ring(Cyclopropene)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.078158,'amu*angstrom^2'), symmetry=1, barrier=(1.79701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541762,'amu*angstrom^2'), symmetry=1, barrier=(12.4562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70483,0.0601561,-0.000120124,1.16861e-07,-4.23049e-11,-16273.9,19.3878], Tmin=(100,'K'), Tmax=(854.978,'K')), NASAPolynomial(coeffs=[5.8368,0.0193093,-1.07132e-05,2.11549e-09,-1.46164e-13,-16194.1,4.69957], Tmin=(854.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[O][CH]F(127)'],
    products = ['[O]C(F)[C](F)F(402)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)[C](F)F(402)'],
    products = ['FC1OC1(F)F(245)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(1104)'],
    products = ['FC1OC1(F)F(245)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]1OC1(F)F(1106)'],
    products = ['FC1OC1(F)F(245)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(1108)'],
    products = ['FC1OC1(F)F(245)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C](F)F(257)', '[CH]F(128)'],
    products = ['[O]C(F)(F)[CH]F(401)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(F)[CH]F(1006)'],
    products = ['[O]C(F)(F)[CH]F(401)'],
