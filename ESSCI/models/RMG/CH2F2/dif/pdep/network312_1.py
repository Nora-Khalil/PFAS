...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.485059,'amu*angstrom^2'), symmetry=1, barrier=(11.1525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484873,'amu*angstrom^2'), symmetry=1, barrier=(11.1482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.241,'amu*angstrom^2'), symmetry=1, barrier=(28.5329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-823.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,223,363,546,575,694,1179,1410,617,898,1187,301.858,301.998,302.068,302.121,302.172],'cm^-1')),
        HinderedRotor(inertia=(0.124369,'amu*angstrom^2'), symmetry=1, barrier=(8.06648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124768,'amu*angstrom^2'), symmetry=1, barrier=(8.06845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.578485,'amu*angstrom^2'), symmetry=1, barrier=(37.3785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100242,0.0945217,-0.000153763,1.20556e-07,-3.54068e-11,-98873.7,28.1836], Tmin=(100,'K'), Tmax=(654.811,'K')), NASAPolynomial(coeffs=[13.8022,0.0218566,-1.25845e-05,2.5586e-09,-1.8236e-13,-100905,-33.9254], Tmin=(654.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-823.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-770.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,202.958,202.964,202.967],'cm^-1')),
        HinderedRotor(inertia=(0.61457,'amu*angstrom^2'), symmetry=1, barrier=(17.969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614701,'amu*angstrom^2'), symmetry=1, barrier=(17.9691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00323,'amu*angstrom^2'), symmetry=1, barrier=(29.3275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21756,'amu*angstrom^2'), symmetry=1, barrier=(27.9941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666597,'amu*angstrom^2'), symmetry=1, barrier=(15.3264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666057,'amu*angstrom^2'), symmetry=1, barrier=(15.314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.210716,0.0927317,-0.000142078,1.00575e-07,-2.30064e-11,-91721.9,26.4616], Tmin=(100,'K'), Tmax=(619.185,'K')), NASAPolynomial(coeffs=[13.4391,0.0232181,-1.23011e-05,2.43129e-09,-1.70535e-13,-93665.7,-33.4846], Tmin=(619.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-971.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,219.3,219.3,219.3],'cm^-1')),
        HinderedRotor(inertia=(0.216456,'amu*angstrom^2'), symmetry=1, barrier=(7.38707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216456,'amu*angstrom^2'), symmetry=1, barrier=(7.38707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890903,'amu*angstrom^2'), symmetry=1, barrier=(30.4041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0174142,'amu*angstrom^2'), symmetry=1, barrier=(46.6555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'FCC(F)(F)OF(814)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]C(F)(F)OF(505)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(875)', 'F[C]CF(874)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(428)', 'F[C]C(F)(F)CF(876)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'F[C]C(F)(F)C(F)(F)OF(877)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOC(F)(F)C(F)F(878)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(24)', 'FOC(F)(F)C(F)(F)F(879)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(428)', 'FCC(F)=C(F)F(881)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)C(F)(F)OF(882)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)(F)[C](F)OF(883)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)(F)OF(884)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)CF(885)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(228)', 'FCC(F)(F)[C](F)F(886)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(240)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(45)', 'FOC(F)(F)[C](F)F(513)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)(F)OF(887)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(F)C(F)(F)CF(805)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'FCC(F)=C(F)OF(888)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'C=C(F)C(F)(F)OF(889)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)C(F)(F)OF(890)'],
    products = ['FCC(F)(F)C(F)(F)OF(726)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)C(F)(F)OF(726)'],
    products = ['F2(77)', 'CF2O(48)', 'CH2CF2(56)'],
