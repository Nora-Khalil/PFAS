...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(367)'],
    products = ['[O]C(F)(F)C([O])(F)F(334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(108)', '[O][C](F)C(=O)F(368)'],
    products = ['[O]C(F)(F)C([O])(F)F(334)'],
    transitionState = 'TS7',
