...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.484916,'amu*angstrom^2'), symmetry=1, barrier=(11.1492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485017,'amu*angstrom^2'), symmetry=1, barrier=(11.1515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24099,'amu*angstrom^2'), symmetry=1, barrier=(28.5329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-823.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,347,453,1141,1468,223,363,546,575,694,1179,1410,617,898,1187,302.019,302.019,302.019,302.019,302.02],'cm^-1')),
        HinderedRotor(inertia=(0.124634,'amu*angstrom^2'), symmetry=1, barrier=(8.06741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124634,'amu*angstrom^2'), symmetry=1, barrier=(8.06741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.57747,'amu*angstrom^2'), symmetry=1, barrier=(37.3789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100341,0.0945202,-0.000153756,1.20544e-07,-3.53993e-11,-98873.7,28.1832], Tmin=(100,'K'), Tmax=(654.785,'K')), NASAPolynomial(coeffs=[13.8021,0.0218567,-1.25846e-05,2.55862e-09,-1.82362e-13,-100905,-33.925], Tmin=(654.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-823.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-770.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,202.596,202.695,202.881],'cm^-1')),
        HinderedRotor(inertia=(0.618424,'amu*angstrom^2'), symmetry=1, barrier=(17.9707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60521,'amu*angstrom^2'), symmetry=1, barrier=(17.9674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0056,'amu*angstrom^2'), symmetry=1, barrier=(29.3275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18415,'amu*angstrom^2'), symmetry=1, barrier=(27.2259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673966,'amu*angstrom^2'), symmetry=1, barrier=(15.4958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673213,'amu*angstrom^2'), symmetry=1, barrier=(15.4785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.071702,0.0968612,-0.000161384,1.3566e-07,-4.45917e-11,-91709.9,27.4303], Tmin=(100,'K'), Tmax=(800.605,'K')), NASAPolynomial(coeffs=[13.5624,0.0229749,-1.2146e-05,2.39199e-09,-1.67102e-13,-93708.1,-34.16], Tmin=(800.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-1073.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,351,323,533,609,664,892,1120,1201,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.685044,'amu*angstrom^2'), symmetry=1, barrier=(15.7505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684638,'amu*angstrom^2'), symmetry=1, barrier=(15.7412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.43516,0.0477264,8.17563e-05,-4.01409e-07,3.86285e-10,-129063,13.6939], Tmin=(10,'K'), Tmax=(417.504,'K')), NASAPolynomial(coeffs=[8.863,0.0369213,-2.74376e-05,9.29925e-09,-1.16983e-12,-129876,-12.0513], Tmin=(417.504,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1073.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""[O]C(F)(F)C(F)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-912.34,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.465489,'amu*angstrom^2'), symmetry=1, barrier=(10.7025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464909,'amu*angstrom^2'), symmetry=1, barrier=(10.6892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.35105,0.0589359,-8.35564e-05,6.62634e-08,-2.18136e-11,-109726,13.5155], Tmin=(10,'K'), Tmax=(714.979,'K')), NASAPolynomial(coeffs=[8.87138,0.0280522,-1.87642e-05,5.84977e-09,-6.89503e-13,-110515,-11.2649], Tmin=(714.979,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-912.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""FCC(F)(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-971.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,219.302,219.36,219.456],'cm^-1')),
        HinderedRotor(inertia=(0.216873,'amu*angstrom^2'), symmetry=1, barrier=(7.38681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217045,'amu*angstrom^2'), symmetry=1, barrier=(7.38733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888558,'amu*angstrom^2'), symmetry=1, barrier=(30.4041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.327616,'amu*angstrom^2'), symmetry=1, barrier=(7.53254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0174133,'amu*angstrom^2'), symmetry=1, barrier=(46.6524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)(F)C(F)(F)OF(882)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(38.3497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'FCC(F)(F)OF(891)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(344.03,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]C(F)(F)OF(575)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(203.005,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(892)', 'F[C]CF-2(188)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(201.542,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['FOF(577)', 'F[C]C(F)(F)CF(893)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(15.354,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H2(7)', 'F[C]C(F)(F)C(F)(F)OF(894)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.26413e-09,'m^3/(mol*s)'), n=4.30786, Ea=(83.9392,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HH_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node HH_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CHF(88)', 'FOC(F)(F)C(F)F(895)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(21.751,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(74)', 'FOC(F)(F)C(F)(F)F(896)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.05141e+54,'m^3/(mol*s)'), n=-13.541, Ea=(163.623,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(577)', 'FCC(F)=C(F)F(793)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)C(F)(F)OF(898)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.811858,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)(F)[C](F)OF(899)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.258402,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)(F)OF(900)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)CF(901)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(156)', 'FCC(F)(F)[C](F)F(902)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(194)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(91)', 'FOC(F)(F)[C](F)F(584)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)(F)OF(903)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(108)', 'O=C(F)C(F)(F)CF(752)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(87.0342,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F2(108)', 'FCC(F)=C(F)OF(904)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(4.47905,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F2(108)', 'C=C(F)C(F)(F)OF(905)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.97483,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)C(F)(F)OF(906)'],
    products = ['FCC(F)(F)C(F)(F)OF(882)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(190.846,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)C(F)(F)OF(882)'],
    products = ['F2(108)', 'CF2O(48)', 'CH2CF2(56)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(231.008,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

network(
    label = 'PDepNetwork #372',
    isomers = [
        'FCC(F)(F)C(F)(F)OF(882)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CHFCF2(54)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
