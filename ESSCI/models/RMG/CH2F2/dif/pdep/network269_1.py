...
"""),
    E0 = (-611.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,334,575,1197,1424,3202,180,180,655.905,655.91,655.971,655.996,656.027],'cm^-1')),
        HinderedRotor(inertia=(0.00857584,'amu*angstrom^2'), symmetry=1, barrier=(2.61921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00858089,'amu*angstrom^2'), symmetry=1, barrier=(2.62078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39548,0.0659421,-0.000114059,1.09721e-07,-4.11737e-11,-73489.1,23.6696], Tmin=(100,'K'), Tmax=(808.164,'K')), NASAPolynomial(coeffs=[5.18867,0.0302497,-1.6411e-05,3.26718e-09,-2.29931e-13,-73549.7,9.59565], Tmin=(808.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCO)(F1s)(H))"""),
)
...
"""),
    E0 = (-621.315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,233,1109,1254,1325,1339,3290,190,488,555,1236,1407,180,180,180,180,835.483,1261.8,1264.07],'cm^-1')),
        HinderedRotor(inertia=(0.0450821,'amu*angstrom^2'), symmetry=1, barrier=(51.3655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24092,'amu*angstrom^2'), symmetry=1, barrier=(51.5232,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.433845,'amu*angstrom^2'), symmetry=1, barrier=(9.97494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159095,'amu*angstrom^2'), symmetry=1, barrier=(3.65791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39341,0.0663417,-0.000124969,1.18108e-07,-4.22429e-11,-50241.3,22.4057], Tmin=(100,'K'), Tmax=(843.434,'K')), NASAPolynomial(coeffs=[7.00204,0.0211412,-1.1501e-05,2.27173e-09,-1.57741e-13,-50525.7,0.224583], Tmin=(843.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCO)(F1s)(H)) + radical(COj(Cs-F1sF1sCs)(O2d))"""),
)
...
"""),
    E0 = (-392.379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([288,410,724,839,1320,194,682,905,1196,1383,3221,180,180,1747.34,1750.31,1751.78,1752.26],'cm^-1')),
        HinderedRotor(inertia=(0.176243,'amu*angstrom^2'), symmetry=1, barrier=(4.05216,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18456,0.0492538,-9.17492e-05,9.59636e-08,-3.76967e-11,-47136,20.0479], Tmin=(100,'K'), Tmax=(831.701,'K')), NASAPolynomial(coeffs=[1.82635,0.0289817,-1.55191e-05,3.0627e-09,-2.13812e-13,-46315.7,26.2834], Tmin=(831.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(686)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(756)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(686)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(128)', '[O]C(=O)[C](F)F(267)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(686)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(757)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(686)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(686)'],
    products = ['F[CH]C(F)(F)[C]1OO1(758)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(686)'],
    products = ['[O]C1([O])C(F)C1(F)F(750)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(760)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(686)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(21.724,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(91.6791,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(=O)[C](F)F(267)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(686)'],
...
network(
    label = 'PDepNetwork #269',
    isomers = [
        '[O]C(=O)C(F)(F)[CH]F(686)',
    ],
    reactants = [
        ('CO2(13)', 'CHFCF2(54)'),
    ],
