...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(920)'],
    products = ['[CH2]C(F)(F)C([O])F(798)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(921)'],
    products = ['[CH2]C(F)(F)C([O])F(798)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(571)'],
    products = ['[CH2]C(F)(F)C([O])F(798)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', '[CH2]C(F)=C[O](922)'],
    products = ['[CH2]C(F)(F)C([O])F(798)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][C](F)C(=O)F(745)'],
    products = ['[CH2]C(F)(F)C([O])F(798)'],
