...
"""),
    E0 = (142.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,167,640,1190,180,2497.29],'cm^-1')),
        HinderedRotor(inertia=(0.426789,'amu*angstrom^2'), symmetry=1, barrier=(9.81271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29675,0.0487892,-9.9006e-05,1.05841e-07,-4.10398e-11,17228.3,16.0432], Tmin=(100,'K'), Tmax=(860.619,'K')), NASAPolynomial(coeffs=[0.7488,0.028148,-1.45138e-05,2.80788e-09,-1.92644e-13,18525.6,29.2678], Tmin=(860.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34173,0.0400434,-5.34168e-05,4.17766e-08,-1.3641e-11,2395.78,14.7083], Tmin=(100,'K'), Tmax=(739.349,'K')), NASAPolynomial(coeffs=[6.37842,0.0182038,-9.10724e-06,1.82212e-09,-1.30697e-13,1798.89,-3.54725], Tmin=(739.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.4505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.204866,'amu*angstrom^2'), symmetry=1, barrier=(4.71028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20521,0.0450656,-7.5879e-05,7.06988e-08,-2.54224e-11,20325.5,17.7683], Tmin=(100,'K'), Tmax=(839.938,'K')), NASAPolynomial(coeffs=[5.25869,0.0191683,-9.35095e-06,1.79866e-09,-1.24059e-13,20213.1,5.9542], Tmin=(839.938,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C[C]F(1494)'],
    products = ['[O]CC=[C]F(2033)'],
    transitionState = 'TS2',
