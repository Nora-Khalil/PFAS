...
"""),
    E0 = (-929.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,548,1085,1183,1302,1466,1520,3060,3119,210.244,214.724,215.386,217.849],'cm^-1')),
        HinderedRotor(inertia=(0.328794,'amu*angstrom^2'), symmetry=1, barrier=(11.6081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297869,'amu*angstrom^2'), symmetry=1, barrier=(10.2303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.983155,'amu*angstrom^2'), symmetry=1, barrier=(32.7743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-492.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,290.234,290.403,290.406,2476.1],'cm^-1')),
        HinderedRotor(inertia=(0.191916,'amu*angstrom^2'), symmetry=1, barrier=(11.4806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668829,'amu*angstrom^2'), symmetry=1, barrier=(39.9809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668068,'amu*angstrom^2'), symmetry=1, barrier=(39.9796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86126,0.051643,-6.38307e-05,4.33331e-08,-1.21938e-11,-59106.6,22.1114], Tmin=(100,'K'), Tmax=(853.019,'K')), NASAPolynomial(coeffs=[8.22981,0.0217797,-1.13175e-05,2.29237e-09,-1.65848e-13,-60193.1,-7.6008], Tmin=(853.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-492.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FCOC(F)(F)OF(348)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(19.0663,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.67448e-06,'m^3/(mol*s)'), n=3.15288, Ea=(3.07355,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(488)', 'CH2(S)(24)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FCO[C](F)OF(523)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)(F)OF(524)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OCF(525)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(240)', '[O]CF(294)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(424)', 'CH2F(45)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(228)', 'FCO[C](F)F(526)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]OC(F)(F)OF(490)'],
    products = ['FCOC(F)(F)OF(348)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(77)', 'O=C(F)OCF(415)'],
    products = ['FCOC(F)(F)OF(348)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(94.5541,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['FCOC(F)(F)OF(348)'],
    products = ['F2(77)', 'CF2O(48)', 'CH2O(19)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(248.103,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
