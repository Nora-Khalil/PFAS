...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.60739,'amu*angstrom^2'), symmetry=1, barrier=(36.957,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1512,0.0749103,-0.000150342,1.46898e-07,-5.33951e-11,-12100.5,23.5731], Tmin=(100,'K'), Tmax=(853.755,'K')), NASAPolynomial(coeffs=[6.06606,0.0245296,-1.37664e-05,2.72388e-09,-1.88399e-13,-11942.8,6.47719], Tmin=(853.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[O]O[CH]C(F)(F)F(946)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11157,0.07003,-0.00012549,1.08805e-07,-3.58033e-11,-58093.8,20.6341], Tmin=(100,'K'), Tmax=(866.878,'K')), NASAPolynomial(coeffs=[10.6157,0.0138742,-7.03554e-06,1.3387e-09,-9.03583e-14,-59279.4,-21.1944], Tmin=(866.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(166)', '[O]O[CH]F(126)'],
    products = ['[O]OC(F)[C](F)F(679)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C(F)F(660)'],
    products = ['[O]OC(F)[C](F)F(679)'],
    transitionState = 'TS9',
