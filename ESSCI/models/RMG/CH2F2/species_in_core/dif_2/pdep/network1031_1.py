...
"""),
    E0 = (-201.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,180,1016.17,1016.17,1016.17,1016.17,1016.17,1016.17,1016.17,1016.17,1016.17,2291.04],'cm^-1')),
        HinderedRotor(inertia=(0.0158712,'amu*angstrom^2'), symmetry=1, barrier=(0.364909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0158712,'amu*angstrom^2'), symmetry=1, barrier=(0.364909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53898,0.0239277,8.38344e-06,-2.38709e-08,8.93077e-12,-62366.4,14.0196], Tmin=(100,'K'), Tmax=(1138.07,'K')), NASAPolynomial(coeffs=[10.1966,0.0171144,-9.13054e-06,1.90844e-09,-1.41441e-13,-65411.1,-29.6336], Tmin=(1138.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)-CO) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'O=COC1=C(F)O1(2616)',
...
"""),
    E0 = (24.1573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,180,180,180,180,658.362,1600,1643.41,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.147332,'amu*angstrom^2'), symmetry=1, barrier=(3.38745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147332,'amu*angstrom^2'), symmetry=1, barrier=(3.38745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-192.411,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', '[O]C1O[C]1F(2633)'],
    products = ['O=[C]OC1O[C]1F(2621)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(12)', '[O]C1O[C]1F(2633)'],
    products = ['O=[C]OC1O[C]1F(2621)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(2656)'],
    products = ['O=[C]OC1O[C]1F(2621)'],
    transitionState = 'TS9',
