...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.14643,'amu*angstrom^2'), symmetry=1, barrier=(26.3587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14661,'amu*angstrom^2'), symmetry=1, barrier=(26.3627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14873,'amu*angstrom^2'), symmetry=1, barrier=(26.4115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14354,'amu*angstrom^2'), symmetry=1, barrier=(26.2922,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.13783,'amu*angstrom^2'), symmetry=1, barrier=(26.1609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13835,'amu*angstrom^2'), symmetry=1, barrier=(26.1728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13783,'amu*angstrom^2'), symmetry=1, barrier=(26.1609,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42322,0.0611053,-8.85185e-05,6.69769e-08,-2.02554e-11,-51474.2,21.7828], Tmin=(100,'K'), Tmax=(808.475,'K')), NASAPolynomial(coeffs=[10.0192,0.0185763,-9.61327e-06,1.91251e-09,-1.36055e-13,-52864.1,-17.8604], Tmin=(808.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.136966,'amu*angstrom^2'), symmetry=1, barrier=(3.14911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975595,'amu*angstrom^2'), symmetry=1, barrier=(22.4309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.591608,0.0822294,-0.000132415,1.01506e-07,-2.86483e-11,-83326.3,24.4866], Tmin=(100,'K'), Tmax=(660.051,'K')), NASAPolynomial(coeffs=[12.9812,0.0177191,-9.83868e-06,1.96759e-09,-1.38746e-13,-85192.1,-31.8835], Tmin=(660.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(O2d-Cdd) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cd(Cdd-Od)CF) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-489.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,288,410,724,839,1320,326,540,652,719,1357,2782.5,750,1395,475,1775,1000,1953.06],'cm^-1')),
        HinderedRotor(inertia=(1.61494,'amu*angstrom^2'), symmetry=1, barrier=(37.1307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43475,'amu*angstrom^2'), symmetry=1, barrier=(9.99575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31203,0.0666039,-0.00011267,1.06101e-07,-3.99477e-11,-58841.4,22.356], Tmin=(100,'K'), Tmax=(762.794,'K')), NASAPolynomial(coeffs=[6.6184,0.0281081,-1.59878e-05,3.26493e-09,-2.33962e-13,-59340.6,0.227283], Tmin=(762.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-489.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-O2d(Cds-Cds)H)"""),
)

species(
    label = 'O=CC(O)=C(F)F(4044)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {9,S}
4 O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.857561,'amu*angstrom^2'), symmetry=1, barrier=(19.717,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57355,0.0579651,-7.36093e-05,4.72803e-08,-1.22275e-11,-77527.2,18.3681], Tmin=(100,'K'), Tmax=(934.857,'K')), NASAPolynomial(coeffs=[10.7922,0.0185204,-1.03188e-05,2.14601e-09,-1.5754e-13,-79250.8,-25.4856], Tmin=(934.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)H) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'OC(=COF)C(F)(F)OF(4045)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.884832,'amu*angstrom^2'), symmetry=1, barrier=(20.344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885828,'amu*angstrom^2'), symmetry=1, barrier=(20.3669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887166,'amu*angstrom^2'), symmetry=1, barrier=(20.3977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887238,'amu*angstrom^2'), symmetry=1, barrier=(20.3994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.867866,0.111938,-0.000171279,1.25059e-07,-3.52144e-11,-86936.6,29.28], Tmin=(100,'K'), Tmax=(878.644,'K')), NASAPolynomial(coeffs=[20.0463,0.0167252,-8.73168e-06,1.72507e-09,-1.21807e-13,-90611.7,-68.9128], Tmin=(878.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-724.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OOC=C(F)C(F)(F)OF(4046)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.380194,'amu*angstrom^2'), symmetry=1, barrier=(8.7414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379936,'amu*angstrom^2'), symmetry=1, barrier=(8.73547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99619,'amu*angstrom^2'), symmetry=1, barrier=(45.8963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97428,'amu*angstrom^2'), symmetry=1, barrier=(22.4006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.479519,0.107348,-0.000180073,1.54247e-07,-5.19864e-11,-87523,31.1334], Tmin=(100,'K'), Tmax=(784.987,'K')), NASAPolynomial(coeffs=[13.662,0.0282621,-1.55258e-05,3.10053e-09,-2.1852e-13,-89526.7,-32.2891], Tmin=(784.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OC(F)=COC(F)(F)OF(3894)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.13308,'amu*angstrom^2'), symmetry=1, barrier=(26.0518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12813,'amu*angstrom^2'), symmetry=1, barrier=(25.9379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13339,'amu*angstrom^2'), symmetry=1, barrier=(26.0589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1338,'amu*angstrom^2'), symmetry=1, barrier=(26.0683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
...
"""),
    E0 = (-702.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,180,180,180,958.921],'cm^-1')),
        HinderedRotor(inertia=(0.234431,'amu*angstrom^2'), symmetry=1, barrier=(5.39003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235247,'amu*angstrom^2'), symmetry=1, barrier=(5.4088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234581,'amu*angstrom^2'), symmetry=1, barrier=(5.39348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.407387,0.110069,-0.000200286,1.84658e-07,-6.5225e-11,-84388.2,32.3553], Tmin=(100,'K'), Tmax=(834.742,'K')), NASAPolynomial(coeffs=[10.2139,0.034109,-1.87505e-05,3.70405e-09,-2.57603e-13,-85288.2,-11.7372], Tmin=(834.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-702.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CCOJ)"""),
)

species(
    label = '[O]C(F)([CH]O)C(F)(F)OF(4048)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-748.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,316,385,515,654,689,1295,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,181.087,181.106,181.148,181.155],'cm^-1')),
        HinderedRotor(inertia=(0.328508,'amu*angstrom^2'), symmetry=1, barrier=(7.64518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0051375,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328284,'amu*angstrom^2'), symmetry=1, barrier=(7.64521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01154,'amu*angstrom^2'), symmetry=1, barrier=(23.5574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.999169,0.121045,-0.000217164,1.88728e-07,-6.2675e-11,-89826.1,33.1702], Tmin=(100,'K'), Tmax=(849.166,'K')), NASAPolynomial(coeffs=[15.4735,0.0245823,-1.34382e-05,2.61856e-09,-1.79606e-13,-91943.4,-39.6017], Tmin=(849.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-748.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CCsJOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08001,'amu*angstrom^2'), symmetry=1, barrier=(24.8317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07907,'amu*angstrom^2'), symmetry=1, barrier=(24.81,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07937,'amu*angstrom^2'), symmetry=1, barrier=(24.817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.430326,0.0945252,-0.000127515,7.95294e-08,-1.88497e-11,-88911,26.6441], Tmin=(100,'K'), Tmax=(1048.49,'K')), NASAPolynomial(coeffs=[22.2877,0.00785305,-3.51559e-06,6.84003e-10,-4.94019e-14,-93674.8,-84.0324], Tmin=(1048.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-740.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'O=CC(O)(F)[C](F)OF(4050)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1004,'amu*angstrom^2'), symmetry=1, barrier=(25.3004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09973,'amu*angstrom^2'), symmetry=1, barrier=(25.285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10052,'amu*angstrom^2'), symmetry=1, barrier=(25.303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09955,'amu*angstrom^2'), symmetry=1, barrier=(25.2807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0005,'amu*angstrom^2'), symmetry=1, barrier=(23.0035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00087,'amu*angstrom^2'), symmetry=1, barrier=(23.012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00079,'amu*angstrom^2'), symmetry=1, barrier=(23.0101,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431004,0.0841737,-0.00012211,8.97826e-08,-2.61315e-11,-113745,27.2382], Tmin=(100,'K'), Tmax=(841.912,'K')), NASAPolynomial(coeffs=[13.4769,0.022193,-1.16835e-05,2.34344e-09,-1.67619e-13,-115942,-33.4559], Tmin=(841.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-946.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.35209,'amu*angstrom^2'), symmetry=1, barrier=(31.0871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.495566,0.0815844,-0.000113975,7.80193e-08,-2.09599e-11,-85512.7,25.0169], Tmin=(100,'K'), Tmax=(912.792,'K')), NASAPolynomial(coeffs=[14.944,0.0182692,-9.92889e-06,2.02825e-09,-1.47092e-13,-88150.4,-43.3701], Tmin=(912.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15157,'amu*angstrom^2'), symmetry=1, barrier=(26.4769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15053,'amu*angstrom^2'), symmetry=1, barrier=(26.453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15265,'amu*angstrom^2'), symmetry=1, barrier=(26.5017,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.195292,0.0998179,-0.0001623,1.32688e-07,-4.27135e-11,-99499.4,29.84], Tmin=(100,'K'), Tmax=(764.493,'K')), NASAPolynomial(coeffs=[14.3275,0.0238275,-1.3193e-05,2.65389e-09,-1.88378e-13,-101720,-36.3233], Tmin=(764.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-828.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15274,'amu*angstrom^2'), symmetry=1, barrier=(26.5038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15372,'amu*angstrom^2'), symmetry=1, barrier=(26.5263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15386,'amu*angstrom^2'), symmetry=1, barrier=(26.5294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.72825,0.0777179,-0.000121834,9.8426e-08,-3.1527e-11,-95440.5,25.152], Tmin=(100,'K'), Tmax=(766.671,'K')), NASAPolynomial(coeffs=[11.5653,0.021176,-1.12067e-05,2.22743e-09,-1.57468e-13,-97102.2,-24.2509], Tmin=(766.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-794.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.489157,'amu*angstrom^2'), symmetry=1, barrier=(11.2467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488514,'amu*angstrom^2'), symmetry=1, barrier=(11.2319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48755,'amu*angstrom^2'), symmetry=1, barrier=(11.2097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120383,0.110758,-0.000240513,2.31767e-07,-8.07934e-11,-89510.9,24.1496], Tmin=(100,'K'), Tmax=(898.753,'K')), NASAPolynomial(coeffs=[8.53213,0.0233375,-1.29778e-05,2.43593e-09,-1.58548e-13,-89090.8,-5.68039], Tmin=(898.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(O2s-H))"""),
)

species(
    label = 'O=[C]C(O)(F)C(F)(F)OF(4054)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06533,'amu*angstrom^2'), symmetry=1, barrier=(24.494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06448,'amu*angstrom^2'), symmetry=1, barrier=(24.4745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06202,'amu*angstrom^2'), symmetry=1, barrier=(24.418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.063,'amu*angstrom^2'), symmetry=1, barrier=(24.4404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.366695,'amu*angstrom^2'), symmetry=1, barrier=(8.43104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94885,'amu*angstrom^2'), symmetry=1, barrier=(44.8078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966336,'amu*angstrom^2'), symmetry=1, barrier=(22.218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.612741,0.082134,-0.000127965,1.00923e-07,-3.06752e-11,-89862.9,25.5405], Tmin=(100,'K'), Tmax=(654.889,'K')), NASAPolynomial(coeffs=[11.3723,0.0242844,-1.34858e-05,2.73153e-09,-1.95228e-13,-91440.9,-23.102], Tmin=(654.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-748.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15487,'amu*angstrom^2'), symmetry=1, barrier=(26.5527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15698,'amu*angstrom^2'), symmetry=1, barrier=(26.6013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15691,'amu*angstrom^2'), symmetry=1, barrier=(26.5997,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08727,0.0693465,-0.000100037,7.61293e-08,-2.32677e-11,-111740,23.8293], Tmin=(100,'K'), Tmax=(798.804,'K')), NASAPolynomial(coeffs=[10.4914,0.0222526,-1.15982e-05,2.31591e-09,-1.65138e-13,-113243,-19.4271], Tmin=(798.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-929.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(COCsFO)"""),
)

species(
    label = 'O=CC(O)=C(F)OF(4057)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    ...
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'O=CC(O)(F)[C]F(4039)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'O=C=C(F)C(F)(F)OF(4042)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(153)', 'O=CC(F)=C(F)OF(4043)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(716)', 'O=CC(O)=C(F)F(4044)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(=COF)C(F)(F)OF(4045)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OOC=C(F)C(F)(F)OF(4046)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OC(F)=COC(F)(F)OF(3894)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]CC([O])(F)C(F)(F)OF(4047)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)([CH]O)C(F)(F)OF(4048)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C=C(O)C(F)(F)OF(4049)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'O=CC(O)(F)[C](F)OF(4050)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)C=O(4051)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(4)', '[O]C=C(F)C(F)(F)OF(1698)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(F)(C=O)C(F)(F)OF(4052)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]F(154)', 'O=CC(O)(F)[C](F)F(4053)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FO[C](F)F(192)', 'O=C[C](O)F(2998)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HCO(14)', 'O[C](F)C(F)(F)OF(720)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'O=[C]C(O)(F)C(F)(F)OF(4054)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=CC(=O)C(F)(F)OF(4055)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(106)', 'O=CC(O)(F)C(=O)F(4056)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(106)', 'O=CC(O)=C(F)OF(4057)'],
    products = ['O=CC(O)(F)C(F)(F)OF(3730)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O=CC(O)(F)C(F)(F)OF(3730)'],
    products = ['HF(38)', 'CF2O(48)', 'O=C=C(O)F(833)'],
...
network(
    label = 'PDepNetwork #1355',
    isomers = [
        'O=CC(O)(F)C(F)(F)OF(3730)',
    ],
    reactants = [
