...
"""),
    E0 = (-754.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,225.941,225.953],'cm^-1')),
        HinderedRotor(inertia=(0.190228,'amu*angstrom^2'), symmetry=1, barrier=(6.89096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190229,'amu*angstrom^2'), symmetry=1, barrier=(6.89098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618657,'amu*angstrom^2'), symmetry=1, barrier=(22.4105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.19104,'amu*angstrom^2'), symmetry=1, barrier=(27.3844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.202,'amu*angstrom^2'), symmetry=1, barrier=(27.6363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19883,'amu*angstrom^2'), symmetry=1, barrier=(27.5635,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
...
"""),
    E0 = (-659.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,342.489,342.806],'cm^-1')),
        HinderedRotor(inertia=(0.320909,'amu*angstrom^2'), symmetry=1, barrier=(26.7223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.319118,'amu*angstrom^2'), symmetry=1, barrier=(26.7304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0959117,'amu*angstrom^2'), symmetry=1, barrier=(2.2052,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)OF(707)', 'CH2(S)(72)'],
    products = ['OC(F)(F)COF(1912)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(716)', 'C=C(O)F(1989)'],
    products = ['OC(F)(F)COF(1912)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(1226)'],
    products = ['OC(F)(F)COF(1912)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(1991)'],
    products = ['OC(F)(F)COF(1912)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(154)', '[CH2]C(O)(F)F(1003)'],
    products = ['OC(F)(F)COF(1912)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(1992)'],
    products = ['OC(F)(F)COF(1912)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(232)', '[CH2]OF(1634)'],
    products = ['OC(F)(F)COF(1912)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(1227)'],
    products = ['OC(F)(F)COF(1912)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(1993)'],
    products = ['OC(F)(F)COF(1912)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(1232)'],
    products = ['OC(F)(F)COF(1912)'],
