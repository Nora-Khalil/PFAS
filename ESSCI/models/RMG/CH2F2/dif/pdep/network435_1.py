...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20456,0.0669657,-9.57129e-05,7.38717e-08,-2.30631e-11,-85295.8,24.8676], Tmin=(100,'K'), Tmax=(780.396,'K')), NASAPolynomial(coeffs=[9.69317,0.0234549,-1.20777e-05,2.42232e-09,-1.73461e-13,-86620.6,-13.98], Tmin=(780.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-709.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.218418,'amu*angstrom^2'), symmetry=1, barrier=(5.02187,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787958,0.077179,-0.000125574,1.08142e-07,-3.70491e-11,-84563.1,23.7038], Tmin=(100,'K'), Tmax=(765.291,'K')), NASAPolynomial(coeffs=[10.181,0.0238326,-1.26801e-05,2.53801e-09,-1.7996e-13,-85876.3,-18.2861], Tmin=(765.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.8572,0.00862116,0.000144574,-3.06111e-07,1.90464e-10,-125589,11.4435], Tmin=(10,'K'), Tmax=(547.739,'K')), NASAPolynomial(coeffs=[3.72153,0.0408582,-2.92769e-05,9.63541e-09,-1.18503e-12,-126043,7.73764], Tmin=(547.739,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1044.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), label="""FC1(F)CC(F)(F)O1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0138611,'amu*angstrom^2'), symmetry=1, barrier=(6.78767,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15905,0.0685176,-9.91319e-05,7.75163e-08,-2.45999e-11,-84188.1,25.196], Tmin=(100,'K'), Tmax=(766.909,'K')), NASAPolynomial(coeffs=[9.60201,0.0244801,-1.29966e-05,2.63779e-09,-1.90099e-13,-85483.1,-13.2955], Tmin=(766.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sF1sH)(H))"""),
)
...
"""),
    E0 = (-399.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.219003,'amu*angstrom^2'), symmetry=1, barrier=(5.0353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218447,'amu*angstrom^2'), symmetry=1, barrier=(5.02253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644619,'amu*angstrom^2'), symmetry=1, barrier=(14.8211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500957,0.0886945,-0.000166683,1.55862e-07,-5.50649e-11,-47951.9,26.8408], Tmin=(100,'K'), Tmax=(851.053,'K')), NASAPolynomial(coeffs=[8.48396,0.0267313,-1.4391e-05,2.818e-09,-1.94325e-13,-48425.6,-5.18457], Tmin=(851.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)CC(F)(F)F(1220)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45084,0.0591311,-6.65973e-05,3.85359e-08,-9.00093e-12,-90538,23.5468], Tmin=(100,'K'), Tmax=(1029.85,'K')), NASAPolynomial(coeffs=[11.4059,0.0204651,-1.02797e-05,2.07922e-09,-1.50971e-13,-92588.5,-24.7736], Tmin=(1029.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[C](F)F(1173)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C([O])(F)F(1172)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]C([O])(F)F(1171)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(1216)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(269.616,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CF2(42)', '[CH2]C([O])(F)F(1171)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(1217)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)C[C](F)F(1219)'],
    products = ['[O]C(F)(F)C[C](F)F(1173)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(77.693,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)(F)C[C](F)F(1173)'],
    products = ['[O][C](F)CC(F)(F)F(1220)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(206.124,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
