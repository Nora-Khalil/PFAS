...
species(
    label = 'F[CH]C(F)(F)C(F)=C(F)F(605)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)(F)[CH]C(F)(F)F(611)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C](F)C(F)C(F)(F)F(613)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(476)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'F[CH]C(F)(F)[CH]F(601)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'F[C](F)C(F)[C](F)F(272)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['FC1C(F)(F)C(F)C1(F)F(602)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['FCC(F)(F)C(F)=C(F)F(603)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=C(F)F(604)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(4.09006,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=C(F)F(605)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=C(F)C(F)[C](F)F(606)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(108)', 'F[CH]C(F)=C[C](F)F(607)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[C](F)F(608)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(89)', 'F[CH]C(F)(F)[CH]F(601)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(88)', 'F[C](F)C(F)[C](F)F(272)'],
    products = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['FCC(F)(F)[C](F)[C](F)F(610)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['F[CH]C(F)(F)[CH]C(F)(F)F(611)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)F(612)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['F[CH][C](F)C(F)C(F)(F)F(613)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)(F)C(F)[C](F)F(475)'],
    products = ['F[C](F)C(F)[C](F)C(F)F(597)'],
