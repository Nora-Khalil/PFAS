...
"""),
    E0 = (-727.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,1855,455,950,268.675],'cm^-1')),
        HinderedRotor(inertia=(0.17144,'amu*angstrom^2'), symmetry=1, barrier=(8.78515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7023,'amu*angstrom^2'), symmetry=1, barrier=(87.007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48041,0.0581371,-8.08541e-05,5.59698e-08,-1.51775e-11,-87419,21.9451], Tmin=(100,'K'), Tmax=(906.031,'K')), NASAPolynomial(coeffs=[11.6484,0.0132498,-6.54489e-06,1.29601e-09,-9.25055e-14,-89261.6,-26.107], Tmin=(906.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: 2-BTP_G4 + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0235,0.0709503,-9.13309e-05,6.24886e-08,-1.73936e-11,-84619.2,23.8651], Tmin=(100,'K'), Tmax=(869.099,'K')), NASAPolynomial(coeffs=[10.8372,0.0257841,-1.33793e-05,2.69508e-09,-1.94168e-13,-86325.1,-22.1037], Tmin=(869.099,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + ring(12dioxetane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)OC1C(F)(F)F(2385)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19869,0.0665137,-9.46156e-05,7.78952e-08,-2.61611e-11,-105538,27.9764], Tmin=(100,'K'), Tmax=(786.552,'K')), NASAPolynomial(coeffs=[8.03392,0.0277985,-1.32415e-05,2.53162e-09,-1.75512e-13,-106491,-2.5808], Tmin=(786.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(CsCsFFF) + ring(O2s-Cs-Cs(C-FFF)) + radical(CCOJ)"""),
)

species(
    label = '[O]C(=C(O)O)C(F)(F)F(2386)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.652324,'amu*angstrom^2'), symmetry=1, barrier=(14.9982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652101,'amu*angstrom^2'), symmetry=1, barrier=(14.9931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652232,'amu*angstrom^2'), symmetry=1, barrier=(14.9961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.653234,0.097133,-0.00013934,9.09875e-08,-2.21883e-11,-126941,27.1399], Tmin=(100,'K'), Tmax=(1081.87,'K')), NASAPolynomial(coeffs=[23.6952,0.00148177,1.08188e-06,-3.51097e-10,2.94343e-14,-131880,-90.7212], Tmin=(1081.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1056.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-1142.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,230,274,587,678,790,1206,1241,1314,375,552.5,462.5,1710,324.787,324.836,324.933,324.978,1207.88,3814.78],'cm^-1')),
        HinderedRotor(inertia=(0.509565,'amu*angstrom^2'), symmetry=1, barrier=(38.1756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509573,'amu*angstrom^2'), symmetry=1, barrier=(38.1774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509516,'amu*angstrom^2'), symmetry=1, barrier=(38.1766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.957607,0.0728491,-9.89353e-05,6.93509e-08,-1.95843e-11,-137305,23.9166], Tmin=(100,'K'), Tmax=(860.023,'K')), NASAPolynomial(coeffs=[11.5668,0.0235054,-1.28731e-05,2.63783e-09,-1.91525e-13,-139130,-25.6669], Tmin=(860.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1142.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCOFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s)"""),
)
...
"""),
    E0 = (-608.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,1855,455,950,315.092,4000],'cm^-1')),
        HinderedRotor(inertia=(0.225607,'amu*angstrom^2'), symmetry=1, barrier=(15.9437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226065,'amu*angstrom^2'), symmetry=1, barrier=(15.9448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27441,0.0604802,-7.71585e-05,4.78083e-08,-1.15225e-11,-73060.6,26.5654], Tmin=(100,'K'), Tmax=(1019.74,'K')), NASAPolynomial(coeffs=[13.6444,0.0119575,-5.78248e-06,1.14475e-09,-8.22735e-14,-75583.4,-33.3542], Tmin=(1019.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-608.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(=O)C([O])C(F)(F)F(2389)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-808.215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,180,180,180,180,1143.33,1143.34,1143.48,1143.56],'cm^-1')),
        HinderedRotor(inertia=(0.00610806,'amu*angstrom^2'), symmetry=1, barrier=(5.66564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0583555,'amu*angstrom^2'), symmetry=1, barrier=(54.1349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47477,0.0617028,-7.48856e-05,5.0177e-08,-1.41236e-11,-97120.2,26.5205], Tmin=(100,'K'), Tmax=(847.125,'K')), NASAPolynomial(coeffs=[8.63275,0.0279038,-1.50376e-05,3.07783e-09,-2.23823e-13,-98332.9,-6.82502], Tmin=(847.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-808.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C=C([O])O(1924)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-915.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,219,296,586,564,718,793,1177,1228,325,375,415,465,420,450,1700,1750,286.213,288.331,289.406],'cm^-1')),
        HinderedRotor(inertia=(0.207522,'amu*angstrom^2'), symmetry=1, barrier=(12.1558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207125,'amu*angstrom^2'), symmetry=1, barrier=(12.1449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0598186,0.0879388,-0.000127792,8.61166e-08,-2.19696e-11,-109952,26.4257], Tmin=(100,'K'), Tmax=(977.166,'K')), NASAPolynomial(coeffs=[19.954,0.00601407,-2.03528e-06,3.2135e-10,-1.99894e-14,-113863,-69.6677], Tmin=(977.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-915.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    E0 = (-780.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,1855,455,950,336.835],'cm^-1')),
        HinderedRotor(inertia=(0.277137,'amu*angstrom^2'), symmetry=1, barrier=(22.5468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119,'amu*angstrom^2'), symmetry=1, barrier=(9.64665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275687,'amu*angstrom^2'), symmetry=1, barrier=(22.5392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238015,'amu*angstrom^2'), symmetry=1, barrier=(19.3693,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493758,0.0786682,-9.83814e-05,5.96251e-08,-1.41368e-11,-93747.5,29.3529], Tmin=(100,'K'), Tmax=(1032.15,'K')), NASAPolynomial(coeffs=[16.3885,0.0170692,-8.86005e-06,1.80258e-09,-1.31309e-13,-97028.6,-47.8326], Tmin=(1032.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', '[O]C(O)C(F)(F)F(2055)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(87)', '[O]C(F)C(=O)O(1397)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CO2(13)', '[O]CC(F)(F)F(262)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=[C]C(=O)C(F)(F)F(2382)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)F(254)', 'O=[C]C=O(2133)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    products = ['[O]C=C(O)OC(F)(F)F(2383)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', 'O=C(O)[CH]C(F)(F)F(1569)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    products = ['O[C]1OOC1C(F)(F)F(2384)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    products = ['[O]C1(O)OC1C(F)(F)F(2385)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=C(O)O)C(F)(F)F(2386)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF3(44)', 'O=CC(=O)O(1401)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(189)', 'CF3CHO(103)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)C(=O)C(F)(F)F(2387)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(4)', '[O]C([C]=O)C(F)(F)F(2388)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C([O])C(F)(F)F(2389)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF3(44)', '[O]C=C([O])O(1924)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(189)', '[O][CH]C(F)(F)F(1448)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(O)=C([O])C(F)(F)F(2390)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
    products = ['O=C(O)[C](O)C(F)(F)F(2391)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=[C]C(OO)C(F)(F)F(2392)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(2177)'],
