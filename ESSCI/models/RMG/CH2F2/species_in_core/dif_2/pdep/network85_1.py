...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C([O])=O(236)'],
    products = ['[O]C(=O)O[C](F)F(247)'],
    transitionState = 'TS2',
