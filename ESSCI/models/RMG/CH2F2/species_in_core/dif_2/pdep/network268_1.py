...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.511831,'amu*angstrom^2'), symmetry=1, barrier=(11.768,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02832,0.0488021,-8.68643e-05,7.88725e-08,-2.7452e-11,-28640,16.0059], Tmin=(100,'K'), Tmax=(838.022,'K')), NASAPolynomial(coeffs=[7.11356,0.0145015,-7.51951e-06,1.47268e-09,-1.02147e-13,-29140.2,-5.52798], Tmin=(838.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'FC1OC(F)O1(660)',
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.544,0.0580724,-9.14617e-05,7.27277e-08,-2.26905e-11,-53839,20.1415], Tmin=(100,'K'), Tmax=(789.5,'K')), NASAPolynomial(coeffs=[10.3176,0.0136164,-6.9888e-06,1.38962e-09,-9.8416e-14,-55224.2,-20.1112], Tmin=(789.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cs)(O2s-H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-391.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,482,586,761,1411,180,180,270.198,883.726],'cm^-1')),
        HinderedRotor(inertia=(1.63733,'amu*angstrom^2'), symmetry=1, barrier=(37.6454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0234435,'amu*angstrom^2'), symmetry=1, barrier=(13.0564,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13005,0.0397547,-3.86692e-05,1.86998e-08,-3.58789e-12,-47018.8,19.3148], Tmin=(100,'K'), Tmax=(1254.22,'K')), NASAPolynomial(coeffs=[10.8139,0.0120597,-5.54687e-06,1.09395e-09,-7.85574e-14,-49197.1,-24.5468], Tmin=(1254.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'F[CH]O[CH]OF(665)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.322096,'amu*angstrom^2'), symmetry=1, barrier=(7.40563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321055,'amu*angstrom^2'), symmetry=1, barrier=(7.38169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167116,'amu*angstrom^2'), symmetry=1, barrier=(51.7473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34103,0.0749633,-0.000164743,1.69414e-07,-6.29151e-11,-11658.9,20.0585], Tmin=(100,'K'), Tmax=(871.939,'K')), NASAPolynomial(coeffs=[2.89118,0.0280601,-1.56009e-05,3.04466e-09,-2.0756e-13,-10416.5,21.4664], Tmin=(871.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.6024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O][CH]OC(F)F(666)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73944,0.0736803,-0.000183222,2.07776e-07,-8.20833e-11,-51861,17.1789], Tmin=(100,'K'), Tmax=(867.538,'K')), NASAPolynomial(coeffs=[-4.613,0.0422644,-2.39417e-05,4.71725e-09,-3.24083e-13,-48474.4,60.0891], Tmin=(867.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(416)'],
    products = ['[O]C(F)O[CH]F(587)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]F(168)', '[O][CH]F(168)'],
    products = ['[O]C(F)O[CH]F(587)'],
    transitionState = 'TS9',
