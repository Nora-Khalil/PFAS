...
"""),
    E0 = (-80.4764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,2950,3100,1380,975,1025,1650,1685,370,271.105,271.398,271.4],'cm^-1')),
        HinderedRotor(inertia=(0.394896,'amu*angstrom^2'), symmetry=1, barrier=(20.6257,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.41187,'amu*angstrom^2'), symmetry=1, barrier=(32.4618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41243,'amu*angstrom^2'), symmetry=1, barrier=(32.4745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55663,0.0435114,-2.65475e-05,-1.0164e-08,1.06148e-11,-13240.1,17.0445], Tmin=(100,'K'), Tmax=(934.407,'K')), NASAPolynomial(coeffs=[17.6999,0.000332184,1.1476e-06,-2.28856e-10,1.19215e-14,-17388.8,-65.799], Tmin=(934.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Ct-CtOs) + group(Ct-CtH) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = 'C=[C]O[C](O)F(3523)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14035,0.0506991,-5.2958e-05,2.59856e-08,-4.76437e-12,-15500.4,24.8658], Tmin=(100,'K'), Tmax=(1510.94,'K')), NASAPolynomial(coeffs=[16.2526,0.00425401,-4.58348e-07,1.49937e-12,1.5205e-15,-19332.4,-51.8478], Tmin=(1510.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sO2sO2s) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC([O])F(3524)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18644,'amu*angstrom^2'), symmetry=1, barrier=(27.2786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18343,'amu*angstrom^2'), symmetry=1, barrier=(27.2094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4829,0.0413857,-7.01708e-06,-3.66875e-08,2.15874e-11,-8691.21,20.2561], Tmin=(100,'K'), Tmax=(920.12,'K')), NASAPolynomial(coeffs=[19.6934,-0.00119986,2.77278e-06,-5.73274e-10,3.53766e-14,-13590.9,-74.4975], Tmin=(920.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.1245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sO2sH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]OC(=O)F(3525)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {4,S} {6,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21157,0.0557523,-6.12476e-05,2.7786e-08,-3.36482e-12,-10588.1,22.8227], Tmin=(100,'K'), Tmax=(942.335,'K')), NASAPolynomial(coeffs=[16.4159,0.00454031,-9.42491e-07,1.30296e-10,-9.36356e-15,-14045.3,-52.766], Tmin=(942.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.9113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]O[CH]OF(3527)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (223.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,272.885,272.928,272.935,272.964],'cm^-1')),
        HinderedRotor(inertia=(0.384111,'amu*angstrom^2'), symmetry=1, barrier=(20.3295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384714,'amu*angstrom^2'), symmetry=1, barrier=(20.3286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385019,'amu*angstrom^2'), symmetry=1, barrier=(20.3287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.795526,0.0623794,-7.74698e-05,4.43582e-08,-9.48857e-12,26978.7,23.3534], Tmin=(100,'K'), Tmax=(1251.35,'K')), NASAPolynomial(coeffs=[18.1422,0.00217297,4.02147e-07,-1.66571e-10,1.37109e-14,23009.8,-62.7358], Tmin=(1251.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C](F)OC=O(3528)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {6,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18382,0.0442994,-5.27668e-05,3.95073e-08,-1.30514e-11,-27128.9,21.4213], Tmin=(100,'K'), Tmax=(716.535,'K')), NASAPolynomial(coeffs=[5.5732,0.0253774,-1.31534e-05,2.64897e-09,-1.90813e-13,-27614.6,6.19949], Tmin=(716.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(131)', '[C]=C(2065)'],
    products = ['C=[C]OC([O])F(3287)'],
    transitionState = 'TS2',
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.37991,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C=[C]OC([O])F(3287)'],
    products = ['C=[C]O[C](O)F(3523)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC([O])F(3287)'],
    products = ['[CH2][C](F)OC=O(3528)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(161.782,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1244',
    isomers = [
        'C=[C]OC([O])F(3287)',
    ],
    reactants = [
