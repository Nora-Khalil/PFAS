...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21887,0.0429884,-6.4383e-05,5.28624e-08,-1.76144e-11,-3398.56,17.657], Tmin=(100,'K'), Tmax=(731.66,'K')), NASAPolynomial(coeffs=[7.23339,0.015575,-8.18445e-06,1.6581e-09,-1.19248e-13,-4132.38,-4.96866], Tmin=(731.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.7609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (85.5534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,440.503,440.942,441.136,441.798,1543.59,1544.3,1545.1,2721.74],'cm^-1')),
        HinderedRotor(inertia=(0.0711605,'amu*angstrom^2'), symmetry=1, barrier=(9.7942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69058,0.0316665,-3.93507e-05,2.94437e-08,-9.34125e-12,10334.2,15.9048], Tmin=(100,'K'), Tmax=(755.755,'K')), NASAPolynomial(coeffs=[5.70137,0.0157305,-7.72002e-06,1.54039e-09,-1.10581e-13,9879.18,2.22275], Tmin=(755.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.5534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(2699)'],
    products = ['[CH]=C(F)C(F)F(1067)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(2700)'],
    products = ['[CH]=C(F)C(F)F(1067)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(F)=C(F)F(1115)'],
    products = ['[CH]=C(F)C(F)F(1067)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(106)', 'C#C[CH]F(2701)'],
    products = ['[CH]=C(F)C(F)F(1067)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'C#C[C](F)F(2702)'],
    products = ['[CH]=C(F)C(F)F(1067)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)F(1067)'],
    products = ['C=C(F)[C](F)F(2703)'],
