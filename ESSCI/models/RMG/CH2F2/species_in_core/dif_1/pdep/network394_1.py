...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(971)'],
    products = ['O=C(O)C(=O)OF(961)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(976)'],
    products = ['O=C(O)C(=O)OF(961)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(978)'],
    products = ['O=C(O)C(=O)OF(961)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(156)', 'O=[C]C(=O)O(979)'],
    products = ['O=C(O)C(=O)OF(961)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(192)', 'O=[C]O(191)'],
    products = ['O=C(O)C(=O)OF(961)'],
