...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05628,0.0721181,-0.000109283,1.00004e-07,-3.74367e-11,-69818.9,29.1484], Tmin=(100,'K'), Tmax=(759.96,'K')), NASAPolynomial(coeffs=[6.12714,0.0357847,-1.85353e-05,3.69875e-09,-2.62942e-13,-70311.2,7.9084], Tmin=(759.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]CC(F)F(1346)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]C[C](F)F(1342)'],
    products = ['F[C](F)CC[C](F)F(1311)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[CH2]C[C](F)F(1342)'],
    products = ['F[C](F)CC[C](F)F(1311)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)CC[C](F)F(1311)'],
    products = ['F[C](F)C[CH]C(F)F(1345)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(5.53672e+09,'s^-1'), n=1.1815, Ea=(180.499,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2H_S;C_rad_out_noH;Cs_H_out_H/NonDeC]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)CC[C](F)F(1311)'],
    products = ['F[C](F)[CH]CC(F)F(1346)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(6.03896e+07,'s^-1'), n=1.33047, Ea=(122.357,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3H_SS_Cs;C_rad_out_noH;XH_out]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: intra_H_migration"""),
)
