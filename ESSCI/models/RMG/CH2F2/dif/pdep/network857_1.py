...
"""),
    E0 = (-579.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,435,565,619,662,854,1178,1396,90,150,250,247,323,377,431,433,1065,1274],'cm^-1')),
        HinderedRotor(inertia=(0.457081,'amu*angstrom^2'), symmetry=1, barrier=(10.5092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0615947,0.0948668,-0.000159595,1.38624e-07,-4.75087e-11,-69563.1,27.1029], Tmin=(100,'K'), Tmax=(781.473,'K')), NASAPolynomial(coeffs=[11.8709,0.0269599,-1.49308e-05,2.99509e-09,-2.1176e-13,-71181,-25.5005], Tmin=(781.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsFFOO) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-530.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,482,586,761,1411,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1136,0.094204,-0.000160776,1.41443e-07,-4.87068e-11,-63708.6,30.4487], Tmin=(100,'K'), Tmax=(805.3,'K')), NASAPolynomial(coeffs=[11.2406,0.0274245,-1.49478e-05,2.96899e-09,-2.08279e-13,-65127.5,-18.5055], Tmin=(805.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFHOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C(F)(F)OC[C](F)F(1994)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-837.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,190,488,555,1236,1407,243.454,243.743,244.048,2241.31],'cm^-1')),
        HinderedRotor(inertia=(0.260833,'amu*angstrom^2'), symmetry=1, barrier=(10.962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260924,'amu*angstrom^2'), symmetry=1, barrier=(10.9577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.712605,'amu*angstrom^2'), symmetry=1, barrier=(30.1555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.470715,0.0841362,-0.000126963,9.98129e-08,-3.13321e-11,-100559,28.3829], Tmin=(100,'K'), Tmax=(779.894,'K')), NASAPolynomial(coeffs=[11.9879,0.0250609,-1.3332e-05,2.67173e-09,-1.90406e-13,-102355,-24.3169], Tmin=(779.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-837.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-688.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,493,600,700,1144,1293,270.371,270.423,270.425,2431.89],'cm^-1')),
        HinderedRotor(inertia=(0.143037,'amu*angstrom^2'), symmetry=1, barrier=(7.4237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142795,'amu*angstrom^2'), symmetry=1, barrier=(7.42123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591474,'amu*angstrom^2'), symmetry=1, barrier=(30.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920822,0.0749088,-0.00012498,1.11465e-07,-3.93329e-11,-82714.6,26.8983], Tmin=(100,'K'), Tmax=(784.18,'K')), NASAPolynomial(coeffs=[8.95892,0.0252835,-1.35591e-05,2.71639e-09,-1.92399e-13,-83710.1,-8.23592], Tmin=(784.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'FOC(F)(F)O[CH][C](F)F(1995)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.658633,0.113843,-0.000207238,1.83946e-07,-6.25666e-11,-94026.5,32.3098], Tmin=(100,'K'), Tmax=(834.726,'K')), NASAPolynomial(coeffs=[13.8081,0.0255778,-1.45879e-05,2.89883e-09,-2.01564e-13,-95781.8,-30.9177], Tmin=(834.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-783.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-838.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,482,664,788,1296,1923,268.341,269.307,269.745,953.81],'cm^-1')),
        HinderedRotor(inertia=(0.00235049,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239481,'amu*angstrom^2'), symmetry=1, barrier=(12.4147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.762317,'amu*angstrom^2'), symmetry=1, barrier=(38.8086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35595,0.0635139,-8.27953e-05,5.79143e-08,-1.65735e-11,-100709,24.2852], Tmin=(100,'K'), Tmax=(844.182,'K')), NASAPolynomial(coeffs=[9.67979,0.0240745,-1.27193e-05,2.5761e-09,-1.86009e-13,-102114,-14.4629], Tmin=(844.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-838.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(COFOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.584833,0.109875,-0.000186043,1.59443e-07,-5.35246e-11,-118378,31.2086], Tmin=(100,'K'), Tmax=(795.74,'K')), NASAPolynomial(coeffs=[14.1046,0.0276323,-1.51741e-05,3.02114e-09,-2.12229e-13,-120450,-34.6318], Tmin=(795.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-985.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H))"""),
)

species(
    label = '[O]C(F)(F)OCC(F)(F)F(1998)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363451,0.0861212,-0.000114733,7.88193e-08,-2.17286e-11,-153173,27.7423], Tmin=(100,'K'), Tmax=(882.121,'K')), NASAPolynomial(coeffs=[13.3936,0.0270354,-1.42595e-05,2.88573e-09,-2.08309e-13,-155472,-33.486], Tmin=(882.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1274.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = 'FO[C](F)OCC(F)(F)F(1999)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-968.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,482,586,761,1411,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.041884,0.0967329,-0.000150347,1.22722e-07,-4.0097e-11,-116320,29.9827], Tmin=(100,'K'), Tmax=(749.431,'K')), NASAPolynomial(coeffs=[12.5302,0.0296256,-1.60192e-05,3.21939e-09,-2.29358e-13,-118204,-27.0429], Tmin=(749.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-968.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFHOO) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)OC[C](F)F(1930)'],
    products = ['HF(38)', 'CF2O(48)', 'O=C[C](F)F(1089)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(26.6929,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]COC(F)(F)OF(1991)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[CH2]OC(F)(F)OF(524)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)OF(424)', 'CH2CF2(56)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(11.7761,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'FOC(F)(F)OC=C(F)F(1992)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FO[C](F)OC[C](F)F(1993)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)(F)OC[C](F)F(1994)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(9.44191,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(424)', '[CH2][C](F)F(1124)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(228)', 'F[C](F)CO[C](F)F(1175)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]COC(F)(F)OF-2(1996)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]OC(F)(F)OF(524)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(1.99143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction15',
    reactants = ['FOC(F)(F)OC[C](F)F(1930)'],
    products = ['FOC(F)(F)O[CH]C(F)F(1997)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FOC(F)(F)OC[C](F)F(1930)'],
    products = ['[O]C(F)(F)OCC(F)(F)F(1998)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(78.623,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)OCC(F)(F)F(1999)'],
    products = ['FOC(F)(F)OC[C](F)F(1930)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.40964e+08,'s^-1'), n=1.42748, Ea=(199.024,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 3.0"""),
)

network(
    label = 'PDepNetwork #857',
    isomers = [
        'FOC(F)(F)OC[C](F)F(1930)',
    ],
    reactants = [
