...
"""),
    E0 = (-454.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,336.478,336.478,336.478,336.478,336.478,861.823],'cm^-1')),
        HinderedRotor(inertia=(0.0138007,'amu*angstrom^2'), symmetry=1, barrier=(28.0593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0138007,'amu*angstrom^2'), symmetry=1, barrier=(28.0593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48898,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99044,0.0417459,-3.58035e-05,1.51651e-08,-2.57812e-12,-54570.1,18.7214], Tmin=(100,'K'), Tmax=(1391.48,'K')), NASAPolynomial(coeffs=[11.3021,0.0149782,-6.94816e-06,1.34023e-09,-9.42737e-14,-57161.5,-29.2782], Tmin=(1391.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-454.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-285.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,412.768],'cm^-1')),
        HinderedRotor(inertia=(0.0589866,'amu*angstrom^2'), symmetry=1, barrier=(7.13393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229425,'amu*angstrom^2'), symmetry=1, barrier=(27.7274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-103.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,2950,3100,1380,975,1025,1650,361.905,371.878],'cm^-1')),
        HinderedRotor(inertia=(0.0635624,'amu*angstrom^2'), symmetry=1, barrier=(5.94683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203631,'amu*angstrom^2'), symmetry=1, barrier=(19.6248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147825,'amu*angstrom^2'), symmetry=1, barrier=(14.3476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
...
"""),
    E0 = (-30.7115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,180,180,1641.3,1648.63],'cm^-1')),
        HinderedRotor(inertia=(0.171611,'amu*angstrom^2'), symmetry=1, barrier=(3.94568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171887,'amu*angstrom^2'), symmetry=1, barrier=(3.95201,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92775,0.0578198,-0.000113593,1.20527e-07,-4.71747e-11,-3630.97,22.3144], Tmin=(100,'K'), Tmax=(844.507,'K')), NASAPolynomial(coeffs=[0.779662,0.0336329,-1.80135e-05,3.53672e-09,-2.45381e-13,-2380.65,33.9138], Tmin=(844.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.7115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[CH]OF(2110)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-72.6942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,180,2048.85],'cm^-1')),
        HinderedRotor(inertia=(0.00711341,'amu*angstrom^2'), symmetry=1, barrier=(21.2866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.914318,'amu*angstrom^2'), symmetry=1, barrier=(21.022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474632,'amu*angstrom^2'), symmetry=1, barrier=(10.9199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39852,0.0636936,-0.000108821,9.72303e-08,-3.37843e-11,-8655.66,24.2514], Tmin=(100,'K'), Tmax=(825.503,'K')), NASAPolynomial(coeffs=[8.04534,0.0206154,-1.0792e-05,2.11048e-09,-1.46616e-13,-9382.65,-4.29755], Tmin=(825.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.6942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.980426,'amu*angstrom^2'), symmetry=1, barrier=(22.5419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980394,'amu*angstrom^2'), symmetry=1, barrier=(22.5412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980963,'amu*angstrom^2'), symmetry=1, barrier=(22.5543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.276712,0.0687679,-8.88608e-05,5.08479e-08,-1.05578e-11,-44928.6,20.6877], Tmin=(100,'K'), Tmax=(1378.37,'K')), NASAPolynomial(coeffs=[20.819,-0.00376873,4.14051e-06,-9.35539e-10,6.80903e-14,-49363.9,-80.5556], Tmin=(1378.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-345.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,180,180,704.724,704.744,704.76,704.803],'cm^-1')),
        HinderedRotor(inertia=(0.00834498,'amu*angstrom^2'), symmetry=1, barrier=(2.94167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00834075,'amu*angstrom^2'), symmetry=1, barrier=(2.94024,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53281,0.0284229,-1.94174e-05,6.58115e-09,-8.99584e-13,-41451.6,17.3916], Tmin=(100,'K'), Tmax=(1695.15,'K')), NASAPolynomial(coeffs=[9.47927,0.0120315,-4.91307e-06,8.76889e-10,-5.83222e-14,-43806.6,-19.7872], Tmin=(1695.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-45.3097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1855,455,950,216.004],'cm^-1')),
        HinderedRotor(inertia=(0.265908,'amu*angstrom^2'), symmetry=1, barrier=(8.62985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58661,'amu*angstrom^2'), symmetry=1, barrier=(19.655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-228.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,510.813,510.815,510.821,510.825,510.832,510.833,510.857],'cm^-1')),
        HinderedRotor(inertia=(0.000646057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000646059,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7984,0.0320512,-1.23478e-05,-3.41577e-08,4.00813e-11,-27460.8,16.0808], Tmin=(100,'K'), Tmax=(448.406,'K')), NASAPolynomial(coeffs=[4.35854,0.0252448,-1.33663e-05,2.72207e-09,-1.97617e-13,-27672.2,9.00817], Tmin=(448.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OCOF(1963)'],
    products = ['O=C(O)COF(2097)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(154)', '[CH2]C(=O)O(1776)'],
    products = ['O=C(O)COF(2097)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(189)', '[CH2]OF(1634)'],
    products = ['O=C(O)COF(2097)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(1396)'],
    products = ['O=C(O)COF(2097)'],
