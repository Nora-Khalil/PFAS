...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44979,0.0552255,-7.2225e-05,4.75079e-08,-1.20778e-11,9925.17,18.6759], Tmin=(100,'K'), Tmax=(974.114,'K')), NASAPolynomial(coeffs=[12.2902,0.0107108,-3.67703e-06,5.93874e-10,-3.74045e-14,7813.26,-33.3381], Tmin=(974.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.7527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(C=C(C)OJ) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97352,0.0346154,-7.55873e-06,-2.17373e-08,1.24563e-11,22131.8,15.8169], Tmin=(100,'K'), Tmax=(962.134,'K')), NASAPolynomial(coeffs=[14.3551,0.00713265,-2.1175e-06,4.10767e-10,-3.32411e-14,18638.8,-49.2099], Tmin=(962.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(CsCCl_triplet)"""),
)

species(
    label = 'O=C1[CH][C](F)C1(4061)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {5,D}
...
"""),
    E0 = (94.8537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2175,525,239,401,1367,376.493,376.499],'cm^-1')),
        HinderedRotor(inertia=(0.205534,'amu*angstrom^2'), symmetry=1, barrier=(20.6748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0563,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04877,0.0428416,-4.78588e-05,2.71649e-08,-6.11693e-12,11478.6,16.9619], Tmin=(100,'K'), Tmax=(1079.55,'K')), NASAPolynomial(coeffs=[10.254,0.01244,-5.61769e-06,1.0799e-09,-7.63732e-14,9707,-23.2519], Tmin=(1079.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.8537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12679,0.056002,-6.74615e-05,3.87347e-08,-8.33393e-12,15150.1,21.2425], Tmin=(100,'K'), Tmax=(1266.81,'K')), NASAPolynomial(coeffs=[15.5944,0.00477559,-2.40554e-07,-9.56174e-11,1.08721e-14,11929.5,-50.221], Tmin=(1266.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[CH]=C(O)C=[C]F(4066)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.954881,'amu*angstrom^2'), symmetry=1, barrier=(21.9546,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.89221,0.0641492,-8.65325e-05,5.47252e-08,-1.30079e-11,23092.9,19.5761], Tmin=(100,'K'), Tmax=(1109,'K')), NASAPolynomial(coeffs=[16.5576,0.0040182,-2.93758e-07,-6.65843e-11,8.73832e-15,19841.4,-56.6152], Tmin=(1109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P) + radical(Cdj(Cd-CdH)(F1s))"""),
)

species(
    label = '[CH]=C([O])C=CF(4067)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {4,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28435,0.0533149,-6.21072e-05,3.51376e-08,-7.53013e-12,8899.81,19.7414], Tmin=(100,'K'), Tmax=(1241.25,'K')), NASAPolynomial(coeffs=[14.6734,0.00656139,-1.24908e-06,1.10234e-10,-3.81563e-15,5853.81,-46.6274], Tmin=(1241.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.1384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = 'O=[C]CC=[C]F(3331)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,D}
3 C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (125.149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1855,455,950,167,640,1190,518.664],'cm^-1')),
        HinderedRotor(inertia=(0.0629313,'amu*angstrom^2'), symmetry=1, barrier=(12.1725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0608538,'amu*angstrom^2'), symmetry=1, barrier=(12.1524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19312,0.0366744,-2.68943e-05,8.90158e-09,-1.15287e-12,15119.2,20.3279], Tmin=(100,'K'), Tmax=(1799.51,'K')), NASAPolynomial(coeffs=[13.3938,0.0117775,-6.14142e-06,1.21331e-09,-8.47761e-14,11088.1,-40.2897], Tmin=(1799.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75633,0.0334708,1.84089e-05,-6.41259e-08,3.21123e-11,3766.92,12.529], Tmin=(100,'K'), Tmax=(902.144,'K')), NASAPolynomial(coeffs=[18.9841,-0.000282148,3.64372e-06,-8.31134e-10,5.58601e-14,-1076.35,-78.4264], Tmin=(902.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(C=CCJCO) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'CC([O])=C=[C]F(4070)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.671453,'amu*angstrom^2'), symmetry=1, barrier=(15.438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88474,0.0471982,-5.63709e-05,3.61332e-08,-9.24244e-12,12576.9,19.3407], Tmin=(100,'K'), Tmax=(954.839,'K')), NASAPolynomial(coeffs=[9.50399,0.0152798,-6.22874e-06,1.12406e-09,-7.62095e-14,11121.9,-17.0657], Tmin=(954.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=C(C)OJ) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C=C[C]F(2867)'],
    products = ['C=C([O])C=[C]F(3329)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(66)', 'O=C=C[C]F(1103)'],
    products = ['C=C([O])C=[C]F(3329)'],
