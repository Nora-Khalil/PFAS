...
"""),
    E0 = (209.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357],'cm^-1')),
        HinderedRotor(inertia=(0.406222,'amu*angstrom^2'), symmetry=1, barrier=(9.33984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94638,0.0252443,-3.64305e-05,2.70906e-08,-8.00056e-12,25225.4,12.0644], Tmin=(100,'K'), Tmax=(828.363,'K')), NASAPolynomial(coeffs=[6.68719,0.00718076,-3.72124e-06,7.66299e-10,-5.59274e-14,24605.7,-5.27847], Tmin=(828.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C#CO(2779)'],
    products = ['[CH]=C(O)F(1882)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(49.0896,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=[C]O(2780)'],
    products = ['[CH]=C(O)F(1882)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]C(=O)F-2(2781)'],
    products = ['[CH]=C(O)F(1882)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(6.87347,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'HCCO(68)'],
    products = ['[CH]=C(O)F(1882)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.80335e-09,'m^3/(mol*s)'), n=4.28272, Ea=(149.87,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)F(1882)'],
    products = ['CH2CFO(107)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O[C]=CF(2463)'],
    products = ['[CH]=C(O)F(1882)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(146.083,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #742',
    isomers = [
        '[CH]=C(O)F(1882)',
    ],
    reactants = [
