...
"""),
    E0 = (-784.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,402.829,402.834,402.847],'cm^-1')),
        HinderedRotor(inertia=(0.18087,'amu*angstrom^2'), symmetry=1, barrier=(20.8282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180874,'amu*angstrom^2'), symmetry=1, barrier=(20.8282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180876,'amu*angstrom^2'), symmetry=1, barrier=(20.8282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78112,0.0311169,2.222e-05,-6.75947e-08,3.26373e-11,-94272.8,20.2583], Tmin=(100,'K'), Tmax=(924.088,'K')), NASAPolynomial(coeffs=[20.3399,-0.00341434,3.92486e-06,-7.59655e-10,4.52999e-14,-99658.4,-78.3932], Tmin=(924.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-784.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(COFOO)"""),
)
...
"""),
    E0 = (-373.535,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,451,553,637,1069,1180,1265,1301,3056,3025,407.5,1350,352.5,180.335,495.102,499.553],'cm^-1')),
        HinderedRotor(inertia=(0.0869741,'amu*angstrom^2'), symmetry=1, barrier=(2.00763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.065122,'amu*angstrom^2'), symmetry=1, barrier=(11.5884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486829,'amu*angstrom^2'), symmetry=1, barrier=(11.5439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54871,0.0547493,-7.16599e-05,4.71445e-08,-1.21154e-11,-44838.3,21.7924], Tmin=(100,'K'), Tmax=(957.646,'K')), NASAPolynomial(coeffs=[11.6803,0.0124305,-5.37442e-06,9.99831e-10,-6.90542e-14,-46778.8,-26.6484], Tmin=(957.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsFHOO) + group(Cs-OsOsHH) + radical(O2sj(Cs-F1sO2sH)) + radical(OCJO)"""),
)

species(
    label = 'O[CH]O[C](O)F(2124)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    E0 = (-424.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3025,407.5,1350,352.5,482,586,761,1411,180,584.464,586.144],'cm^-1')),
        HinderedRotor(inertia=(0.134901,'amu*angstrom^2'), symmetry=1, barrier=(3.10163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99297,'amu*angstrom^2'), symmetry=1, barrier=(22.8303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.594667,'amu*angstrom^2'), symmetry=1, barrier=(13.6726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.054574,'amu*angstrom^2'), symmetry=1, barrier=(13.7016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25515,0.0595049,-7.91741e-05,5.06819e-08,-1.24546e-11,-50924.1,23.1794], Tmin=(100,'K'), Tmax=(1008.15,'K')), NASAPolynomial(coeffs=[14.0761,0.00863589,-3.48765e-06,6.32259e-10,-4.33298e-14,-53509.1,-38.7782], Tmin=(1008.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCJO) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[O]COC([O])F(2125)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-335.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,451,553,637,1069,1180,1265,1301,3056,180,542.269,1356.05,1356.27],'cm^-1')),
        HinderedRotor(inertia=(1.01014,'amu*angstrom^2'), symmetry=1, barrier=(23.2251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01007,'amu*angstrom^2'), symmetry=1, barrier=(23.2235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97601,0.0375871,-2.23531e-05,7.57926e-10,2.42755e-12,-40224.2,20.9437], Tmin=(100,'K'), Tmax=(1086.64,'K')), NASAPolynomial(coeffs=[11.9858,0.0131726,-5.8129e-06,1.13925e-09,-8.25576e-14,-43133.5,-31.5568], Tmin=(1086.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCOJ) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[O]CO[C](O)F(2126)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-385.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,482,586,761,1411,434.731,434.774,434.863,434.891],'cm^-1')),
        HinderedRotor(inertia=(0.000891891,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21335,'amu*angstrom^2'), symmetry=1, barrier=(28.6115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213226,'amu*angstrom^2'), symmetry=1, barrier=(28.612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74849,0.0415639,-2.71682e-05,8.79507e-10,3.48995e-12,-46312.7,22.094], Tmin=(100,'K'), Tmax=(1033.64,'K')), NASAPolynomial(coeffs=[13.9302,0.0101342,-4.35777e-06,8.72903e-10,-6.51846e-14,-49670.3,-41.1385], Tmin=(1033.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCOJ) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    E0 = (-365.578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1855,455,950,309.614,310.034],'cm^-1')),
        HinderedRotor(inertia=(0.397743,'amu*angstrom^2'), symmetry=1, barrier=(27.0388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39843,'amu*angstrom^2'), symmetry=1, barrier=(27.0381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396427,'amu*angstrom^2'), symmetry=1, barrier=(27.0395,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14938,0.0247006,2.63271e-05,-6.70106e-08,3.1804e-11,-43887.4,16.8767], Tmin=(100,'K'), Tmax=(915.159,'K')), NASAPolynomial(coeffs=[18.2548,-0.00375966,4.24317e-06,-8.54004e-10,5.39046e-14,-48591.2,-68.9888], Tmin=(915.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-365.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.438873,'amu*angstrom^2'), symmetry=1, barrier=(20.1129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837954,'amu*angstrom^2'), symmetry=1, barrier=(38.3801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-557.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,459.06,459.694,460.225,460.424],'cm^-1')),
        HinderedRotor(inertia=(0.000796949,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28115,'amu*angstrom^2'), symmetry=1, barrier=(41.9514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(136)', 'CH2OH(81)'],
    products = ['O=C(F)OCO(2099)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', '[CH2]OC(=O)F(1641)'],
    products = ['O=C(F)OCO(2099)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(1405)'],
    products = ['O=C(F)OCO(2099)'],
