...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C(F)(F)[CH]F(918)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(736)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(497)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(955)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C[C](F)F(500)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]C(F)(F)[CH]F(918)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(86)', 'F[C](F)C[C](F)F(736)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(956)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(952)'],
    products = ['F[CH]C(F)(F)C[C](F)F(805)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(805)'],
    products = ['F[CH][C](F)CC(F)(F)F(957)'],
