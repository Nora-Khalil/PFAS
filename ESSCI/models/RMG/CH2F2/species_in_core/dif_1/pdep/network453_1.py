...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(=O)OF(1190)'],
    products = ['HF(38)', 'CO2(13)', 'CH2CF2(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(32.3528,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'CC(F)(F)OF(1212)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(87)', 'O=C([C]F)OF(814)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(169.405,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(74)', 'O=C(OF)C(F)F(1198)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(577)', 'CC(F)=C=O(1245)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1248)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1249)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1250)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1251)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(156)', 'CC(F)(F)[C]=O(1252)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(69)', 'O=C(OF)[C](F)F(822)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(192)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(1206)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(1210)'],
    products = ['CC(F)(F)C(=O)OF(1190)'],
