...
"""),
    E0 = (-663.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,2782.5,750,1395,475,1775,1000,227.442,227.484,1277.35],'cm^-1')),
        HinderedRotor(inertia=(0.971296,'amu*angstrom^2'), symmetry=1, barrier=(35.7057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669333,'amu*angstrom^2'), symmetry=1, barrier=(24.58,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973371,'amu*angstrom^2'), symmetry=1, barrier=(35.7063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90833,0.0471286,-4.38577e-05,2.00566e-08,-3.72307e-12,-79708.9,19.8047], Tmin=(100,'K'), Tmax=(1265.97,'K')), NASAPolynomial(coeffs=[11.1192,0.0180258,-9.37513e-06,1.89806e-09,-1.37193e-13,-82041.1,-26.8049], Tmin=(1265.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-249.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,482,586,761,1411,180,180,207.186,1030.31,1034.09],'cm^-1')),
        HinderedRotor(inertia=(0.0307645,'amu*angstrom^2'), symmetry=1, barrier=(23.1968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00826,'amu*angstrom^2'), symmetry=1, barrier=(23.1818,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-288.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,482,586,761,1411,3025,407.5,1350,352.5,380.84,380.841,380.841,380.841],'cm^-1')),
        HinderedRotor(inertia=(0.138161,'amu*angstrom^2'), symmetry=1, barrier=(14.2199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387364,'amu*angstrom^2'), symmetry=1, barrier=(39.8688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0686929,'amu*angstrom^2'), symmetry=1, barrier=(7.0701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0686929,'amu*angstrom^2'), symmetry=1, barrier=(7.07011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853188,0.0735225,-0.000118351,9.37248e-08,-2.88567e-11,-34573.8,25.1062], Tmin=(100,'K'), Tmax=(802.656,'K')), NASAPolynomial(coeffs=[12.787,0.0140465,-7.1943e-06,1.39358e-09,-9.64972e-14,-36489.4,-29.8431], Tmin=(802.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsFHOO) + group(Cs-OsOsHH) + radical(CsF1sO2sO2s) + radical(OCJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.63183,'amu*angstrom^2'), symmetry=1, barrier=(37.519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63189,'amu*angstrom^2'), symmetry=1, barrier=(37.5203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
...
"""),
    E0 = (-457.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,2782.5,750,1395,475,1775,1000,221.155,1131.99,1409.18],'cm^-1')),
        HinderedRotor(inertia=(1.07293,'amu*angstrom^2'), symmetry=1, barrier=(37.4173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0671,'amu*angstrom^2'), symmetry=1, barrier=(37.4241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07647,'amu*angstrom^2'), symmetry=1, barrier=(37.4155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1909,0.0407083,-3.57658e-05,1.50931e-08,-2.58253e-12,-54920.5,20.9709], Tmin=(100,'K'), Tmax=(1359.32,'K')), NASAPolynomial(coeffs=[10.5825,0.016015,-8.51717e-06,1.72942e-09,-1.24778e-13,-57201.9,-22.0902], Tmin=(1359.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsH) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'O=[C]OC(F)OF(1401)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-466.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,1855,455,950,233.39,234.467,235.841],'cm^-1')),
        HinderedRotor(inertia=(0.720822,'amu*angstrom^2'), symmetry=1, barrier=(28.1111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1674,'amu*angstrom^2'), symmetry=1, barrier=(44.9459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14726,'amu*angstrom^2'), symmetry=1, barrier=(44.8521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66541,0.0551257,-7.21609e-05,4.79986e-08,-1.27859e-11,-56075,19.3165], Tmin=(100,'K'), Tmax=(912.123,'K')), NASAPolynomial(coeffs=[10.4231,0.0167198,-9.00141e-06,1.83523e-09,-1.33097e-13,-57672.6,-22.1286], Tmin=(912.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(F)OF(1386)'],
    products = ['HF(38)', 'CO2(13)', 'CHFO(46)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(13.0105,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)OF(1115)'],
    products = ['O=COC(F)OF(1386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(1399)'],
    products = ['O=COC(F)OF(1386)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(1400)'],
    products = ['O=COC(F)OF(1386)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(179)', '[O]C=O(142)'],
    products = ['O=COC(F)OF(1386)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(156)', 'O=CO[CH]F(716)'],
    products = ['O=COC(F)OF(1386)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(1401)'],
    products = ['O=COC(F)OF(1386)'],
