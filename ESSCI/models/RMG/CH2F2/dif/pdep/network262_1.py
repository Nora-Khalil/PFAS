...
"""),
    E0 = (-296.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,294.045,294.109,2381.14],'cm^-1')),
        HinderedRotor(inertia=(0.00195355,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313956,'amu*angstrom^2'), symmetry=1, barrier=(19.3247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95549,0.0408488,-4.71287e-05,2.49396e-08,-4.8224e-12,-35552.7,16.3981], Tmin=(100,'K'), Tmax=(1043.54,'K')), NASAPolynomial(coeffs=[12.9644,0.00373754,-1.09625e-06,2.02867e-10,-1.53156e-14,-38127.3,-38.5096], Tmin=(1043.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
5 C u0 p0 c0 {1,S} {2,S} {4,S} {6,S}
6 C u2 p0 c0 {3,S} {5,S}
7 H u0 p0 c0 {4,S}
"""),
    E0 = (-535.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,497.19,965.128,3028.04],'cm^-1')),
        HinderedRotor(inertia=(0.000163255,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000167045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03472,0.0467404,-6.75075e-05,4.90269e-08,-1.40701e-11,-64352.5,16.8123], Tmin=(100,'K'), Tmax=(853.349,'K')), NASAPolynomial(coeffs=[9.44492,0.0120063,-6.45351e-06,1.33004e-09,-9.6932e-14,-65617.2,-17.7626], Tmin=(853.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.79906,'amu*angstrom^2'), symmetry=1, barrier=(18.372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798939,'amu*angstrom^2'), symmetry=1, barrier=(18.3692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08184,0.0438232,-5.88366e-05,3.85022e-08,-9.80533e-12,-32280.3,17.0306], Tmin=(100,'K'), Tmax=(965.26,'K')), NASAPolynomial(coeffs=[10.537,0.00878524,-4.38802e-06,8.96773e-10,-6.55991e-14,-33912.6,-23.4618], Tmin=(965.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)(F)F(1003)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'O[C](F)F(239)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'OC(F)(F)[C]F-2(1004)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)=CF(566)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(41.2105,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[C](F)[CH]F(1005)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)[CH]F(401)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[CH]F(1006)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(179.123,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O[C](F)F(239)'],
    products = ['OC(F)(F)[CH]F(572)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC(F)(F)[C]F(506)'],
    products = ['OC(F)(F)[CH]F(572)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(5.61014,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)CF(909)'],
    products = ['OC(F)(F)[CH]F(572)'],
