...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.772094,0.080431,-0.00014071,1.31248e-07,-4.7768e-11,-84628,28.5646], Tmin=(100,'K'), Tmax=(806.316,'K')), NASAPolynomial(coeffs=[7.54574,0.0303115,-1.67462e-05,3.34974e-09,-2.36069e-13,-85183.4,0.673309], Tmin=(806.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'F[C](F)OOC1(F)[CH]O1(3016)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04291,0.0682963,-7.90924e-05,4.58363e-08,-1.06557e-11,-50873.5,26.2031], Tmin=(100,'K'), Tmax=(1037.32,'K')), NASAPolynomial(coeffs=[13.1846,0.0214768,-1.139e-05,2.32529e-09,-1.69296e-13,-53392.5,-32.8186], Tmin=(1037.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFFHO) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    E0 = (-486.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,197,221,431,657,493,600,700,1144,1293,2120,512.5,787.5,180,896.515],'cm^-1')),
        HinderedRotor(inertia=(0.179635,'amu*angstrom^2'), symmetry=1, barrier=(4.13017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00707868,'amu*angstrom^2'), symmetry=1, barrier=(4.08498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32783,'amu*angstrom^2'), symmetry=1, barrier=(53.5214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834875,0.0780062,-0.000136901,1.24817e-07,-4.43742e-11,-58408.2,28.8378], Tmin=(100,'K'), Tmax=(806.856,'K')), NASAPolynomial(coeffs=[8.73826,0.0254168,-1.42072e-05,2.8445e-09,-2.00301e-13,-59247.2,-4.89066], Tmin=(806.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-486.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.475218,0.0887998,-0.000161938,1.50745e-07,-5.35465e-11,-75582.3,28.2684], Tmin=(100,'K'), Tmax=(843.07,'K')), NASAPolynomial(coeffs=[8.1003,0.02971,-1.60396e-05,3.1385e-09,-2.16917e-13,-76053.8,-2.38744], Tmin=(843.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-629.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.89753,'amu*angstrom^2'), symmetry=1, barrier=(43.6279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00414199,'amu*angstrom^2'), symmetry=1, barrier=(11.7259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90256,'amu*angstrom^2'), symmetry=1, barrier=(43.7436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.969965,0.0739153,-0.000126064,1.12846e-07,-3.97462e-11,-23200,26.9671], Tmin=(100,'K'), Tmax=(794.534,'K')), NASAPolynomial(coeffs=[8.9462,0.0239567,-1.32403e-05,2.65042e-09,-1.87036e-13,-24158.1,-7.73187], Tmin=(794.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-549.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,431,527,613,668,835,1199,1245,1322,3010,987.5,1337.5,450,1655,1685,370,242.479,242.492],'cm^-1')),
        HinderedRotor(inertia=(0.368019,'amu*angstrom^2'), symmetry=1, barrier=(15.3553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368003,'amu*angstrom^2'), symmetry=1, barrier=(15.355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972038,'amu*angstrom^2'), symmetry=1, barrier=(40.5627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745039,0.0708785,-8.60048e-05,5.02818e-08,-1.14316e-11,-66024.7,30.7941], Tmin=(100,'K'), Tmax=(1079.21,'K')), NASAPolynomial(coeffs=[16.1192,0.0138955,-6.804e-06,1.35676e-09,-9.80641e-14,-69343.1,-44.5494], Tmin=(1079.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(171)', 'O=C[C]F-2(2705)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]O[C](F)C=O(633)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)OO[C](F)F(3011)'],
    products = ['F[C](F)OOC1(F)[CH]O1(3016)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=C(F)OO[C](F)F(3019)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[C](F)F(171)', 'O=C[C]F(628)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[O]O[C](F)C=O(633)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH]=C(F)OO[C](F)F(3022)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C[C](F)OO[C](F)F(3011)'],
    products = ['[O][CH]C1(F)OOC1(F)F(3024)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O[C]=C(F)OO[C](F)F(3026)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C=[C]OOC(F)(F)F(3028)'],
    products = ['O=C[C](F)OO[C](F)F(3011)'],
...
network(
    label = 'PDepNetwork #1187',
    isomers = [
        'O=C[C](F)OO[C](F)F(3011)',
    ],
    reactants = [
