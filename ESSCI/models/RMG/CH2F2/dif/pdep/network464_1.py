...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.886224,'amu*angstrom^2'), symmetry=1, barrier=(20.376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.886773,'amu*angstrom^2'), symmetry=1, barrier=(20.3887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88803,0.0378875,-2.38148e-05,-4.0783e-09,6.02843e-12,-1020.39,18.7461], Tmin=(100,'K'), Tmax=(989.174,'K')), NASAPolynomial(coeffs=[15.043,0.00385134,-1.25584e-06,2.99144e-10,-2.68223e-14,-4560.25,-49.3139], Tmin=(989.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.17977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.498801,'amu*angstrom^2'), symmetry=1, barrier=(11.4684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498518,'amu*angstrom^2'), symmetry=1, barrier=(11.4619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498648,'amu*angstrom^2'), symmetry=1, barrier=(11.4649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2]O[O](1157)'],
    products = ['[O]OCC(F)F(1299)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[CH]C(F)F(920)'],
    products = ['[O]OCC(F)F(1299)'],
