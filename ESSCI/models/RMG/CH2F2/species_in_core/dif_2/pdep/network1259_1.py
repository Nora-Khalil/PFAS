...
"""),
    E0 = (-382.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,1855,455,950,257.282,257.358,2380.16],'cm^-1')),
        HinderedRotor(inertia=(0.143279,'amu*angstrom^2'), symmetry=1, barrier=(6.72319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.671066,'amu*angstrom^2'), symmetry=1, barrier=(31.5188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143217,'amu*angstrom^2'), symmetry=1, barrier=(6.72026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66704,0.0566507,-8.91071e-05,7.90954e-08,-2.83061e-11,-45950.9,24.1333], Tmin=(100,'K'), Tmax=(773.402,'K')), NASAPolynomial(coeffs=[6.9404,0.0231798,-1.21713e-05,2.41659e-09,-1.70741e-13,-46581.2,1.2457], Tmin=(773.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05371,'amu*angstrom^2'), symmetry=1, barrier=(24.2269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05158,'amu*angstrom^2'), symmetry=1, barrier=(24.1779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.812076,0.054456,-6.06448e-05,3.01848e-08,-5.5001e-12,-48901.2,23.8032], Tmin=(100,'K'), Tmax=(1561.54,'K')), NASAPolynomial(coeffs=[18.5682,-0.000693267,1.61577e-06,-3.59934e-10,2.46782e-14,-53268.1,-66], Tmin=(1561.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1607,0.0434054,4.45468e-06,-5.90639e-08,3.18493e-11,-53721.9,23.1472], Tmin=(100,'K'), Tmax=(919.476,'K')), NASAPolynomial(coeffs=[24.2689,-0.00728725,5.85372e-06,-1.1323e-09,7.09795e-14,-60078,-97.852], Tmin=(919.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[O][C]=COC(F)F(3358)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241857,0.0618543,-6.84754e-05,3.39184e-08,-6.09638e-12,-50640.7,27.3144], Tmin=(100,'K'), Tmax=(1619.9,'K')), NASAPolynomial(coeffs=[20.1049,-0.00101628,2.54159e-06,-5.76252e-10,4.01744e-14,-55262.2,-72.4962], Tmin=(1619.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C[C]=O(1921)'],
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(222)', '[CH2]O[C](F)F(729)'],
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(101.616,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(29.4149,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(2918)'],
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(87)', '[O]C[C]=O(1921)'],
    products = ['O=[C]CO[C](F)F(3302)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(6.21274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['O=[C]CO[C](F)F(3302)'],
    products = ['[O]C=CO[C](F)F(3357)'],
