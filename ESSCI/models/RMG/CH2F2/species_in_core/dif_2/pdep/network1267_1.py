...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.240731,'amu*angstrom^2'), symmetry=1, barrier=(5.53488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240973,'amu*angstrom^2'), symmetry=1, barrier=(5.54043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240847,'amu*angstrom^2'), symmetry=1, barrier=(5.53756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0899896,'amu*angstrom^2'), symmetry=1, barrier=(2.06904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439401,'amu*angstrom^2'), symmetry=1, barrier=(10.1027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.911817,0.0744209,-0.000105464,7.64294e-08,-2.04545e-11,-56157.1,25.95], Tmin=(100,'K'), Tmax=(651.816,'K')), NASAPolynomial(coeffs=[10.4193,0.0250454,-1.2478e-05,2.43461e-09,-1.70891e-13,-57587,-17.3104], Tmin=(651.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24543,0.0656105,-8.16389e-05,5.5112e-08,-1.52638e-11,-83367,22.3878], Tmin=(100,'K'), Tmax=(870.442,'K')), NASAPolynomial(coeffs=[9.90347,0.0258276,-1.30893e-05,2.61536e-09,-1.87707e-13,-84874.4,-18.1818], Tmin=(870.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-308.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,194,682,905,1196,1383,3221,1855,455,950,257.908],'cm^-1')),
        HinderedRotor(inertia=(0.00238554,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25812,'amu*angstrom^2'), symmetry=1, barrier=(12.1867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03987,0.0460021,-3.85314e-05,1.54489e-08,-2.53496e-12,-37042,20.3834], Tmin=(100,'K'), Tmax=(1391.96,'K')), NASAPolynomial(coeffs=[10.9506,0.0203961,-1.09382e-05,2.23347e-09,-1.61461e-13,-39522.7,-25.5526], Tmin=(1391.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-492.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.230314,'amu*angstrom^2'), symmetry=1, barrier=(5.29537,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2962,0.064454,-8.73443e-05,6.33655e-08,-1.86409e-11,-59181.4,25.2349], Tmin=(100,'K'), Tmax=(825.692,'K')), NASAPolynomial(coeffs=[9.88169,0.0228618,-1.17843e-05,2.35716e-09,-1.68776e-13,-60599.2,-14.5406], Tmin=(825.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-492.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
"""),
    E0 = (-186.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,3010,987.5,1337.5,450,1655,234,589,736,816,1240,3237,1855,455,950],'cm^-1')),
        HinderedRotor(inertia=(0.946419,'amu*angstrom^2'), symmetry=1, barrier=(21.76,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95009,'amu*angstrom^2'), symmetry=1, barrier=(21.8444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09362,0.0705839,-0.000119275,1.06039e-07,-3.73675e-11,-22286.9,21.6899], Tmin=(100,'K'), Tmax=(772.993,'K')), NASAPolynomial(coeffs=[9.06398,0.0224754,-1.25992e-05,2.54854e-09,-1.81273e-13,-23314.1,-13.3836], Tmin=(772.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(C=CCJ=O)"""),
)
...
"""),
    E0 = (-479.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,2995,3025,975,1000,1300,1375,400,500,1630,1680,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.938749,'amu*angstrom^2'), symmetry=1, barrier=(21.5837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940502,'amu*angstrom^2'), symmetry=1, barrier=(21.624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.606547,0.067477,-7.13939e-05,3.62361e-08,-7.10077e-12,-57514.7,27.7398], Tmin=(100,'K'), Tmax=(1254.41,'K')), NASAPolynomial(coeffs=[18.0236,0.0119381,-4.9816e-06,9.40632e-10,-6.65003e-14,-61884.4,-60.2355], Tmin=(1254.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)

species(
    label = 'O=[C][CH]C(F)(F)CF(3477)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804019,0.0749451,-0.000108669,8.37564e-08,-2.5755e-11,-61565.1,24.7543], Tmin=(100,'K'), Tmax=(797.001,'K')), NASAPolynomial(coeffs=[11.1329,0.0231022,-1.10901e-05,2.12763e-09,-1.47908e-13,-63211.4,-22.7319], Tmin=(797.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682444,0.0860394,-0.000160833,1.55523e-07,-5.67261e-11,-58202.6,28.2076], Tmin=(100,'K'), Tmax=(849.945,'K')), NASAPolynomial(coeffs=[5.5822,0.0340638,-1.80729e-05,3.51953e-09,-2.42526e-13,-57991,11.5101], Tmin=(849.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[CH]F(3308)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)(F)[CH]F(3306)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'O=[C]C[C](F)F(883)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(222)', '[CH2]C(F)(F)[CH]F(918)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(13.5501,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.28467,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=CC(F)(F)[CH]F(3474)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=[C]C=C(F)[CH]F(3475)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(217.251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CHF(86)', 'O=[C]C[C](F)F(883)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C=CC(F)(F)[CH]F(3476)'],
    products = ['O=[C]CC(F)(F)[CH]F(3308)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]CC(F)(F)[CH]F(3308)'],
    products = ['O=C(F)C[C](F)[CH]F(3478)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(225.576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #1267',
    isomers = [
        'O=[C]CC(F)(F)[CH]F(3308)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CO(75)'),
    ],
