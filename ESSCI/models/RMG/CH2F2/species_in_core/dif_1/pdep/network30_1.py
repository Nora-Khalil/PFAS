...
reaction(
    label = 'reaction3',
    reactants = ['HF(38)', 'CHF(88)'],
    products = ['CH2F2(1)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(9488.44,'cm^3/(mol*s)'), n=2.40423, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.15696, dn = +|- 0.019155, dEa = +|- 0.104241 kJ/molMatched reaction 25 CHF_r1 + FH <=> CH2F2 in 1,2_Insertion_carbene/training
This reaction matched rate rule [HY_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s]
