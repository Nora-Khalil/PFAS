...
"""),
    E0 = (-935.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,262,406,528,622,1148,1246,1368,1480,3164,3240,180,180,1832.24],'cm^-1')),
        HinderedRotor(inertia=(0.245233,'amu*angstrom^2'), symmetry=1, barrier=(5.63839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245368,'amu*angstrom^2'), symmetry=1, barrier=(5.6415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245366,'amu*angstrom^2'), symmetry=1, barrier=(5.64144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00711917,'amu*angstrom^2'), symmetry=1, barrier=(7.89054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.47585,'amu*angstrom^2'), symmetry=1, barrier=(56.9248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98863,0.0718189,-0.000104043,8.01376e-08,-2.47908e-11,-55993.4,22.1801], Tmin=(100,'K'), Tmax=(789.427,'K')), NASAPolynomial(coeffs=[10.551,0.0233674,-1.19813e-05,2.39359e-09,-1.70886e-13,-57503.2,-21.6922], Tmin=(789.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(873)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.230694,0.102689,-0.000175262,1.54655e-07,-5.33143e-11,-113363,32.4193], Tmin=(100,'K'), Tmax=(807.923,'K')), NASAPolynomial(coeffs=[11.7875,0.0300647,-1.60623e-05,3.1862e-09,-2.23531e-13,-114877,-20.3476], Tmin=(807.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'F[CH]C(F)(F)[C](F)F(773)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=CF(871)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.01667,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['F2(77)', 'F[CH]C(F)=C(F)[CH]F(872)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(773)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(719)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(873)'],
