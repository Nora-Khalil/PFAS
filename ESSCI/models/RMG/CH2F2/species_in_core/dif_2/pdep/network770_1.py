...
"""),
    E0 = (-468.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,3000,3100,440,815,1455,1000,232.531,232.889,1730.36],'cm^-1')),
        HinderedRotor(inertia=(0.2343,'amu*angstrom^2'), symmetry=1, barrier=(8.9946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233864,'amu*angstrom^2'), symmetry=1, barrier=(8.99668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.769856,'amu*angstrom^2'), symmetry=1, barrier=(29.5509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17155,0.0679474,-0.000105765,8.99472e-08,-3.08699e-11,-56193,23.4339], Tmin=(100,'K'), Tmax=(734.979,'K')), NASAPolynomial(coeffs=[9.02791,0.0236936,-1.23934e-05,2.48333e-09,-1.76864e-13,-57307.4,-11.7745], Tmin=(734.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27315,0.0671065,-0.000111449,1.01839e-07,-3.67306e-11,-56731.2,23.9528], Tmin=(100,'K'), Tmax=(797.206,'K')), NASAPolynomial(coeffs=[7.21236,0.0262443,-1.37496e-05,2.73197e-09,-1.9263e-13,-57326.6,-1.14968], Tmin=(797.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[C](F)[C](F)F(1930)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-452.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,180,180,1628.02],'cm^-1')),
        HinderedRotor(inertia=(0.236243,'amu*angstrom^2'), symmetry=1, barrier=(5.43169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235736,'amu*angstrom^2'), symmetry=1, barrier=(5.42004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236898,'amu*angstrom^2'), symmetry=1, barrier=(5.44676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40485,0.0671015,-0.000120895,1.19198e-07,-4.49958e-11,-54332.9,24.1407], Tmin=(100,'K'), Tmax=(822.671,'K')), NASAPolynomial(coeffs=[4.4213,0.031178,-1.66362e-05,3.30217e-09,-2.31648e-13,-54109.9,14.5487], Tmin=(822.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]O[CH]C(F)(F)F(1931)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56991,0.0585973,-8.00607e-05,5.77446e-08,-1.55585e-11,-61367.7,23.3377], Tmin=(100,'K'), Tmax=(650.159,'K')), NASAPolynomial(coeffs=[8.61311,0.0218621,-1.05275e-05,2.05213e-09,-1.44497e-13,-62423,-8.68155], Tmin=(650.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = 'FCO[CH][C](F)F(903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18228,0.0689757,-0.000114625,1.03158e-07,-3.65068e-11,-56504,24.7003], Tmin=(100,'K'), Tmax=(805.909,'K')), NASAPolynomial(coeffs=[7.86685,0.0250776,-1.29659e-05,2.55782e-09,-1.79432e-13,-57233.3,-3.94659], Tmin=(805.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(66)', '[O]C(F)[C](F)F(386)'],
    products = ['[CH2]OC(F)[C](F)F(1901)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]O[CH]F(900)'],
    products = ['[CH2]OC(F)[C](F)F(1901)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(1927)'],
    products = ['[CH2]OC(F)[C](F)F(1901)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C(F)F(1928)'],
    products = ['[CH2]OC(F)[C](F)F(1901)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(87)', '[CH2]O[CH]F(900)'],
    products = ['[CH2]OC(F)[C](F)F(1901)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(1901)'],
    products = ['[CH2]O[CH]C(F)(F)F(1931)'],
