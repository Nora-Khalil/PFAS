...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.758628,'amu*angstrom^2'), symmetry=1, barrier=(17.4423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754629,'amu*angstrom^2'), symmetry=1, barrier=(17.3504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10334,'amu*angstrom^2'), symmetry=1, barrier=(25.368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-647.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,580,1155,1237,1373,3147,180,180,1345.66],'cm^-1')),
        HinderedRotor(inertia=(1.08271,'amu*angstrom^2'), symmetry=1, barrier=(24.8936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.665159,'amu*angstrom^2'), symmetry=1, barrier=(15.2933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80784,'amu*angstrom^2'), symmetry=1, barrier=(41.5657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.506078,'amu*angstrom^2'), symmetry=1, barrier=(11.6357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506535,'amu*angstrom^2'), symmetry=1, barrier=(11.6462,'kJ/mol'), semiclassical=False),
...
reaction(
    ...
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.01313,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[CH]OC(F)F(562)'],
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)O[CH]F(563)'],
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(146)', 'O[CH]F(180)'],
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(4)', 'F[CH]OC(F)F(416)'],
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)OC(F)F(509)'],
    products = ['OC(F)OC(F)F(446)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O[C](F)OC(F)F(542)'],
    products = ['OC(F)OC(F)F(446)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC(F)O[C](F)F(557)'],
    products = ['OC(F)OC(F)F(446)'],
