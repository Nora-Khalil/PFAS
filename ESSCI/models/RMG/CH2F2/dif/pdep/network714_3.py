...
"""),
    E0 = (130.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,1415.95,1416.02],'cm^-1')),
        HinderedRotor(inertia=(0.00503023,'amu*angstrom^2'), symmetry=1, barrier=(7.15721,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (64.0158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.29426,0.0369466,-0.000118761,1.55871e-07,-6.65427e-11,15759.1,11.7691], Tmin=(100,'K'), Tmax=(861.479,'K')), NASAPolynomial(coeffs=[-9.34765,0.0386252,-2.24013e-05,4.46987e-09,-3.09971e-13,20053.2,83.1544], Tmin=(861.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (45.0174,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.50212,-0.00152053,5.13299e-05,-8.05967e-08,3.62109e-11,20739.7,7.02936], Tmin=(100,'K'), Tmax=(863.888,'K')), NASAPolynomial(coeffs=[13.0344,-0.0113623,8.87142e-06,-1.87857e-09,1.32471e-13,17813.1,-44.9702], Tmin=(863.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsHH) + ring(dioxirane) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(4)', 'CFO(50)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OF(173)', 'CO(12)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(85.3677,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]C([O])F(131)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=[C]O(164)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.27036e+07,'m^3/(mol*s)'), n=-0.266667, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.03623134627034809, var=1.003233389522121, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_3BrCO->O',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_3BrCO->O"""),
)

reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]C(=O)F(136)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'CO2(13)'],
    products = ['O=C(O)F(134)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.0156067,'cm^3/(mol*s)'), n=4.28272, Ea=(163.976,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 2.45163, dn = +|- 0.117815, dEa = +|- 0.641147 kJ/molMatched reaction 43 HF + CO2 <=> CHFO2 in XY_Addition_MultipleBond/training
This reaction matched rate rule [HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_4COCdCddCtO2d->Cdd]
family: XY_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction10',
    reactants = ['O(6)', '[O][CH]F(127)'],
    products = ['[O]C([O])F(131)'],
    transitionState = 'TS7',
