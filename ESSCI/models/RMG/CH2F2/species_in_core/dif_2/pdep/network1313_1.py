...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.24483,'amu*angstrom^2'), symmetry=1, barrier=(28.6212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24441,'amu*angstrom^2'), symmetry=1, barrier=(28.6115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24961,'amu*angstrom^2'), symmetry=1, barrier=(28.7309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867448,0.0565567,-3.67191e-05,-8.07814e-09,1.11256e-11,-28146.7,22.8795], Tmin=(100,'K'), Tmax=(945.03,'K')), NASAPolynomial(coeffs=[20.6925,0.00301546,5.70572e-08,-1.40352e-11,-4.13172e-15,-33250,-78.8195], Tmin=(945.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'C=COC([O])(F)F(3680)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17367,'amu*angstrom^2'), symmetry=1, barrier=(26.985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17261,'amu*angstrom^2'), symmetry=1, barrier=(26.9605,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07976,0.0484016,-1.06518e-05,-3.79406e-08,2.26041e-11,-64991,21.3205], Tmin=(100,'K'), Tmax=(931.67,'K')), NASAPolynomial(coeffs=[21.7649,5.76855e-05,2.03342e-06,-3.99632e-10,2.12695e-14,-70601.5,-86.4344], Tmin=(931.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-358.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,493,600,700,1144,1293,180,180,1246.18],'cm^-1')),
        HinderedRotor(inertia=(0.465678,'amu*angstrom^2'), symmetry=1, barrier=(10.7069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.82878,'amu*angstrom^2'), symmetry=1, barrier=(19.0553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-433.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2950,3100,1380,975,1025,1650,1685,370,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.05035,'amu*angstrom^2'), symmetry=1, barrier=(24.1497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04821,'amu*angstrom^2'), symmetry=1, barrier=(24.1005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05041,'amu*angstrom^2'), symmetry=1, barrier=(24.1509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.475993,0.0722057,-8.67015e-05,4.86895e-08,-1.04412e-11,-52021.2,25.8902], Tmin=(100,'K'), Tmax=(1154.78,'K')), NASAPolynomial(coeffs=[18.9531,0.00820267,-3.56385e-06,6.92715e-10,-5.01674e-14,-56288.5,-65.91], Tmin=(1154.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC(F)(F)OF(3683)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-426.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.24496,'amu*angstrom^2'), symmetry=1, barrier=(28.6241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24466,'amu*angstrom^2'), symmetry=1, barrier=(28.6172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24489,'amu*angstrom^2'), symmetry=1, barrier=(28.6224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255844,0.0792165,-9.46642e-05,5.07071e-08,-1.00812e-11,-51102.9,25.7936], Tmin=(100,'K'), Tmax=(1360,'K')), NASAPolynomial(coeffs=[24.3668,-0.000507247,1.32246e-06,-2.94226e-10,1.99607e-14,-57124.7,-98.0841], Tmin=(1360,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C[C-]=[O+]C(F)(F)OF(3684)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-318.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.82038,'amu*angstrom^2'), symmetry=1, barrier=(41.8541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81895,'amu*angstrom^2'), symmetry=1, barrier=(41.8213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82035,'amu*angstrom^2'), symmetry=1, barrier=(41.8534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459137,0.0873389,-0.000147862,1.34393e-07,-4.77365e-11,-38206.1,34.7958], Tmin=(100,'K'), Tmax=(819.049,'K')), NASAPolynomial(coeffs=[8.32863,0.0324139,-1.70685e-05,3.34851e-09,-2.33387e-13,-38942,1.77793], Tmin=(819.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsFFOO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COC(F)(F)OF(3685)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-310.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412547,0.0870737,-0.00014616,1.29189e-07,-4.49924e-11,-37179,25.4291], Tmin=(100,'K'), Tmax=(796.525,'K')), NASAPolynomial(coeffs=[10.1054,0.0279364,-1.50922e-05,3.00097e-09,-2.11114e-13,-38391.2,-17.0448], Tmin=(796.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsFFOO) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08303,'amu*angstrom^2'), symmetry=1, barrier=(24.9009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69064,0.0415835,-2.31906e-05,-7.37621e-09,7.60828e-12,-62065.5,18.1032], Tmin=(100,'K'), Tmax=(977.378,'K')), NASAPolynomial(coeffs=[15.2891,0.00698309,-2.39782e-06,4.7906e-10,-3.79967e-14,-65729.2,-52.3342], Tmin=(977.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-516.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(COFOO)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(34.7409,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=CO[C](F)OF(3679)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=COC([O])(F)F(3680)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(712)', 'C2H3(76)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(154)', 'C=CO[C](F)F(3681)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC(F)(F)OF(3682)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=COC(F)(F)OF(3683)'],
    products = ['C=COC(F)(F)OF(3350)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(106)', 'C=COC(=O)F(3522)'],
    products = ['C=COC(F)(F)OF(3350)'],
