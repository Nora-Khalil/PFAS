...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19,0.0346621,-3.10228e-05,1.06717e-08,-5.11854e-13,-28427.3,16.7377], Tmin=(100,'K'), Tmax=(1040.82,'K')), NASAPolynomial(coeffs=[12.0464,0.00571273,-2.17143e-06,4.35013e-10,-3.30334e-14,-30962.7,-33.5316], Tmin=(1040.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-236.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06308,0.0417084,-3.67637e-05,1.54384e-08,-2.58166e-12,-52697.5,21.5788], Tmin=(100,'K'), Tmax=(1411.12,'K')), NASAPolynomial(coeffs=[11.8788,0.0138844,-7.18736e-06,1.46542e-09,-1.06151e-13,-55467.7,-29.1569], Tmin=(1411.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=COJ) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)[CH][C](F)F(765)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-515.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,190,488,555,1236,1407,611,648,830,1210,1753,331.589,1474.02],'cm^-1')),
        HinderedRotor(inertia=(0.146962,'amu*angstrom^2'), symmetry=1, barrier=(11.4629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685302,'amu*angstrom^2'), symmetry=1, barrier=(53.4547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98659,0.0477078,-5.81353e-05,3.68605e-08,-9.44966e-12,-61921.3,21.5871], Tmin=(100,'K'), Tmax=(941.903,'K')), NASAPolynomial(coeffs=[9.3248,0.0165443,-8.50637e-06,1.73364e-09,-1.26213e-13,-63303.6,-13.3762], Tmin=(941.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-515.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJC=O) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.507471,0.0889411,-0.000168675,1.58157e-07,-5.57914e-11,-85023.5,26.5559], Tmin=(100,'K'), Tmax=(857.158,'K')), NASAPolynomial(coeffs=[8.32434,0.0265663,-1.42026e-05,2.76633e-09,-1.89862e-13,-85412.2,-4.4017], Tmin=(857.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-707.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)C(F)F(798)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720069,0.081052,-0.000142751,1.28691e-07,-4.44641e-11,-81997.3,25.3941], Tmin=(100,'K'), Tmax=(846.836,'K')), NASAPolynomial(coeffs=[9.05288,0.0246311,-1.25925e-05,2.43375e-09,-1.67295e-13,-82796.9,-9.8096], Tmin=(846.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sCsH)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)[C](F)[C](F)F(799)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639104,0.0838353,-0.000151454,1.39478e-07,-4.921e-11,-83633.6,26.5999], Tmin=(100,'K'), Tmax=(834.725,'K')), NASAPolynomial(coeffs=[8.75999,0.0261398,-1.40274e-05,2.76627e-09,-1.92458e-13,-84335.1,-7.19258], Tmin=(834.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-696.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(F)[CH][C](F)F(800)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-387.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,3025,407.5,1350,352.5,190,488,555,1236,1407,219.845,223.116,1698.65],'cm^-1')),
        HinderedRotor(inertia=(0.926587,'amu*angstrom^2'), symmetry=1, barrier=(32.9926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311022,'amu*angstrom^2'), symmetry=1, barrier=(11.0851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939362,'amu*angstrom^2'), symmetry=1, barrier=(32.9787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987712,0.0731789,-0.00010896,8.68114e-08,-2.80605e-11,-46466,25.8752], Tmin=(100,'K'), Tmax=(755.443,'K')), NASAPolynomial(coeffs=[9.94253,0.0256118,-1.42088e-05,2.92818e-09,-2.1262e-13,-47814.6,-14.7865], Tmin=(755.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)[CH]C(F)(F)F(801)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870696,0.0739541,-0.000113889,9.11999e-08,-2.89031e-11,-87419.7,24.9451], Tmin=(100,'K'), Tmax=(775.545,'K')), NASAPolynomial(coeffs=[11.2715,0.0203036,-1.01102e-05,1.97933e-09,-1.38986e-13,-89032.8,-22.5878], Tmin=(775.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sF1s)(H))"""),
)

species(
    label = 'FO[CH]C(F)[C](F)F(802)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-367.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,3025,407.5,1350,352.5,190,488,555,1236,1407,216.067,216.962,217.328],'cm^-1')),
        HinderedRotor(inertia=(0.513317,'amu*angstrom^2'), symmetry=1, barrier=(17.1091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390867,'amu*angstrom^2'), symmetry=1, barrier=(13.3197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925565,'amu*angstrom^2'), symmetry=1, barrier=(30.3183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183653,0.0913821,-0.000157047,1.34508e-07,-4.49174e-11,-44099.3,26.3563], Tmin=(100,'K'), Tmax=(792.657,'K')), NASAPolynomial(coeffs=[13.0339,0.020457,-1.13272e-05,2.27583e-09,-1.6065e-13,-45945.5,-31.4482], Tmin=(792.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]C(F)C(F)(F)F(803)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.878058,0.0758793,-0.000124404,1.10903e-07,-3.94703e-11,-86234.4,23.3997], Tmin=(100,'K'), Tmax=(769.174,'K')), NASAPolynomial(coeffs=[8.77724,0.0272042,-1.4666e-05,2.94966e-09,-2.09735e-13,-87224.8,-11.1755], Tmin=(769.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-717.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', '[O]C(F)[CH]F(439)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)[C](F)F(789)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)C=C(F)F(791)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C(F)=C(F)F(792)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(F)[C](F)F(793)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(F)C(F)[C](F)F(650)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(77)', '[O]C=C[C](F)F(794)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]C=C(F)[C](F)F(795)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)[CH][C](F)F(765)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(42)', '[O]C(F)[CH]F(439)'],
    products = ['[O]C(F)C(F)[C](F)F(705)'],
