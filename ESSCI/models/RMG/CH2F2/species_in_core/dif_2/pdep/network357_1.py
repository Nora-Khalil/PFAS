...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]C[C](F)F(968)'],
    products = ['F[C](F)CC[C](F)F(814)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(933)'],
    products = ['F[C](F)CC[C](F)F(814)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(87)', '[CH2]C[C](F)F(968)'],
    products = ['F[C](F)CC[C](F)F(814)'],
    transitionState = 'TS9',
