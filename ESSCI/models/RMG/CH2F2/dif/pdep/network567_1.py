...
"""),
    E0 = (-243.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,180,180,1190.52,1190.79,4000],'cm^-1')),
        HinderedRotor(inertia=(0.69961,'amu*angstrom^2'), symmetry=1, barrier=(16.0854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6323,'amu*angstrom^2'), symmetry=1, barrier=(37.5298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107576,'amu*angstrom^2'), symmetry=1, barrier=(16.0819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37724,0.056845,-6.94132e-05,4.13424e-08,-9.56717e-12,-29195.6,25.2432], Tmin=(100,'K'), Tmax=(1062.43,'K')), NASAPolynomial(coeffs=[13.478,0.0112862,-5.09053e-06,9.80367e-10,-6.95934e-14,-31766.8,-33.8688], Tmin=(1062.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (-188.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([493,600,700,1144,1293,180,180,887.477,887.489,887.523],'cm^-1')),
        HinderedRotor(inertia=(0.117559,'amu*angstrom^2'), symmetry=1, barrier=(2.70292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117522,'amu*angstrom^2'), symmetry=1, barrier=(2.70205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29738,0.0349472,-4.16785e-05,2.29342e-08,-4.55973e-12,-22584,20.7893], Tmin=(100,'K'), Tmax=(964.794,'K')), NASAPolynomial(coeffs=[10.8918,0.00414046,-1.28441e-06,2.0607e-10,-1.36549e-14,-24466.9,-21.5296], Tmin=(964.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(ROOJ) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78053,0.0382795,-3.18412e-06,-3.71286e-08,2.20389e-11,-61219.7,16.2197], Tmin=(100,'K'), Tmax=(874.005,'K')), NASAPolynomial(coeffs=[15.8746,0.00458718,1.76126e-06,-5.66445e-10,4.34909e-14,-64860.1,-56.61], Tmin=(874.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-509.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFFO) + ring(123trioxolane)"""),
)
...
"""),
    E0 = (-39.3724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,180.019,180.148,638.284,638.349,2060.15],'cm^-1')),
        HinderedRotor(inertia=(0.000570037,'amu*angstrom^2'), symmetry=1, barrier=(1.71688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.505881,'amu*angstrom^2'), symmetry=1, barrier=(11.6313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44876,0.0359989,-3.86685e-05,2.30444e-08,-5.69871e-12,-4681.12,21.1195], Tmin=(100,'K'), Tmax=(965.681,'K')), NASAPolynomial(coeffs=[7.31722,0.0158329,-7.34431e-06,1.41936e-09,-1.00283e-13,-5621.39,-2.19792], Tmin=(965.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.3724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (129.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,180,773.77],'cm^-1')),
        HinderedRotor(inertia=(0.00824936,'amu*angstrom^2'), symmetry=1, barrier=(3.51383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0359081,'amu*angstrom^2'), symmetry=1, barrier=(15.2922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00693101,'amu*angstrom^2'), symmetry=1, barrier=(33.3838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45252,'amu*angstrom^2'), symmetry=1, barrier=(33.3963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30084,0.0628072,-8.61927e-05,5.90628e-08,-1.59655e-11,15611.7,26.7443], Tmin=(100,'K'), Tmax=(905.837,'K')), NASAPolynomial(coeffs=[11.9702,0.0156928,-8.17365e-06,1.64267e-09,-1.18093e-13,13678.8,-23.6741], Tmin=(905.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + group(Cs-CsHHH) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)

species(
    label = '[O]OO[C](F)CF(1507)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-202.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,180,180,180,249.248,572.573,2680.4],'cm^-1')),
        HinderedRotor(inertia=(0.0590586,'amu*angstrom^2'), symmetry=1, barrier=(13.7248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0579658,'amu*angstrom^2'), symmetry=1, barrier=(13.7293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185013,'amu*angstrom^2'), symmetry=1, barrier=(43.5121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51246,0.0577285,-7.81589e-05,5.4527e-08,-1.51009e-11,-24256.4,24.6724], Tmin=(100,'K'), Tmax=(883.44,'K')), NASAPolynomial(coeffs=[10.6441,0.0163828,-7.95754e-06,1.55109e-09,-1.09532e-13,-25869.9,-18.2506], Tmin=(883.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OO[O](1491)'],
    products = ['O2(2)', 'FC1(F)CO1(1321)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](911)'],
    products = ['[CH2]C(F)(F)OO[O](1491)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(241)', 'CH2(T)(17)'],
    products = ['[CH2]C(F)(F)OO[O](1491)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OO[O](1505)'],
    products = ['[CH2]C(F)(F)OO[O](1491)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](F)OOOF(1506)'],
    products = ['[CH2]C(F)(F)OO[O](1491)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(61.8895,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]OO[C](F)CF(1507)'],
    products = ['[CH2]C(F)(F)OO[O](1491)'],
