...
"""),
    E0 = (-281.874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,180,180,737.556,738.264,738.285,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.339035,'amu*angstrom^2'), symmetry=1, barrier=(21.6485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.941455,'amu*angstrom^2'), symmetry=1, barrier=(21.6459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25336,0.0404163,-6.17015e-05,4.50954e-08,-1.27422e-11,-33840.5,19.4311], Tmin=(100,'K'), Tmax=(874.574,'K')), NASAPolynomial(coeffs=[9.67821,0.00645665,-3.4548e-06,6.94014e-10,-4.95491e-14,-35139.2,-15.3942], Tmin=(874.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical(OC=OOJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-60.3782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,620.874,889.737,889.738,889.742,1871.83],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.36988,0.0105618,-1.27526e-06,-7.37791e-09,3.82308e-12,-7236.21,10.2409], Tmin=(100,'K'), Tmax=(995.96,'K')), NASAPolynomial(coeffs=[7.17799,0.00288729,-1.19275e-06,2.48508e-10,-1.94617e-14,-8372.67,-10.0128], Tmin=(995.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.3782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), label="""CO3t1""", comment="""Thermo library: primaryThermoLibrary"""),
)
...
"""),
    E0 = (-91.7908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1850,1860,440,470,900,1000,217.925],'cm^-1')),
        HinderedRotor(inertia=(0.366618,'amu*angstrom^2'), symmetry=1, barrier=(12.3323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366091,'amu*angstrom^2'), symmetry=1, barrier=(12.3343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47242,0.0374745,-6.98132e-05,6.12891e-08,-2.02089e-11,-10988.6,15.1737], Tmin=(100,'K'), Tmax=(882.839,'K')), NASAPolynomial(coeffs=[7.43594,0.00673291,-3.55925e-06,6.69616e-10,-4.43926e-14,-11543.3,-6.33247], Tmin=(882.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.7908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)

species(
    label = 'O=C1OC(=O)O1(190)',
...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59643,0.0137868,3.71896e-05,-7.3747e-08,3.30763e-11,-67250.2,18.5298], Tmin=(100,'K'), Tmax=(932.556,'K')), NASAPolynomial(coeffs=[18.5638,-0.0108059,6.14106e-06,-1.07644e-09,6.35058e-14,-72137,-67.6222], Tmin=(932.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-OdOsOs) + group(Cds-OdOsOs) + ring(Cyclobutane)"""),
)

species(
    label = 'O=[C]O[C]1OO1(191)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (88.0189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89912,0.000707709,3.52402e-05,-3.42654e-08,9.27164e-12,-25351.3,14.0332], Tmin=(100,'K'), Tmax=(1303.87,'K')), NASAPolynomial(coeffs=[4.1788,0.0210379,-1.25232e-05,2.61884e-09,-1.9003e-13,-27225.3,5.70313], Tmin=(1303.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsOs) + ring(Cyclobutane) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])OC1=O(193)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {5,S} {6,S}
2 O u1 p2 c0 {5,S}
3 O u1 p2 c0 {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C([O])=O(188)'],
    products = ['[O]C(=O)O[C]=O(183)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C]=O(189)'],
    products = ['[O]C(=O)O[C]=O(183)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3335.46,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [CO_rad/NonDe;O_birad]
...
reaction(
    label = 'reaction8',
    reactants = ['CO(12)', '[O]C([O])=O(188)'],
    products = ['[O]C(=O)O[C]=O(183)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(102.3,'m^3/(mol*s)'), n=8.73864e-09, Ea=(4.6119,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CO2(13)', '[O][C]=O(141)'],
    products = ['[O]C(=O)O[C]=O(183)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(306.062,'m^3/(mol*s)'), n=1.16366, Ea=(122.028,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(141)', '[O][C]=O(141)'],
    products = ['[O]C(=O)O[C]=O(183)'],
