...
"""),
    E0 = (-691.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,580,1155,1237,1373,3147,180,180,180,1399.7],'cm^-1')),
        HinderedRotor(inertia=(0.283775,'amu*angstrom^2'), symmetry=1, barrier=(6.52455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286424,'amu*angstrom^2'), symmetry=1, barrier=(6.58545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96535,'amu*angstrom^2'), symmetry=1, barrier=(45.1873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876307,0.076199,-0.000128041,1.14788e-07,-4.05866e-11,-83011.7,26.4095], Tmin=(100,'K'), Tmax=(791.155,'K')), NASAPolynomial(coeffs=[8.87421,0.0258699,-1.38633e-05,2.77148e-09,-1.95906e-13,-83967.6,-8.34553], Tmin=(791.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.168106,'amu*angstrom^2'), symmetry=1, barrier=(3.8651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789188,'amu*angstrom^2'), symmetry=1, barrier=(18.145,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394436,0.0927979,-0.000181023,1.70523e-07,-5.98016e-11,-84027.7,27.0652], Tmin=(100,'K'), Tmax=(870.893,'K')), NASAPolynomial(coeffs=[8.38915,0.0258757,-1.37387e-05,2.6454e-09,-1.79357e-13,-84274.9,-3.82364], Tmin=(870.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(592)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(474)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(385)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(682)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(86)', 'F[CH]O[C](F)F(385)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(86)', '[O]C(F)(F)[CH]F(474)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(670)'],
    products = ['F[CH]OC(F)(F)[CH]F(592)'],
...
network(
    ...
    isomers = [
        'F[CH]OC(F)(F)[CH]F(592)',
    ],
    reactants = [
        ('CHFO(46)', 'CHFCF2(54)'),
        ('CHF(40)', '[O]C(F)(F)[CH]F(474)'),
        ('CHF(86)', '[O]C(F)(F)[CH]F(474)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
