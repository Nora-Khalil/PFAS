...
"""),
    E0 = (-515.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,261,493,600,1152,1365,1422,3097,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.405085,'amu*angstrom^2'), symmetry=1, barrier=(9.3137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.405035,'amu*angstrom^2'), symmetry=1, barrier=(9.31255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-115.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,461.584,461.596],'cm^-1')),
        HinderedRotor(inertia=(0.0592631,'amu*angstrom^2'), symmetry=1, barrier=(8.96159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217618,'amu*angstrom^2'), symmetry=1, barrier=(32.905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217601,'amu*angstrom^2'), symmetry=1, barrier=(32.9053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-413.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00571165,'amu*angstrom^2'), symmetry=1, barrier=(10.8727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0158,'amu*angstrom^2'), symmetry=1, barrier=(23.3553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.93951,'amu*angstrom^2'), symmetry=1, barrier=(21.6012,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.534965,'amu*angstrom^2'), symmetry=1, barrier=(12.2999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535975,'amu*angstrom^2'), symmetry=1, barrier=(12.3231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.686068,'amu*angstrom^2'), symmetry=1, barrier=(15.7741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235494,'amu*angstrom^2'), symmetry=1, barrier=(5.41447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234896,'amu*angstrom^2'), symmetry=1, barrier=(5.40072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.641109,'amu*angstrom^2'), symmetry=1, barrier=(14.7404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640943,'amu*angstrom^2'), symmetry=1, barrier=(14.7365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)COF(1598)'],
    products = ['HF(38)', 'CHFO(46)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.2092,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]COF(1735)'],
    products = ['OC(F)COF(1598)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(49.8077,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
...
reaction(
    ...
    products = ['OC(F)COF(1598)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(68.7107,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(228)', '[CH2]C(O)F(1754)'],
    products = ['OC(F)COF(1598)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(290)', '[CH2]OF(1527)'],
    products = ['OC(F)COF(1598)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CCOF(1755)'],
    products = ['OC(F)COF(1598)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(153.723,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=CC(O)F(591)'],
    products = ['OC(F)COF(1598)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(447.167,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(255.308,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #671',
    isomers = [
        'OC(F)COF(1598)',
    ],
    reactants = [
