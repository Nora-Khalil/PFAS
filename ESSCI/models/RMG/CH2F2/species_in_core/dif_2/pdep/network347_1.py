species(
    label = '[CH2]C(F)(F)C(F)(F)[CH]F(804)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(66)', 'F[CH]C(F)(F)[C](F)F(473)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[CH]F(958)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=CF(959)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(106)', '[CH2]C(F)=C(F)[CH]F(960)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(86)', '[CH2]C(F)(F)[C](F)F(743)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)[C](F)CF(961)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(962)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][C](F)C(F)(F)CF(963)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(804)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)F(948)'],
...
network(
    label = 'PDepNetwork #347',
    isomers = [
        '[CH2]C(F)(F)C(F)(F)[CH]F(804)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CF2(56)'),
    ],
