...
"""),
    E0 = (-1410.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,193,295,551,588,656,1146,1192,1350,209.18,209.404],'cm^-1')),
        HinderedRotor(inertia=(0.184622,'amu*angstrom^2'), symmetry=1, barrier=(5.73478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184826,'amu*angstrom^2'), symmetry=1, barrier=(5.7368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183784,'amu*angstrom^2'), symmetry=1, barrier=(5.7354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-904.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,329.186],'cm^-1')),
        HinderedRotor(inertia=(0.0908389,'amu*angstrom^2'), symmetry=1, barrier=(6.98536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.090944,'amu*angstrom^2'), symmetry=1, barrier=(6.98421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-600.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,617,898,1187,212.351],'cm^-1')),
        HinderedRotor(inertia=(0.171557,'amu*angstrom^2'), symmetry=1, barrier=(5.59068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242871,'amu*angstrom^2'), symmetry=1, barrier=(5.60507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86504,0.0501051,-5.9346e-05,3.76483e-08,-9.7553e-12,-72109.3,19.6186], Tmin=(100,'K'), Tmax=(929.6,'K')), NASAPolynomial(coeffs=[9.04987,0.0191892,-9.45988e-06,1.87215e-09,-1.33863e-13,-73445.1,-14.5195], Tmin=(929.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsFFF) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-982.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,395,473,707,1436,225.682,231.294],'cm^-1')),
        HinderedRotor(inertia=(0.123457,'amu*angstrom^2'), symmetry=1, barrier=(4.70652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123272,'amu*angstrom^2'), symmetry=1, barrier=(4.68427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.617693,'amu*angstrom^2'), symmetry=1, barrier=(22.4749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.135025,'amu*angstrom^2'), symmetry=1, barrier=(3.1045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135037,'amu*angstrom^2'), symmetry=1, barrier=(3.10477,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-998.195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,190,488,555,1236,1407,180,642.576],'cm^-1')),
        HinderedRotor(inertia=(0.121842,'amu*angstrom^2'), symmetry=1, barrier=(2.80139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122295,'amu*angstrom^2'), symmetry=1, barrier=(2.81181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80534,0.02762,0.000524078,-5.11835e-06,1.45779e-08,-120057,9.45361], Tmin=(10,'K'), Tmax=(125.441,'K')), NASAPolynomial(coeffs=[4.51231,0.0394898,-2.93659e-05,9.95111e-09,-1.2528e-12,-120102,6.43129], Tmin=(125.441,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-998.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""F[C](F)CC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1154.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,193,295,551,588,656,1146,1192,1350,211.206,1058.02],'cm^-1')),
        HinderedRotor(inertia=(0.22359,'amu*angstrom^2'), symmetry=1, barrier=(7.08609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223363,'amu*angstrom^2'), symmetry=1, barrier=(7.0873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.47314,0.0477792,-1.39665e-05,-4.10119e-08,3.14829e-11,-138838,14.9342], Tmin=(10,'K'), Tmax=(677.438,'K')), NASAPolynomial(coeffs=[8.94227,0.0336042,-2.26968e-05,7.05881e-09,-8.263e-13,-139995,-12.3897], Tmin=(677.438,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1154.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""[O]C(F)(F)CC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.617948,'amu*angstrom^2'), symmetry=1, barrier=(14.2078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618298,'amu*angstrom^2'), symmetry=1, barrier=(14.2159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.7848,'amu*angstrom^2'), symmetry=1, barrier=(18.0441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235269,'amu*angstrom^2'), symmetry=1, barrier=(5.40931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235251,'amu*angstrom^2'), symmetry=1, barrier=(5.40888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
"""),
    E0 = (-1119.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,486,617,768,1157,1926,180,468.028],'cm^-1')),
        HinderedRotor(inertia=(0.107993,'amu*angstrom^2'), symmetry=1, barrier=(2.48296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105735,'amu*angstrom^2'), symmetry=1, barrier=(2.43106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80199,0.0400395,-2.88896e-05,9.08065e-09,-9.11747e-13,-134678,12.7812], Tmin=(10,'K'), Tmax=(1373.07,'K')), NASAPolynomial(coeffs=[15.5393,0.0122787,-5.58925e-06,1.17935e-09,-9.43171e-14,-138507,-49.7738], Tmin=(1373.07,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1119.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""ODC(F)CC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    ...
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(142.17,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'OCC(F)(F)F(1134)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(186.446,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OF(173)', 'F[C]CC(F)(F)F(1435)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.60497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)
...
reaction(
    ...
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(236.898,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC(F)=CC(F)(F)F(716)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)(F)F(244)', 'CH2CF2(56)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)CC(F)(F)F(1436)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)C[C](F)F(1437)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', 'F[C](F)CC(F)(F)F(1150)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)CC(F)(F)F(1144)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(239)', '[CH2]C(F)(F)F(1125)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF3(44)', '[CH2]C(O)(F)F(1291)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]C(F)(F)F(1033)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)CC(F)(F)F(1438)'],
    products = ['OC(F)(F)CC(F)(F)F(1318)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(163.886,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
