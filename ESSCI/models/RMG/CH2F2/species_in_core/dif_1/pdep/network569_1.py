...
"""),
    E0 = (-408.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,180,180,180,966.656],'cm^-1')),
        HinderedRotor(inertia=(0.186592,'amu*angstrom^2'), symmetry=1, barrier=(4.29012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18606,'amu*angstrom^2'), symmetry=1, barrier=(4.27789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85344,0.0590093,-0.000119061,1.24833e-07,-4.84774e-11,-49105.4,18.1399], Tmin=(100,'K'), Tmax=(835.41,'K')), NASAPolynomial(coeffs=[2.21307,0.0295885,-1.65014e-05,3.30047e-09,-2.31366e-13,-48199,22.2545], Tmin=(835.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23347,0.0783857,-0.000175667,1.79689e-07,-6.60195e-11,-53711.4,19.6817], Tmin=(100,'K'), Tmax=(880.468,'K')), NASAPolynomial(coeffs=[3.25159,0.0265788,-1.47662e-05,2.85815e-09,-1.92901e-13,-52414.1,19.5878], Tmin=(880.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(OCJO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C[O](197)'],
    products = ['[O]CO[C](F)F(1472)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(89)', '[O]C[O](197)'],
    products = ['[O]CO[C](F)F(1472)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(257654,'m^3/(mol*s)'), n=0.469398, Ea=(4.32726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R
Multiplied by reaction path degeneracy 2.0"""),
)
