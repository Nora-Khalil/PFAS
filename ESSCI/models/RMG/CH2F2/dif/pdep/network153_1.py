...
"""),
    E0 = (-682.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,232,360,932,1127,1349,1365,3045,384.804,386.754,386.964,386.991,387.33,387.649],'cm^-1')),
        HinderedRotor(inertia=(0.426587,'amu*angstrom^2'), symmetry=1, barrier=(45.3929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427162,'amu*angstrom^2'), symmetry=1, barrier=(45.4039,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-216.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,196.612,197.119],'cm^-1')),
        HinderedRotor(inertia=(0.656685,'amu*angstrom^2'), symmetry=1, barrier=(18.3846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670295,'amu*angstrom^2'), symmetry=1, barrier=(18.3884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677975,'amu*angstrom^2'), symmetry=1, barrier=(18.3876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674075,0.0741975,-0.000111535,7.92956e-08,-2.15156e-11,-25975.5,21.7385], Tmin=(100,'K'), Tmax=(916.088,'K')), NASAPolynomial(coeffs=[15.8002,0.00815166,-3.39348e-06,5.98098e-10,-3.9337e-14,-28746.9,-49.9108], Tmin=(916.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.158266,'amu*angstrom^2'), symmetry=1, barrier=(3.63884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15784,'amu*angstrom^2'), symmetry=1, barrier=(3.62906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158724,'amu*angstrom^2'), symmetry=1, barrier=(3.64938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27257,0.0741041,-0.000150442,1.52721e-07,-5.72639e-11,-24748.8,22.7621], Tmin=(100,'K'), Tmax=(853.466,'K')), NASAPolynomial(coeffs=[3.31145,0.0314854,-1.7429e-05,3.42972e-09,-2.36945e-13,-23892.6,20.3033], Tmin=(853.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C(OF)[C](O)F(478)',
...
"""),
    E0 = (-287.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,395,473,707,1436,180,180,1109.39],'cm^-1')),
        HinderedRotor(inertia=(0.26691,'amu*angstrom^2'), symmetry=1, barrier=(6.13679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269104,'amu*angstrom^2'), symmetry=1, barrier=(6.18722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270888,'amu*angstrom^2'), symmetry=1, barrier=(6.22825,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08826,0.076349,-0.000150354,1.46684e-07,-5.34558e-11,-34493.9,26.1338], Tmin=(100,'K'), Tmax=(852.497,'K')), NASAPolynomial(coeffs=[5.76513,0.0268979,-1.49439e-05,2.94172e-09,-2.03156e-13,-34291.7,10.1793], Tmin=(852.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)C([O])OF(479)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258304,'amu*angstrom^2'), symmetry=1, barrier=(5.93891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257304,'amu*angstrom^2'), symmetry=1, barrier=(5.91594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4339,0.0643222,-0.000112252,1.0525e-07,-3.83066e-11,-30651.1,24.9935], Tmin=(100,'K'), Tmax=(818.357,'K')), NASAPolynomial(coeffs=[6.34821,0.0254163,-1.36553e-05,2.70258e-09,-1.89217e-13,-30956.9,5.31528], Tmin=(818.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(F)[C](O)OF(480)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-276.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,391,562,707,872,1109,1210,1289,3137,360,370,350,233.54,233.577],'cm^-1')),
        HinderedRotor(inertia=(0.00601714,'amu*angstrom^2'), symmetry=1, barrier=(9.79772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253121,'amu*angstrom^2'), symmetry=1, barrier=(9.79772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253097,'amu*angstrom^2'), symmetry=1, barrier=(9.7977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25939,0.0657303,-0.000101477,7.76759e-08,-2.24775e-11,-33102.8,25.4648], Tmin=(100,'K'), Tmax=(674.04,'K')), NASAPolynomial(coeffs=[10.6662,0.0170174,-8.8944e-06,1.75619e-09,-1.23559e-13,-34532.4,-17.4048], Tmin=(674.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Cs_P)"""),
)

species(
    label = 'OC(F)=C(O)OF(481)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.560929,'amu*angstrom^2'), symmetry=1, barrier=(12.8969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560778,'amu*angstrom^2'), symmetry=1, barrier=(12.8934,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730401,0.0769997,-0.000129541,1.06466e-07,-3.3771e-11,-64013.7,21.0842], Tmin=(100,'K'), Tmax=(837.722,'K')), NASAPolynomial(coeffs=[12.746,0.0141723,-7.27783e-06,1.39538e-09,-9.53244e-14,-65835.4,-33.6143], Tmin=(837.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-533.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-591.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,232,360,932,1127,1349,1365,3045,180,180,180,1295.23,1297.16,1297.74],'cm^-1')),
        HinderedRotor(inertia=(1.4143,'amu*angstrom^2'), symmetry=1, barrier=(53.2231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0447164,'amu*angstrom^2'), symmetry=1, barrier=(53.256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41912,0.0385857,-4.98555e-05,4.49884e-08,-1.79764e-11,-71122.7,17.3001], Tmin=(100,'K'), Tmax=(695.023,'K')), NASAPolynomial(coeffs=[4.18534,0.0249904,-1.31106e-05,2.64127e-09,-1.89765e-13,-71285.3,10.0177], Tmin=(695.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-273.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,235,1215,1347,1486,3221,253.665,253.666,253.667,253.674,593.372,2118.11],'cm^-1')),
        HinderedRotor(inertia=(0.691537,'amu*angstrom^2'), symmetry=1, barrier=(31.5756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691509,'amu*angstrom^2'), symmetry=1, barrier=(31.5756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-456.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,241,322,589,815,1096,1220,1302,2892,180,180,180,180,180,1491.95],'cm^-1')),
        HinderedRotor(inertia=(0.00437186,'amu*angstrom^2'), symmetry=1, barrier=(6.9214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11362,'amu*angstrom^2'), symmetry=1, barrier=(57.5104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60465,0.0603053,-0.000106828,9.96863e-08,-3.57173e-11,-54814.4,20.7854], Tmin=(100,'K'), Tmax=(838.977,'K')), NASAPolynomial(coeffs=[6.24949,0.0226989,-1.19486e-05,2.32815e-09,-1.60991e-13,-55049.7,2.43515], Tmin=(838.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.787477,'amu*angstrom^2'), symmetry=1, barrier=(18.1057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786064,'amu*angstrom^2'), symmetry=1, barrier=(18.0732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-543.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,280,501,1494,1531,180,180,861.87,862.17,862.34,862.483],'cm^-1')),
        HinderedRotor(inertia=(2.40027,'amu*angstrom^2'), symmetry=1, barrier=(55.1869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534359,'amu*angstrom^2'), symmetry=1, barrier=(55.2009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.40098,'amu*angstrom^2'), symmetry=1, barrier=(55.2033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
...
"""),
    E0 = (-347.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2782.5,750,1395,475,1775,1000,442.2,443.665,444.872,445.718,445.796],'cm^-1')),
        HinderedRotor(inertia=(0.331436,'amu*angstrom^2'), symmetry=1, barrier=(46.6276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333557,'amu*angstrom^2'), symmetry=1, barrier=(46.626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65562,0.0341149,-3.02436e-05,1.33749e-08,-2.52357e-12,-41726.2,14.5066], Tmin=(100,'K'), Tmax=(1189.67,'K')), NASAPolynomial(coeffs=[7.40425,0.0181486,-1.01124e-05,2.09375e-09,-1.52915e-13,-42856,-9.22748], Tmin=(1189.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)OF(468)'],
    products = ['O=C(OF)C(O)F(338)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)OF(426)'],
    products = ['O=C(OF)C(O)F(338)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'O=C=C(O)F(427)'],
    products = ['O=C(OF)C(O)F(338)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C([CH]O)OF(482)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)C(O)F(483)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'O=C([CH]F)OF(484)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(=O)OF(485)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(228)', 'O=[C]C(O)F(486)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(142)', 'O[CH]F(290)'],
    products = ['O=C(OF)C(O)F(338)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)[C](O)F(433)'],
    products = ['O=C(OF)C(O)F(338)'],
