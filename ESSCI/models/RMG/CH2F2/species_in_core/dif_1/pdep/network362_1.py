...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.120802,'amu*angstrom^2'), symmetry=1, barrier=(2.77748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118522,'amu*angstrom^2'), symmetry=1, barrier=(2.72506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610525,'amu*angstrom^2'), symmetry=1, barrier=(14.0372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884395,0.0746187,-0.00011506,9.25196e-08,-2.96631e-11,-88740,25.7866], Tmin=(100,'K'), Tmax=(764.175,'K')), NASAPolynomial(coeffs=[10.9402,0.0219804,-1.17317e-05,2.37192e-09,-1.69948e-13,-90276.8,-20.0217], Tmin=(764.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-738.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.290903,'amu*angstrom^2'), symmetry=1, barrier=(6.68844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290805,'amu*angstrom^2'), symmetry=1, barrier=(6.68617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290859,'amu*angstrom^2'), symmetry=1, barrier=(6.68742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641223,0.0869315,-0.00016823,1.60802e-07,-5.74535e-11,-82452.4,26.9869], Tmin=(100,'K'), Tmax=(860.073,'K')), NASAPolynomial(coeffs=[7.10826,0.0279479,-1.49452e-05,2.90847e-09,-1.99372e-13,-82495.6,2.9775], Tmin=(860.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)F(910)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759895,0.0778034,-0.000129924,1.117e-07,-3.74952e-11,-90837.4,26.8026], Tmin=(100,'K'), Tmax=(815.043,'K')), NASAPolynomial(coeffs=[10.6459,0.0211943,-1.08495e-05,2.12185e-09,-1.47736e-13,-92180.1,-17.2208], Tmin=(815.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-756.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)F(872)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(872)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(68)', 'F[C](F)O[C](F)F(361)'],
    products = ['[CH2]C(F)(F)O[C](F)F(872)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(872)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(12.5491,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(872)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(3.58475,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['FC[C](F)O[C](F)F(909)'],
    products = ['[CH2]C(F)(F)O[C](F)F(872)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(128.336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)O[C](F)F(872)'],
    products = ['[CH2][C](F)OC(F)(F)F(910)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(219.043,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
