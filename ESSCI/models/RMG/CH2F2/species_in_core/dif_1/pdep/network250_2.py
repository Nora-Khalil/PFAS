...
"""),
    E0 = (76.4938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3010,987.5,1337.5,450,1655,167,640,1190,336.68],'cm^-1')),
        HinderedRotor(inertia=(0.158364,'amu*angstrom^2'), symmetry=1, barrier=(12.7385,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0255,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48664,0.0352328,-4.81847e-05,3.32663e-08,-9.05721e-12,9252.9,15.2864], Tmin=(100,'K'), Tmax=(899.771,'K')), NASAPolynomial(coeffs=[8.38217,0.00902547,-4.49732e-06,8.99127e-10,-6.45956e-14,8191.91,-12.5339], Tmin=(899.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.4938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C(F)F(648)'],
    products = ['O=C(F)[CH]F(519)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction1',
    reactants = ['F(37)', 'O=C[C]F-2(795)'],
    products = ['O=C[C](F)F(1007)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2(89)', 'HCO(14)'],
    products = ['O=C[C](F)F(1007)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.35659,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=C=[C]F(796)'],
    products = ['O=C[C](F)F(1007)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(286.914,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction11',
    reactants = ['O[C]=C(F)F(1172)'],
    products = ['O=C[C](F)F(1007)'],
