...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC([O])(F)F(853)'],
    products = ['O2(2)', 'FC1(F)OO1(932)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(205)'],
    products = ['[O]OOC([O])(F)F(853)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](159)', '[O][C](F)F(178)'],
    products = ['[O]OOC([O])(F)F(853)'],
    transitionState = 'TS9',
