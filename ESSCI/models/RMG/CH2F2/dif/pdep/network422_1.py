...
"""),
    E0 = (-354.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,1656.03,2884.29],'cm^-1')),
        HinderedRotor(inertia=(0.000447304,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00619476,'amu*angstrom^2'), symmetry=1, barrier=(12.0422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62071,0.057848,-9.34579e-05,8.29437e-08,-2.91562e-11,-42516.5,17.6157], Tmin=(100,'K'), Tmax=(798.996,'K')), NASAPolynomial(coeffs=[7.37371,0.0214517,-1.08706e-05,2.13734e-09,-1.49965e-13,-43193.4,-7.33116], Tmin=(798.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.248207,'amu*angstrom^2'), symmetry=1, barrier=(5.70676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248368,'amu*angstrom^2'), symmetry=1, barrier=(5.71047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.049,'amu'),
...
reaction(
    ...
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.000105193,'m^3/(mol*s)'), n=3.55802, Ea=(27.3651,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_N-4R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_N-4R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'CH3-CF2(64)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.00405e-10,'m^3/(mol*s)'), n=4.72997, Ea=(130.753,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'CH2F-CF2(67)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(135.634,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C(F)F(1135)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(1406)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(166)', 'CHF2-CH2(63)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(1235)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2][C](F)F(1124)'],
    products = ['F[C](F)CC(F)F(1162)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(975)'],
    products = ['F[C](F)CC(F)F(1162)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(1216)'],
    products = ['F[C](F)CC(F)F(1162)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(977)'],
    products = ['F[C](F)CC(F)F(1162)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]CC(F)F(1372)'],
    products = ['F[C](F)CC(F)F(1162)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(1162)'],
    products = ['F[CH]CC(F)(F)F(1136)'],
