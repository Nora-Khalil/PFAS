...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31714,0.0246028,2.2334e-05,-5.97809e-08,2.94267e-11,-31830.5,21.8992], Tmin=(100,'K'), Tmax=(880.737,'K')), NASAPolynomial(coeffs=[15.0474,0.0013041,3.22715e-06,-8.19429e-10,5.92139e-14,-35411.6,-45.5003], Tmin=(880.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(124trioxolane) + radical(Cs_P) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C([O])OC(=O)F(390)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-519.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,482,664,788,1296,1923,180,1328.25,1328.3,1328.5,1329.52],'cm^-1')),
        HinderedRotor(inertia=(0.00491402,'amu*angstrom^2'), symmetry=1, barrier=(6.14979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00491031,'amu*angstrom^2'), symmetry=1, barrier=(6.14698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72366,0.0520744,-0.0001407,1.84889e-07,-8.12579e-11,-62465.8,20.9139], Tmin=(100,'K'), Tmax=(838.174,'K')), NASAPolynomial(coeffs=[-11.9651,0.0570774,-3.31574e-05,6.69285e-09,-4.70891e-13,-57716.8,102.826], Tmin=(838.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(COFOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(=O)OC([O])F(391)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-535.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,180,180,652.239,652.381,652.824,652.884,653.344,653.937],'cm^-1')),
        HinderedRotor(inertia=(0.00540726,'amu*angstrom^2'), symmetry=1, barrier=(1.63095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00540057,'amu*angstrom^2'), symmetry=1, barrier=(1.63352,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92769,0.0427598,-4.23205e-05,2.01359e-08,-3.76212e-12,-70319.7,23.1481], Tmin=(100,'K'), Tmax=(1294.58,'K')), NASAPolynomial(coeffs=[12.2834,0.0107623,-5.24528e-06,1.04307e-09,-7.50047e-14,-73000.9,-29.4858], Tmin=(1294.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-585.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    E0 = (-525.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,491.593,491.595,491.603,491.604,491.607,491.618],'cm^-1')),
        HinderedRotor(inertia=(0.0153847,'amu*angstrom^2'), symmetry=1, barrier=(2.6384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0793908,'amu*angstrom^2'), symmetry=1, barrier=(13.6142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0793859,'amu*angstrom^2'), symmetry=1, barrier=(13.6142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0268,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85324,0.0439492,-5.35247e-05,2.99566e-08,-6.37671e-12,-63137.7,20.3873], Tmin=(100,'K'), Tmax=(1164.53,'K')), NASAPolynomial(coeffs=[13.526,0.00385427,-1.87881e-06,3.90191e-10,-2.93402e-14,-65856.3,-37.7051], Tmin=(1164.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-700.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([482,664,788,1296,1923,483.602,483.604,483.608,483.608,483.61,483.615,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0758509,'amu*angstrom^2'), symmetry=1, barrier=(12.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.075852,'amu*angstrom^2'), symmetry=1, barrier=(12.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.017,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96227,0.0459062,-6.24774e-05,4.00202e-08,-9.89672e-12,-84229.3,22.5369], Tmin=(100,'K'), Tmax=(996.523,'K')), NASAPolynomial(coeffs=[11.6626,0.00696917,-3.86751e-06,8.10276e-10,-5.99451e-14,-86162.6,-24.2277], Tmin=(996.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(COFOO) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(136)', 'O=[C]O(164)'],
    products = ['O=C(O)OC(=O)F(328)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(203)'],
    products = ['O=C(O)OC(=O)F(328)'],
