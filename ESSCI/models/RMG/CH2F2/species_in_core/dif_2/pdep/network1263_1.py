...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.55581,'amu*angstrom^2'), symmetry=1, barrier=(35.771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5562,'amu*angstrom^2'), symmetry=1, barrier=(35.7801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55051,'amu*angstrom^2'), symmetry=1, barrier=(35.6493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.70505,'amu*angstrom^2'), symmetry=1, barrier=(39.2024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70696,'amu*angstrom^2'), symmetry=1, barrier=(39.2463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70616,'amu*angstrom^2'), symmetry=1, barrier=(39.2279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49681,0.059037,-8.22978e-05,5.80478e-08,-1.62741e-11,-4660.89,21.178], Tmin=(100,'K'), Tmax=(871.387,'K')), NASAPolynomial(coeffs=[10.8068,0.0163009,-8.73289e-06,1.76645e-09,-1.27203e-13,-6283.43,-22.4558], Tmin=(871.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.4736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFHO) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = '[C]#COOC(F)F(3440)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (79.6566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(1.72778,'amu*angstrom^2'), symmetry=1, barrier=(39.7251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72821,'amu*angstrom^2'), symmetry=1, barrier=(39.7349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70839,'amu*angstrom^2'), symmetry=1, barrier=(39.2793,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24218,0.0677182,-0.00011904,1.06081e-07,-3.63278e-11,9673,22.3233], Tmin=(100,'K'), Tmax=(845.974,'K')), NASAPolynomial(coeffs=[8.6567,0.0195129,-1.02551e-05,1.98333e-09,-1.36161e-13,8888.96,-9.42675], Tmin=(845.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.6566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFHO) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COOC(F)F(3441)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
4 O u0 p2 c0 {3,S} {6,S}
...
"""),
    E0 = (-103.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.483832,'amu*angstrom^2'), symmetry=1, barrier=(11.1243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.482885,'amu*angstrom^2'), symmetry=1, barrier=(11.1025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84688,'amu*angstrom^2'), symmetry=1, barrier=(42.4633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14091,0.0749308,-0.000145538,1.424e-07,-5.22123e-11,-12302.4,22.8828], Tmin=(100,'K'), Tmax=(849.145,'K')), NASAPolynomial(coeffs=[5.34955,0.0282232,-1.55426e-05,3.05775e-09,-2.11486e-13,-12047.9,8.97356], Tmin=(849.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(F)F(3304)'],
    products = ['CF2O(48)', 'CH2CO(75)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(13.2772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'C#COO(2906)'],
    products = ['C#COOC(F)F(3304)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(86)', 'C#COOF(3439)'],
    products = ['C#COOC(F)F(3304)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(12.1949,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(2923)'],
    products = ['C#COOC(F)F(3304)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(2915)'],
    products = ['C#COOC(F)F(3304)'],
    transitionState = 'TS8',
