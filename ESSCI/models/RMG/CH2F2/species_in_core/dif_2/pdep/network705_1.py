species(
    label = '[O]C(F)C(F)(F)C(O)(F)F(1675)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292516,'amu*angstrom^2'), symmetry=1, barrier=(6.72551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565771,'amu*angstrom^2'), symmetry=1, barrier=(13.0082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292802,'amu*angstrom^2'), symmetry=1, barrier=(6.7321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.20415,0.0991035,-0.000154567,1.2224e-07,-3.80526e-11,-155272,30.3008], Tmin=(100,'K'), Tmax=(790.475,'K')), NASAPolynomial(coeffs=[14.5858,0.0242631,-1.25516e-05,2.46898e-09,-1.73444e-13,-157610,-37.575], Tmin=(790.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1292.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.38402,'amu*angstrom^2'), symmetry=1, barrier=(31.8212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39593,'amu*angstrom^2'), symmetry=1, barrier=(32.0951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03035,0.046278,-6.6989e-05,4.89416e-08,-1.41201e-11,-64798.6,17.5213], Tmin=(100,'K'), Tmax=(850.047,'K')), NASAPolynomial(coeffs=[9.35662,0.011803,-6.15344e-06,1.22947e-09,-8.77629e-14,-66044.1,-16.6334], Tmin=(850.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-539.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = '[O]C(F)C(O)(F)C(F)(F)F(1857)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1137.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,180,2081.92],'cm^-1')),
        HinderedRotor(inertia=(0.484014,'amu*angstrom^2'), symmetry=1, barrier=(11.1284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01638,'amu*angstrom^2'), symmetry=1, barrier=(23.3685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33505,'amu*angstrom^2'), symmetry=1, barrier=(53.6874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1192.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,223,363,546,575,694,1179,1410,2782.5,750,1395,475,1775,1000,223.106],'cm^-1')),
        HinderedRotor(inertia=(0.202514,'amu*angstrom^2'), symmetry=1, barrier=(7.15368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20252,'amu*angstrom^2'), symmetry=1, barrier=(7.15353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.472924,'amu*angstrom^2'), symmetry=1, barrier=(16.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637857,0.0798411,-0.000117252,8.99189e-08,-2.75456e-11,-143368,26.3864], Tmin=(100,'K'), Tmax=(798.595,'K')), NASAPolynomial(coeffs=[11.769,0.0240872,-1.25288e-05,2.49548e-09,-1.77514e-13,-145146,-24.8114], Tmin=(798.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1192.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'O=C(F)C(F)(F)C(O)(F)F(1859)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.236608,'amu*angstrom^2'), symmetry=1, barrier=(5.44009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236353,'amu*angstrom^2'), symmetry=1, barrier=(5.43423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.806118,'amu*angstrom^2'), symmetry=1, barrier=(18.5342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152866,0.0915216,-0.000146222,1.1957e-07,-3.86896e-11,-173900,29.0452], Tmin=(100,'K'), Tmax=(759.453,'K')), NASAPolynomial(coeffs=[12.9667,0.0240372,-1.29442e-05,2.5847e-09,-1.82964e-13,-175846,-29.2494], Tmin=(759.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1446.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(COCsFO)"""),
)

species(
    label = '[O]C(F)[C](F)C(O)(F)F(1860)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309048,'amu*angstrom^2'), symmetry=1, barrier=(7.10562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309561,'amu*angstrom^2'), symmetry=1, barrier=(7.11741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310202,'amu*angstrom^2'), symmetry=1, barrier=(7.13214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675397,0.0832874,-0.000117703,6.65837e-08,-2.46745e-12,-106569,28.9724], Tmin=(100,'K'), Tmax=(569.092,'K')), NASAPolynomial(coeffs=[11.7663,0.0243983,-1.27378e-05,2.49175e-09,-1.73452e-13,-108140,-20.9953], Tmin=(569.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-886.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(F)C(F)(F)[C](O)F(1861)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.289902,'amu*angstrom^2'), symmetry=1, barrier=(6.66542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289402,'amu*angstrom^2'), symmetry=1, barrier=(6.65392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28892,'amu*angstrom^2'), symmetry=1, barrier=(6.64285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00805263,0.101516,-0.00019192,1.77337e-07,-6.15151e-11,-105185,29.9004], Tmin=(100,'K'), Tmax=(868.942,'K')), NASAPolynomial(coeffs=[9.59013,0.0281451,-1.4879e-05,2.85226e-09,-1.93181e-13,-105752,-8.71633], Tmin=(868.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-875.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(O)(F)F(1862)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-909.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,180,1094.31,1096.91],'cm^-1')),
        HinderedRotor(inertia=(0.145063,'amu*angstrom^2'), symmetry=1, barrier=(3.33529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145027,'amu*angstrom^2'), symmetry=1, barrier=(3.33447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143721,'amu*angstrom^2'), symmetry=1, barrier=(3.30442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558334,0.0867636,-0.000154129,1.4551e-07,-5.30354e-11,-109306,29.8163], Tmin=(100,'K'), Tmax=(823.063,'K')), NASAPolynomial(coeffs=[7,0.0338549,-1.83344e-05,3.62962e-09,-2.53816e-13,-109634,4.43846], Tmin=(823.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.422139,'amu*angstrom^2'), symmetry=1, barrier=(9.70581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423151,'amu*angstrom^2'), symmetry=1, barrier=(9.72907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.112869,0.097307,-0.000182447,1.67383e-07,-5.81171e-11,-105549,27.2421], Tmin=(100,'K'), Tmax=(851.553,'K')), NASAPolynomial(coeffs=[10.4133,0.025247,-1.38098e-05,2.71007e-09,-1.86769e-13,-106445,-15.756], Tmin=(851.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)C(F)(F)C([O])(F)F(1863)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.27842,'amu*angstrom^2'), symmetry=1, barrier=(6.40141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.148954,0.0930704,-0.000143717,1.06955e-07,-2.87556e-11,-124020,29.6452], Tmin=(100,'K'), Tmax=(650.15,'K')), NASAPolynomial(coeffs=[13.5494,0.0233809,-1.23625e-05,2.44163e-09,-1.71482e-13,-126032,-31.3081], Tmin=(650.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sH))"""),
)
...
species(
    label = '[O][C](F)C(F)(F)C(O)(F)F(1864)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1098.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,395,473,707,1436,180,180,3231.4],'cm^-1')),
        HinderedRotor(inertia=(0.364452,'amu*angstrom^2'), symmetry=1, barrier=(8.37947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363713,'amu*angstrom^2'), symmetry=1, barrier=(8.36248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363482,'amu*angstrom^2'), symmetry=1, barrier=(8.35716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.44843,0.114299,-0.000225472,2.10739e-07,-7.3115e-11,-131960,32.085], Tmin=(100,'K'), Tmax=(878.531,'K')), NASAPolynomial(coeffs=[10.1235,0.0287564,-1.55481e-05,2.97215e-09,-1.99586e-13,-132374,-9.33333], Tmin=(878.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1098.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)C(F)(F)C(=O)F(1865)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.335457,'amu*angstrom^2'), symmetry=1, barrier=(7.71282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336052,'amu*angstrom^2'), symmetry=1, barrier=(7.7265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881249,0.0742553,-0.000111051,8.70036e-08,-2.72539e-11,-119886,26.7342], Tmin=(100,'K'), Tmax=(781.135,'K')), NASAPolynomial(coeffs=[10.9671,0.0226105,-1.18826e-05,2.371e-09,-1.68619e-13,-121462,-19.4332], Tmin=(781.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(COCsFO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.49737,'amu*angstrom^2'), symmetry=1, barrier=(11.4355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58301,'amu*angstrom^2'), symmetry=1, barrier=(36.3966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497405,'amu*angstrom^2'), symmetry=1, barrier=(11.4363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817641,0.0749844,-0.000106465,7.65463e-08,-2.18181e-11,-130629,26.2821], Tmin=(100,'K'), Tmax=(858.613,'K')), NASAPolynomial(coeffs=[12.5923,0.0201305,-1.0635e-05,2.14019e-09,-1.53572e-13,-132651,-28.7288], Tmin=(858.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1087.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COCsFO) + radical(CsCOCsF1s)"""),
)

species(
    label = 'O[C](F)C(F)(F)C(O)(F)F(1869)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.690191,0.11817,-0.000224592,2.06059e-07,-7.099e-11,-159201,32.0496], Tmin=(100,'K'), Tmax=(868.091,'K')), NASAPolynomial(coeffs=[11.5021,0.0297316,-1.60374e-05,3.08962e-09,-2.09541e-13,-160102,-18.0459], Tmin=(868.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1324.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)(F)C(F)(F)C(O)F(1870)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1258.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,201.674,201.675],'cm^-1')),
        HinderedRotor(inertia=(0.233173,'amu*angstrom^2'), symmetry=1, barrier=(6.73023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233195,'amu*angstrom^2'), symmetry=1, barrier=(6.73055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684236,'amu*angstrom^2'), symmetry=1, barrier=(19.7496,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.14039,0.0978154,-0.000147887,1.13123e-07,-3.41543e-11,-151258,29.7639], Tmin=(100,'K'), Tmax=(813.408,'K')), NASAPolynomial(coeffs=[14.7267,0.0247016,-1.30519e-05,2.60652e-09,-1.85375e-13,-153676,-38.8898], Tmin=(813.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1258.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'OOC(F)C(F)(F)[C](F)F(1871)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83822,'amu*angstrom^2'), symmetry=1, barrier=(42.2643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8382,'amu*angstrom^2'), symmetry=1, barrier=(42.2637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.619303,'amu*angstrom^2'), symmetry=1, barrier=(14.239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.619242,'amu*angstrom^2'), symmetry=1, barrier=(14.2376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.624135,0.110931,-0.000187729,1.61319e-07,-5.43738e-11,-124289,30.876], Tmin=(100,'K'), Tmax=(792.715,'K')), NASAPolynomial(coeffs=[14.0201,0.0285349,-1.57282e-05,3.13727e-09,-2.207e-13,-126343,-34.6872], Tmin=(792.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1034.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)[C](F)C(F)OF(1872)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.364404,'amu*angstrom^2'), symmetry=1, barrier=(8.37837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364516,'amu*angstrom^2'), symmetry=1, barrier=(8.38093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81695,'amu*angstrom^2'), symmetry=1, barrier=(18.7833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72232,'amu*angstrom^2'), symmetry=1, barrier=(39.5995,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.234541,0.102687,-0.000160704,1.23379e-07,-3.52886e-11,-117608,31.4588], Tmin=(100,'K'), Tmax=(648.766,'K')), NASAPolynomial(coeffs=[13.99,0.0273334,-1.50294e-05,3.02209e-09,-2.14687e-13,-119714,-33.0144], Tmin=(648.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-979.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsCsF1s)"""),
)

species(
    label = 'O[C](F)C(F)(F)C(F)OF(1873)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.355043,'amu*angstrom^2'), symmetry=1, barrier=(8.16313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355364,'amu*angstrom^2'), symmetry=1, barrier=(8.17053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35531,'amu*angstrom^2'), symmetry=1, barrier=(8.16927,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.741458,0.117939,-0.000218461,1.98584e-07,-6.85955e-11,-116232,31.8002], Tmin=(100,'K'), Tmax=(849.577,'K')), NASAPolynomial(coeffs=[12.1591,0.0304606,-1.67994e-05,3.29244e-09,-2.26782e-13,-117459,-22.6552], Tmin=(849.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-967.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)(F)C(F)(F)[CH]OF(1756)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-994.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,297.378,297.722,297.863],'cm^-1')),
        HinderedRotor(inertia=(0.165253,'amu*angstrom^2'), symmetry=1, barrier=(10.3863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165362,'amu*angstrom^2'), symmetry=1, barrier=(10.3881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165308,'amu*angstrom^2'), symmetry=1, barrier=(10.3911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394458,'amu*angstrom^2'), symmetry=1, barrier=(24.8463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.864003,0.114956,-0.00019371,1.60135e-07,-5.14836e-11,-119472,31.4961], Tmin=(100,'K'), Tmax=(796.407,'K')), NASAPolynomial(coeffs=[16.8808,0.022191,-1.21361e-05,2.40161e-09,-1.67768e-13,-122183,-49.3482], Tmin=(796.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    ...
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)F(170)', 'OC(F)(F)[C]F(715)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    products = ['[O]C(F)C(O)(F)C(F)(F)F(1857)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(153)', '[O]C(F)C(F)=C(F)F(686)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(O)F(549)', 'CF2CF2(60)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'OC(F)(F)C(F)(F)[CH]F(1346)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)(F)C(O)(F)F(1858)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFO(46)', 'OC(F)(F)[C](F)F(725)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=C(F)C(F)(F)C(O)(F)F(1859)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)[C](F)C(O)(F)F(1860)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(F)(F)[C](O)F(1861)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O][CH]C(F)(F)C(O)(F)F(1862)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', '[O]C(F)C(F)(F)[C](F)F(596)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)C([O])(F)F(1863)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(232)', '[O]C(F)[C](F)F(386)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O][CH]F(168)', 'OC(F)(F)[C](F)F(725)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O][C](F)C(F)(F)C(O)(F)F(1864)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C(F)C(F)(F)C(=O)F(1865)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(106)', '[O]C(F)C(F)=C(O)F(1866)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', '[O]C=C(F)C(O)(F)F(1867)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)[C](F)C(O)(F)F(1868)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
    products = ['O[C](F)C(F)(F)C(O)(F)F(1869)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(F)C(F)(F)C(O)F(1870)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OOC(F)C(F)(F)[C](F)F(1871)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(F)(F)[C](F)C(F)OF(1872)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C](F)C(F)(F)C(F)OF(1873)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)(F)C(F)(F)[CH]OF(1756)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(1675)'],
