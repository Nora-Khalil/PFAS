...
"""),
    E0 = (-1086.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,431,527,613,668,835,1199,1245,1322,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.183871,'amu*angstrom^2'), symmetry=1, barrier=(4.22755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183887,'amu*angstrom^2'), symmetry=1, barrier=(4.22794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606177,'amu*angstrom^2'), symmetry=1, barrier=(13.9372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.64065,0.0301227,8.90373e-05,-3.46247e-07,3.21459e-10,-130660,11.5903], Tmin=(10,'K'), Tmax=(406.279,'K')), NASAPolynomial(coeffs=[6.2667,0.0323516,-2.2878e-05,7.53469e-09,-9.31357e-13,-131105,-1.566], Tmin=(406.279,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1086.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""OCOC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-636.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,198.799,198.83,198.878],'cm^-1')),
        HinderedRotor(inertia=(0.305372,'amu*angstrom^2'), symmetry=1, barrier=(8.57866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306098,'amu*angstrom^2'), symmetry=1, barrier=(8.57828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410147,'amu*angstrom^2'), symmetry=1, barrier=(11.516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-710.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,180,921.491],'cm^-1')),
        HinderedRotor(inertia=(0.24849,'amu*angstrom^2'), symmetry=1, barrier=(5.71328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248241,'amu*angstrom^2'), symmetry=1, barrier=(5.70755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0318,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.78238,0.0176008,6.79537e-05,-1.98626e-07,1.50468e-10,-85474.6,12.1247], Tmin=(10,'K'), Tmax=(477.93,'K')), NASAPolynomial(coeffs=[5.12204,0.025696,-1.80498e-05,5.86713e-09,-7.1539e-13,-85823.1,4.34376], Tmin=(477.93,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-710.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""[CH2]OC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-868.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,431,527,613,668,835,1199,1245,1322,180,180,1134.57,1134.93],'cm^-1')),
        HinderedRotor(inertia=(0.21582,'amu*angstrom^2'), symmetry=1, barrier=(4.96212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215729,'amu*angstrom^2'), symmetry=1, barrier=(4.96004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.79381,0.0336598,-2.28682e-05,6.1417e-09,-2.87057e-13,-104478,12.7148], Tmin=(10,'K'), Tmax=(1282.29,'K')), NASAPolynomial(coeffs=[12.269,0.0135225,-6.68214e-06,1.5583e-09,-1.40527e-13,-107170,-32.3004], Tmin=(1282.29,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-868.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[O]COC(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    ...
    products = ['OCOC(F)(F)F(1914)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(20.3085,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OCO[C](F)F(1997)'],
    products = ['OCOC(F)(F)F(1914)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(4)', '[CH2]OC(F)(F)F(1999)'],
    products = ['OCOC(F)(F)F(1914)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]COC(F)(F)F(2000)'],
    products = ['OCOC(F)(F)F(1914)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(1238)'],
    products = ['OCOC(F)(F)F(1914)'],
    transitionState = 'TS8',
