...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[O]C(F)[CH]F(674)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)[C](F)F(483)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)C=C(F)F(685)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C(F)=C(F)F(686)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(F)[C](F)F(687)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(F)C(F)[C](F)F(463)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(106)', '[O]C=C[C](F)F(688)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]C=C(F)[C](F)F(689)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(87)', '[O]C(F)[CH]F(674)'],
    products = ['[O]C(F)C(F)[C](F)F(591)'],
