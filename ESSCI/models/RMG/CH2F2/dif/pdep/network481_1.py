...
"""),
    E0 = (-1119.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,306.477,306.831,307.447,308.027,309.628,1702.09],'cm^-1')),
        HinderedRotor(inertia=(0.00884787,'amu*angstrom^2'), symmetry=1, barrier=(43.1525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00174136,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.642522,'amu*angstrom^2'), symmetry=1, barrier=(43.1962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36029,0.0632879,-7.66741e-05,5.21129e-08,-1.47801e-11,-134578,21.9734], Tmin=(100,'K'), Tmax=(845.213,'K')), NASAPolynomial(coeffs=[8.79993,0.0280796,-1.41902e-05,2.82853e-09,-2.02689e-13,-135836,-12.6675], Tmin=(845.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1119.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-603.084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,244,1102,1254,1379,1468,1475,3037,3083,180,709.494,709.496,709.498,709.557],'cm^-1')),
        HinderedRotor(inertia=(0.132859,'amu*angstrom^2'), symmetry=1, barrier=(47.4689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132888,'amu*angstrom^2'), symmetry=1, barrier=(47.4692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.764166,'amu*angstrom^2'), symmetry=1, barrier=(17.5697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.762584,'amu*angstrom^2'), symmetry=1, barrier=(17.5333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764032,'amu*angstrom^2'), symmetry=1, barrier=(17.5666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0576696,0.0756245,-8.90857e-05,4.8799e-08,-1.00402e-11,-118344,23.9822], Tmin=(100,'K'), Tmax=(1286.42,'K')), NASAPolynomial(coeffs=[21.4507,0.00435595,-4.47329e-07,-5.97453e-12,2.1852e-15,-123455,-83.0879], Tmin=(1286.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-985.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C([O])CC(F)(F)F(1401)',
...
"""),
    E0 = (-686.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1380,1390,370,380,2900,435,180,1732.02,1732.26,1732.97],'cm^-1')),
        HinderedRotor(inertia=(0.281695,'amu*angstrom^2'), symmetry=1, barrier=(6.47672,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25638,0.0718272,-0.00012762,1.2846e-07,-4.95188e-11,-82475.5,26.4298], Tmin=(100,'K'), Tmax=(822.77,'K')), NASAPolynomial(coeffs=[2.85795,0.038565,-2.05337e-05,4.05769e-09,-2.84042e-13,-81876.8,24.2558], Tmin=(822.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[CH]C(F)(F)F(1402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-712.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,249.854,1792.36,1792.36],'cm^-1')),
        HinderedRotor(inertia=(0.00270045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175883,'amu*angstrom^2'), symmetry=1, barrier=(7.79132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175889,'amu*angstrom^2'), symmetry=1, barrier=(7.7916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15314,0.0685262,-0.000103425,8.91163e-08,-3.13085e-11,-85569.7,29.1344], Tmin=(100,'K'), Tmax=(756.576,'K')), NASAPolynomial(coeffs=[7.92974,0.0281843,-1.44931e-05,2.86653e-09,-2.0257e-13,-86465.9,-0.81463], Tmin=(756.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'OC(O)=CC(F)(F)F(1403)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.739249,'amu*angstrom^2'), symmetry=1, barrier=(16.9968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738125,'amu*angstrom^2'), symmetry=1, barrier=(16.9709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.179661,0.0786229,-9.76197e-05,5.54752e-08,-1.14849e-11,-120425,22.8917], Tmin=(100,'K'), Tmax=(966.305,'K')), NASAPolynomial(coeffs=[19.9843,0.00679191,-1.87158e-06,2.87149e-10,-1.90806e-14,-124727,-74.4272], Tmin=(966.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1002.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)
...
"""),
    E0 = (-678.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,352.848,352.926,352.932,352.969,352.993,353.063],'cm^-1')),
        HinderedRotor(inertia=(0.00135307,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00135271,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00135363,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38186,0.0641201,-0.000102086,9.16415e-08,-3.26223e-11,-81460.4,21.734], Tmin=(100,'K'), Tmax=(812.78,'K')), NASAPolynomial(coeffs=[6.69172,0.0271046,-1.36868e-05,2.65896e-09,-1.84975e-13,-81964.1,-0.570792], Tmin=(812.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-704.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1855,455,950,348.382],'cm^-1')),
        HinderedRotor(inertia=(0.0878646,'amu*angstrom^2'), symmetry=1, barrier=(7.56453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879074,'amu*angstrom^2'), symmetry=1, barrier=(7.56507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-893.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,180,180,180,180,884.216,884.294,884.313],'cm^-1')),
        HinderedRotor(inertia=(0.00593303,'amu*angstrom^2'), symmetry=1, barrier=(3.292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593456,'amu*angstrom^2'), symmetry=1, barrier=(3.29458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43886,0.0642353,-0.000103718,9.94104e-08,-3.79888e-11,-107438,21.8367], Tmin=(100,'K'), Tmax=(789.929,'K')), NASAPolynomial(coeffs=[4.6086,0.0335959,-1.78342e-05,3.54838e-09,-2.50678e-13,-107484,10.173], Tmin=(789.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OCC(F)(F)F(1134)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=C(O)CF(1399)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CO2(13)', 'CC(F)(F)F(1133)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(F)(F)F(1076)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)F(244)', 'CH2CO(27)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)[CH]C(F)(F)F(1402)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C(O)C[C](F)F(1404)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'O=[C]CC(F)(F)F(1148)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)CC(F)(F)F(1139)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF3(44)', '[CH2]C(=O)O(1405)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]O(164)', '[CH2]C(F)(F)F(1125)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)(F)F(1082)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(O)C=C(F)F(1087)'],
    products = ['O=C(O)CC(F)(F)F(1314)'],
