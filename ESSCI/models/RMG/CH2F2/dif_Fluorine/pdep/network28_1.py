...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'CF2(42)'],
    products = ['OC(F)F(179)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.52789e-06,'cm^3/(mol*s)'), n=5.02686, Ea=(72.5674,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 3.96429, dn = +|- 0.180953, dEa = +|- 0.98474 kJ/molMatched reaction 48 CF2_r1 + H2O <=> CH2F2O in 1,2_Insertion_carbene/training
This reaction matched rate rule [OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s]
family: 1,2_Insertion_carbene"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(172)', 'CHF(40)'],
    products = ['OC(F)F(179)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(7.62067,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[CH]F(180)'],
    products = ['OC(F)F(179)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'CHFO(46)'],
    products = ['OC(F)F(179)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(159.488,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

network(
    label = 'PDepNetwork #28',
    isomers = [
        'OC(F)F(179)',
    ],
    reactants = [
