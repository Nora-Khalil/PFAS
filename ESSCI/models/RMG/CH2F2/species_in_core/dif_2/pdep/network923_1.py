...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.407981,'amu*angstrom^2'), symmetry=1, barrier=(9.38028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29373,'amu*angstrom^2'), symmetry=1, barrier=(29.7453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47046,'amu*angstrom^2'), symmetry=1, barrier=(10.8168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0264153,'amu*angstrom^2'), symmetry=1, barrier=(3.87754,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (46.0436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.50522,0.00692192,1.5603e-05,-2.26094e-08,8.49006e-12,9752.45,9.13917], Tmin=(100,'K'), Tmax=(981.328,'K')), NASAPolynomial(coeffs=[5.27404,0.00958126,-3.54745e-06,6.4879e-10,-4.59747e-14,8930.09,-1.78223], Tmin=(981.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.9091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.973441,'amu*angstrom^2'), symmetry=1, barrier=(22.3813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974454,'amu*angstrom^2'), symmetry=1, barrier=(22.4046,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258414,'amu*angstrom^2'), symmetry=1, barrier=(5.94145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703005,'amu*angstrom^2'), symmetry=1, barrier=(16.1635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258676,'amu*angstrom^2'), symmetry=1, barrier=(5.94747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03059,0.0753601,-0.000131206,1.25145e-07,-4.60522e-11,-45869.1,23.0685], Tmin=(100,'K'), Tmax=(827.895,'K')), NASAPolynomial(coeffs=[5.55954,0.0329496,-1.71709e-05,3.36671e-09,-2.34501e-13,-45915.5,6.32321], Tmin=(827.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s))"""),
)

species(
    label = 'CC(F)(F)[CH]OF(2227)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-408.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,205.661,205.663],'cm^-1')),
        HinderedRotor(inertia=(0.00398596,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502518,'amu*angstrom^2'), symmetry=1, barrier=(15.0977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502955,'amu*angstrom^2'), symmetry=1, barrier=(15.0975,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07254,0.0693099,-9.07283e-05,6.25689e-08,-1.7396e-11,-48980.1,21.9034], Tmin=(100,'K'), Tmax=(873.653,'K')), NASAPolynomial(coeffs=[11.1073,0.0233654,-1.1844e-05,2.37327e-09,-1.70586e-13,-50733.5,-25.1531], Tmin=(873.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)

species(
    label = 'CC(F)(F)C([O])F(2228)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.442315,'amu*angstrom^2'), symmetry=1, barrier=(10.1697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442884,'amu*angstrom^2'), symmetry=1, barrier=(10.1828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443008,'amu*angstrom^2'), symmetry=1, barrier=(10.1856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.365692,0.0914151,-0.000166141,1.54606e-07,-5.49391e-11,-72628.4,24.1547], Tmin=(100,'K'), Tmax=(840.323,'K')), NASAPolynomial(coeffs=[8.36112,0.0304019,-1.62564e-05,3.1887e-09,-2.20968e-13,-73161.7,-8.20537], Tmin=(840.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-604.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)C(F)OF(2201)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-584.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,180,285.008],'cm^-1')),
        ...
        HinderedRotor(inertia=(0.107765,'amu*angstrom^2'), symmetry=1, barrier=(2.47772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.653714,'amu*angstrom^2'), symmetry=1, barrier=(15.0302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53913,'amu*angstrom^2'), symmetry=1, barrier=(35.3877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'CC(F)OF(2223)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(85)', 'F[C]C(F)OF(1224)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(253)', 'C[C]F-2(309)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(153)', 'CC(F)(F)[C]F(1243)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(86)', 'CC(F)(F)OF(1242)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(716)', 'CC(F)=CF(2225)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(2226)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)[CH]OF(2227)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(F)C([O])F(2228)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(154)', 'CC(F)(F)[CH]F(2229)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(177)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(67)', 'FOC(F)[C](F)F(1230)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(1247)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(2201)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(106)', 'CC(F)(F)C=O(1977)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(106)', 'CC(F)=COF(2230)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(919)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(F)=C(F)OF(1250)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)C(F)OF(2206)'],
    products = ['CC(F)(F)C(F)OF(2191)'],
