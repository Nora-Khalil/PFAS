...
species(
    label = 'F[C](F)C1O[CH]C1(F)F(2782)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07446,0.0657044,-6.86514e-05,3.57003e-08,-7.45065e-12,-70022.4,24.9982], Tmin=(100,'K'), Tmax=(1148.13,'K')), NASAPolynomial(coeffs=[13.7406,0.0215762,-1.09986e-05,2.22371e-09,-1.6123e-13,-72930.9,-37.8582], Tmin=(1148.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-583.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(Csj(Cs-F1sF1sCs)(O2s-Cs)(H)_ring) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-96.2883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,334,575,1197,1424,3202,180,180,180,806.534,806.548,806.561,806.574,806.582,806.589,806.595],'cm^-1')),
        HinderedRotor(inertia=(0.00972989,'amu*angstrom^2'), symmetry=1, barrier=(4.49151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37235,0.038731,-3.74948e-05,1.90156e-08,-4.01052e-12,-11524.6,16.8611], Tmin=(100,'K'), Tmax=(1109.72,'K')), NASAPolynomial(coeffs=[8.25723,0.0175191,-8.82316e-06,1.79124e-09,-1.30223e-13,-12830.8,-12.1428], Tmin=(1109.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.2883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)_1917_ring)"""),
)
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976889,0.0721969,-9.62866e-05,6.92416e-08,-2.02784e-11,-95909.9,23.5735], Tmin=(100,'K'), Tmax=(827.872,'K')), NASAPolynomial(coeffs=[10.4069,0.0266307,-1.37199e-05,2.7474e-09,-1.96958e-13,-97471.1,-20.1388], Tmin=(827.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-798.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + ring(Cs-Cs(F)-O2s)"""),
)
...
"""),
    E0 = (-192.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,2950,1000,190,488,555,1236,1407,292.735,292.742,292.743,292.75,1665.48,1665.51,1665.52],'cm^-1')),
        HinderedRotor(inertia=(0.145012,'amu*angstrom^2'), symmetry=1, barrier=(8.81945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145017,'amu*angstrom^2'), symmetry=1, barrier=(8.81943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883541,0.0788269,-0.000142986,1.35742e-07,-4.9567e-11,-22996.2,25.4121], Tmin=(100,'K'), Tmax=(822.093,'K')), NASAPolynomial(coeffs=[6.89054,0.029493,-1.62848e-05,3.24531e-09,-2.27594e-13,-23304.5,1.74089], Tmin=(822.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)
...
species(
    label = 'FC(F)=C(F)C1(F)[CH]O1(2788)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-614.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,467,575,827,1418,2950,1000,182,240,577,636,1210,1413,368.522,368.523,368.525,368.526,368.526,368.527,540.015,1427.51,1427.51,4000],'cm^-1')),
        HinderedRotor(inertia=(0.237372,'amu*angstrom^2'), symmetry=1, barrier=(22.8762,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774487,0.0758091,-0.000105841,7.41695e-08,-2.05677e-11,-73805,24.5005], Tmin=(100,'K'), Tmax=(882.278,'K')), NASAPolynomial(coeffs=[13.1418,0.0197365,-1.0505e-05,2.12882e-09,-1.53599e-13,-75987.2,-33.6152], Tmin=(882.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-614.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + ring(Cs-Cs(F)-O2s) + radical(CCsJO)"""),
)
...
"""),
    E0 = (-239.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,2950,1000,161,297,490,584,780,1358,740.171,740.18,740.204,740.21,740.21,740.214,740.218],'cm^-1')),
        HinderedRotor(inertia=(0.000307716,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29148,0.0510006,-4.67919e-05,2.02809e-08,-3.40617e-12,-28753.4,25.6074], Tmin=(100,'K'), Tmax=(1450.36,'K')), NASAPolynomial(coeffs=[16.0885,0.0101907,-4.58455e-06,8.79756e-10,-6.19124e-14,-33045.5,-51.2811], Tmin=(1450.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + ring(Cd(Cd-F)-Cs-O2s) + radical(C=CCJO) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847292,0.0771081,-0.000124447,1.11667e-07,-3.97289e-11,-65963.2,29.0705], Tmin=(100,'K'), Tmax=(805.573,'K')), NASAPolynomial(coeffs=[7.67017,0.0310444,-1.59855e-05,3.13063e-09,-2.18777e-13,-66667.1,0.0832134], Tmin=(805.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)C(F)[C]1OC1F(2772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00965,0.071106,-9.23052e-05,6.42511e-08,-1.82005e-11,-72058.9,25.9103], Tmin=(100,'K'), Tmax=(854.922,'K')), NASAPolynomial(coeffs=[10.6321,0.0260865,-1.33196e-05,2.66077e-09,-1.90686e-13,-73704.2,-19.0045], Tmin=(854.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-599.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + ring(Cs(C-F)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'F[C](F)[CH]C1(F)OC1F(2793)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37155,0.0589915,-5.65898e-05,2.7609e-08,-5.48832e-12,-66818.9,27.9727], Tmin=(100,'K'), Tmax=(1190.49,'K')), NASAPolynomial(coeffs=[12.0737,0.0230327,-1.12825e-05,2.23725e-09,-1.60317e-13,-69367,-25.5251], Tmin=(1190.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(Cs(F)(C)-Cs-O2s) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'FC(F)(F)[CH]C1(F)[CH]O1(2794)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23246,0.0609288,-6.13712e-05,3.13431e-08,-6.44015e-12,-70686.1,27.216], Tmin=(100,'K'), Tmax=(1165.98,'K')), NASAPolynomial(coeffs=[12.8771,0.020981,-9.97947e-06,1.95916e-09,-1.39877e-13,-73401.6,-30.7506], Tmin=(1165.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-588.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFF) + ring(Cs(F)(C)-Cs-O2s) + radical(CCJCO) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['CHFCF2(54)', 'FC1=CO1(390)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(88.1735,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['F[C](F)C1O[CH]C1(F)F(2782)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(42)', 'F[CH]C1(F)[CH]O1(2783)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['FC(F)=C(F)C1(F)CO1(2785)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[C](F)C(F)[C](F)F(2786)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)C1=CO1(2787)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(16.5698,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC(F)=CC1(F)[CH]O1(2732)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(73.8259,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['F2(106)', 'F[C](F)C=C1[CH]O1(2733)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.6969,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[C](F)C(F)=C1[CH]O1(2789)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(261.274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CF2(87)', 'F[CH]C1(F)[CH]O1(2783)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['F[C](F)[C](F)C1(F)CO1(2791)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['F[C](F)C(F)[C]1OC1F(2772)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['FC([C]1[CH]O1)C(F)(F)F(2792)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(191.864,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['F[C](F)[CH]C1(F)OC1F(2793)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.466,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(2761)'],
    products = ['FC(F)(F)[CH]C1(F)[CH]O1(2794)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(5.38157e+14,'s^-1'), n=-0.447076, Ea=(157.397,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R"""),
)

network(
    label = 'PDepNetwork #1056',
    isomers = [
        'F[C](F)C(F)C1(F)[CH]O1(2761)',
    ],
    reactants = [
