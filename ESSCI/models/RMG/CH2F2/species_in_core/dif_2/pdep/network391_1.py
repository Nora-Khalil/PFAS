...
reaction(
    label = 'reaction1',
    reactants = ['HF(38)', 'CF2(87)'],
    products = ['CHF3(41)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00398081,'cm^3/(mol*s)'), n=4.16158, Ea=(55.7474,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 3.20446, dn = +|- 0.152998, dEa = +|- 0.832608 kJ/molMatched reaction 24 CF2_r1 + FH <=> CHF3 in 1,2_Insertion_carbene/training
This reaction matched rate rule [HY_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s_4Br1sCl1sF1sI1s->F1s]
family: 1,2_Insertion_carbene"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'CHF2(81)'],
    products = ['CHF3(41)'],
    transitionState = 'TS2',
