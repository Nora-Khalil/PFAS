...
"""),
    E0 = (-399.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,256.272,256.779],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11598,0.0403099,-3.4444e-05,1.37729e-08,-2.18373e-12,-47931.1,16.8767], Tmin=(100,'K'), Tmax=(1483.16,'K')), NASAPolynomial(coeffs=[12.1808,0.0131658,-6.99166e-06,1.43332e-09,-1.03785e-13,-50916.6,-35.6474], Tmin=(1483.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-447.431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,180,418.943],'cm^-1')),
        HinderedRotor(inertia=(0.587213,'amu*angstrom^2'), symmetry=1, barrier=(13.5012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56739,'amu*angstrom^2'), symmetry=1, barrier=(36.0375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67301,0.0554638,-7.94941e-05,5.80336e-08,-1.68344e-11,-53733.5,18.0279], Tmin=(100,'K'), Tmax=(842.86,'K')), NASAPolynomial(coeffs=[10.1064,0.0154401,-8.26429e-06,1.69269e-09,-1.22859e-13,-55155.1,-21.2167], Tmin=(842.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O][CH]C(O)(F)F(1623)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60831,0.0594658,-0.000103992,9.73311e-08,-3.5679e-11,-57854.9,18.5157], Tmin=(100,'K'), Tmax=(792.337,'K')), NASAPolynomial(coeffs=[6.81106,0.0221068,-1.2265e-05,2.48179e-09,-1.76433e-13,-58331.2,-3.17603], Tmin=(792.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-481.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O][C](F)COF(1624)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.277968,'amu*angstrom^2'), symmetry=1, barrier=(6.39103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278877,'amu*angstrom^2'), symmetry=1, barrier=(6.41192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25476,0.071887,-0.000145172,1.38303e-07,-4.8476e-11,-11429.1,20.671], Tmin=(100,'K'), Tmax=(883.144,'K')), NASAPolynomial(coeffs=[6.96656,0.0191821,-1.00757e-05,1.91585e-09,-1.28118e-13,-11391.5,-0.250646], Tmin=(883.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.7577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-O2sHH)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C[C](F)OF(1625)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-87.3406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,180,180,1444.58],'cm^-1')),
        HinderedRotor(inertia=(0.323575,'amu*angstrom^2'), symmetry=1, barrier=(7.43963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323515,'amu*angstrom^2'), symmetry=1, barrier=(7.43825,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72606,0.0618445,-0.000124661,1.26285e-07,-4.7193e-11,-10434.1,20.6857], Tmin=(100,'K'), Tmax=(858.153,'K')), NASAPolynomial(coeffs=[3.27955,0.0267123,-1.44997e-05,2.83093e-09,-1.94633e-13,-9673.78,19.4124], Tmin=(858.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.3406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])(F)F(1171)'],
    products = ['[O]CC([O])(F)F(1546)'],
    transitionState = 'TS2',
