...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(800)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(732)'],
    products = ['[CH2]C(F)(F)O[CH]F(800)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(66)', 'F[CH]O[C](F)F(385)'],
    products = ['[CH2]C(F)(F)O[CH]F(800)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(904)'],
    products = ['[CH2]C(F)(F)O[CH]F(800)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(86)', '[CH2]C([O])(F)F(732)'],
    products = ['[CH2]C(F)(F)O[CH]F(800)'],
    transitionState = 'TS9',
