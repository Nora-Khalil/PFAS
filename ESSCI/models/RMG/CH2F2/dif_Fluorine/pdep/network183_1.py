...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(402)', '[O]C=O(142)'],
    products = ['O=COC(F)OF(568)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(248)', 'O=CO[CH]F(488)'],
    products = ['O=COC(F)OF(568)'],
