...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'CC(F)(F)OF(1242)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(85)', 'F[C]C(F)(F)OF(714)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(1140)', 'C[C]F-2(309)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(716)', 'CC(F)(F)[C]F(1243)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(72)', 'FOC(F)(F)C(F)F(1143)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(716)', 'CC(F)=C(F)F(1245)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)C(F)(F)OF(1246)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)[C](F)OF(1247)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)F(1248)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(154)', 'CC(F)(F)[C](F)F(1249)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(192)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(67)', 'FOC(F)(F)[C](F)F(723)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)OF(1148)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(106)', 'CC(F)(F)C(=O)F(919)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(106)', 'CC(F)=C(F)OF(1250)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)C(F)(F)OF(1153)'],
    products = ['CC(F)(F)C(F)(F)OF(1200)'],
...
network(
    label = 'PDepNetwork #504',
    isomers = [
        'CC(F)(F)C(F)(F)OF(1200)',
    ],
    reactants = [
