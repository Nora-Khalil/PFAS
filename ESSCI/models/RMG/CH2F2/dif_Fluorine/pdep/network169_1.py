...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(125)', '[O]O[CH]F(134)'],
    products = ['F[CH]OO[CH]F(436)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['F[CH]OO[CH]F(436)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(233.692,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 232.3 to 233.7 kJ/mol to match endothermicity of reaction."""),
)
