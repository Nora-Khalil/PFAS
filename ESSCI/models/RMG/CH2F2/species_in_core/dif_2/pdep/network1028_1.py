...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13838,0.0504726,-5.46923e-05,2.8896e-08,-5.6282e-12,6007.99,24.3087], Tmin=(100,'K'), Tmax=(1497.15,'K')), NASAPolynomial(coeffs=[13.8643,0.00599463,3.67868e-07,-2.9628e-10,2.70036e-14,3371.7,-38.3007], Tmin=(1497.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.0074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'O=C1OO[CH][C]1F(2681)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80918,0.00318453,9.47943e-05,-1.30954e-07,5.12063e-11,-27197.9,19.279], Tmin=(100,'K'), Tmax=(954.051,'K')), NASAPolynomial(coeffs=[16.17,0.00567182,-1.09942e-06,3.29938e-10,-3.81166e-14,-32409.9,-58.5046], Tmin=(954.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCCFH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Cyclopentane) + radical(CsCOCsF1s) + radical(CCsJOOC)"""),
)
...
"""),
    E0 = (-76.5505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,498.265,498.287,498.317,498.329,498.342,498.419,498.429,498.455,2544.69],'cm^-1')),
        HinderedRotor(inertia=(0.000678478,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12253,0.0361259,-3.36147e-05,1.21918e-08,-7.98428e-13,-9134.78,19.748], Tmin=(100,'K'), Tmax=(1028.31,'K')), NASAPolynomial(coeffs=[12.3372,0.00549286,-2.20557e-06,4.35426e-10,-3.26248e-14,-11716.7,-32.1567], Tmin=(1028.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.5505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cs-Cs(F)-O2s) + radical(CCsJO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13816,0.0565133,-0.000131414,1.43766e-07,-5.58413e-11,23097.1,17.8964], Tmin=(100,'K'), Tmax=(864.842,'K')), NASAPolynomial(coeffs=[-0.297264,0.0289833,-1.63797e-05,3.22411e-09,-2.21642e-13,24969.2,37.6799], Tmin=(864.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)O2s) + ring(oxirene) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C1(F)[CH]O1(2618)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C]1[CH]O1(2680)'],
    products = ['[O]C(=O)C1(F)[CH]O1(2618)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C1(F)[CH]O1(2682)'],
    products = ['[O]C(=O)C1(F)[CH]O1(2618)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C1(F)[CH]O1(2618)'],
    products = ['FC1([C]2OO2)[CH]O1(2683)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(=O)C1=CO1(2686)'],
    products = ['[O]C(=O)C1(F)[CH]O1(2618)'],
