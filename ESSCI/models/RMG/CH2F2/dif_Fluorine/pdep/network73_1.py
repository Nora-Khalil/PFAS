...
"""),
    E0 = (-265.256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31705,0.024604,2.23297e-05,-5.97747e-08,2.94237e-11,-31830.5,21.8995], Tmin=(100,'K'), Tmax=(880.75,'K')), NASAPolynomial(coeffs=[15.0476,0.00130372,3.22737e-06,-8.19483e-10,5.92185e-14,-35411.7,-45.5015], Tmin=(880.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(124trioxolane) + radical(Cs_P) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O]C([O])OC(=O)F(308)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-519.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,482,664,788,1296,1923,180,1327.89,1328,1328.08,1328.73],'cm^-1')),
        HinderedRotor(inertia=(0.00490099,'amu*angstrom^2'), symmetry=1, barrier=(6.1459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00490957,'amu*angstrom^2'), symmetry=1, barrier=(6.14863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72387,0.0520718,-0.00014069,1.84873e-07,-8.12502e-11,-62465.8,20.9132], Tmin=(100,'K'), Tmax=(838.189,'K')), NASAPolynomial(coeffs=[-11.9655,0.0570781,-3.31579e-05,6.69296e-09,-4.70899e-13,-57716.7,102.828], Tmin=(838.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(COFOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(=O)OC([O])F(309)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-535.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,180,180,652.806,652.814,652.819,652.825,652.837,652.862],'cm^-1')),
        HinderedRotor(inertia=(0.00540188,'amu*angstrom^2'), symmetry=1, barrier=(1.63361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00540417,'amu*angstrom^2'), symmetry=1, barrier=(1.63436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95692,0.0385704,-3.00624e-05,8.51085e-09,-7.85725e-14,-64382.9,22.3982], Tmin=(100,'K'), Tmax=(1119.64,'K')), NASAPolynomial(coeffs=[12.5439,0.0101884,-4.68669e-06,9.32366e-10,-6.79537e-14,-67345.4,-32.5171], Tmin=(1119.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sO2sH)) + radical(OC=OOJ)"""),
)

species(
    label = '[O]C(=O)O[C](O)F(310)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92769,0.0427599,-4.23206e-05,2.0136e-08,-3.76214e-12,-70319.7,23.1481], Tmin=(100,'K'), Tmax=(1294.54,'K')), NASAPolynomial(coeffs=[12.2834,0.0107623,-5.24531e-06,1.04308e-09,-7.50054e-14,-73000.9,-29.4856], Tmin=(1294.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-585.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    E0 = (-525.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,491.155,491.361,491.695,491.7,491.743,491.858],'cm^-1')),
        HinderedRotor(inertia=(0.0153855,'amu*angstrom^2'), symmetry=1, barrier=(2.63845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792915,'amu*angstrom^2'), symmetry=1, barrier=(13.6142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0794463,'amu*angstrom^2'), symmetry=1, barrier=(13.6143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0268,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85324,0.0439492,-5.35247e-05,2.99566e-08,-6.37671e-12,-63137.7,20.3873], Tmin=(100,'K'), Tmax=(1164.52,'K')), NASAPolynomial(coeffs=[13.526,0.00385427,-1.87881e-06,3.90192e-10,-2.93403e-14,-65856.3,-37.7051], Tmin=(1164.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-700.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([482,664,788,1296,1923,483.567,483.586,483.593,483.619,483.653,483.676,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0758601,'amu*angstrom^2'), symmetry=1, barrier=(12.5889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0758574,'amu*angstrom^2'), symmetry=1, barrier=(12.5886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.017,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96226,0.0459062,-6.24774e-05,4.00202e-08,-9.89673e-12,-84229.3,22.5369], Tmin=(100,'K'), Tmax=(996.519,'K')), NASAPolynomial(coeffs=[11.6626,0.00696918,-3.86752e-06,8.10277e-10,-5.99451e-14,-86162.6,-24.2277], Tmin=(996.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-700.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(COFOO) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'O=C(O)OF(241)'],
    products = ['O=C(O)OC(=O)F(205)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(143)', 'O=[C]O(175)'],
    products = ['O=C(O)OC(=O)F(205)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(198)'],
    products = ['O=C(O)OC(=O)F(205)'],
