...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0957398,'amu*angstrom^2'), symmetry=1, barrier=(2.20125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0957478,'amu*angstrom^2'), symmetry=1, barrier=(2.20143,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-765.379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,3025,407.5,1350,352.5,388.537,389.642],'cm^-1')),
        HinderedRotor(inertia=(0.00111739,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250846,'amu*angstrom^2'), symmetry=1, barrier=(26.8903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310831,'amu*angstrom^2'), symmetry=1, barrier=(33.2812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-726.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,180,1887.75],'cm^-1')),
        HinderedRotor(inertia=(0.342884,'amu*angstrom^2'), symmetry=1, barrier=(7.88357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345096,'amu*angstrom^2'), symmetry=1, barrier=(7.93443,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-776.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,334,575,1197,1424,3202,379.742,2045.86],'cm^-1')),
        HinderedRotor(inertia=(0.112752,'amu*angstrom^2'), symmetry=1, barrier=(11.5386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.416095,'amu*angstrom^2'), symmetry=1, barrier=(42.5815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.464703,'amu*angstrom^2'), symmetry=1, barrier=(10.6844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0088317,'amu*angstrom^2'), symmetry=1, barrier=(19.971,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'F[C]CC(F)(F)F(1435)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'OCC(F)(F)F(1134)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC=CC(F)(F)F(1110)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)(F)F(244)', 'CH2CHF(55)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[CH]CC(F)(F)F(1822)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)C[C](F)F(1823)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', 'F[CH]CC(F)(F)F(1136)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)CC(F)(F)F(1146)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[CH]F(290)', '[CH2]C(F)(F)F(1125)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF3(44)', '[CH2]C(O)F(1754)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)[CH]C(F)(F)F(1111)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[C](F)CC(F)(F)F(1436)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CCC(F)(F)F(1824)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'OC=CC(F)(F)F(1117)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'OC(F)C=C(F)F(1119)'],
    products = ['OC(F)CC(F)(F)F(1443)'],
