...
"""),
    E0 = (108.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3100,440,815,1455,1000,180,180,180,1006.64,1006.66,1006.66,1006.67,1006.69,1006.7],'cm^-1')),
        HinderedRotor(inertia=(0.00884864,'amu*angstrom^2'), symmetry=1, barrier=(6.36332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45024,0.0294548,-1.89964e-05,4.79102e-09,-1.29565e-13,13159.7,16.7562], Tmin=(100,'K'), Tmax=(1261.72,'K')), NASAPolynomial(coeffs=[9.6458,0.0122238,-5.14611e-06,9.7855e-10,-6.87871e-14,10899.7,-21.3914], Tmin=(1261.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.945832,0.0805689,-0.00015107,1.51236e-07,-5.71707e-11,-48050.8,24.6377], Tmin=(100,'K'), Tmax=(836.011,'K')), NASAPolynomial(coeffs=[3.58629,0.0378532,-2.04531e-05,4.03654e-09,-2.81201e-13,-47441,18.6592], Tmin=(836.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(oxirene)"""),
)

species(
    label = 'FC(F)=CC1OC1F(2719)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-199.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,180,180,180,180,1109.19,1145.05,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.182697,'amu*angstrom^2'), symmetry=1, barrier=(4.20057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182697,'amu*angstrom^2'), symmetry=1, barrier=(4.20057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09624,0.0768125,-0.000147131,1.47665e-07,-5.58082e-11,-23848.4,26.0315], Tmin=(100,'K'), Tmax=(834.939,'K')), NASAPolynomial(coeffs=[3.86239,0.0345439,-1.90649e-05,3.78572e-09,-2.64379e-13,-23298.9,19.2421], Tmin=(834.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(oxirene) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41033,0.0527275,-4.42509e-05,1.83465e-08,-3.04432e-12,-39187.1,26.7834], Tmin=(100,'K'), Tmax=(1427.81,'K')), NASAPolynomial(coeffs=[13.5995,0.0185797,-8.37665e-06,1.59626e-09,-1.11482e-13,-42667.9,-36.3636], Tmin=(1427.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(O2s-Cs(F)-Cs(C)) + radical(CCJCO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)

species(
    label = 'F[C](F)[CH]C1OC1F(2725)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86295,0.0490365,-3.96819e-05,1.65156e-08,-2.88335e-12,-41921.3,25.7289], Tmin=(100,'K'), Tmax=(1304.66,'K')), NASAPolynomial(coeffs=[9.73946,0.0248882,-1.19184e-05,2.32901e-09,-1.64964e-13,-43976.5,-14.3655], Tmin=(1304.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(O2s-Cs(F)-Cs(C)) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]1O[C]1CC(F)F(2726)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46178,0.0609917,-7.66374e-05,5.70646e-08,-1.7979e-11,-41578,25.2257], Tmin=(100,'K'), Tmax=(761.622,'K')), NASAPolynomial(coeffs=[7.44178,0.0295857,-1.47854e-05,2.92523e-09,-2.08349e-13,-42488.9,-1.99613], Tmin=(761.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(38.8221,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 38.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C1O[C]1F(2716)'],
    products = ['F[C](F)CC1O[C]1F(2715)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]C[C](F)F(2720)'],
    products = ['F[C](F)CC1O[C]1F(2715)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)CC1=C(F)O1(2721)'],
    products = ['F[C](F)CC1O[C]1F(2715)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C]1OC1C=C(F)F(2722)'],
    products = ['F[C](F)CC1O[C]1F(2715)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]C1O[C]1F(2716)'],
    products = ['F[C](F)CC1O[C]1F(2715)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC1O[C]1F(2715)'],
    products = ['F[C]1OC1[CH]C(F)F(2724)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1O[C]1F(2715)'],
    products = ['F[C]1O[C]1CC(F)F(2726)'],
...
network(
    label = 'PDepNetwork #1053',
    isomers = [
        'F[C](F)CC1O[C]1F(2715)',
    ],
    reactants = [
