...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73901,0.0119379,-2.69321e-07,-5.51894e-09,2.18135e-12,-55439.7,16.2342], Tmin=(298,'K'), Tmax=(1100,'K')), NASAPolynomial(coeffs=[4.5585,0.00831979,-3.37157e-06,6.18797e-10,-4.19515e-14,-56506.2,0.436637], Tmin=(1100,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-462.682,'kJ/mol'), Cp0=(33.2579,'J/mol/K'), CpInf=(108.088,'J/mol/K'), label="""CH2F2""", comment="""Thermo library: Fluorine"""),
)
...
"""),
    E0 = (-444.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,244,1102,1254,1379,1468,1475,3037,3083,311.51,311.525,311.581,311.864,312.264,1081.11],'cm^-1')),
        HinderedRotor(inertia=(0.508461,'amu*angstrom^2'), symmetry=1, barrier=(35.2311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.013012,'amu*angstrom^2'), symmetry=1, barrier=(35.233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-342.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,617,898,1187,272.748,272.748,272.749,272.75,272.751,272.752],'cm^-1')),
        HinderedRotor(inertia=(0.0759665,'amu*angstrom^2'), symmetry=1, barrier=(42.8708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812092,'amu*angstrom^2'), symmetry=1, barrier=(42.8709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812116,'amu*angstrom^2'), symmetry=1, barrier=(42.8708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45403,0.0618795,-8.54401e-05,6.43664e-08,-1.9981e-11,-41115.8,22.7554], Tmin=(100,'K'), Tmax=(778.585,'K')), NASAPolynomial(coeffs=[8.72307,0.0245348,-1.34931e-05,2.76171e-09,-2.00091e-13,-42247.8,-10.4942], Tmin=(778.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-438.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,350,440,435,1725,180,180,2398.18],'cm^-1')),
        HinderedRotor(inertia=(0.193339,'amu*angstrom^2'), symmetry=1, barrier=(4.44525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193684,'amu*angstrom^2'), symmetry=1, barrier=(4.45317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72183,'amu*angstrom^2'), symmetry=1, barrier=(39.5882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309431,0.0944826,-0.000176882,1.68519e-07,-6.08382e-11,-52578.3,27.7511], Tmin=(100,'K'), Tmax=(843.931,'K')), NASAPolynomial(coeffs=[7.2442,0.0334123,-1.82113e-05,3.58002e-09,-2.4796e-13,-52744.5,1.42153], Tmin=(843.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFFH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'FC=C(OF)OC(F)F(1231)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-759.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,194,682,905,1196,1383,3221,212.698,220.212,223.609,1786.96],'cm^-1')),
        HinderedRotor(inertia=(0.269422,'amu*angstrom^2'), symmetry=1, barrier=(9.36433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307959,'amu*angstrom^2'), symmetry=1, barrier=(9.37826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30182,'amu*angstrom^2'), symmetry=1, barrier=(35.2953,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277205,0.0903337,-0.000152959,1.34819e-07,-4.6571e-11,-91168.7,26.4865], Tmin=(100,'K'), Tmax=(806.778,'K')), NASAPolynomial(coeffs=[10.6033,0.0275885,-1.48291e-05,2.93502e-09,-2.05625e-13,-92459,-18.7848], Tmin=(806.778,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-759.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C(OF)[C](F)C(F)F(1232)',
...
"""),
    E0 = (-532.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,180,2349.9],'cm^-1')),
        HinderedRotor(inertia=(0.292869,'amu*angstrom^2'), symmetry=1, barrier=(6.73362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291737,'amu*angstrom^2'), symmetry=1, barrier=(6.7076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68755,'amu*angstrom^2'), symmetry=1, barrier=(38.8,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245488,0.0966981,-0.000183368,1.76655e-07,-6.44234e-11,-63938.9,31.8264], Tmin=(100,'K'), Tmax=(839.361,'K')), NASAPolynomial(coeffs=[6.9036,0.0349624,-1.94187e-05,3.84677e-09,-2.6768e-13,-63999.6,7.16736], Tmin=(839.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(OF)C(F)[C](F)F(1233)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-521.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,180,2223.14],'cm^-1')),
        HinderedRotor(inertia=(0.214806,'amu*angstrom^2'), symmetry=1, barrier=(4.93881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215524,'amu*angstrom^2'), symmetry=1, barrier=(4.95532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63689,'amu*angstrom^2'), symmetry=1, barrier=(37.6353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.223312,0.0967321,-0.00018202,1.74227e-07,-6.33043e-11,-62626.6,31.1993], Tmin=(100,'K'), Tmax=(837.373,'K')), NASAPolynomial(coeffs=[7.31734,0.0343015,-1.9056e-05,3.77779e-09,-2.63106e-13,-62814,4.20915], Tmin=(837.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-521.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OF)C(F)[C](F)F(1234)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-542.187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,259,529,569,1128,1321,1390,3140,360,370,350,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.144951,'amu*angstrom^2'), symmetry=1, barrier=(3.3327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145564,'amu*angstrom^2'), symmetry=1, barrier=(3.34679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144937,'amu*angstrom^2'), symmetry=1, barrier=(3.33239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944568,'amu*angstrom^2'), symmetry=1, barrier=(21.7175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0806149,0.0999335,-0.000179031,1.59594e-07,-5.46915e-11,-65072.9,32.1194], Tmin=(100,'K'), Tmax=(833.588,'K')), NASAPolynomial(coeffs=[11.8074,0.0255823,-1.40984e-05,2.78279e-09,-1.93279e-13,-66453.6,-19.4633], Tmin=(833.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(OF)=C(F)C(F)F(1235)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48049,0.0611912,-7.65879e-05,5.34459e-08,-1.56082e-11,-65455.6,24.1556], Tmin=(100,'K'), Tmax=(820.288,'K')), NASAPolynomial(coeffs=[8.45043,0.0272024,-1.44333e-05,2.92997e-09,-2.11926e-13,-66599,-8.08937], Tmin=(820.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-544.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCJCO)"""),
)

species(
    label = 'O=C(OF)C(F)[CH]F(1237)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-819.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,235,523,627,1123,1142,1372,1406,3097,490.431,490.439,490.466,490.473,490.52,490.527,490.537],'cm^-1')),
        HinderedRotor(inertia=(0.000700803,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000700823,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5204,0.0606754,-8.83295e-05,8.0925e-08,-3.122e-11,-98477.3,22.4386], Tmin=(100,'K'), Tmax=(724.098,'K')), NASAPolynomial(coeffs=[5.34974,0.0330546,-1.77148e-05,3.57671e-09,-2.56379e-13,-98862.3,6.37122], Tmin=(724.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-273.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,235,1215,1347,1486,3221,343.237,343.409,343.424,343.463,343.475,343.877],'cm^-1')),
        HinderedRotor(inertia=(0.00142935,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.544718,'amu*angstrom^2'), symmetry=1, barrier=(45.5807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-712.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,180,233,1109,1254,1325,1339,3290,190,488,555,1236,1407,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.616963,0.0814151,-0.000123747,9.84363e-08,-3.14673e-11,-85580.1,25.9666], Tmin=(100,'K'), Tmax=(764.097,'K')), NASAPolynomial(coeffs=[11.2687,0.0256497,-1.42655e-05,2.90692e-09,-2.09143e-13,-87207.7,-22.555], Tmin=(764.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sCOH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292473,'amu*angstrom^2'), symmetry=1, barrier=(6.72454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293381,'amu*angstrom^2'), symmetry=1, barrier=(6.7454,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21695,0.0441443,-7.46453e-05,7.01077e-08,-2.62067e-11,-41419.2,17.5915], Tmin=(100,'K'), Tmax=(766.154,'K')), NASAPolynomial(coeffs=[5.89323,0.018029,-9.96403e-06,2.03336e-09,-1.45832e-13,-41779.3,2.16063], Tmin=(766.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)C(F)F(1186)'],
    products = ['HF(38)', 'CO2(13)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.6215,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'FOC(F)C(F)F(924)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(214.071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'O=C([C]F)OF(814)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.67744e-07,'m^3/(mol*s)'), n=3.38172, Ea=(51.1185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CF2(89)', 'O=C(CF)OF(1226)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(115.729,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(OF)C(F)[C]F(1227)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(88)', 'O=C(OF)C(F)F(1198)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.9233e-06,'m^3/(mol*s)'), n=3.30609, Ea=(141.692,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['FOF(577)', 'O=C=CC(F)F(1228)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(155)', 'O=C=C(F)C(F)F(1229)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOC(=CC(F)F)OF(1230)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.7779e+11,'s^-1'), n=0.725184, Ea=(123.56,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['FC=C(OF)OC(F)F(1231)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(94.8615,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]C(OF)[C](F)C(F)F(1232)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C(F)[C](F)F(1233)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C(F)[C](F)F(1234)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OC(OF)=C(F)C(F)F(1235)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(153.047,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C([CH]C(F)F)OF(1236)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(OF)C(F)[CH]F(1237)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(=O)C(F)C(F)F(1238)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(156)', 'O=[C]C(F)C(F)F(1239)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(81)', 'O=C([CH]F)OF(1240)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(192)', 'CHF2-CHF(66)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(OF)[C](F)C(F)F(1241)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(OF)C(F)[C](F)F(1242)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(108)', 'O=C(C=CF)OF(1243)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(OF)C(F)=CF(1211)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(C=C(F)F)OF(1244)'],
    products = ['O=C(OF)C(F)C(F)F(1186)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(OF)C(F)C(F)F(1186)'],
    products = ['F2(108)', 'CO2(13)', 'CHFCHF[Z](97)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(252.815,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #448',
    isomers = [
        'O=C(OF)C(F)C(F)F(1186)',
    ],
    reactants = [
