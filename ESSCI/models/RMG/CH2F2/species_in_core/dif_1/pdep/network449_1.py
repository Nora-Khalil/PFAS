...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)(F)CF(1187)'],
    products = ['HF(38)', 'CO2(13)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(35.2015,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'FCC(F)(F)OF(891)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(7)', 'O=C(OF)C(F)(F)[C]F(1197)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['O=C(OF)C(F)(F)CF(1187)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(20.3837,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(74)', 'O=C(OF)C(F)(F)F(1199)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(577)', 'O=C=C(F)CF(1200)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)C(F)(F)[CH]F(1203)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C](OF)C(F)(F)[CH]F(1204)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(OF)[C](F)CF(1205)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)OF(1206)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)CF(1207)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(156)', 'O=[C]C(F)(F)CF(1208)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(91)', 'O=C(OF)[C](F)F(822)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(192)', 'CH2F-CF2(67)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[CH]F(1209)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(108)', 'C=C(F)C(=O)OF(1210)'],
    products = ['O=C(OF)C(F)(F)CF(1187)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(OF)C(F)(F)CF(1187)'],
    products = ['F2(108)', 'CO2(13)', 'CH2CF2(56)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(222.362,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

network(
    label = 'PDepNetwork #449',
    isomers = [
        'O=C(OF)C(F)(F)CF(1187)',
    ],
    reactants = [
