...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(224)', '[O]C([O])F(138)'],
    products = ['[O]C(F)O[C]=O(654)'],
    transitionState = 'TS2',
