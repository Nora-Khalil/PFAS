...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24303,0.0519203,-4.44338e-05,1.32635e-08,7.50802e-15,-153959,23.1546], Tmin=(100,'K'), Tmax=(1069.42,'K')), NASAPolynomial(coeffs=[16.6859,0.00868953,-4.17866e-06,8.74345e-10,-6.64283e-14,-158093,-56.2699], Tmin=(1069.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1280.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFFO) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdOsOs)"""),
)
...
"""),
    E0 = (-805.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,1380,1390,370,380,2900,435,1772.58,1773.2,1773.84,1774.64,1774.7],'cm^-1')),
        HinderedRotor(inertia=(0.228318,'amu*angstrom^2'), symmetry=1, barrier=(5.24949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228346,'amu*angstrom^2'), symmetry=1, barrier=(5.25013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15166,0.068826,-0.000180559,2.24699e-07,-9.51239e-11,-96815.1,23.1012], Tmin=(100,'K'), Tmax=(848.175,'K')), NASAPolynomial(coeffs=[-11.9745,0.0610489,-3.52344e-05,7.05922e-09,-4.93149e-13,-91742.8,104.701], Tmin=(848.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-1037.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,328.726,328.821,329.313,329.561,329.662,996.406,1523.87,3535.27],'cm^-1')),
        HinderedRotor(inertia=(0.0178334,'amu*angstrom^2'), symmetry=1, barrier=(29.4108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.383035,'amu*angstrom^2'), symmetry=1, barrier=(29.4308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72566,0.0474764,-4.9647e-05,2.47345e-08,-4.81533e-12,-124666,21.8976], Tmin=(100,'K'), Tmax=(1248.22,'K')), NASAPolynomial(coeffs=[13.2227,0.0106331,-5.37146e-06,1.08694e-09,-7.90196e-14,-127536,-36.1178], Tmin=(1248.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFFO) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    ...
    products = ['O=C(O)OC(F)(F)F(334)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(21.256,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]C([O])OC(F)(F)F(555)'],
    products = ['O=C(O)OC(F)(F)F(334)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(556)'],
    products = ['O=C(O)OC(F)(F)F(334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'O=[C]OC(F)(F)F(557)'],
    products = ['O=C(O)OC(F)(F)F(334)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(558)'],
    products = ['O=C(O)OC(F)(F)F(334)'],
    transitionState = 'TS8',
