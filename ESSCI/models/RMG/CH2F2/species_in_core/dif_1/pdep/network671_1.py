species(
    label = 'F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)',
...
species(
    label = 'FC1(F)C(F)(F)C(F)(F)C1(F)F(1582)',
...
species(
    label = 'F[C](F)C(F)(F)[C](F)C(F)(F)F(1583)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'F[C](F)[C](F)C(F)(F)C(F)(F)F(1584)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'F[C](F)C(F)(F)[C](F)F(617)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    products = ['FC1(F)C(F)(F)C(F)(F)C1(F)F(1582)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C(F)=C(F)F(772)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2CF2(60)', 'F[C](F)[C](F)F(315)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.61741e-05,'m^3/(mol*s)'), n=3.0961, Ea=(1.66919,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(315)', 'F[C](F)[C](F)F(315)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(108)', 'F[C](F)C(F)=C(F)[C](F)F(773)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(89)', 'F[C](F)C(F)(F)[C](F)F(617)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    products = ['F[C](F)C(F)(F)[C](F)C(F)(F)F(1583)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(1581)'],
    products = ['F[C](F)[C](F)C(F)(F)C(F)(F)F(1584)'],
