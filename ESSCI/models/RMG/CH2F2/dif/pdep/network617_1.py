...
"""),
    E0 = (-175.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,493,600,700,1144,1293],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95939,0.0464415,-5.55906e-05,3.41278e-08,-8.33023e-12,-21081.2,18.3334], Tmin=(100,'K'), Tmax=(996.975,'K')), NASAPolynomial(coeffs=[10.0992,0.0137832,-6.45439e-06,1.27092e-09,-9.10575e-14,-22704.3,-20.912], Tmin=(996.975,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsJOOC) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(171)', 'CH2(T)(17)'],
    products = ['[CH2]OO[C](F)F(1549)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]OO[C](F)F(1549)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(198.86,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['[CH2]OO[C](F)F(1549)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(27.5626,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    ...
    products = ['[CH2]OO[C](F)F(1549)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(15.5348,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

network(
    label = 'PDepNetwork #617',
    isomers = [
        '[CH2]OO[C](F)F(1549)',
    ],
    reactants = [
