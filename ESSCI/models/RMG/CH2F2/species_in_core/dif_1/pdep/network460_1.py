...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.296264,'amu*angstrom^2'), symmetry=1, barrier=(6.81169,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41749,0.0445695,-9.60421e-05,9.84609e-08,-3.64119e-11,-2891.1,20.2577], Tmin=(100,'K'), Tmax=(877.916,'K')), NASAPolynomial(coeffs=[3.16549,0.0174566,-9.21537e-06,1.77091e-09,-1.19714e-13,-2108.93,21.9492], Tmin=(877.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(C=CJO)"""),
)
...
reaction(
    ...
    products = ['[O]OC=C(F)F(353)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(10.5311,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C[C](F)F(1007)'],
    products = ['[O]OC=C(F)F(353)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(353)'],
    products = ['FC1(F)[CH]OO1(686)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(1319)'],
    products = ['[O]OC=C(F)F(353)'],
    transitionState = 'TS6',
