...
"""),
    E0 = (134.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3000,3100,440,815,1455,1000,289.419],'cm^-1')),
        HinderedRotor(inertia=(0.00200946,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00201129,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94138,0.0233296,-2.00299e-05,8.75637e-09,-1.5647e-12,16176.6,12.1985], Tmin=(100,'K'), Tmax=(1308.54,'K')), NASAPolynomial(coeffs=[7.34112,0.00988036,-4.61294e-06,9.01902e-10,-6.40904e-14,15025.2,-10.2109], Tmin=(1308.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsJOO)"""),
)
