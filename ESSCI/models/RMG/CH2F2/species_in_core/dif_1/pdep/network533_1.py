...
reaction(
    label = 'reaction2',
    reactants = ['CF2(89)', 'O=C(O)O(1432)'],
    products = ['O=C(O)OC(F)F(1391)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(1436)'],
    products = ['O=C(O)OC(F)F(1391)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(146)', 'O=[C]O(191)'],
    products = ['O=C(O)OC(F)F(1391)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(841)'],
    products = ['O=C(O)OC(F)F(1391)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(850)'],
    products = ['O=C(O)OC(F)F(1391)'],
