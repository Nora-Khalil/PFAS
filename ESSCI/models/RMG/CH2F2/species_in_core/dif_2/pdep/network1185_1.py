...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309856,'amu*angstrom^2'), symmetry=1, barrier=(7.12421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309749,'amu*angstrom^2'), symmetry=1, barrier=(7.12174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50473,'amu*angstrom^2'), symmetry=1, barrier=(34.5966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38697,0.0874272,-0.000150069,1.30343e-07,-4.37397e-11,-63056.4,29.6426], Tmin=(100,'K'), Tmax=(841.728,'K')), NASAPolynomial(coeffs=[11.1032,0.0232436,-1.20629e-05,2.32641e-09,-1.59663e-13,-64390.8,-17.4208], Tmin=(841.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(OCJC=O) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18979,0.06876,-0.000116654,1.0446e-07,-3.65898e-11,-83044.2,25.0026], Tmin=(100,'K'), Tmax=(814.666,'K')), NASAPolynomial(coeffs=[8.23151,0.0231371,-1.23084e-05,2.42389e-09,-1.69278e-13,-83824.9,-5.27613], Tmin=(814.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsFFHO) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240085,0.0944961,-0.000177935,1.64565e-07,-5.77082e-11,-98477,30.1212], Tmin=(100,'K'), Tmax=(846.445,'K')), NASAPolynomial(coeffs=[9.73283,0.025975,-1.45766e-05,2.87722e-09,-1.99055e-13,-99236.4,-9.08616], Tmin=(846.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)OC(F)F(3050)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401069,0.0900648,-0.000165969,1.52713e-07,-5.35152e-11,-94642.5,29.1641], Tmin=(100,'K'), Tmax=(844.632,'K')), NASAPolynomial(coeffs=[9.3055,0.0263092,-1.44085e-05,2.82901e-09,-1.95548e-13,-95376.7,-7.73301], Tmin=(844.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-787.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C=C(OF)O[C](F)F(3051)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-446.997,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,379.582,380.058,380.454,380.536,380.731],'cm^-1')),
        HinderedRotor(inertia=(0.195087,'amu*angstrom^2'), symmetry=1, barrier=(20.0605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195195,'amu*angstrom^2'), symmetry=1, barrier=(20.0564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19512,'amu*angstrom^2'), symmetry=1, barrier=(20.0595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15923,0.0806932,-0.000103663,6.1601e-08,-1.39366e-11,-53619.7,28.9967], Tmin=(100,'K'), Tmax=(1096.56,'K')), NASAPolynomial(coeffs=[20.2344,0.00746231,-3.48724e-06,6.97205e-10,-5.11859e-14,-58022.4,-69.7047], Tmin=(1096.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[O]C=C([O])OC(F)(F)F(3052)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]OF)O[C](F)F(3040)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(42)', '[O]C([O])(F)C=O(3041)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    products = ['F[C](F)OC1(F)[CH]OO1(3043)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    products = ['[O]C1OC1(F)O[C](F)F(3045)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)O[C](F)F(3047)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(14)', 'O=C(F)O[C](F)F(300)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(87)', '[O]C([O])(F)C=O(3041)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    products = ['O=[C]C(O)(F)O[C](F)F(3049)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    products = ['[O]C(F)([C]=O)OC(F)F(3050)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C(OF)O[C](F)F(3051)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3010)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3010)'],
    products = ['[O]C=C([O])OC(F)(F)F(3052)'],
