...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(329)'],
    products = ['OOC(F)(F)OF(1424)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]OC(F)(F)OF(1428)'],
    products = ['OOC(F)(F)OF(1424)'],
    transitionState = 'TS5',
