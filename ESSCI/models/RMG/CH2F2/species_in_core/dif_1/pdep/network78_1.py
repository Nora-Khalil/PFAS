...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(224)', '[O]C([O])=O(237)'],
    products = ['[O]C(=O)O[C]=O(239)'],
    transitionState = 'TS2',
