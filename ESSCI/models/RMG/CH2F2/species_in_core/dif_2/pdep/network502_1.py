...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(1238)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(1239)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'F[CH]OC(F)(F)F(1240)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(1241)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(768)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(525)'],
    products = ['OC(F)OC(F)(F)F(1198)'],
