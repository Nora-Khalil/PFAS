...
"""),
    E0 = (376.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,230.46,230.461,230.461],'cm^-1')),
        HinderedRotor(inertia=(1.3399,'amu*angstrom^2'), symmetry=1, barrier=(50.5001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (40.0638,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.31908,0.00818003,3.3472e-05,-4.36173e-08,1.58204e-11,45331.5,10.639], Tmin=(100,'K'), Tmax=(983.768,'K')), NASAPolynomial(coeffs=[5.36769,0.0170741,-6.35094e-06,1.16616e-09,-8.27593e-14,44095,-3.44685], Tmin=(983.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30647,0.0418717,-2.81082e-05,1.06804e-08,-1.91512e-12,-8020.11,18.4604], Tmin=(100,'K'), Tmax=(1145.42,'K')), NASAPolynomial(coeffs=[5.26178,0.0315513,-1.45928e-05,2.81408e-09,-1.98194e-13,-8697.13,3.80152], Tmin=(1145.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
"""),
    E0 = (51.0975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.392452,'amu*angstrom^2'), symmetry=1, barrier=(9.02325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393687,'amu*angstrom^2'), symmetry=1, barrier=(9.05163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60102,0.0609928,-0.000104094,9.89818e-08,-3.61862e-11,6224.05,19.9915], Tmin=(100,'K'), Tmax=(840.096,'K')), NASAPolynomial(coeffs=[4.91191,0.0278234,-1.37932e-05,2.6609e-09,-1.83694e-13,6281.94,8.25078], Tmin=(840.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.0975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=C[C](F)F(2842)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05802,0.0423918,-3.42921e-05,1.44652e-08,-2.5163e-12,-15278.4,18.6649], Tmin=(100,'K'), Tmax=(1334.78,'K')), NASAPolynomial(coeffs=[9.67852,0.0195551,-8.62851e-06,1.64723e-09,-1.15538e-13,-17312.7,-20.3001], Tmin=(1334.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH]C=C(2836)'],
    products = ['[CH]=CC[C](F)F(2804)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(87)', '[CH]C=C(2836)'],
    products = ['[CH]=CC[C](F)F(2804)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(9.35743,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH]=CC[C](F)F(2804)'],
    products = ['[CH]C=CC(F)F(2839)'],
