...
"""),
    E0 = (-894.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,580,1155,1237,1373,3147,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.186272,'amu*angstrom^2'), symmetry=1, barrier=(4.28275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18691,'amu*angstrom^2'), symmetry=1, barrier=(4.29742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564148,'amu*angstrom^2'), symmetry=1, barrier=(12.9709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281414,0.0951532,-0.000183303,1.74386e-07,-6.25753e-11,-107426,28.2981], Tmin=(100,'K'), Tmax=(843.182,'K')), NASAPolynomial(coeffs=[8.32142,0.0291716,-1.63953e-05,3.2612e-09,-2.26925e-13,-107793,-3.25027], Tmin=(843.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.20022,0.0946861,-0.000176128,1.60613e-07,-5.55477e-11,-109467,27.8519], Tmin=(100,'K'), Tmax=(849.842,'K')), NASAPolynomial(coeffs=[10.5504,0.0241644,-1.31663e-05,2.58443e-09,-1.78257e-13,-110438,-15.7648], Tmin=(849.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-911.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'F[C](F)[C](F)OC(F)F(454)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[C](F)F(597)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'F[CH]O[C](F)F(385)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CHFO(46)', 'F[C](F)[C](F)F(230)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(59.8855,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=C(F)F(669)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(36.3013,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['[O][CH]F(168)', 'CF2CF2(60)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(4.84663,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(168)', 'F[C](F)[C](F)F(230)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(87)', 'F[CH]O[C](F)F(385)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(86)', '[O]C(F)(F)[C](F)F(303)'],
    products = ['F[CH]OC(F)(F)[C](F)F(597)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OC(F)(F)[C](F)F(597)'],
    products = ['F[C](F)[C](F)OC(F)F(454)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(225.27,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #278',
    isomers = [
        'F[CH]OC(F)(F)[C](F)F(597)',
    ],
    reactants = [
        ('CHFO(46)', 'CF2CF2(60)'),
    ],
