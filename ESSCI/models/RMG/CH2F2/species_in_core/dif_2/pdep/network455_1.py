...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42903,'amu*angstrom^2'), symmetry=1, barrier=(32.8563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4231,'amu*angstrom^2'), symmetry=1, barrier=(32.7199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83524,0.0523491,-8.08091e-05,6.10375e-08,-1.70153e-11,-381.774,17.3643], Tmin=(100,'K'), Tmax=(651.637,'K')), NASAPolynomial(coeffs=[9.16562,0.0139224,-7.47844e-06,1.48788e-09,-1.05052e-13,-1476.62,-15.9315], Tmin=(651.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.78554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(Cdj(Cd-O2sH)(F1s)) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (31.4452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,1855,455,950,239,401,1367,267.104,267.235],'cm^-1')),
        HinderedRotor(inertia=(0.865062,'amu*angstrom^2'), symmetry=1, barrier=(43.9007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867839,'amu*angstrom^2'), symmetry=1, barrier=(43.906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0291,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.498,0.0367727,-4.40752e-05,2.68441e-08,-6.71397e-12,3832.97,14.3933], Tmin=(100,'K'), Tmax=(953.812,'K')), NASAPolynomial(coeffs=[7.95071,0.0139061,-8.11501e-06,1.71028e-09,-1.26357e-13,2792.77,-11.6551], Tmin=(953.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.4452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-OdOsH) + group(Ct-CtOs) + group(CtCF) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (39.5101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,180,3171.56],'cm^-1')),
        HinderedRotor(inertia=(1.48752,'amu*angstrom^2'), symmetry=1, barrier=(34.2011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47921,'amu*angstrom^2'), symmetry=1, barrier=(34.01,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12716,0.0481779,-8.79433e-05,8.61314e-08,-3.23936e-11,4812.62,20.7984], Tmin=(100,'K'), Tmax=(817.83,'K')), NASAPolynomial(coeffs=[4.70837,0.02108,-1.16968e-05,2.33868e-09,-1.64508e-13,4874.44,11.8238], Tmin=(817.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.5101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(C=CJO) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(222)', 'O=C[C]F-2(964)'],
    products = ['O=[C]OC=[C]F(1050)'],
    transitionState = 'TS2',
