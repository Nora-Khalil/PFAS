...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[O](317)'],
    products = ['O=O(177)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(171)', 'CH2(T)(66)'],
    products = ['[CH2]C(F)(F)O[O](317)'],
    transitionState = 'TS3',
