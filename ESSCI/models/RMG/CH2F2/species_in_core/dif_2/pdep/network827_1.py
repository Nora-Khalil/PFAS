...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](157)', 'CH2(T)(66)'],
    products = ['[CH2]OO[O](1576)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.62e+09,'s^-1'), n=1.1, Ea=(133.47,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R2OO;C_pri_rad_intra;OOJ]
Euclidian distance = 0
