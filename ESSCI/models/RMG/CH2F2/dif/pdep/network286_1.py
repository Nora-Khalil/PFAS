...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441325,0.0895944,-0.000166498,1.55641e-07,-5.5468e-11,-107913,29.8635], Tmin=(100,'K'), Tmax=(833.83,'K')), NASAPolynomial(coeffs=[8.77725,0.0275691,-1.52767e-05,3.04059e-09,-2.12337e-13,-108537,-4.24401], Tmin=(833.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)O[CH]C(F)(F)F(734)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.732008,0.077186,-0.000111984,8.14893e-08,-2.33828e-11,-114011,28.3216], Tmin=(100,'K'), Tmax=(854.585,'K')), NASAPolynomial(coeffs=[13.1239,0.0191841,-1.01773e-05,2.06978e-09,-1.49515e-13,-116129,-29.5151], Tmin=(854.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-948.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)[C](F)F(701)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(166)', '[O]C(F)[C](F)F(402)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(166)', 'F[CH]O[C](F)F(394)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(70.72,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OC=C(F)F(730)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(14.9255,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)OC(F)=C(F)F(731)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', 'F[CH]O[C](F)F(394)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(42)', '[O]C(F)[C](F)F(402)'],
    products = ['F[C](F)OC(F)[C](F)F(701)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(6.82532,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F[C](F)OC(F)[C](F)F(701)'],
    products = ['F[C](F)O[C](F)C(F)F(732)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)OC(F)[C](F)F(701)'],
    products = ['F[C](F)O[CH]C(F)(F)F(734)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)OC(F)[C](F)F(701)'],
    products = ['F[C](F)[CH]OC(F)(F)F(735)'],
