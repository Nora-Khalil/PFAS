...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.119778,'amu*angstrom^2'), symmetry=1, barrier=(2.75393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119546,'amu*angstrom^2'), symmetry=1, barrier=(2.7486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610518,'amu*angstrom^2'), symmetry=1, barrier=(14.037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884374,0.074619,-0.000115061,9.25206e-08,-2.96635e-11,-88740,25.7867], Tmin=(100,'K'), Tmax=(764.042,'K')), NASAPolynomial(coeffs=[10.9401,0.0219805,-1.17318e-05,2.37193e-09,-1.69949e-13,-90276.8,-20.0215], Tmin=(764.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-738.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.290856,'amu*angstrom^2'), symmetry=1, barrier=(6.68736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290785,'amu*angstrom^2'), symmetry=1, barrier=(6.68572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290916,'amu*angstrom^2'), symmetry=1, barrier=(6.68874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641233,0.0869314,-0.000168229,1.60801e-07,-5.74532e-11,-82452.4,26.9868], Tmin=(100,'K'), Tmax=(860.074,'K')), NASAPolynomial(coeffs=[7.10823,0.0279479,-1.49452e-05,2.90848e-09,-1.99372e-13,-82495.6,2.97763], Tmin=(860.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)F(1202)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759949,0.0778027,-0.000129921,1.11696e-07,-3.7493e-11,-90837.4,26.8024], Tmin=(100,'K'), Tmax=(815.072,'K')), NASAPolynomial(coeffs=[10.6458,0.0211945,-1.08496e-05,2.12188e-09,-1.47738e-13,-92180.1,-17.2203], Tmin=(815.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-756.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)F(1174)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(1174)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'F[C](F)O[C](F)F(273)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1174)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[C](F)F(1200)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1174)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)O[C](F)F(1174)'],
    products = ['[CH2][C](F)OC(F)(F)F(1202)'],
...
network(
    label = 'PDepNetwork #436',
    isomers = [
        '[CH2]C(F)(F)O[C](F)F(1174)',
    ],
    reactants = [
        ('CF2O(48)', 'CH2CF2(56)'),
    ],
