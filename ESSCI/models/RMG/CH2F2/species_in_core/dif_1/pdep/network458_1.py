...
reaction(
    label = 'reaction3',
    reactants = ['CF2(89)', 'OCC(F)(F)F(1379)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(183.866,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OF(155)', 'F[C]CC(F)(F)F(1380)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(89)', 'OC(F)(F)CF(319)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(234.233,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC(F)=CC(F)(F)F(857)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)CC(F)(F)F(1381)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)C[C](F)F(1382)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(4)', 'F[C](F)CC(F)(F)F(1383)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)CC(F)(F)F(473)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(220)', '[CH2]C(F)(F)F(962)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF3(44)', '[CH2]C(O)(F)F(1176)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]C(F)(F)F(1274)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)CC(F)(F)F(1384)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'OC(F)=CC(F)(F)F(1280)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'OC(F)(F)C=C(F)F(912)'],
    products = ['OC(F)(F)CC(F)(F)F(1195)'],
...
network(
    ...
    isomers = [
        'OC(F)(F)CC(F)(F)F(1195)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CH2CF2(56)'),
        ('O[C](F)F(220)', '[CH2]C(F)(F)F(962)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
