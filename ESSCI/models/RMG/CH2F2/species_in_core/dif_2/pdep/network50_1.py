...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)F(163)'],
    products = ['[O]OOOC(F)F(206)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)F(206)'],
    products = ['[O-][O+]=O(225)', '[O]C(F)F(170)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](157)', '[O]C(F)F(170)'],
    products = ['[O]OOOC(F)F(206)'],
    transitionState = 'TS7',
