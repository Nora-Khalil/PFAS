...
"""),
    E0 = (-730.051,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.48833,'amu*angstrom^2'), symmetry=1, barrier=(11.2277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.4885,'amu*angstrom^2'), symmetry=1, barrier=(11.2316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970287,'amu*angstrom^2'), symmetry=1, barrier=(22.3088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3052,'amu*angstrom^2'), symmetry=1, barrier=(30.0092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31089,'amu*angstrom^2'), symmetry=1, barrier=(30.14,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50457,0.0459929,-3.26845e-05,3.08723e-09,3.32997e-12,-75047.6,18.2146], Tmin=(100,'K'), Tmax=(1034.43,'K')), NASAPolynomial(coeffs=[15.6902,0.00860645,-3.80021e-06,7.95803e-10,-6.13638e-14,-78916.9,-55.22], Tmin=(1034.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.1737,'amu*angstrom^2'), symmetry=1, barrier=(3.99371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173647,'amu*angstrom^2'), symmetry=1, barrier=(3.99248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(428)', 'OC[C]F-2(1433)'],
    products = ['OCC(F)(F)OF(1594)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(173)', 'C=C(F)OF(1731)'],
    products = ['OCC(F)(F)OF(1594)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(1733)'],
    products = ['OCC(F)(F)OF(1594)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(228)', 'OC[C](F)F(1290)'],
    products = ['OCC(F)(F)OF(1594)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', '[CH2]C(F)(F)OF(1377)'],
    products = ['OCC(F)(F)OF(1594)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]CC(F)(F)OF(1734)'],
    products = ['OCC(F)(F)OF(1594)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(240)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(1594)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(538)'],
    products = ['OCC(F)(F)OF(1594)'],
