...
"""),
    E0 = (-210.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,290.799,293.642,307.114,618.946,1049.04,1051.49,2598.4],'cm^-1')),
        HinderedRotor(inertia=(0.558669,'amu*angstrom^2'), symmetry=1, barrier=(33.7778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856729,'amu*angstrom^2'), symmetry=1, barrier=(52.0308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38315,0.0370496,-3.35537e-05,1.57506e-08,-3.07184e-12,-25273.1,18.0921], Tmin=(100,'K'), Tmax=(1194.54,'K')), NASAPolynomial(coeffs=[8.40091,0.0168986,-8.24958e-06,1.6284e-09,-1.16251e-13,-26710.8,-12.0097], Tmin=(1194.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-456.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,241,322,589,815,1096,1220,1302,2892,180,180,180,180,180,1491.29],'cm^-1')),
        HinderedRotor(inertia=(0.00440267,'amu*angstrom^2'), symmetry=1, barrier=(6.98864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112449,'amu*angstrom^2'), symmetry=1, barrier=(57.6152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60471,0.0603045,-0.000106825,9.96817e-08,-3.5715e-11,-54814.4,20.7852], Tmin=(100,'K'), Tmax=(838.995,'K')), NASAPolynomial(coeffs=[6.24938,0.0226991,-1.19487e-05,2.32819e-09,-1.60994e-13,-55049.6,2.43581], Tmin=(838.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(O2sj(Cs-F1sCOH))"""),
)
...
"""),
    E0 = (-496.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,1855,455,950,208.474],'cm^-1')),
        HinderedRotor(inertia=(0.292188,'amu*angstrom^2'), symmetry=1, barrier=(9.0108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885173,'amu*angstrom^2'), symmetry=1, barrier=(27.2962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89998,0.0515566,-7.28208e-05,5.08343e-08,-1.1933e-11,-59631,21.257], Tmin=(100,'K'), Tmax=(609.685,'K')), NASAPolynomial(coeffs=[8.09363,0.0184069,-9.6796e-06,1.92944e-09,-1.3702e-13,-60525.4,-6.70006], Tmin=(609.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.795611,0.0771753,-0.000105804,7.74029e-08,-2.3052e-11,-38732.7,24.2444], Tmin=(100,'K'), Tmax=(814.111,'K')), NASAPolynomial(coeffs=[10.8252,0.0278969,-1.50093e-05,3.05281e-09,-2.2057e-13,-40365.8,-22.08], Tmin=(814.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(12dioxetane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)OC1C(F)F(2263)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13262,0.0698341,-0.000105275,9.42524e-08,-3.44511e-11,-63813.9,26.7746], Tmin=(100,'K'), Tmax=(771.064,'K')), NASAPolynomial(coeffs=[6.51058,0.033226,-1.71165e-05,3.38113e-09,-2.38604e-13,-64384.4,3.90609], Tmin=(771.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-531.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(CsCsFFH) + ring(Cs(C-FF)-Cs-O2s) + radical(CCOJ)"""),
)

species(
    label = '[O]C(=C(O)OF)C(F)F(2264)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-651.815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,325,375,415,465,420,450,1700,1750,329.298,329.881,330.19],'cm^-1')),
        HinderedRotor(inertia=(0.112129,'amu*angstrom^2'), symmetry=1, barrier=(8.62476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111095,'amu*angstrom^2'), symmetry=1, barrier=(8.62225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185267,'amu*angstrom^2'), symmetry=1, barrier=(14.3867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.238111,0.102917,-0.000183612,1.59418e-07,-5.26254e-11,-78251.9,27.8067], Tmin=(100,'K'), Tmax=(868.003,'K')), NASAPolynomial(coeffs=[13.2412,0.0220081,-1.13177e-05,2.14562e-09,-1.44472e-13,-79884,-31.237], Tmin=(868.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-347.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2782.5,750,1395,475,1775,1000,444.466,444.466,444.466,444.466,444.466],'cm^-1')),
        HinderedRotor(inertia=(0.332705,'amu*angstrom^2'), symmetry=1, barrier=(46.6407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332705,'amu*angstrom^2'), symmetry=1, barrier=(46.6407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65563,0.0341149,-3.02434e-05,1.33748e-08,-2.52353e-12,-41726.2,14.5066], Tmin=(100,'K'), Tmax=(1189.69,'K')), NASAPolynomial(coeffs=[7.40429,0.0181486,-1.01123e-05,2.09374e-09,-1.52914e-13,-42856,-9.22768], Tmin=(1189.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H)"""),
)
...
"""),
    E0 = (-780.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903884,0.0754183,-0.000111695,9.05134e-08,-3.01284e-11,-93816.7,25.013], Tmin=(100,'K'), Tmax=(728.915,'K')), NASAPolynomial(coeffs=[9.34157,0.0291178,-1.64205e-05,3.37917e-09,-2.44932e-13,-95046.8,-13.0264], Tmin=(728.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36149,0.0625079,-7.51297e-05,4.71026e-08,-1.20197e-11,-30486.7,27.5675], Tmin=(100,'K'), Tmax=(943.23,'K')), NASAPolynomial(coeffs=[10.7375,0.022747,-1.18991e-05,2.41214e-09,-1.74731e-13,-32255.4,-17.1183], Tmin=(943.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CsCsF1sH)"""),
)

species(
    label = '[O]C(=O)C([O])C(F)F(2267)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-579.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,180,180,180,1131.55,1131.87,1132.5,1134.55,1135.08],'cm^-1')),
        HinderedRotor(inertia=(0.238134,'amu*angstrom^2'), symmetry=1, barrier=(5.47518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0602467,'amu*angstrom^2'), symmetry=1, barrier=(54.7877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94103,0.0509746,-5.35537e-05,3.31836e-08,-9.12094e-12,-69663.8,25.5993], Tmin=(100,'K'), Tmax=(844.2,'K')), NASAPolynomial(coeffs=[6.45683,0.0295775,-1.55339e-05,3.15872e-09,-2.29266e-13,-70426.3,4.57812], Tmin=(844.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-379.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,1855,455,950,309.601,4000],'cm^-1')),
        HinderedRotor(inertia=(0.240069,'amu*angstrom^2'), symmetry=1, barrier=(16.3553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240302,'amu*angstrom^2'), symmetry=1, barrier=(16.3529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71384,0.0500974,-5.71574e-05,3.26896e-08,-7.37479e-12,-45603.1,25.7384], Tmin=(100,'K'), Tmax=(1080.39,'K')), NASAPolynomial(coeffs=[11.6476,0.0133194,-6.09584e-06,1.18185e-09,-8.40484e-14,-47749.6,-22.9545], Tmin=(1080.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C([O])OF(650)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
2 O u0 p2 c0 {1,S} {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-91.8413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,231.946,232.029,232.2],'cm^-1')),
        HinderedRotor(inertia=(0.796217,'amu*angstrom^2'), symmetry=1, barrier=(30.3121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0259,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57326,0.049127,-6.15285e-05,3.573e-08,-7.85413e-12,-10954.9,18.8623], Tmin=(100,'K'), Tmax=(1133.16,'K')), NASAPolynomial(coeffs=[14.5013,0.00349176,-1.1196e-06,1.89895e-10,-1.31851e-14,-13884.8,-45.124], Tmin=(1133.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.8413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    E0 = (-510.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,325,375,415,465,420,450,1700,1750,180,180,180,812.23],'cm^-1')),
        HinderedRotor(inertia=(0.116766,'amu*angstrom^2'), symmetry=1, barrier=(2.68467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124399,'amu*angstrom^2'), symmetry=1, barrier=(2.86018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.192181,0.09575,-0.000179682,1.65286e-07,-5.74218e-11,-61255.6,27.6711], Tmin=(100,'K'), Tmax=(858.334,'K')), NASAPolynomial(coeffs=[9.77883,0.0260506,-1.41462e-05,2.74882e-09,-1.88087e-13,-61979.5,-11.7447], Tmin=(858.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38847,0.0642991,-6.94636e-05,4.05592e-08,-1.00597e-11,-82781.6,26.9747], Tmin=(100,'K'), Tmax=(945.623,'K')), NASAPolynomial(coeffs=[9.22995,0.0311296,-1.68482e-05,3.4653e-09,-2.53014e-13,-84264.6,-10.4174], Tmin=(945.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'O=C(OF)C([CH]F)OF(2274)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-363.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,990,1113,1380,1390,370,380,2900,435,334,575,1197,1424,3202,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752038,0.0764874,-9.32596e-05,5.72949e-08,-1.41544e-11,-43601.9,29.148], Tmin=(100,'K'), Tmax=(977.542,'K')), NASAPolynomial(coeffs=[13.4952,0.0243438,-1.32476e-05,2.72834e-09,-1.99378e-13,-46093.3,-32.0411], Tmin=(977.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CsCsF1sH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(=O)OF)C(F)F(2175)'],
    products = ['HF(38)', 'CO2(13)', 'O=C[C](F)F(1009)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(13.5514,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', '[O]C(OF)C(F)F(1729)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(203.406,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(87)', '[O]CC(=O)OF(2121)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(86)', '[O]C(F)C(=O)OF(1387)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(151.014,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(153)', 'O=[C]C(=O)C(F)F(2260)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C=C(OF)OC(F)F(2261)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(155.005,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'O=C([CH]C(F)F)OF(1294)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C(=O)OF)C(F)F(2175)'],
    products = ['[O]C1(OF)OC1C(F)F(2263)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(139.608,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 139.2 to 139.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['[O]C(=C(O)OF)C(F)F(2264)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(209.967,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', 'O=CC(=O)OF(1389)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(30.9618,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(190)', 'O=CC(F)F(311)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(61.6708,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(OF)C(=O)C(F)F(2265)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(39.7,'m^3/(mol*s)'), n=1.88, Ea=(10.563,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_Sp-6R!H=5R!H"""),
)

reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C([CH]F)C(=O)OF(2266)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(=O)C([O])C(F)F(2267)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(154)', '[O]C([C]=O)C(F)F(2268)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', '[O]C=C([O])OF(650)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]OF(190)', '[O][CH]C(F)F(1447)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(OF)=C([O])C(F)F(2269)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C([CH]F)C(=O)OF(2271)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(238.398,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['[O]C(C(=O)OF)C(F)F(2175)'],
    products = ['F2(106)', 'CO2(13)', 'O=C[CH]F(1739)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(176.688,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(C(=O)OF)C(F)F(2175)'],
    products = ['[O]C(=O)C(OF)C(F)F(2273)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(OF)C([CH]F)OF(2274)'],
    products = ['[O]C(C(=O)OF)C(F)F(2175)'],
