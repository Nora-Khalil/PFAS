...
"""),
    ...
    molecularWeight = (77.0162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14984,0.022796,-3.43919e-05,3.39798e-08,-1.2564e-11,-18545.6,13.7538], Tmin=(100,'K'), Tmax=(909.604,'K')), NASAPolynomial(coeffs=[2.16169,0.0166592,-6.98618e-06,1.22458e-09,-7.93404e-14,-17932.2,20.8111], Tmin=(909.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + ring(dioxirane) + radical(OCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24172,0.0164884,-1.87037e-05,1.04488e-08,-2.29625e-12,12889.7,11.1068], Tmin=(100,'K'), Tmax=(1108.86,'K')), NASAPolynomial(coeffs=[6.67162,0.0041158,-1.96699e-06,3.86455e-10,-2.76579e-14,12129,-5.79493], Tmin=(1108.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(78.9875,'J/(mol*K)'), label="""CO3t2""", comment="""Thermo library: primaryThermoLibrary"""),
)
...
"""),
    E0 = (-110.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,180,180,180,3798.04,4000],'cm^-1')),
        HinderedRotor(inertia=(0.867185,'amu*angstrom^2'), symmetry=1, barrier=(19.9383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30488,0.0363492,-5.92087e-05,4.1998e-08,-1.0769e-11,-13268.4,14.8426], Tmin=(100,'K'), Tmax=(1127.53,'K')), NASAPolynomial(coeffs=[10.8703,-0.0019397,2.24131e-06,-5.50896e-10,4.32315e-14,-14697.6,-25.2812], Tmin=(1127.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(O2s-(Os-CdOd)H) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(C(=O)OOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(=O)O(204)'],
    products = ['HO2(10)', 'CO2(13)'],
    transitionState = 'TS1',
