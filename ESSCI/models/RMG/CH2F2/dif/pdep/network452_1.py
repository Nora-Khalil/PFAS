...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.339489,'amu*angstrom^2'), symmetry=1, barrier=(7.80552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.29402,'amu*angstrom^2'), symmetry=1, barrier=(75.7359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646429,0.0796283,-0.000129313,1.08011e-07,-3.51818e-11,-60419.5,23.9771], Tmin=(100,'K'), Tmax=(831.089,'K')), NASAPolynomial(coeffs=[11.3844,0.020747,-1.00452e-05,1.91578e-09,-1.3143e-13,-61955.7,-24.3445], Tmin=(831.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-503.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-CdF1s)(F1s)(H)) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[CH]C(F)(F)[CH]C(F)F(1282)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.242275,'amu*angstrom^2'), symmetry=1, barrier=(5.57039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242365,'amu*angstrom^2'), symmetry=1, barrier=(5.57244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242263,'amu*angstrom^2'), symmetry=1, barrier=(5.57011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00649945,0.10175,-0.000187555,1.7736e-07,-6.38434e-11,-91814.8,29.9773], Tmin=(100,'K'), Tmax=(838.521,'K')), NASAPolynomial(coeffs=[8.04283,0.0354657,-1.90944e-05,3.76395e-09,-2.61647e-13,-92184.3,-1.59251], Tmin=(838.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-764.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0913832,'amu*angstrom^2'), symmetry=1, barrier=(2.10108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0864806,'amu*angstrom^2'), symmetry=1, barrier=(1.98836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754143,'amu*angstrom^2'), symmetry=1, barrier=(17.3392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0868908,0.0954126,-0.000161396,1.43817e-07,-5.01694e-11,-96879.9,29.9827], Tmin=(100,'K'), Tmax=(808.661,'K')), NASAPolynomial(coeffs=[10.366,0.0308681,-1.62592e-05,3.21531e-09,-2.25429e-13,-98094.5,-14.6553], Tmin=(808.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C[C](F)C(F)F(1262)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169033,0.095506,-0.000168279,1.54807e-07,-5.47668e-11,-92905.9,29.9986], Tmin=(100,'K'), Tmax=(836.096,'K')), NASAPolynomial(coeffs=[8.74779,0.0328498,-1.70937e-05,3.33904e-09,-2.3146e-13,-93585,-5.33539], Tmin=(836.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC(F)[C](F)F(1190)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(128)', 'F[C](F)C[C](F)F(1216)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(7.30779,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(861)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(1281)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(9.87274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C[C](F)F(864)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(1.94207,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(1216)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(1282)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(1278)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1188)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    products = ['F[CH][C](F)CC(F)(F)F(1283)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1188)'],
    products = ['F[C](F)C[C](F)C(F)F(1262)'],
