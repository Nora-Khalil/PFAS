...
species(
    label = '[CH2]C1(F)O[CH]C1(F)F(2737)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829079,0.07426,-0.00010046,7.1009e-08,-2.00576e-11,-49574.1,23.1359], Tmin=(100,'K'), Tmax=(864.202,'K')), NASAPolynomial(coeffs=[11.929,0.0228834,-1.12858e-05,2.21736e-09,-1.57265e-13,-51492.6,-28.7947], Tmin=(864.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(Csj(Cs-F1sF1sCs)(O2s-Cs)(H)_ring) + radical(CJC(C)OC) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-3.71062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,2950,1000,3000,3100,440,815,1455,1000,180,180,1497.61,1501.59,1517.45,4000],'cm^-1')),
        HinderedRotor(inertia=(0.297201,'amu*angstrom^2'), symmetry=1, barrier=(6.83322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889954,'amu*angstrom^2'), symmetry=1, barrier=(20.4618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61902,0.0571041,-7.43593e-05,5.36327e-08,-1.59382e-11,-364.76,20.8112], Tmin=(100,'K'), Tmax=(812.728,'K')), NASAPolynomial(coeffs=[8.49767,0.0232484,-1.1872e-05,2.37389e-09,-1.70147e-13,-1482.82,-10.9477], Tmin=(812.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.71062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-261.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,467,575,827,1418,2950,1000,2950,3100,1380,975,1025,1650,455.008,455.013,455.028,455.029,455.029,455.03,455.03,455.037,455.05,2496.4],'cm^-1')),
        HinderedRotor(inertia=(0.000814185,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
...
"""),
    E0 = (109.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,2950,1000,3000,3100,440,815,1455,1000,691.313,691.417,691.463,691.497,691.551,691.608,691.618],'cm^-1')),
        HinderedRotor(inertia=(0.000352581,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18414,0.028161,1.29601e-05,-4.08887e-08,1.83999e-11,13246,19.122], Tmin=(100,'K'), Tmax=(972.942,'K')), NASAPolynomial(coeffs=[13.4626,0.0103842,-3.71361e-06,7.40505e-10,-5.79581e-14,9698.04,-41.9354], Tmin=(972.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + ring(Cd(Cd-F)-Cs-O2s) + radical(C=CCJO) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-319.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    products = ['[CH2]C1(F)O[CH]C1(F)F(2737)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(66)', 'F[C](F)C1(F)[CH]O1(2672)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)[C](F)C=O(2738)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C1=CO1(2739)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C1(F)[CH]O1(2740)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', '[CH2]C(F)=C1[CH]O1(2741)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    products = ['FCC(F)(F)[C]1[CH]O1(2743)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
    products = ['[CH2][C](F)C1(F)OC1F(2744)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)C1(F)[CH]O1(2745)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(2712)'],
...
network(
    label = 'PDepNetwork #1050',
    isomers = [
        '[CH2]C(F)(F)C1(F)[CH]O1(2712)',
    ],
    reactants = [
