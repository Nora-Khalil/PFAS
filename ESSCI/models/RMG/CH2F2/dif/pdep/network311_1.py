...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.256829,'amu*angstrom^2'), symmetry=1, barrier=(5.90501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257777,'amu*angstrom^2'), symmetry=1, barrier=(5.92681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61015,'amu*angstrom^2'), symmetry=1, barrier=(37.0206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-607.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,223,363,546,575,694,1179,1410,617,898,1187,180,180,180,665.813,665.818],'cm^-1')),
        HinderedRotor(inertia=(0.10538,'amu*angstrom^2'), symmetry=1, barrier=(2.42289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105377,'amu*angstrom^2'), symmetry=1, barrier=(2.42283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69438,'amu*angstrom^2'), symmetry=1, barrier=(38.9572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542083,0.0826989,-0.000126304,9.77407e-08,-3.00269e-11,-72972.3,26.1043], Tmin=(100,'K'), Tmax=(797.532,'K')), NASAPolynomial(coeffs=[12.6139,0.0221505,-1.24199e-05,2.53894e-09,-1.82985e-13,-74897.7,-29.4034], Tmin=(797.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FOC(C(F)F)C(F)(F)F(893)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.401129,'amu*angstrom^2'), symmetry=1, barrier=(9.22274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401756,'amu*angstrom^2'), symmetry=1, barrier=(9.23715,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-769.431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,191.899,191.928,191.988],'cm^-1')),
        HinderedRotor(inertia=(0.287643,'amu*angstrom^2'), symmetry=1, barrier=(7.52131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287554,'amu*angstrom^2'), symmetry=1, barrier=(7.52114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20441,'amu*angstrom^2'), symmetry=1, barrier=(31.4552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.164862,'amu*angstrom^2'), symmetry=1, barrier=(3.79049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626426,'amu*angstrom^2'), symmetry=1, barrier=(14.4028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.186,'amu*angstrom^2'), symmetry=1, barrier=(27.2686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18566,'amu*angstrom^2'), symmetry=1, barrier=(27.2606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.327642,'amu*angstrom^2'), symmetry=1, barrier=(7.53314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.327609,'amu*angstrom^2'), symmetry=1, barrier=(7.53237,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-651.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,242.118,244.187],'cm^-1')),
        HinderedRotor(inertia=(0.23901,'amu*angstrom^2'), symmetry=1, barrier=(10.0214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.735558,'amu*angstrom^2'), symmetry=1, barrier=(31.0345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)C(F)F(725)'],
    products = ['HF(38)', 'CF2O(48)', 'CHFCF2(54)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(45.6851,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2F2(1)', 'F[C]C(F)(F)OF(505)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.67744e-07,'m^3/(mol*s)'), n=3.38172, Ea=(61.1628,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(243)', 'F[C]C(F)F(231)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(133.797,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'F[C]C(F)C(F)(F)OF(892)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOC(F)(F)C(F)C(F)F(725)'],
    products = ['FOC(C(F)F)C(F)(F)F(893)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(173)', 'FC(F)=C(F)C(F)F(718)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(428)', 'FC(F)=CC(F)F(894)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FOC(F)(F)[CH]C(F)F(895)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FO[C](F)C(F)C(F)F(896)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[CH]C(F)C(F)(F)OF(897)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(F)C(F)C(F)F(898)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(228)', 'F[C](F)C(F)C(F)F(682)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(240)', 'CHF2-CHF(66)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(81)', 'F[CH]C(F)(F)OF(541)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FOC(F)(F)[C](F)C(F)F(899)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)(F)C(F)[C](F)F(900)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'O=C(F)C(F)C(F)F(626)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'FOC(F)=CC(F)F(901)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FOC(F)=C(F)C(F)F(902)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'FC=CC(F)(F)OF(903)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FOC(F)(F)C=C(F)F(904)'],
    products = ['FOC(F)(F)C(F)C(F)F(725)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FOC(F)(F)C(F)C(F)F(725)'],
    products = ['F2(77)', 'CF2O(48)', 'CHFCHF[Z](58)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(282.349,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #311',
    isomers = [
        'FOC(F)(F)C(F)C(F)F(725)',
    ],
    reactants = [
