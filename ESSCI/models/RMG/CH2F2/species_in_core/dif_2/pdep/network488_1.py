...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.372096,'amu*angstrom^2'), symmetry=1, barrier=(8.55522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05967,'amu*angstrom^2'), symmetry=1, barrier=(24.3638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37194,'amu*angstrom^2'), symmetry=1, barrier=(8.55163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-747.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,235,523,627,1123,1142,1372,1406,3097,617,898,1187,180,180,180,1263.37],'cm^-1')),
        HinderedRotor(inertia=(0.427095,'amu*angstrom^2'), symmetry=1, barrier=(9.81975,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21761,0.0664333,-9.99963e-05,7.86573e-08,-2.47514e-11,-89842.7,22.6319], Tmin=(100,'K'), Tmax=(777.437,'K')), NASAPolynomial(coeffs=[10.2024,0.0202047,-1.08007e-05,2.16915e-09,-1.54811e-13,-91239.7,-18.4525], Tmin=(777.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.37103,'amu*angstrom^2'), symmetry=1, barrier=(8.53071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370522,'amu*angstrom^2'), symmetry=1, barrier=(8.51902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370539,'amu*angstrom^2'), symmetry=1, barrier=(8.51941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.374313,'amu*angstrom^2'), symmetry=1, barrier=(8.60619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374559,'amu*angstrom^2'), symmetry=1, barrier=(8.61185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526485,'amu*angstrom^2'), symmetry=1, barrier=(12.1049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(87)', 'OC(F)(F)C(F)F(322)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'OC(F)(F)[C]F(715)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(254)', 'F[C]C(F)F(180)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(153)', 'F[C]C(F)(F)C(F)F(1433)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'OC(F)(F)C(F)(F)[C]F(1340)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(86)', 'OC(F)(F)C(F)(F)F(1341)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
    products = ['OC(F)(C(F)F)C(F)(F)F(1557)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(162)', 'CF2CF2(60)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[C](F)C(F)F(1558)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)(F)C(F)F(1559)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)C(F)(F)[CH]F(1346)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(4)', 'F[C](F)C(F)(F)C(F)F(537)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)C(F)F(363)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(232)', 'CHF2-CF2(68)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', 'OC(F)(F)[C](F)F(725)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[C](F)F(1560)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)C(F)F(750)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(106)', 'OC(F)=C(F)C(F)F(1561)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(106)', 'OC(F)(F)C(F)=CF(1349)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=C(F)F(460)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(1138)'],
...
network(
    label = 'PDepNetwork #488',
    isomers = [
        'OC(F)(F)C(F)(F)C(F)F(1138)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'CHFCF2(54)'),
        ('O[C](F)F(232)', 'CHF2-CF2(68)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
