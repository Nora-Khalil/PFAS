...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.455168,'amu*angstrom^2'), symmetry=1, barrier=(10.4652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45558,'amu*angstrom^2'), symmetry=1, barrier=(10.4747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87396,0.0530161,-5.37522e-05,2.28223e-08,2.68987e-12,-21157.5,21.7352], Tmin=(100,'K'), Tmax=(558.858,'K')), NASAPolynomial(coeffs=[6.189,0.0303588,-1.50221e-05,2.96385e-09,-2.10917e-13,-21768.3,2.27884], Tmin=(558.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[O][C]1CCC1(F)F(3614)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59718,0.0456059,-2.90879e-05,6.47155e-09,2.37015e-13,-22961.1,21.5031], Tmin=(100,'K'), Tmax=(1205.8,'K')), NASAPolynomial(coeffs=[12.3753,0.0194001,-8.36617e-06,1.58199e-09,-1.10787e-13,-26254.5,-35.3904], Tmin=(1205.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44763,0.0500825,-4.8848e-05,2.39644e-08,-4.59679e-12,-21222.2,18.4729], Tmin=(100,'K'), Tmax=(1275.44,'K')), NASAPolynomial(coeffs=[13.4735,0.0123671,-4.492e-06,7.79615e-10,-5.22895e-14,-24289.8,-42.4705], Tmin=(1275.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.691889,'amu*angstrom^2'), symmetry=1, barrier=(15.9079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692346,'amu*angstrom^2'), symmetry=1, barrier=(15.9184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572879,0.080522,-0.00012173,9.42776e-08,-2.88136e-11,-21443.6,22.9118], Tmin=(100,'K'), Tmax=(804.409,'K')), NASAPolynomial(coeffs=[12.5703,0.0208548,-1.04513e-05,2.03977e-09,-1.43011e-13,-23373.5,-32.356], Tmin=(804.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(C)(F)F(3617)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.84855,'amu*angstrom^2'), symmetry=1, barrier=(42.5017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00367867,'amu*angstrom^2'), symmetry=1, barrier=(10.8943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0143167,'amu*angstrom^2'), symmetry=1, barrier=(42.4839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05263,0.0704443,-0.000105555,8.91372e-08,-3.037e-11,4489.41,24.0394], Tmin=(100,'K'), Tmax=(789.84,'K')), NASAPolynomial(coeffs=[8.43859,0.027516,-1.35395e-05,2.61708e-09,-1.82209e-13,3494.96,-8.76043], Tmin=(789.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(O)CJ) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)

species(
    label = 'C=C([O])[C](F)CF(3619)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22837,0.0591137,-5.96378e-05,3.05884e-08,-6.25383e-12,-37168.7,22.2468], Tmin=(100,'K'), Tmax=(1181.01,'K')), NASAPolynomial(coeffs=[13.1809,0.0186315,-8.22157e-06,1.56472e-09,-1.10032e-13,-39991.9,-37.406], Tmin=(1181.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CsCdCsF1s)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54839,0.0584554,-7.4744e-05,5.73352e-08,-1.85188e-11,-19878.3,20.6417], Tmin=(100,'K'), Tmax=(746.002,'K')), NASAPolynomial(coeffs=[7.22234,0.028027,-1.35503e-05,2.63988e-09,-1.86184e-13,-20724.7,-5.06822], Tmin=(746.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(66)', '[CH2]C(=O)[C](F)F(3383)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(2844)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(=C)[O](3316)'],
    products = ['[CH2]C(F)(F)[C]1CO1(3613)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(3615)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(3616)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(3618)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(66)', '[CH2]C(F)(F)[C]=O(890)'],
    products = ['[CH2]C(F)(F)C(=C)[O](3316)'],
