...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(F)[C](F)F(371)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(601)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(753)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(754)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(41.9351,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(396)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(108)', '[O]C=C(F)[CH]F(755)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(397)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(88)', '[O]C(F)[C](F)F(371)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(759)'],
    products = ['[O]C(F)C(F)(F)[CH]F(662)'],
...
network(
    label = 'PDepNetwork #266',
    isomers = [
        '[O]C(F)C(F)(F)[CH]F(662)',
    ],
    reactants = [
        ('CHFO(46)', 'CHFCF2(54)'),
    ],
