...
"""),
    E0 = (-632.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,182,240,577,636,1210,1413,180,1971.96],'cm^-1')),
        HinderedRotor(inertia=(0.156935,'amu*angstrom^2'), symmetry=1, barrier=(3.60825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.976269,'amu*angstrom^2'), symmetry=1, barrier=(22.4463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.107808,'amu*angstrom^2'), symmetry=1, barrier=(2.47873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108728,'amu*angstrom^2'), symmetry=1, barrier=(2.49988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.463193,'amu*angstrom^2'), symmetry=1, barrier=(10.6497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333896,0.0896289,-0.000149118,1.33833e-07,-4.72638e-11,-91273,31.0806], Tmin=(100,'K'), Tmax=(804.578,'K')), NASAPolynomial(coeffs=[9.19159,0.0321054,-1.67308e-05,3.3041e-09,-2.31853e-13,-92261.8,-7.01385], Tmin=(804.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-759.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.135821,0.0968728,-0.000173069,1.6029e-07,-5.68314e-11,-92805,30.0596], Tmin=(100,'K'), Tmax=(840.529,'K')), NASAPolynomial(coeffs=[8.56463,0.0331799,-1.73205e-05,3.3805e-09,-2.33927e-13,-93389,-4.18516], Tmin=(840.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-772.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]C(F)C(F)F(1264)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-760.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,190,488,555,1236,1407,253.935,256.814,2307.68],'cm^-1')),
        HinderedRotor(inertia=(0.136433,'amu*angstrom^2'), symmetry=1, barrier=(6.43963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84188,'amu*angstrom^2'), symmetry=1, barrier=(39.5024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137808,'amu*angstrom^2'), symmetry=1, barrier=(6.4411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373335,0.0881843,-0.000144039,1.27963e-07,-4.50364e-11,-91374.1,30.9975], Tmin=(100,'K'), Tmax=(794.506,'K')), NASAPolynomial(coeffs=[9.34894,0.0318216,-1.65317e-05,3.26935e-09,-2.29953e-13,-92447.7,-8.02033], Tmin=(794.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-760.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]CC(F)(F)F(1265)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40362,0.0876899,-0.000144582,1.28684e-07,-4.50222e-11,-99883.2,30.7972], Tmin=(100,'K'), Tmax=(811.577,'K')), NASAPolynomial(coeffs=[9.21157,0.031181,-1.59318e-05,3.12078e-09,-2.1794e-13,-100882,-7.19978], Tmin=(811.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-831.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)C[CH]C(F)(F)F(1266)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614979,0.0827095,-0.000133052,1.19874e-07,-4.30715e-11,-99445.5,30.5339], Tmin=(100,'K'), Tmax=(787.625,'K')), NASAPolynomial(coeffs=[8.0596,0.0334271,-1.73424e-05,3.43742e-09,-2.42447e-13,-100262,-1.34541], Tmin=(787.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-827.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(166)', '[CH2]C(F)[C](F)F(1255)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(166)', 'F[CH]C[C](F)F(1235)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(851)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C](F)CC=C(F)F(1259)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(1260)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(853)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(42)', '[CH2]C(F)[C](F)F(1255)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(42)', 'F[CH]C[C](F)F(1235)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)[CH]C(F)F(1261)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)CC(F)[C](F)F(1190)'],
    products = ['F[C](F)[C](F)CC(F)F(1263)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)[CH]C(F)C(F)F(1264)'],
    products = ['F[C](F)CC(F)[C](F)F(1190)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(1190)'],
    products = ['F[C](F)[CH]CC(F)(F)F(1265)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(1190)'],
    products = ['F[C](F)C[CH]C(F)(F)F(1266)'],
