...
"""),
    E0 = (-65.6582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,513.308,513.308,513.357,513.362,513.365,4000],'cm^-1')),
        HinderedRotor(inertia=(0.000639707,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107483,'amu*angstrom^2'), symmetry=1, barrier=(20.0962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45168,0.0281352,-1.74298e-05,-1.76775e-09,3.59989e-12,-7835.89,12.9138], Tmin=(100,'K'), Tmax=(1007.81,'K')), NASAPolynomial(coeffs=[11.4874,0.00495454,-1.80384e-06,3.81698e-10,-3.061e-14,-10301.2,-33.9437], Tmin=(1007.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.6582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(4)', 'CH2CF2(56)'],
    products = ['OC[C](F)F(1290)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['OC[C](F)F(1290)'],
    products = ['O[CH]C(F)F(1434)'],
