...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.622439,'amu*angstrom^2'), symmetry=1, barrier=(14.3111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622548,'amu*angstrom^2'), symmetry=1, barrier=(14.3136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445548,0.0761161,-9.39802e-05,5.60351e-08,-1.29003e-11,-80273.3,22.0492], Tmin=(100,'K'), Tmax=(1071.42,'K')), NASAPolynomial(coeffs=[17.3441,0.0130269,-5.65356e-06,1.07513e-09,-7.60264e-14,-83894.4,-60.6419], Tmin=(1071.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'F[C](F)C(F)[C]1CO1(3445)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93071,0.0689546,-8.03213e-05,4.78776e-08,-1.13671e-11,-34617.4,22.4169], Tmin=(100,'K'), Tmax=(1023.56,'K')), NASAPolynomial(coeffs=[13.2601,0.0207716,-9.70995e-06,1.88652e-09,-1.33926e-13,-37141.4,-37.3526], Tmin=(1023.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsHHH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(CC(C)2OJ) + radical(CJC(C)2O) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.908949,0.0709095,-9.68253e-05,6.66593e-08,-1.8036e-11,-63720.3,21.8935], Tmin=(100,'K'), Tmax=(907.445,'K')), NASAPolynomial(coeffs=[13.0626,0.0173365,-8.2702e-06,1.60145e-09,-1.12757e-13,-65926.1,-35.5607], Tmin=(907.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.856515,'amu*angstrom^2'), symmetry=1, barrier=(19.693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856403,'amu*angstrom^2'), symmetry=1, barrier=(19.6904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856627,'amu*angstrom^2'), symmetry=1, barrier=(19.6955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648193,0.0767403,-0.000100451,6.53668e-08,-1.67366e-11,-42159.6,25.7549], Tmin=(100,'K'), Tmax=(956.104,'K')), NASAPolynomial(coeffs=[14.5216,0.0186991,-9.39216e-06,1.87402e-09,-1.34659e-13,-44812.5,-40.5534], Tmin=(956.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCdH)(F1s)(F1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(F)C(F)F(3453)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.614722,'amu*angstrom^2'), symmetry=1, barrier=(14.1337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740378,'amu*angstrom^2'), symmetry=1, barrier=(17.0228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811425,0.0742435,-9.97295e-05,6.9296e-08,-1.91667e-11,-50044.5,24.8621], Tmin=(100,'K'), Tmax=(883.411,'K')), NASAPolynomial(coeffs=[12.393,0.0218018,-1.06825e-05,2.09453e-09,-1.48488e-13,-52090.7,-29.576], Tmin=(883.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(=C[C](F)F)OF(3454)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-162.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,161,297,490,584,780,1358,423.187],'cm^-1')),
        HinderedRotor(inertia=(0.068314,'amu*angstrom^2'), symmetry=1, barrier=(8.68763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00484907,'amu*angstrom^2'), symmetry=1, barrier=(8.68105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404256,'amu*angstrom^2'), symmetry=1, barrier=(51.4219,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.878765,0.0734623,-0.00010332,7.76079e-08,-2.33911e-11,-19493.3,26.3082], Tmin=(100,'K'), Tmax=(810.729,'K')), NASAPolynomial(coeffs=[10.9115,0.0239582,-1.17204e-05,2.27828e-09,-1.60023e-13,-21119.9,-19.9879], Tmin=(810.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C([O])=CC(F)(F)F(3455)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895206,0.066722,-7.89161e-05,4.71468e-08,-1.10083e-11,-70894.4,24.7338], Tmin=(100,'K'), Tmax=(1052.41,'K')), NASAPolynomial(coeffs=[14.3042,0.0157569,-6.27522e-06,1.13105e-09,-7.7203e-14,-73716.8,-40.6417], Tmin=(1052.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCdFFF) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86201,0.052327,-5.18253e-05,3.01223e-08,-7.74557e-12,-81389.1,21.2089], Tmin=(100,'K'), Tmax=(898.547,'K')), NASAPolynomial(coeffs=[6.76655,0.0304939,-1.53781e-05,3.08079e-09,-2.21933e-13,-82270.5,-1.9281], Tmin=(898.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)C1F(3458)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948223,0.0729338,-0.000111932,9.46292e-08,-3.18472e-11,-49523.1,23.6424], Tmin=(100,'K'), Tmax=(814.377,'K')), NASAPolynomial(coeffs=[8.93924,0.0263867,-1.27554e-05,2.43801e-09,-1.68225e-13,-50582.7,-11.7831], Tmin=(814.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(C2CsJOCs) + radical(CJC(C)OC) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'CC([O])=C(F)[C](F)F(3459)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.908619,0.0746656,-0.000117136,1.0197e-07,-3.53886e-11,-59053.4,26.1675], Tmin=(100,'K'), Tmax=(803.037,'K')), NASAPolynomial(coeffs=[8.35947,0.0286054,-1.43874e-05,2.79608e-09,-1.94774e-13,-59961.6,-6.34801], Tmin=(803.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(C)OJ) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['C=C([O])C(F)(F)[CH]F(3306)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', '[CH2]C(=O)[CH]F(3443)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(2829)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['F[C](F)C(F)[C]1CO1(3445)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['[CH2]C1([O])C(F)C1(F)F(3447)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(172.206,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C(F)F(3448)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C(F)F(3449)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(87)', '[CH2]C(=O)[CH]F(3443)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['[CH2]C(O)=C(F)[C](F)F(3451)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C](F)F(3452)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C(F)F(3453)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C[C](F)F)OF(3454)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['[CH2]C([O])=CC(F)(F)F(3455)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(66)', 'O=[C]C(F)[C](F)F(421)'],
    products = ['C=C([O])C(F)[C](F)F(3309)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)[C](F)F(3309)'],
    products = ['[CH2][C]1OC(F)(F)C1F(3458)'],
...
network(
    label = 'PDepNetwork #1268',
    isomers = [
        'C=C([O])C(F)[C](F)F(3309)',
    ],
    reactants = [
        ('CHFCF2(54)', 'CH2CO(75)'),
    ],
