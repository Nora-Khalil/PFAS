...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.262952,'amu*angstrom^2'), symmetry=1, barrier=(6.04579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81925,'amu*angstrom^2'), symmetry=1, barrier=(18.8362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263109,'amu*angstrom^2'), symmetry=1, barrier=(6.0494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.250234,'amu*angstrom^2'), symmetry=1, barrier=(5.75337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247116,'amu*angstrom^2'), symmetry=1, barrier=(5.68168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247511,'amu*angstrom^2'), symmetry=1, barrier=(5.69077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
...
"""),
    E0 = (-1125.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,493,600,700,1144,1293,180,182.182,182.946],'cm^-1')),
        HinderedRotor(inertia=(0.00150658,'amu*angstrom^2'), symmetry=1, barrier=(11.1289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60907,'amu*angstrom^2'), symmetry=1, barrier=(37.156,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1265.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,482,664,788,1296,1923,228.722,230.442,237.783],'cm^-1')),
        HinderedRotor(inertia=(0.279928,'amu*angstrom^2'), symmetry=1, barrier=(10.434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889254,'amu*angstrom^2'), symmetry=1, barrier=(34.6317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    ...
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(19.9073,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[C](F)OC(F)(F)F(576)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)(F)O[C](F)F(577)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CF3(44)', '[O]C(O)(F)F(155)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'F[C](F)OC(F)(F)F(578)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)(F)F(579)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)OC(F)(F)F(580)'],
    products = ['OC(F)(F)OC(F)(F)F(343)'],
    transitionState = 'TS9',
