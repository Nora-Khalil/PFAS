...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(850)'],
    products = ['O=C(O)OC(F)(F)F(810)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', 'O=[C]OC(F)(F)F(851)'],
    products = ['O=C(O)OC(F)(F)F(810)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(852)'],
    products = ['O=C(O)OC(F)(F)F(810)'],
    transitionState = 'TS8',
