...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OO[CH]F(200)'],
    products = ['[O]OOO[CH]F(226)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](157)', '[O][CH]F(168)'],
    products = ['[O]OOO[CH]F(226)'],
    transitionState = 'TS7',
