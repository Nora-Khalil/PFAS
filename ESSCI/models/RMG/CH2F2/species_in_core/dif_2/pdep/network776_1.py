...
"""),
    E0 = (-249.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3000,3100,440,815,1455,1000,313.355,313.404,2065.03],'cm^-1')),
        HinderedRotor(inertia=(0.00171779,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103654,'amu*angstrom^2'), symmetry=1, barrier=(7.22027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103753,'amu*angstrom^2'), symmetry=1, barrier=(7.22182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67178,0.0554964,-8.12392e-05,6.80671e-08,-2.29777e-11,-29880.7,21.9369], Tmin=(100,'K'), Tmax=(799.94,'K')), NASAPolynomial(coeffs=[7.44724,0.0221447,-1.0314e-05,1.96938e-09,-1.36459e-13,-30661.6,-3.74281], Tmin=(799.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(CsJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79566,0.0539786,-6.76127e-05,3.86994e-08,-4.00823e-12,-31864.1,21.3065], Tmin=(100,'K'), Tmax=(601.782,'K')), NASAPolynomial(coeffs=[8.31194,0.0206471,-9.41115e-06,1.78548e-09,-1.23559e-13,-32829.2,-8.32306], Tmin=(601.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = 'CO[CH][C](F)F(1959)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46313,0.0642121,-0.000111958,1.04886e-07,-3.75333e-11,-30087.6,21.6083], Tmin=(100,'K'), Tmax=(850.406,'K')), NASAPolynomial(coeffs=[5.83982,0.0257921,-1.27342e-05,2.44128e-09,-1.67446e-13,-30187.2,4.99397], Tmin=(850.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-250.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]O[CH2](1956)'],
    products = ['[CH2]OC[C](F)F(1906)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]OC[C](F)F(1906)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(47.3879,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(87)', '[CH2]O[CH2](1956)'],
    products = ['[CH2]OC[C](F)F(1906)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.0195237,'m^3/(mol*s)'), n=2.64543, Ea=(2.66783,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)
