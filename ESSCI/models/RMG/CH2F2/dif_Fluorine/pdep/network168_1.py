...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(125)', '[O]C([O])F(138)'],
    products = ['[O]C(F)O[CH]F(435)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(472)'],
    products = ['[O]C(F)O[CH]F(435)'],
    transitionState = 'TS8',
