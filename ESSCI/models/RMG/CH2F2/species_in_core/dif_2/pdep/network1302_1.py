...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.90075,'amu*angstrom^2'), symmetry=1, barrier=(20.71,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.902781,'amu*angstrom^2'), symmetry=1, barrier=(20.7567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900346,'amu*angstrom^2'), symmetry=1, barrier=(20.7007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31581,0.080587,-0.000120034,8.4632e-08,-2.25794e-11,-31573.5,22.1306], Tmin=(100,'K'), Tmax=(982.784,'K')), NASAPolynomial(coeffs=[17.2646,0.00742649,-1.99405e-06,2.34834e-10,-1.01427e-14,-34703.2,-58.3166], Tmin=(982.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cds-(Cdd-O2d)CsOs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'C=C=C(OO)OF(3566)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.414779,'amu*angstrom^2'), symmetry=1, barrier=(9.53659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41381,'amu*angstrom^2'), symmetry=1, barrier=(9.5143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86166,'amu*angstrom^2'), symmetry=1, barrier=(42.8033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.963367,0.0770247,-0.000140112,1.31408e-07,-4.68657e-11,12018.4,23.2723], Tmin=(100,'K'), Tmax=(849.284,'K')), NASAPolynomial(coeffs=[6.90204,0.0274562,-1.44177e-05,2.79725e-09,-1.92419e-13,11788.6,0.177623], Tmin=(849.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.0996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (38.8157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3120,650,792.5,1650,420.624,420.626],'cm^-1')),
        HinderedRotor(inertia=(0.104763,'amu*angstrom^2'), symmetry=1, barrier=(13.1537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293937,'amu*angstrom^2'), symmetry=1, barrier=(13.1536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.572098,'amu*angstrom^2'), symmetry=1, barrier=(13.1537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.898726,0.0725895,-0.000108562,8.19775e-08,-2.43314e-11,4776.15,25.6611], Tmin=(100,'K'), Tmax=(828.696,'K')), NASAPolynomial(coeffs=[12.3167,0.0174771,-8.80556e-06,1.72622e-09,-1.21516e-13,2883.74,-27.2786], Tmin=(828.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.8157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-45.8736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,231,791,325,375,415,465,420,450,1700,1750,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.13502,'amu*angstrom^2'), symmetry=1, barrier=(49.0882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13548,'amu*angstrom^2'), symmetry=1, barrier=(49.0988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13511,'amu*angstrom^2'), symmetry=1, barrier=(49.0904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.135,'amu*angstrom^2'), symmetry=1, barrier=(49.0878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
...
"""),
    E0 = (-234.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,339.98,340.1,340.156,340.172,1512.12,4000],'cm^-1')),
        HinderedRotor(inertia=(0.113247,'amu*angstrom^2'), symmetry=1, barrier=(9.28748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278337,'amu*angstrom^2'), symmetry=1, barrier=(22.8351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.015,0.0490921,-6.27822e-05,3.65657e-08,-3.93114e-12,-28161.2,17.9696], Tmin=(100,'K'), Tmax=(585.806,'K')), NASAPolynomial(coeffs=[7.64483,0.0194972,-9.6551e-06,1.88493e-09,-1.32456e-13,-28972.6,-7.4761], Tmin=(585.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.141072,'amu*angstrom^2'), symmetry=1, barrier=(3.24351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4813,0.0378622,-6.77971e-05,6.50284e-08,-2.46459e-11,10980.6,16.4924], Tmin=(100,'K'), Tmax=(754.605,'K')), NASAPolynomial(coeffs=[5.82749,0.014023,-8.28038e-06,1.73174e-09,-1.25721e-13,10649.3,2.44224], Tmin=(754.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.8794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(C=CJC=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03719,'amu*angstrom^2'), symmetry=1, barrier=(23.8471,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-78.7978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,350,440,435,1725,3120,650,792.5,1650,365.468,365.473,365.481,365.482,365.492],'cm^-1')),
        HinderedRotor(inertia=(0.123533,'amu*angstrom^2'), symmetry=1, barrier=(11.7094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123531,'amu*angstrom^2'), symmetry=1, barrier=(11.7099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123518,'amu*angstrom^2'), symmetry=1, barrier=(11.7096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947158,0.0701138,-0.00010572,7.67438e-08,-2.15238e-11,-9369.87,22.1787], Tmin=(100,'K'), Tmax=(881.625,'K')), NASAPolynomial(coeffs=[13.9023,0.0113345,-5.71127e-06,1.11872e-09,-7.87611e-14,-11654.2,-38.6902], Tmin=(881.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.7978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)C(=O)OF(3573)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u0 p2 c0 {1,S} {6,S}
4  O u0 p2 c0 {6,D}
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(3569)'],
    products = ['C=C(O)C(=O)OF(3341)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(4)', 'C=[C]C(=O)OF(3570)'],
    products = ['C=C(O)C(=O)OF(3341)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(154)', 'C=C(O)[C]=O(3571)'],
    products = ['C=C(O)C(=O)OF(3341)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(190)', 'C=[C]O(3261)'],
    products = ['C=C(O)C(=O)OF(3341)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(3572)'],
    products = ['C=C(O)C(=O)OF(3341)'],
