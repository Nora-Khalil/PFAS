...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.500882,'amu*angstrom^2'), symmetry=1, barrier=(11.5163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501635,'amu*angstrom^2'), symmetry=1, barrier=(11.5336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69194,0.0271135,-2.49832e-05,1.1931e-08,-2.28596e-12,-21673.7,14.0558], Tmin=(100,'K'), Tmax=(1253.5,'K')), NASAPolynomial(coeffs=[8.21381,0.00949296,-3.89778e-06,7.16892e-10,-4.94196e-14,-23058.1,-13.8317], Tmin=(1253.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""HOCH2OO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-106.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,297.589],'cm^-1')),
        HinderedRotor(inertia=(0.190584,'amu*angstrom^2'), symmetry=1, barrier=(11.9519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191027,'amu*angstrom^2'), symmetry=1, barrier=(11.9583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0328,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OCO(2003)'],
    products = ['HO2(10)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.38e+12,'s^-1','*|/',5), n=0, Ea=(123.219,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(600,'K'), comment="""Matched reaction 14 CH3O3 <=> CH2O + HO2 in HO2_Elimination_from_PeroxyRadical/training
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OCO(2003)'],
    products = ['OH(4)', 'O=CO(196)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6e+08,'s^-1'), n=1.23, Ea=(154.18,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 269 used for R3H_SS_O;O_rad_out;Cs_H_out_H/NonDeO
Exact match found for rate rule [R3H_SS_O;O_rad_out;Cs_H_out_H/NonDeO]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
