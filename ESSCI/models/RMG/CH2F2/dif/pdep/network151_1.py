...
"""),
    E0 = (-682.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,232,360,932,1127,1349,1365,3045,365.317,365.317,365.317,365.317,365.318,1694.15],'cm^-1')),
        HinderedRotor(inertia=(0.0608396,'amu*angstrom^2'), symmetry=1, barrier=(36.2257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26317,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38252,'amu*angstrom^2'), symmetry=1, barrier=(36.2257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-275.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,197,221,431,657,2120,512.5,787.5,717.326,717.958],'cm^-1')),
        HinderedRotor(inertia=(0.0120132,'amu*angstrom^2'), symmetry=1, barrier=(4.39315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-216.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,175,287,726,856,350,440,435,1725,3010,987.5,1337.5,450,1655,196.849,197.448],'cm^-1')),
        HinderedRotor(inertia=(0.668744,'amu*angstrom^2'), symmetry=1, barrier=(18.384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669538,'amu*angstrom^2'), symmetry=1, barrier=(18.3893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670182,'amu*angstrom^2'), symmetry=1, barrier=(18.3873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674078,0.0741975,-0.000111535,7.92954e-08,-2.15155e-11,-25975.5,21.7385], Tmin=(100,'K'), Tmax=(916.141,'K')), NASAPolynomial(coeffs=[15.8002,0.00815164,-3.39347e-06,5.98096e-10,-3.93368e-14,-28746.9,-49.9109], Tmin=(916.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-268.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,194,682,905,1196,1383,3221,257.431,1732.86],'cm^-1')),
        HinderedRotor(inertia=(0.167525,'amu*angstrom^2'), symmetry=1, barrier=(8.08242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166762,'amu*angstrom^2'), symmetry=1, barrier=(8.07683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704698,'amu*angstrom^2'), symmetry=1, barrier=(34.0545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09049,0.0713709,-0.000125179,1.12098e-07,-3.88036e-11,-32253.4,22.333], Tmin=(100,'K'), Tmax=(829.206,'K')), NASAPolynomial(coeffs=[8.92125,0.021004,-1.12881e-05,2.21878e-09,-1.54195e-13,-33119.1,-11.3689], Tmin=(829.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)OF(496)',
...
"""),
    E0 = (-256.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,180,180,1730.98,1735.58],'cm^-1')),
        HinderedRotor(inertia=(0.190275,'amu*angstrom^2'), symmetry=1, barrier=(4.3748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88923,'amu*angstrom^2'), symmetry=1, barrier=(43.4371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52428,0.0658384,-0.000125238,1.28056e-07,-4.95083e-11,-30762.2,23.931], Tmin=(100,'K'), Tmax=(823.301,'K')), NASAPolynomial(coeffs=[3.05689,0.0327694,-1.83057e-05,3.66564e-09,-2.57816e-13,-30146.2,22.1089], Tmin=(823.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[C](F)OF(497)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-287.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,180,180,1108.86],'cm^-1')),
        HinderedRotor(inertia=(0.268329,'amu*angstrom^2'), symmetry=1, barrier=(6.16942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26736,'amu*angstrom^2'), symmetry=1, barrier=(6.14713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27099,'amu*angstrom^2'), symmetry=1, barrier=(6.2306,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.950407,'amu*angstrom^2'), symmetry=1, barrier=(21.8517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560664,'amu*angstrom^2'), symmetry=1, barrier=(12.8908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560996,'amu*angstrom^2'), symmetry=1, barrier=(12.8984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    E0 = (-457.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,423.79,423.794,423.8,423.8,423.806,423.809,423.813],'cm^-1')),
        HinderedRotor(inertia=(0.000938605,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000938622,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90373,0.0514486,-7.85142e-05,7.27259e-08,-2.80342e-11,-54928.1,19.3185], Tmin=(100,'K'), Tmax=(724.323,'K')), NASAPolynomial(coeffs=[5.447,0.0262002,-1.44626e-05,2.94455e-09,-2.11755e-13,-55292.3,4.39571], Tmin=(724.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-745.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,619,818,1246,1924,299.027,299.027,299.028,1357.48,1357.49],'cm^-1')),
        HinderedRotor(inertia=(0.531842,'amu*angstrom^2'), symmetry=1, barrier=(33.7466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122995,'amu*angstrom^2'), symmetry=1, barrier=(33.7466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['OF(173)', 'O=C(O)[C]F(447)'],
    products = ['O=C(O)C(F)OF(336)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(448)'],
    products = ['O=C(O)C(F)OF(336)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(499)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(500)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(228)', 'O=C(O)[CH]F(501)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(503)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(295)', 'O=[C]O(164)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(452)'],
    products = ['O=C(O)C(F)OF(336)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(382)'],
    products = ['O=C(O)C(F)OF(336)'],
