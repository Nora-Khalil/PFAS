...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.640893,'amu*angstrom^2'), symmetry=1, barrier=(14.7354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641209,'amu*angstrom^2'), symmetry=1, barrier=(14.7427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.64109,'amu*angstrom^2'), symmetry=1, barrier=(14.7399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-658.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,519,593,830,1115,1166,1389,1413,3114,3025,407.5,1350,352.5,180,180,1066.88],'cm^-1')),
        HinderedRotor(inertia=(1.1037,'amu*angstrom^2'), symmetry=1, barrier=(25.3763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109568,'amu*angstrom^2'), symmetry=1, barrier=(2.51919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10282,'amu*angstrom^2'), symmetry=1, barrier=(25.3559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
"""),
    E0 = (-636.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,197.034,198.89,200.636],'cm^-1')),
        HinderedRotor(inertia=(0.310252,'amu*angstrom^2'), symmetry=1, barrier=(8.54932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29862,'amu*angstrom^2'), symmetry=1, barrier=(8.60712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413236,'amu*angstrom^2'), symmetry=1, barrier=(11.5163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    ...
    products = ['OCOC(F)F(1599)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.622,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OCO[CH]F(1810)'],
    products = ['OCOC(F)F(1599)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(170)', 'CH2OH(33)'],
    products = ['OCOC(F)F(1599)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(4)', '[CH2]OC(F)F(1532)'],
    products = ['OCOC(F)F(1599)'],
    transitionState = 'TS7',
