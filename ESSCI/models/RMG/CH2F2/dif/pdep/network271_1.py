...
"""),
    E0 = (-639.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,1855,455,950,253.822,254.612,254.996],'cm^-1')),
        HinderedRotor(inertia=(0.900256,'amu*angstrom^2'), symmetry=1, barrier=(41.3386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903367,'amu*angstrom^2'), symmetry=1, barrier=(41.3309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.899346,'amu*angstrom^2'), symmetry=1, barrier=(41.3315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07777,0.0314047,9.84897e-06,-4.16579e-08,2.03775e-11,-109777,20.3258], Tmin=(100,'K'), Tmax=(921.111,'K')), NASAPolynomial(coeffs=[13.3245,0.0107181,-2.31049e-06,3.24965e-10,-2.31691e-14,-113044,-39.4921], Tmin=(921.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-913.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCCFH) + group(CsCFFO) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Beta-Propiolactone)"""),
)
...
"""),
    E0 = (-449.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,194,682,905,1196,1383,3221,1855,455,950,180,459.213],'cm^-1')),
        HinderedRotor(inertia=(0.788937,'amu*angstrom^2'), symmetry=1, barrier=(18.1392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.44043,'amu*angstrom^2'), symmetry=1, barrier=(56.1102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46014,0.0616492,-0.000102951,9.1257e-08,-3.2083e-11,-54015.8,19.0492], Tmin=(100,'K'), Tmax=(780.623,'K')), NASAPolynomial(coeffs=[8.23521,0.0204264,-1.12367e-05,2.25389e-09,-1.59557e-13,-54875.3,-10.6888], Tmin=(780.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C(F)(F)[CH]F(401)'],
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'O=[C]O[C](F)F(258)'],
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(12)', '[O]C(F)(F)[CH]F(401)'],
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(89.4109,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(742)'],
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(8.14471,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(258)'],
    products = ['O=[C]OC(F)(F)[CH]F(688)'],
