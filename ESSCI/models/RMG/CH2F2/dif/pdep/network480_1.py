...
"""),
    E0 = (-735.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,304.963,304.967,304.968,304.969,304.97,854.776],'cm^-1')),
        HinderedRotor(inertia=(0.0661197,'amu*angstrom^2'), symmetry=1, barrier=(4.36376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81257,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0794734,'amu*angstrom^2'), symmetry=1, barrier=(41.2053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44076,0.0616814,-6.63103e-05,3.85926e-08,-9.4421e-12,-88408.1,21.0452], Tmin=(100,'K'), Tmax=(964.716,'K')), NASAPolynomial(coeffs=[9.43117,0.0285506,-1.4796e-05,2.99346e-09,-2.16725e-13,-89949.7,-17.2168], Tmin=(964.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-225.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2800,2850,1350,1500,750,1050,1375,1000,323,467,575,827,1418,350,440,435,1725,180,1769.88],'cm^-1')),
        HinderedRotor(inertia=(0.262115,'amu*angstrom^2'), symmetry=1, barrier=(6.02653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259064,'amu*angstrom^2'), symmetry=1, barrier=(5.95639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260171,'amu*angstrom^2'), symmetry=1, barrier=(5.98184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.671785,0.0894303,-0.00017647,1.7717e-07,-6.60216e-11,-27065.1,24.3912], Tmin=(100,'K'), Tmax=(854.868,'K')), NASAPolynomial(coeffs=[3.49004,0.0384685,-2.07679e-05,4.05648e-09,-2.79361e-13,-26166.6,19.3098], Tmin=(854.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'COC(OF)=C(F)F(1336)',
...
"""),
    E0 = (-504.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,181.053,204.021,2207.43],'cm^-1')),
        HinderedRotor(inertia=(0.299716,'amu*angstrom^2'), symmetry=1, barrier=(8.49587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00398869,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33807,'amu*angstrom^2'), symmetry=1, barrier=(36.9407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735702,0.0803696,-0.00013503,1.22316e-07,-4.33517e-11,-60590.5,23.36], Tmin=(100,'K'), Tmax=(818.798,'K')), NASAPolynomial(coeffs=[8.0325,0.029954,-1.5614e-05,3.05773e-09,-2.13035e-13,-61290.3,-7.36078], Tmin=(818.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[CH2]C(F)(F)C([O])OF(1337)',
...
"""),
    E0 = (-352.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,180,1905.02],'cm^-1')),
        HinderedRotor(inertia=(0.226596,'amu*angstrom^2'), symmetry=1, barrier=(5.20988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224306,'amu*angstrom^2'), symmetry=1, barrier=(5.15723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34506,'amu*angstrom^2'), symmetry=1, barrier=(30.9255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.426948,0.0889462,-0.000157427,1.45554e-07,-5.21161e-11,-42283.1,28.3657], Tmin=(100,'K'), Tmax=(819.369,'K')), NASAPolynomial(coeffs=[8.4999,0.0308485,-1.68588e-05,3.3487e-09,-2.34571e-13,-42978.7,-5.14541], Tmin=(819.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)[C](O)OF(1338)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-373.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,215,315,519,588,595,1205,1248,360,370,350,3000,3100,440,815,1455,1000,234.844,235.021],'cm^-1')),
        HinderedRotor(inertia=(0.00357407,'amu*angstrom^2'), symmetry=1, barrier=(7.12529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471879,'amu*angstrom^2'), symmetry=1, barrier=(18.4836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181886,'amu*angstrom^2'), symmetry=1, barrier=(7.12446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471879,'amu*angstrom^2'), symmetry=1, barrier=(18.4844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14322,0.0918859,-0.000153407,1.29406e-07,-4.27723e-11,-44730.2,29.2148], Tmin=(100,'K'), Tmax=(793.725,'K')), NASAPolynomial(coeffs=[12.937,0.0222248,-1.19587e-05,2.3677e-09,-1.65931e-13,-46597.8,-28.523], Tmin=(793.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    E0 = (-363.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,234,347,1316,1464,433.995,434.029,434.084,434.106,434.199,1953.86],'cm^-1')),
        HinderedRotor(inertia=(0.219284,'amu*angstrom^2'), symmetry=1, barrier=(29.3041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30838,'amu*angstrom^2'), symmetry=1, barrier=(46.619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348309,'amu*angstrom^2'), symmetry=1, barrier=(46.615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91469,0.0477245,-4.05026e-05,1.74828e-08,-3.13912e-12,-43688.8,19.3359], Tmin=(100,'K'), Tmax=(1281.39,'K')), NASAPolynomial(coeffs=[9.95696,0.02262,-1.11156e-05,2.19391e-09,-1.56283e-13,-45749.8,-21.4576], Tmin=(1281.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = 'CC(F)(F)C([O])=O(1340)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-644.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,180,633.71,636.902,637.329,637.579,637.925],'cm^-1')),
        HinderedRotor(inertia=(0.00859195,'amu*angstrom^2'), symmetry=1, barrier=(2.48931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10811,'amu*angstrom^2'), symmetry=1, barrier=(2.48566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92181,0.0511354,-6.97917e-05,6.55679e-08,-2.63275e-11,-77457.6,19.2935], Tmin=(100,'K'), Tmax=(733.154,'K')), NASAPolynomial(coeffs=[3.79002,0.0332133,-1.73096e-05,3.46533e-09,-2.47502e-13,-77523.8,12.2771], Tmin=(733.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-644.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'CC(F)(F)OF(1324)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'O=C([C]F)OF(426)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(24)', 'O=C(OF)C(F)F(816)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(428)', 'CC(F)=C=O(1334)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1337)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1338)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1339)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1340)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(228)', 'CC(F)(F)[C]=O(1341)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', 'O=C(OF)[C](F)F(435)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(142)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(824)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(828)'],
    products = ['CC(F)(F)C(=O)OF(1313)'],
