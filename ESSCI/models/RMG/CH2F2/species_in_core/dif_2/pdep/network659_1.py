...
"""),
    E0 = (-554.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,1620.49],'cm^-1')),
        HinderedRotor(inertia=(6.42059e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59655,0.0338666,-4.11386e-05,2.54319e-08,-6.35998e-12,-66685.3,14.3171], Tmin=(100,'K'), Tmax=(961.962,'K')), NASAPolynomial(coeffs=[7.95727,0.0115756,-6.37967e-06,1.34272e-09,-9.948e-14,-67716.6,-11.3373], Tmin=(961.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)F(312)'],
    products = ['CF2(87)', 'CF3(44)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.27e+15,'s^-1'), n=0, Ea=(56722.9,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 3 C2F5 <=> CF3 + CF2 in halocarbene_recombination/training
This reaction matched rate rule [Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s_N-4R!H->Br_N-4ClF->Cl]
family: halocarbene_recombination
Ea raised from 235.3 to 237.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(1812)'],
    products = ['F[C](F)C(F)(F)F(312)'],
    transitionState = 'TS2',
