...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0875934,0.0940636,-0.000143281,1.08117e-07,-3.04779e-11,-74600.5,30.1966], Tmin=(100,'K'), Tmax=(664.602,'K')), NASAPolynomial(coeffs=[13.3317,0.0253866,-1.31826e-05,2.59659e-09,-1.82508e-13,-76604.6,-30.121], Tmin=(664.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(CCsJOCs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-188.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,611,648,830,1210,1753,3000,3100,440,815,1455,1000,180,180,1075.35],'cm^-1')),
        HinderedRotor(inertia=(0.105617,'amu*angstrom^2'), symmetry=1, barrier=(2.42834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207829,'amu*angstrom^2'), symmetry=1, barrier=(11.7374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0212905,'amu*angstrom^2'), symmetry=1, barrier=(17.5105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67402,0.0491349,-5.60454e-05,3.20327e-08,-7.14502e-12,-22547.2,21.774], Tmin=(100,'K'), Tmax=(1100.95,'K')), NASAPolynomial(coeffs=[12.0896,0.011293,-4.48785e-06,8.12947e-10,-5.58164e-14,-24840.7,-29.4772], Tmin=(1100.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(COCsFO) + radical(CCsJOCs) + radical(CsJOCC)"""),
)

species(
    label = 'O=C(F)C1OCC1(F)F(3716)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32903,0.0459616,-6.84355e-06,-2.49988e-08,1.23645e-11,-107103,26.4456], Tmin=(100,'K'), Tmax=(1046.72,'K')), NASAPolynomial(coeffs=[15.6153,0.0193486,-8.80452e-06,1.7896e-09,-1.33529e-13,-111626,-50.4516], Tmin=(1046.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-891.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(COCsFO) + ring(Cs-O2s-Cs-Cs(F)(F))"""),
)

species(
    label = 'O=C(F)COC=C(F)F(3949)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265273,0.0750905,-7.8563e-05,3.94331e-08,-7.67287e-12,-103713,27.7652], Tmin=(100,'K'), Tmax=(1258.75,'K')), NASAPolynomial(coeffs=[19.3056,0.0145857,-6.46278e-06,1.24739e-09,-8.89076e-14,-108506,-68.4752], Tmin=(1258.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-863.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'F[C](F)COC1O[C]1F(3950)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810401,0.076482,-9.62582e-05,6.55952e-08,-1.83819e-11,-56573.3,27.0928], Tmin=(100,'K'), Tmax=(859.548,'K')), NASAPolynomial(coeffs=[10.7199,0.030368,-1.5786e-05,3.1821e-09,-2.29378e-13,-58276.8,-19.2152], Tmin=(859.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.559563,0.0716899,-7.07717e-05,2.6967e-08,8.02135e-14,-74574.8,21.8851], Tmin=(100,'K'), Tmax=(839.771,'K')), NASAPolynomial(coeffs=[16.4579,0.0149522,-3.34571e-06,3.66842e-10,-1.71203e-14,-77914.6,-56.0257], Tmin=(839.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(O2sj(Cs-F1sCsCs)) + radical(CCsJOCs) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-420.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.928936,'amu*angstrom^2'), symmetry=1, barrier=(21.3581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.932626,'amu*angstrom^2'), symmetry=1, barrier=(21.4429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92811,'amu*angstrom^2'), symmetry=1, barrier=(21.3391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182428,0.0789923,-9.82951e-05,5.79302e-08,-1.30246e-11,-50456.5,25.6128], Tmin=(100,'K'), Tmax=(1104.05,'K')), NASAPolynomial(coeffs=[19.4738,0.00909941,-3.33637e-06,5.90595e-10,-4.06846e-14,-54716.2,-69.3663], Tmin=(1104.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C(F)[CH]O[CH]C(F)F(3954)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162393,0.0979773,-0.000154819,1.23981e-07,-3.9014e-11,-76567.9,30.8503], Tmin=(100,'K'), Tmax=(782.705,'K')), NASAPolynomial(coeffs=[14.4205,0.0234541,-1.20053e-05,2.34356e-09,-1.63598e-13,-78850.8,-35.9313], Tmin=(782.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CCsJOCs)"""),
)

species(
    label = 'O=C(F)CO[CH][C](F)F(3955)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-615.807,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,486,617,768,1157,1926,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0576311,0.0951011,-0.000157961,1.37231e-07,-4.68261e-11,-73930.6,31.4465], Tmin=(100,'K'), Tmax=(808.75,'K')), NASAPolynomial(coeffs=[11.2419,0.0289536,-1.51876e-05,2.98111e-09,-2.08026e-13,-75385.4,-17.9471], Tmin=(808.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-596.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,186.737,188.375,188.755],'cm^-1')),
        HinderedRotor(inertia=(0.48051,'amu*angstrom^2'), symmetry=1, barrier=(11.8553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46856,'amu*angstrom^2'), symmetry=1, barrier=(11.8381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29766,'amu*angstrom^2'), symmetry=1, barrier=(33.2945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220296,0.0926793,-0.000156667,1.40738e-07,-4.94081e-11,-71581.6,29.9515], Tmin=(100,'K'), Tmax=(818.536,'K')), NASAPolynomial(coeffs=[9.35828,0.0322182,-1.6905e-05,3.31586e-09,-2.31094e-13,-72548.1,-9.06983], Tmin=(818.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-299.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,167,640,1190,233.068,233.272,233.28,233.45],'cm^-1')),
        HinderedRotor(inertia=(0.474741,'amu*angstrom^2'), symmetry=1, barrier=(18.3626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.475153,'amu*angstrom^2'), symmetry=1, barrier=(18.3625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.475233,'amu*angstrom^2'), symmetry=1, barrier=(18.3658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41616,0.0823594,-0.0001149,7.95975e-08,-2.15831e-11,-35885.4,25.9461], Tmin=(100,'K'), Tmax=(906.684,'K')), NASAPolynomial(coeffs=[14.9178,0.0183837,-9.06077e-06,1.77711e-09,-1.25957e-13,-38515.1,-42.5953], Tmin=(906.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29816,0.063534,-6.47913e-05,3.55857e-08,-8.15536e-12,-62640,25.7312], Tmin=(100,'K'), Tmax=(1030.23,'K')), NASAPolynomial(coeffs=[10.2583,0.0287453,-1.41393e-05,2.80855e-09,-2.01524e-13,-64486.2,-17.763], Tmin=(1030.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-521.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCFHO) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.089949,0.0949599,-0.000138332,9.99336e-08,-2.82505e-11,-62499.9,30.9445], Tmin=(100,'K'), Tmax=(870.428,'K')), NASAPolynomial(coeffs=[16.041,0.0208304,-1.05841e-05,2.09006e-09,-1.48182e-13,-65308,-44.6394], Tmin=(870.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = '[O]C(F)=[C]OCC(F)F(3962)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-581.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,293,496,537,1218,1685,370,372.848,372.908,372.91,372.936,373.472,1272.32],'cm^-1')),
        HinderedRotor(inertia=(0.150339,'amu*angstrom^2'), symmetry=1, barrier=(14.8358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109732,'amu*angstrom^2'), symmetry=1, barrier=(10.8272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335114,'amu*angstrom^2'), symmetry=1, barrier=(33.0615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513878,0.0825443,-0.000108174,7.38062e-08,-2.02829e-11,-69859.4,29.3563], Tmin=(100,'K'), Tmax=(883.587,'K')), NASAPolynomial(coeffs=[12.7499,0.0271497,-1.41307e-05,2.84737e-09,-2.05141e-13,-72021.6,-28.1603], Tmin=(883.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'OC(F)=CO[CH][C](F)F(3963)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-566.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,326,540,652,719,1357,190,488,555,1236,1407,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.924844,'amu*angstrom^2'), symmetry=1, barrier=(21.264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924048,'amu*angstrom^2'), symmetry=1, barrier=(21.2457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92361,'amu*angstrom^2'), symmetry=1, barrier=(21.2356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924231,'amu*angstrom^2'), symmetry=1, barrier=(21.2499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817932,0.104506,-0.000145562,9.3883e-08,-2.30324e-11,-67978.3,30.5865], Tmin=(100,'K'), Tmax=(1012.74,'K')), NASAPolynomial(coeffs=[23.3506,0.00904891,-4.18059e-06,8.15389e-10,-5.85321e-14,-72873.7,-86.3189], Tmin=(1012.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'FO[C]=COC[C](F)F(3964)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(2781)', '[O]C[C](F)F(728)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', '[CH2]O[CH]C(=O)F(3948)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['O=C(F)C1OCC1(F)F(3716)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['F[C](F)COC1O[C]1F(3950)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['[O]C1(F)[CH]OCC1(F)F(3952)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(44.3806,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(3953)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(87)', '[CH2]O[CH]C(=O)F(3948)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.37175,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(3954)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(3955)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['[O][C]=COCC(F)(F)F(3956)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(179.342,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3713)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', 'F[C]=COC[C](F)F(3957)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(3714)'],
    products = ['[O][C](F)C1OCC1(F)F(3960)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(4.06771e+06,'s^-1'), n=1.35044, Ea=(99.7734,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 95.8 to 99.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(3961)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(3962)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(3963)'],
    products = ['O=C(F)[CH]OC[C](F)F(3714)'],
...
network(
    label = 'PDepNetwork #1339',
    isomers = [
        'O=C(F)[CH]OC[C](F)F(3714)',
    ],
    reactants = [
