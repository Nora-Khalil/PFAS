...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(F)(F)OF(817)'],
    products = ['HF(38)', 'CF2O(48)', 'CO2(13)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(13.0161,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)(F)OF(707)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(823)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(824)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(192)', '[O]C=O(135)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(712)', 'HCO(14)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(154)', 'O=CO[C](F)F(431)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(825)'],
    products = ['O=COC(F)(F)OF(817)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(106)', 'O=COC(=O)F(642)'],
    products = ['O=COC(F)(F)OF(817)'],
