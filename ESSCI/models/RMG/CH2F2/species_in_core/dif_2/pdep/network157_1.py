...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    products = ['[O]C(F)(F)C(F)(F)[CH]F(353)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C(F)[C](F)F(459)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)(F)C=C(F)F(461)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=C(F)F(462)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)C(F)[C](F)F(463)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(106)', 'O=C(F)[CH][C](F)F(464)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[C](F)F(465)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    products = ['[O]C(F)(F)[C](F)C(F)F(466)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FOC(F)(F)[CH][C](F)F(468)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    products = ['[O]C(F)(F)[CH]C(F)(F)F(469)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FO[C](F)C(F)[C](F)F(470)'],
    products = ['[O]C(F)(F)C(F)[C](F)F(354)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C(F)[C](F)F(354)'],
    products = ['[O][C](F)C(F)C(F)(F)F(471)'],
