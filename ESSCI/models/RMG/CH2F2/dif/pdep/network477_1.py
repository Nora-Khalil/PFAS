...
"""),
    E0 = (-591.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,190,488,555,1236,1407,3000,3100,440,815,1455,1000,208.416,209.07],'cm^-1')),
        HinderedRotor(inertia=(0.222558,'amu*angstrom^2'), symmetry=1, barrier=(7.02013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223528,'amu*angstrom^2'), symmetry=1, barrier=(7.01185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223246,'amu*angstrom^2'), symmetry=1, barrier=(7.0122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218743,0.0929968,-0.000159984,1.44109e-07,-5.02989e-11,-70973.6,26.8028], Tmin=(100,'K'), Tmax=(828.707,'K')), NASAPolynomial(coeffs=[9.61824,0.0304653,-1.57345e-05,3.07548e-09,-2.13653e-13,-71942.2,-13.2227], Tmin=(828.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C([CH2])(F)F(1309)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243995,0.0884733,-0.000129914,9.82448e-08,-2.93979e-11,-71587.4,25.4496], Tmin=(100,'K'), Tmax=(820.03,'K')), NASAPolynomial(coeffs=[13.4628,0.0239952,-1.19726e-05,2.36349e-09,-1.67508e-13,-73755.4,-35.7009], Tmin=(820.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'F[C](F)CC[C](F)F(1311)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-579.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,146,234,414,562,504,606,1176,1296,1354,1460,180,899.481,899.493],'cm^-1')),
        HinderedRotor(inertia=(0.23032,'amu*angstrom^2'), symmetry=1, barrier=(5.29551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230299,'amu*angstrom^2'), symmetry=1, barrier=(5.29504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230295,'amu*angstrom^2'), symmetry=1, barrier=(5.29495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993886,0.0757194,-0.000124431,1.1969e-07,-4.54425e-11,-69582.9,27.0892], Tmin=(100,'K'), Tmax=(798.823,'K')), NASAPolynomial(coeffs=[4.80781,0.0383751,-2.00446e-05,3.97855e-09,-2.806e-13,-69610.1,13.1898], Tmin=(798.823,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.119981,'amu*angstrom^2'), symmetry=1, barrier=(2.75861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119913,'amu*angstrom^2'), symmetry=1, barrier=(2.75703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.198757,'amu*angstrom^2'), symmetry=1, barrier=(4.56982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198749,'amu*angstrom^2'), symmetry=1, barrier=(4.56964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.542284,'amu*angstrom^2'), symmetry=1, barrier=(12.4682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420614,0.0857843,-0.000135613,1.15859e-07,-3.94902e-11,-70128.6,27.8156], Tmin=(100,'K'), Tmax=(777.653,'K')), NASAPolynomial(coeffs=[10.4513,0.028612,-1.45756e-05,2.8726e-09,-2.02113e-13,-71520,-16.9696], Tmin=(777.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-584.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[CH][C](F)F(1352)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540907,0.0861789,-0.000147809,1.36736e-07,-4.90853e-11,-71522,27.1071], Tmin=(100,'K'), Tmax=(824.465,'K')), NASAPolynomial(coeffs=[7.57039,0.0332235,-1.71673e-05,3.36566e-09,-2.34581e-13,-72040.5,-1.56374], Tmin=(824.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](F)CC(F)(F)F(1353)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828829,0.0765437,-0.00011818,1.02721e-07,-3.56375e-11,-74192.1,27.1807], Tmin=(100,'K'), Tmax=(804,'K')), NASAPolynomial(coeffs=[8.3065,0.0302238,-1.47517e-05,2.85477e-09,-1.98743e-13,-75099.8,-5.43082], Tmin=(804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C[C](F)F(1354)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.261263,'amu*angstrom^2'), symmetry=1, barrier=(6.00695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263646,'amu*angstrom^2'), symmetry=1, barrier=(6.06174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510364,'amu*angstrom^2'), symmetry=1, barrier=(11.7343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.393437,0.0933301,-0.00017353,1.68074e-07,-6.15348e-11,-66901.3,28.2499], Tmin=(100,'K'), Tmax=(844.575,'K')), NASAPolynomial(coeffs=[5.81116,0.0371752,-1.96342e-05,3.84349e-09,-2.66118e-13,-66728.8,9.46673], Tmin=(844.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    products = ['[CH2]C(F)(F)C([CH2])(F)F(1309)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(1311)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(166)', '[CH2]C([CH2])(F)F(1347)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', 'F[C](F)C[C](F)F(1216)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(56)', '[CH2][C](F)F(1124)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C(F)F(1270)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C[C](F)F(1350)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(1124)', '[CH2][C](F)F(1124)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[C](F)F(1272)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(42)', '[CH2]C([CH2])(F)F(1347)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(1351)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1310)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C[C](F)F(1310)'],
    products = ['[CH2][C](F)CC(F)(F)F(1353)'],
