...
"""),
    E0 = (-969.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([480,558,523,663,745,915,1086,1144,1147,1185,1338,1440,1394,1432,3056,3172,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.380481,0.0764446,-8.27141e-05,4.32523e-08,-8.84684e-12,-116435,35.3445], Tmin=(100,'K'), Tmax=(1191.2,'K')), NASAPolynomial(coeffs=[17.95,0.0174468,-8.42224e-06,1.67418e-09,-1.20769e-13,-120620,-52.4925], Tmin=(1191.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-969.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsFFHO) + group(CsFFHO)"""),
)
...
"""),
    E0 = (-427.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,519,593,830,1115,1166,1389,1413,3114,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15585,0.0552339,-5.57183e-05,2.36162e-08,-2.96821e-12,-51252.6,29.1277], Tmin=(100,'K'), Tmax=(1037.96,'K')), NASAPolynomial(coeffs=[16.7401,0.00691973,-2.868e-06,5.71117e-10,-4.2939e-14,-55120.4,-49.6854], Tmin=(1037.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsFFHO)"""),
)
...
"""),
    E0 = (-537.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,580,1155,1237,1373,3147,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73824,0.0698417,-7.76873e-05,4.1869e-08,-8.83221e-12,-64551.1,33.3453], Tmin=(100,'K'), Tmax=(1155.86,'K')), NASAPolynomial(coeffs=[16.3026,0.015979,-7.78743e-06,1.5526e-09,-1.12163e-13,-68149.1,-43.9981], Tmin=(1155.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsFFHO) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (-751.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,493,600,700,1144,1293,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.299367,0.075743,-8.51053e-05,4.5229e-08,-9.26534e-12,-90208.7,36.1326], Tmin=(100,'K'), Tmax=(1200.74,'K')), NASAPolynomial(coeffs=[19.3915,0.0121414,-5.65195e-06,1.11529e-09,-8.06137e-14,-94793.6,-59.4687], Tmin=(1200.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-751.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsFFHO) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)F(168)', '[O]OC(F)F(168)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.24576e+08,'m^3/(mol*s)'), n=0.0472428, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OOOOC(F)F(310)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOOOOC(F)F(545)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[CH]OOOOC(F)F(546)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(170)', '[O]OOC(F)F(222)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF2(81)', '[O]OOOC(F)F(177)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)OOOOC(F)F(547)'],
    products = ['FC(F)OOOOC(F)F(314)'],
    transitionState = 'TS7',
