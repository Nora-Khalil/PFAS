...
"""),
    ...
    molecularWeight = (64.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.30451,0.015538,-7.22212e-06,9.68424e-10,5.6629e-14,-10919.1,11.642], Tmin=(100,'K'), Tmax=(1819.26,'K')), NASAPolynomial(coeffs=[8.39316,0.00776389,-3.62737e-06,6.82724e-10,-4.58699e-14,-13335.6,-17.5058], Tmin=(1819.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.9927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-319.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([193,295,551,588,656,1146,1192,1350,180,747.925,1907.62],'cm^-1')),
        HinderedRotor(inertia=(0.00850039,'amu*angstrom^2'), symmetry=1, barrier=(3.32661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0245,'amu'),
...
"""),
    ...
    molecularWeight = (82.0245,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97023,0.0240336,-2.143e-05,9.72933e-09,-1.81777e-12,-37522.2,13.6041], Tmin=(100,'K'), Tmax=(1244.41,'K')), NASAPolynomial(coeffs=[7.14385,0.0106182,-5.25941e-06,1.06638e-09,-7.74184e-14,-38560.9,-7.44392], Tmin=(1244.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.367107,'amu*angstrom^2'), symmetry=1, barrier=(8.44052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (64.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88776,0.0292787,-5.20605e-05,5.24826e-08,-2.00724e-11,-8512.84,14.1704], Tmin=(100,'K'), Tmax=(832.921,'K')), NASAPolynomial(coeffs=[3.49552,0.0155531,-7.88008e-06,1.54338e-09,-1.07575e-13,-8239.21,13.5998], Tmin=(832.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.0739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sH) + radical(CsCsF1sH)"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]C(F)(F)F-2(1132)'],
    products = ['[CH2]C(F)(F)F(1125)'],
