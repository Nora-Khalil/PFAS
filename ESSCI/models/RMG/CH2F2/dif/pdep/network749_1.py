...
"""),
    E0 = (-146.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1053.42,1053.46,1053.46,2965.74,2965.75],'cm^-1')),
        HinderedRotor(inertia=(0.135303,'amu*angstrom^2'), symmetry=1, barrier=(3.11087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
