...
"""),
    E0 = (-895.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2782.5,750,1395,475,1775,1000,180,524.547,830.98],'cm^-1')),
        HinderedRotor(inertia=(1.26686,'amu*angstrom^2'), symmetry=1, barrier=(29.1275,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70192,0.053237,-5.40512e-05,2.69764e-08,-5.46227e-12,-107621,21.2074], Tmin=(100,'K'), Tmax=(1168.77,'K')), NASAPolynomial(coeffs=[11.5957,0.0193764,-1.05941e-05,2.1883e-09,-1.60053e-13,-109933,-28.0672], Tmin=(1168.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-895.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFOO) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-763.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,805.865,1505.09],'cm^-1')),
        HinderedRotor(inertia=(1.57384,'amu*angstrom^2'), symmetry=1, barrier=(36.1858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57638,'amu*angstrom^2'), symmetry=1, barrier=(36.244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00685,0.0371,-2.51039e-05,4.68034e-09,7.59556e-13,-91747.1,20.8435], Tmin=(100,'K'), Tmax=(1171.65,'K')), NASAPolynomial(coeffs=[12.414,0.0118129,-5.84354e-06,1.18276e-09,-8.62509e-14,-94888.9,-34.014], Tmin=(1171.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-699.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,1855,455,950,236.595,236.813,236.94],'cm^-1')),
        HinderedRotor(inertia=(1.21465,'amu*angstrom^2'), symmetry=1, barrier=(48.0117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19457,'amu*angstrom^2'), symmetry=1, barrier=(48.1481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.805084,'amu*angstrom^2'), symmetry=1, barrier=(32.0132,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39406,0.0620107,-8.50828e-05,5.84248e-08,-1.59944e-11,-83983.9,20.9508], Tmin=(100,'K'), Tmax=(889.651,'K')), NASAPolynomial(coeffs=[11.3207,0.0173792,-9.83216e-06,2.03557e-09,-1.48613e-13,-85750.2,-25.779], Tmin=(889.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(F)(F)OF(805)'],
    products = ['HF(38)', 'CF2O(48)', 'CO2(13)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(9.20995,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(12)', 'OC(F)(F)OF(568)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.27e-07,'m^3/(mol*s)'), n=3.7, Ea=(226.974,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(811)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(812)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(194)', '[O]C=O(142)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(573)', 'HCO(14)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(156)', 'O=CO[C](F)F(548)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(813)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(108)', 'O=COC(=O)F(696)'],
    products = ['O=COC(F)(F)OF(805)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(68.8265,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
