...
"""),
    E0 = (-1304.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,435,565,619,662,854,1178,1396,190,488,555,1236,1407,240.461,240.465,240.467,240.472],'cm^-1')),
        HinderedRotor(inertia=(0.228303,'amu*angstrom^2'), symmetry=1, barrier=(9.36809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228336,'amu*angstrom^2'), symmetry=1, barrier=(9.36801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787178,'amu*angstrom^2'), symmetry=1, barrier=(32.3015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787313,'amu*angstrom^2'), symmetry=1, barrier=(32.3015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0498395,0.0943446,-0.000135238,9.89071e-08,-2.88798e-11,-156702,30.2575], Tmin=(100,'K'), Tmax=(835.948,'K')), NASAPolynomial(coeffs=[14.0434,0.0273853,-1.50874e-05,3.08681e-09,-2.23446e-13,-159042,-34.7457], Tmin=(835.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1304.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.703504,'amu*angstrom^2'), symmetry=1, barrier=(16.1749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703532,'amu*angstrom^2'), symmetry=1, barrier=(16.1756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703074,'amu*angstrom^2'), symmetry=1, barrier=(16.165,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02828,'amu*angstrom^2'), symmetry=1, barrier=(23.6423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0282,'amu*angstrom^2'), symmetry=1, barrier=(23.6403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0284,'amu*angstrom^2'), symmetry=1, barrier=(23.6448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.19643,0.0794784,-9.43609e-05,5.29016e-08,-1.14062e-11,-140009,26.1331], Tmin=(100,'K'), Tmax=(1143.58,'K')), NASAPolynomial(coeffs=[19.5695,0.0117157,-5.47878e-06,1.08672e-09,-7.88806e-14,-144440,-69.9302], Tmin=(1143.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1165.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-1346.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,326,540,652,719,1357,182,240,577,636,1210,1413,226.344,226.727,227.018],'cm^-1')),
        HinderedRotor(inertia=(0.340151,'amu*angstrom^2'), symmetry=1, barrier=(12.3461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338322,'amu*angstrom^2'), symmetry=1, barrier=(12.3504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808913,'amu*angstrom^2'), symmetry=1, barrier=(29.2156,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00896848,0.0924813,-0.000131397,9.06755e-08,-2.44343e-11,-161810,27.1707], Tmin=(100,'K'), Tmax=(912.144,'K')), NASAPolynomial(coeffs=[16.8193,0.0187633,-1.01695e-05,2.07253e-09,-1.50028e-13,-164877,-52.3836], Tmin=(912.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1346.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'OC(F)(F)O[CH][C](F)F(1744)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-917.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,3025,407.5,1350,352.5,190,488,555,1236,1407,194.542,194.542,194.543,194.545],'cm^-1')),
        HinderedRotor(inertia=(0.266063,'amu*angstrom^2'), symmetry=1, barrier=(7.1456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00445433,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266065,'amu*angstrom^2'), symmetry=1, barrier=(7.14562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11093,'amu*angstrom^2'), symmetry=1, barrier=(29.8363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.163385,0.101248,-0.000179659,1.57816e-07,-5.32777e-11,-110220,30.3618], Tmin=(100,'K'), Tmax=(838.669,'K')), NASAPolynomial(coeffs=[12.6002,0.0242682,-1.31747e-05,2.58044e-09,-1.78279e-13,-111795,-25.5932], Tmin=(838.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-917.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](F)OC(F)[C](F)F(1745)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-867.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,586,761,1411,245.903,246.18,246.255,246.416],'cm^-1')),
        HinderedRotor(inertia=(0.563995,'amu*angstrom^2'), symmetry=1, barrier=(24.3128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885635,'amu*angstrom^2'), symmetry=1, barrier=(38.0861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564871,'amu*angstrom^2'), symmetry=1, barrier=(24.3057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00279437,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
...
"""),
    E0 = (-1037.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,190,488,555,1236,1407,203.133,203.151,203.161,203.169],'cm^-1')),
        HinderedRotor(inertia=(0.795767,'amu*angstrom^2'), symmetry=1, barrier=(23.3042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00408497,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27283,'amu*angstrom^2'), symmetry=1, barrier=(37.2839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446883,0.083939,-0.00011009,7.20224e-08,-1.87805e-11,-124661,29.73], Tmin=(100,'K'), Tmax=(932.279,'K')), NASAPolynomial(coeffs=[14.4846,0.0237112,-1.31887e-05,2.73086e-09,-1.99853e-13,-127278,-37.0097], Tmin=(932.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)O[C](F)[C](F)F(1747)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1100.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,395,473,707,1436,190,488,555,1236,1407,199.769,203.085,207.96,1872.69],'cm^-1')),
        HinderedRotor(inertia=(0.275377,'amu*angstrom^2'), symmetry=1, barrier=(7.69301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278654,'amu*angstrom^2'), symmetry=1, barrier=(7.65952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18958,'amu*angstrom^2'), symmetry=1, barrier=(32.2339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13381,'amu*angstrom^2'), symmetry=1, barrier=(32.2783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0426282,0.0978662,-0.00016706,1.47256e-07,-5.12964e-11,-132233,32.9057], Tmin=(100,'K'), Tmax=(771.249,'K')), NASAPolynomial(coeffs=[11.8037,0.0283609,-1.61931e-05,3.28731e-09,-2.34022e-13,-133820,-19.6141], Tmin=(771.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1100.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)OC(F)[C](F)F(1312)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1038.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,664,788,1296,1923,273.191,273.192,273.192,273.192],'cm^-1')),
        HinderedRotor(inertia=(0.62635,'amu*angstrom^2'), symmetry=1, barrier=(33.1722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392293,'amu*angstrom^2'), symmetry=1, barrier=(20.7764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0310708,'amu*angstrom^2'), symmetry=1, barrier=(33.1723,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22028,0.0648673,-7.24187e-05,4.00589e-08,-8.93278e-12,-124806,26.0179], Tmin=(100,'K'), Tmax=(1074.07,'K')), NASAPolynomial(coeffs=[12.8682,0.0214885,-1.18371e-05,2.45606e-09,-1.803e-13,-127308,-31.0087], Tmin=(1074.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1038.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)OC(F)[C]F-2(1748)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.861241,'amu*angstrom^2'), symmetry=1, barrier=(19.8016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859452,'amu*angstrom^2'), symmetry=1, barrier=(19.7605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62457,'amu*angstrom^2'), symmetry=1, barrier=(37.352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.860311,'amu*angstrom^2'), symmetry=1, barrier=(19.7802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54024,0.0823861,-0.000117616,8.61307e-08,-2.51871e-11,-113393,27.0963], Tmin=(100,'K'), Tmax=(834.908,'K')), NASAPolynomial(coeffs=[12.686,0.0241965,-1.3072e-05,2.65378e-09,-1.91273e-13,-115422,-29.3085], Tmin=(834.908,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-1245.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,375,486,586,623,710,938,1161,1294,322.339,322.34,322.34,322.341],'cm^-1')),
        HinderedRotor(inertia=(0.435671,'amu*angstrom^2'), symmetry=1, barrier=(32.1232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103284,'amu*angstrom^2'), symmetry=1, barrier=(7.61541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332519,'amu*angstrom^2'), symmetry=1, barrier=(24.5176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.37485,0.0831379,-9.85583e-05,5.79914e-08,-1.35842e-11,-149658,28.5285], Tmin=(100,'K'), Tmax=(1034.21,'K')), NASAPolynomial(coeffs=[15.7011,0.0238608,-1.25837e-05,2.57096e-09,-1.8741e-13,-152828,-45.9272], Tmin=(1034.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1245.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = 'OC(F)(F)O[CH]C(F)(F)F(1751)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.52076,0.109498,-0.000190832,1.66853e-07,-5.64616e-11,-162952,30.2488], Tmin=(100,'K'), Tmax=(826.475,'K')), NASAPolynomial(coeffs=[13.2618,0.027711,-1.50195e-05,2.95568e-09,-2.05393e-13,-164715,-30.501], Tmin=(826.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1356.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFOO) + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H))"""),
)

species(
    label = 'O[C](F)OC(F)C(F)(F)F(1752)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'OC(F)(F)O[CH]F(1145)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)(F)OC=C(F)F(1742)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(O)(F)F(257)', 'CHFCF2(54)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.29185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=C(F)F(1743)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(F)(F)O[CH][C](F)F(1744)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)OC(F)[C](F)F(1745)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(257)', 'F[CH][C](F)F(185)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O[C](F)F(220)', '[O]C(F)[C](F)F(371)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(4)', 'F[C](F)OC(F)[C](F)F(340)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)[C](F)F(1746)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)[C](F)F(1747)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)OC(F)[C](F)F(1312)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F-2(1748)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(89)', 'OC(F)(F)O[CH]F(1145)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    products = ['OC(F)(F)O[C](F)C(F)F(1749)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)OC(F)C(F)F(1750)'],
    products = ['OC(F)(F)OC(F)[C](F)F(1655)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    products = ['OC(F)(F)O[CH]C(F)(F)F(1751)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(F)(F)OC(F)[C](F)F(1655)'],
    products = ['O[C](F)OC(F)C(F)(F)F(1752)'],
...
network(
    label = 'PDepNetwork #710',
    isomers = [
        'OC(F)(F)OC(F)[C](F)F(1655)',
    ],
    reactants = [
