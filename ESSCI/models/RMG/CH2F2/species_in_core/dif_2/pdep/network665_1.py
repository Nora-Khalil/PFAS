...
"""),
    E0 = (-447.431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,180,418.944],'cm^-1')),
        HinderedRotor(inertia=(0.587214,'amu*angstrom^2'), symmetry=1, barrier=(13.5012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56739,'amu*angstrom^2'), symmetry=1, barrier=(36.0374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67301,0.0554638,-7.9494e-05,5.80334e-08,-1.68343e-11,-53733.5,18.0279], Tmin=(100,'K'), Tmax=(842.873,'K')), NASAPolynomial(coeffs=[10.1065,0.0154401,-8.26428e-06,1.69268e-09,-1.22859e-13,-55155.1,-21.2167], Tmin=(842.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)
...
"""),
    E0 = (-87.3406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,180,180,1444.65],'cm^-1')),
        HinderedRotor(inertia=(0.323682,'amu*angstrom^2'), symmetry=1, barrier=(7.44209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32344,'amu*angstrom^2'), symmetry=1, barrier=(7.43651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72584,0.0618473,-0.000124672,1.26301e-07,-4.72008e-11,-10434.1,20.6865], Tmin=(100,'K'), Tmax=(858.115,'K')), NASAPolynomial(coeffs=[3.28002,0.0267114,-1.44992e-05,2.8308e-09,-1.94622e-13,-9673.96,19.4098], Tmin=(858.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.3406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C](F)COF(1648)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.278531,'amu*angstrom^2'), symmetry=1, barrier=(6.40397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278523,'amu*angstrom^2'), symmetry=1, barrier=(6.40379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25465,0.0718883,-0.000145177,1.3831e-07,-4.84796e-11,-11429.1,20.6714], Tmin=(100,'K'), Tmax=(883.123,'K')), NASAPolynomial(coeffs=[6.96682,0.0191817,-1.00754e-05,1.91578e-09,-1.28113e-13,-11391.6,-0.252087], Tmin=(883.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.7577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-O2sHH)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(728)'],
    products = ['[O]CC([O])(F)F(1635)'],
    transitionState = 'TS2',
