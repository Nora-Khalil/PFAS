...
reaction(
    label = 'reaction2',
    reactants = ['[O]OF(154)', 'CF2(89)'],
    products = ['[O]OC(F)(F)F(416)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(37.3062,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'CF3O(47)'],
    products = ['[O]OC(F)(F)F(416)'],
    transitionState = 'TS3',
