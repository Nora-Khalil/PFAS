...
"""),
    ...
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.76619,-0.000867219,3.32871e-05,-3.95802e-08,1.39935e-11,-46830.2,7.56902], Tmin=(100,'K'), Tmax=(997.636,'K')), NASAPolynomial(coeffs=[5.5248,0.00779097,-3.35069e-06,6.86781e-10,-5.23879e-14,-47962.8,-4.8291], Tmin=(997.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), label="""formic_acid""", comment="""Thermo library: DFT_QCI_thermo"""),
)
