...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(236)', 'CHF(40)'],
    products = ['[O]C(=O)O[CH]F(575)'],
    transitionState = 'TS2',
