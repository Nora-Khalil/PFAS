...
"""),
    E0 = (-290.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,247.733,247.974],'cm^-1')),
        HinderedRotor(inertia=(0.389781,'amu*angstrom^2'), symmetry=1, barrier=(16.9936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390022,'amu*angstrom^2'), symmetry=1, barrier=(16.9887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389561,'amu*angstrom^2'), symmetry=1, barrier=(16.9908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-181.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,264.839,265.632],'cm^-1')),
        HinderedRotor(inertia=(0.297144,'amu*angstrom^2'), symmetry=1, barrier=(14.7777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305192,'amu*angstrom^2'), symmetry=1, barrier=(14.7714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16795,0.0297818,3.5507e-06,-3.66207e-08,1.96201e-11,-21694.1,14.8552], Tmin=(100,'K'), Tmax=(904.327,'K')), NASAPolynomial(coeffs=[14.6704,0.0027984,1.3381e-06,-3.63651e-10,2.45671e-14,-25113.3,-50.6068], Tmin=(904.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""HOCH2CH2O""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-64.6142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,1069.02],'cm^-1')),
        HinderedRotor(inertia=(0.00900124,'amu*angstrom^2'), symmetry=1, barrier=(7.3025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757944,'amu*angstrom^2'), symmetry=1, barrier=(17.4266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OCCOF(1614)'],
    products = ['HF(38)', 'CH2O(19)', 'CH2O(19)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(50.1793,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    ...
    products = ['OCCOF(1614)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.52948e-05,'m^3/(mol*s)'), n=2.95311, Ea=(67.3024,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'C=COF(1743)'],
    products = ['OCCOF(1614)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OF(1527)', 'CH2OH(33)'],
    products = ['OCCOF(1614)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O[CH]COF(1750)'],
    products = ['OCCOF(1614)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(1.12121,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC[CH]OF(1744)'],
    products = ['OCCOF(1614)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=CCO(1748)'],
    products = ['OCCOF(1614)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(454.278,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #687',
    isomers = [
        'OCCOF(1614)',
    ],
    reactants = [
