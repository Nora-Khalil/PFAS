...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(192)', '[O]C=O(142)'],
    products = ['O=COC(=O)OF(959)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(156)', 'O=[C]OC=O(697)'],
    products = ['O=COC(=O)OF(959)'],
    transitionState = 'TS9',
